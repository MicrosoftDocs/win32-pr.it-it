...
description: Questa sezione descrive le considerazioni sull'inoltro di messaggi usando SendMessage, PostMessage e le funzioni correlate con i messaggi tramite tocco.
...
In questa sezione vengono descritte alcune considerazioni sull'inoltro di messaggi tramite [SendMessage](/windows/desktop/api/winuser/nf-winuser-sendmessage), [PostMessage](/windows/win32/api/winuser/nf-winuser-postmessagea)e le funzioni correlate con i messaggi tramite tocco.
...
> [!Note]  
> I messaggi tocco sono soggetti alle normali regole Interfaccia utente di isolamento dei privilegi (UIPI) quando vengono inoltrati.
