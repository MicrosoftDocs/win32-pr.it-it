...
| [**SetGestureConfig**](/windows/desktop/api/winuser/nf-winuser-setgestureconfig)             | Imposta la configurazione del movimento per una finestra.                                                            |
