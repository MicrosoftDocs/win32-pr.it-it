...
Il **metodo UnlockWithPassphrase** della [**classe Win32 \_ EncryptableVolume**](win32-encryptablevolume.md) usa la passphrase per ottenere la chiave derivata. Dopo aver calcolato la chiave derivata, la chiave derivata viene usata per sbloccare la chiave master del volume crittografato.
...
| <dl> <dt>**FVE \_ E \_ AUTENTICAZIONE \_ NON RIUSCITA**</dt> <dt>2150694951 (0x80310027)</dt> </dl>              | Il volume non può essere sbloccato con le informazioni fornite. <br/>                                                  |
