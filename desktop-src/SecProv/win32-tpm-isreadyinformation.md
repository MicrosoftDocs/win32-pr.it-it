...
---
# <a name="win32_tpmisreadyinformation-method"></a>\_Metodo Win32 TPM:: IsReadyInformation

Indica se il TPM è pronto e fornisce informazioni aggiuntive sullo stato del TPM. Il parametro Information restituisce una maschera di base di informazioni sugli elementi necessari per eseguire il provisioning completo del TPM.
...
Restituisce una maschera di base della quantità di informazioni disponibile per il provisioning completo del TPM.
...
| <span id="INFORMATION_TPM_SRK_AUTH"></span><span id="information_tpm_srk_auth"></span><dl> <dt>**Informazioni \_ su TPM \_ SRK \_ AUTH**</dt> <dt>0x00000200</dt> </dl>                                  | Il valore di autorizzazione della chiave radice di archiviazione (SRK) non è pari a zero.<br/>                                                                                                                                                            |
...
| <span id="INFORMATION_DEVICEID"></span><span id="information_deviceid"></span><dl> <dt>**Informazioni \_ su**</dt> <dt>0x00800000</dt> DEVICEID </dl>                                                | L'identificatore del dispositivo non è stato creato.<br/>                                                                                                                                                                                 |
| <span id="INFORMATION_ATTESTATION_VULNERABILITY"></span><span id="information_attestation_vulnerability"></span><dl> <dt>**Informazioni \_ su \_Vulnerabilità di attestazione**</dt> <dt> 0x01000000</dt> </dl>                                                | Il TPM presenta una vulnerabilità relativa all'attestazione dell'integrità.<br/>                                                                                                                                                                                 |
