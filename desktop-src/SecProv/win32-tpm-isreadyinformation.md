...
title: Win32_Tpm::IsReadyInformation
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118890838"
---
# <a name="win32_tpmisreadyinformation-method"></a>Metodo \_ Win32 Tpm::IsReadyInformation

Indica se il TPM è pronto e fornisce informazioni aggiuntive sullo stato del TPM. Il parametro information restituisce una maschera di bit di informazioni sugli elementi necessari per eseguire il provisioning completo del TPM.
...
Restituisce una maschera di bit con tutte le informazioni disponibili per il provisioning completo del TPM.
...
| <span id="INFORMATION_TPM_SRK_AUTH"></span><span id="information_tpm_srk_auth"></span><dl> <dt>**INFORMAZIONI \_ TPM \_ SRK \_ AUTH**</dt> <dt>0x00000200</dt> </dl>                                  | Il Archiviazione di autorizzazione della chiave radice radice (SRK) non è uguale a zero.<br/>                                                                                                                                                            |
...
| <span id="INFORMATION_DEVICEID"></span><span id="information_deviceid"></span><dl> <dt>**INFORMAZIONI \_ DEVICEID**</dt> <dt> 0x00800000</dt> </dl>                                                | L'identificatore del dispositivo non è stato creato.<br/>                                                                                                                                                                                 |
| <span id="INFORMATION_ATTESTATION_VULNERABILITY"></span><span id="information_attestation_vulnerability"></span><dl> <dt>**INFORMAZIONI \_ VULNERABILITÀ DI \_ ATTESTAZIONE**</dt> <dt> 0x01000000</dt> </dl>                                                | Il TPM presenta una vulnerabilità correlata all'attestazione dell'integrità.<br/>                                                                                                                                                                                 |
