...
---
# <a name="awe-example"></a><span data-ttu-id="5dfc8-103">Esempio AWE</span><span class="sxs-lookup"><span data-stu-id="5dfc8-103">AWE Example</span></span>

<span data-ttu-id="5dfc8-104">Nel programma di esempio seguente vengono illustrate le [**estensioni della finestra degli indirizzi**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="5dfc8-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
