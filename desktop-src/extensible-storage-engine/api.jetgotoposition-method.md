---
description: Altre informazioni sul metodo Api.JetGotoPosition
title: Metodo Api.JetGotoPosition
...
ms.locfileid: "119978211"
---
# <a name="apijetgotoposition-method"></a>Metodo Api.JetGotoPosition

Sposta un cursore in una nuova posizione che rappresenta una frazione dell'indice corrente. Vedere anche [JetGetRecordPosition(JET_SESID, JET_TABLEID, JET_RECPOS)](./api.jetgetrecordposition-method.md).
