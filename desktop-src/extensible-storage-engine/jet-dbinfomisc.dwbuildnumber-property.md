...
---
# <a name="jet_dbinfomiscdwbuildnumber-property"></a>Proprietà JET_DBINFOMISC. dwBuildNumber

Ottiene il numero di build del sistema operativo dall'ultima connessione.
