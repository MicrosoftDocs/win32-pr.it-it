---
description: 'Altre informazioni su: JET_COLUMNLIST.tableid'
title: JET_COLUMNLIST.tableid
...
ms.locfileid: "118486856"
---
# <a name="jet_columnlisttableid-property"></a>JET_COLUMNLIST.tableid

Ottiene l'ID di tabella della tabella temporanea. Questa operazione deve essere chiusa quando la tabella non è più necessaria.
