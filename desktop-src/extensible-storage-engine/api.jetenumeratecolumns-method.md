...
<!-- end list -->
  ...
  - columnValues  
    ...
    Restituisce i valori della colonna enumerata.
...
<!-- end list -->
  ...
  - allocator  
    ...
    Callback usato per allocare memoria.
...
<!-- end list -->
  ...
  - maxDataSize  
    ...
    Imposta un limite per la quantità di dati da restituire da un testo lungo o una colonna binaria di tipo Long. Questo parametro può essere utilizzato per impedire l'enumerazione di un valore di colonna estremamente grande.
