...
---
# <a name="jet_indexlistcolumnidindexname-property"></a>Proprietà JET_INDEXLIST. columnidindexname

Ottiene l'ColumnID della colonna nella tabella temporanea in cui è archiviato il nome dell'indice. La colonna è di tipo [Text](./jet-coltyp-enumeration.md).
