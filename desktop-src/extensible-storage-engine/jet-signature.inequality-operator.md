...
---
# <a name="jet_signatureinequality-operator"></a>JET_SIGNATURE. Operatore di disuguaglianza

Determina se due istanze specificate di JET_SIGNATURE non sono uguali.
