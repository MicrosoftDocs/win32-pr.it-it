---
description: 'Altre informazioni su: membri di EsentCorruptionException'
title: Membri di EsentCorruptionException
...
ms.locfileid: "103749911"
---
# <a name="esentcorruptionexception-members"></a>Membri di EsentCorruptionException
...
Il tipo [EsentCorruptionException](./esentcorruptionexception-class.md) espone i membri seguenti.
...
<td>Inizializza una nuova istanza della classe EsentCorruptionException. Questo costruttore viene utilizzato per deserializzare un'eccezione serializzata.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Metodo protetto" alt="Protected method" /></td>
<td><a href="dn334330(v=exchg.10).md">EsentCorruptionException (stringa, JET_err)</a></td>
<td>Inizializza una nuova istanza della classe EsentCorruptionException.</td>
</tr>
</tbody>
</table>
