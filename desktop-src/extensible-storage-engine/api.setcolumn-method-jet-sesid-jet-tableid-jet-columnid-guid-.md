---
description: 'Altre informazioni su: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Guid)'
title: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Guid)
...
ms.locfileid: "117717592"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-guid"></a>Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Guid)
