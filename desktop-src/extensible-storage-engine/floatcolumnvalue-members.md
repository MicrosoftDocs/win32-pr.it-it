...
---
# <a name="floatcolumnvalue-members"></a>Membri di FloatColumnValue

Includi membri protetti  
Includi membri ereditati  

Valore di colonna [singola](/dotnet/api/system.single) .

Il tipo [FloatColumnValue](./floatcolumnvalue-class.md) espone i membri seguenti.
...
<td>Ottiene la lunghezza in byte di un valore di colonna, che è zero se la colonna è null; in caso contrario, corrisponde alla dimensione della colonna a dimensione fissa. Ereditato da <a href="dn334171(v=exchg.10).md">ColumnValueOfStruct &lt; T &gt; </a>.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Proprietà pubblica" alt="Public property" /></td>
...
<td><a href="dn350901(v=exchg.10).md">Dimensioni</a></td>
