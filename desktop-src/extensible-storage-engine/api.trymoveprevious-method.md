...
---
# <a name="apitrymoveprevious-method"></a>API. TryMovePrevious, metodo

Provare a passare al record precedente nella tabella. Se non è presente un record precedente, viene restituito false, se viene rilevato un errore diverso, viene generata un'eccezione.
