...
<td><p>Il contenuto dell'ID di indice non è valido o è scaduto e deve essere aggiornato. Questo problema può verificarsi per <strong>JetSetCurrentIndex</strong> quando:</p>
<ul>
...
<td><p>Implementato come <strong>JetSetCurrentIndexW</strong> (Unicode) e <strong>JetSetCurrentIndexA</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
