...
title: InstanceParameters.CachePriority - proprietà
...
ms.locfileid: "117895650"
---
# <a name="instanceparameterscachepriority-property"></a>InstanceParameters.CachePriority - proprietà

Ottiene o imposta la proprietà per istanza per le priorità relative della cache (impostazione predefinita = 100).
