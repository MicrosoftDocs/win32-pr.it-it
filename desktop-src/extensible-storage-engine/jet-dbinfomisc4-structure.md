---
description: 'Altre informazioni su: JET_DBINFOMISC4 Structure'
...
La **JET_DBINFOMISC4** contiene informazioni varie su un database. Si tratta delle informazioni contenute nell'intestazione del database.
...
Rappresenta i Windows NT di versione al momento dell'aggiornamento degli indici dei database. Utilizzato per l'aggiornamento degli indici.
