...
---
# <a name="transaction-members"></a>Membri di Transaction 

Includi membri protetti  
Includi membri ereditati  

Classe che incapsula una transazione in un JET_SESID.
...
<td><a href="dn351177(v=exchg.10).md">Transazione</a></td>
<td>Inizializza una nuova istanza della classe Transaction. Viene avviata automaticamente una transazione. Se non viene eseguito il commit esplicito, verrà eseguito il rollback della transazione.</td>
</tr>
</tbody>
</table>
...
<td>Ottiene un valore che indica se l'oggetto è attualmente in una transazione.</td>
</tr>
</tbody>
</table>
