---
description: 'Altre informazioni su: metodi di JET_RSTINFO'
title: Metodi di JET_RSTINFO
...
ms.locfileid: "103966553"
---
# <a name="jet_rstinfo-methods"></a>Metodi di JET_RSTINFO

Includi membri protetti  
Includi membri ereditati  

Il tipo di [JET_RSTINFO](./jet-rstinfo-class.md) espone i membri seguenti.
...
<td>Restituisce una <a href="/dotnet/api/system.string">stringa</a> che rappresenta la <a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>corrente. Esegue l'override di <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.</td>
</tr>
</tbody>
</table>
