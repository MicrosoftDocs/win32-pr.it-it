---
description: Altre informazioni sul metodo Api.JetGetLock
title: Metodo Api.JetGetLock
...
<!-- end list -->
  ...
  - tableid  
    ...
    Cursore da utilizzare. Verrà acquisito un blocco nel record corrente.
...
<!-- end list -->
  ...
  - grbit  
    ...
    Opzioni di blocco, usare questa opzione per specificare il tipo di blocco da ottenere.
