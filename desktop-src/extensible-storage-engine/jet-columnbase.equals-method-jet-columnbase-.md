---
description: 'Altre informazioni su: JET_COLUMNBASE. Metodo Equals (JET_COLUMNBASE)'
title: JET_COLUMNBASE. Metodo Equals (JET_COLUMNBASE)
...
ms.locfileid: "118487189"
---
# <a name="jet_columnbaseequals-method-jet_columnbase"></a>JET_COLUMNBASE. Metodo Equals (JET_COLUMNBASE)
...
[Confronta l'overload](./jet-columnbase.equals-method.md)
