---
description: 'Altre informazioni su: membri di EsentResourceException'
title: Membri di EsentResourceException
...
ms.locfileid: "104552507"
---
# <a name="esentresourceexception-members"></a>Membri di EsentResourceException

Includi membri protetti  
Includi membri ereditati  

Classe di base per le eccezioni di risorsa.

Il tipo [EsentResourceException](./esentresourceexception-class.md) espone i membri seguenti.
...
<td>Inizializza una nuova istanza della classe EsentResourceException. Questo costruttore viene utilizzato per deserializzare un'eccezione serializzata.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Metodo protetto" alt="Protected method" /></td>
<td><a href="dn350558(v=exchg.10).md">EsentResourceException (stringa, JET_err)</a></td>
<td>Inizializza una nuova istanza della classe EsentResourceException.</td>
</tr>
</tbody>
</table>
