...
---
# <a name="apijetresetsessioncontext-method"></a>API. JetResetSessionContext, metodo

Annulla l'associazione di una sessione dal thread corrente. Questa operazione deve essere utilizzata insieme a [JetSetSessionContext (JET_SESID, IntPtr)](./api.jetsetsessioncontext-method.md).
