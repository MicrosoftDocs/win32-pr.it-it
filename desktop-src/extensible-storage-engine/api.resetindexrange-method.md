...
Rimuove un intervallo di indice creato con [JetSetIndexRange (JET_SESID, JET_TABLEID, SetIndexRangeGrbit)](./api.jetsetindexrange-method.md) o [TrySetIndexRange (JET_SESID, JET_TABLEID, SetIndexRangeGrbit)](./api.trysetindexrange-method.md). Se non è presente alcun intervallo di indice, questo metodo non esegue alcuna operazione.
