---
description: Altre informazioni sul metodo Api.RetrieveColumnAsString (JET_SESID, JET_TABLEID, JET_COLUMNID, Encoding, RetrieveColumnGrbit)
...
<!-- end list -->
  ...
  - codifica  
    ...
    Codifica di stringa da utilizzare durante la conversione dei dati.
