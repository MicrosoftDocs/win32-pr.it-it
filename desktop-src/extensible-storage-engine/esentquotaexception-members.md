---
description: 'Altre informazioni su: membri di EsentQuotaException'
title: Membri di EsentQuotaException
...
ms.locfileid: "104563924"
---
# <a name="esentquotaexception-members"></a>Membri di EsentQuotaException
...
Il tipo [EsentQuotaException](./esentquotaexception-class.md) espone i membri seguenti.
...
<td>Inizializza una nuova istanza della classe EsentQuotaException. Questo costruttore viene utilizzato per deserializzare un'eccezione serializzata.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Metodo protetto" alt="Protected method" /></td>
<td><a href="dn319867(v=exchg.10).md">EsentQuotaException (stringa, JET_err)</a></td>
<td>Inizializza una nuova istanza della classe EsentQuotaException.</td>
</tr>
</tbody>
</table>
