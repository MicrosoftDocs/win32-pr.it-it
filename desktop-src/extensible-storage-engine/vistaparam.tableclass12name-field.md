---
description: Altre informazioni sul campo VistaParam.TableClass12Name
...
ms:contentKeyID: 55104343
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.Vista.VistaParam.TableClass12Name
dev_langs:
- CSharp
- JScript
- VB
...
ROBOTS: INDEX,FOLLOW
ms.openlocfilehash: b266772b3ac3771d2b6ef6c669d0682fa5d61b97f8e04467bb9ca453908fd089
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 08/11/2021
ms.locfileid: "118483995"
---
# <a name="vistaparamtableclass12name-field"></a>Campo VistaParam.TableClass12Name

Impostare il nome associato alla classe di tabella 12.
...
``` vb
'Declaration
Public Const TableClass12Name As JET_param
'Usage
Dim value As JET_param

value = VistaParam.TableClass12Name
```

``` csharp
public const JET_param TableClass12Name
```
