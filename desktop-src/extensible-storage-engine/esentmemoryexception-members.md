...
ms.locfileid: "119115631"
---
# <a name="esentmemoryexception-members"></a>Membri di EsentMemoryException
...
Il [tipo EsentMemoryException](./esentmemoryexception-class.md) espone i membri seguenti.
...
<td>Inizializza una nuova istanza della classe EsentMemoryException. Questo costruttore viene usato per deserializzare un'eccezione serializzata.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Metodo protetto" alt="Protected method" /></td>
