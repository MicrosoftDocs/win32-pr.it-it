---
description: Altre informazioni sulla funzione JetGetLogInfoInstance2
title: Funzione JetGetLogInfoInstance2
...
ms.locfileid: "122982534"
---
# <a name="jetgetloginfoinstance2-function"></a>Funzione JetGetLogInfoInstance2
...
| <p>JET_errInvalidBackupSequence</p> | <p>L'operazione di backup non è riuscita perché è stata chiamata fuori sequenza. <a href="gg294055(v=exchg.10).md">JetGetLogInfo restituirà</a> questo errore se sono presenti handle di file in sospeso creati <a href="gg269249(v=exchg.10).md">usando JetOpenFile per</a> l'istanza.</p> | 
| <p>JET_errInvalidParameter</p> | <p>Uno dei parametri forniti contiene un valore imprevisto o contiene un valore che non ha senso se combinato con il valore di un altro parametro. Questa operazione può verificarsi <a href="gg294055(v=exchg.10).md">per JetGetLogInfo</a> quando l'handle di istanza specificato non è valido (Windows XP e versioni successive).</p> | 
...
| <p><strong>Unicode</strong></p> | <p>Implementato come <strong>JetGetLogInfoInstance2W</strong> (Unicode) e <strong>JetGetLogInfoInstance2A</strong> (ANSI).</p> | 
