...
---
# <a name="apiretrievecolumnasint64-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>Metodo API. RetrieveColumnAsInt64 (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
...
Dati recuperati dalla colonna come Long. Null se la colonna è null.  
...
[Overload RetrieveColumnAsInt64](./api.retrievecolumnasint64-method.md)
