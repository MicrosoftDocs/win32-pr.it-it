...
---
# <a name="apiretrievecolumns-method"></a>API. RetrieveColumns, metodo
...
<!-- end list -->
  ...
  - TableID  
    ...
    Il cursore Recupera i dati da. Il cursore deve essere posizionato in corrispondenza di un record.
