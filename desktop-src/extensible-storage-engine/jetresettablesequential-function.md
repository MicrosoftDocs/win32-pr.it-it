...
title: Funzione JetResetTableSequential
...
ms.locfileid: "122985704"
---
# <a name="jetresettablesequential-function"></a>Funzione JetResetTableSequential
...
La **funzione JetResetTableSequential** notifica al motore di database che l'applicazione non esegue più l'analisi dell'intero indice corrente contenente un determinato cursore. Questa chiamata inverte una notifica inviata [da JetSetTableSequential](./jetsettablesequential-function.md).
...
In caso di esito positivo, l'indice corrente del cursore non è più ottimizzato per un'analisi sequenziale dell'intero indice. Non verrà apportata alcuna modifica allo stato del database.

In caso di errore, non verrà apportata alcuna modifica alla configurazione del cursore. Non verrà apportata alcuna modifica allo stato del database.
