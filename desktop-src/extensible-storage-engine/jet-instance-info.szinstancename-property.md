...
---
# <a name="jet_instance_infoszinstancename-property"></a>Proprietà JET_INSTANCE_INFO. szInstanceName

Ottiene il nome dell'istanza del database. Questo valore può essere null se l'istanza non ha un nome.
