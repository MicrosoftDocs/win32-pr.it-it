---
description: 'Altre informazioni su: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Int64)'
title: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Int64)
...
ms.locfileid: "119786641"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-int64"></a>Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Int64)
