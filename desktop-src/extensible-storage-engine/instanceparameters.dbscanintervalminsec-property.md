...
---
# <a name="instanceparametersdbscanintervalminsec-property"></a>Proprietà InstanceParameters. DbScanIntervalMinSec

Ottiene o imposta l'intervallo minimo per la ripetizione dell'analisi del database, in secondi.
