...
---
# <a name="jet_dbinfomisclogtimerepair-property"></a>Proprietà JET_DBINFOMISC. logtimeRepair

Ottiene l'ultima volta in cui è stato eseguito il ripristino sul database.
