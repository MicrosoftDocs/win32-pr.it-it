...
---
# <a name="apijetgetindexinfo-method-jet_sesid-jet_dbid-string-string-string-jet_idxinfo"></a>Metodo API. JetGetIndexInfo (JET_SESID, JET_DBID, String, String, String, JET_IdxInfo)
