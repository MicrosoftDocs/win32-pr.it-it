...
---
# <a name="jet_columnidtostring-method-string-iformatprovider"></a>JET_COLUMNID. Metodo ToString (String, IFormatProvider)
...
[Overload ToString](./jet-columnid.tostring-method2.md)
