...
---
# <a name="jet_enumcolumn-members"></a>Membri JET_ENUMCOLUMN
...
<td>Restituisce una <a href="/dotnet/api/system.string">stringa</a> che rappresenta la <a href="dn335081(v=exchg.10).md">JET_ENUMCOLUMN</a>corrente. Esegue l'override di <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.</td>
</tr>
</tbody>
</table>
