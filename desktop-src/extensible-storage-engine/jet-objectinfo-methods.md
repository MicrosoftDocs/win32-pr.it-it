---
description: 'Altre informazioni su: metodi di JET_OBJECTINFO'
title: Metodi di JET_OBJECTINFO
...
ms.locfileid: "103757907"
---
# <a name="jet_objectinfo-methods"></a>Metodi di JET_OBJECTINFO
...
<td>Restituisce una <a href="/dotnet/api/system.string">stringa</a> che rappresenta la <a href="dn335219(v=exchg.10).md">JET_OBJECTINFO</a>corrente. Esegue l'override di <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.</td>
</tr>
</tbody>
</table>
