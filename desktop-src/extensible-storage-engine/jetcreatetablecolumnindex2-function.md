---
description: Altre informazioni sulla funzione JetCreateTableColumnIndex2
title: Funzione JetCreateTableColumnIndex2
...
ms.locfileid: "122985014"
---
# <a name="jetcreatetablecolumnindex2-function"></a>Funzione JetCreateTableColumnIndex2
...
La **funzione JetCreateTableColumnIndex2** crea una tabella in un database ESE con un set iniziale [](./jet-tablecreate2-structure.md) di indici e un set iniziale di colonne da una matrice di JET_TABLECREATE2 struttura. La [JET_TABLECREATE2](./jet-tablecreate2-structure.md) struttura consente di impostare una funzione di callback.
...
Puntatore a una [JET_TABLECREATE2](./jet-tablecreate2-structure.md) struttura che definisce la tabella da creare. Vedere [JET_TABLECREATE2](./jet-tablecreate2-structure.md) per altri dettagli.
...
| <p>JET_errIndexTuplesSecondaryIndexOnly</p> | <p>Windows XP e versioni successive. Un indice di tupla non può essere un indice primario, ovvero il membro <strong>grbit</strong> della struttura <a href="gg269186(v=exchg.10).md">JET_INDEXCREATE</a> non deve avere sia JET_bitIndexPrimary che JET_bitIndexTuples impostati).</p> | 
| <p>JET_errIndexTuplesTextColumnsOnly</p> | <p>Windows XP e versioni successive. Un indice di tupla può essere solo in una colonna di tipo text o Unicode. Un tentativo di indicizzare altre colonne, ad esempio le colonne binarie, genererà JET_errIndexTuplesTextColumnsOnly.</p> | 
...
| <p>JET_errInvalidColumnType</p> | <p>Il <strong>membro coltyp</strong> della struttura <a href="gg269252(v=exchg.10).md">JET_COLUMNCREATE</a> non è stato impostato su un tipo di colonna valido.</p> | 
...
| <p>JET_errTooManyColumns</p> | <p>Si è tentato di aggiungere troppe colonne alla tabella. Una tabella non può contenere più di JET_ccolFixedMost colonne fisse, non più di JET_ccolVarMost colonne a lunghezza variabile e non più di JET_ccolTaggedMost colonne con tag.</p> | 
...
Il nome **JetCreateTableColumnIndex2** deriva dall'ordine di creazione degli oggetti: crea prima una tabella, le colonne e infine gli indici. **JetCreateTableColumnIndex2** crea una tabella con un set iniziale di colonne e indici. È possibile aggiungere e rimuovere in modo dinamico colonne e indici aggiuntivi con [JetAddColumn](./jetaddcolumn-function.md), [JetDeleteColumn](./jetdeletecolumn-function.md), [JetDeleteColumn2](./jetdeletecolumn2-function.md), [JetCreateIndex](./jetcreateindex-function.md), [JetCreateIndex2](./jetcreateindex2-function.md)e [JetDeleteIndex](./jetdeleteindex-function.md).

Analogamente [a JetOpenTable,](./jetopentable-function.md)quando l'applicazione viene completata usando l'ID di tabella restituito, in genere deve essere chiusa [con JetCloseTable.](./jetclosetable-function.md) 
...
| <p><strong>Unicode</strong></p> | <p>Implementato come <strong>JetCreateTableColumnIndex2W</strong> (Unicode) e <strong>JetCreateTableColumnIndex2A</strong> (ANSI).</p> | 
