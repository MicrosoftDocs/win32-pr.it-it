...
---
# <a name="jetclosetable-function"></a>JetCloseTable (funzione)
...
Questa funzione deve essere chiamata su tutte le tabelle aperte con [JetOpenTable](./jetopentable-function.md).
