---
description: 'Altre informazioni su: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte )'
title: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte )
...
ms.locfileid: "117717666"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-byte-"></a>Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte )
