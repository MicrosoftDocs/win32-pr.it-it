...
| <p>Digitare:</p> | <p>Speciali</p> | 
| <p>Intervallo valido:</p> | <p>Speciali</p> | 
...
| Etichetta | Valore |
|--------|-------|
| <p>Valore predefinito:</p> | <p>JET_ExceptionMsgBox</p> | 
| <p>Digitare:</p> | <p>Intero</p> | 
| <p>Intervallo valido:</p> | <p>JET_ExceptionMsgBox, JET_ExceptionNone</p> | 
| <p>Ambito:</p> | <p>Globale</p> | 
| <p>Imposta dopo <a href="gg269354(v=exchg.10).md">JetCreateInstance</a>:</p> | <p><strong>Windows 2000, Windows XP e Windows Server 2003:</strong>  No</p><p><strong>Windows Vista:</strong>  Sì</p> | 
| <p>Impostare dopo <a href="gg294068(v=exchg.10).md">JetInit</a>:</p> | <p><strong>Windows 2000, Windows XP e Windows Server 2003:</strong>  No</p><p><strong>Windows Vista:</strong>  Sì</p> | 
| <p>Influisce sul layout fisico:</p> | <p>No</p> | 
