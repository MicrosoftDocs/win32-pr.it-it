---
description: 'Altre informazioni su: JET_TABLEID membri'
title: JET_TABLEID membri
...
ms.locfileid: "119472771"
---
# <a name="jet_tableid-members"></a>JET_TABLEID membri

Includere membri protetti  
Includi membri ereditati  

Un JET_TABLEID contiene un handle al cursore del database da utilizzare per una chiamata all'API JET. Un cursore può essere utilizzato solo con la sessione utilizzata per aprire il cursore.

Il [JET_TABLEID](./jet-tableid-structure.md) espone i membri seguenti.
...
<td>Ottiene un valore null JET_TABLEID.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh596595(v=exchg.10).md">Uguaglianza</a></td>
<td>Determina se due istanze specificate di JET_TABLEID sono uguali.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operatore pubblico" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro statico" alt="Static member" /></td>
<td><a href="hh577464(v=exchg.10).md">Disuguaglianza</a></td>
<td>Determina se due istanze specificate di JET_TABLEID non sono uguali.</td>
</tr>
</tbody>
</table>
