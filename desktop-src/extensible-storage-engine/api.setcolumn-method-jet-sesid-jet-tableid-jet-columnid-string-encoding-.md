...
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-string-encoding"></a>Metodo API. secolumn (JET_SESID, JET_TABLEID, JET_COLUMNID, String, Encoding)
