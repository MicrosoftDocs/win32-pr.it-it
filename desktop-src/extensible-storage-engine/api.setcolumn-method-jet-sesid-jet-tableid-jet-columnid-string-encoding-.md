---
description: 'Altre informazioni su: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, String, Encoding)'
title: Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, String, Encoding)
...
ms.locfileid: "118084410"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-string-encoding"></a>Metodo Api.SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, String, Encoding)
