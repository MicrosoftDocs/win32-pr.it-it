...
---
# <a name="apijetossnapshotfreeze-method"></a>API. JetOSSnapshotFreeze, metodo

Avvia uno snapshot. Durante l'esecuzione dello snapshot, non è possibile eseguire alcuna attività Write-to-disk da parte del motore.
...
<!-- end list -->
  ...
  - numInstances  
    ...
    Restituisce il numero di istanze che fanno parte della sessione snapshot.
...
<!-- end list -->
  ...
  - instances  
    ...
    Restituisce informazioni sulle istanze di che fanno parte della sessione snapshot.
...
<!-- end list -->
  ...
  - grbit  
    ...
    Opzioni di blocco dello snapshot.
