---
description: 'Altre informazioni su: membri di EsentDataException'
title: Membri di EsentDataException
...
ms.locfileid: "104554309"
---
# <a name="esentdataexception-members"></a>Membri di EsentDataException
...
Il tipo [EsentDataException](./esentdataexception-class.md) espone i membri seguenti.
...
<td>Inizializza una nuova istanza della classe EsentDataException. Questo costruttore viene utilizzato per deserializzare un'eccezione serializzata.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Metodo protetto" alt="Protected method" /></td>
<td><a href="dn274233(v=exchg.10).md">EsentDataException (stringa, JET_err)</a></td>
<td>Inizializza una nuova istanza della classe EsentDataException.</td>
</tr>
</tbody>
</table>
