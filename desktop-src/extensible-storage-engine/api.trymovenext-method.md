...
Provare a passare al record successivo nella tabella. Se non è presente un record successivo, restituisce false, se viene rilevato un errore diverso viene generata un'eccezione.
