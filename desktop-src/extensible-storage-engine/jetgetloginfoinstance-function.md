...
---
# <a name="jetgetloginfoinstance-function"></a>JetGetLogInfoInstance (funzione)
...
<td><p>Implementato come <strong>JetGetLogInfoInstanceW</strong> (Unicode) e <strong>JetGetLogInfoInstanceA</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
