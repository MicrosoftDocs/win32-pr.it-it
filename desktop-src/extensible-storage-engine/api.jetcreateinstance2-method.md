...
---
# <a name="apijetcreateinstance2-method"></a>API. JetCreateInstance2, metodo

Allocare una nuova istanza del motore di database per l'utilizzo in un singolo processo, con un nome visualizzato specificato.
...
<!-- end list -->
  ...
  - displayName  
    ...
    Nome visualizzato per l'istanza da creare. Questa operazione verrà utilizzata nelle voci del registro eventi.
