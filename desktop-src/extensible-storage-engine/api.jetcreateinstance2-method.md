...
title: Metodo Api.JetCreateInstance2
...
ms.locfileid: "117719259"
---
# <a name="apijetcreateinstance2-method"></a>Metodo Api.JetCreateInstance2

Allocare una nuova istanza del motore di database per l'uso in un singolo processo, con un nome visualizzato specificato.
...
<!-- end list -->
  ...
  - displayName  
    ...
    Nome visualizzato per l'istanza da creare. Verrà usato nelle voci del registro eventi.
