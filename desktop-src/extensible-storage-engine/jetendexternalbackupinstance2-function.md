---
description: Altre informazioni sulla funzione JetEndExternalBackupInstance2
title: Funzione JetEndExternalBackupInstance2
...
ms.locfileid: "122477617"
---
# <a name="jetendexternalbackupinstance2-function"></a>Funzione JetEndExternalBackupInstance2
...
La **funzione JetEndExternalBackupInstance2** termina una sessione di backup esterna. Questa API è l'ultima API di una serie di API che devono essere chiamate per eseguire correttamente un backup online (non basato su VSS).
...
|--------------|----------------|
| <p>JET_bitBackupEndAbort<br />0x0002</p> | <p>L'applicazione client sta interrompendo il backup.</p> | 
| <p>JET_bitBackupEndNormal<br />0x0001</p> | <p>L'applicazione client ha completato completamente il backup e termina normalmente.</p> | 
| <p>JET_bitBackupTruncateDone<br />0x0100</p> | <p><strong>Windows Vista:</strong> JET_bitBackupTruncateDone è stato introdotto in Windows Vista.</p><p>Il motore può contrassegnare le intestazioni del database come appropriate (ad esempio, un backup completo completato), anche se la chiamata a truncate non è stata completata.</p> | 
