...
---
# <a name="jetcreatetablecolumnindex-function"></a>JetCreateTableColumnIndex (funzione)
...
Puntatore a una struttura [JET_TABLECREATE](./jet-tablecreate-structure.md) che definisce la tabella da creare. Per ulteriori informazioni, vedere [JET_TABLECREATE](./jet-tablecreate-structure.md) .
...
<td><p>Implementato come <strong>JetCreateTableColumnIndexW</strong> (Unicode) e <strong>JetCreateTableColumnIndexA</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
