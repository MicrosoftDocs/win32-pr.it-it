...
| <p>JET_errCannotBeTagged</p> | <p>Si è tentato di usare una colonna con tag quando la colonna potrebbe non essere contrassegnata. Di seguito sono riportati alcuni dei vincoli per la disattivazione delle colonne con tag:</p><ul><li><p>Non è possibile usare una colonna di aggiornamento del deposito (JET_bitColumnEscrowUpdate) in una colonna con tag o valore lungo<a href="gg269213(v=exchg.10).md">(JET_coltypLongBinary</a> o <a href="gg269213(v=exchg.10).md">JET_coltypLongText</a>).</p></li><li><p>Una colonna di incrementale automatico potrebbe non essere contrassegnata.</p></li><li><p>Una colonna Versione potrebbe non essere contrassegnata.</p></li></ul> | 
| <p>JET_errExclusiveTableLockRequired</p> | <p>Per questa operazione è stato richiesto un blocco esclusivo sulla tabella.</p> | 
