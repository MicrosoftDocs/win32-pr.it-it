---
description: 'Altre informazioni su: Membri InstanceParameters'
...
Questa classe fornisce proprietà per impostare e ottenere i parametri di sistema in un'istanza ESENT. Questa classe fornisce proprietà statiche per impostare e ottenere i parametri di sistema ESENT per istanza.
...
<td>Restituisce un <a href="/dotnet/api/system.string">oggetto String</a> che rappresenta l'oggetto <a href="dn350942(v=exchg.10).md">InstanceParameters corrente.</a> Esegue l'override <a href="/dotnet/api/system.object.tostring#System_Object_ToString">di Object.ToString()</a>.</td>
</tr>
</tbody>
</table>
