...
---
# <a name="instanceparameters-members"></a>Membri di InstanceParameters

Includi membri protetti  
Includi membri ereditati  

Questa classe fornisce le proprietà per impostare e ottenere i parametri di sistema in un'istanza di ESENT. Questa classe fornisce proprietà statiche per impostare e ottenere i parametri di sistema ESENT per istanza.
...
<td>Inizializza una nuova istanza della classe InstanceParameters.</td>
</tr>
</tbody>
</table>
...
<td>Restituisce una <a href="/dotnet/api/system.string">stringa</a> che rappresenta l'oggetto <a href="dn350942(v=exchg.10).md">InstanceParameters</a>corrente. Esegue l'override di <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.</td>
</tr>
</tbody>
</table>
