...
---
# <a name="apijetossnapshotthaw-method"></a>API. JetOSSnapshotThaw, metodo

Notifica al motore che può riprendere le normali operazioni di i/o dopo un periodo di blocco e uno snapshot riuscito.
