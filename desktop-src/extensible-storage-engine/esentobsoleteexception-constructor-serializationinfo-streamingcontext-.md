...
Inizializza una nuova istanza della classe EsentObsoleteException. Questo costruttore viene utilizzato per deserializzare un'eccezione serializzata.
...
[Overload EsentObsoleteException](./esentobsoleteexception-constructor.md)
