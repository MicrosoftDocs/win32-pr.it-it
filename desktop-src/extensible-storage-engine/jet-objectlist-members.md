---
description: 'Altre informazioni su: JET_OBJECTLIST membri'
title: JET_OBJECTLIST membri
...
ms.locfileid: "118765997"
---
# <a name="jet_objectlist-members"></a>JET_OBJECTLIST membri

Includere membri protetti  
Includere i membri ereditati  

Informazioni su una tabella temporanea contenente informazioni su tutte le tabelle per un database specificato.

Il [JET_OBJECTLIST](./jet-objectlist-class.md) tipo espone i membri seguenti.
...
<td>Ottiene il columnid della colonna nella tabella temporanea in cui è archiviato il numero di pagine utilizzate dalla tabella.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Proprietà pubblica" alt="Public property" /></td>
...
<td>Ottiene il columnid della colonna nella tabella temporanea in cui sono archiviati i flag di tabella, ad esempio il flag della tabella di sistema.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Proprietà pubblica" alt="Public property" /></td>
<td><a href="dn335211(v=exchg.10).md">columnidgrbit</a></td>
<td>Ottiene il columnid della colonna nella tabella temporanea in cui sono archiviati i grbit usati al momento della creazione della tabella.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Proprietà pubblica" alt="Public property" /></td>
<td><a href="dn335213(v=exchg.10).md">columnidobjectname</a></td>
<td>Ottiene il columnid della colonna nella tabella temporanea in cui è archiviato il nome della tabella.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Proprietà pubblica" alt="Public property" /></td>
...
<td>Restituisce un <a href="/dotnet/api/system.string">oggetto String</a> che rappresenta l'oggetto <a href="dn335206(v=exchg.10).md">JET_OBJECTLIST</a>. Esegue l'override <a href="/dotnet/api/system.object.tostring#System_Object_ToString">di Object.ToString()</a>.</td>
</tr>
</tbody>
</table>
