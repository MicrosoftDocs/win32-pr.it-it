...
---
# <a name="bytescolumnvalue-members"></a>Membri di BytesColumnValue
...
<td>Restituisce una <a href="/dotnet/api/system.string">stringa</a> che rappresenta l'oggetto <a href="dn334170(v=exchg.10).md">BytesColumnValue</a>corrente. Esegue l'override di <a href="dn334163(v=exchg.10).md">columnValue. ToString ()</a>.</td>
</tr>
</tbody>
</table>
