...
---
# <a name="instanceparametersmaxopentables-property"></a>Proprietà InstanceParameters. MaxOpenTables

Ottiene o imposta il numero di risorse dell'albero B + riservate per l'istanza.
