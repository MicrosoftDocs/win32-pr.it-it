...
Si tratta delle dimensioni effettive dell'ID indice restituito nel buffer di output da [JetGetIndexInfo](./jetgetindexinfo-function.md) [o JetGetTableIndexInfo.](./jetgettableindexinfo-function.md)
