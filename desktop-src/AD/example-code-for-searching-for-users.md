---
title: Codice di esempio per la ricerca di utenti
description: Negli esempi di codice seguenti viene eseguita la ricerca di utenti nel dominio dell'account utente con cui viene eseguito il processo chiamante. Esempio di base di C++ ExampleVisual
ms.assetid: 53bbd57b-0bd2-4acb-a69f-89764b85e257
ms.tgt_platform: multiple
keywords:
- Esempi di Active Directory Active Directory, ricerca di utenti
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104398834"
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="88490-104">Codice di esempio per la ricerca di utenti</span><span class="sxs-lookup"><span data-stu-id="88490-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="88490-105">Negli esempi di codice seguenti viene eseguita la ricerca di utenti nel dominio dell'account utente con cui viene eseguito il processo chiamante.</span><span class="sxs-lookup"><span data-stu-id="88490-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="88490-106">Esempio di C++</span><span class="sxs-lookup"><span data-stu-id="88490-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="88490-107">Esempio di Visual Basic</span><span class="sxs-lookup"><span data-stu-id="88490-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="88490-108">Esempio C++</span><span class="sxs-lookup"><span data-stu-id="88490-108">C++ Example</span></span>

<span data-ttu-id="88490-109">Nell'esempio di codice C++ riportato di seguito viene eseguita la ricerca del dominio corrente per tutti gli utenti o di un utente specifico in base a un filtro specificato.</span><span class="sxs-lookup"><span data-stu-id="88490-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="88490-110">Esempio di Visual Basic</span><span class="sxs-lookup"><span data-stu-id="88490-110">Visual Basic Example</span></span>

<span data-ttu-id="88490-111">Nell'esempio di codice seguente Visual Basic viene eseguita la ricerca nel dominio corrente degli utenti con il cognome specificato e vengono restituiti gli attributi Name e [**Distinguishname**](/windows/desktop/ADSchema/a-distinguishedname) per gli oggetti trovati.</span><span class="sxs-lookup"><span data-stu-id="88490-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="88490-112">Nell'esempio di codice riportato di seguito viene utilizzato ADO per eseguire la ricerca.</span><span class="sxs-lookup"><span data-stu-id="88490-112">The following code example uses ADO to perform the search.</span></span>
