...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a>Codice di esempio per l'implementazione dell'oggetto COM del menu di scelta rapida

L'esempio di codice seguente può essere usato per implementare un'estensione del menu di scelta rapida Active Directory. La voce del menu di scelta rapida Visualizza una finestra di messaggio contenente il ADsPath di ogni elemento selezionato.

## <a name="ishellextinit-implementation"></a>Implementazione di IShellExtInit

L'esempio di codice seguente può essere usato per implementare i metodi [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="icontextmenu-implementation"></a>Implementazione di IContextMenu

L'esempio di codice seguente può essere usato per implementare i metodi [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) .
