...
---
# <a name="vb-script-listing-all-service-connection-points"></a><span data-ttu-id="fac53-103">Script VB che elenca tutti i punti di connessione del servizio</span><span class="sxs-lookup"><span data-stu-id="fac53-103">VB Script Listing all Service Connection Points</span></span>

<span data-ttu-id="fac53-104">I punti di connessione del servizio possono essere gestiti tramite uno script VB.</span><span class="sxs-lookup"><span data-stu-id="fac53-104">Service Connection Points can be managed using VB Script.</span></span> <span data-ttu-id="fac53-105">Il codice di esempio seguente mostra come elencare tutti i punti di connessione del servizio nel nome di dominio fornito dalla riga di comando:</span><span class="sxs-lookup"><span data-stu-id="fac53-105">The following sample code shows how to list all Service Connection Points on the domain name provided on the command line:</span></span>
