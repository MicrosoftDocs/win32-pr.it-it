...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="d3c1d-105">Codice di esempio per l'estensione dello schema a livello di codice</span><span class="sxs-lookup"><span data-stu-id="d3c1d-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="d3c1d-106">Questo argomento include un esempio di codice C++ che estende a livello di codice lo schema di Active Directory.</span><span class="sxs-lookup"><span data-stu-id="d3c1d-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
