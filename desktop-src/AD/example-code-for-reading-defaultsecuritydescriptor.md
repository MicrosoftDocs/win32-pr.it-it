...
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a><span data-ttu-id="cd7c5-104">Codice di esempio per la lettura di defaultSecurityDescriptor</span><span class="sxs-lookup"><span data-stu-id="cd7c5-104">Example Code for Reading defaultSecurityDescriptor</span></span>

<span data-ttu-id="cd7c5-105">Nell'esempio di codice seguente viene letta la **defaultSecurityDescriptor** per una classe di oggetti specificata.</span><span class="sxs-lookup"><span data-stu-id="cd7c5-105">The following code example reads the **defaultSecurityDescriptor** for a specified object class.</span></span>
