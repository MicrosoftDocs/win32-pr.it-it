...
Nell'esempio di codice C++ riportato di seguito viene illustrato come eseguire l'associazione a un oggetto noto utilizzando la stringa di associazione WKGUID.
