...
---
# <a name="example-code-for-removing-the-rnr-connection-point"></a><span data-ttu-id="c3d72-106">Codice di esempio per la rimozione del punto di connessione RnR</span><span class="sxs-lookup"><span data-stu-id="c3d72-106">Example Code for Removing the RnR Connection Point</span></span>

<span data-ttu-id="c3d72-107">L'esempio di codice seguente viene usato dall'esempio di codice del servizio Winsock per annullare la registrazione del punto di connessione RnR per il servizio.</span><span class="sxs-lookup"><span data-stu-id="c3d72-107">The following code example is used by the Winsock service code example to unregister the RnR connection point for the service.</span></span>
