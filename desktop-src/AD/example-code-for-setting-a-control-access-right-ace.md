...
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="10ada-104">Codice di esempio per l'impostazione di un controllo ACE a destra</span><span class="sxs-lookup"><span data-stu-id="10ada-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="10ada-105">Nell'esempio di codice C/C++ riportato di seguito viene aggiunta una voce ACE per un controllo di accesso Right all'ACL di un oggetto.</span><span class="sxs-lookup"><span data-stu-id="10ada-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
