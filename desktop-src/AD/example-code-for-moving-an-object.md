...
---
# <a name="example-code-for-moving-an-object"></a><span data-ttu-id="e1e3e-105">Codice di esempio per lo stato di trasferimento di un oggetto</span><span class="sxs-lookup"><span data-stu-id="e1e3e-105">Example Code for Moving an Object</span></span>

<span data-ttu-id="e1e3e-106">Questo argomento include esempi di codice usati per spostare un oggetto nel dominio.</span><span class="sxs-lookup"><span data-stu-id="e1e3e-106">This topic includes code examples used to move an object in the domain.</span></span>

<span data-ttu-id="e1e3e-107">Nell'esempio di codice C++ riportato di seguito viene illustrato come utilizzare ADSI per spostare un oggetto nel dominio.</span><span class="sxs-lookup"><span data-stu-id="e1e3e-107">The following C++ code example shows how to use ADSI to move an object in the domain.</span></span>
...
<span data-ttu-id="e1e3e-108">Nell'esempio di codice Visual Basic riportato di seguito viene illustrato come utilizzare ADSI per spostare un oggetto nel dominio.</span><span class="sxs-lookup"><span data-stu-id="e1e3e-108">The following Visual Basic code example shows how to use ADSI to move an object in the domain.</span></span>
