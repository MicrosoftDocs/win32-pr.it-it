...
---
# <a name="example-code-for-installing-an-rnr-service-class"></a>Codice di esempio per l'installazione di una classe del servizio RnR

Il programma seguente installa una classe del servizio RnR.
