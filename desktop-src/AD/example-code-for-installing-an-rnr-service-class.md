---
title: Codice di esempio per l'installazione di una classe del servizio RnR
description: Il programma seguente installa una classe del servizio RnR.
ms.assetid: 85605ecf-bc82-48ac-8b36-ee43862a3bc9
ms.tgt_platform: multiple
keywords:
- Active Directory per la registrazione e la risoluzione di Windows Sockets, codice di esempio, installazione di una classe RnR
- Installazione di un annuncio di classe del servizio RnR, esempio di codice
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104220939"
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="ce484-105">Codice di esempio per l'installazione di una classe del servizio RnR</span><span class="sxs-lookup"><span data-stu-id="ce484-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="ce484-106">Il programma seguente installa una classe del servizio RnR.</span><span class="sxs-lookup"><span data-stu-id="ce484-106">The following program installs an RnR Service class.</span></span>
