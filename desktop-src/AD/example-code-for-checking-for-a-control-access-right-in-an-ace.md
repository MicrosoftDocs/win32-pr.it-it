---
title: Codice di esempio per la verifica dell'accesso a un controllo a destra in una voce ACE
description: Nell'esempio di codice C++ riportato di seguito viene verificato un diritto di accesso al controllo specificato in una voce ACE nell'ACL dell'oggetto specificato.
ms.assetid: 03a96c99-eefb-4de5-a4ab-526eca7875cc
ms.tgt_platform: multiple
keywords:
- Codice di esempio per la verifica di un diritto di accesso di controllo in un annuncio ACE
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044125"
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a><span data-ttu-id="e5b82-104">Codice di esempio per la verifica dell'accesso a un controllo a destra in una voce ACE</span><span class="sxs-lookup"><span data-stu-id="e5b82-104">Example Code for Checking for a Control Access Right in an ACE</span></span>

<span data-ttu-id="e5b82-105">Nell'esempio di codice C++ riportato di seguito viene verificato un diritto di accesso al controllo specificato in una voce ACE nell'ACL dell'oggetto specificato.</span><span class="sxs-lookup"><span data-stu-id="e5b82-105">The following C++ code example verifies a specified control access right in an ACE in the ACL of the specified object.</span></span>
