...
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a>Codice di esempio per la verifica dell'accesso a un controllo a destra in una voce ACE

Nell'esempio di codice C++ riportato di seguito viene verificato un diritto di accesso al controllo specificato in una voce ACE nell'ACL dell'oggetto specificato.
