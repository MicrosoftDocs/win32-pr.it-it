...
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a><span data-ttu-id="28c13-104">Codice di esempio per la verifica dell'accesso a un controllo a destra nell'ACL di un oggetto</span><span class="sxs-lookup"><span data-stu-id="28c13-104">Example Code for Checking a Control Access Right in an Object's ACL</span></span>

<span data-ttu-id="28c13-105">L'esempio seguente può essere usato per verificare che l'utente attualmente connesso disponga delle autorizzazioni per un controllo di accesso Right sull'oggetto specificato.</span><span class="sxs-lookup"><span data-stu-id="28c13-105">The following example can be used to verify that the currently logged-on user has permissions for a control access right on the specified object.</span></span>
