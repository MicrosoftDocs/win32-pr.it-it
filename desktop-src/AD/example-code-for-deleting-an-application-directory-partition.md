...
---
# <a name="example-code-for-deleting-an-application-directory-partition"></a>Codice di esempio per l'eliminazione di una partizione di directory applicativa

L'esempio di codice C++ seguente può essere utilizzato per eliminare una partizione di directory applicativa utilizzando ADSI. Questo esempio usa una delle funzioni di esempio **GetPartitionsDN \*** descritte nel [codice di esempio per l'individuazione del contenitore di partizioni](example-code-for-locating-the-partitions-container.md).
...
Il seguente esempio di codice di Visual Basic Scripting Edition può essere utilizzato per eliminare una partizione di directory applicativa utilizzando ADSI. Questo esempio usa una delle funzioni di esempio **GetPartitionsDN \*** descritte nel [codice di esempio per l'individuazione del contenitore di partizioni](example-code-for-locating-the-partitions-container.md).
...
L'esempio di codice C# seguente può essere utilizzato per eliminare una partizione di directory applicativa utilizzando [System. DirectoryServices](/dotnet/api/system.directoryservices). Questo esempio usa una delle funzioni di esempio **GetPartitionsDN \*** descritte nel [codice di esempio per l'individuazione del contenitore di partizioni](example-code-for-locating-the-partitions-container.md).
...
Il seguente Visual Basic esempio di codice .NET può essere usato per eliminare una partizione di directory applicativa usando [System. DirectoryServices](/dotnet/api/system.directoryservices). Questo esempio usa una delle funzioni di esempio **GetPartitionsDN \*** descritte nel [codice di esempio per l'individuazione del contenitore di partizioni](example-code-for-locating-the-partitions-container.md).
