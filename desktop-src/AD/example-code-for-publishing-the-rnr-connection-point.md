---
title: Codice di esempio per la pubblicazione del punto di connessione RnR
description: L'esempio di codice seguente viene usato dal servizio Winsock per registrare il punto di connessione RnR per il servizio.
ms.assetid: dd2c7ac9-76fc-4366-8654-8048e6793a16
ms.tgt_platform: multiple
keywords:
- Codice di esempio per la pubblicazione del punto di connessione di RnR AD
- Active Directory per la registrazione e la risoluzione di Windows Sockets, codice di esempio, pubblicazione del punto di connessione RnR
- Pubblicazione del punto di connessione di RnR AD, codice di esempio
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104220937"
---
# <a name="example-code-for-publishing-the-rnr-connection-point"></a><span data-ttu-id="8f309-106">Codice di esempio per la pubblicazione del punto di connessione RnR</span><span class="sxs-lookup"><span data-stu-id="8f309-106">Example Code for Publishing the RnR Connection Point</span></span>

<span data-ttu-id="8f309-107">L'esempio di codice seguente viene usato dal servizio Winsock per registrare il punto di connessione RnR per il servizio.</span><span class="sxs-lookup"><span data-stu-id="8f309-107">The following code example is used by the Winsock service to register the RnR connection point for the service.</span></span>
