---
title: Codice di esempio per la creazione di un oggetto contenitore
description: Nell'esempio di codice seguente vengono creati due oggetti.
ms.assetid: bd9a8d62-c8e8-4ee5-86d8-bda5ddeb6e2c
ms.tgt_platform: multiple
keywords:
- Esempi di Active Directory Active Directory, creazione di un oggetto contenitore
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103956333"
---
# <a name="example-code-for-creating-a-container-object"></a><span data-ttu-id="14407-104">Codice di esempio per la creazione di un oggetto contenitore</span><span class="sxs-lookup"><span data-stu-id="14407-104">Example Code for Creating a Container Object</span></span>

<span data-ttu-id="14407-105">Nell'esempio di codice seguente vengono creati due oggetti.</span><span class="sxs-lookup"><span data-stu-id="14407-105">The following code example creates two objects.</span></span> <span data-ttu-id="14407-106">Per prima cosa, un oggetto contenitore e, secondo, un oggetto contenitore secondario.</span><span class="sxs-lookup"><span data-stu-id="14407-106">First, a container object and, second, a sub-container object.</span></span> <span data-ttu-id="14407-107">Un valore per l'oggetto contenitore secondario viene aggiunto alla proprietà [**otherWellKnownObjects archiviato nel**](/windows/desktop/ADSchema/a-otherwellknownobjects) dell'oggetto contenitore.</span><span class="sxs-lookup"><span data-stu-id="14407-107">A value for the sub-container object is added to the [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) property of the container object.</span></span> <span data-ttu-id="14407-108">L'esempio di codice viene associato all'oggetto sottocontenitore usando l'associazione WKGUID e ne Visualizza il ADsPath.</span><span class="sxs-lookup"><span data-stu-id="14407-108">The code example binds to the sub-container object using the WKGUID binding and displays its ADsPath.</span></span> <span data-ttu-id="14407-109">Viene quindi rinominato l'oggetto del sottocontenitore e associato nuovamente utilizzando la stessa associazione WKGUID.</span><span class="sxs-lookup"><span data-stu-id="14407-109">It then renames the sub-container object and binds again using the same WKGUID binding.</span></span>
