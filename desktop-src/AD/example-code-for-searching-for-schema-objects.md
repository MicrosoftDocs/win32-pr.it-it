...
---
# <a name="example-code-for-searching-for-schema-objects"></a><span data-ttu-id="a54f9-104">Codice di esempio per la ricerca di oggetti dello schema</span><span class="sxs-lookup"><span data-stu-id="a54f9-104">Example Code for Searching for Schema Objects</span></span>

<span data-ttu-id="a54f9-105">In questo argomento è incluso un esempio di codice utilizzato per cercare gli oggetti dello schema.</span><span class="sxs-lookup"><span data-stu-id="a54f9-105">This topic includes a code example used to search for schema objects.</span></span>

<span data-ttu-id="a54f9-106">Nell'esempio di codice C++ riportato di seguito viene illustrato come cercare oggetti dello schema con bit impostati nell'attributo **systemFlags** .</span><span class="sxs-lookup"><span data-stu-id="a54f9-106">The following C++ code example shows how to search for schema objects that have bits set in the **systemFlags** attribute.</span></span>
...
<span data-ttu-id="a54f9-107">Nell'esempio di codice C e C++ riportato di seguito viene illustrato come cercare gli oggetti dello schema replicati nel catalogo globale.</span><span class="sxs-lookup"><span data-stu-id="a54f9-107">The following C and C++ code example shows how to search for schema objects replicated to the global catalog.</span></span>
...
<span data-ttu-id="a54f9-108">Nell'esempio di codice C e C++ riportato di seguito viene illustrato come cercare oggetti dello schema indicizzati.</span><span class="sxs-lookup"><span data-stu-id="a54f9-108">The following C and C++ code example shows how to search for indexed schema objects.</span></span>
