---
title: Codice di esempio per la creazione di un attributo
description: Nell'esempio di codice seguente viene creato un oggetto attributeSchema nel contenitore dello schema.
...
---
# <a name="example-code-for-creating-an-attribute"></a><span data-ttu-id="b0e38-104">Codice di esempio per la creazione di un attributo</span><span class="sxs-lookup"><span data-stu-id="b0e38-104">Example Code for Creating an Attribute</span></span>

<span data-ttu-id="b0e38-105">Nell'esempio di codice seguente viene creato un oggetto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) nel contenitore dello schema.</span><span class="sxs-lookup"><span data-stu-id="b0e38-105">The following code example creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container.</span></span>

<span data-ttu-id="b0e38-106">La funzione **CreateAttribute** crea un oggetto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) nel contenitore dello schema, ma non esegue il commit nella directory.</span><span class="sxs-lookup"><span data-stu-id="b0e38-106">The **CreateAttribute** function creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container, but does not commit it to the directory.</span></span> <span data-ttu-id="b0e38-107">Chiamare il metodo [**IADs. seinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) per eseguire il commit del nuovo oggetto **attributeSchema** nella directory.</span><span class="sxs-lookup"><span data-stu-id="b0e38-107">Call the [**IADs.SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) method to commit the new **attributeSchema** object to the directory.</span></span>

<span data-ttu-id="b0e38-108">La funzione **BytesToVariantArray** è una funzione di utilità che comprime una stringa ottetto in una matrice Variant.</span><span class="sxs-lookup"><span data-stu-id="b0e38-108">The **BytesToVariantArray** function is a utility function that packs an octet string into a variant array.</span></span>
