---
title: Codice di esempio per la creazione di un utente
description: Questo argomento include esempi di codice che creano un utente in un dominio controllato da Active Directory Domain Services.
...
ms.locfileid: "104044122"
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="4c4c8-104">Codice di esempio per la creazione di un utente</span><span class="sxs-lookup"><span data-stu-id="4c4c8-104">Example Code for Creating a User</span></span>

<span data-ttu-id="4c4c8-105">Questo argomento include esempi di codice che creano un utente in un dominio controllato da Active Directory Domain Services.</span><span class="sxs-lookup"><span data-stu-id="4c4c8-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
