...
---
# <a name="example-code-for-creating-a-user"></a>Codice di esempio per la creazione di un utente

Questo argomento include esempi di codice che creano un utente in un dominio controllato da Active Directory Domain Services.
