...
keywords:
- Esempi di Active Directory Active Directory, creazione di utenti in un server membro o Windows 2000 Professional
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
---
# <a name="example-code-for-creating-users-on-a-member-server-or-windows-2000-professional"></a><span data-ttu-id="2286a-104">Codice di esempio per la creazione di utenti in un server membro o in Windows 2000 Professional</span><span class="sxs-lookup"><span data-stu-id="2286a-104">Example Code for Creating Users on a Member Server or Windows 2000 Professional</span></span>

<span data-ttu-id="2286a-105">Nell'esempio di codice seguente Visual Basic viene creato un utente in un server membro o in Windows 2000 Professional.</span><span class="sxs-lookup"><span data-stu-id="2286a-105">The following Visual Basic code example creates a user on a member server or Windows 2000 Professional.</span></span>
