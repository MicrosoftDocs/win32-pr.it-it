---
description: 'Esempio di applicazione delle impostazioni di sistema MUI:'
ms.assetid: 34cfd3a8-20b2-4a57-bc43-8da410cf9ae9
title: 'Esempio di applicazione delle impostazioni di sistema MUI:'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106308691"
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="373fb-103">Esempio di applicazione delle impostazioni di sistema MUI:</span><span class="sxs-lookup"><span data-stu-id="373fb-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="373fb-104">L'applicazione di esempio descritta in questo argomento è una semplice applicazione Hello MUI che supporta le impostazioni di sistema per le lingue dell'interfaccia utente.</span><span class="sxs-lookup"><span data-stu-id="373fb-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
