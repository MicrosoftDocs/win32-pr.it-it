...
Specifica se il profilo è il profilo predefinito.

Per informazioni più dettagliate su questo elemento, vedere la documentazione V1 per [**IsDefault**](./schema-isdefault-mbnprofile-element.md).
