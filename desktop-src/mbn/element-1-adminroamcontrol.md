...
Specifica se il profilo è controllato dal roaming amministrativo. Questo elemento è nuovo per la versione 4. Il valore di questo elemento è un [**valore roamControlType.**](simpletype-roamcontroltype.md) Si tratta di un elemento facoltativo. se non viene specificato alcun valore, l'impostazione predefinita **è AllRoamAllowed.**
