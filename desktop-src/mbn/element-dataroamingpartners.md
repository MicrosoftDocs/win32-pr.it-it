...
Per informazioni dettagliate, vedere la documentazione per l'elemento V1 [**DataRoamingPartners**](./schema-dataroamingpartners-mbnprofile-element.md) .
...
<p>Il valore di questo elemento è un'istanza del tipo complesso V1 <a href="../mbn/schema-providertype-complextype.md"><strong>ProviderType</strong></a> .</p></td>
</tr>
</tbody>
</table>
