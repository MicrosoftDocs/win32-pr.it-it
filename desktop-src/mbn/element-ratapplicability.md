---
description: APPLICAZIONE DI BASEApplicità
MS-HAID: WWAN\_profile\_v4.element\_RATApplicability
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: APPLICAZIONE DI BASEApplicità
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "122880481"
---
# <a name="span-idwwan_profile_v4element_ratapplicabilityspanratapplicability"></a><span id="WWAN_profile_v4.element_RATApplicability"></span>APPLICAZIONE DI BASEApplicità

Specifica che questo profilo è attivo solo quando il tipo RAT è quello specificato. In caso contrario, il profilo non è applicabile e non può essere usato per attivare un contesto PDP (Packet Data Protocol).

## <a name="element-hierarchy"></a>Gerarchia degli elementi

[&lt;MBNProfileExt&gt;](element-mbnprofileext.md)  
[&lt;ProfileConditionedOn&gt;](element-profileconditionedon.md)  
**&lt;APPLICAZIONE DI BASEApplicità&gt;**
