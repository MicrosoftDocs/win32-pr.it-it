...
Per altre informazioni su questo elemento, vedere la documentazione relativa all'elemento [**ProfileCreationType**](./schema-profilecreationtype-mbnprofile-element.md) v1.
