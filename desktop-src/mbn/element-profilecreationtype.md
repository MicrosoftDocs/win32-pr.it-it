...
Per ulteriori informazioni su questo elemento, vedere la documentazione relativa all'elemento V1 [**ProfileCreationType**](./schema-profilecreationtype-mbnprofile-element.md) .
