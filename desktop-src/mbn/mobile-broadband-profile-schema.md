...
---
# <a name="mobile-broadband-profile-schema-v1"></a><span data-ttu-id="98a09-103">Schema profilo broadband mobile V1</span><span class="sxs-lookup"><span data-stu-id="98a09-103">Mobile Broadband Profile Schema v1</span></span>

<span data-ttu-id="98a09-104">Nello spazio dei nomi è disponibile lo schema del profilo a banda larga 7Mobile Windows V1 `https://www.microsoft.com/networking/WWAN/profile/v1` .</span><span class="sxs-lookup"><span data-stu-id="98a09-104">The Windows 7Mobile Broadband Profile Schema v1 is available in the namespace `https://www.microsoft.com/networking/WWAN/profile/v1`.</span></span>

-   [<span data-ttu-id="98a09-105">Elementi del profilo di Mobile Broadband schema v1</span><span class="sxs-lookup"><span data-stu-id="98a09-105">Mobile Broadband Profile Schema v1 Elements</span></span>](schema-elements.md)
-   [<span data-ttu-id="98a09-106">Tipi semplici dello schema profilo a banda larga mobile V1</span><span class="sxs-lookup"><span data-stu-id="98a09-106">Mobile Broadband Profile Schema v1 Simple Types</span></span>](schema-simple-types.md)
-   [<span data-ttu-id="98a09-107">Tipi complessi dello schema profilo broadband mobile V1</span><span class="sxs-lookup"><span data-stu-id="98a09-107">Mobile Broadband Profile Schema v1 Complex Types</span></span>](schema-complex-types.md)
