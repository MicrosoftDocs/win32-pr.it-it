...
---
# <a name="mobile-broadband-profile-schema-v2"></a>Schema del profilo broadband mobile V2

Lo schema del profilo a banda larga 8Mobile di Windows V2 è disponibile nello spazio dei nomi `https://www.microsoft.com/networking/WWAN/profile/v2` .

-   [Elementi del profilo Mobile Broadband schema V2](mobile-broadband-profile-schema-v2-elements.md)
