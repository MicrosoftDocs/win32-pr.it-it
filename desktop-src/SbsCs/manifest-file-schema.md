---
description: Di seguito è riportato l'elenco completo dello schema del file manifesto.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Schema file manifesto
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106322033"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="34c9a-103">Schema file manifesto</span><span class="sxs-lookup"><span data-stu-id="34c9a-103">Manifest File Schema</span></span>

<span data-ttu-id="34c9a-104">Di seguito è riportato l'elenco completo dello schema del file manifesto.</span><span class="sxs-lookup"><span data-stu-id="34c9a-104">The following is the complete listing of the manifest file schema.</span></span>
