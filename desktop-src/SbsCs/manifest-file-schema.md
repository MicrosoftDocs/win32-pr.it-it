...
title: Schema del file manifesto
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119977351"
---
# <a name="manifest-file-schema"></a>Schema del file manifesto

Di seguito è riportato l'elenco completo dello schema del file manifesto.
