...
---
# <a name="application-configuration-file-schema"></a>Schema del file di configurazione dell'applicazione

Di seguito è riportato l'elenco completo dello schema del file di configurazione dell'applicazione.
