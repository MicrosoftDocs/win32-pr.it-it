...
Una finestra di dialogo **Apri** o **Salva con nome** invia il messaggio registrato **LBSELCHSTRING** alla routine hook quando la selezione viene modificata in una delle caselle di riepilogo o nelle caselle combinate della finestra di dialogo.
...
Identificatore della casella di riepilogo o casella combinata in cui è stata modificata la selezione.
...
La parola di ordine inferiore specifica il numero di elemento della stringa selezionata nella casella di riepilogo o nella casella combinata. La parola più ordinata specifica il tipo di modifica della selezione. Questo parametro può avere uno dei valori seguenti.
...
| <span id="CD_LBSELNOITEMS"></span><span id="cd_lbselnoitems"></span><dl> <dt>**CD \_ LBSELNOITEMS**</dt> <dt>-1</dt> </dl> | Nessun elemento presente in una casella di riepilogo a selezione multipla.<br/>                        |
...
La routine hook deve specificare la costante **LBSELCHSTRING** in una chiamata alla funzione [**RegisterWindowMessage**](/windows/desktop/api/winuser/nf-winuser-registerwindowmessagea) per ottenere l'identificatore del messaggio inviato dalla finestra di dialogo.
