...
---
# <a name="id3dxconstanttablesetvector-method"></a>Metodo ID3DXConstantTable:: sevector
...
Identificatore univoco della costante Vector. Vedere [D3DXHANDLE](dx9-graphics-reference-effects-constants.md).
