...
---
# <a name="id3dxconstanttablesetvector-method"></a>Metodo ID3DXConstantTable::SetVector
...
Identificatore univoco della costante vettore. Vedere [D3DXHANDLE](dx9-graphics-reference-effects-constants.md).
