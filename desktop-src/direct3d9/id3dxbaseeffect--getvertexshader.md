...
---
# <a name="id3dxbaseeffectgetvertexshader-method"></a>Metodo ID3DXBaseEffect:: GetVertexShader

Ottiene un vertex shader.
...
Restituisce un oggetto vertex shader. Vedere [**IDirect3DVertexShader9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dvertexshader9).
