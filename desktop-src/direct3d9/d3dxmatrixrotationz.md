...
---
# <a name="d3dxmatrixrotationz-function-d3dx9mathh"></a>Funzione D3DXMatrixRotationZ (D3dx9math.h)
...
Puntatore a [**una struttura D3DXMATRIX**](d3dxmatrix.md) ruotata intorno all'asse z.
