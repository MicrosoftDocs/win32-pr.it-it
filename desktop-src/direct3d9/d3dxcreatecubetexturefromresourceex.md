...
---
# <a name="d3dxcreatecubetexturefromresourceex-function"></a>D3DXCreateCubeTextureFromResourceEx (funzione)
...
**D3DXCreateCubeTextureFromResourceEx** usa il formato di file DirectDraw Surface (DDS). L'editor di trame DirectX (Dxtex.exe) consente di generare una mappa del cubo da altri formati di file e di salvarli nel formato di file DDS. È possibile ottenere Dxtex.exe e ottenere informazioni su di esso da DirectX SDK. Per informazioni su DirectX SDK, vedere [dove è DirectX SDK?](../directx-sdk--august-2009-.md).
