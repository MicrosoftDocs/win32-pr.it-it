---
description: Vedere un elenco di flag di funzionalità del driver D3DCAPS2. Include le definizioni, i valori e le descrizioni con collegamenti alle API.
...
<td>0x80000000L</td>
<td>Il dispositivo può creare risorse condivise. I metodi che creano risorse possono impostare valori non NULL per i <a href="/windows/desktop/api/dxgi/nf-dxgi-idxgiresource-getsharedhandle"><strong>relativi parametri pSharedHandle.</strong></a> 
<table>
<tbody>
<tr class="odd">
