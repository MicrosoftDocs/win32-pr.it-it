...
---
# <a name="d3dxcreatesphere-function"></a>D3DXCreateSphere (funzione)

Usa un sistema di coordinate a sinistra per creare una mesh contenente una sfera.
...
Puntatore a un'interfaccia [**IDirect3DDevice9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3ddevice9) , che rappresenta il dispositivo associato alla mesh della sfera creata.
...
Raggio della sfera. Questo valore deve essere maggiore o uguale a 0,0 f.
