...
title: Metodo ID3DXConstantTable::SetMatrix (D3DX9Shader.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118987561"
---
# <a name="id3dxconstanttablesetmatrix-method"></a>Metodo ID3DXConstantTable::SetMatrix
