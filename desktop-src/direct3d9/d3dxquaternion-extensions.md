...
---
# <a name="d3dxquaternion-extensions"></a>Estensioni D3DXQUATERNION

Fornisce i seguenti overload di operatore e cast di tipo per le strutture [**D3DXQUATERNION**](d3dxquaternion.md) .
...
Tipi derivati: \* LPD3DXQUATERNION

## <a name="remarks"></a>Commenti

Per ulteriori informazioni sui membri della struttura, fare riferimento a [**D3DXQUATERNION**](d3dxquaternion.md).
