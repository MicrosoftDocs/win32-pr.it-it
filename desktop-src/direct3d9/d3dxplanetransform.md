...
Puntatore alla struttura [**D3DXMATRIX di**](d3dxmatrix.md) origine, che contiene i valori della trasformazione. Questa matrice deve contenere la trasposizione inversa dei valori di trasformazione.
