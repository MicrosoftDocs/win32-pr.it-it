...
---
# <a name="id3dxtextureshadersetboolarray-method"></a>Metodo ID3DXTextureShader:: SetBoolArray

Imposta una matrice di valori BOOL.
...
Numero di valori BOOL nella matrice.
