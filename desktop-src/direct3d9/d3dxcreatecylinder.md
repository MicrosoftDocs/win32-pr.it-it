...
---
# <a name="d3dxcreatecylinder-function"></a>D3DXCreateCylinder (funzione)

Usa un sistema di coordinate a sinistra per creare una mesh contenente un cilindro.
...
Puntatore a un'interfaccia [**IDirect3DDevice9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3ddevice9) , che rappresenta il dispositivo associato alla mesh a cilindri creata.
...
Raggio all'estremità Z negativa. Il valore deve essere maggiore o uguale a 0,0 f.
...
Raggio al termine Z positivo. Il valore deve essere maggiore o uguale a 0,0 f.
...
Il cilindro creato è centrato sull'origine e il relativo asse è allineato all'asse z.
