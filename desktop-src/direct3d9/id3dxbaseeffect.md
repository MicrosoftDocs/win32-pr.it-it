...
L'interfaccia **ID3DXBaseEffect** eredita dall'interfaccia [**IUnknown**](/windows/win32/api/unknwn/nn-unknwn-iunknown) . **ID3DXBaseEffect** dispone anche di questi tipi di membri:

-   [Metodi](#methods)

### <a name="methods"></a>Metodi

L'interfaccia **ID3DXBaseEffect** dispone di questi metodi.
...
| [**GetInt**](id3dxbaseeffect--getint.md)                                                 | Ottiene un intero.<br/>                                                                                                                                                                                                       |
| [**GetIntArray**](id3dxbaseeffect--getintarray.md)                                       | Ottiene una matrice di numeri interi.<br/>                                                                                                                                                                                             |
| [**GetMatrix**](id3dxbaseeffect--getmatrix.md)                                           | Ottiene una matrice nontransposed.<br/>                                                                                                                                                                                           |
| [**GetMatrixArray**](id3dxbaseeffect--getmatrixarray.md)                                 | Ottiene una matrice di matrici nontransposed.<br/>                                                                                                                                                                               |
| [**GetMatrixPointerArray**](id3dxbaseeffect--getmatrixpointerarray.md)                   | Ottiene una matrice di puntatori alle matrici nontransposed.<br/>                                                                                                                                                                   |
...
| [**GetParameter**](id3dxbaseeffect--getparameter.md)                                     | Ottiene l'handle di un parametro di primo livello o di un parametro del membro della struttura.<br/>                                                                                                                                              |
| [**GetParameterByName**](id3dxbaseeffect--getparameterbyname.md)                         | Ottiene l'handle di un parametro di primo livello o di un parametro del membro della struttura cercandone il nome.<br/>                                                                                                                       |
| [**GetParameterBySemantic**](id3dxbaseeffect--getparameterbysemantic.md)                 | Ottiene l'handle di un parametro di primo livello o di un parametro del membro della struttura cercando la relativa semantica con una ricerca senza distinzione tra maiuscole e minuscole.<br/>                                                                                    |
| [**GetParameterDesc**](id3dxbaseeffect--getparameterdesc.md)                             | Ottiene una descrizione del parametro o dell'annotazione.<br/>                                                                                                                                                                            |
...
| [**GetPassByName**](id3dxbaseeffect--getpassbyname.md)                                   | Ottiene l'handle di un oggetto pass cercandone il nome.<br/>                                                                                                                                                                      |
...
| [**GetTechniqueDesc**](id3dxbaseeffect--gettechniquedesc.md)                             | Ottiene una descrizione di tecnica.<br/>                                                                                                                                                                                          |
| [**GetTexture**](id3dxbaseeffect--gettexture.md)                                         | Ottiene una trama.<br/>                                                                                                                                                                                                        |
| [**GetValue**](id3dxbaseeffect--getvalue.md)                                             | Ottenere il valore di un parametro o di un'annotazione arbitraria, inclusi tipi semplici, struct, matrici, stringhe, shader e trame. Questo metodo può essere utilizzato al posto di quasi tutte le chiamate GetXXX in **ID3DXBaseEffect**.<br/> |
...
| [**SetArrayRange**](id3dxbaseeffect--setarrayrange.md)                                   | Consente di impostare l'intervallo di una matrice da passare al dispositivo.<br/>                                                                                                                                                                       |
| [**DiBOOL**](id3dxbaseeffect--setbool.md)                                               | Imposta un valore BOOL.<br/>                                                                                                                                                                                                     |
...
| [**SetInt**](id3dxbaseeffect--setint.md)                                                 | Imposta un valore integer.<br/>                                                                                                                                                                                                       |
| [**SetIntArray**](id3dxbaseeffect--setintarray.md)                                       | Imposta una matrice di numeri interi.<br/>                                                                                                                                                                                             |
| [**Sematrix**](id3dxbaseeffect--setmatrix.md)                                           | Imposta una matrice non trasposta.<br/>                                                                                                                                                                                          |
| [**SetMatrixArray**](id3dxbaseeffect--setmatrixarray.md)                                 | Imposta una matrice di matrici nontransposed.<br/>                                                                                                                                                                               |
| [**SetMatrixPointerArray**](id3dxbaseeffect--setmatrixpointerarray.md)                   | Imposta una matrice di puntatori alle matrici nontransposed.<br/>                                                                                                                                                                   |
...
| [**Sevector**](id3dxbaseeffect--setvector.md)                                           | Imposta un vettore.<br/>                                                                                                                                                                                                         |
