...
I dati della faccia mesh restituiti da questo metodo sono validi solo per texel validi (non di classe 0). [**ID3DXTextureGutterHelper::GetGutterMap**](id3dxtexturegutterhelper--getguttermap.md) restituirà valori diversi da zero per i texel validi (non di classe 0).

Per [**i texel della classe 2,**](id3dxtexturegutterhelper.md)questo metodo recupera il viso più vicino.
