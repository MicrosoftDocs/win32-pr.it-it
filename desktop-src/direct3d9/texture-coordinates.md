...
Le coordinate di trama sono associate alle trame tramite le fasi della trama. Le trame vengono assegnate alle fasi della trama con SetTexture(stageIndex, pTexture). Vedere [**IDirect3DDevice9::SetTexture**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-settexture).
