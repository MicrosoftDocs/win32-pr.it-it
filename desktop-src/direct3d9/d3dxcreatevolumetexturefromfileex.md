---
description: 'Funzione D3DXCreateVolumeTextureFromFileEx: crea una trama di volume da un file.'
...
L'impostazione del compilatore determina anche la versione della funzione. Se unicode è definito, la chiamata di funzione viene risolta in D3DXCreateVolumeTextureFromFileExW. In caso contrario, la chiamata di funzione viene risolta in D3DXCreateVolumeTextureFromFileExA perché vengono usate stringhe ANSI.
