...
Un dispositivo hardware che esegue l'elaborazione dei vertici e supporta gli sprite punto - MaxPointSize impostato su un valore maggiore di 1,0f - è necessario per eseguire il calcolo delle dimensioni per gli sprite non trasformati ed è necessario impostare correttamente il valore per vertice o D3DRS \_ POINTSIZED3DRS POINTSIZE per \_ i vertici TL.
