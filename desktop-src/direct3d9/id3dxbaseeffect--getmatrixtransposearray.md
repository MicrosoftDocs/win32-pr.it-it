...
---
# <a name="id3dxbaseeffectgetmatrixtransposearray-method"></a>Metodo ID3DXBaseEffect:: GetMatrixTransposeArray

Ottiene una matrice di matrici trasposte.
...
Restituisce una matrice di matrici trasposte. Vedere [**D3DXMATRIX**](d3dxmatrix.md).
