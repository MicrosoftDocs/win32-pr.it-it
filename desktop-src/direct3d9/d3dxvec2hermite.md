...
Puntatore a una struttura [**D3DXVECTOR2**](d3dxvector2.md) di origine, un vettore di posizione.
...
Puntatore a una struttura [**D3DXVECTOR2**](d3dxvector2.md) di origine, un vettore tangente.
...
Puntatore a una struttura [**D3DXVECTOR2**](d3dxvector2.md) che è il risultato dell'interpolazione della spline eremita.
