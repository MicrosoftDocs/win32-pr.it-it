---
description: Converte il subset di mesh specificato in una singola striscia triangolare.
...
ms.locfileid: "119857371"
---
# <a name="d3dxconvertmeshsubsettosinglestrip-function"></a>Funzione D3DXConvertMeshSubsetToSingleStrip

Converte il subset di mesh specificato in una singola striscia triangolare.
...
Puntatore a [**un'interfaccia IDirect3DIndexBuffer9,**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dindexbuffer9) che rappresenta il index buffer contenente la striscia.
