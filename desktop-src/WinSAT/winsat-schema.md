...
---
# <a name="winsat-schema"></a><span data-ttu-id="52480-103">Schema WinSAT</span><span class="sxs-lookup"><span data-stu-id="52480-103">WinSAT Schema</span></span>

<span data-ttu-id="52480-104">\[Le enumerazioni WinSAT possono essere modificate o non disponibili per le versioni dopo Windows 8.1.\]</span><span class="sxs-lookup"><span data-stu-id="52480-104">\[WinSAT enumerations may be altered or unavailable for releases after Windows 8.1.\]</span></span>

<span data-ttu-id="52480-105">È possibile utilizzare lo schema Windows System Assessment Tool (WinSAT) per determinare le query XPath valide da eseguire.</span><span class="sxs-lookup"><span data-stu-id="52480-105">You can use the Windows System Assessment Tool (WinSAT) schema to determine valid XPath queries to run.</span></span> <span data-ttu-id="52480-106">Per eseguire una query XPath, vedere uno dei metodi seguenti:</span><span class="sxs-lookup"><span data-stu-id="52480-106">To run an XPath query, see one of the following methods:</span></span>

-   [<span data-ttu-id="52480-107">**IQueryAllWinSATAssessments:: Get \_ AllXML**</span><span class="sxs-lookup"><span data-stu-id="52480-107">**IQueryAllWinSATAssessments::get\_AllXML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml)
-   [<span data-ttu-id="52480-108">**IQueryRecentWinSATAssessment:: Get \_ XML**</span><span class="sxs-lookup"><span data-stu-id="52480-108">**IQueryRecentWinSATAssessment::get\_XML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryrecentwinsatassessment-get_xml)

<span data-ttu-id="52480-109">L'elemento **WinSAT** può avere un elemento **WinsatAssessments** come elemento padre quando si chiama il metodo [**get \_ AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) .</span><span class="sxs-lookup"><span data-stu-id="52480-109">The **WinSAT** element can have a **WinsatAssessments** element as a parent element when you call the [**get\_AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) method.</span></span>

<span data-ttu-id="52480-110">Di seguito è riportato lo schema WinSAT che è possibile utilizzare per determinare l'XPath.</span><span class="sxs-lookup"><span data-stu-id="52480-110">The following is the WinSAT schema that you can use to determine the XPath.</span></span>
