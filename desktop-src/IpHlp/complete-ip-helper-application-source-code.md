...
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="330bd-104">Codice sorgente completo dell'applicazione helper IP</span><span class="sxs-lookup"><span data-stu-id="330bd-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="330bd-105">Di seguito è riportato il codice sorgente completo per l'applicazione helper IP.</span><span class="sxs-lookup"><span data-stu-id="330bd-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="330bd-106">Il controllo degli errori aggiuntivo è stato aggiunto al codice sorgente.</span><span class="sxs-lookup"><span data-stu-id="330bd-106">Additional error checking has been added to source code.</span></span>
