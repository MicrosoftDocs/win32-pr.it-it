...
description: Le classi di monitoraggio di sistema (SYSMON) utilizzano le enumerazioni seguenti.
...
ms.locfileid: "104336530"
---
# <a name="sysmon-enumerations"></a>Enumerazioni SYSMON

Le [classi](sysmon-classes.md) di monitoraggio di sistema (Sysmon) utilizzano le enumerazioni seguenti.
