---
title: Enumerazioni SYSMON
description: Le classi di Monitoraggio di sistema (SYSMON) usano le enumerazioni seguenti.
...
ms.locfileid: "118883129"
---
# <a name="sysmon-enumerations"></a>Enumerazioni SYSMON

Le classi di Monitoraggio [](sysmon-classes.md) di sistema (SYSMON) usano le enumerazioni seguenti.

-   [**DataSourceTypeConstants**](/windows/win32/api/isysmon/ne-isysmon-datasourcetypeconstants)
-   [**Proprietà DisplayTypeConstants**](/windows/win32/api/isysmon/ne-isysmon-displaytypeconstants)
