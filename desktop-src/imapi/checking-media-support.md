---
title: Verifica del supporto multimediale
description: Lo script seguente esamina le caratteristiche dei supporti caricati nel dispositivo disco.
...
ms.locfileid: "104221271"
---
# <a name="checking-media-support"></a><span data-ttu-id="8f3ef-103">Verifica del supporto multimediale</span><span class="sxs-lookup"><span data-stu-id="8f3ef-103">Checking Media Support</span></span>

<span data-ttu-id="8f3ef-104">Lo script seguente esamina le caratteristiche dei supporti caricati nel dispositivo disco.</span><span class="sxs-lookup"><span data-stu-id="8f3ef-104">The following script examines characteristics of the media loaded in the disc device.</span></span> <span data-ttu-id="8f3ef-105">In particolare, controlla il tipo di supporto e lo stato corrente del supporto, nonché la registrazione e la compatibilità dei supporti.</span><span class="sxs-lookup"><span data-stu-id="8f3ef-105">More specifically, it checks the media type and the current state of the media, as well as recorder and media compatibility.</span></span> <span data-ttu-id="8f3ef-106">Questo script può essere adattato per verificare la compatibilità e i problemi di stato prima di usare il supporto.</span><span class="sxs-lookup"><span data-stu-id="8f3ef-106">This script can be adapted to verify compatibility and state issues before using the media.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8f3ef-107">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="8f3ef-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8f3ef-108">Uso di IMAPi</span><span class="sxs-lookup"><span data-stu-id="8f3ef-108">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="8f3ef-109">**\_tipo fisico del supporto IMAPI \_ \_**</span><span class="sxs-lookup"><span data-stu-id="8f3ef-109">**IMAPI\_MEDIA\_PHYSICAL\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_media_physical_type)
</dt> <dt>

[<span data-ttu-id="8f3ef-110">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="8f3ef-110">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="8f3ef-111">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="8f3ef-111">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="8f3ef-112">**IDiscFormat2Data**</span><span class="sxs-lookup"><span data-stu-id="8f3ef-112">**IDiscFormat2Data**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscformat2data)
</dt> </dl>
