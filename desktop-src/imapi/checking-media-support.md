...
---
# <a name="checking-media-support"></a>Verifica del supporto multimediale

Lo script seguente esamina le caratteristiche dei supporti caricati nel dispositivo disco. In particolare, controlla il tipo di supporto e lo stato corrente del supporto, nonché la registrazione e la compatibilità dei supporti. Questo script può essere adattato per verificare la compatibilità e i problemi di stato prima di usare il supporto.
