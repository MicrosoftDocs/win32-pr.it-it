---
title: Codice di esempio per l'uso di una ricerca VLV
description: Questo argomento contiene esempi di codice C++ da usare per eseguire una ricerca VLV.
...
---
# <a name="example-code-for-using-a-vlv-search"></a><span data-ttu-id="a534d-104">Codice di esempio per l'uso di una ricerca VLV</span><span class="sxs-lookup"><span data-stu-id="a534d-104">Example Code for Using a VLV Search</span></span>

<span data-ttu-id="a534d-105">Gli esempi di codice seguenti usano le ricerche VLV per ottenere i risultati della ricerca.</span><span class="sxs-lookup"><span data-stu-id="a534d-105">The following code examples use VLV searches to obtain search results.</span></span>

-   <span data-ttu-id="a534d-106">**GetVLVItemCount**</span><span class="sxs-lookup"><span data-stu-id="a534d-106">**GetVLVItemCount**</span></span>
-   <span data-ttu-id="a534d-107">**GetVLVItemText**</span><span class="sxs-lookup"><span data-stu-id="a534d-107">**GetVLVItemText**</span></span>
-   <span data-ttu-id="a534d-108">**GetVLVItemsByString**</span><span class="sxs-lookup"><span data-stu-id="a534d-108">**GetVLVItemsByString**</span></span>

## <a name="utility-functions"></a><span data-ttu-id="a534d-109">Funzioni di utilità</span><span class="sxs-lookup"><span data-stu-id="a534d-109">Utility Functions</span></span>

<span data-ttu-id="a534d-110">Gli esempi di codice seguenti vengono usati dalle funzioni di esempio in questo argomento.</span><span class="sxs-lookup"><span data-stu-id="a534d-110">The following code examples are used by the example functions in this topic.</span></span>
...
## <a name="getvlvitemcount-example-function"></a><span data-ttu-id="a534d-111">Funzione di esempio GetVLVItemCount</span><span class="sxs-lookup"><span data-stu-id="a534d-111">GetVLVItemCount Example Function</span></span>

<span data-ttu-id="a534d-112">Nell'esempio di codice seguente viene illustrato come utilizzare una ricerca VLV per ottenere una stima del numero di elementi risultante dalla ricerca.</span><span class="sxs-lookup"><span data-stu-id="a534d-112">The following code example shows how to use a VLV search to obtain an estimate of the number of items that would result from the search.</span></span>
...
## <a name="getvlvitemtext-example-function"></a><span data-ttu-id="a534d-113">Funzione di esempio GetVLVItemText</span><span class="sxs-lookup"><span data-stu-id="a534d-113">GetVLVItemText Example Function</span></span>

<span data-ttu-id="a534d-114">Nell'esempio di codice seguente viene illustrato come utilizzare una ricerca VLV per ottenere il testo per un singolo elemento in base a un indice.</span><span class="sxs-lookup"><span data-stu-id="a534d-114">The following code example shows how to use a VLV search to obtain the text for a single item based on an index.</span></span>
...
## <a name="getvlvitemsbystring-example-function"></a><span data-ttu-id="a534d-115">Funzione di esempio GetVLVItemsByString</span><span class="sxs-lookup"><span data-stu-id="a534d-115">GetVLVItemsByString Example Function</span></span>

<span data-ttu-id="a534d-116">Nell'esempio di codice seguente viene illustrato come utilizzare una ricerca VLV per ottenere il testo per un numero specificato di elementi in base a una stringa.</span><span class="sxs-lookup"><span data-stu-id="a534d-116">The following code example shows how to use a VLV search to obtain the text for a specified number of items based on a string.</span></span> <span data-ttu-id="a534d-117">In questo esempio vengono aggiunti gli ordinamenti recuperati a una casella di riepilogo.</span><span class="sxs-lookup"><span data-stu-id="a534d-117">This example will add the sortings retrieved to a list box.</span></span>
