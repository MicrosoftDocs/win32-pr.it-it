...
---
# <a name="iadsprintqueue-property-methods"></a>Metodi di proprietà IADsPrintQueue

I metodi di proprietà dell'interfaccia [**IADsPrintQueue**](/windows/desktop/api/Iads/nn-iads-iadsprintqueue) ottengono o impostano le proprietà descritte nella tabella seguente. Per altre informazioni, vedere [metodi della proprietà di interfaccia](interface-property-methods.md).
...
Percorso file system che punta alla pagina del banner utilizzata per separare i processi di stampa. Se è **null**, non viene utilizzata alcuna pagina di intestazione.
...
Descrizione testuale della coda di stampa.
...
SAFEARRAY di **BSTR** che contiene i nomi dei dispositivi di stampa in cui questa coda di stampa consente di eseguire lo spooling dei processi.
...
Stringa che fa riferimento al percorso mediante il quale è possibile accedere a una stampante condivisa.
...
Priorità della coda di processi dell'oggetto Printer per tutti i dispositivi connessi. Verranno elaborati per primi tutti i processi con priorità più alta.
...
Ora di inizio dell'elaborazione dei processi da parte della coda. La parte relativa alla data dell'ora viene ignorata.
...
Data e ora in cui la coda deve arrestare l'elaborazione dei processi.
...
| IID<br/>                      | IID \_ IADsPrintQueue è definito come B15160D0-1226-11CF-A985-00AA006BC149<br/>       |
