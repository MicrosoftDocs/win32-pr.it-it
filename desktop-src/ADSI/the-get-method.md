...
L'esempio di codice seguente è identico all'esempio precedente, ad eccezione del fatto che si accede **all'attributo distinguishedName** usando la notazione con punto.
...
Se nell'oggetto non è impostato un valore, il metodo [**IADs::Get**](/windows/desktop/api/Iads/nf-iads-iads-get) restituirà l'errore "Proprietà non trovata nella cache".
