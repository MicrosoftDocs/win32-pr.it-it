...
---
# <a name="adding-users-to-a-group"></a>Aggiunta di utenti a un gruppo

Joe worden, l'amministratore dell'organizzazione, ora aggiungerà Julie Bankert al gruppo di gestione. Per aggiungere un oggetto a un gruppo, usare il metodo [**IADsGroup. Add**](/windows/desktop/api/Iads/nf-iads-iadsgroup-add) .
...
[Creazione di un nuovo gruppo](creating-a-new-group.md)
</dt> </dl>
