...
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a><span data-ttu-id="58e54-105">Codice di esempio per la gamma con IDirectorySearch</span><span class="sxs-lookup"><span data-stu-id="58e54-105">Example Code for Ranging with IDirectorySearch</span></span>

<span data-ttu-id="58e54-106">Nell'esempio di codice riportato di seguito viene utilizzata la funzione Rang per recuperare i membri di un gruppo utilizzando l'interfaccia [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .</span><span class="sxs-lookup"><span data-stu-id="58e54-106">The following code example uses ranging to retrieve the members of a group using the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) interface.</span></span>
