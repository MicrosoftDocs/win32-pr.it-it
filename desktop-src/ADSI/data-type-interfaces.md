---
title: Interfacce dei tipi di dati
description: In questo argomento vengono elencate le interfacce ADSI che funzionano con tipi di dati diversi.
ms.assetid: b9cfd99e-f2df-4db0-ae94-889f7aacd92d
ms.tgt_platform: multiple
keywords:
- interfacce dei tipi di dati ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119082705"
---
# <a name="data-type-interfaces"></a>Interfacce dei tipi di dati

In questa sezione vengono descritte le interfacce dei tipi di dati seguenti:
