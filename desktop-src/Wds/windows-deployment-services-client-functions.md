...
|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| [*PFN \_ WdsCliCallback*](/windows/desktop/api/WdsClientAPI/nc-wdsclientapi-pfn_wdsclicallback)                                          | Messaggi di notifica dello stato di avanzamento e di errore durante il trasferimento di un file o di un'immagine.                                                              |
| [*PFN \_ WdsCliTraceFunction*](/windows/desktop/api/WdsClientAPI/nc-wdsclientapi-pfn_wdsclitracefunction)                                | Riceve i messaggi di debug dal client wds.                                                                                       |
...
| [**WdsCliCancelTransfer**](/windows/desktop/api/WdsClientAPI/nf-wdsclientapi-wdsclicanceltransfer)                                     | Annulla un'operazione di trasferimento di Servizi di distribuzione Windows.                                                                                                      |
| [**WdsCliClose**](/windows/desktop/api/WdsClientAPI/nf-wdsclientapi-wdscliclose)                                                       | Chiude un handle per una sessione o un'immagine di Servizi di distribuzione Windows e rilascia le risorse.                                                                      |
...
| [**WdsCliObtainDriverPackages**](/windows/desktop/api/WdsClientAPI/nf-wdsclientapi-wdscliobtaindriverpackages)                         | Ottiene da un'immagine wds, i pacchetti driver (file INF) che possono essere utilizzati nel computer.                                           |
...
| Funzione                                                             | Descrizione                                                                                                                                                    |
|----------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**WdsCliGetDriverQueryXml**](/windows/desktop/api/WdsClientAPI/nf-wdsclientapi-wdscligetdriverqueryxml)           | Genera una stringa XML che può essere utilizzata per eseguire query su un server WDS per i pacchetti driver. Disponibile a partire da Windows 8 e Windows Server 2012.               |
| [**WdsCliObtainDriverPackagesEx**](/windows/desktop/api/WdsClientAPI/nf-wdsclientapi-wdscliobtaindriverpackagesex) | Ottiene i pacchetti driver (file INF) applicabili al file XML di query del driver WDS specificato. Disponibile a partire da Windows 8 e Windows Server 2012. |
