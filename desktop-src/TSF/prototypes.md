...
---
# <a name="prototypes"></a><span data-ttu-id="90ddb-110">Prototipi</span><span class="sxs-lookup"><span data-stu-id="90ddb-110">Prototypes</span></span>

<span data-ttu-id="90ddb-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup)e [tf \_ RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) descritti in questo riferimento non sono definiti in file di intestazione o IDL.</span><span class="sxs-lookup"><span data-stu-id="90ddb-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup), and [TF\_RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) described in this reference are not defined in IDL or header files.</span></span> <span data-ttu-id="90ddb-112">Per ottenere il file di intestazione, è necessario che i prototipi seguenti siano conformi al compilatore MIDL.</span><span class="sxs-lookup"><span data-stu-id="90ddb-112">The following prototypes are needed to be complied by MIDL compiler to get the header file..</span></span>
