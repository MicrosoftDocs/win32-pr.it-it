...
keywords:
- Schema AD della classe ms-DFSR-Subscriber
- Schema AD della classe msDFSR-Subscriber
topic_type:
- apiref
api_name:
- ms-DFSR-Subscriber
...
ms.locfileid: "118959890"
---
# <a name="ms-dfsr-subscriber-class"></a>Classe ms-DFSR-Subscriber

Contiene l'appartenenza al computer locale di un gruppo di replica.
...
| Possibili superiori          | [**ms-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**Ms-DFSR-Extension**](a-msdfsr-extension.md)                             | Falso     | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falso     | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | Vero      | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falso     | [**In alto**](c-top.md)<br/> |
| [**Ms-DFSR-Options**](a-msdfsr-options.md)                                 | Falso     | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Vero      | **ms-DFSR-Subscriber**          |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | Falso     | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | Falso     | **ms-DFSR-Subscriber**          |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)          | Vero      | **ms-DFSR-Subscriber**          |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | Falso     | [**In alto**](c-top.md)<br/> |
...
La **classe ms-DFSR-Subscriber** fa parte del supporto del servizio Replica file system distribuito (DFS).
