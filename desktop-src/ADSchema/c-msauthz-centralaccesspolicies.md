...
- Schema AD della classe msAuthz-CentralAccessPolicies
topic_type:
- apiref
api_name:
...
ms.locfileid: "118959900"
---
# <a name="ms-authz-central-access-policies-class"></a>Classe ms-Authz-Central-Access-Policies

Un contenitore di questa classe può contenere oggetti Criteri di accesso centrale.
