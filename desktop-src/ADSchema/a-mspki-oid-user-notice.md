...
---
# <a name="ms-pki-oid-user-notice-attribute"></a>ms-PKI-OID-utente-avviso-attributo

Avviso dell'utente per il criterio dell'autorità di certificazione aziendale.



| Voce | Valore |
|-------------------|--------------------------------------------------------------------------------------------|
| CN                | ms-PKI-OID-utente-avviso                                                                     |
| LDAP-Display-Name | msPKI-OID-utente-avviso                                                                      |
| Dimensione              | \-                                                                                         |
