...
description: Identifica un diritto esteso che può essere concesso o revocato tramite un ACL.
ms.assetid: 87abaa8d-ca5b-46a2-b4e8-231a8542f509
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Control-Access-Right
- Schema DI AD della classe controlAccessRight
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423201"
---
# <a name="control-access-right-class"></a>Classe Control-Access-Right

Identifica un diritto esteso che può essere concesso o revocato tramite un ACL.
...
| Ldap-Display-Name | controlAccessRight                   |
| Aggiorna privilegio  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 8297931e-86d3-11d0-afda-00c04fd930c9 |
...
| [**Si applica a**](a-appliesto.md)                                         | Falso     | **Control-Access-Right**        |
...
| [**Localization-Display-ID**](a-localizationdisplayid.md)                | Falso     | **Control-Access-Right**        |
...
| [**Rights-Guid**](a-rightsguid.md)                                       | Falso     | **Control-Access-Right**        |
...
| [**Accessi validi**](a-validaccesses.md)                                 | Falso     | **Control-Access-Right**        |
