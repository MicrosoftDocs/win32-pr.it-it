...
---
# <a name="extended-class-info-attribute"></a>Extended-Class-info (attributo)

Proprietà multivalore che contiene stringhe che rappresentano informazioni aggiuntive per ogni classe. Ogni valore contiene governsID, lDAPDisplayName e schemaIDGUID della classe.
