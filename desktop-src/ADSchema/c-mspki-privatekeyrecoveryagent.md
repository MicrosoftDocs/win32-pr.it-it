...
description: Usato per pubblicare il certificato dell'agente di recupero chiavi nel contenitore DELL'agente di recupero chiavi.
ms.assetid: b414a312-1613-4fe4-afda-896dff6cbfdb
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-PKI-Private-Key-Recovery-Agent
- Schema AD della classe msPKI-PrivateKeyRecoveryAgent
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879801"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>Classe ms-PKI-Private-Key-Recovery-Agent

Usato per pubblicare il certificato dell'agente di recupero chiavi nel contenitore DELL'agente di recupero chiavi.
...
| [**Certificato X509**](a-usercertificate.md)                                      | Vero      | **ms-PKI-Private-Key-Recovery-Agent** |
