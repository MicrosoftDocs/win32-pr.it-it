...
Utilizzato per pubblicare il certificato dell'agente di recupero chiavi nel contenitore KRA.
...
| [**X509-Cert**](a-usercertificate.md)                                      | Vero      | **ms-PKI-Private-Key-Recovery-Agent** |
