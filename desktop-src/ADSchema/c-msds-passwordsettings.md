...
---
# <a name="ms-ds-password-settings-class"></a>Classe ms-DS-Password-Settings

Oggetto Impostazioni password per gli account.

> [!Note]  
> Questo oggetto classSchema viene creato con un elenco di systemMustContain OID. Si tratta di un elenco di attributi che devono essere contenuti in un oggetto Impostazioni password (PSO). in caso contrario, la creazione di PSO avrà esito negativo.
...
| Possibili superiori          | [**ms-DS-Password-Settings-Container**](c-msds-passwordsettingscontainer.md) |
| Classi ausiliarie           | \-                                                                            |
...
| [**ms-DS-blocco-durata**](a-msds-lockoutduration.md)                                           | Vero      | **ms-DS-password-impostazioni**     |
| [**ms-DS-blocco-osservazione-finestra**](a-msds-lockoutobservationwindow.md)                        | Vero      | **ms-DS-password-impostazioni**     |
| [**ms-DS-blocco-soglia**](a-msds-lockoutthreshold.md)                                         | Vero      | **ms-DS-password-impostazioni**     |
...
| [**ms-DS-lunghezza minima password**](a-msds-minimumpasswordlength.md)                              | Vero      | **ms-DS-password-impostazioni**     |
...
| [**ms-DS-password-complessità-abilitata**](a-msds-passwordcomplexityenabled.md)                      | Vero      | **ms-DS-password-impostazioni**     |
| [**ms-DS-password-cronologia-lunghezza**](a-msds-passwordhistorylength.md)                              | Vero      | **ms-DS-password-impostazioni**     |
| [**ms-DS-password-reversibile-Encryption-Enabled**](a-msds-passwordreversibleencryptionenabled.md) | Vero      | **ms-DS-password-impostazioni**     |
| [**ms-DS-Password-Settings-precedenza**](a-msds-passwordsettingsprecedence.md)                    | Vero      | **ms-DS-password-impostazioni**     |
...
| [**ms-DS-PSO-si applica a**](a-msds-psoappliesto.md)                                                | Falso     | **ms-DS-password-impostazioni**     |
