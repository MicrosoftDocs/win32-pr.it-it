---
title: Classe server
description: Questa classe rappresenta un computer server in un sito.
ms.assetid: 6625a62f-4140-4c8a-b099-90246f3699c5
ms.tgt_platform: multiple
keywords:
- Schema AD della classe server
- Schema AD della classe server
topic_type:
- apiref
api_name:
...
ms.locfileid: "119549101"
---
# <a name="server-class"></a>Classe server

Questa classe rappresenta un computer server in un sito.
...
| [**Bridgehead-Transport-List**](a-bridgeheadtransportlist.md)            | Falso     | **Server**                      |
...
| [**DNS-Host-Name**](a-dnshostname.md)                                    | Falso     | **Server**                      |
...
| [**Indirizzo di posta elettronica SMTP**](a-mailaddress.md)                                | Falso     | **Server**                      |
...
| [**Elenco bridgehead-transport-list**](a-bridgeheadtransportlist.md)              | Falso     | **Server**                      |
| [**Canonical-Name**](a-canonicalname.md)                                   | Falso     | [**In alto**](c-top.md)<br/> |
| [**Nome comune**](a-cn.md)                                                 | Falso     | [**In alto**](c-top.md)<br/> |
...
| [**NETBIOS-Name**](a-netbiosname.md)                                       | Falso     | **Server**                      |
| [**NT-Security-Descriptor**](a-ntsecuritydescriptor.md)                    | Vero      | [**In alto**](c-top.md)<br/> |
| [**Obj-Dist-Name**](a-distinguishedname.md)                                | Falso     | [**In alto**](c-top.md)<br/> |
| [**Categoria di oggetti**](a-objectcategory.md)                                 | Vero      | [**In alto**](c-top.md)<br/> |
| [**Classe object**](a-objectclass.md)                                       | Vero      | [**In alto**](c-top.md)<br/> |
...
| [**ms-DS-Is-User-Cachable-At-Rodc**](a-msds-isusercachableatrodc.md)          | Falso     | **Server**                      |
