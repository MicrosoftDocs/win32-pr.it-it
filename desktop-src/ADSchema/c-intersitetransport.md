---
title: Classe Inter-Site-Transport
description: Attributo facoltativo degli oggetti ntdsConnection. Se presente, contiene il DN di un oggetto interSiteTransport in CN Inter-Site Transports,CN Sites,CN Configuration,... Contenitore.
ms.assetid: eeeb47aa-cfe8-4ff6-86e7-b3e1727c907a
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Inter-Site-Transport
- Schema AD della classe interSiteTransport
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703681"
---
# <a name="inter-site-transport-class"></a>Classe Inter-Site-Transport

Attributo facoltativo degli oggetti ntdsConnection. Se presente, contiene il DN di un oggetto interSiteTransport in CN=Inter-Site Transports,CN=Sites,CN=Configuration,... Contenitore.



| Voce | Valore |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Trasporto tra siti                                                                                                               |
| Ldap-Display-Name | interSiteTransport                                                                                                                 |
| Privilegio di aggiornamento  | Questo valore viene impostato dal KCC o dall'amministratore dell'organizzazione.                                                                          |
| Frequenza di aggiornamento  | Creato/gestito dal controllo di coerenza delle informazioni in risposta alle modifiche nella topologia di rete (incluse le interruzioni temporanee). |
...
| Possibili superiori          | [**Inter-Site-Transport-Container**](c-intersitetransportcontainer.md)                      |
| Classi ausiliarie           | \-                                                                                           |
...
| [**Opzioni**](a-options.md)                                              | Falso     | **Trasporto tra siti**        |
...
| [**Intervallo di ripetizione**](a-replinterval.md)                                   | Falso     | **Trasporto tra siti**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | Vero      | **Trasporto tra siti**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | Vero      | **Trasporto tra siti**        |
