...
---
# <a name="inter-site-transport-class"></a>Classe trasporto tra siti

Attributo facoltativo degli oggetti ntdsConnection. Se presente, in viene archiviato il DN di un oggetto interSiteTransport in CN = tra i trasporti tra siti, CN = Sites, CN = Configuration,... contenitore.
...
| Privilegio aggiornamento  | Questo valore viene impostato dall'amministratore KCC o Enterprise.                                                                          |
| Frequenza di aggiornamento  | Creato/gestito dal controllo di coerenza informazioni in risposta alle modifiche della topologia di rete (incluse interruzioni temporanee). |
...
| Possibili superiori          | [**Contenitore tra siti-trasporto**](c-intersitetransportcontainer.md)                      |
| Classi ausiliarie           | \-                                                                                           |
...
| [**REPL-intervallo**](a-replinterval.md)                                   | Falso     | **Trasporto tra siti**        |
...
| [**Transport-nome-DLL**](a-transportdllname.md)                          | Vero      | **Trasporto tra siti**        |
