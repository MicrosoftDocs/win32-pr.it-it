...
Elenco di server che rappresentano il set di repliche per il contesto dei nomi non di dominio corrispondente.



| Voce | Valore |
|-------------------|-----------------------------------------|
| CN                | ms-DS-NC-replica-posizioni              |
| LDAP-Display-Name | msDS-NC-replica-posizioni               |
| Dimensione              | \-                                      |
