---
title: Dfs-Configuration classe
...
keywords:
- Dfs-Configuration schema AD della classe
- Schema AD della classe dfsConfiguration
topic_type:
- apiref
api_name:
- Dfs-Configuration
...
ms.locfileid: "119324931"
---
# <a name="dfs-configuration-class"></a>Dfs-Configuration classe

Contiene tutte le configurazioni DFS a tolleranza di errore.
...
| Possibili superiori          | [**Contenitore DNS di**](c-domaindns.md)[**dominio**](c-container.md)                            |
| Classi ausiliarie           | \-                                                                                           |
...
| Rdn-Att-Id                  | [**Nome comune**](a-cn.md)<br/>                                                       |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                              |
| Possibili superiori          | [**Contenitore DOMAIN-DNS**](c-domaindns.md)[](c-container.md)                            |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au) |
| System-Flags                | 0x00000010                                                                                   |
