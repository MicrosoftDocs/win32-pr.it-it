...
---
# <a name="ds-ui-settings-class"></a>Classe DS-UI-Settings

Utilizzato per archiviare le impostazioni di configurazione utilizzate dallo snap-in Active Directory utenti e computer.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | DS-interfaccia utente-impostazioni                       |
...
| [**DS-UI-admin-massimo**](a-dsuiadminmaximum.md)                         | Falso     | **DS-interfaccia utente-impostazioni**              |
| [**DS-UI-admin-notifica**](a-dsuiadminnotification.md)               | Falso     | **DS-interfaccia utente-impostazioni**              |
| [**DS-UI-Shell-massimo**](a-dsuishellmaximum.md)                         | Falso     | **DS-interfaccia utente-impostazioni**              |
...
| [**MS-DS-coerenza-figlio-conteggio**](a-ms-ds-consistencychildcount.md)                    | Falso     | [**In alto**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-Filter-container**](a-msds-filtercontainers.md)                                | Falso     | **DS-interfaccia utente-impostazioni**              |
...
| [**ms-DS-non-Security-Group-extra-classi**](a-msds-non-security-group-extra-classes.md) | Falso     | **DS-interfaccia utente-impostazioni**              |
...
| [**ms-DS-Security-Group-extra-classi**](a-msds-security-group-extra-classes.md)         | Falso     | **DS-interfaccia utente-impostazioni**              |
