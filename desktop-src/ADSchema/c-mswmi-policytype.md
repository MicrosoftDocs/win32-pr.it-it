...
description: Comunicare lo schema per gli oggetti criteri.
ms.assetid: cf89a4cb-cf42-4f80-b16e-8c958eafb5ae
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-PolicyType
- Schema AD della classe msWMI-PolicyType
topic_type:
- apiref
api_name:
- ms-WMI-PolicyType
...
ms.locfileid: "118422212"
---
# <a name="ms-wmi-policytype-class"></a>Classe ms-WMI-PolicyType

Comunicare lo schema per gli oggetti criteri.
...
| Ldap-Display-Name | msWMI-PolicyType                     |
| Aggiorna privilegio  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 595b2613-4109-4e77-9013-a3bb4ef277c7 |
...
| Descrittore di sicurezza predefinito | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSW;;;D A)(A;; CC;;; PA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**ms-WMI-Author**](a-mswmi-author.md)                                     | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-ChangeDate**](a-mswmi-changedate.md)                             | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Vero      | **ms-WMI-PolicyType**           |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-SourceOrganization**](a-mswmi-sourceorganization.md)             | Falso     | **ms-WMI-PolicyType**           |
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Vero      | **ms-WMI-PolicyType**           |
