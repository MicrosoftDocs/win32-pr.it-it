---
title: Sintassi
description: Active Directory ha definito le sintassi seguenti.
...
ms.locfileid: "119529941"
---
# <a name="syntaxes"></a>Sintassi

Active Directory ha definito le sintassi seguenti.

<dl>

[**Boolean**](s-boolean.md)  
[**Enumerazione**](s-enumeration.md)  
[**Enumerazione (meccanismo di recapito)**](s-enumeration-delivery-mechanism.md)  
[**Enumerazione (export-information-level)**](s-enumeration-export-information-level.md)  
[**Enumerazione (metodo di recapito preferito)**](s-enumeration-preferred-delivery-method.md)  
[**Intero**](s-integer.md)  
[**Intervallo**](s-interval.md)  
...
[**String (distinzione tra maiuscole e minuscole)**](s-string-case-sensitive.md)  
