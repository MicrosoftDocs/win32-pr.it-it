...
---
# <a name="ms-sql-informationdirectory-attribute"></a>Attributo MS-SQL-InformationDirectory

Directory Informativa per l'istanza corrente di SQL Server.
...
| Classi utilizzate in        | [**MS-SQL-SQLRepository**](c-ms-sql-sqlrepository.md)<br/> |
