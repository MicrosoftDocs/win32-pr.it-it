...
description: Un contenitore di questa classe può contenere oggetti Voce di criteri di accesso centrale.
ms.assetid: e290790a-231b-4d51-8ffa-126d9f489af1
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-Authz-Central-Access-Rules
- Schema AD della classe msAuthz-CentralAccessRules
topic_type:
- apiref
api_name:
...
ms.locfileid: "119801781"
---
# <a name="ms-authz-central-access-rules-class"></a>Classe ms-Authz-Central-Access-Rules

Un contenitore di questa classe può contenere oggetti Voce di criteri di accesso centrale.
