...
description: Contiene i dati di codifica per una classe WMI o un oggetto istanza, nonché informazioni aggiuntive relative all'oggetto.
ms.assetid: 8f2830f0-c427-431e-bcd2-6d7f8951792a
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-ObjectEncoding
- Schema AD della classe msWMI-ObjectEncoding
topic_type:
- apiref
api_name:
...
ms.locfileid: "119440291"
---
# <a name="ms-wmi-objectencoding-class"></a>Classe ms-WMI-ObjectEncoding

Contiene i dati di codifica per una classe WMI o un oggetto istanza, nonché informazioni aggiuntive relative all'oggetto.
...
| [**Classe ms-WMI**](a-mswmi-class.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Genus**](a-mswmi-genus.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-ScopeGuid**](a-mswmi-scopeguid.md)                               | Vero      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Vero      | **ms-WMI-ObjectEncoding**       |
