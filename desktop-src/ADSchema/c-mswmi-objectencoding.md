...
Include i dati di codifica per una classe WMI o un oggetto istanza, nonché informazioni aggiuntive sull'oggetto.
...
| [**MS-WMI-genere**](a-mswmi-genus.md)                                       | Vero      | **MS-WMI-ObjectEncoding**       |
| [**ID MS-WMI**](a-mswmi-id.md)                                             | Vero      | **MS-WMI-ObjectEncoding**       |
