...
L'ammissione controlla i criteri di allocazione della larghezza di banda del servizio per un utente o un profilo.
...
|----------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-aggregato-token-rate per utente**](a-acsaggregatetokenrateperuser.md)      | Falso     | **ACS-criteri**                  |
| [**Direzione ACS**](a-acsdirection.md)                                          | Falso     | **ACS-criteri**                  |
| [**Nome-identità ACS**](a-acsidentityname.md)                                   | Falso     | **ACS-criteri**                  |
| [**ACS-max-aggregate-picco-frequenza per utente**](a-acsmaxaggregatepeakrateperuser.md) | Falso     | **ACS-criteri**                  |
| [**ACS-Max-durata per flusso**](a-acsmaxdurationperflow.md)                     | Falso     | **ACS-criteri**                  |
| [**ACS-Maximum-SDU-size**](a-acsmaximumsdusize.md)                              | Falso     | **ACS-criteri**                  |
| [**ACS-max-picco-larghezza di banda per flusso**](a-acsmaxpeakbandwidthperflow.md)          | Falso     | **ACS-criteri**                  |
| [**ACS-max-token-bucket per flusso**](a-acsmaxtokenbucketperflow.md)              | Falso     | **ACS-criteri**                  |
| [**ACS-max-token-rate-per-Flow**](a-acsmaxtokenrateperflow.md)                  | Falso     | **ACS-criteri**                  |
| [**ACS-minimo-ritardo-variazione**](a-acsminimumdelayvariation.md)                | Falso     | **ACS-criteri**                  |
| [**ACS-latenza minima**](a-acsminimumlatency.md)                               | Falso     | **ACS-criteri**                  |
| [**ACS-dimensioni minime di polizia**](a-acsminimumpolicedsize.md)                      | Falso     | **ACS-criteri**                  |
| [**ACS-autorizzazioni-BITS**](a-acspermissionbits.md)                               | Falso     | **ACS-criteri**                  |
| [**ACS-priorità**](a-acspriority.md)                                            | Falso     | **ACS-criteri**                  |
| [**Tipo di servizio ACS**](a-acsservicetype.md)                                     | Falso     | **ACS-criteri**                  |
| [**ACS-ora del giorno**](a-acstimeofday.md)                                        | Falso     | **ACS-criteri**                  |
| [**ACS-totale senza flussi**](a-acstotalnoofflows.md)                             | Falso     | **ACS-criteri**                  |
