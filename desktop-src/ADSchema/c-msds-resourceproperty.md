...
description: Un'istanza di questa classe contiene la definizione di una proprietà nelle risorse.
ms.assetid: 745048bc-d197-4ef1-a71c-46eb089a16d6
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Resource-Property
- Schema AD della classe msDS-ResourceProperty
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422542"
---
# <a name="ms-ds-resource-property-class"></a>Classe ms-DS-Resource-Property

Un'istanza di questa classe contiene la definizione di una proprietà nelle risorse.
