...
---
# <a name="ms-ds-resource-property-class"></a>Classe ms-DS-Resource-Property

Un'istanza di questa classe include la definizione di una proprietà per le risorse.
...
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;; EA) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; Au |
...
| [**ms-DS-si applica a-tipi di risorse**](a-msds-appliestoresourcetypes.md)                         | Falso     | **ms-DS-Resource-Property**                                                       |
...
| [**ms-DS-valore-tipo-riferimento**](a-msds-valuetypereference.md)                                  | Vero      | **ms-DS-Resource-Property**                                                       |
