...
keywords:
- Schema AD della classe MS-SQL-OLAPDatabase
- Schema AD della classe mS-SQL-OLAPDatabase
topic_type:
- apiref
api_name:
...
ms.locfileid: "119441211"
---
# <a name="ms-sql-olapdatabase-class"></a>Classe MS-SQL-OLAPDatabase

Contenitore per [**l'archiviazione di oggetti MS-SQL-OLAPCube.**](c-ms-sql-olapcube.md)
...
| Schema-Id-Guid    | 20af031a-ccef-11d2-9993-0000f87a57d4 |
...
| Possibili superiori          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Classi ausiliarie           | \-                                                                                           |
...
| [**Ms-SQL-Applications**](a-ms-sql-applications.md)                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-ConnectionURL**](a-ms-sql-connectionurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Parole chiave SQL MS-SQL**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Type**](a-ms-sql-type.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
...
| [**MS-SQL-Description**](a-ms-sql-description.md)                          | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Parole chiave ms-SQL-keywords**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
