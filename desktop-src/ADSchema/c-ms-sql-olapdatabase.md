...
| [**MS-SQL-applicazioni**](a-ms-sql-applications.md)                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-ConnectionURL**](a-ms-sql-connectionurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Descrizione**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-parole chiave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPDatabase**         |
...
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-dimensioni**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Tipo MS-SQL**](a-ms-sql-type.md)                                      | Falso     | **MS-SQL-OLAPDatabase**         |
