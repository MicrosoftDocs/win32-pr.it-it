...
Per fornire la convalida dei dati, ogni decimo carattere viene impostato sul numero di caratteri diviso per dieci. Ad esempio, il decimo carattere è "1". il carattere "2" è "2" e così via.
