...
keywords:
- Schema AD della classe ms-DFSR-Topology
- Schema AD della classe msDFSR-Topology
topic_type:
- apiref
api_name:
- ms-DFSR-Topology
...
ms.locfileid: "118959860"
---
# <a name="ms-dfsr-topology-class"></a>Classe ms-DFSR-Topology

Contiene gli oggetti che formano la topologia di replica.
...
|-------------------|--------------------------------------|
| CN                | Ms-DFSR-Topology                     |
| Ldap-Display-Name | MsDFSR-Topology                      |
| Privilegio di aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 04828aa9-6e42-4e80-b962-e2fe00754d17 |
...
| [**Ms-DFSR-Extension**](a-msdfsr-extension.md)                             | Falso     | **Ms-DFSR-Topology**            |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falso     | **Ms-DFSR-Topology**            |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falso     | [**In alto**](c-top.md)<br/> |
| [**Ms-DFSR-Options**](a-msdfsr-options.md)                                 | Falso     | **Ms-DFSR-Topology**            |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | Falso     | **Ms-DFSR-Topology**            |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | Falso     | **Ms-DFSR-Topology**            |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | Falso     | [**In alto**](c-top.md)<br/> |
...
La **classe ms-DFSR-Topology** fa parte del supporto del servizio replica file system distribuito (DFS).
