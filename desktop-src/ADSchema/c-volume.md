---
title: Classe Volume
description: Contiene informazioni su un dispositivo o un file di archiviazione. Questa classe viene utilizzata per creare cartelle condivise.
ms.assetid: c8be8697-d54e-45c1-860d-85625af95211
ms.tgt_platform: multiple
keywords:
- Schema ad Active Directory della classe Volume
- Schema ad Active Directory della classe volume
topic_type:
- apiref
api_name:
...
ms.locfileid: "119533231"
---
# <a name="volume-class"></a>Classe Volume

Contiene informazioni su un dispositivo o un file di archiviazione. Questa classe viene utilizzata per creare cartelle condivise.
...
|-------------------|--------------------------------------|
| CN                | Volume                               |
| Ldap-Display-Name | volume                               |
| Aggiorna privilegio  | Amministratore di dominio                 |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | bf967abb-0de6-11d0-a285-00aa003049e2 |
...
| [**Content-Indexing-Allowed**](a-contentindexingallowed.md)              | Falso     | **Volume**                                                                               |
...
| [**Last-Content-Indexed**](a-lastcontentindexed.md)                      | Falso     | **Volume**                                                                               |
...
| [**UNC-Name**](a-uncname.md)                                             | Vero      | **Volume**                                                                               |
...
| [**SubSchemaSubEntry**](a-subschemasubentry.md)                            | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Flag di sistema**](a-systemflags.md)                                       | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**NOME UNC**](a-uncname.md)                                               | Vero      | **Volume**                                                                               |
