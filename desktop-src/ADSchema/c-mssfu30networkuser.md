...
---
# <a name="mssfu-30-network-user-class"></a>Attributo msSFU-30-classe utente rete

Rappresenta i dati dei file di rete.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Attributo msSFU-30-utente rete                |
...
| [**Attributo msSFU-30-chiave-valori**](a-mssfu30keyvalues.md)                           | Falso     | **Attributo msSFU-30-utente rete**       |
| [**Attributo msSFU-30-nome**](a-mssfu30name.md)                                      | Falso     | **Attributo msSFU-30-utente rete**       |
| [**Attributo msSFU-30-NIS-domain**](a-mssfu30nisdomain.md)                           | Falso     | **Attributo msSFU-30-utente rete**       |
...
| [**nisMapName**](a-nismapname.md)                                          | Falso     | **Attributo msSFU-30-utente rete**       |
