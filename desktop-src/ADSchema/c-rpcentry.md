...
description: Classe astratta le cui sottoclassi vengono usate dal servizio nomi RPC (Ns), a cui si accede tramite le funzioni RpcNs\ nell'API Win32.
ms.assetid: 8ec4831d-d30b-4b4d-a5d4-8457a7774ec0
ms.tgt_platform: multiple
keywords:
- Schema AD della classe rpc-Entry
- Schema AD della classe rpcEntry
topic_type:
- apiref
api_name:
- rpc-Entry
...
ms.locfileid: "119801551"
---
# <a name="rpc-entry-class"></a>Classe rpc-Entry

Classe astratta le cui sottoclassi vengono usate dal servizio nomi RPC (Ns), a cui si accede tramite le funzioni RpcNs \* nell'API Win32.
