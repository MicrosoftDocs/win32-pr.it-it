---
title: Classe oncRpc
description: Rappresenta un'astrazione dell'associazione RPC (Remote Procedure Call) ONC (Open Network Computing).
ms.assetid: 05fb9e0b-2fc2-4bbe-9083-f3f383e97b2b
ms.tgt_platform: multiple
keywords:
- Schema AD della classe oncRpc
topic_type:
- apiref
api_name:
- oncRpc
...
ms.locfileid: "118959750"
---
# <a name="oncrpc-class"></a>Classe oncRpc

Rappresenta un'astrazione dell'associazione RPC (Remote Procedure Call) ONC (Open Network Computing).
