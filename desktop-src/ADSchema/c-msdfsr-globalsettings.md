...
| [**Flag MS-DFSR**](a-msdfsr-flags.md)                                     | Falso     | **MS-DFSR-GlobalSettings**      |
...
La classe **MS-DFSR-GlobalSettings** fa parte del supporto del servizio di replica file System distribuito (DFS).
