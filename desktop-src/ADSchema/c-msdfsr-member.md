...
keywords:
- Schema AD della classe ms-DFSR-Member
- Schema AD della classe msDFSR-Member
topic_type:
- apiref
api_name:
- ms-DFSR-Member
...
| Possibili superiori          | [**Ms-DFSR-Topology**](c-msdfsr-topology.md)                                                                                    |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**ms-DFSR-ComputerReference**](a-msdfsr-computerreference.md)             | Vero      | **ms-DFSR-Member**              |
| [**ms-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)         | Falso     | [**In alto**](c-top.md)<br/> |
| [**Ms-DFSR-Extension**](a-msdfsr-extension.md)                             | Falso     | **ms-DFSR-Member**              |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falso     | **ms-DFSR-Member**              |
| [**parole chiave ms-DFSR**](a-msdfsr-keywords.md)                               | Falso     | **ms-DFSR-Member**              |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                 | Falso     | **ms-DFSR-Member**              |
...
| [**Riferimento al server**](a-serverreference.md)                               | Falso     | **ms-DFSR-Member**              |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | Falso     | **ms-DFSR-Member**              |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | Falso     | **ms-DFSR-Member**              |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | Falso     | [**In alto**](c-top.md)<br/> |
...
La **classe ms-DFSR-Member** fa parte del supporto del servizio replica file system distribuito (DFS).
