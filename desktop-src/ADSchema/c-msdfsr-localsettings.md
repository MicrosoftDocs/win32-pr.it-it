...
description: Contiene le file system distribuito servizio Replica DFS applicabili al computer locale.
ms.assetid: a7e57bd9-2b02-4d3c-bc05-f4d53e92567d
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DFSR-LocalSettings
- Schema AD della classe msDFSR-LocalSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "120065361"
---
# <a name="ms-dfsr-localsettings-class"></a>Classe ms-DFSR-LocalSettings

Contiene le file system distribuito servizio Replica DFS applicabili al computer locale.
...
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falso     | **ms-DFSR-LocalSettings**       |
...
La **classe ms-DFSR-LocalSettings** fa parte del Replica DFS del servizio.
