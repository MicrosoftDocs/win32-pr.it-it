---
title: Infrastructure-Update classe
...
keywords:
- Infrastructure-Update schema AD della classe
- Schema AD della classe infrastructureUpdate
topic_type:
- apiref
api_name:
...
ms.locfileid: "119324491"
---
# <a name="infrastructure-update-class"></a>Infrastructure-Update classe

Questo oggetto rappresenta il master infrastrutture per un dominio.
...
| Possibili superiori          | [**Aggiornamento**](c-domain.md)**dell'infrastruttura di dominio** |
| Classi ausiliarie           | \-                                                  |
...
| [**DN-Reference-Update**](a-dnreferenceupdate.md)                        | Falso     | **Aggiornamento dell'infrastruttura**       |
...
| Nome comune                                                            |
|------------------------------------------------------------------------|
| [**Modifica infrastruttura-master**](r-change-infrastructure-master.md) |
