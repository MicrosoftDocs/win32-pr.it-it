...
---
# <a name="ms-ds-resource-properties-class"></a>Classe ms-DS-Resource-Properties

Un contenitore di questa classe può contenere le proprietà delle risorse.
...
| LDAP-Display-Name | msDS-raccolta ResourceProperties              |
