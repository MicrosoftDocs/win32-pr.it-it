...
description: Un contenitore di questa classe può contenere proprietà delle risorse.
ms.assetid: 4c29de10-8218-406e-8f5a-5e2edb341a85
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Resource-Properties
- Schema AD della classe msDS-ResourceProperties
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879901"
---
# <a name="ms-ds-resource-properties-class"></a>Classe ms-DS-Resource-Properties

Un contenitore di questa classe può contenere proprietà delle risorse.
