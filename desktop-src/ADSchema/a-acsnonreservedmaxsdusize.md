...
---
# <a name="acs-non-reserved-max-sdu-size-attribute"></a>Attributo ACS-non riservato-max-SDU-size

L'attributo **ACS-non riservato-max-SDU-size** è solo per uso interno. Basato su RFC2814.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ACS-non riservato-max-SDU-size        |
