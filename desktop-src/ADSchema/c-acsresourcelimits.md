...
Contiene limiti di risorse riservati per una subnet. Questi limiti possono essere per ogni tipo di servizio ACS o per tutti i tipi di servizio.



| Voce | Valore |
|-------------------|------------------------------------------------|
| CN                | Limite di risorse ACS                            |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-allocabile-RSVP-larghezza di banda**](a-acsallocablersvpbandwidth.md)       | Falso     | **Limite di risorse ACS**         |
| [**ACS-max-picco-larghezza di banda**](a-acsmaxpeakbandwidth.md)                   | Falso     | **Limite di risorse ACS**         |
| [**ACS-max-picco-larghezza di banda per flusso**](a-acsmaxpeakbandwidthperflow.md)   | Falso     | **Limite di risorse ACS**         |
| [**ACS-max-token-rate-per-Flow**](a-acsmaxtokenrateperflow.md)           | Falso     | **Limite di risorse ACS**         |
| [**Tipo di servizio ACS**](a-acsservicetype.md)                              | Falso     | **Limite di risorse ACS**         |
