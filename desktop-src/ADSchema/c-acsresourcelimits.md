...
description: Contiene i limiti delle risorse riservabili per una subnet. Questi limiti possono essere per ogni tipo di servizio ACS o per tutti i tipi di servizio.
ms.assetid: 6b1d15e8-a60b-4253-8521-db3c9ebbb69b
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ACS-Resource-Limits
- Schema AD della classe aCSResourceLimits
topic_type:
- apiref
api_name:
- ACS-Resource-Limits
...
ms.locfileid: "119021879"
---
# <a name="acs-resource-limits-class"></a>Classe ACS-Resource-Limits

Contiene i limiti delle risorse riservabili per una subnet. Questi limiti possono essere per ogni tipo di servizio ACS o per tutti i tipi di servizio.



| Voce | Valore |
|-------------------|------------------------------------------------|
| CN                | Limiti delle risorse ACS                            |
| Ldap-Display-Name | aCSResourceLimits                              |
| Aggiorna privilegio  | Questo valore viene impostato dall'amministratore di dominio. |
| Frequenza di aggiornamento  | \-                                             |
| Schema-Id-Guid    | 2e899b04-2834-11d3-91d4-0000f87a57d4           |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)       | Falso     | **Limiti delle risorse ACS**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                   | Falso     | **Limiti delle risorse ACS**         |
| [**ACS-Max-Peak-Bandwidth-Per-Flow**](a-acsmaxpeakbandwidthperflow.md)   | Falso     | **Limiti delle risorse ACS**         |
| [**ACS-Max-Token-Rate-Per-Flow**](a-acsmaxtokenrateperflow.md)           | Falso     | **Limiti delle risorse ACS**         |
| [**ACS-Service-Type**](a-acsservicetype.md)                              | Falso     | **Limiti delle risorse ACS**         |
...
| Attributo                                                                      | Obbligatorio | Derivato da                    |
|--------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)            | Falso     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                        | Falso     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth-Per-Flow**](a-acsmaxpeakbandwidthperflow.md)        | Falso     | **ACS-Resource-Limits**         |
| [**ACS-Max-Token-Rate-Per-Flow**](a-acsmaxtokenrateperflow.md)                | Falso     | **ACS-Resource-Limits**         |
| [**ACS-Service-Type**](a-acsservicetype.md)                                   | Falso     | **ACS-Resource-Limits**         |
