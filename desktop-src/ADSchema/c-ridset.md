---
title: RID-Set classe
description: È presente uno di questi per ogni controller di dominio. Contiene i pool di RID allocati dal controller di dominio.
ms.assetid: b3e0eccd-63de-4950-ba1c-574be3a4019b
ms.tgt_platform: multiple
keywords:
- RID-Set schema AD della classe
- Schema AD della classe rIDSet
topic_type:
- apiref
api_name:
- RID-Set
...
ms.locfileid: "118959546"
---
# <a name="rid-set-class"></a>RID-Set classe

È presente uno di questi per ogni controller di dominio. Contiene i pool di RID allocati dal controller di dominio.
...
| Possibili superiori          | [**Utente contenitore**](c-computer.md)[](c-container.md)[**computer**](c-user.md)         |
| Classi ausiliarie           | \-                                                                                           |
...
| [**RID-Allocation-Pool**](a-ridallocationpool.md)                        | Vero      | **SET RID**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                      | Vero      | **SET RID**                     |
| [**RID-Previous-Allocation-Pool**](a-ridpreviousallocationpool.md)       | Vero      | **SET RID**                     |
| [**RID-Used-Pool**](a-ridusedpool.md)                                    | Vero      | **SET RID**                     |
...
| [**Reps-To**](a-repsto.md)                                                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Revisione**](a-revision.md)                                              | Falso     | [**In alto**](c-top.md)<br/> |
| [**Pool di allocazione RID**](a-ridallocationpool.md)                          | Vero      | **SET DI RID**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                        | Vero      | **SET DI RID**                     |
| [**RID-Previous-Allocation-Pool**](a-ridpreviousallocationpool.md)         | Vero      | **SET DI RID**                     |
| [**Pool usato da RID**](a-ridusedpool.md)                                      | Vero      | **SET DI RID**                     |
| [**SD-Rights-Effective**](a-sdrightseffective.md)                          | Falso     | [**In alto**](c-top.md)<br/> |
| [**Server-Reference-BL**](a-serverreferencebl.md)                          | Falso     | [**In alto**](c-top.md)<br/> |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)              | Falso     | [**In alto**](c-top.md)<br/> |
