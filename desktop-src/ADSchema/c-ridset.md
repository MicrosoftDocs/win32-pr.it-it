...
---
# <a name="rid-set-class"></a>Classe RID-Set

Uno di questi per ogni controller di dominio. Che include i pool di RID allocati dal controller di dominio.
...
| Possibili superiori          | [](c-computer.md)[](c-container.md)[**Utente**](c-user.md) contenitore computer         |
| Classi ausiliarie           | \-                                                                                           |
...
| [**RID-allocazione-pool**](a-ridallocationpool.md)                        | Vero      | **Set RID**                     |
| [**RID-successivo-RID**](a-ridnextrid.md)                                      | Vero      | **Set RID**                     |
| [**RID-precedente-allocazione-pool**](a-ridpreviousallocationpool.md)       | Vero      | **Set RID**                     |
| [**RID-usato-pool**](a-ridusedpool.md)                                    | Vero      | **Set RID**                     |
