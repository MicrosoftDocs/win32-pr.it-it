...
---
# <a name="group-of-names-class"></a>Classe Group-of-names

Utilizzato per definire le voci che rappresentano un set non ordinato di nomi che rappresentano singoli oggetti o altri gruppi di nomi.
...
|-------------------|--------------------------------------|
| CN                | Gruppo di nomi                       |
| LDAP-Display-Name | groupOfNames                         |
...
| [**Categoria aziendale**](a-businesscategory.md)                           | Falso     | **Gruppo di nomi**                                 |
| [**Nome canonico**](a-canonicalname.md)                                 | Falso     | [**In alto**](c-top.md)<br/>                    |
| [**Nome comune**](a-cn.md)                                               | Vero      | **Primo gruppo di nomi** [](c-top.md)<br/> |
...
| [**Membro**](a-member.md)                                                | Vero      | **Gruppo di nomi**                                 |
...
| [**Nome-unità-organizzativa**](a-ou.md)                                  | Falso     | **Gruppo di nomi**                                 |
| [**Nome organizzazione**](a-o.md)                                          | Falso     | **Gruppo di nomi**                                 |
| [**Altri oggetti-well-known**](a-otherwellknownobjects.md)               | Falso     | [**In alto**](c-top.md)<br/>                    |
| [**Proprietario**](a-owner.md)                                                  | Falso     | **Gruppo di nomi**                                 |
...
| [**Vedere anche**](a-seealso.md)                                             | Falso     | **Gruppo di nomi**                                 |
...
| RDN-att-ID                  | [**Nome comune**](a-cn.md)<br/>                                                                                                                  |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                                                                                         |
| Possibili superiori          | [**Unità organizzativa di**](c-organizationalunit.md) località dell'[**organizzazione**](c-organization.md)[**del**](c-locality.md) [**contenitore**](c-container.md) |
| Classi ausiliarie           | \-                                                                                                                                                      |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                                                                            |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; Au                                                            |
| System-Flags                | 0x00000010                                                                                                                                              |
