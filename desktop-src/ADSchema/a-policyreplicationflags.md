...
---
# <a name="policy-replication-flags-attribute"></a>Attributo Policy-Replication-Flags

Determina quali proprietà LSA vengono replicate nei client.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Criteri-replica-flag             |
