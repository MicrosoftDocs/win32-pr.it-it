...
keywords:
- Schema AD della classe Ipsec-ISAKMP-Policy
- Schema AD della classe ipsecISAKMPPolicy
topic_type:
- apiref
api_name:
- Ipsec-ISAKMP-Policy
...
ms.locfileid: "119324231"
---
# <a name="ipsec-isakmp-policy-class"></a>Classe Ipsec-ISAKMP-Policy
