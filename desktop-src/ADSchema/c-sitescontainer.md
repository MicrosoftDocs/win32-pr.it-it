...
---
# <a name="sites-container-class"></a>Classe Sites-Container

Contenitore per l'archiviazione di oggetti del sito. Si trova nel contesto dei nomi di configurazione.
...
| Privilegio aggiornamento  | Questo oggetto viene gestito dal sistema. |
| Frequenza di aggiornamento  | Quando viene creato il servizio directory.   |
