...
description: Contiene i criteri di connessione della stampante.
ms.assetid: 39981d4b-ee21-4f11-8393-5d40d1909bcb
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-Print-ConnectionPolicy
- Schema AD della classe msPrint-ConnectionPolicy
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879711"
---
# <a name="ms-print-connectionpolicy-class"></a>Classe ms-Print-ConnectionPolicy

Contiene i criteri di connessione della stampante.
...
| [**Nome comune**](a-cn.md)                                                 | Vero      | **ms-Print-ConnectionPolicy** [ **Top**](c-top.md)<br/> |
...
| [**Attributi di stampa**](a-printattributes.md)                               | Falso     | **ms-Print-ConnectionPolicy**                                 |
| [**Nome stampante**](a-printername.md)                                       | Falso     | **ms-Print-ConnectionPolicy**                                 |
...
| [**Nome server**](a-servername.md)                                         | Falso     | **ms-Print-ConnectionPolicy**                                 |
...
| [**NOME UNC**](a-uncname.md)                                               | Falso     | **ms-Print-ConnectionPolicy**                                 |
...
| [**SubSchemaSubEntry**](a-subschemasubentry.md)                               | Falso     | [**In alto**](c-top.md)<br/>                               |
| [**Flag di sistema**](a-systemflags.md)                                          | Falso     | [**In alto**](c-top.md)<br/>                               |
| [**UNC-Name**](a-uncname.md)                                                  | Falso     | **ms-Print-ConnectionPolicy**                                 |
