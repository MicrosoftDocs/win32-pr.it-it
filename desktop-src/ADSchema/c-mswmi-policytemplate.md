...
Il modello di criteri fornisce una ricetta per la creazione di un'istanza di classe nello spazio dei nomi di destinazione.
...
| [**MS-WMI-autore**](a-mswmi-author.md)                                     | Falso     | **MS-WMI-PolicyTemplate**       |
| [**MS-WMI-modificato**](a-mswmi-changedate.md)                             | Falso     | **MS-WMI-PolicyTemplate**       |
| [**MS-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Falso     | **MS-WMI-PolicyTemplate**       |
| [**ID MS-WMI**](a-mswmi-id.md)                                             | Vero      | **MS-WMI-PolicyTemplate**       |
...
| [**MS-WMI-nome**](a-mswmi-name.md)                                         | Vero      | **MS-WMI-PolicyTemplate**       |
