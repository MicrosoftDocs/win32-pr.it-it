...
description: Il modello di criteri fornisce una ricetta per la creazione di un'istanza della classe nello spazio dei nomi di destinazione.
ms.assetid: a51ab1e5-3080-48be-a18a-0714c3fbceb3
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-PolicyTemplate
- Schema AD della classe msWMI-PolicyTemplate
topic_type:
- apiref
api_name:
...
ms.locfileid: "120005411"
---
# <a name="ms-wmi-policytemplate-class"></a>Classe ms-WMI-PolicyTemplate

Il modello di criteri fornisce una ricetta per la creazione di un'istanza della classe nello spazio dei nomi di destinazione.
...
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Vero      | **ms-WMI-PolicyTemplate**       |
...
| [**ms-WMI-Name**](a-mswmi-name.md)                                         | Vero      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Vero      | **ms-WMI-PolicyTemplate**       |
...
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vero      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | Vero      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetPath**](a-mswmi-targetpath.md)                             | Vero      | **ms-WMI-PolicyTemplate**       |
