...
keywords:
- Schema AD della classe ms-WMI-StringSetParam
- Schema AD della classe msWMI-StringSetParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753651"
---
# <a name="ms-wmi-stringsetparam-class"></a>Classe ms-WMI-StringSetParam

Oggetto parametro set di stringhe.
...
| [**ms-WMI-stringDefault**](a-mswmi-stringdefault.md)                       | Vero      | **ms-WMI-StringSetParam**                                  |
| [**ms-WMI-stringValidValues**](a-mswmi-stringvalidvalues.md)               | Falso     | **ms-WMI-StringSetParam**                                  |
