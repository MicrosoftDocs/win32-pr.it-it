...
keywords:
- Schema AD della classe bootableDevice
topic_type:
- apiref
api_name:
- bootableDevice
...
ms.locfileid: "119643851"
---
# <a name="bootabledevice-class"></a>Classe bootableDevice

Rappresenta un dispositivo con parametri di avvio.
...
|-------------------|--------------------------------------|
| CN                | bootableDevice                       |
| Ldap-Display-Name | bootableDevice                       |
| Privilegio di aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 4bcb2477-4bb3-4545-a9fc-fb66e136b435 |
...
| [**bootFile**](a-bootfile.md)                                              | Falso     | **bootableDevice**                                 |
| [**bootParameter**](a-bootparameter.md)                                    | Falso     | **bootableDevice**                                 |
...
| [**Nome comune**](a-cn.md)                                                 | Falso     | **bootableDevice** [ **Top**](c-top.md)<br/> |
