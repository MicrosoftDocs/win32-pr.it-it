...
---
# <a name="dns-node-class"></a>Classe Dns-Node

Include i record di risorse DNS per un singolo host.
...
|-------------------|--------------------------------------|
| CN                | Dns-Node                             |
| LDAP-Display-Name | dnsNode                              |
| Privilegio aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | e0fa1e8c-9b45-11d0-afdd-00c04fd930c9 |
...
| Possibili superiori          | [**Zona DNS**](c-dnszone.md)                                                                                                                                        |
| Classi ausiliarie           | \-                                                                                                                                                                   |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                                                                                         |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; ED) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) (A;; RPLCLORC;;; WD |
...
| [**Proprietà DNS**](a-dnsproperty.md)                                     | Falso     | **DNS-nodo**                    |
| [**Record DNS**](a-dnsrecord.md)                                         | Falso     | **DNS-nodo**                    |
| [**DNS-contrassegnato per la rimozione definitiva**](a-dnstombstoned.md)                                 | Falso     | **DNS-nodo**                    |
| [**Componente di dominio**](a-dc.md)                                          | Vero      | **DNS-nodo**                    |
