---
title: Classe Licensing-Site-Impostazioni
description: Punta al server licenze per un sito.
ms.assetid: b1573bfc-e81b-4b94-858d-5cc274c07d1a
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Licensing-Site-Impostazioni
- Classe licensingSiteSettings - Schema DI AD
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423082"
---
# <a name="licensing-site-settings-class"></a>Classe Licensing-Site-Impostazioni

Punta al server licenze per un sito.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Licensing-Site-Impostazioni              |
...
| [**Server del sito**](a-siteserver.md)                                       | Falso     | **Licensing-Site-Impostazioni**                                               |
