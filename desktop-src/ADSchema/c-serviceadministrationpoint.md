...
---
# <a name="service-administration-point-class"></a>Servizio-Amministrazione-classe punto

Include informazioni di binding per la connessione a un servizio per l'amministrazione.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Servizio-amministrazione-punto         |
