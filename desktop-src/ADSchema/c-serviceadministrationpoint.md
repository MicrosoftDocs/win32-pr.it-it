---
title: Classe Service-Administration-Point
description: Contiene le informazioni di associazione per la connessione a un servizio per amministrarlo.
ms.assetid: 7a96881c-a223-4d9c-a0db-5d771f96d362
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Service-Administration-Point
- Schema AD della classe serviceAdministrationPoint
topic_type:
- apiref
api_name:
...
ms.locfileid: "119548981"
---
# <a name="service-administration-point-class"></a>Classe Service-Administration-Point

Contiene le informazioni di associazione per la connessione a un servizio per amministrarlo.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Punto di amministrazione del servizio         |
| Ldap-Display-Name | serviceAdministrationPoint           |
| Aggiorna privilegio  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | b7b13123-b82e-11d0-afee-0000f80367c1 |
