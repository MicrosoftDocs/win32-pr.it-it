...
description: Oggetto per tenere traccia dei collegamenti di sito connessi in modo transitivo.
ms.assetid: dabd236e-f4e7-4a4b-92ea-c0d144dea74c
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Site-Link-Bridge
- Schema AD della classe siteLinkBridge
topic_type:
- apiref
api_name:
- Site-Link-Bridge
...
ms.locfileid: "119548901"
---
# <a name="site-link-bridge-class"></a>Classe Site-Link-Bridge

Oggetto per tenere traccia dei collegamenti di sito connessi in modo transitivo.



| Voce | Valore |
|-------------------|--------------------------------------------------------------------|
| CN                | Collegamento di sito -Bridge                                                   |
| Ldap-Display-Name | siteLinkBridge                                                     |
| Aggiorna privilegio  | Amministratore di dominio                                               |
| Frequenza di aggiornamento  | Ogni volta che è necessario aggiungere o rimuovere un collegamento di sito dal bridge. |
...
| [**Elenco dei collegamenti di sito**](a-sitelinklist.md)                                  | Vero      | **Collegamento di sito -Bridge**            |
...
| [**Server-Reference-BL**](a-serverreferencebl.md)                          | Falso     | [**In alto**](c-top.md)<br/> |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)              | Falso     | [**In alto**](c-top.md)<br/> |
| [**Site-Link-List**](a-sitelinklist.md)                                    | Vero      | **Site-Link-Bridge**            |
