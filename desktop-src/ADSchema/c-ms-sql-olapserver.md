...
| [**MS-SQL-compilazione**](a-ms-sql-build.md)                                    | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-parole chiave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-linguaggio**](a-ms-sql-language.md)                              | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-OLAPServer**                                                                    |
...
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-versione**](a-ms-sql-version.md)                                | Falso     | **MS-SQL-OLAPServer**                                                                    |
