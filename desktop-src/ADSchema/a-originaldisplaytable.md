...
---
# <a name="original-display-table-attribute"></a>Originale-display-Table-attributo

Tabella di visualizzazione MAPI (originale) per una voce di indirizzo.



| Voce | Valore |
|-------------------|-------------------------------------------------------|
| CN                | Originale-visualizzazione tabella                                |
