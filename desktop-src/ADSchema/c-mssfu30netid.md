...
---
# <a name="mssfu-30-net-id-class"></a>classe attributo msSFU-30-NET-ID

Utilizzato per archiviare l'ID di rete.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Attributo msSFU-30-NET-ID                      |
...
| [**Attributo msSFU-30-chiave-valori**](a-mssfu30keyvalues.md)                           | Falso     | **Attributo msSFU-30-NET-ID**             |
| [**Attributo msSFU-30-nome**](a-mssfu30name.md)                                      | Falso     | **Attributo msSFU-30-NET-ID**             |
| [**Attributo msSFU-30-NIS-domain**](a-mssfu30nisdomain.md)                           | Falso     | **Attributo msSFU-30-NET-ID**             |
...
| [**nisMapName**](a-nismapname.md)                                          | Falso     | **Attributo msSFU-30-NET-ID**             |
