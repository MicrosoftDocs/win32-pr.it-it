...
Un oggetto tipo di valore include informazioni sul tipo di valore per una proprietà della risorsa.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ms-DS-valore-tipo                     |
...
| [**ms-DS-Claim-is-a valore singolo**](a-msds-claimissinglevalued.md)                           | Vero      | **ms-DS-valore-tipo**            |
| [**ms-DS-Claim-is-value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Vero      | **ms-DS-valore-tipo**            |
| [**ms-DS-Claim-shares-possible-values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-claim-value-type**](a-msds-claimvaluetype.md)                                      | Vero      | **ms-DS-valore-tipo**            |
...
| [**ms-DS-is-possible-values-present**](a-msds-ispossiblevaluespresent.md)                   | Vero      | **ms-DS-valore-tipo**            |
