...
description: Un oggetto tipo valore contiene informazioni sul tipo di valore per una proprietà della risorsa.
ms.assetid: c464d53b-f0dd-42fd-8a8a-a86a270d9f1f
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Value-Type
- Schema AD della classe msDS-ValueType
topic_type:
- apiref
api_name:
- ms-DS-Value-Type
...
ms.locfileid: "119879791"
---
# <a name="ms-ds-value-type-class"></a>Classe ms-DS-Value-Type

Un oggetto tipo valore contiene informazioni sul tipo di valore per una proprietà della risorsa.
...
| Schema-Id-Guid    | e3c27fdf-b01d-4f4e-87e7-056eef0eb922 |
...
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) |
...
| [**ms-DS-Claim-Is-Single-Valued**](a-msds-claimissinglevalued.md)                           | Vero      | **Ms-DS-Value-Type**            |
| [**ms-DS-Claim-Is-Value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Vero      | **Ms-DS-Value-Type**            |
| [**ms-DS-Claim-Shares-Possible-Values-With-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-Claim-Value-Type**](a-msds-claimvaluetype.md)                                      | Vero      | **Ms-DS-Value-Type**            |
...
| [**ms-DS-Is-Possible-Values-Present**](a-msds-ispossiblevaluespresent.md)                   | Vero      | **Ms-DS-Value-Type**            |
