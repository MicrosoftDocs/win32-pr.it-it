...
description: Oggetto di attivazione usato nell'attivazione basata su Active Directory
ms.assetid: 133a06cd-972e-4aca-b266-be63910f3761
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-SPP-Activation-Object
- Schema AD della classe msSPP-ActivationObject
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879431"
---
# <a name="ms-spp-activation-object-class"></a>Classe ms-SPP-Activation-Object

Oggetto di attivazione usato nell'attivazione basata su Active Directory
...
| Possibili superiori          | [**ms-SPP-Activation-Objects-Container**](c-msspp-activationobjectscontainer.md) |
| Classi ausiliarie           | \-                                                                                |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                      |
| Descrittore di sicurezza predefinito | O:BAG:BAD: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; Au)                 |
...
| [**ms-SPP-CSVLK-Partial-Product-Key**](a-msspp-csvlkpartialproductkey.md)                   | Vero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-CSVLK-Pid**](a-msspp-csvlkpid.md)                                                 | Vero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-CSVLK-Sku-Id**](a-msspp-csvlkskuid.md)                                            | Vero      | **ms-SPP-Activation-Object**    |
...
| [**ms-SPP-Servizio di gestione delle chiavi-IDs**](a-msspp-kmsids.md)                                                     | Vero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-Online-License**](a-msspp-onlinelicense.md)                                       | Falso     | **ms-SPP-Activation-Object**    |
| [**ms-SPP-Telefono-License**](a-msspp-phonelicense.md)                                         | Falso     | **ms-SPP-Activation-Object**    |
