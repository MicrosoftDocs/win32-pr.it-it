...
keywords:
- Ipsec-Filter schema AD della classe
- Schema AD della classe ipsecFilter
topic_type:
- apiref
api_name:
- Ipsec-Filter
...
ms.locfileid: "119835051"
---
# <a name="ipsec-filter-class"></a>Ipsec-Filter classe
