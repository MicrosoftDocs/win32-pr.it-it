...
---
# <a name="ipsec-filter-class"></a>Classe Ipsec-Filter

Rappresenta un filtro IPSec utilizzato per creare criteri di sicurezza, ad esempio quelli che bloccano porte e protocolli.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Filter                         |
| LDAP-Display-Name | ipsecFilter                          |
| Privilegio aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | b40ff826-427a-11d1-a9c2-0000f80367c1 |
