...
keywords:
- Schema di ACTIVE Directory della classe ms-DS-Az-Application
- Schema AD della classe msDS-AzApplication
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880391"
---
# <a name="ms-ds-az-application-class"></a>Classe ms-DS-Az-Application

Definisce un'istanza installata di un'applicazione associata a un archivio criteri specifico.
...
| Possibili superiori          | [**ms-DS-Az-Admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**Descrizione**](a-description.md)                                        | Falso     | **ms-DS-Az-Application** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)               | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Application-Name**](a-msds-azapplicationname.md)               | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Application-Version**](a-msds-azapplicationversion.md)         | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Class-ID**](a-msds-azclassid.md)                               | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generate-Audits**](a-msds-azgenerateaudits.md)                 | Falso     | **ms-DS-Az-Application**                                 |
...
| [**ms-DS-Az-Class-ID**](a-msds-azclassid.md)                                  | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generate-Audits**](a-msds-azgenerateaudits.md)                    | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generic-Data**](a-msds-azgenericdata.md)                          | Falso     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | Falso     | **ms-DS-Az-Application**                                 |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falso     | [**In alto**](c-top.md)<br/>                          |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falso     | [**In alto**](c-top.md)<br/>                          |
