...
description: Rappresenta una subnet specifica nella rete a cui sono collegati server e workstation.
ms.assetid: b40aad45-8794-4bed-a053-68cd0f3aace9
ms.tgt_platform: multiple
keywords:
- Schema AD della classe subnet
...
ms.locfileid: "119548851"
---
# <a name="subnet-class"></a>Classe di subnet

Rappresenta una subnet specifica nella rete a cui sono collegati server e workstation.
...
| Possibili superiori          | [**Contenitore subnet**](c-subnetcontainer.md)                                                |
| Classi ausiliarie           | \-                                                                                           |
...
| [**Località**](a-location.md)                                            | Falso     | **Subnet**                      |
...
| [**Physical-Location-Object**](a-physicallocationobject.md)              | Falso     | **Subnet**                      |
...
| [**Oggetto site**](a-siteobject.md)                                       | Falso     | **Subnet**                      |
...
| Rdn-Att-Id                  | [**Nome comune**](a-cn.md)<br/>        |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>               |
| Possibili superiori          | [**Subnet-Container**](c-subnetcontainer.md) |
| Classi ausiliarie           | \-                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                  |
