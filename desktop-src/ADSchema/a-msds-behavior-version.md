...
Questo attributo viene utilizzato per tenere traccia della versione del comportamento del dominio o della foresta. Si tratta di un numero a incremento progressivo costante utilizzato per abilitare determinate funzionalità di Active Directory.
...
| Classi utilizzate in        | [**Riferimento incrociato**](c-crossref.md)<br/> [**Cross-Ref-container**](c-crossrefcontainer.md)<br/> [**Domain-DNS**](c-domaindns.md)<br/> [**NTDS-DSA**](c-ntdsdsa.md)<br/> |
