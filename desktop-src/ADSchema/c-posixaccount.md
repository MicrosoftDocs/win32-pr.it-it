...
keywords:
- Schema AD della classe posixAccount
topic_type:
- apiref
api_name:
- posixAccount
...
ms.locfileid: "118959730"
---
# <a name="posixaccount-class"></a>Classe posixAccount

Rappresenta un'astrazione di un account con attributi POSIX (Portable Operating System Interface).
...
| [**Nome comune**](a-cn.md)                                                 | Falso     | **PosixAccount** [ **Top**](c-top.md)<br/> |
| [**Create-Time-Stamp**](a-createtimestamp.md)                              | Falso     | [**In alto**](c-top.md)<br/>                  |
| [**Descrizione**](a-description.md)                                        | Falso     | **PosixAccount** [ **Top**](c-top.md)<br/> |
...
| [**gecos**](a-gecos.md)                                                    | Falso     | **posixAccount**                                 |
| [**gidNumber**](a-gidnumber.md)                                            | Falso     | **posixAccount**                                 |
| [**Home directory**](a-homedirectory.md)                                   | Falso     | **posixAccount**                                 |
...
| [**loginShell**](a-loginshell.md)                                          | Falso     | **posixAccount**                                 |
...
| [**Uid**](a-uid.md)                                                        | Falso     | **posixAccount**                                 |
| [**uidNumber**](a-uidnumber.md)                                            | Falso     | **posixAccount**                                 |
| [**unixHomeDirectory**](a-unixhomedirectory.md)                            | Falso     | **posixAccount**                                 |
| [**unixUserPassword**](a-unixuserpassword.md)                              | Falso     | **posixAccount**                                 |
| [**Password utente**](a-userpassword.md)                                     | Falso     | **posixAccount**                                 |
...
| [**unixHomeDirectory**](a-unixhomedirectory.md)                                             | Falso     | **posixAccount**                                 |
| [**unixUserPassword**](a-unixuserpassword.md)                                               | Falso     | **posixAccount**                                 |
| [**User-Password**](a-userpassword.md)                                                      | Falso     | **posixAccount**                                 |
