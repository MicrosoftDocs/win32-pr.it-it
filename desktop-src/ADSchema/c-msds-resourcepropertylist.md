...
description: Un oggetto di questa classe contiene un elenco di proprietà della risorsa.
ms.assetid: e1777452-073f-4a7d-b593-fbb1c50d2421
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Resource-Property-List
- Schema AD della classe msDS-ResourcePropertyList
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422365"
---
# <a name="ms-ds-resource-property-list-class"></a>Classe ms-DS-Resource-Property-List

Un oggetto di questa classe contiene un elenco di proprietà della risorsa.
