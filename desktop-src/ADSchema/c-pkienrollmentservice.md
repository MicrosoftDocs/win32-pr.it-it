---
title: Classe PKI-Enrollment-Service
description: Server di certificati in grado di elaborare le richieste di certificati ed emettere certificati.
ms.assetid: c0e9b6b3-953d-413b-9817-8d7f125e2020
ms.tgt_platform: multiple
keywords:
- Schema AD della classe PKI-Enrollment-Service
- Schema AD della classe pKIEnrollmentService
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753071"
---
# <a name="pki-enrollment-service-class"></a>Classe PKI-Enrollment-Service

Server di certificati in grado di elaborare le richieste di certificati ed emettere certificati.
...
| [**Certificato CA**](a-cacertificate.md)                                 | Falso     | **PKI-Enrollment-Service**      |
...
| [**Modelli di certificato**](a-certificatetemplates.md)                   | Falso     | **PKI-Enrollment-Service**      |
...
| [**Provider di registrazione**](a-enrollmentproviders.md)                     | Falso     | **PKI-Enrollment-Service**      |
...
| [**Algoritmi di firma**](a-signaturealgorithms.md)                     | Falso     | **PKI-Enrollment-Service**      |
...
| [**Firma DSA**](a-dsasignature.md)                                     | Falso     | [**In alto**](c-top.md)<br/> |
| [**DS-Core-Propagation-Data**](a-dscorepropagationdata.md)                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Provider di registrazioni**](a-enrollmentproviders.md)                       | Falso     | **PKI-Enrollment-Service**      |
| [**Extension-Name**](a-extensionname.md)                                   | Falso     | [**In alto**](c-top.md)<br/> |
| [**Bandiere**](a-flags.md)                                                    | Falso     | [**In alto**](c-top.md)<br/> |
| [**From-Entry**](a-fromentry.md)                                           | Falso     | [**In alto**](c-top.md)<br/> |
| [**Frs-Computer-Reference-BL**](a-frscomputerreferencebl.md)               | Falso     | [**In alto**](c-top.md)<br/> |
