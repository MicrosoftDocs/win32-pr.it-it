...
---
# <a name="initial-auth-incoming-attribute"></a>Attributo Initial-auth-in ingresso

Contiene informazioni su una richiesta di autenticazione in ingresso iniziale da un client a questo server. Questa richiesta viene quindi inviata dal server al server di autenticazione per il dominio.



| Voce | Valore |
|-------------------|---------------------------------------------|
| CN                | Autenticazione iniziale-in ingresso                       |
| LDAP-Display-Name | initialAuthIncoming                         |
| Dimensione              | \-                                          |
