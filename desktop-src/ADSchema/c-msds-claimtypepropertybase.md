...
Classe astratta che definisce la classe di base per le classi di proprietà del tipo di attestazione o delle risorse.
...
| [**ms-DS-Claim-possibili-valori**](a-msds-claimpossiblevalues.md)                            | Falso     | **ms-DS-Claim-Type-Property-base** |
