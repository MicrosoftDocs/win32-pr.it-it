...
description: Classe astratta che definisce la classe di base per le classi di proprietà del tipo di attestazione o della risorsa.
ms.assetid: 85ec891b-0fdd-4b65-bc4d-6d0d2ca4e85d
ms.tgt_platform: multiple
keywords:
- Ms-DS-Claim-Type-Property-Base class AD Schema
- Schema AD della classe msDS-ClaimTypePropertyBase
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422786"
---
# <a name="ms-ds-claim-type-property-base-class"></a>Classe ms-DS-Claim-Type-Property-Base

Classe astratta che definisce la classe di base per le classi di proprietà del tipo di attestazione o della risorsa.
...
| [**Abilitato**](a-enabled.md)                                                                 | Falso     | **ms-DS-Claim-Type-Property-Base** |
