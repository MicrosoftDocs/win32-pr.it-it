...
description: Supporta i tipi di parametro di cui non si sa nulla, quindi vengono trasportati come oggetti WMI compilati.
ms.assetid: a513da7c-8169-4f78-b5ef-a035076faa86
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-UnknownRangeParam
- Schema AD della classe msWMI-UnknownRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753618"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>Classe ms-WMI-UnknownRangeParam

Supporta i tipi di parametro di cui non si sa nulla, quindi vengono trasportati come oggetti WMI compilati.
