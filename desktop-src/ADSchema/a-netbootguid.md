...
---
# <a name="netboot-guid-attribute"></a>Attributo per il GUID

Avvio senza dischi: GUID a bordo di un computer. Corrisponde all'indirizzo MAC della scheda di rete del computer.
