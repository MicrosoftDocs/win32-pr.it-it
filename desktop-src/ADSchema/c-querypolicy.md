---
title: Query-Policy classe
description: Contiene limiti amministrativi per le risorse del server LDAP per i risultati ordinati e di cui è stato paginato.
ms.assetid: 3dc5cbf1-cace-4b6b-8bc7-6907ec089025
ms.tgt_platform: multiple
keywords:
- Query-Policy schema AD della classe
- Schema AD della classe queryPolicy
topic_type:
- apiref
api_name:
- Query-Policy
...
ms.locfileid: "119753031"
---
# <a name="query-policy-class"></a>Query-Policy classe

Contiene limiti amministrativi per le risorse del server LDAP per i risultati ordinati e di cui è stato paginato.
...
| [**Ldap-Admin-Limits**](a-ldapadminlimits.md)                            | Falso     | **Criteri di query**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                              | Falso     | **Criteri di query**                |
