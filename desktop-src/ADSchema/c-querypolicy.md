...
---
# <a name="query-policy-class"></a>Classe Query-Policy

Include limiti amministrativi per le risorse del server LDAP per i risultati ordinati e di paging.
...
| [**LDAP-admin-limiti**](a-ldapadminlimits.md)                            | Falso     | **Query-criteri**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                              | Falso     | **Query-criteri**                |
