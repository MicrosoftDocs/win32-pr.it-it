...
description: La classe di oggetto domainRelatedObject viene usata per definire una voce che rappresenta una serie di documenti.
ms.assetid: 358470d8-7799-4609-b8a1-01646d6ce09e
ms.tgt_platform: multiple
keywords:
- Schema AD della classe domainRelatedObject
topic_type:
- apiref
api_name:
- domainRelatedObject
...
ms.locfileid: "119324711"
---
# <a name="domainrelatedobject-class"></a>Classe domainRelatedObject

La classe di oggetto domainRelatedObject viene usata per definire una voce che rappresenta una serie di documenti.
...
| Ldap-Display-Name | domainRelatedObject                  |
| Aggiorna privilegio  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 8bfd2d3d-efda-4549-852c-f85e137aedc6 |
...
| [**associatedDomain**](a-associateddomain.md)                              | Falso     | **domainRelatedObject**         |
