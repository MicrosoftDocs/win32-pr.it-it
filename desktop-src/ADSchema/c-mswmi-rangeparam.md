...
---
# <a name="ms-wmi-rangeparam-class"></a>Classe MS-WMI-RangeParam

Classe di parametri di intervallo che rappresenta la base di PolicyTemplate. Viene descritta una proprietà mergeable della destinazione. Ogni sottoclasse implementa un tipo specifico. Implementa il metodo Merge per supportare l'Unione. Implementa un metodo Resolve per generare la proprietà di destinazione finale.
...
| [**MS-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Vero      | **MS-WMI-RangeParam**           |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vero      | **MS-WMI-RangeParam**           |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | Vero      | **MS-WMI-RangeParam**           |
