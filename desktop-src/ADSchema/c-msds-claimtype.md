...
---
# <a name="ms-ds-claim-type-class"></a>Classe ms-DS-Claim-Type

Un'istanza di questa classe include la definizione di un tipo di attestazione che può essere definita sulle entità di sicurezza.
...
| Sottoclasse di                 | [**ms-DS-Claim-Type-Property-base**](c-msds-claimtypepropertybase.md)<br/>            |
| Possibili superiori          | [**ms-DS-Claim-Types**](c-msds-claimtypes.md)                                               |
| Classi ausiliarie           | \-                                                                                           |
...
| [**Abilitato**](a-enabled.md)                                                                 | Falso     | [**ms-DS-Claim-Type-Property-base**](c-msds-claimtypepropertybase.md)<br/> |
...
| [**ms-DS-Claim-attribute-source**](a-msds-claimattributesource.md)                          | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-Claim-is-a valore singolo**](a-msds-claimissinglevalued.md)                           | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-Claim-is-value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-Claim-possibili-valori**](a-msds-claimpossiblevalues.md)                            | Falso     | [**ms-DS-Claim-Type-Property-base**](c-msds-claimtypepropertybase.md)<br/> |
...
| [**ms-DS-Claim-source**](a-msds-claimsource.md)                                             | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-Claim-Source-Type**](a-msds-claimsourcetype.md)                                    | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-Claim-Type-si applica alla classe**](a-msds-claimtypeappliestoclass.md)                  | Falso     | **ms-DS-Claim-Type**                                                              |
| [**ms-DS-claim-value-type**](a-msds-claimvaluetype.md)                                      | Falso     | **ms-DS-Claim-Type**                                                              |
