...
description: Un'istanza di questa classe contiene la definizione di un tipo di attestazione che può essere definito nelle entità di sicurezza.
ms.assetid: 7edfd085-ab6e-47f3-8e36-793946f06049
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Claim-Type
- Schema AD della classe msDS-ClaimType
topic_type:
- apiref
api_name:
- ms-DS-Claim-Type
...
ms.locfileid: "119922451"
---
# <a name="ms-ds-claim-type-class"></a>Classe ms-DS-Claim-Type

Un'istanza di questa classe contiene la definizione di un tipo di attestazione che può essere definito nelle entità di sicurezza.
...
| Schema-Id-Guid    | 81a3857c-5469-4d8f-aae6-c276999762604 |
...
| [**ms-DS-Claim-Is-Single-Valued**](a-msds-claimissinglevalued.md)                           | Falso     | **ms-DS-Claim-Type**                                                              |
...
| [**ms-DS-Claim-Type-Applies-To-Class**](a-msds-claimtypeappliestoclass.md)                  | Falso     | **ms-DS-Claim-Type**                                                              |
