...
---
# <a name="application-version-class"></a>Classe Application-Version

Può essere utilizzato dagli sviluppatori di applicazioni per archiviare le informazioni sulla versione relative all'applicazione o al relativo schema.
...
| [**Parole chiave**](a-keywords.md)                                              | Falso     | **Versione applicazione**                                          |
...
| [**Versione-numero-Ciao**](a-versionnumberhi.md)                              | Falso     | **Versione applicazione**                                          |
