...
description: Un oggetto di questa classe contiene l'unico set di criteri di trasformazione delle attestazioni per la trasformazione delle attestazioni tra foreste. | Classe ms-DS-Claims-Transformation-Policies
ms.assetid: d6e188b3-0ff2-4888-8e19-277d642de68e
ms.tgt_platform: multiple
keywords:
- Classe MS-DS-Claims-Transformation-Policies Schema di ACTIVE Directory
- Schema AD della classe msDS-ClaimsTransformationPolicies
topic_type:
- apiref
api_name:
...
ms.locfileid: "118680701"
---
# <a name="ms-ds-claims-transformation-policies-class"></a>Classe ms-DS-Claims-Transformation-Policies
