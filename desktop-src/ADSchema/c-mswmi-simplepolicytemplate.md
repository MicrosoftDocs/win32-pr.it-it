...
description: Fornisce un tipo di modello che non può essere unito. Usato nei casi in cui l'oggetto di destinazione non deve essere combinato (unito).
...
Fornisce un tipo di modello che non può essere unito. Usato nei casi in cui l'oggetto di destinazione non deve essere combinato (unito).
