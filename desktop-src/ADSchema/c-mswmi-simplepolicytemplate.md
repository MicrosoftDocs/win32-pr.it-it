...
description: Fornisce un tipo di modello che non può essere unito. Utilizzato nei casi in cui l'oggetto di destinazione non deve essere combinato (unito).
ms.assetid: 49ef0059-6ee1-4c1a-b02e-1f3a2dd06c64
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-SimplePolicyTemplate
- Schema AD della classe msWMI-SimplePolicyTemplate
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753614"
---
# <a name="ms-wmi-simplepolicytemplate-class"></a>Classe ms-WMI-SimplePolicyTemplate

Fornisce un tipo di modello che non può essere unito. Utilizzato nei casi in cui l'oggetto di destinazione non deve essere combinato (unito).
...
| Sottoclasse di                 | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/>                                 |
| Possibili superiori          | [**Contenitore**](c-container.md)                                                                   |
| Classi ausiliarie           | \-                                                                                                 |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                       |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPCCDCLCLODTRC;;; Au) |
...
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
...
| [**ms-WMI-Name**](a-mswmi-name.md)                                         | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
...
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**ms-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Vero      | **ms-WMI-SimplePolicyTemplate**                                    |
| [**ms-WMI-TargetPath**](a-mswmi-targetpath.md)                             | Vero      | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
