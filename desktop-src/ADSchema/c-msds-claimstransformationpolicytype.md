...
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>ms-DS-Claims-Transformation-Policy-Type (classe)

Un oggetto di questa classe include un set di criteri di trasformazione delle attestazioni per la trasformazione delle attestazioni tra foreste.
...
| [**ms-DS-Transformation-Rules-compilato**](a-msds-transformationrulescompiled.md)            | Falso     | **ms-DS-Claims-Transformation-Policy-type** |
