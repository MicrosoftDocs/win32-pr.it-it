...
description: Un oggetto di questa classe contiene l'unico set di criteri di trasformazione delle attestazioni per la trasformazione delle attestazioni tra foreste. | Classe ms-DS-Claims-Transformation-Policy-Type
ms.assetid: 5368ea9a-0fd7-4b0e-8b49-d5c3ee3cb09c
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Claims-Transformation-Policy-Type
- Schema AD della classe msDS-ClaimsTransformationPolicyType
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880221"
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>Classe ms-DS-Claims-Transformation-Policy-Type

Un oggetto di questa classe contiene l'unico set di criteri di trasformazione delle attestazioni per la trasformazione delle attestazioni tra foreste.
...
| Possibili superiori          | [**ms-DS-Claims-Transformation-Policies**](c-msds-claimstransformationpolicies.md) |
| Classi ausiliarie           | \-                                                                                  |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                        |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)          |
...
| [**ms-DS-Transformation-Rules-Compiled**](a-msds-transformationrulescompiled.md)            | Falso     | **ms-DS-Claims-Transformation-Policy-Type** |
