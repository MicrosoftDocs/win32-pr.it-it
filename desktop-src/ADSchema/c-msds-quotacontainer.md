...
Contiene tutte le specifiche di quota per il database di directory.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ms-DS-quota-contenitore                |
...
| Possibili superiori          | [**Dominio-**](c-domaindns.md)[**configurazione** DNS](c-configuration.md)                                 |
| Classi ausiliarie           | \-                                                                                                        |
...
| [**Nome comune**](a-cn.md)                                                 | Vero      | **ms-DS-quota-contenitore** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-default-quota**](a-msds-defaultquota.md)                          | Falso     | **ms-DS-quota-contenitore**                                 |
...
| [**ms-DS-quota-effettivo**](a-msds-quotaeffective.md)                      | Falso     | **ms-DS-quota-contenitore**                                 |
| [**ms-DS-quota utilizzata**](a-msds-quotaused.md)                                | Falso     | **ms-DS-quota-contenitore**                                 |
...
| [**ms-DS-Tombstone-quota-fattore**](a-msds-tombstonequotafactor.md)         | Falso     | **ms-DS-quota-contenitore**                                 |
| [**ms-DS-Top-quota-utilizzo**](a-msds-topquotausage.md)                       | Falso     | **ms-DS-quota-contenitore**                                 |
