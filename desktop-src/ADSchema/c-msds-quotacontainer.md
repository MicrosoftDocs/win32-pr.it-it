...
description: Contiene tutte le specifiche di quota per il database della directory.
ms.assetid: 47ae1632-dad0-47d5-97f3-47b22d4d04f5
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Quota-Container
- Schema AD della classe msDS-QuotaContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879881"
---
# <a name="ms-ds-quota-container-class"></a>Classe ms-DS-Quota-Container

Contiene tutte le specifiche di quota per il database della directory.
...
| Possibili superiori          | [**Configurazione dns di**](c-domaindns.md)[**dominio**](c-configuration.md)                                 |
| Classi ausiliarie           | \-                                                                                                        |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                              |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; BA)(OA;; CR;4ecc03fe-ffc0-4947-b630-eb672a8a9dbc;; WD) |
...
| [**Nome comune**](a-cn.md)                                                 | Vero      | **ms-DS-Quota-Container** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Default-Quota**](a-msds-defaultquota.md)                          | Falso     | **ms-DS-Quota-Container**                                 |
...
| [**ms-DS-Quota-Effective**](a-msds-quotaeffective.md)                      | Falso     | **ms-DS-Quota-Container**                                 |
| [**ms-DS-Quota-Used**](a-msds-quotaused.md)                                | Falso     | **ms-DS-Quota-Container**                                 |
...
| [**ms-DS-Tombstone-Quota-Factor**](a-msds-tombstonequotafactor.md)         | Falso     | **ms-DS-Quota-Container**                                 |
| [**ms-DS-Top-Quota-Usage**](a-msds-topquotausage.md)                       | Falso     | **ms-DS-Quota-Container**                                 |
