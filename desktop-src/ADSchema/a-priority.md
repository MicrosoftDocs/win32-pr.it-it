...
description: Priorità corrente (di un processo, un processo di stampa e così via).
...
ms.locfileid: "118423842"
---
# <a name="priority-attribute"></a>Attributo Priority

Priorità corrente (di un processo, un processo di stampa e così via).
