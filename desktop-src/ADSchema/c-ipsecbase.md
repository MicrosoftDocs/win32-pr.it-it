---
title: Ipsec-Base classe
description: Classe di base IPSEC da cui derivano tutte le classi IPSEC.
ms.assetid: 2e1bd416-398f-47e1-a13e-947924bb50c2
ms.tgt_platform: multiple
keywords:
- Ipsec-Base schema AD della classe
- Schema AD della classe ipsecBase
topic_type:
- apiref
api_name:
- Ipsec-Base
...
ms.locfileid: "119922561"
---
# <a name="ipsec-base-class"></a>Ipsec-Base classe

Classe di base IPSEC da cui derivano tutte le classi IPSEC.
...
| [**Ipsec-Data**](a-ipsecdata.md)                                         | Falso     | **Ipsec-Base**                  |
| [**Ipsec-Data-Type**](a-ipsecdatatype.md)                                | Falso     | **Ipsec-Base**                  |
| [**IPSEC-ID**](a-ipsecid.md)                                             | Falso     | **Ipsec-Base**                  |
| [**Ipsec-Name**](a-ipsecname.md)                                         | Falso     | **Ipsec-Base**                  |
| [**Riferimento a Ipsec-Owners-Reference**](a-ipsecownersreference.md)                  | Falso     | **Ipsec-Base**                  |
...
| [**Tipo di istanza**](a-instancetype.md)                                     | Vero      | [**In alto**](c-top.md)<br/> |
| [**Ipsec-Data**](a-ipsecdata.md)                                           | Falso     | **Ipsec-Base**                  |
| [**Tipo di dati Ipsec**](a-ipsecdatatype.md)                                  | Falso     | **Ipsec-Base**                  |
| [**IPSEC-ID**](a-ipsecid.md)                                               | Falso     | **Ipsec-Base**                  |
| [**Ipsec-Name**](a-ipsecname.md)                                           | Falso     | **Ipsec-Base**                  |
| [**Informazioni di riferimento su Ipsec-Owners**](a-ipsecownersreference.md)                    | Falso     | **Ipsec-Base**                  |
| [**Is-Critical-System-Object**](a-iscriticalsystemobject.md)               | Falso     | [**In alto**](c-top.md)<br/> |
| [**Is-Deleted**](a-isdeleted.md)                                           | Falso     | [**In alto**](c-top.md)<br/> |
