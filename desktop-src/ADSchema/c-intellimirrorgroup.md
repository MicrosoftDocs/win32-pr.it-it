...
---
# <a name="intellimirror-group-class"></a>Classe Intellimirror-Group

Legacy di avvio remoto per la gestione dei gruppi di computer server. Attualmente non utilizzato.
