...
---
# <a name="msmq-custom-recipient-class"></a>Classe MSMQ-Custom-Recipient

Utilizzato per definire un destinatario MSMQ personalizzato, noto anche come coda di alias. Definisce un alias per una coda out-of-Enterprise. Contiene il nome del formato di tale coda.



| Voce | Valore |
|-------------------|------------------------------------------|
| CN                | MSMQ-personalizzato-destinatario                    |
| LDAP-Display-Name | msMQ-personalizzato-destinatario                    |
| Privilegio aggiornamento  | Proprietario della coda.                         |
| Frequenza di aggiornamento  | Solo dopo lo spostamento della coda esterna. |
...
| [**MSMQ-Recipient-FormatName**](a-msmq-recipient-formatname.md)            | Falso     | **MSMQ-personalizzato-destinatario**       |
