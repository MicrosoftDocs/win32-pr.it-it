...
Rappresenta un server o un set di server DHCP.
...
| [**Identificazione DHCP**](a-dhcpidentification.md)                       | Vero      | **Classe DHCP**                  |
| [**Maschera DHCP**](a-dhcpmask.md)                                           | Falso     | **Classe DHCP**                  |
...
| [**Opzioni DHCP**](a-dhcpoptions.md)                                     | Falso     | **Classe DHCP**                  |
| [**Proprietà DHCP**](a-dhcpproperties.md)                               | Falso     | **Classe DHCP**                  |
| [**DHCP-intervalli**](a-dhcpranges.md)                                       | Falso     | **Classe DHCP**                  |
| [**Prenotazioni DHCP**](a-dhcpreservations.md)                           | Falso     | **Classe DHCP**                  |
| [**Server DHCP**](a-dhcpservers.md)                                     | Falso     | **Classe DHCP**                  |
| [**DHCP-siti**](a-dhcpsites.md)                                         | Falso     | **Classe DHCP**                  |
| [**Stato DHCP**](a-dhcpstate.md)                                         | Falso     | **Classe DHCP**                  |
| [**DHCP-subnet**](a-dhcpsubnets.md)                                     | Falso     | **Classe DHCP**                  |
| [**Tipo DHCP**](a-dhcptype.md)                                           | Vero      | **Classe DHCP**                  |
| [**DHCP-chiave univoca**](a-dhcpuniquekey.md)                                | Vero      | **Classe DHCP**                  |
| [**DHCP-tempo di aggiornamento**](a-dhcpupdatetime.md)                              | Falso     | **Classe DHCP**                  |
...
| [**ID di mscope**](a-mscopeid.md)                                           | Falso     | **Classe DHCP**                  |
...
| [**Descrizione di Super-Scope**](a-superscopedescription.md)                | Falso     | **Classe DHCP**                  |
| [**Ambiti avanzati**](a-superscopes.md)                                     | Falso     | **Classe DHCP**                  |
