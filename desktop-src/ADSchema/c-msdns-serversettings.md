---
title: Classe ms-DNS-Server-Impostazioni
...
keywords:
- Schema AD della classe ms-DNS-Server-Impostazioni
- Schema AD della classe msDNS-ServerSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880611"
---
# <a name="ms-dns-server-settings-class"></a>Classe ms-DNS-Server-Impostazioni
...
| [**ms-DNS-Keymaster-Zones**](a-msdns-keymasterzones.md)                                     | Falso     | **ms-DNS-Server-Impostazioni**      |
