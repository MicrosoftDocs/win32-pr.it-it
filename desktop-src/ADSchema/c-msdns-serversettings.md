...
Contenitore per l'archiviazione delle impostazioni del server DNS.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | MS-DNS-server-impostazioni               |
...
| [**MS-DNS-master zone**](a-msdns-keymasterzones.md)                                     | Falso     | **MS-DNS-server-impostazioni**      |
