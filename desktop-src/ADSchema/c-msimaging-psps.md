...
description: Contenitore per tutti Enterprise oggetto Scan Post Scan Process.
ms.assetid: aa0315e1-973b-4066-a5e3-834149c1ab7f
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-Imaging-PSPs
- Schema AD della classe msImaging-PSPs
topic_type:
- apiref
api_name:
- ms-Imaging-PSPs
...
ms.locfileid: "118175735"
---
# <a name="ms-imaging-psps-class"></a>Classe ms-Imaging-PSPs

Contenitore per tutti Enterprise oggetto Scan Post Scan Process.
