...
---
# <a name="ms-imaging-psps-class"></a>Classe MS-Imaging-PSP

Contenitore per tutti gli oggetti processo di post-analisi Enterprise Scan.
...
|-------------------|--------------------------------------|
| CN                | MS-Imaging-PSP                      |
| LDAP-Display-Name | msImaging-PSP                       |
| Privilegio aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | a0ed2ac1-970c-4777-848e-ec63a0ec44fc |
