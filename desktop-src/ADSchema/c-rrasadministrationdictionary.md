...
description: Oggetto dizionario per la conversione degli attributi di routing specifici del fornitore in nomi.
ms.assetid: 52318b1d-a76f-4293-91f5-a63288c6f0be
ms.tgt_platform: multiple
keywords:
- Schema AD della classe RRAS-Administration-Dictionary
- Schema AD della classe rRASAdministrationDictionary
topic_type:
- apiref
api_name:
...
ms.locfileid: "119801471"
---
# <a name="rras-administration-dictionary-class"></a>Classe RRAS-Administration-Dictionary

Oggetto dizionario per la conversione degli attributi di routing specifici del fornitore in nomi.
...
| [**ms-RRAS-Vendor-Attribute-Entry**](a-msrrasvendorattributeentry.md)    | Falso     | **RRAS-Administration-Dictionary** |
