...
---
# <a name="msmq-enterprise-settings-class"></a>Classe MSMQ-Enterprise-Settings

Oggetto con informazioni generali su MSMQ. Si trova in \\ servizi di configurazione \\ . Può essere presente solo uno di questi in una foresta. Questo oggetto contiene informazioni di configurazione a livello di organizzazione per l'accodamento dei messaggi.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | MSMQ-Enterprise-impostazioni             |
| LDAP-Display-Name | mSMQEnterpriseSettings               |
| Privilegio aggiornamento  | Proprietario della coda.                     |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | 9a0dc345-c100-11d1-bbc5-0080c76670c0 |
...
| [**MSMQ-CSP-Name**](a-msmqcspname.md)                                    | Falso     | **MSMQ-Enterprise-impostazioni**    |
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | Falso     | **MSMQ-Enterprise-impostazioni**    |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | Falso     | **MSMQ-Enterprise-impostazioni**    |
| [**MSMQ-durata**](a-msmqlonglived.md)                                | Falso     | **MSMQ-Enterprise-impostazioni**    |
| [**MSMQ-stile nome**](a-msmqnamestyle.md)                                | Falso     | **MSMQ-Enterprise-impostazioni**    |
| [**MSMQ-versione**](a-msmqversion.md)                                     | Falso     | **MSMQ-Enterprise-impostazioni**    |
