...
description: Rappresenta un contenitore per gli oggetti ms-DFSR-ContentSet.
ms.assetid: b1defe9e-46d8-4db8-b885-0196fd218332
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DFSR-Content
- Schema AD della classe msDFSR-Content
topic_type:
- apiref
api_name:
- ms-DFSR-Content
...
ms.locfileid: "119880691"
---
# <a name="ms-dfsr-content-class"></a>Classe ms-DFSR-Content

Rappresenta un contenitore [**per gli oggetti ms-DFSR-ContentSet.**](c-msdfsr-contentset.md)
...
| Possibili superiori          | [**ms-DFSR-ReplicationGroup**](c-msdfsr-replicationgroup.md)                                                                    |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**Ms-DFSR-Extension**](a-msdfsr-extension.md)                             | Falso     | **ms-DFSR-Content**             |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falso     | **ms-DFSR-Content**             |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falso     | [**In alto**](c-top.md)<br/> |
| [**Ms-DFSR-Options**](a-msdfsr-options.md)                                 | Falso     | **ms-DFSR-Content**             |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | Falso     | **ms-DFSR-Content**             |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | Falso     | **ms-DFSR-Content**             |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | Falso     | [**In alto**](c-top.md)<br/> |
...
La **classe ms-DFSR-Content** fa parte del supporto del servizio replica file system distribuito (DFS).
