...
Rappresenta un contenitore per gli oggetti [**MS-DFSR-contentt**](c-msdfsr-contentset.md) .
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-content                      |
| LDAP-Display-Name | msDFSR-contenuto                       |
...
| [**Flag MS-DFSR**](a-msdfsr-flags.md)                                     | Falso     | **MS-DFSR-content**             |
...
La classe **MS-DFSR-content** fa parte del supporto del servizio di replica file System distribuito (DFS).
