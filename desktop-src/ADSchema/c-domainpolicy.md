...
---
# <a name="domain-policy-class"></a>Classe Domain-Policy

Definisce i criteri dell'autorità di sicurezza locale per uno o più domini.
...
| Possibili superiori          | Dominio [**contenitore**](c-container.md)[**-**](c-domaindns.md)[**unità organizzativa**](c-organizationalunit.md) DNS |
| Classi ausiliarie           | \-                                                                                                                   |
...
| [**Opzioni di autenticazione**](a-authenticationoptions.md)                 | Falso     | **Criteri di dominio**               |
...
| [**Default-local-Policy-Object**](a-defaultlocalpolicyobject.md)         | Falso     | **Criteri di dominio**               |
...
| [**Dominio-autorità di certificazione**](a-domaincas.md)                     | Falso     | **Criteri di dominio**               |
| [**Domain-Policy-Reference**](a-domainpolicyreference.md)                | Falso     | **Criteri di dominio**               |
| [**Criteri a livello di dominio**](a-domainwidepolicy.md)                          | Falso     | **Criteri di dominio**               |
...
| [**EFSPolicy**](a-efspolicy.md)                                          | Falso     | **Criteri di dominio**               |
| [**Nome estensione**](a-extensionname.md)                                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Bandiere**](a-flags.md)                                                  | Falso     | [**In alto**](c-top.md)<br/> |
| [**Forza disconnessione**](a-forcelogoff.md)                                     | Falso     | **Criteri di dominio**               |
...
| [**IPSec-criteri-riferimento**](a-ipsecpolicyreference.md)                  | Falso     | **Criteri di dominio**               |
...
| [**Blocco-durata**](a-lockoutduration.md)                             | Falso     | **Criteri di dominio**               |
| [**Lock-out-osservazione-finestra**](a-lockoutobservationwindow.md)         | Falso     | **Criteri di dominio**               |
| [**Soglia di blocco**](a-lockoutthreshold.md)                           | Falso     | **Criteri di dominio**               |
| [**Gestito da**](a-managedby.md)                                         | Falso     | **Criteri di dominio**               |
| [**Oggetti gestiti**](a-managedobjects.md)                               | Falso     | [**In alto**](c-top.md)<br/> |
| [**Mastered-by**](a-masteredby.md)                                       | Falso     | [**In alto**](c-top.md)<br/> |
| [**Max-pwd-Age**](a-maxpwdage.md)                                        | Falso     | **Criteri di dominio**               |
| [**Max-rinnovo-Age**](a-maxrenewage.md)                                    | Falso     | **Criteri di dominio**               |
| [**Numero massimo-ticket-Age**](a-maxticketage.md)                                  | Falso     | **Criteri di dominio**               |
| [**Min-pwd-Age**](a-minpwdage.md)                                        | Falso     | **Criteri di dominio**               |
| [**Min-pwd-length**](a-minpwdlength.md)                                  | Falso     | **Criteri di dominio**               |
| [**Min-ticket-Age**](a-minticketage.md)                                  | Falso     | **Criteri di dominio**               |
...
| [**Durata proxy**](a-proxylifetime.md)                                 | Falso     | **Criteri di dominio**               |
| [**Public-Key-policy**](a-publickeypolicy.md)                            | Falso     | **Criteri di dominio**               |
| [**Pwd-cronologia-lunghezza**](a-pwdhistorylength.md)                          | Falso     | **Criteri di dominio**               |
| [**Pwd-proprietà**](a-pwdproperties.md)                                 | Falso     | **Criteri di dominio**               |
| [**Qualità del servizio**](a-qualityofservice.md)                          | Falso     | **Criteri di dominio**               |
