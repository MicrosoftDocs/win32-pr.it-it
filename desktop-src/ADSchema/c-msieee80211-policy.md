...
---
# <a name="ms-ieee-80211-policy-class"></a>Classe MS-IEEE-80211-Policy

Classe per archiviare l'oggetto Criteri di rete wireless.
...
| LDAP-Display-Name | msieee80211-criteri                                                               |
| Privilegio aggiornamento  | Amministratore di dominio                                                             |
| Frequenza di aggiornamento  | Ogni volta che un amministratore di dominio modifica i criteri di rete wireless per un dominio o un'unità organizzativa. |
...
| [**MS-IEEE-80211-dati**](a-msieee80211-data.md)                            | Falso     | **MS-IEEE-80211-Policy**        |
| [**MS-IEEE-80211-tipo di dati**](a-msieee80211-datatype.md)                   | Falso     | **MS-IEEE-80211-Policy**        |
| [**MS-IEEE-80211-ID**](a-msieee80211-id.md)                                | Falso     | **MS-IEEE-80211-Policy**        |
