---
title: Country class
description: Paese/area geografica nell'indirizzo dell'utente. Si tratta del nome completo.
...
ms.locfileid: "119643721"
---
# <a name="country-class"></a>Country class

Paese/area geografica nell'indirizzo dell'utente. Si tratta del nome completo.
...
| Aggiorna privilegio  | Il proprietario dell'account o l'amministratore di dominio imposta questo valore. |
| Frequenza di aggiornamento  | Quando il paese o l'area geografica dell'utente cambia.               |
...
| Rdn-Att-Id                  | [**Nome paese**](a-c.md)<br/>                                                       |
...
| [**Guida alla ricerca**](a-searchguide.md)                                     | Falso     | **Paese**                     |
...
| [**Text-Country**](a-co.md)                                              | Falso     | **Paese**                     |
...
| Rdn-Att-Id                  | [**Nome paese**](a-c.md)<br/>                                                       |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                              |
| Possibili superiori          | [**DNS**](c-organization.md)[**di dominio dell'organizzazione**](c-domaindns.md)                      |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au) |
| System-Flags                | 0x00000010                                                                                   |
