...
---
# <a name="country-class"></a>Classe Country

Il paese/area geografica nell'indirizzo dell'utente. Si tratta del nome completo.
...
| Privilegio aggiornamento  | Il proprietario dell'account o l'amministratore di dominio imposta questo valore. |
| Frequenza di aggiornamento  | Quando il paese/area geografica dell'utente cambia.               |
...
| [**Testo-paese**](a-co.md)                                              | Falso     | **Paese**                     |
...
| RDN-att-ID                  | [**Nome paese**](a-c.md)<br/>                                                       |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                              |
| Possibili superiori          | Dominio dell' [**organizzazione**](c-organization.md)[**-DNS**](c-domaindns.md)                      |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                 |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; Au |
| System-Flags                | 0x00000010                                                                                   |
