...
---
# <a name="schema-version-attribute"></a>Attributo Schema-Version

Numero di versione per lo schema.
...
| Frequenza di aggiornamento  | Ogni volta che viene rilasciato lo schema.    |
...
| Classi utilizzate in        | [**Contenitore**](c-container.md)<br/> |
