---
title: Classe application-site-Impostazioni
description: Contiene tutte le impostazioni specifiche del sito.
ms.assetid: 9431ec9c-7647-4de8-94c0-824763ceee97
ms.tgt_platform: multiple
keywords:
- Schema AD della Impostazioni application-site-Impostazioni
- Schema AD della classe applicationSiteSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703911"
---
# <a name="application-site-settings-class"></a>Classe application-site-Impostazioni

Contiene tutte le impostazioni specifiche del sito.



| Voce | Valore |
|-------------------|------------------------------------------------------|
| CN                | Application-Site-Impostazioni                            |
| Ldap-Display-Name | applicationSiteSettings                              |
| Privilegio di aggiornamento  | Il sistema imposta questo valore.                          |
| Frequenza di aggiornamento  | Ogni volta che questo diritto esteso si applica a una nuova classe. |
...
| [**Application-Name**](a-applicationname.md)                             | Falso     | **Application-Site-Impostazioni**   |
...
| [**Elenco notifiche**](a-notificationlist.md)                           | Falso     | **Application-Site-Impostazioni**   |
