...
---
# <a name="application-site-settings-class"></a>Classe Application-Site-Settings
...
| Voce | Valore |
|-------------------|------------------------------------------------------|
| CN                | Applicazione-sito-impostazioni                            |
...
| [**Nome applicazione**](a-applicationname.md)                             | Falso     | **Applicazione-sito-impostazioni**   |
...
| [**Elenco notifiche**](a-notificationlist.md)                           | Falso     | **Applicazione-sito-impostazioni**   |
