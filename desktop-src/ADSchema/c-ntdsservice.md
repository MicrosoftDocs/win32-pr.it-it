---
title: NTDS-Service classe
description: Questa classe viene utilizzata per un oggetto servizi NTDS, che contiene informazioni sulla configurazione della foresta del servizio directory. Questo oggetto viene mantenuto in CN Directory Service,CN Windows NT,CN Services,CN Configuration,... Contenitore.
ms.assetid: 55f94e25-3871-4946-9a7e-073bec0abce5
ms.tgt_platform: multiple
keywords:
- NTDS-Service schema AD della classe
- Schema AD della classe nTDSService
topic_type:
- apiref
api_name:
- NTDS-Service
...
ms.locfileid: "119753451"
---
# <a name="ntds-service-class"></a>NTDS-Service classe

Questa classe viene utilizzata per un oggetto servizi NTDS, che contiene informazioni sulla configurazione della foresta del servizio directory. Questo oggetto viene mantenuto in CN=Directory Service,CN=Windows NT,CN=Services,CN=Configuration,... Contenitore.
...
| [**Euristica DS**](a-dsheuristics.md)                                   | Falso     | **NTDS-Service**                |
...
| [**Garbage-Coll-Period**](a-garbagecollperiod.md)                        | Falso     | **NTDS-Service**                |
...
| [**Repl-Topology-Stay-Of-Execution**](a-repltopologystayofexecution.md)  | Falso     | **NTDS-Service**                |
...
| [**Mapping SPN**](a-spnmappings.md)                                     | Falso     | **NTDS-Service**                |
...
| [**Durata rimozione definitiva**](a-tombstonelifetime.md)                         | Falso     | **NTDS-Service**                |
...
| [**ms-DS-Other-Impostazioni**](a-msds-other-settings.md)                       | Falso     | **NTDS-Service**                |
...
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)           | Falso     | [**In alto**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-Deleted-Object-Lifetime**](a-msds-deletedobjectlifetime.md)            | Falso     | **NTDS-Service**                |
