...
Questa classe viene utilizzata per un oggetto servizi NTDS, che contiene informazioni sulla configurazione della foresta del servizio directory. Questo oggetto viene mantenuto nel CN = Directory Service, CN = Windows NT, CN = Services, CN = Configuration,... contenitore.
...
| [**Servizi di dominio Active Directory-euristica**](a-dsheuristics.md)                                   | Falso     | **NTDS-Service**                |
...
| [**REPL-topologia-permanenza di esecuzione**](a-repltopologystayofexecution.md)  | Falso     | **NTDS-Service**                |
...
| [**SPN-mapping**](a-spnmappings.md)                                     | Falso     | **NTDS-Service**                |
...
| [**Rimozione definitiva-durata**](a-tombstonelifetime.md)                         | Falso     | **NTDS-Service**                |
...
| [**ms-DS-altre impostazioni**](a-msds-other-settings.md)                       | Falso     | **NTDS-Service**                |
...
| [**MS-DS-coerenza-figlio-conteggio**](a-ms-ds-consistencychildcount.md)           | Falso     | [**In alto**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-eliminato-oggetto-durata**](a-msds-deletedobjectlifetime.md)            | Falso     | **NTDS-Service**                |
