...
description: Definisce un set di operazioni che possono essere eseguite da un particolare set di utenti all'interno di un determinato ambito.
ms.assetid: 1cf0c229-8e5f-4c3b-9284-50be088ecdc3
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Az-Role
- Schema AD della classe msDS-AzRole
topic_type:
- apiref
api_name:
- ms-DS-Az-Role
...
ms.locfileid: "119880321"
---
# <a name="ms-ds-az-role-class"></a>Classe ms-DS-Az-Role

Definisce un set di operazioni che possono essere eseguite da un particolare set di utenti all'interno di un determinato ambito.
...
| Possibili superiori          | [**Ms-DS-Az-Application**](c-msds-azapplication.md)[**ms-DS-Az-Scope**](c-msds-azscope.md)[**Container**](c-container.md)     |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**Descrizione**](a-description.md)                                        | Falso     | **Ms-DS-Az-Role** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)               | Falso     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Members-For-Az-Role**](a-msds-membersforazrole.md)                | Falso     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Operations-For-Az-Role**](a-msds-operationsforazrole.md)          | Falso     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Tasks-For-Az-Role**](a-msds-tasksforazrole.md)                    | Falso     | **ms-DS-Az-Role**                                 |
...
| Rdn-Att-Id                  | [**Nome comune**](a-cn.md)<br/>                                                                                           |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                                                                  |
| Possibili superiori          | [**Contenitore ms-DS-Az-Application**](c-msds-azapplication.md)[**ms-DS-Az-Scope**](c-msds-azscope.md)[](c-container.md)     |
| Classi ausiliarie           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) |
| System-Flags                | 0x00000010                                                                                                                       |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)                  | Falso     | **ms-DS-Az-Role**                                 |
| [**ms-DS-Az-Generic-Data**](a-msds-azgenericdata.md)                          | Falso     | **ms-DS-Az-Role**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | Falso     | **ms-DS-Az-Role**                                 |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falso     | [**In alto**](c-top.md)<br/>                   |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falso     | [**In alto**](c-top.md)<br/>                   |
