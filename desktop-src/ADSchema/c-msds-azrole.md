...
Definisce un set di operazioni che possono essere eseguite da un determinato set di utenti all'interno di un ambito specifico.
...
|-------------------|-----------------------------------------|
| CN                | ms-DS-AZ-Role                           |
| LDAP-Display-Name | msDS-scheda azrole                             |
