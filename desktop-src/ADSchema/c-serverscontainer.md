---
title: Servers-Container classe
description: Contiene oggetti server in un sito.
ms.assetid: 1da4d943-1196-4425-9799-3ac44f7591f2
ms.tgt_platform: multiple
keywords:
- Servers-Container schema AD della classe
- Schema AD della classe serversContainer
topic_type:
- apiref
api_name:
- Servers-Container
...
ms.locfileid: "119533791"
---
# <a name="servers-container-class"></a>Servers-Container classe

Contiene oggetti server in un sito.
...
| Ldap-Display-Name | serversContainer                     |
| Aggiorna privilegio  | Amministratore di dominio                 |
| Frequenza di aggiornamento  | Quando viene creato un sito.              |
| Schema-Id-Guid    | f780acc0-56f0-11d1-a9c6-0000f80367c1 |
...
| Descrittore di sicurezza predefinito | D:(A;; CC;;; BA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au) |
