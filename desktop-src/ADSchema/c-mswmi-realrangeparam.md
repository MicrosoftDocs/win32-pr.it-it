...
description: Oggetto parametro dell'intervallo di numeri reali.
ms.assetid: 8cb85f16-fb13-4014-8ee9-4d513088554a
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-RealRangeParam
- Schema AD della classe msWMI-RealRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422202"
---
# <a name="ms-wmi-realrangeparam-class"></a>Classe ms-WMI-RealRangeParam

Oggetto parametro dell'intervallo di numeri reali.
...
| [**ms-WMI-int8Default**](a-mswmi-int8default.md)                           | Vero      | **ms-WMI-RealRangeParam**                                  |
| [**ms-WMI-int8Max**](a-mswmi-int8max.md)                                   | Falso     | **ms-WMI-RealRangeParam**                                  |
| [**ms-WMI-int8Min**](a-mswmi-int8min.md)                                   | Falso     | **ms-WMI-RealRangeParam**                                  |
