...
keywords:
- Schema di ACTIVE Directory della classe del sito
- site class SCHEMA di ACTIVE Directory
topic_type:
- apiref
api_name:
- Site
...
ms.locfileid: "119548921"
---
# <a name="site-class"></a>Classe del sito

Contenitore per l'archiviazione di oggetti server. Rappresenta una posizione fisica che contiene computer. Consentono di gestire le operazioni di replica.
...
| Frequenza di aggiornamento  | Ogni volta che è necessario un nuovo sito.       |
...
| Possibili superiori          | [**Sites-Container**](c-sitescontainer.md)              |
| Classi ausiliarie           | \-                                                       |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                             |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au) |
...
| [**Collegamento a Criteri di gruppo**](a-gplink.md)                                               | Falso     | **Sito**                        |
| [**Opzioni di Criteri di gruppo**](a-gpoptions.md)                                         | Falso     | **Sito**                        |
...
| [**Località**](a-location.md)                                            | Falso     | **Sito**                        |
| [**Gestito da**](a-managedby.md)                                         | Falso     | **Sito**                        |
...
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | Falso     | **Sito**                        |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | Falso     | **Sito**                        |
| [**MSMQ-Nt4-Stub**](a-msmqnt4stub.md)                                    | Falso     | **Sito**                        |
| [**MSMQ-Site-Foreign**](a-msmqsiteforeign.md)                            | Falso     | **Sito**                        |
| [**MSMQ-Site-ID**](a-msmqsiteid.md)                                      | Falso     | **Sito**                        |
...
| [**Elenco notifiche**](a-notificationlist.md)                           | Falso     | **Sito**                        |
...
| Classi ausiliarie           | \-                                                                         |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                               |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(A;; LCRPLORC;;; ED) |
| System-Flags                | 0x00000010                                                                 |
...
| [**ms-DS-BridgeHead-Servers-Used**](a-msds-bridgeheadserversused.md)          | Falso     | **Sito**                        |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falso     | [**In alto**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falso     | [**In alto**](c-top.md)<br/> |
