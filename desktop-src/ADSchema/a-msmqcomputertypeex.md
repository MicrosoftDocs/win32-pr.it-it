...
---
# <a name="msmq-computer-type-ex-attribute"></a>Attributo MSMQ-computer-Type-ex

Stringa che descrive la versione del sistema operativo e la versione MSMQ.



| Voce | Valore |
|-------------------|---------------------------------------------|
| CN                | MSMQ-computer-Type-es                       |
| LDAP-Display-Name | mSMQComputerTypeEx                          |
| Dimensione              | \-                                          |
| Privilegio aggiornamento  | \-                                          |
| Frequenza di aggiornamento  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1417                     |
| System-ID-GUID    | 18120de8-f4c4-4341-bd95-32eb5bcf7c80        |
