...
description: Classe per l'SQL Server del repository.
ms.assetid: 93a7c7f6-cb87-46cd-9609-9f50d5cb19bc
ms.tgt_platform: multiple
keywords:
- Schema AD della classe MS-SQL-SQLRepository
- Schema AD della classe mS-SQL-SQLRepository
topic_type:
- apiref
api_name:
...
ms.locfileid: "119323911"
---
# <a name="ms-sql-sqlrepository-class"></a>Classe MS-SQL-SQLRepository

Classe per l'SQL Server del repository.
...
| Ldap-Display-Name | mS-SQL-SQLRepository                 |
...
| Schema-Id-Guid    | 11d43c5c-ccef-11d2-9993-0000f87a57d4 |
...
| [**MS-SQL-Build**](a-ms-sql-build.md)                                    | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-InformationDirectory**](a-ms-sql-informationdirectory.md)      | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Version**](a-ms-sql-version.md)                                | Falso     | **MS-SQL-SQLRepository**        |
