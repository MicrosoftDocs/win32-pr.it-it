...
Classe per l'archiviazione di SQL Server proprietà del repository.
...
| [**MS-SQL-compilazione**](a-ms-sql-build.md)                                    | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Descrizione**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-InformationDirectory**](a-ms-sql-informationdirectory.md)      | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-versione**](a-ms-sql-version.md)                                | Falso     | **MS-SQL-SQLRepository**        |
