...
Questa classe viene utilizzata per creare il contenitore dell'archivio classi. Il contenitore dell'archivio classi fornisce il Framework per la distribuzione delle risorse dell'applicazione in Active Directory e rende disponibili i criteri di distribuzione per i destinatari dei criteri (ovvero utenti e computer). I privilegi di accesso e amministrazione sono controllati dalle proprietà di controllo di accesso standard nell'oggetto contenitore dell'archivio classi.
...
| Possibili superiori          | Dominio [**contenitore**](c-container.md)[**:**](c-domaindns.md)dominio aziendale DNS-[**unità**](c-organizationalunit.md)**di classe-**[**dominio**](c-domainpolicy.md) [**computer**](c-computer.md)del [**gruppo**](c-group.md)di [**utenti**](c-user.md) |
| Classi ausiliarie           | \-                                                                                                                                                                                                                                                     |
...
| [**Ultima sequenza di aggiornamento**](a-lastupdatesequence.md)                      | Falso     | **Archivio classi**                 |
