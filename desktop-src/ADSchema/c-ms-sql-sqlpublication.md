...
Classe per l'archiviazione di SQL Server proprietà della pubblicazione. Consente all'utente di esplorare le pubblicazioni disponibili per la sottoscrizione a.
...
| LDAP-Display-Name | mS-SQL-SQLPublication                |
| Privilegio aggiornamento  | Questo valore viene impostato dal sistema.     |
| Frequenza di aggiornamento  | Durante l'installazione del sistema.                     |
| Schema-ID-GUID    | 17c2f64e-ccef-11d2-9993-0000f87a57d4 |
...
| Possibili superiori          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Classi ausiliarie           | \-                                                                                           |
...
| [**MS-SQL-AllowAnonymousSubscription**](a-ms-sql-allowanonymoussubscription.md)                 | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowImmediateUpdatingSubscription**](a-ms-sql-allowimmediateupdatingsubscription.md) | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowKnownPullSubscription**](a-ms-sql-allowknownpullsubscription.md)                 | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowQueuedUpdatingSubscription**](a-ms-sql-allowqueuedupdatingsubscription.md)       | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowSnapshotFilesFTPDownloading**](a-ms-sql-allowsnapshotfilesftpdownloading.md)     | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-database**](a-ms-sql-database.md)                                                     | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-Descrizione**](a-ms-sql-description.md)                                               | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-nome**](a-ms-sql-name.md)                                                             | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-Server di pubblicazione**](a-ms-sql-publisher.md)                                                   | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-stato**](a-ms-sql-status.md)                                                         | Falso     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-ThirdParty**](a-ms-sql-thirdparty.md)                                                 | Falso     | **MS-SQL-SQLPublication**       |
| [**Tipo MS-SQL**](a-ms-sql-type.md)                                                             | Falso     | **MS-SQL-SQLPublication**       |
