...
---
# <a name="organizational-role-class"></a>Classe Organizational-Role

Questa classe viene utilizzata per gli oggetti che contengono informazioni relative a una posizione o a un ruolo all'interno di un'organizzazione, ad esempio un amministratore di sistema, un Manager e così via. Può essere usato anche per un'identità non umana in un'organizzazione.
...
| Schema-ID-GUID    | a8df74bf-c5ea-11d1-bbcb-0080c76670c0 |
...
| [**Nome comune**](a-cn.md)                                               | Vero      | **Ruolo Organizational** [ **Top**](c-top.md)<br/> |
...
| [**Fax-telefono-numero**](a-facsimiletelephonenumber.md)          | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**Nome località**](a-l.md)                                              | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**Casella Post-Office**](a-postofficebox.md)                                | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**Ruolo-occupante**](a-roleoccupant.md)                                   | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**Stato-o-provincia-nome**](a-st.md)                                    | Falso     | **Ruolo dell'organizzazione**                                 |
| [**Indirizzo via**](a-street.md)                                        | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**Numero telex**](a-telexnumber.md)                                     | Falso     | **Ruolo dell'organizzazione**                                 |
...
| [**X121-indirizzo**](a-x121address.md)                                     | Falso     | **Ruolo dell'organizzazione**                                 |
