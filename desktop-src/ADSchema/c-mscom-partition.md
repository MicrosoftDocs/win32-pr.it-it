...
description: Spazio dei nomi utilizzato da COM+ per consentire la esistenza di più versioni della stessa applicazione COM+ nello stesso computer fisico.
ms.assetid: 84e7af24-0202-4ae8-a278-0f390ddadbb3
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-COM-Partition
- Schema AD della classe msCOM-Partition
topic_type:
- apiref
api_name:
- ms-COM-Partition
...
ms.locfileid: "119643191"
---
# <a name="ms-com-partition-class"></a>Classe ms-COM-Partition

Spazio dei nomi utilizzato da COM+ per consentire la esistenza di più versioni della stessa applicazione COM+ nello stesso computer fisico.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Partizione ms-COM                     |
...
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | Falso     | **Partizione ms-COM**            |
...
| [**Mastered-By**](a-masteredby.md)                                         | Falso     | [**In alto**](c-top.md)<br/> |
| [**Modifica timestamp**](a-modifytimestamp.md)                              | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | Falso     | **ms-COM-Partition**            |
| [**ms-COM-PartitionSetLink**](a-mscom-partitionsetlink.md)                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-COM-UserLink**](a-mscom-userlink.md)                                 | Falso     | [**In alto**](c-top.md)<br/> |
