...
Spazio dei nomi utilizzato da COM+ per consentire l'esistenza di più versioni della stessa applicazione COM+ nello stesso computer fisico.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | MS-COM-partizione                     |
| LDAP-Display-Name | msCOM-partizione                      |
...
| [**MS-COM-ObjectId**](a-mscom-objectid.md)                                 | Falso     | **MS-COM-partizione**            |
