...
---
# <a name="ntds-connection-class"></a>Classe NTDS-Connection

Connessione da un controller di dominio remoto.
...
| Possibili superiori          | [**NTDS-DSA**](c-ntdsdsa.md)[**NTFRS-Replica-Set**](c-ntfrsreplicaset.md)[**NTFRS-membro**](c-ntfrsmember.md) |
| Classi ausiliarie           | \-                                                                                                               |
...
| [**Abilitato-connessione**](a-enabledconnection.md)                         | Vero      | **NTDS-connessione**             |
...
| [**Da server**](a-fromserver.md)                                       | Vero      | **NTDS-connessione**             |
...
| [**Connessione generata**](a-generatedconnection.md)                     | Falso     | **NTDS-connessione**             |
...
| [**MS-DS-replicas-NC-Reason**](a-ms-ds-replicatesncreason.md)          | Falso     | **NTDS-connessione**             |
...
| [**Opzioni**](a-options.md)                                              | Vero      | **NTDS-connessione**             |
...
| [**Pianifica**](a-schedule.md)                                            | Falso     | **NTDS-connessione**             |
...
| [**Tipo di trasporto**](a-transporttype.md)                                 | Falso     | **NTDS-connessione**             |
...
| RDN-att-ID                  | [**Nome comune**](a-cn.md)<br/> |
| Sottoclasse di                 | [**Foglia**](c-leaf.md)<br/>      |
| Possibili superiori          | [**NTDS-DSA**](c-ntdsdsa.md)          |
| Classi ausiliarie           | \-                                     |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                           |
