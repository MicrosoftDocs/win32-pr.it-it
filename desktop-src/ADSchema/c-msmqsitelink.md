...
---
# <a name="msmq-site-link-class"></a>Classe MSMQ-site-link

Contiene informazioni sulla connettività di routing MSMQ tra siti. Questo oggetto viene creato per ogni collegamento di routing creato e contiene informazioni sulla connettività. Questi oggetti sono contenuti negli oggetti dei servizi MSMQ.



| Voce | Valore |
|-------------------|-------------------------------------------------------------------|
| CN                | MSMQ-sito-collegamento                                                    |
| LDAP-Display-Name | mSMQSiteLink                                                      |
| Privilegio aggiornamento  | Proprietario della coda.                                                  |
| Frequenza di aggiornamento  | Viene creata un'istanza per ogni coppia di siti connessi. |
...
| Possibili superiori          | [**MSMQ-Enterprise-impostazioni**](c-msmqenterprisesettings.md)                                 |
| Classi ausiliarie           | \-                                                                                           |
...
| [**Costo MSMQ**](a-msmqcost.md)                                           | Vero      | **MSMQ-sito-collegamento**              |
| [**MSMQ-sito 1**](a-msmqsite1.md)                                        | Vero      | **MSMQ-sito-collegamento**              |
| [**MSMQ-sito 2**](a-msmqsite2.md)                                        | Vero      | **MSMQ-sito-collegamento**              |
| [**MSMQ-site-Gates**](a-msmqsitegates.md)                                | Falso     | **MSMQ-sito-collegamento**              |
| [**MSMQ-site-Gates-MIG**](a-msmqsitegatesmig.md)                         | Falso     | **MSMQ-sito-collegamento**              |
