...
Classe per l'archiviazione di SQL Server proprietà del database.
...
| [**Alias MS-SQL**](a-ms-sql-alias.md)                                    | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-applicazioni**](a-ms-sql-applications.md)                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Descrizione**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-parole chiave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-SQLDatabase**          |
...
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-dimensioni**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-SQLDatabase**          |
