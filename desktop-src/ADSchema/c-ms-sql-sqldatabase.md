...
description: Classe per l'archiviazione SQL Server proprietà del database.
ms.assetid: ad1d7532-534a-4220-8e19-70f7c6f36e36
ms.tgt_platform: multiple
keywords:
- Schema AD della classe MS-SQL-SQLDatabase
- Schema AD della classe mS-SQL-SQLDatabase
topic_type:
- apiref
api_name:
...
ms.locfileid: "119441191"
---
# <a name="ms-sql-sqldatabase-class"></a>Classe MS-SQL-SQLDatabase

Classe per l'archiviazione SQL Server proprietà del database.
...
| [**MS-SQL-Alias**](a-ms-sql-alias.md)                                    | Falso     | **MS-SQL-SQLDatabase**          |
| [**Ms-SQL-Applications**](a-ms-sql-applications.md)                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-SQLDatabase**          |
| [**Parole chiave SQL MS-SQL**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)          | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-SQLDatabase**          |
...
| [**MS-SQL-Description**](a-ms-sql-description.md)                          | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-SQLDatabase**          |
| [**Parole chiave ms-SQL**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                    | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)            | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-SQLDatabase**          |
| [**Ms-SQL-Size**](a-ms-sql-size.md)                                        | Falso     | **MS-SQL-SQLDatabase**          |
...
| [**MS-SQL-Description**](a-ms-sql-description.md)                               | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                         | Falso     | **MS-SQL-SQLDatabase**          |
| [**Parole chiave ms-SQL-keywords**](a-ms-sql-keywords.md)                                     | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                         | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)                 | Falso     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                             | Falso     | **MS-SQL-SQLDatabase**          |
| [**Ms-SQL-Size**](a-ms-sql-size.md)                                             | Falso     | **MS-SQL-SQLDatabase**          |
