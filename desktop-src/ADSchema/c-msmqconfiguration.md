...
---
# <a name="msmq-configuration-class"></a>Classe MSMQ-Configuration

Questo oggetto contiene i parametri di configurazione MSMQ per un computer specifico. Gli attributi di questa classe sono specifici di MSMQ e vengono utilizzati per le decisioni relative al routing MSMQ.
...
| Frequenza di aggiornamento  | Viene creata un'istanza di questa classe per ogni computer che installa MSMQ, sotto l'oggetto computer. |
...
| [**MSMQ-computer-Type**](a-msmqcomputertype.md)                          | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-computer-Type-es**](a-msmqcomputertypeex.md)                     | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-dipendenti-Client-Services**](a-msmqdependentclientservices.md)   | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-DS-servizi**](a-msmqdsservices.md)                              | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-crittografia-chiave**](a-msmqencryptkey.md)                              | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-esterno**](a-msmqforeign.md)                                     | Falso     | **Configurazione MSMQ**          |
| [**Server MSMQ-in-routing**](a-msmqinroutingservers.md)                 | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-Journal-quota**](a-msmqjournalquota.md)                          | Falso     | **Configurazione MSMQ**          |
| [**Tipo MSMQ-OS**](a-msmqostype.md)                                      | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-out-routing-server**](a-msmqoutroutingservers.md)               | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-quota**](a-msmqquota.md)                                         | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-Routing-servizi**](a-msmqroutingservices.md)                    | Falso     | **Configurazione MSMQ**          |
| [**Tipo di servizio MSMQ**](a-msmqservicetype.md)                            | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-chiave di firma**](a-msmqsignkey.md)                                    | Falso     | **Configurazione MSMQ**          |
| [**MSMQ-siti**](a-msmqsites.md)                                         | Falso     | **Configurazione MSMQ**          |
...
| Nome comune                                                              |
|--------------------------------------------------------------------------|
| [**MSMQ-ricezione-messaggio non recapitabile**](r-msmq-receive-dead-letter.md)           |
