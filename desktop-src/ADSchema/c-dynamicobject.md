---
title: Dynamic-Object classe
description: Questa classe, se presente in una voce, indica che questa voce ha una durata limitata e potrebbe scomparire automaticamente quando la durata (TDE) raggiunge lo 0. Se il client non ha fornito un valore per l'attributo entryTtl, il server ne fornirà uno.
ms.assetid: 80f3597e-14ef-4427-b3e3-09128d07f331
ms.tgt_platform: multiple
keywords:
- Dynamic-Object schema AD della classe
- Schema AD della classe dynamicObject
topic_type:
- apiref
api_name:
- Dynamic-Object
...
ms.locfileid: "119922811"
---
# <a name="dynamic-object-class"></a>Dynamic-Object classe

Questa classe, se presente in una voce, indica che questa voce ha una durata limitata e potrebbe scomparire automaticamente quando la durata (TDE) raggiunge lo 0. Se il client non ha fornito un valore per l'attributo entryTtl, il server ne fornirà uno.
...
|-------------------|--------------------------------------|
| CN                | Dynamic-Object                       |
| Ldap-Display-Name | Dynamicobject                        |
| Aggiorna privilegio  | \-                                   |
...
| [**Voce TTL**](a-entryttl.md)                                             | Falso     | **Oggetto dinamico**              |
...
| [**ms-DS-Entry-Time-To-Die**](a-msds-entry-time-to-die.md)                 | Falso     | **Oggetto dinamico**              |
...
| [**Firma DSA**](a-dsasignature.md)                                     | Falso     | [**In alto**](c-top.md)<br/> |
| [**DS-Core-Propagation-Data**](a-dscorepropagationdata.md)                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Entry-TTL**](a-entryttl.md)                                             | Falso     | **Oggetto dinamico**              |
| [**From-Entry**](a-fromentry.md)                                           | Falso     | [**In alto**](c-top.md)<br/> |
| [**FSMO-Role-Owner**](a-fsmoroleowner.md)                                  | Falso     | [**In alto**](c-top.md)<br/> |
| [**Tipo di istanza**](a-instancetype.md)                                     | Vero      | [**In alto**](c-top.md)<br/> |
| [**Is-Critical-System-Object**](a-iscriticalsystemobject.md)               | Falso     | [**In alto**](c-top.md)<br/> |
