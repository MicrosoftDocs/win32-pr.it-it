...
---
# <a name="dynamic-object-class"></a>Classe Dynamic-Object

Questa classe, se presente in una voce, indica che questa voce ha una durata limitata e può scomparire automaticamente al raggiungimento del valore di durata pari a 0. Se il client non ha fornito un valore per l'attributo entryTtl, il server ne fornirà uno.
