...
Questa classe contiene le informazioni di ripristino per un dispositivo Trusted Platform Module (TPM).
...
| Possibili superiori          | [**ms-TPM-Information-Objects-container**](c-mstpm-informationobjectscontainer.md)                  |
| Classi ausiliarie           | \-                                                                                                   |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                         |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLO;;;D C) (A;; WP;;; Co |
...
| [**ms-TPM-OwnerInformation**](a-mstpm-ownerinformation.md)                                  | Vero      | **ms-TPM-Information-Object**   |
| [**ms-TPM-Owner-Information-Temp**](a-mstpm-ownerinformationtemp.md)                        | Falso     | **ms-TPM-Information-Object**   |
| [**ms-TPM-SRK-pub-identificazione personale**](a-mstpm-srkpubthumbprint.md)                                | Falso     | **ms-TPM-Information-Object**   |
