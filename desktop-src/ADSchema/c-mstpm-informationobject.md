...
description: Questa classe contiene informazioni di ripristino per un Trusted Platform Module (TPM).
ms.assetid: 75897787-f177-4899-905d-6ae2f2f7a16f
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-TPM-Information-Object
- Schema AD della classe msTPM-InformationObject
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879311"
---
# <a name="ms-tpm-information-object-class"></a>Classe ms-TPM-Information-Object

Questa classe contiene informazioni di ripristino per un Trusted Platform Module (TPM).
