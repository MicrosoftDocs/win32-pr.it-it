---
title: Display-Specifier classe
description: Descrive i menu di scelta rapida e le pagine delle proprietà da utilizzare con un oggetto nella directory.
ms.assetid: 648f664e-0f20-4281-9ead-fd70429ed776
ms.tgt_platform: multiple
keywords:
- Display-Specifier schema AD della classe
- Schema AD della classe displaySpecifier
topic_type:
- apiref
api_name:
- Display-Specifier
...
ms.locfileid: "118959930"
---
# <a name="display-specifier-class"></a>Display-Specifier classe

Descrive i menu di scelta rapida e le pagine delle proprietà da utilizzare con un oggetto nella directory.
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**Menu di scelta rapida amministratore**](a-admincontextmenu.md)                          | Falso     | **Identificatore di visualizzazione**           |
...
| [**Admin-Property-Pages**](a-adminpropertypages.md)                      | Falso     | **Identificatore di visualizzazione**           |
...
| [**Attribute-Display-Names**](a-attributedisplaynames.md)                | Falso     | **Identificatore di visualizzazione**           |
...
| [**Class-Display-Name**](a-classdisplayname.md)                          | Falso     | **Identificatore di visualizzazione**           |
| [**Nome comune**](a-cn.md)                                               | Falso     | [**In alto**](c-top.md)<br/> |
| [**Menu di scelta rapida**](a-contextmenu.md)                                     | Falso     | **Identificatore di visualizzazione**           |
| [**Crea finestra di dialogo**](a-createdialog.md)                                   | Falso     | **Identificatore di visualizzazione**           |
| [**Create-Time-Stamp**](a-createtimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/> |
| [**Creazione guidata- Ext**](a-createwizardext.md)                            | Falso     | **Identificatore di visualizzazione**           |
| [**Creazione guidata**](a-creationwizard.md)                               | Falso     | **Identificatore di visualizzazione**           |
...
| [**Icon-Path**](a-iconpath.md)                                           | Falso     | **Identificatore di visualizzazione**           |
...
| [**Filtro query**](a-queryfilter.md)                                     | Falso     | **Identificatore di visualizzazione**           |
...
| [**Flag di ambito**](a-scopeflags.md)                                       | Falso     | **Identificatore di visualizzazione**           |
...
| [**Menu di scelta rapida della shell**](a-shellcontextmenu.md)                          | Falso     | **Identificatore di visualizzazione**           |
| [**Shell-Property-Pages**](a-shellpropertypages.md)                      | Falso     | **Identificatore di visualizzazione**           |
...
| [**Considera come foglia**](a-treatasleaf.md)                                    | Falso     | **Identificatore di visualizzazione**           |
...
| [**Admin-Description**](a-admindescription.md)                             | Falso     | [**In alto**](c-top.md)<br/> |
| [**Admin-Display-Name**](a-admindisplayname.md)                            | Falso     | [**In alto**](c-top.md)<br/> |
| [**Admin-Multiselect-Property-Pages**](a-adminmultiselectpropertypages.md) | Falso     | **Identificatore di visualizzazione**           |
| [**Admin-Property-Pages**](a-adminpropertypages.md)                        | Falso     | **Identificatore di visualizzazione**           |
| [**Attributi consentiti**](a-allowedattributes.md)                           | Falso     | [**In alto**](c-top.md)<br/> |
| [**Allowed-Attributes-Effective**](a-allowedattributeseffective.md)        | Falso     | [**In alto**](c-top.md)<br/> |
| [**Classi consentite-figlio**](a-allowedchildclasses.md)                      | Falso     | [**In alto**](c-top.md)<br/> |
...
| [**DS-Core-Propagation-Data**](a-dscorepropagationdata.md)                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Extension-Name**](a-extensionname.md)                                   | Falso     | [**In alto**](c-top.md)<br/> |
| [**Colonne aggiuntive**](a-extracolumns.md)                                     | Falso     | **Identificatore di visualizzazione**           |
| [**Bandiere**](a-flags.md)                                                    | Falso     | [**In alto**](c-top.md)<br/> |
| [**From-Entry**](a-fromentry.md)                                           | Falso     | [**In alto**](c-top.md)<br/> |
| [**Frs-Computer-Reference-BL**](a-frscomputerreferencebl.md)               | Falso     | [**In alto**](c-top.md)<br/> |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                   | Falso     | [**In alto**](c-top.md)<br/> |
...
| [**Nome comune**](a-cn.md)                                                    | Falso     | [**In alto**](c-top.md)<br/> |
| [**Menu di scelta rapida**](a-contextmenu.md)                                          | Falso     | **Identificatore di visualizzazione**           |
| [**Finestra di dialogo di creazione**](a-createdialog.md)                                        | Falso     | **Identificatore di visualizzazione**           |
...
| [**Server-Reference-BL**](a-serverreferencebl.md)                             | Falso     | [**In alto**](c-top.md)<br/> |
| [**Menu di scelta rapida della shell**](a-shellcontextmenu.md)                               | Falso     | **Identificatore di visualizzazione**           |
| [**Pagine delle proprietà della shell**](a-shellpropertypages.md)                           | Falso     | **Identificatore di visualizzazione**           |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)                 | Falso     | [**In alto**](c-top.md)<br/> |
