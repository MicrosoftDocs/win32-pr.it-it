...
Oggetto punto di connessione usato dal servizio dei nomi RnR (Windows Sockets Registration and Resolution), a cui si accede tramite le API WSA Windows \* Sockets.
