...
---
# <a name="service-instance-class"></a>Classe Service-Instance

Oggetto punto di connessione utilizzato dal servizio di denominazione Windows Sockets Registration and Resolution (RnR), a cui si accede tramite le API WSA di Windows Sockets \* .
...
| [**Nome visualizzato**](a-displayname.md)                                     | Vero      | **Primo servizio-istanza** [](c-top.md)<br/>                                     |
