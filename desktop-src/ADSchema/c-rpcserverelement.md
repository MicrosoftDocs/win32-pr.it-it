...
keywords:
- Schema AD della classe rpc-Server-Element
- Schema AD della classe rpcServerElement
topic_type:
- apiref
api_name:
- rpc-Server-Element
...
ms.locfileid: "120005371"
---
# <a name="rpc-server-element-class"></a>Classe rpc-Server-Element

Rappresenta una singola interfaccia in un determinato server RPC.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Elemento rpc-Server                   |
...
| Sottoclasse di                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
| Possibili superiori          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Classi ausiliarie           | \-                                                                                           |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                | Vero      | **Elemento rpc-Server**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | Vero      | **Elemento rpc-Server**                                                                   |
| [**Rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                   | Vero      | **Elemento rpc-Server**                                                                   |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                  | Vero      | **Elemento rpc-Server**                                                                   |
| [**RPC-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                           | Vero      | **Elemento rpc-Server**                                                                   |
| [**Sintassi rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                     | Vero      | **Elemento rpc-Server**                                                                   |
| [**SD-Rights-Effective**](a-sdrightseffective.md)                          | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Server-Reference-BL**](a-serverreferencebl.md)                          | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)              | Falso     | [**In alto**](c-top.md)<br/>                                                          |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                  | Vero      | **Elemento rpc-Server**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                           | Vero      | **Elemento rpc-Server**                                                                   |
| [**Sintassi rpc-Ns-Transfer**](a-rpcnstransfersyntax.md)                     | Vero      | **Elemento rpc-Server**                                                                   |
| [**SD-Rights-Effective**](a-sdrightseffective.md)                          | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Server-Reference-BL**](a-serverreferencebl.md)                          | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)              | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Oggetto sito -BL**](a-siteobjectbl.md)                                    | Falso     | [**In alto**](c-top.md)<br/>                                                          |
