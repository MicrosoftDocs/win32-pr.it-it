---
title: Classe ms-DS-Password-Impostazioni-Container
description: Contenitore per gli oggetti delle impostazioni della password.
ms.assetid: 45e55a1d-63a9-41e5-ac54-3ed467251d3d
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Password-Impostazioni-Container
- Schema AD della classe msDS-PasswordSettingsContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879941"
---
# <a name="ms-ds-password-settings-container-class"></a>Classe ms-DS-Password-Impostazioni-Container

Contenitore per gli oggetti delle impostazioni della password.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Impostazioni-Container    |
| Ldap-Display-Name | msDS-PasswordSettingsContainer       |
| Privilegio di aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 5b06b06a-4cf3-44c0-bd16-43bc10a987da |
