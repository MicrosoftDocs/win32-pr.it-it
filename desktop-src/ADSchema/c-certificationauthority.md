...
description: Rappresenta un processo che emessi certificati a chiave pubblica, ad esempio un server dei certificati.
ms.assetid: 0392332c-3c6c-4060-9f9e-16cb8289b392
ms.tgt_platform: multiple
keywords:
- Certification-Authority schema AD della classe
- Schema AD della classe certificationAuthority
topic_type:
- apiref
api_name:
...
ms.locfileid: "119701961"
---
# <a name="certification-authority-class"></a>Certification-Authority classe

Rappresenta un processo che emessi certificati a chiave pubblica, ad esempio un server dei certificati.
...
| [**Elenco di revoche di autorità**](a-authorityrevocationlist.md)            | Vero      | **Autorità di certificazione**                                 |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)             | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Certificato CA**](a-cacertificate.md)                                 | Vero      | **Autorità di certificazione**                                 |
| [**CA-Certificate-DN**](a-cacertificatedn.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**Autorità di certificazione Connessione**](a-caconnect.md)                                         | Falso     | **Autorità di certificazione**                                 |
| [**Canonical-Name**](a-canonicalname.md)                                 | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Ca-Usages**](a-causages.md)                                           | Falso     | **Autorità di certificazione**                                 |
| [**URL CA-WEB**](a-caweburl.md)                                          | Falso     | **Autorità di certificazione**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)        | Vero      | **Autorità di certificazione**                                 |
| [**Modelli di certificato**](a-certificatetemplates.md)                   | Falso     | **Autorità di certificazione**                                 |
| [**Nome comune**](a-cn.md)                                               | Vero      | **Top autorità di** [ **certificazione**](c-top.md)<br/> |
| [**Create-Time-Stamp**](a-createtimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Oggetto CRL**](a-crlobject.md)                                         | Falso     | **Autorità di certificazione**                                 |
| [**Coppia tra certificati**](a-crosscertificatepair.md)                  | Falso     | **Autorità di certificazione**                                 |
| [**Current-Parent-CA**](a-currentparentca.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**Delta-Revocation-List**](a-deltarevocationlist.md)                    | Falso     | **Autorità di certificazione**                                 |
...
| [**DNS-Host-Name**](a-dnshostname.md)                                    | Falso     | **Autorità di certificazione**                                 |
| [**ID dominio**](a-domainid.md)                                           | Falso     | **Autorità di certificazione**                                 |
| [**Domain-Policy-Object**](a-domainpolicyobject.md)                      | Falso     | **Autorità di certificazione**                                 |
...
| [**Provider di registrazione**](a-enrollmentproviders.md)                     | Falso     | **Autorità di certificazione**                                 |
...
| [**Autorità di certificazione padre**](a-parentca.md)                                           | Falso     | **Autorità di certificazione**                                 |
| [**Parent-CA-Certificate-Chain**](a-parentcacertificatechain.md)         | Falso     | **Autorità di certificazione**                                 |
...
| [**Certificati CA in sospeso**](a-pendingcacertificates.md)                | Falso     | **Autorità di certificazione**                                 |
| [**Pending-Parent-CA**](a-pendingparentca.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**Possibili eserezioni**](a-possibleinferiors.md)                         | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Certificati CA precedenti**](a-previouscacertificates.md)              | Falso     | **Autorità di certificazione**                                 |
| [**Autorità di certificazione padre precedente**](a-previousparentca.md)                          | Falso     | **Autorità di certificazione**                                 |
...
| [**Guida alla ricerca**](a-searchguide.md)                                     | Falso     | **Autorità di certificazione**                                 |
...
| [**Algoritmi di firma**](a-signaturealgorithms.md)                     | Falso     | **Autorità di certificazione**                                 |
...
| [**Supported-Application-Context**](a-supportedapplicationcontext.md)    | Falso     | **Autorità di certificazione**                                 |
| [**Flag di sistema**](a-systemflags.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Teletex-Terminal-Identifier**](a-teletexterminalidentifier.md)        | Falso     | **Autorità di certificazione**                                 |
...
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)          | Vero      | **Autorità di certificazione**                                 |
| [**Modelli di certificato**](a-certificatetemplates.md)                     | Falso     | **Autorità di certificazione**                                 |
| [**Nome comune**](a-cn.md)                                                 | Vero      | **Certification-Authority** [ **Top**](c-top.md)<br/> |
| [**Creazione timestamp**](a-createtimestamp.md)                              | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Oggetto CRL**](a-crlobject.md)                                           | Falso     | **Autorità di certificazione**                                 |
| [**Coppia tra certificati**](a-crosscertificatepair.md)                    | Falso     | **Autorità di certificazione**                                 |
| [**Current-Parent-CA**](a-currentparentca.md)                              | Falso     | **Autorità di certificazione**                                 |
| [**Elenco di revoche differenziali**](a-deltarevocationlist.md)                      | Falso     | **Autorità di certificazione**                                 |
| [**Descrizione**](a-description.md)                                        | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Nome visualizzato**](a-displayname.md)                                       | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Display-Name-Printable**](a-displaynameprintable.md)                    | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**DNS-Host-Name**](a-dnshostname.md)                                      | Falso     | **Autorità di certificazione**                                 |
| [**ID dominio**](a-domainid.md)                                             | Falso     | **Autorità di certificazione**                                 |
| [**Oggetto Domain-Policy**](a-domainpolicyobject.md)                        | Falso     | **Autorità di certificazione**                                 |
| [**Firma DSA**](a-dsasignature.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**DS-Core-Propagation-Data**](a-dscorepropagationdata.md)                 | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Provider di registrazioni**](a-enrollmentproviders.md)                       | Falso     | **Autorità di certificazione**                                 |
| [**Extension-Name**](a-extensionname.md)                                   | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Bandiere**](a-flags.md)                                                    | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**From-Entry**](a-fromentry.md)                                           | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Frs-Computer-Reference-BL**](a-frscomputerreferencebl.md)               | Falso     | [**In alto**](c-top.md)<br/>                             |
...
| [**Certificati precedenti-CA**](a-previouscacertificates.md)                   | Falso     | **Autorità di certificazione**                                 |
| [**Previous-Parent-CA**](a-previousparentca.md)                               | Falso     | **Autorità di certificazione**                                 |
| [**Proxied-Object-Name**](a-proxiedobjectname.md)                             | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Indirizzi proxy**](a-proxyaddresses.md)                                    | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Query-Policy-BL**](a-querypolicybl.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Rdn**](a-name.md)                                                          | Falso     | [**In alto**](c-top.md)<br/>                             |
...
| [**Certificato CA**](a-cacertificate.md)                                                    | Vero      | **Autorità di certificazione**                                 |
| [**CA-Certificate-DN**](a-cacertificatedn.md)                                               | Falso     | **Autorità di certificazione**                                 |
| [**Ca-Connessione**](a-caconnect.md)                                                            | Falso     | **Autorità di certificazione**                                 |
| [**Canonical-Name**](a-canonicalname.md)                                                    | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Ca-Usages**](a-causages.md)                                                              | Falso     | **Autorità di certificazione**                                 |
| [**URL CA-WEB**](a-caweburl.md)                                                             | Falso     | **Autorità di certificazione**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)                           | Vero      | **Autorità di certificazione**                                 |
