...
Rappresenta un processo che rilascia certificati di chiave pubblica, ad esempio un server di certificati.
...
| [**CA-certificato-DN**](a-cacertificatedn.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**CA-Connetti**](a-caconnect.md)                                         | Falso     | **Autorità di certificazione**                                 |
| [**Nome canonico**](a-canonicalname.md)                                 | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**CA-utilizzi**](a-causages.md)                                           | Falso     | **Autorità di certificazione**                                 |
| [**CA-WEB-URL**](a-caweburl.md)                                          | Falso     | **Autorità di certificazione**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)        | Vero      | **Autorità di certificazione**                                 |
| [**Modello di certificato**](a-certificatetemplates.md)                   | Falso     | **Autorità di certificazione**                                 |
| [**Nome comune**](a-cn.md)                                               | Vero      | **Autorità di certificazione-** [ **superiore**](c-top.md)<br/> |
| [**Creazione timestamp**](a-createtimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**CRL-oggetto**](a-crlobject.md)                                         | Falso     | **Autorità di certificazione**                                 |
| [**Associazione tra certificati**](a-crosscertificatepair.md)                  | Falso     | **Autorità di certificazione**                                 |
| [**Current-Parent-CA**](a-currentparentca.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**Elenco di revoche Delta**](a-deltarevocationlist.md)                    | Falso     | **Autorità di certificazione**                                 |
...
| [**Nome-host-DNS**](a-dnshostname.md)                                    | Falso     | **Autorità di certificazione**                                 |
...
| [**Registrazione-provider**](a-enrollmentproviders.md)                     | Falso     | **Autorità di certificazione**                                 |
...
| [**CA padre**](a-parentca.md)                                           | Falso     | **Autorità di certificazione**                                 |
...
| [**In sospeso-certificati CA**](a-pendingcacertificates.md)                | Falso     | **Autorità di certificazione**                                 |
| [**In sospeso-padre-CA**](a-pendingparentca.md)                            | Falso     | **Autorità di certificazione**                                 |
| [**Possibili-inferiori**](a-possibleinferiors.md)                         | Falso     | [**In alto**](c-top.md)<br/>                             |
| [**Precedenti-certificati CA**](a-previouscacertificates.md)              | Falso     | **Autorità di certificazione**                                 |
| [**Precedente-padre-CA**](a-previousparentca.md)                          | Falso     | **Autorità di certificazione**                                 |
...
| [**Supportato-contesto applicazione**](a-supportedapplicationcontext.md)    | Falso     | **Autorità di certificazione**                                 |
