...
Definisce le voci per un gruppo di nomi univoci. In generale, utilizzato per archiviare gli oggetti account.
...
| [**Categoria aziendale**](a-businesscategory.md)                             | Falso     | **groupOfUniqueNames**                                 |
