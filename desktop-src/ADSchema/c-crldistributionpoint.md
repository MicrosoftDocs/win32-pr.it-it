---
title: Classe CRL-Distribution-Point
description: Oggetto che contiene gli elenchi di certificati, autorità e revoche differenziali.
ms.assetid: 8d99052c-b72b-49b6-9c1b-a9c1fcd09fe7
ms.tgt_platform: multiple
keywords:
- Schema AD della classe CRL-Distribution-Point
- Schema AD della classe cRLDistributionPoint
topic_type:
- apiref
api_name:
...
ms.locfileid: "119701951"
---
# <a name="crl-distribution-point-class"></a>Classe CRL-Distribution-Point

Oggetto che contiene gli elenchi di certificati, autorità e revoche differenziali.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Punto di distribuzione CRL               |
...
| [**Elenco di revoche di autorità**](a-authorityrevocationlist.md)            | Falso     | **Punto di distribuzione CRL**                                 |
...
| [**Oggetto Autorità di certificazione**](a-certificateauthorityobject.md)      | Falso     | **Punto di distribuzione CRL**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)        | Falso     | **Punto di distribuzione CRL**                                 |
| [**Nome comune**](a-cn.md)                                               | Vero      | **CRL-Distribution-Point** [ **Top**](c-top.md)<br/> |
| [**Creazione timestamp**](a-createtimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**CRL-Partitioned-Revocation-List**](a-crlpartitionedrevocationlist.md) | Falso     | **Punto di distribuzione CRL**                                 |
| [**Elenco di revoche differenziali**](a-deltarevocationlist.md)                    | Falso     | **Punto di distribuzione CRL**                                 |
...
| [**Allowed-Child-Classes-Effective**](a-allowedchildclasseseffective.md)   | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Elenco di revoche di autorità**](a-authorityrevocationlist.md)              | Falso     | **CRL-Distribution-Point**                                 |
| [**Testa di ponte-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Canonical-Name**](a-canonicalname.md)                                   | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Oggetto Certificate-Authority**](a-certificateauthorityobject.md)        | Falso     | **CRL-Distribution-Point**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)          | Falso     | **CRL-Distribution-Point**                                 |
| [**Nome comune**](a-cn.md)                                                 | Vero      | **CRL-Distribution-Point** [ **Top**](c-top.md)<br/> |
| [**Create-Time-Stamp**](a-createtimestamp.md)                              | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**CRL-Partitioned-Revocation-List**](a-crlpartitionedrevocationlist.md)   | Falso     | **CRL-Distribution-Point**                                 |
| [**Delta-Revocation-List**](a-deltarevocationlist.md)                      | Falso     | **CRL-Distribution-Point**                                 |
| [**Descrizione**](a-description.md)                                        | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Nome visualizzato**](a-displayname.md)                                       | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Display-Name-Printable**](a-displaynameprintable.md)                    | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Firma DSA**](a-dsasignature.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                            |
