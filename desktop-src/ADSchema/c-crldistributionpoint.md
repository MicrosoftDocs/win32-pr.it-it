...
---
# <a name="crl-distribution-point-class"></a>Classe del punto di distribuzione CRL

Oggetto che contiene gli elenchi di revoche di certificati, autorità e Delta.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | CRL-punto di distribuzione               |
...
| [**Elenco di revoche di autorità**](a-authorityrevocationlist.md)            | Falso     | **CRL-punto di distribuzione**                                 |
...
| [**Certificate-Authority-Object**](a-certificateauthorityobject.md)      | Falso     | **CRL-punto di distribuzione**                                 |
| [**Elenco di revoche di certificati**](a-certificaterevocationlist.md)        | Falso     | **CRL-punto di distribuzione**                                 |
| [**Nome comune**](a-cn.md)                                               | Vero      | **CRL-punto di distribuzione** in [ **alto**](c-top.md)<br/> |
| [**Creazione timestamp**](a-createtimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/>                            |
| [**Elenco di revoche di certificati CRL-partizionato**](a-crlpartitionedrevocationlist.md) | Falso     | **CRL-punto di distribuzione**                                 |
| [**Elenco di revoche Delta**](a-deltarevocationlist.md)                    | Falso     | **CRL-punto di distribuzione**                                 |
