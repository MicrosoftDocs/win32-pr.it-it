...
- Schema AD della classe msTAPI-RtPerson
topic_type:
- apiref
api_name:
- ms-TAPI-Rt-Person
...
ms.locfileid: "119879381"
---
# <a name="ms-tapi-rt-person-class"></a>Classe ms-TAPI-Rt-Person

Consente di eseguire il mapping di un utente all'indirizzo IP del computer a cui l'utente è connesso per l'uso da parte di conferenze multicast TAPI.
...
| Ldap-Display-Name | msTAPI-RtPerson                                                                   |
| Aggiorna privilegio  | Non sono necessari privilegi speciali.                                                   |
| Frequenza di aggiornamento  | Ogni volta che un client TAPI viene avviato dopo la registrazione con la directory TAPI. |
| Schema-Id-Guid    | 53ea1cb5-b704-4df9-818f-5cb4ec86cac1                                              |
...
| Possibili superiori          | [**Organizzazione delle unità**](c-organizationalunit.md)[**organizzative**](c-organization.md)    |
| Classi ausiliarie           | \-                                                                                           |
...
| [**ms-TAPI-Ip-Address**](a-mstapi-ipaddress.md)                            | Falso     | **ms-TAPI-Rt-Person**           |
| [**ms-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Falso     | **ms-TAPI-Rt-Person**           |
...
| Rdn-Att-Id                  | [**Nome comune**](a-cn.md)<br/>                                                       |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                              |
| Possibili superiori          | [**Organizzazione unità**](c-organizationalunit.md)[**organizzativa**](c-organization.md)    |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au) |
| System-Flags                | 0x00000010                                                                                   |
