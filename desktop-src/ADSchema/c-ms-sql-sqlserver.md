...
| [**MS-SQL-compilazione**](a-ms-sql-build.md)                                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**Il carattere MS-SQL**](a-ms-sql-characterset.md)                      | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-cluster**](a-ms-sql-clustered.md)                            | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**MS-SQL-parole chiave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-posizione**](a-ms-sql-location.md)                              | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-memoria**](a-ms-sql-memory.md)                                  | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Multiprotocol**](a-ms-sql-multiprotocol.md)                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**Service-binding-informazioni**](a-servicebindinginformation.md)        | Falso     | [**Punto di connessione del servizio**](c-serviceconnectionpoint.md)<br/>                  |
| [**Nome-classe-servizio**](a-serviceclassname.md)                          | Falso     | [**Punto di connessione del servizio**](c-serviceconnectionpoint.md)<br/>                  |
| [**Servizio-DNS-Name**](a-servicednsname.md)                              | Falso     | [**Punto di connessione del servizio**](c-serviceconnectionpoint.md)<br/>                  |
| [**Servizio-DNS-nome-tipo**](a-servicednsnametype.md)                     | Falso     | [**Punto di connessione del servizio**](c-serviceconnectionpoint.md)<br/>                  |
...
| [**Versione-numero-Ciao**](a-versionnumberhi.md)                              | Falso     | [**Punto di connessione del servizio**](c-serviceconnectionpoint.md)<br/>                  |
