---
title: Connection-Point classe
description: Classe di base da cui derivano tutti gli oggetti collegabili.
ms.assetid: b20a1300-d086-46f5-929c-dbaa60c3ec52
ms.tgt_platform: multiple
keywords:
- Connection-Point schema AD della classe
- Schema AD della classe connectionPoint
topic_type:
- apiref
api_name:
- Connection-Point
...
ms.locfileid: "119703811"
---
# <a name="connection-point-class"></a>Connection-Point classe

Classe di base da cui derivano tutti gli oggetti collegabili.
...
|-------------------|--------------------------------------|
| CN                | Connection-Point                     |
| Ldap-Display-Name | Connectionpoint                      |
| Privilegio di aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | 5cb41ecf-0e4c-11d0-a286-00aa003049e2 |
...
| [**Nome comune**](a-cn.md)                                               | Vero      | **Parte superiore del punto di** [ **connessione**](c-top.md)<br/> |
...
| [**Parole chiavi**](a-keywords.md)                                            | Falso     | **Punto di connessione**                                 |
| [**Ultimo elemento padre noto**](a-lastknownparent.md)                            | Falso     | [**In alto**](c-top.md)<br/>                      |
| [**Gestito da**](a-managedby.md)                                         | Falso     | **Punto di connessione**                                 |
...
| [**Canonical-Name**](a-canonicalname.md)                                   | Falso     | [**In alto**](c-top.md)<br/>                      |
| [**Nome comune**](a-cn.md)                                                 | Vero      | **Punto di connessione** [ **superiore**](c-top.md)<br/> |
...
| [**ms-DS-Impostazioni**](a-msds-settings.md)                                   | Falso     | **Punto di connessione**                                 |
