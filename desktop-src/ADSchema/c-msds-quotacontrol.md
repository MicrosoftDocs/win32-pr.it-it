...
description: Classe utilizzata per rappresentare le specifiche di quota per il database della directory.
ms.assetid: e37897f8-9646-4bc8-b6e6-9da4a83d66d5
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Quota-Control
- Schema AD della classe msDS-QuotaControl
topic_type:
- apiref
api_name:
- ms-DS-Quota-Control
...
ms.locfileid: "119879891"
---
# <a name="ms-ds-quota-control-class"></a>Classe ms-DS-Quota-Control

Classe utilizzata per rappresentare le specifiche di quota per il database della directory.
...
| Possibili superiori          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md)   |
| Classi ausiliarie           | \-                                                       |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                             |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; BA) |
...
| [**Nome comune**](a-cn.md)                                                 | Vero      | **Ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Quota-Amount**](a-msds-quotaamount.md)                            | Vero      | **ms-DS-Quota-Control**                                 |
| [**ms-DS-Quota-Trustee**](a-msds-quotatrustee.md)                          | Vero      | **ms-DS-Quota-Control**                                 |
