...
Classe utilizzata per rappresentare le specifiche di quota per il database di directory.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ms-DS-quota-controllo                  |
...
| Possibili superiori          | [**ms-DS-quota-contenitore**](c-msds-quotacontainer.md)   |
| Classi ausiliarie           | \-                                                       |
...
| [**Nome comune**](a-cn.md)                                                 | Vero      | **ms-DS-quota-controllo** in [ **alto**](c-top.md)<br/> |
...
| [**ms-DS-quota-importo**](a-msds-quotaamount.md)                            | Vero      | **ms-DS-quota-controllo**                                 |
| [**ms-DS-quota-fiduciario**](a-msds-quotatrustee.md)                          | Vero      | **ms-DS-quota-controllo**                                 |
