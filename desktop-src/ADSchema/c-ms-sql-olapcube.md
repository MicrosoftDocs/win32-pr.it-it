...
Classe per l'archiviazione di SQL Server proprietà dei cubi OLAP.
...
| [**MS-SQL-contatto**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Descrizione**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-parole chiave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-nome**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-dimensioni**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-stato**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-OLAPCube**             |
