...
description: Classe per l'archiviazione SQL Server proprietà del cubo OLAP.
ms.assetid: 9ffcc94b-3866-456b-8b65-0374ae613fb5
ms.tgt_platform: multiple
keywords:
- Schema AD della classe MS-SQL-OLAPCube
- Schema AD della classe mS-SQL-OLAPCube
topic_type:
- apiref
api_name:
...
ms.locfileid: "119834671"
---
# <a name="ms-sql-olapcube-class"></a>Classe MS-SQL-OLAPCube

Classe per l'archiviazione SQL Server proprietà del cubo OLAP.
...
| Possibili superiori          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Classi ausiliarie           | \-                                                                                           |
...
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**Parole chiave SQL MS-SQL**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | Falso     | **MS-SQL-OLAPCube**             |
...
| [**MS-SQL-Description**](a-ms-sql-description.md)                          | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-OLAPCube**             |
| [**Parole chiave ms-SQL-keywords**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                    | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                        | Falso     | **MS-SQL-OLAPCube**             |
