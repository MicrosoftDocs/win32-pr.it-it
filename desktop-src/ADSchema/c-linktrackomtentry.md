...
---
# <a name="link-track-omt-entry-class"></a>Classe Link-Track-OMT-entry

Tiene traccia del collegamento per gli oggetti spostati.
...
| Frequenza di aggiornamento  | Ogni volta che viene modificato un collegamento a un file.   |
...
| [**Luogo di nascita**](a-birthlocation.md)                                 | Falso     | **Link-Track-OMT-entry**        |
...
| [**Aggiornamento del tempo**](a-timerefresh.md)                                     | Falso     | **Link-Track-OMT-entry**        |
