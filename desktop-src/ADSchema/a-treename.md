...
---
# <a name="tree-name-attribute"></a>Attributo Tree-Name

Nome DNS del dominio alla radice di un albero.
...
|-------------------|---------------------------------------------|
| CN                | Tree-Name                                   |
| LDAP-Display-Name | treename                                    |
| Dimensione              | \-                                          |
| Privilegio aggiornamento  | \-                                          |
| Frequenza di aggiornamento  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.660                      |
| System-ID-GUID    | 28630ebd-41d5-11d1-a9c1-0000f80367c1        |
