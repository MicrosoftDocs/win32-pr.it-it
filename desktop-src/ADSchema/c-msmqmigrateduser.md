...
---
# <a name="msmq-migrated-user-class"></a>MSMQ-migrated-classe utente

In MSMQ 1,0 abbiamo il nostro DS, in cui abbiamo mantenuto alcune informazioni per ogni utente. Nell'ambito dell'integrazione MSMQ con Windows 2000 DS, MSMQ fornisce uno strumento di migrazione. Durante la migrazione, per ogni utente che non si trova nel dominio di Windows 2000 viene creato un utente migrato.



| Voce | Valore |
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ-migrated-utente                                                                               |
| LDAP-Display-Name | mSMQMigratedUser                                                                                 |
| Privilegio aggiornamento  | Proprietario della coda.                                                                                 |
| Frequenza di aggiornamento  | Questo oggetto viene creato dall'aggiornamento guidato di Accodamento messaggi in un ambiente di dominio in modalità mista. |
| Schema-ID-GUID    | 50776997-3c3d-11d2-90cc-00c04fd91ab1                                                             |
...
| Possibili superiori          | Dominio [**incorporato**](c-builtindomain.md)-[**unità organizzativa**](c-organizationalunit.md) [**DNS**](c-domaindns.md) |
| Classi ausiliarie           | \-                                                                                                                            |
...
| [**MSMQ-digest**](a-msmqdigests.md)                                     | Falso     | **MSMQ-migrated-utente**          |
| [**MSMQ-digest-MIG**](a-msmqdigestsmig.md)                              | Falso     | **MSMQ-migrated-utente**          |
| [**MSMQ-Sign-Certificates**](a-msmqsigncertificates.md)                  | Falso     | **MSMQ-migrated-utente**          |
| [**MSMQ-Sign-Certificates-MIG**](a-msmqsigncertificatesmig.md)           | Falso     | **MSMQ-migrated-utente**          |
| [**MSMQ-utente-SID**](a-msmqusersid.md)                                    | Falso     | **MSMQ-migrated-utente**          |
...
| [**Oggetto-SID**](a-objectsid.md)                                         | Falso     | **MSMQ-migrated-utente**          |
