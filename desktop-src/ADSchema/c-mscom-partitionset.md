...
---
# <a name="ms-com-partitionset-class"></a>Classe MS-COM-divisori

Raccolta concettuale di partizioni COM+.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | MS-COM-partizionato                  |
| LDAP-Display-Name | msCOM-partizioni                   |
| Privilegio aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | 250464ab-c417-497a-975a-9e0d459a7ca1 |
...
| [**MS-COM-DefaultPartitionLink**](a-mscom-defaultpartitionlink.md)         | Falso     | **MS-COM-partizionato**         |
| [**MS-COM-ObjectId**](a-mscom-objectid.md)                                 | Falso     | **MS-COM-partizionato**         |
| [**MS-COM-PartitionLink**](a-mscom-partitionlink.md)                       | Falso     | **MS-COM-partizionato**         |
