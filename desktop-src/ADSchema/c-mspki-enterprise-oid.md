...
---
# <a name="ms-pki-enterprise-oid-class"></a>Classe ms-PKI-Enterprise-OID

Utilizzato quando un'interfaccia utente di un certificato Visualizza un nome visualizzato per un modello di certificato, l'utilizzo chiavi avanzato, i criteri di applicazione e i criteri di rilascio. Il componente dell'interfaccia utente tenterà di individuare una stringa nell'attributo che corrisponde alle impostazioni locali della lingua predefinita.
...
| Frequenza di aggiornamento  | Viene aggiornato quando l'amministratore esegue certutil.exe per archiviare il nome localizzato per ogni OID. |
...
| Possibili superiori          | [**Contenitore**](c-container.md)**ms-PKI-Enterprise-OID**                                    |
| Classi ausiliarie           | \-                                                                                           |
...
| [**ms-PKI-CERT-template-OID**](a-mspki-cert-template-oid.md)               | Falso     | **ms-PKI-Enterprise-OID**       |
| [**ms-PKI-OID-attribute**](a-mspki-oid-attribute.md)                       | Falso     | **ms-PKI-Enterprise-OID**       |
| [**ms-PKI-OID-CPS**](a-mspki-oid-cps.md)                                   | Falso     | **ms-PKI-Enterprise-OID**       |
| [**ms-PKI-OID-localizzato**](a-mspki-oidlocalizedname.md)                | Falso     | **ms-PKI-Enterprise-OID**       |
| [**ms-PKI-OID-utente-avviso**](a-mspki-oid-user-notice.md)                   | Falso     | **ms-PKI-Enterprise-OID**       |
...
| [**ms-DS-non membri-BL**](a-msds-nonmembersbl.md)                              | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-Object-Reference-BL**](a-msds-objectreferencebl.md)                    | Falso     | [**In alto**](c-top.md)<br/> |
| [**ms-DS-OIDToGroup-collegamento**](a-msds-oidtogrouplink.md)                           | Falso     | **ms-PKI-Enterprise-OID**       |
