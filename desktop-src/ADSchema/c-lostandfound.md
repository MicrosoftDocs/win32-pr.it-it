...
---
# <a name="lost-and-found-class"></a>Classe persa e trovata

Contenitore per oggetti orfani.
...
| Privilegio aggiornamento  | Questo contenitore è gestito dal sistema.                  |
| Frequenza di aggiornamento  | Ogni volta che non è possibile riconciliare la posizione di un oggetto. |
...
| Possibili superiori          | Dominio [**DMD**](c-dmd.md)[**-**](c-domaindns.md)[**configurazione**](c-configuration.md) DNS |
| Classi ausiliarie           | \-                                                                                            |
...
| [**Move-Tree-state**](a-movetreestate.md)                                | Falso     | **Perso e trovato**              |
