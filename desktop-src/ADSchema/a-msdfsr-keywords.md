...
---
# <a name="ms-dfsr-keywords-attribute"></a>attributo ms-DFSR-Keywords

Contiene le parole chiave definite dall'utente.



| Voce | Valore |
|-------------------|---------------------------------------------|
| CN                | MS-DFSR-parole chiave                            |
| LDAP-Display-Name | msDFSR-parole chiave                             |
| Dimensione              | \-                                          |
...
| Classi utilizzate in        | [**Membro MS-DFSR**](c-msdfsr-member.md)<br/> [**MS-DFSR-Connection**](c-msdfsr-connection.md)<br/> |
...
L'attributo **MS-DFSR-Keywords** fa parte del supporto del servizio di replica file System distribuito (DFS).
