...
| LDAP-Display-Name | msDFSR-connessione                    |
| Privilegio aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | e58f972e-64b5-46ef-8d8b-bbc3e1897eab |
...
| Possibili superiori          | [**Membro MS-DFSR**](c-msdfsr-member.md)                                                                                        |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**Flag MS-DFSR**](a-msdfsr-flags.md)                                     | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-parole chiave**](a-msdfsr-keywords.md)                               | Falso     | **MS-DFSR-Connection**          |
...
| [**MS-DFSR-priorità**](a-msdfsr-priority.md)                                  | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-RdcEnabled**](a-msdfsr-rdcenabled.md)                              | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-RdcMinFileSizeInKb**](a-msdfsr-rdcminfilesizeinkb.md)              | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-Schedule**](a-msdfsr-schedule.md)                                  | Falso     | **MS-DFSR-Connection**          |
| [**ms-DS-approx-immed-subordinates**](a-msds-approx-immed-subordinates.md)    | Falso     | [**In alto**](c-top.md)<br/> |
...
La classe **MS-DFSR-Connection** fa parte del supporto del servizio di replica file System distribuito (DFS).
