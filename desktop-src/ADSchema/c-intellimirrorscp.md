...
description: Questo oggetto contiene informazioni di configurazione per il servizio che risponde ai client di avvio remoto che richiedono attenzione da un server di installazione remota.
ms.assetid: 6284a1ad-8184-4dda-a588-ed89c8f19fd5
ms.tgt_platform: multiple
keywords:
- Schema AD della classe Intellimirror-SCP
- Schema AD della classe intellimirrorSCP
topic_type:
- apiref
api_name:
- Intellimirror-SCP
...
ms.locfileid: "118423119"
---
# <a name="intellimirror-scp-class"></a>Classe Intellimirror-SCP

Questo oggetto contiene informazioni di configurazione per il servizio che risponde ai client di avvio remoto che richiedono attenzione da un server di installazione remota.
...
| Sottoclasse di                 | [**Service-Administration-Point**](c-serviceadministrationpoint.md)<br/>              |
| Possibili superiori          | [**Intellimirror-Group**](c-intellimirrorgroup.md)[**Computer**](c-computer.md)            |
| Classi ausiliarie           | \-                                                                                           |
...
| [**netboot-Allow-New-Clients**](a-netbootallownewclients.md)                | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-answer-only-valid-clients**](a-netbootansweronlyvalidclients.md) | Falso     | **Intellimirror-SCP**                                                                    |
| [**Netboot-Answer-Requests**](a-netbootanswerrequests.md)                   | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-Current-Client-Count**](a-netbootcurrentclientcount.md)          | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-IntelliMirror-OSes**](a-netbootintellimirroroses.md)             | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-Limit-Clients**](a-netbootlimitclients.md)                       | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-Locally-Installed-OSes**](a-netbootlocallyinstalledoses.md)      | Falso     | **Intellimirror-SCP**                                                                    |
| [**Netboot-Machine-File-Path**](a-netbootmachinefilepath.md)                | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-Max-Clients**](a-netbootmaxclients.md)                           | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-New-Machine-Naming-Policy**](a-netbootnewmachinenamingpolicy.md) | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-New-Machine-OU**](a-netbootnewmachineou.md)                      | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**netboot-Server**](a-netbootserver.md)                                    | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-Tools**](a-netboottools.md)                                      | Falso     | **Intellimirror-SCP**                                                                    |
...
| Default-Hiding-Value        | 1                                                                                            |
| Rdn-Att-Id                  | [**Nome comune**](a-cn.md)<br/>                                                       |
| Sottoclasse di                 | [**Punto di amministrazione del servizio**](c-serviceadministrationpoint.md)<br/>              |
| Possibili superiori          | [**Intellimirror-Group**](c-intellimirrorgroup.md)[**Computer**](c-computer.md)            |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;; Au) |
