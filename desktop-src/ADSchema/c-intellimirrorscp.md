...
Questo oggetto contiene le informazioni di configurazione per il servizio che risponde ai client di avvio remoto che richiedono attenzione da un server di installazione remota.
...
| Sottoclasse di                 | [**Servizio-amministrazione-punto**](c-serviceadministrationpoint.md)<br/>              |
| Possibili superiori          | [**IntelliMirror-**](c-intellimirrorgroup.md)[**computer** del gruppo](c-computer.md)            |
| Classi ausiliarie           | \-                                                                                           |
...
| [**accesso alla piattaforma-Consenti-nuovi-client**](a-netbootallownewclients.md)                | Falso     | **IntelliMirror-SCP**                                                                    |
| [**per la sola risposta, solo per i client validi**](a-netbootansweronlyvalidclients.md) | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Domande e risposte-risposta**](a-netbootanswerrequests.md)                   | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Numero di piattaforma-client corrente**](a-netbootcurrentclientcount.md)          | Falso     | **IntelliMirror-SCP**                                                                    |
| [**IntelliMirror-sistemi operativi**](a-netbootintellimirroroses.md)             | Falso     | **IntelliMirror-SCP**                                                                    |
| [**-Limite-client**](a-netbootlimitclients.md)                       | Falso     | **IntelliMirror-SCP**                                                                    |
| [**modalità di installazione a livello locale-sistemi operativi**](a-netbootlocallyinstalledoses.md)      | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Percorso-computer-file-percorso**](a-netbootmachinefilepath.md)                | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Numero massimo-client**](a-netbootmaxclients.md)                           | Falso     | **IntelliMirror-SCP**                                                                    |
| [**-Nuovo-computer-Naming-Policy**](a-netbootnewmachinenamingpolicy.md) | Falso     | **IntelliMirror-SCP**                                                                    |
| [**-Nuovo-computer-OU**](a-netbootnewmachineou.md)                      | Falso     | **IntelliMirror-SCP**                                                                    |
| [**-SCP-BL**](a-netbootscpbl.md)                                     | Falso     | [**In alto**](c-top.md)<br/>                                                          |
| [**Server di avviamento**](a-netbootserver.md)                                    | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Strumenti di avviamento**](a-netboottools.md)                                      | Falso     | **IntelliMirror-SCP**                                                                    |
