...
description: Contiene il GUID e le informazioni sul computer corrente per un file con rilevamento del collegamento.
ms.assetid: ab537bf4-0cf7-455a-8c87-ce365af77f3d
ms.tgt_platform: multiple
keywords:
- Schema AD della classe File-Link-Tracking-Entry
- Schema AD della classe fileLinkTrackingEntry
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703761"
---
# <a name="file-link-tracking-entry-class"></a>Classe File-Link-Tracking-Entry

Contiene il GUID e le informazioni sul computer corrente per un file con rilevamento del collegamento.
...
| Possibili superiori          | [**Rilevamento collegamento file**](c-filelinktracking.md)                                             |
| Classi ausiliarie           | \-                                                                                           |
