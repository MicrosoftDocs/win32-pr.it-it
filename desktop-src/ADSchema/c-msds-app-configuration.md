...
Utilizzato per archiviare le informazioni sulle impostazioni per un'applicazione. Per archiviare i valori effettivi, è necessario usare l'attributo [**ms-DS-Settings**](a-msds-settings.md) .
...
| [**Parole chiave**](a-keywords.md)                                              | Falso     | **ms-DS-app-Configuration**                                      |
...
| [**ms-DS-Data-ora**](a-msds-datetime.md)                                  | Falso     | **ms-DS-app-Configuration**                                      |
