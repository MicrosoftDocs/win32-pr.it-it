...
description: Usato per archiviare le informazioni sulle impostazioni per un'applicazione. L'attributo ms-DS-Impostazioni deve essere usato per archiviare i valori effettivi.
ms.assetid: cbb050c8-c391-4c13-bb01-11a11635c9be
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-App-Configuration
- Schema AD della classe msDS-App-Configuration
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880601"
---
# <a name="ms-ds-app-configuration-class"></a>Classe ms-DS-App-Configuration

Usato per archiviare le informazioni sulle impostazioni per un'applicazione. [**L'attributo ms-DS-Impostazioni**](a-msds-settings.md) deve essere usato per archiviare i valori effettivi.
...
| [**Parole chiavi**](a-keywords.md)                                              | Falso     | **ms-DS-App-Configuration**                                      |
| [**Ultimo elemento padre noto**](a-lastknownparent.md)                              | Falso     | [**In alto**](c-top.md)<br/>                                  |
| [**Gestito da**](a-managedby.md)                                           | Falso     | **ms-DS-App-Configuration**                                      |
...
| [**ms-DS-Byte-Array**](a-msds-bytearray.md)                                | Falso     | **ms-DS-App-Configuration**                                      |
...
| [**ms-DS-Date-Time**](a-msds-datetime.md)                                  | Falso     | **ms-DS-App-Configuration**                                      |
| [**ms-DS-Integer**](a-msds-integer.md)                                     | Falso     | **ms-DS-App-Configuration**                                      |
...
| [**Ms-DS-Object-Reference**](a-msds-objectreference.md)                    | Falso     | **ms-DS-App-Configuration**                                      |
...
| [**Proprietario**](a-owner.md)                                                    | Falso     | **ms-DS-App-Configuration**                                      |
