...
---
# <a name="rid-manager-class"></a>Classe RID-Manager

Contiene l'FSMO RID e il percorso del pool di RID disponibile utilizzato dal gestore RID. RID Manager è un componente in esecuzione sul controller di dominio responsabile dell'allocazione degli identificatori di sicurezza.
...
| Frequenza di aggiornamento  | Ogni volta che l'allocazione del pool di RID cambia. |
...
| [**RID-disponibile-pool**](a-ridavailablepool.md)                          | Vero      | **RID-Manager**                 |
