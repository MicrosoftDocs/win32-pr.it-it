---
title: RID-Manager classe
description: Contiene il FSMO RID e il percorso RID-Available-Pool usato da Gestione RID. Gestione RID è un componente in esecuzione nel controller di dominio responsabile dell'allocazione degli identificatori di sicurezza.
ms.assetid: 84af5d6d-a5a7-4288-a9eb-0eaaf0c23063
ms.tgt_platform: multiple
keywords:
- RID-Manager schema AD della classe
- Schema AD della classe rIDManager
topic_type:
- apiref
api_name:
- RID-Manager
...
ms.locfileid: "118959570"
---
# <a name="rid-manager-class"></a>RID-Manager classe

Contiene il FSMO RID e il percorso RID-Available-Pool usato da Gestione RID. Gestione RID è un componente in esecuzione nel controller di dominio responsabile dell'allocazione degli identificatori di sicurezza.
...
|-------------------|-------------------------------------------|
| CN                | RID-Manager                               |
| Ldap-Display-Name | rIDManager                                |
| Privilegio di aggiornamento  | Questo valore viene impostato dal sistema.          |
| Frequenza di aggiornamento  | Ogni volta che cambia l'allocazione del pool di RID. |
...
| [**RID-Available-Pool**](a-ridavailablepool.md)                          | Vero      | **RID-Manager**                 |
...
| Classi ausiliarie           | \-                                                                                                              |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                    |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)S:(AU;SA; CRWP;;; WD) |
| System-Flags                | 0x00000010                                                                                                      |
...
| [**Reps-To**](a-repsto.md)                                                 | Falso     | [**In alto**](c-top.md)<br/> |
| [**Revisione**](a-revision.md)                                              | Falso     | [**In alto**](c-top.md)<br/> |
| [**RID-Available-Pool**](a-ridavailablepool.md)                            | Vero      | **GESTIONE RID**                 |
| [**SD-Rights-Effective**](a-sdrightseffective.md)                          | Falso     | [**In alto**](c-top.md)<br/> |
| [**Server-Reference-BL**](a-serverreferencebl.md)                          | Falso     | [**In alto**](c-top.md)<br/> |
| [**Show-In-Advanced-View-Only**](a-showinadvancedviewonly.md)              | Falso     | [**In alto**](c-top.md)<br/> |
...
| Nome comune                                      |
|--------------------------------------------------|
| [**Modifica rid-master**](r-change-rid-master.md) |
