...
---
# <a name="security-principal-class"></a>Classe Security-Principal
...
|------------------------------------------------------------------------------|-----------|--------------------------------------------------------|
| [**Nome-account-cronologia**](a-accountnamehistory.md)                         | Falso     | **Entità di sicurezza**                                 |
...
| [**Alt-sicurezza-identità**](a-altsecurityidentities.md)                   | Falso     | **Entità di sicurezza**                                 |
...
| [**NT-Security-descrittore**](a-ntsecuritydescriptor.md)                     | Vero      | **Sicurezza-entità** [ **superiore**](c-top.md)<br/> |
...
| [**Oggetto-SID**](a-objectsid.md)                                            | Vero      | **Entità di sicurezza**                                 |
...
| [**Sbarazzarsi**](a-rid.md)                                                         | Falso     | **Entità di sicurezza**                                 |
| [**Nome account SAM**](a-samaccountname.md)                                 | Vero      | **Entità di sicurezza**                                 |
| [**Tipo di account SAM**](a-samaccounttype.md)                                 | Falso     | **Entità di sicurezza**                                 |
...
| [**SID-cronologia**](a-sidhistory.md)                                          | Falso     | **Entità di sicurezza**                                 |
...
| [**Supplementare-credenziali**](a-supplementalcredentials.md)                | Falso     | **Entità di sicurezza**                                 |
| [**Flag di sistema**](a-systemflags.md)                                        | Falso     | [**In alto**](c-top.md)<br/>                        |
| [**Gruppi di token**](a-tokengroups.md)                                        | Falso     | **Entità di sicurezza**                                 |
| [**Token-gruppi-globale e universale**](a-tokengroupsglobalanduniversal.md) | Falso     | **Entità di sicurezza**                                 |
| [**Token-Groups-No-GC-accettabile**](a-tokengroupsnogcacceptable.md)         | Falso     | **Entità di sicurezza**                                 |
