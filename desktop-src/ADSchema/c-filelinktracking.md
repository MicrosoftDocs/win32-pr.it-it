---
title: Classe File-Link-Tracking
description: Contenitore per oggetti File-Link-Tracking-Entry.
ms.assetid: 15ed6bd8-bbd7-4d64-a02b-599bddf4492b
ms.tgt_platform: multiple
keywords:
- Schema AD della classe File-Link-Tracking
- Schema AD della classe fileLinkTracking
topic_type:
- apiref
api_name:
- File-Link-Tracking
...
ms.locfileid: "119922741"
---
# <a name="file-link-tracking-class"></a>Classe File-Link-Tracking

Contenitore per oggetti File-Link-Tracking-Entry.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Rilevamento collegamento file                   |
| Ldap-Display-Name | fileLinkTracking                     |
| Privilegio di aggiornamento  | \-                                   |
| Frequenza di aggiornamento  | \-                                   |
| Schema-Id-Guid    | dd712229-10e4-11d0-a05f-00aa006c33ed |
