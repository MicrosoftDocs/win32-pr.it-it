...
---
# <a name="file-link-tracking-class"></a>Classe di rilevamento file-collegamento

Contenitore per gli oggetti voce di rilevamento file-collegamento.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Rilevamento dei collegamenti di file                   |
