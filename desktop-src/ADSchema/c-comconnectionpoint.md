...
Binding per l'esecuzione del servizio COM/DCOM.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Com-punto di connessione                 |
...
| [**Nome comune**](a-cn.md)                                               | Vero      | **Com-** [ **punto di connessione** punto di connessione](c-connectionpoint.md)<br/> [**In alto**](c-top.md)<br/> |
...
| [**Interfaccia di marshalling**](a-marshalledinterface.md)                     | Falso     | **Com-punto di connessione**                                                                                          |
| [**Mastered-by**](a-masteredby.md)                                       | Falso     | [**In alto**](c-top.md)<br/>                                                                                   |
| [**Modifica-timestamp**](a-modifytimestamp.md)                            | Falso     | [**In alto**](c-top.md)<br/>                                                                                   |
| [**Moniker**](a-moniker.md)                                              | Falso     | **Com-punto di connessione**                                                                                          |
| [**Moniker-Display-Name**](a-monikerdisplayname.md)                      | Falso     | **Com-punto di connessione**                                                                                          |
