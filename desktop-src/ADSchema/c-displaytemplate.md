...
---
# <a name="display-template-class"></a>Classe Display-Template
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Address-entry-display-Table**](a-addressentrydisplaytable.md)            | Falso     | **Visualizzazione-modello**                                 |
| [**Address-entry-display-Table-MSDOS**](a-addressentrydisplaytablemsdos.md) | Falso     | **Visualizzazione-modello**                                 |
...
| [**Nome comune**](a-cn.md)                                                  | Vero      | **Visualizzazione-modello** in [ **alto**](c-top.md)<br/> |
...
| [**Guida-Data16**](a-helpdata16.md)                                          | Falso     | **Visualizzazione-modello**                                 |
| [**Guida-data32**](a-helpdata32.md)                                          | Falso     | **Visualizzazione-modello**                                 |
| [**Help-nome-file**](a-helpfilename.md)                                     | Falso     | **Visualizzazione-modello**                                 |
...
| [**Originale-visualizzazione tabella**](a-originaldisplaytable.md)                     | Falso     | **Visualizzazione-modello**                                 |
| [**Originale-display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | Falso     | **Visualizzazione-modello**                                 |
