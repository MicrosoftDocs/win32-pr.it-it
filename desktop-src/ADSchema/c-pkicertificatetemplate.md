...
Contiene informazioni per i certificati rilasciati dal server di certificazione.
...
| [**Nome visualizzato**](a-displayname.md)                                     | Falso     | **PKI-certificate-modello** [ **Top**](c-top.md)<br/> |
...
| [**Bandiere**](a-flags.md)                                                  | Falso     | **PKI-certificate-modello** [ **Top**](c-top.md)<br/> |
...
| [**PKI-predefinito-CSP**](a-pkidefaultcsps.md)                              | Falso     | **PKI-certificate-template**                                 |
| [**PKI-Default-Key-spec**](a-pkidefaultkeyspec.md)                       | Falso     | **PKI-certificate-template**                                 |
| [**PKI-registrazione-accesso**](a-pkienrollmentaccess.md)                    | Falso     | **PKI-certificate-template**                                 |
| [**PKI-scadenza-periodo**](a-pkiexpirationperiod.md)                    | Falso     | **PKI-certificate-template**                                 |
| [**Infrastruttura PKI-chiave estesa-utilizzo**](a-pkiextendedkeyusage.md)                   | Falso     | **PKI-certificate-template**                                 |
| [**Utilizzo chiave PKI**](a-pkikeyusage.md)                                    | Falso     | **PKI-certificate-template**                                 |
| [**PKI-max-emissione-profondità**](a-pkimaxissuingdepth.md)                     | Falso     | **PKI-certificate-template**                                 |
| [**Infrastruttura PKI-periodo di sovrapposizione**](a-pkioverlapperiod.md)                          | Falso     | **PKI-certificate-template**                                 |
...
| Nome comune                                                |
|------------------------------------------------------------|
| [**Certificato-registrazione**](r-certificate-enrollment.md) |
...
| [**ms-PKI-registrazione-flag**](a-mspki-enrollment-flag.md)                               | Falso     | **PKI-certificate-template**                                 |
| [**ms-PKI-minimo-chiave-dimensioni**](a-mspki-minimal-key-size.md)                             | Falso     | **PKI-certificate-template**                                 |
...
| [**ms-PKI-RA-criteri**](a-mspki-ra-policies.md)                                       | Falso     | **PKI-certificate-template**                                 |
| [**ms-PKI-RA-Signature**](a-mspki-ra-signature.md)                                     | Falso     | **PKI-certificate-template**                                 |
| [**ms-PKI-sostituisce-modelli**](a-mspki-supersede-templates.md)                       | Falso     | **PKI-certificate-template**                                 |
| [**ms-PKI-template-minor-Revisione**](a-mspki-template-minor-revision.md)               | Falso     | **PKI-certificate-template**                                 |
