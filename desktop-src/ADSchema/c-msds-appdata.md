...
Archivia i dati che devono essere utilizzati da un oggetto. Ad esempio, le informazioni sul profilo per un oggetto utente.
...
| [**Parole chiave**](a-keywords.md)                                              | Falso     | **ms-DS-app-dati**                                               |
| [**Ultimo elemento padre noto**](a-lastknownparent.md)                              | Falso     | [**In alto**](c-top.md)<br/>                                  |
| [**Gestito da**](a-managedby.md)                                           | Falso     | **ms-DS-app-dati**                                               |
...
| [**ms-DS-byte-array**](a-msds-bytearray.md)                                | Falso     | **ms-DS-app-dati**                                               |
...
| [**ms-DS-Data-ora**](a-msds-datetime.md)                                  | Falso     | **ms-DS-app-dati**                                               |
| [**ms-DS-Integer**](a-msds-integer.md)                                     | Falso     | **ms-DS-app-dati**                                               |
...
| [**ms-DS-Object-Reference**](a-msds-objectreference.md)                    | Falso     | **ms-DS-app-dati**                                               |
...
| [**Proprietario**](a-owner.md)                                                    | Falso     | **ms-DS-app-dati**                                               |
