...
---
# <a name="mssfu-30-mail-aliases-class"></a>classe attributo msSFU-30-mail-aliases

Rappresenta i dati del file di posta elettronica UNIX.



| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | Attributo msSFU-30-alias di posta elettronica                |
...
| [**Attributo msSFU-30-alias**](a-mssfu30aliases.md)                                | Falso     | **Attributo msSFU-30-alias di posta elettronica**       |
| [**Attributo msSFU-30-nome**](a-mssfu30name.md)                                      | Falso     | **Attributo msSFU-30-alias di posta elettronica**       |
| [**Attributo msSFU-30-NIS-domain**](a-mssfu30nisdomain.md)                           | Falso     | **Attributo msSFU-30-alias di posta elettronica**       |
...
| [**nisMapName**](a-nismapname.md)                                          | Falso     | **Attributo msSFU-30-alias di posta elettronica**       |
...
| RDN-att-ID                  | [**Nome comune**](a-cn.md)<br/>                                                       |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                              |
| Possibili superiori          | Dominio nisMap del [**contenitore**](c-container.md)[](c-nismap.md)[**-DNS**](c-domaindns.md)  |
| Classi ausiliarie           | \-                                                                                           |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                 |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; Au |
| System-Flags                | 0x00000000                                                                                   |
