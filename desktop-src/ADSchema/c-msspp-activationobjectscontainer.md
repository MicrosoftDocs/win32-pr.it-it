---
title: Classe ms-SPP-Activation-Objects-Container
description: Contenitore per gli oggetti di attivazione usati dall'attivazione basata su Active Directory
ms.assetid: 3e43b439-91aa-4bdf-b1af-96d908c9a3eb
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-SPP-Activation-Objects-Container
- Schema AD della classe msSPP-ActivationObjectsContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879401"
---
# <a name="ms-spp-activation-objects-container-class"></a>Classe ms-SPP-Activation-Objects-Container

Contenitore per gli oggetti di attivazione usati dall'attivazione basata su Active Directory
