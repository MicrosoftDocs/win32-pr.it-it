...
---
# <a name="ms-spp-activation-objects-container-class"></a>classe del contenitore MS-SPP-Activation-Objects

Contenitore per gli oggetti attivazione utilizzati dall'attivazione basata su Active Directory
