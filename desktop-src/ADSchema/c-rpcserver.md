...
---
# <a name="rpc-server-class"></a>classe server RPC

Rappresenta un particolare server che include una o più interfacce RPC.
...
| [**RPC-NS-decodificatore**](a-rpcnscodeset.md)                                  | Falso     | **Server RPC**                                                                           |
| [**RPC-NS-entry-Flags**](a-rpcnsentryflags.md)                           | Falso     | **Server RPC**                                                                           |
| [**RPC-NS-Object-ID**](a-rpcnsobjectid.md)                               | Falso     | **Server RPC**                                                                           |
