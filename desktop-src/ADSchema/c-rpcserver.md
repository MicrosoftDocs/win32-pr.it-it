...
description: Rappresenta un server specifico che contiene una o più interfacce RPC.
ms.assetid: 39ab92ac-285f-4696-a41d-1278c9b17b52
ms.tgt_platform: multiple
keywords:
- Schema AD della classe rpc-Server
- Schema AD della classe rpcServer
topic_type:
- apiref
api_name:
- rpc-Server
...
ms.locfileid: "120077721"
---
# <a name="rpc-server-class"></a>Classe rpc-Server

Rappresenta un server specifico che contiene una o più interfacce RPC.
...
| [**rpc-Ns-Codeset**](a-rpcnscodeset.md)                                  | Falso     | **rpc-Server**                                                                           |
| [**rpc-Ns-Entry-Flags**](a-rpcnsentryflags.md)                           | Falso     | **rpc-Server**                                                                           |
| [**rpc-Ns-Object-ID**](a-rpcnsobjectid.md)                               | Falso     | **rpc-Server**                                                                           |
