...
- Schema AD della classe msDFS-DeletedLinkv2
topic_type:
- apiref
api_name:
...
ms.locfileid: "117836446"
---
# <a name="ms-dfs-deleted-link-v2-class"></a>Classe ms-DFS-Deleted-Link-v2

Collegamento DFS eliminato nello spazio dei nomi DFS.
...
| [**ms-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | Falso     | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | Vero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | Vero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Path-v2**](a-msdfs-linkpathv2.md)                              | Vero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | Vero      | **ms-DFS-Deleted-Link-v2**      |
...
| [**ms-DFS-Short-Name-Link-Path-v2**](a-msdfs-shortnamelinkpathv2.md)          | Falso     | **ms-DFS-Deleted-Link-v2**      |
