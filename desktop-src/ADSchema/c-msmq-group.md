...
---
# <a name="msmq-group-class"></a>Classe MSMQ-Group

Utilizzato per definire un gruppo di code MSMQ (noto anche come elenco di distribuzione).
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| LDAP-Display-Name | Gruppo msMQ                                              |
| Privilegio aggiornamento  | Proprietario della coda.                                        |
| Frequenza di aggiornamento  | Ogni volta che un membro viene aggiunto o rimosso da un gruppo. |
| Schema-ID-GUID    | 46b27aac-aafa-4ffb-b773-e5bf621ee87b                    |
...
| [**Membro**](a-member.md)                                                  | Vero      | **Gruppo MSMQ**                  |
