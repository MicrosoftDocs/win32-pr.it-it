...
description: Questo valore viene scritto in Active Directory nel percorso a cui punta l'oggetto Criteri di gruppo specificato. Ha lo scopo di collegare i vari oggetti usati per esprimere le estensioni WMI all'Criteri di gruppo virtuale.
ms.assetid: fe70fb59-7ba5-4ae1-ac3e-9a521157bc9b
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-WMIGPO
- Schema AD della classe msWMI-WMIGPO
topic_type:
- apiref
api_name:
- ms-WMI-WMIGPO
...
ms.locfileid: "119753631"
---
# <a name="ms-wmi-wmigpo-class"></a>Classe ms-WMI-WMIGPO

Questo valore viene scritto in Active Directory nel percorso a cui punta l'oggetto Criteri di gruppo specificato. Ha lo scopo di collegare i vari oggetti usati per esprimere le estensioni WMI all'Criteri di gruppo virtuale.
...
| Schema-Id-Guid    | 05630000-3927-4ede-bf27-ca91f275c26f |
...
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Falso     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vero      | **ms-WMI-WMIGPO**               |
