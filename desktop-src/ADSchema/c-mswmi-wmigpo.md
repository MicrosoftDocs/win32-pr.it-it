...
Questo valore viene scritto nel Active Directory nel percorso a cui fa riferimento l'oggetto Criteri di gruppo corrispondente. È concepito per combinare i vari oggetti utilizzati per esprimere le estensioni WMI all'infrastruttura Criteri di gruppo.
