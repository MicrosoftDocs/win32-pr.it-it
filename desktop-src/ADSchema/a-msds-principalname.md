...
- Schema AD dell'attributo msDS-PrincipalName
topic_type:
- apiref
api_name:
...
ms.locfileid: "118683367"
---
# <a name="ms-ds-principal-name-attribute"></a>Attributo ms-DS-Principal-Name

Nome dell'account per l'entità di sicurezza (costruita).
...
| Classi usate in        | [**ms-DS-Bind-Proxy**](c-msds-bindproxy.md)<br/> |
