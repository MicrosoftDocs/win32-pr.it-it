...
---
# <a name="locality-class"></a>Classe di località

Contiene una località, ad esempio un indirizzo, una città e uno stato.
...
| Privilegio aggiornamento  | Questo valore viene impostato dall'amministratore di dominio o dal proprietario dell'account.          |
| Frequenza di aggiornamento  | Quando viene creato un record utente e ogni volta che è necessario modificare la località. |
...
| RDN-att-ID                  | [**Nome località**](a-l.md)<br/>                                                                                           |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                                                                   |
| Possibili superiori          | [**Organizzazione**](c-organization.md)locale-[**paese**](c-country.md) dell'[**unità organizzativa**](c-organizationalunit.md) |
| Classi ausiliarie           | \-                                                                                                                                |
...
| [**Nome località**](a-l.md)                                              | Vero      | **Località**                    |
...
| [**Stato-o-provincia-nome**](a-st.md)                                    | Falso     | **Località**                    |
| [**Indirizzo via**](a-street.md)                                        | Falso     | **Località**                    |
...
| RDN-att-ID                  | [**Nome località**](a-l.md)<br/>                                                                                                                            |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                                                                                                    |
| Possibili superiori          | Organizzazione della **località**[**Organization**](c-organization.md)[**-**](c-organizationalunit.md)domain [**Country**](c-country.md)[**-DNS**](c-domaindns.md) |
| Classi ausiliarie           | \-                                                                                                                                                                 |
| NT-Security-descrittore      | O:BAG: NON VALIDO: S:                                                                                                                                                       |
| Descrittore di sicurezza predefinito | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; Au                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
