---
title: Classe Locality
description: Contiene una città, ad esempio un indirizzo, una città e uno stato.
ms.assetid: e668fb4b-5414-4ff3-9230-a06feacca84b
ms.tgt_platform: multiple
keywords:
- Schema AD della classe locality
- Classe di localizzazione Schema DI AD
topic_type:
- apiref
api_name:
- Locality
...
ms.locfileid: "119834921"
---
# <a name="locality-class"></a>Classe Locality

Contiene una città, ad esempio un indirizzo, una città e uno stato.
...
| Privilegio di aggiornamento  | Questo valore viene impostato dall'amministratore di dominio o dal proprietario dell'account.          |
| Frequenza di aggiornamento  | Quando viene creato un record utente e ogni volta che la localizzazione deve cambiare. |
...
| Possibili superiori          | **Locality**[**Organization**](c-organization.md)[**Organizational-Unit**](c-organizationalunit.md)[**Country**](c-country.md) |
| Classi ausiliarie           | \-                                                                                                                                |
...
| [**Locality-Name**](a-l.md)                                              | Vero      | **Località**                    |
...
| [**Guida alla ricerca**](a-searchguide.md)                                     | Falso     | **Località**                    |
| [**Vedere anche**](a-seealso.md)                                             | Falso     | **Località**                    |
...
| [**State-or-Province-Name**](a-st.md)                                    | Falso     | **Località**                    |
| [**Via e indirizzo**](a-street.md)                                        | Falso     | **Località**                    |
...
| Rdn-Att-Id                  | [**Locality-Name**](a-l.md)<br/>                                                                                                                            |
| Sottoclasse di                 | [**In alto**](c-top.md)<br/>                                                                                                                                    |
| Possibili superiori          | **Locality**[**Organization**](c-organization.md)[**Organizational-Unit**](c-organizationalunit.md)[**Country**](c-country.md)[**Domain-DNS**](c-domaindns.md) |
| Classi ausiliarie           | \-                                                                                                                                                                 |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                                                       |
| Descrittore di sicurezza predefinito | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; Au)                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
...
| [**State-Or-Province-Name**](a-st.md)                                      | Falso     | **Località**                    |
| [**Via**](a-street.md)                                          | Falso     | **Località**                    |
