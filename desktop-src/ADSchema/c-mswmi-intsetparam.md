...
description: Oggetto parametro del set di interi con segno.
ms.assetid: ad7b7a66-3216-496f-a40d-f3b4ab8de8ec
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-WMI-IntSetParam
- Schema AD della classe msWMI-IntSetParam
topic_type:
- apiref
api_name:
- ms-WMI-IntSetParam
...
ms.locfileid: "119440331"
---
# <a name="ms-wmi-intsetparam-class"></a>Classe ms-WMI-IntSetParam

Oggetto parametro del set di interi con segno.
...
| [**ms-WMI-intDefault**](a-mswmi-intdefault.md)                             | Vero      | **ms-WMI-IntSetParam**                                     |
| [**ms-WMI-intValidValues**](a-mswmi-intvalidvalues.md)                     | Falso     | **ms-WMI-IntSetParam**                                     |
