...
---
# <a name="supplemental-credentials-attribute"></a>Attributo Supplemental-Credentials

Credenziali archiviate da utilizzare per l'autenticazione. Versione crittografata della password dell'utente. Questo attributo non è leggibile né scrivibile.
...
| Frequenza di aggiornamento  | Quando la password dell'utente viene modificata.                     |
