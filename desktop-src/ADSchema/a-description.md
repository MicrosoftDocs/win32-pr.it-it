...
description: Contiene la descrizione da visualizzare per un oggetto . Questo valore è limitato come a valore singolo per compatibilità con le versioni precedenti in alcuni casi, ma può essere multivalore in altri. Vedere la sezione Osservazioni.
ms.assetid: 97dad871-5db0-4d1e-b931-1b053559f9c2
ms.tgt_platform: multiple
keywords:
- Attributo di descrizione Schema AD
- Attributo description Schema di ACTIVE Directory
topic_type:
- apiref
api_name:
- Description
...
Contiene la descrizione da visualizzare per un oggetto . Questo valore è limitato come a valore singolo per compatibilità con le versioni precedenti in alcuni casi, ma può essere multivalore in altri. Vedere la sezione Osservazioni.
