...
---
# <a name="short-server-name-attribute"></a>Short-Server-Name-attributo

Nome del server compatibile precedente a Windows 2000 per i server di stampa.



| Voce | Valore |
|-------------------|---------------------------------------------|
| CN                | Nome-server breve                           |
| LDAP-Display-Name | shortServerName                             |
| Dimensione              | \-                                          |
| Privilegio aggiornamento  | Amministratore di dominio                        |
| Frequenza di aggiornamento  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1209                     |
| System-ID-GUID    | 45b01501-c419-11d1-bbc9-0080c76670c0        |
