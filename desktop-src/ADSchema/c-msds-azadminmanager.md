...
Radice dell'istanza dell'archivio dei criteri di autorizzazione. Si noti che possono essere presenti molte istanze di archivio.
...
| Privilegio aggiornamento  | Questo valore viene impostato dall'amministratore di AzRoles. |
...
| Possibili superiori          | [](c-container.md)[**Unità organizzativa**](c-organizationalunit.md)del contenitore [**-DNS**](c-domaindns.md)             |
| Classi ausiliarie           | \-                                                                                                                               |
...
| [**ms-DS-AZ-generate-controlli**](a-msds-azgenerateaudits.md)                 | Falso     | **ms-DS-AZ-Admin-Manager**                                 |
