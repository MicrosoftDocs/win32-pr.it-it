...
---
# <a name="usn-source-attribute"></a>Attributo USN-Source

Valore dell'attributo [**USN-changed**](a-usnchanged.md) dell'oggetto dalla directory remota che ha replicato la modifica nel server locale.
...
| Frequenza di aggiornamento  | Quando l'oggetto viene modificato in una directory remota che ha replicato la modifica alla directory locale. |
