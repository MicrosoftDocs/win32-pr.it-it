...
---
# <a name="ms-wmi-rule-class"></a>Classe MS-WMI-Rule

Definisce una singola regola in un SOM.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-regola                          |
| LDAP-Display-Name | msWMI-regola                           |
| Privilegio aggiornamento  | Amministratore Criteri di gruppo           |
| Frequenza di aggiornamento  | \-                                   |
| Schema-ID-GUID    | 3c7e6f83-dd0e-481b-a0c2-74cd96ef2a66 |
...
| Possibili superiori          | [**Contenitore**](c-container.md)[**MS-WMI-som**](c-mswmi-som.md)                            |
| Classi ausiliarie           | \-                                                                                           |
...
| [**MS-WMI-query**](a-mswmi-query.md)                                       | Vero      | **MS-WMI-regola**                 |
| [**MS-WMI-QueryLanguage**](a-mswmi-querylanguage.md)                       | Vero      | **MS-WMI-regola**                 |
| [**MS-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | Vero      | **MS-WMI-regola**                 |
