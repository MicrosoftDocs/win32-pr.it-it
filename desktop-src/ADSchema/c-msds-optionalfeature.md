...
---
# <a name="ms-ds-optional-feature-class"></a>ms-DS-optional-classe della funzionalità
...
| Voce | Valore |
|-------------------|--------------------------------------|
| CN                | ms-DS-facoltativo-funzionalità               |
...
| [**ms-DS-facoltativo-feature-Flags**](a-msds-optionalfeatureflags.md)                    | Vero      | **ms-DS-facoltativo-funzionalità**      |
| [**ms-DS-facoltativo-feature-GUID**](a-msds-optionalfeatureguid.md)                      | Vero      | **ms-DS-facoltativo-funzionalità**      |
...
| [**ms-DS-required-Domain-Behavior-Version**](a-msds-requireddomainbehaviorversion.md) | Falso     | **ms-DS-facoltativo-funzionalità**      |
| [**ms-DS-required-Forest-Behavior-Version**](a-msds-requiredforestbehaviorversion.md) | Falso     | **ms-DS-facoltativo-funzionalità**      |
