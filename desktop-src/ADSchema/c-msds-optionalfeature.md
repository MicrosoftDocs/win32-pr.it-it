---
title: Classe ms-DS-Optional-Feature
description: Configurazione per una funzionalità DS facoltativa.
ms.assetid: 236ff60d-84a2-4c71-9759-1863e24b2a98
ms.tgt_platform: multiple
keywords:
- Schema AD della classe ms-DS-Optional-Feature
- Schema AD della classe msDS-OptionalFeature
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879981"
---
# <a name="ms-ds-optional-feature-class"></a>Classe ms-DS-Optional-Feature

Configurazione per una funzionalità DS facoltativa.
...
| Descrittore di sicurezza predefinito | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; EA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**ms-DS-Optional-Feature-Flags**](a-msds-optionalfeatureflags.md)                    | Vero      | **ms-DS-Optional-Feature**      |
| [**ms-DS-Optional-Feature-GUID**](a-msds-optionalfeatureguid.md)                      | Vero      | **ms-DS-Optional-Feature**      |
...
| [**ms-DS-Required-Domain-Behavior-Version**](a-msds-requireddomainbehaviorversion.md) | Falso     | **ms-DS-Optional-Feature**      |
| [**ms-DS-Required-Forest-Behavior-Version**](a-msds-requiredforestbehaviorversion.md) | Falso     | **ms-DS-Optional-Feature**      |
