...
---
# <a name="inapcomponentinfogetdescription-method"></a>Metodo INapComponentInfo:: GetDescription
...
Il metodo di callback **INapComponentInfo:: GetDescription** viene utilizzato dal sistema NAP per ottenere la descrizione di un client di integrità.
...
Puntatore a un [**MessageID**](nap-datatypes.md) che contiene l'ID risorsa della descrizione.
