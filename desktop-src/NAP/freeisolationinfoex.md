...
---
# <a name="freeisolationinfoex-function"></a>FreeIsolationInfoEx (funzione)
...
La funzione **FreeIsolationInfoEx** libera una struttura di dati [**IsolationInfoEx**](/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) .
...
Puntatore alla struttura di dati [**IsolationInfoEx**](/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) da liberare.
