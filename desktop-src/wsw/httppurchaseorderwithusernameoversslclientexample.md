...
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="3fe90-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="3fe90-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="3fe90-107">Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio PurchaseOrder, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="3fe90-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="3fe90-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="3fe90-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="3fe90-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="3fe90-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="3fe90-110">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="3fe90-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="3fe90-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3fe90-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3fe90-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="3fe90-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="3fe90-113">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="3fe90-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3fe90-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3fe90-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3fe90-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="3fe90-115">Makefile</span></span>
