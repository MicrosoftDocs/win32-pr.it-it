...
description: Questo esempio illustra come creare manualmente la descrizione dei criteri e usarla per creare il proxy del servizio.
ms.assetid: 1c7ff0fb-06a2-4285-bbc8-ea8f2d82b15b
keywords:
- PolicyTemplateExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044950"
---
# <a name="policytemplateexample"></a><span data-ttu-id="dd43d-106">PolicyTemplateExample</span><span class="sxs-lookup"><span data-stu-id="dd43d-106">PolicyTemplateExample</span></span>

<span data-ttu-id="dd43d-107">Questo esempio illustra come creare manualmente la descrizione dei criteri e usarla per creare il proxy del servizio.</span><span class="sxs-lookup"><span data-stu-id="dd43d-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="dd43d-108">PolicyTemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="dd43d-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="dd43d-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="dd43d-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="dd43d-110">PolicyTemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="dd43d-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="dd43d-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="dd43d-111">Makefile</span></span>
