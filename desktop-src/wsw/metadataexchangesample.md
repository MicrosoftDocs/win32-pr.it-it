...
description: Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su TCP. Il servizio supporta inoltre WS-MetadataExchange.
ms.assetid: 8f14e6a8-ccb9-4556-b04f-df08c6c80adf
keywords:
- MetadataExchangeSample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044296"
---
# <a name="metadataexchangesample"></a><span data-ttu-id="9dce6-107">MetadataExchangeSample</span><span class="sxs-lookup"><span data-stu-id="9dce6-107">MetadataExchangeSample</span></span>

<span data-ttu-id="9dce6-108">Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su TCP.</span><span class="sxs-lookup"><span data-stu-id="9dce6-108">This example shows how to use service host for hosting a PurchaseOrder service over TCP.</span></span> <span data-ttu-id="9dce6-109">Il servizio supporta inoltre WS-MetadataExchange.</span><span class="sxs-lookup"><span data-stu-id="9dce6-109">The service also supports WS-MetadataExchange.</span></span>

-   [<span data-ttu-id="9dce6-110">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="9dce6-110">MexService.cpp</span></span>](#mexservicecpp)
-   [<span data-ttu-id="9dce6-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9dce6-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9dce6-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="9dce6-112">Makefile</span></span>](#makefile)

## <a name="mexservicecpp"></a><span data-ttu-id="9dce6-113">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="9dce6-113">MexService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9dce6-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9dce6-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9dce6-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="9dce6-115">Makefile</span></span>
