...
description: Vedere un esempio di richiesta e risposta al server TCP che usa l'API dei servizi Web Windows (WWSAPI). Questo esempio accetta un canale e riceve e risponde ai messaggi.
...
ms.locfileid: "112404084"
---
# <a name="requestreplytcpserverexample"></a><span data-ttu-id="bb962-107">RequestReplyTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="bb962-107">RequestReplyTcpServerExample</span></span>

<span data-ttu-id="bb962-108">In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi.</span><span class="sxs-lookup"><span data-stu-id="bb962-108">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="bb962-109">RequestReplyTcpServer.cpp</span><span class="sxs-lookup"><span data-stu-id="bb962-109">RequestReplyTcpServer.cpp</span></span>](#requestreplytcpservercpp)
-   [<span data-ttu-id="bb962-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="bb962-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="bb962-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="bb962-111">Makefile</span></span>](#makefile)

## <a name="requestreplytcpservercpp"></a><span data-ttu-id="bb962-112">RequestReplyTcpServer.cpp</span><span class="sxs-lookup"><span data-stu-id="bb962-112">RequestReplyTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="bb962-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="bb962-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="bb962-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="bb962-114">Makefile</span></span>
