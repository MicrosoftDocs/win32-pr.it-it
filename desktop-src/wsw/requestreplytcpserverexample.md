...
description: Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi.
ms.assetid: da9a507b-952d-4378-a37f-c2c4407335e8
keywords:
- RequestReplyTcpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106297929"
---
# <a name="requestreplytcpserverexample"></a><span data-ttu-id="71d94-106">RequestReplyTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="71d94-106">RequestReplyTcpServerExample</span></span>

<span data-ttu-id="71d94-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi.</span><span class="sxs-lookup"><span data-stu-id="71d94-107">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="71d94-108">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="71d94-108">RequestReplyTcpServer.cpp</span></span>](#requestreplytcpservercpp)
-   [<span data-ttu-id="71d94-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="71d94-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="71d94-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="71d94-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpservercpp"></a><span data-ttu-id="71d94-111">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="71d94-111">RequestReplyTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="71d94-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="71d94-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="71d94-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="71d94-113">Makefile</span></span>
