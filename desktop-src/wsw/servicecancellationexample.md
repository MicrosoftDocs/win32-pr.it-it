...
description: Applicazione client di esempio che illustra l'annullamento del servizio.
ms.assetid: c9e727c8-5fa7-47b9-8624-18fe4de79026
keywords:
- ServiceCancellationExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103855177"
---
# <a name="servicecancellationexample"></a><span data-ttu-id="71d3e-106">ServiceCancellationExample</span><span class="sxs-lookup"><span data-stu-id="71d3e-106">ServiceCancellationExample</span></span>

<span data-ttu-id="71d3e-107">Applicazione client di esempio che illustra l'annullamento del servizio.</span><span class="sxs-lookup"><span data-stu-id="71d3e-107">Example client application demonstrating service cancellation.</span></span>

-   [<span data-ttu-id="71d3e-108">ServiceCancel. cpp</span><span class="sxs-lookup"><span data-stu-id="71d3e-108">ServiceCancel.cpp</span></span>](#servicecancelcpp)
-   [<span data-ttu-id="71d3e-109">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="71d3e-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="71d3e-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="71d3e-110">Makefile</span></span>](#makefile)

## <a name="servicecancelcpp"></a><span data-ttu-id="71d3e-111">ServiceCancel. cpp</span><span class="sxs-lookup"><span data-stu-id="71d3e-111">ServiceCancel.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="71d3e-112">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="71d3e-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="71d3e-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="71d3e-113">Makefile</span></span>
