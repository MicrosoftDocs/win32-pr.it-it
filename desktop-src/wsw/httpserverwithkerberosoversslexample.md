...
description: Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con Kerberos sulla sicurezza in modalità mista SSL.
ms.assetid: 2910f594-2f38-4c1e-bb47-89258b752572
keywords:
- HttpServerWithKerberosOverSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103955819"
---
# <a name="httpserverwithkerberosoversslexample"></a><span data-ttu-id="be6ae-106">HttpServerWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="be6ae-106">HttpServerWithKerberosOverSslExample</span></span>

<span data-ttu-id="be6ae-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con Kerberos sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="be6ae-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="be6ae-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="be6ae-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="be6ae-109">L'autenticazione client viene fornita da un ticket APREQ Kerberos in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="be6ae-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="be6ae-110">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="be6ae-110">HttpServerWithKerberosOverSsl.cpp</span></span>](#httpserverwithkerberosoversslcpp)
-   [<span data-ttu-id="be6ae-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="be6ae-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="be6ae-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="be6ae-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithkerberosoversslcpp"></a><span data-ttu-id="be6ae-113">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="be6ae-113">HttpServerWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="be6ae-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="be6ae-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="be6ae-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="be6ae-115">Makefile</span></span>
