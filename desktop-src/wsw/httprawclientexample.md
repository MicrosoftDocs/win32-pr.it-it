...
description: Questo esempio è il lato client che invia richieste HTTP non elaborate.
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- HttpRawClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103856457"
---
# <a name="httprawclientexample"></a><span data-ttu-id="c319d-106">HttpRawClientExample</span><span class="sxs-lookup"><span data-stu-id="c319d-106">HttpRawClientExample</span></span>

<span data-ttu-id="c319d-107">Questo esempio è il lato client che invia richieste HTTP non elaborate.</span><span class="sxs-lookup"><span data-stu-id="c319d-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="c319d-108">HttpRawClient. cpp</span><span class="sxs-lookup"><span data-stu-id="c319d-108">HttpRawClient.cpp</span></span>
