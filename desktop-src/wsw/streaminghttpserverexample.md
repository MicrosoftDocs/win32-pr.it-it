...
description: Questo esempio mostra un server HTTP che accetta un canale ed esegue l'elaborazione Request/Reply in modalità flusso.
ms.assetid: c108a5b3-923c-439c-8d86-7003a76ff45d
keywords:
- StreamingHttpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103857038"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="a3c49-106">StreamingHttpServerExample</span><span class="sxs-lookup"><span data-stu-id="a3c49-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="a3c49-107">Questo esempio mostra un server HTTP che accetta un canale ed esegue l'elaborazione Request/Reply in modalità flusso.</span><span class="sxs-lookup"><span data-stu-id="a3c49-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="a3c49-108">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="a3c49-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="a3c49-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a3c49-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a3c49-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="a3c49-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="a3c49-111">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="a3c49-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a3c49-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a3c49-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a3c49-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="a3c49-113">Makefile</span></span>
