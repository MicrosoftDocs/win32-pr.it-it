...
description: Implementazione di un servizio di calcolo con sessione utilizzando l'host del servizio.
ms.assetid: 7501025b-5692-4f89-ad74-c60694c29163
keywords:
- SessionfullCalculatorServiceExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104332548"
---
# <a name="sessionfullcalculatorserviceexample"></a><span data-ttu-id="2f59c-106">SessionfullCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="2f59c-106">SessionfullCalculatorServiceExample</span></span>

<span data-ttu-id="2f59c-107">Implementazione di un servizio di calcolo con sessione utilizzando l'host del servizio.</span><span class="sxs-lookup"><span data-stu-id="2f59c-107">An implementation of a sessionful calculator service using the Service Host.</span></span>

-   [<span data-ttu-id="2f59c-108">SessionfullCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="2f59c-108">SessionfullCalculatorService.cpp</span></span>](#sessionfullcalculatorservicecpp)
-   [<span data-ttu-id="2f59c-109">SessionBasedCalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="2f59c-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="2f59c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2f59c-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorservicecpp"></a><span data-ttu-id="2f59c-111">SessionfullCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="2f59c-111">SessionfullCalculatorService.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="2f59c-112">SessionBasedCalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="2f59c-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2f59c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2f59c-113">Makefile</span></span>
