...
description: Questo esempio mostra un server TCP che accetta un canale e legge i messaggi unidirezionali in modalità flusso.
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- StreamingTcpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104395770"
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="70a32-106">StreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="70a32-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="70a32-107">Questo esempio mostra un server TCP che accetta un canale e legge i messaggi unidirezionali in modalità flusso.</span><span class="sxs-lookup"><span data-stu-id="70a32-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="70a32-108">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="70a32-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="70a32-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="70a32-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="70a32-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="70a32-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="70a32-111">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="70a32-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="70a32-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="70a32-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="70a32-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="70a32-113">Makefile</span></span>
