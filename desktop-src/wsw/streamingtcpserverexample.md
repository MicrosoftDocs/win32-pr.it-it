...
description: In questo esempio viene illustrato un server TCP che accetta un canale e legge i messaggi unidireli in modalità di streaming.
...
ms.locfileid: "120109821"
---
# <a name="streamingtcpserverexample"></a>StreamingTcpServerExample

In questo esempio viene illustrato un server TCP che accetta un canale e legge i messaggi unidireli in modalità di streaming.
