...
description: Questo esempio mostra un server TCP che riceve messaggi unidirezionali in modalità di flusso asincrono.
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- AsyncStreamingTcpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298357"
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="d7072-106">AsyncStreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="d7072-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="d7072-107">Questo esempio mostra un server TCP che riceve messaggi unidirezionali in modalità di flusso asincrono.</span><span class="sxs-lookup"><span data-stu-id="d7072-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="d7072-108">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="d7072-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="d7072-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d7072-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d7072-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d7072-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="d7072-111">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="d7072-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d7072-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d7072-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d7072-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d7072-113">Makefile</span></span>
