...
description: Questo esempio scrive i dati binari usando la codifica MTOM e lo legge.
ms.assetid: 6b80846e-6959-4c38-bf1b-17827ecb9d1a
keywords:
- Servizi Web ReadWriteBytesXmlExample per Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106297621"
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="5d1ad-106">ReadWriteBytesXmlExample</span><span class="sxs-lookup"><span data-stu-id="5d1ad-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="5d1ad-107">Questo esempio scrive i dati binari usando la codifica MTOM e lo legge.</span><span class="sxs-lookup"><span data-stu-id="5d1ad-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="5d1ad-108">ReadWriteBytesXml. cpp</span><span class="sxs-lookup"><span data-stu-id="5d1ad-108">ReadWriteBytesXml.cpp</span></span>
