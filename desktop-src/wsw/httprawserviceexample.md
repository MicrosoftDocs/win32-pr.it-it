...
---
# <a name="httprawserviceexample"></a><span data-ttu-id="34d1c-106">HttpRawServiceExample</span><span class="sxs-lookup"><span data-stu-id="34d1c-106">HttpRawServiceExample</span></span>

<span data-ttu-id="34d1c-107">Questo esempio illustra come usare l'host del servizio per gestire le richieste HTTP non elaborate (non SOAP).</span><span class="sxs-lookup"><span data-stu-id="34d1c-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="34d1c-108">HttpRawService. cpp</span><span class="sxs-lookup"><span data-stu-id="34d1c-108">HttpRawService.cpp</span></span>
