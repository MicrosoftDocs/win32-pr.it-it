...
description: Applicazione client per la conversazione con un servizio calcolatrice con sessione.
...
ms.locfileid: "119880961"
---
# <a name="sessionfullcalculatorclientexample"></a>SessionfullCalculatorClientExample

Applicazione client per la conversazione con un servizio calcolatrice con sessione.
