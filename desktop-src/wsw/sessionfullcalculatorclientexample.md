...
description: Applicazione client per comunicare con un servizio di calcolatrice con sessione.
ms.assetid: 0981474c-cb87-4069-ab84-7662776c182e
keywords:
- SessionfullCalculatorClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103710228"
---
# <a name="sessionfullcalculatorclientexample"></a><span data-ttu-id="7f023-106">SessionfullCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="7f023-106">SessionfullCalculatorClientExample</span></span>

<span data-ttu-id="7f023-107">Applicazione client per comunicare con un servizio di calcolatrice con sessione.</span><span class="sxs-lookup"><span data-stu-id="7f023-107">Client application to talk to a sessionful calculator service.</span></span>

-   [<span data-ttu-id="7f023-108">SessionfullCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="7f023-108">SessionfullCalculatorClient.cpp</span></span>](#sessionfullcalculatorclientcpp)
-   [<span data-ttu-id="7f023-109">SessionBasedCalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f023-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="7f023-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f023-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorclientcpp"></a><span data-ttu-id="7f023-111">SessionfullCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="7f023-111">SessionfullCalculatorClient.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="7f023-112">SessionBasedCalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f023-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7f023-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f023-113">Makefile</span></span>
