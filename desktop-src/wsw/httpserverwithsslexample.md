...
description: In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi, con sicurezza del trasporto SSL.
...
ms.locfileid: "119927285"
---
# <a name="httpserverwithsslexample"></a>HttpServerWithSslExample

In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi, con sicurezza del trasporto SSL.
