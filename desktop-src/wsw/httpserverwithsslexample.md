...
description: Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con la sicurezza del trasporto SSL.
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- HttpServerWithSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104332335"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="14efc-106">HttpServerWithSslExample</span><span class="sxs-lookup"><span data-stu-id="14efc-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="14efc-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con la sicurezza del trasporto SSL.</span><span class="sxs-lookup"><span data-stu-id="14efc-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="14efc-108">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="14efc-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="14efc-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="14efc-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="14efc-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="14efc-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="14efc-111">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="14efc-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="14efc-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="14efc-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="14efc-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="14efc-113">Makefile</span></span>
