...
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a><span data-ttu-id="95e28-106">HttpCalculatorWithSslPolicyClientExample</span><span class="sxs-lookup"><span data-stu-id="95e28-106">HttpCalculatorWithSslPolicyClientExample</span></span>

<span data-ttu-id="95e28-107">Questo esempio illustra come usare le routine di supporto per i criteri generati da WSUTIL per creare il proxy del servizio per comunicare con un servizio di calcolatrice, con la sicurezza del trasporto SSL.</span><span class="sxs-lookup"><span data-stu-id="95e28-107">This example shows how to use the wsutil generated policy helper routines to create service proxy to talk to a calculator service, with SSL transport security.</span></span> <span data-ttu-id="95e28-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="95e28-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span>

-   [<span data-ttu-id="95e28-109">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="95e28-109">HttpCalculatorWithSslPolicyClient.cpp</span></span>](#httpcalculatorwithsslpolicyclientcpp)
-   [<span data-ttu-id="95e28-110">CalculatorServiceWithPolicy. WSDL</span><span class="sxs-lookup"><span data-stu-id="95e28-110">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="95e28-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="95e28-111">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a><span data-ttu-id="95e28-112">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="95e28-112">HttpCalculatorWithSslPolicyClient.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="95e28-113">CalculatorServiceWithPolicy. WSDL</span><span class="sxs-lookup"><span data-stu-id="95e28-113">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="95e28-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="95e28-114">Makefile</span></span>
