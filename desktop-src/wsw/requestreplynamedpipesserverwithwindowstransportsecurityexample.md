...
description: Questo esempio mostra un server named pipe che accetta un canale e riceve e risponde ai messaggi con sicurezza fornita dalla sicurezza del trasporto SSPI di Windows.
...
ms.locfileid: "104044024"
---
# <a name="requestreplynamedpipesserverwithwindowstransportsecurityexample"></a><span data-ttu-id="45dd9-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="45dd9-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="45dd9-104">Questo esempio mostra un server named pipe che accetta un canale e riceve e risponde ai messaggi con sicurezza fornita dalla sicurezza del trasporto SSPI di Windows.</span><span class="sxs-lookup"><span data-stu-id="45dd9-104">This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.</span></span>

-   [<span data-ttu-id="45dd9-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="45dd9-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="45dd9-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="45dd9-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="45dd9-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="45dd9-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="45dd9-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="45dd9-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="45dd9-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="45dd9-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="45dd9-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="45dd9-110">Makefile</span></span>
