...
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="e4e28-106">HttpCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="e4e28-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="e4e28-107">Questo esempio illustra come usare il proxy del servizio per comunicare con un servizio di calcolatrice basato su HTTP.</span><span class="sxs-lookup"><span data-stu-id="e4e28-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="e4e28-108">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="e4e28-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="e4e28-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="e4e28-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="e4e28-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="e4e28-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="e4e28-111">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="e4e28-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="e4e28-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="e4e28-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e4e28-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="e4e28-113">Makefile</span></span>
