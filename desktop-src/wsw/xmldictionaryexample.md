...
description: In questo esempio viene scritto un documento utilizzando \_ un \_ dizionario WS XML.
ms.assetid: d8185577-3483-4005-84e5-0b10a6698e79
keywords:
- XmlDictionaryExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104331063"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="f338d-106">XmlDictionaryExample</span><span class="sxs-lookup"><span data-stu-id="f338d-106">XmlDictionaryExample</span></span>

<span data-ttu-id="f338d-107">In questo esempio viene scritto un documento utilizzando \_ un \_ dizionario WS XML.</span><span class="sxs-lookup"><span data-stu-id="f338d-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="f338d-108">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="f338d-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="f338d-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="f338d-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="f338d-110">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="f338d-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f338d-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="f338d-111">Makefile</span></span>
