...
description: Applicazione client di esempio che illustra l'abbandono di una chiamata.
ms.assetid: 71253dd6-4f59-4acd-b244-c721834ca381
keywords:
- CallAbandonExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104395942"
---
# <a name="callabandonexample"></a><span data-ttu-id="be3b0-106">CallAbandonExample</span><span class="sxs-lookup"><span data-stu-id="be3b0-106">CallAbandonExample</span></span>

<span data-ttu-id="be3b0-107">Applicazione client di esempio che illustra l'abbandono di una chiamata.</span><span class="sxs-lookup"><span data-stu-id="be3b0-107">Example client application demonstrating abandoning a call.</span></span>

-   [<span data-ttu-id="be3b0-108">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="be3b0-108">AbandonCallClient.cpp</span></span>](#abandoncallclientcpp)
-   [<span data-ttu-id="be3b0-109">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="be3b0-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="be3b0-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="be3b0-110">Makefile</span></span>](#makefile)

## <a name="abandoncallclientcpp"></a><span data-ttu-id="be3b0-111">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="be3b0-111">AbandonCallClient.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="be3b0-112">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="be3b0-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="be3b0-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="be3b0-113">Makefile</span></span>
