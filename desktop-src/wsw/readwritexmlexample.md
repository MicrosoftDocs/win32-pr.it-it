...
description: Esaminare un esempio di lettura/scrittura XML che usa Windows API dei servizi Web (WWSAPI). Questo esempio scrive codice XML in un buffer XML e quindi lo legge nuovamente.
