...
---
# <a name="requestreplytcpclientwithwindowstransportsecurityexample"></a><span data-ttu-id="9ed02-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="9ed02-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="9ed02-108">Questo esempio mostra un client TCP che invia messaggi di richiesta-risposta, con la sicurezza fornita dalla sicurezza del trasporto SSPI di Windows.</span><span class="sxs-lookup"><span data-stu-id="9ed02-108">This example shows a TCP client that sends request-reply messages, with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="9ed02-109">Viene inoltre illustrato il client utilizzando le proprietà del token di sicurezza per modificare il livello di rappresentazione consentito dal valore predefinito.</span><span class="sxs-lookup"><span data-stu-id="9ed02-109">It also illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="9ed02-110">RequestReplyTcpClientWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="9ed02-110">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="9ed02-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9ed02-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9ed02-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="9ed02-112">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="9ed02-113">RequestReplyTcpClientWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="9ed02-113">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9ed02-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9ed02-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9ed02-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="9ed02-115">Makefile</span></span>
