...
---
# <a name="blockingserviceexample"></a><span data-ttu-id="0578a-106">BlockingServiceExample</span><span class="sxs-lookup"><span data-stu-id="0578a-106">BlockingServiceExample</span></span>

<span data-ttu-id="0578a-107">Applicazione di servizio di esempio che illustra l'annullamento della chiamata sul lato server.</span><span class="sxs-lookup"><span data-stu-id="0578a-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="0578a-108">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="0578a-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="0578a-109">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0578a-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="0578a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0578a-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="0578a-111">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="0578a-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="0578a-112">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0578a-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0578a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0578a-113">Makefile</span></span>
