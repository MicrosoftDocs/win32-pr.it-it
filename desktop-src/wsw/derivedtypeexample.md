...
In questo esempio vengono scritti e letti i tipi derivati usando le funzioni Helper C++ generate da wsutil. Per ulteriori informazioni sulle descrizioni di tipi derivati, vedere [**\_ mapping dei campi dell' \_ attributo \_ \_ WS Type**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .
...
[**\_ \_ \_ mapping campi attributo di tipo WS \_**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
