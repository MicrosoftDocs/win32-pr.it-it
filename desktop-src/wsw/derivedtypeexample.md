...
description: In questo esempio vengono scritti e letti i tipi derivati usando le funzioni Helper C++ generate da wsutil. \_ \_ \_ \_ Per ulteriori informazioni sulle descrizioni di tipi derivati, vedere Mapping dei campi dell'attributo WS Type.
ms.assetid: 279663c0-8797-4f87-aaec-8cb8d4046a05
keywords:
- DerivedTypeExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298059"
---
# <a name="derivedtypeexample"></a><span data-ttu-id="46b3f-107">DerivedTypeExample</span><span class="sxs-lookup"><span data-stu-id="46b3f-107">DerivedTypeExample</span></span>

<span data-ttu-id="46b3f-108">In questo esempio vengono scritti e letti i tipi derivati usando le funzioni Helper C++ generate da wsutil.</span><span class="sxs-lookup"><span data-stu-id="46b3f-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="46b3f-109">Per ulteriori informazioni sulle descrizioni di tipi derivati, vedere [**\_ mapping dei campi dell' \_ attributo \_ \_ WS Type**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .</span><span class="sxs-lookup"><span data-stu-id="46b3f-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="46b3f-110">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="46b3f-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="46b3f-111">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="46b3f-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="46b3f-112">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="46b3f-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="46b3f-113">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="46b3f-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="46b3f-114">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="46b3f-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="46b3f-115">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="46b3f-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="46b3f-116">**\_ \_ \_ mapping campi attributo di tipo WS \_**</span><span class="sxs-lookup"><span data-stu-id="46b3f-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
