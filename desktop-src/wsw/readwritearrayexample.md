...
description: In questo esempio viene letta e scritta una matrice di elementi.
ms.assetid: 3c4851b5-1c31-4de7-929e-03a8199b273a
keywords:
- Servizi Web ReadWriteArrayExample per Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106297622"
---
# <a name="readwritearrayexample"></a><span data-ttu-id="a9b3b-106">ReadWriteArrayExample</span><span class="sxs-lookup"><span data-stu-id="a9b3b-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="a9b3b-107">In questo esempio viene letta e scritta una matrice di elementi.</span><span class="sxs-lookup"><span data-stu-id="a9b3b-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="a9b3b-108">ReadWriteArray. cpp</span><span class="sxs-lookup"><span data-stu-id="a9b3b-108">ReadWriteArray.cpp</span></span>
