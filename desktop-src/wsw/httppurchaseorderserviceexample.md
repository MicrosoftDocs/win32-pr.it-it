...
description: Esaminare un Windows api dei servizi Web (WWSAPI) C++ che illustra come usare l'host del servizio per ospitare un servizio di ordine di acquisto su HTTP.
