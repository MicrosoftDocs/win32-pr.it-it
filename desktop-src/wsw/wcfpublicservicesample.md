...
description: Questo esempio mostra il proxy di servizio che comunica con il WSDL del servizio//131.107.72.15/Example HelloWorld di http \_ \_ \_ Indigo/HelloWorld. svc.
ms.assetid: 755e645e-b39c-471c-9220-531dec4fc107
keywords:
- WcfPublicServiceSample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044388"
---
# <a name="wcfpublicservicesample"></a><span data-ttu-id="f96b2-106">WcfPublicServiceSample</span><span class="sxs-lookup"><span data-stu-id="f96b2-106">WcfPublicServiceSample</span></span>

<span data-ttu-id="f96b2-107">Questo esempio mostra il proxy di servizio che comunica con http://131.107.72.15/Example\_HelloWorld\_Service\_Indigo/HelloWorld.svc?wsdl .</span><span class="sxs-lookup"><span data-stu-id="f96b2-107">This examples shows service proxy talking to http://131.107.72.15/Example\_HelloWorld\_Service\_Indigo/HelloWorld.svc?wsdl.</span></span>

-   [<span data-ttu-id="f96b2-108">WcfPublicServiceClient. cpp</span><span class="sxs-lookup"><span data-stu-id="f96b2-108">WcfPublicServiceClient.cpp</span></span>](#wcfpublicserviceclientcpp)
-   [<span data-ttu-id="f96b2-109">schemi. Microsoft. com. 2003.10. Serialization. xsd</span><span class="sxs-lookup"><span data-stu-id="f96b2-109">schemas.microsoft.com.2003.10.Serialization.xsd</span></span>](#schemasmicrosoftcom200310serializationxsd)
-   [<span data-ttu-id="f96b2-110">tempuri. org. xsd</span><span class="sxs-lookup"><span data-stu-id="f96b2-110">tempuri.org.xsd</span></span>](#tempuriorgxsd)
-   [<span data-ttu-id="f96b2-111">tempuri. org. WSDL</span><span class="sxs-lookup"><span data-stu-id="f96b2-111">tempuri.org.wsdl</span></span>](#tempuriorgwsdl)
-   [<span data-ttu-id="f96b2-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="f96b2-112">Makefile</span></span>](#makefile)

## <a name="wcfpublicserviceclientcpp"></a><span data-ttu-id="f96b2-113">WcfPublicServiceClient. cpp</span><span class="sxs-lookup"><span data-stu-id="f96b2-113">WcfPublicServiceClient.cpp</span></span>
...
## <a name="schemasmicrosoftcom200310serializationxsd"></a><span data-ttu-id="f96b2-114">schemi. Microsoft. com. 2003.10. Serialization. xsd</span><span class="sxs-lookup"><span data-stu-id="f96b2-114">schemas.microsoft.com.2003.10.Serialization.xsd</span></span>
...
## <a name="tempuriorgxsd"></a><span data-ttu-id="f96b2-115">tempuri. org. xsd</span><span class="sxs-lookup"><span data-stu-id="f96b2-115">tempuri.org.xsd</span></span>
...
## <a name="tempuriorgwsdl"></a><span data-ttu-id="f96b2-116">tempuri. org. WSDL</span><span class="sxs-lookup"><span data-stu-id="f96b2-116">tempuri.org.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f96b2-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="f96b2-117">Makefile</span></span>
