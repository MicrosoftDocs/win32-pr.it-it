...
description: In questo esempio viene illustrato un client named pipe che invia messaggi unidireli in modo fumante.
...
ms.locfileid: "119545731"
---
# <a name="streamingnamedpipesclientexample"></a>StreamingNamedPipesClientExample

In questo esempio viene illustrato un client named pipe che invia messaggi unidireli in modo fumante.
