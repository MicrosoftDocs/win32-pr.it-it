...
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="d7d04-106">Esempio di RequestReplyTcpServerWithWindowsTransportSecurity</span><span class="sxs-lookup"><span data-stu-id="d7d04-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="d7d04-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con la sicurezza fornita dalla sicurezza del trasporto basata su SSPI di Windows.</span><span class="sxs-lookup"><span data-stu-id="d7d04-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="d7d04-108">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="d7d04-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="d7d04-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d7d04-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d7d04-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d7d04-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="d7d04-111">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="d7d04-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d7d04-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d7d04-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d7d04-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d7d04-113">Makefile</span></span>
