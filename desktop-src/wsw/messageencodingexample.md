...
description: Questo esempio codifica e decodifica un messaggio.
ms.assetid: b1f0a1df-22be-4c86-9a7a-0a4d4f363206
keywords:
- Servizi Web MessageEncodingExample per Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044781"
---
# <a name="messageencodingexample"></a><span data-ttu-id="de44c-106">MessageEncodingExample</span><span class="sxs-lookup"><span data-stu-id="de44c-106">MessageEncodingExample</span></span>

<span data-ttu-id="de44c-107">Questo esempio codifica e decodifica un messaggio.</span><span class="sxs-lookup"><span data-stu-id="de44c-107">This example encodes and decodes a message.</span></span>

-   [<span data-ttu-id="de44c-108">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="de44c-108">MessageEncoding.cpp</span></span>](#messageencodingcpp)
-   [<span data-ttu-id="de44c-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="de44c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="de44c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="de44c-110">Makefile</span></span>](#makefile)

## <a name="messageencodingcpp"></a><span data-ttu-id="de44c-111">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="de44c-111">MessageEncoding.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="de44c-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="de44c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="de44c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="de44c-113">Makefile</span></span>
