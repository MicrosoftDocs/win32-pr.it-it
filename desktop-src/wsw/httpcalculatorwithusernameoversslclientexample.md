...
---
# <a name="httpcalculatorwithusernameoversslclientexample"></a><span data-ttu-id="79618-106">HttpCalculatorWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="79618-106">HttpCalculatorWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="79618-107">Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio di calcolatrice, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="79618-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="79618-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="79618-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="79618-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="79618-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="79618-110">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="79618-110">CalculatorClientUserNameOverSsl.cpp</span></span>](#calculatorclientusernameoversslcpp)
-   [<span data-ttu-id="79618-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="79618-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="79618-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="79618-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientusernameoversslcpp"></a><span data-ttu-id="79618-113">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="79618-113">CalculatorClientUserNameOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="79618-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="79618-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="79618-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="79618-115">Makefile</span></span>
