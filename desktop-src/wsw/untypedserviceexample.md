...
---
# <a name="untypedserviceexample"></a><span data-ttu-id="419fd-107">UnTypedServiceExample</span><span class="sxs-lookup"><span data-stu-id="419fd-107">UnTypedServiceExample</span></span>

<span data-ttu-id="419fd-108">In questo esempio viene illustrato come implementare un servizio non tipizzato con il modello di servizio.</span><span class="sxs-lookup"><span data-stu-id="419fd-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="419fd-109">Il modello di servizio in questo caso fornisce l'infrastruttura della piastra calda.</span><span class="sxs-lookup"><span data-stu-id="419fd-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="419fd-110">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="419fd-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="419fd-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="419fd-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="419fd-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="419fd-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="419fd-113">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="419fd-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="419fd-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="419fd-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="419fd-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="419fd-115">Makefile</span></span>
