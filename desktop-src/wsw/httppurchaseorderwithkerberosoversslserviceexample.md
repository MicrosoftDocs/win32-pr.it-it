...
description: Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP, con Kerberos sulla sicurezza in modalità mista SSL.
ms.assetid: 9fbf5577-6a54-4ce1-ad44-80b9ee91c0d3
keywords:
- HttpPurchaseOrderWithKerberosOverSslServiceExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298487"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="f003b-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="f003b-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="f003b-107">Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP, con Kerberos sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="f003b-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="f003b-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="f003b-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="f003b-109">L'autenticazione client viene fornita da un ticket APREQ Kerberos in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="f003b-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="f003b-110">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="f003b-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="f003b-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f003b-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f003b-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="f003b-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="f003b-113">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="f003b-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f003b-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f003b-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f003b-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="f003b-115">Makefile</span></span>
