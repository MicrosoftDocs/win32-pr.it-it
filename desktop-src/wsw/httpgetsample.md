---
title: HttpGetSample
description: Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP. Il servizio espone i metadati tramite HTTP GET e WS-Metadata Exchange v 1.1. Il servizio Mostra anche come implementare una pagina di copertina per un servizio WWSAPI.
ms.assetid: 5e3a2d24-afd1-451d-94c4-4234c24a4895
keywords:
- HttpGetSample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104398439"
---
# <a name="httpgetsample"></a><span data-ttu-id="f29d3-108">HttpGetSample</span><span class="sxs-lookup"><span data-stu-id="f29d3-108">HttpGetSample</span></span>

<span data-ttu-id="f29d3-109">Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP.</span><span class="sxs-lookup"><span data-stu-id="f29d3-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="f29d3-110">Il servizio espone i metadati tramite HTTP GET e WS-Metadata Exchange v 1.1.</span><span class="sxs-lookup"><span data-stu-id="f29d3-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="f29d3-111">Il servizio Mostra anche come implementare una pagina di copertina per un servizio WWSAPI.</span><span class="sxs-lookup"><span data-stu-id="f29d3-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="f29d3-112">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="f29d3-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="f29d3-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f29d3-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f29d3-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="f29d3-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="f29d3-115">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="f29d3-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f29d3-116">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f29d3-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f29d3-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="f29d3-117">Makefile</span></span>
