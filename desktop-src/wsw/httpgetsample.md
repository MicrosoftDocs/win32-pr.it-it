---
title: HttpGetSample
description: Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio PurchaseOrder su HTTP. Il servizio espone i metadati tramite HTTP GET e WS-Metadata Exchange v1.1. Il servizio illustra anche come implementare una pagina di presentazione per un servizio WWSAPI.
...
ms.locfileid: "118963270"
---
# <a name="httpgetsample"></a>HttpGetSample

Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio PurchaseOrder su HTTP. Il servizio espone i metadati tramite HTTP GET e WS-Metadata Exchange v1.1. Il servizio illustra anche come implementare una pagina di presentazione per un servizio WWSAPI.
