...
Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP. Il servizio espone i metadati tramite HTTP GET e WS-Metadata Exchange v 1.1. Il servizio Mostra anche come implementare una pagina di copertina per un servizio WWSAPI.
