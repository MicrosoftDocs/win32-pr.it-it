...
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="d833f-106">HttpPurchaseOrderWithSslClientExample</span><span class="sxs-lookup"><span data-stu-id="d833f-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="d833f-107">In questo esempio viene illustrato come utilizzare il proxy del servizio per comunicare con un servizio PurchaseOrder, con la sicurezza del trasporto SSL.</span><span class="sxs-lookup"><span data-stu-id="d833f-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="d833f-108">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d833f-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="d833f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d833f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d833f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d833f-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="d833f-111">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d833f-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d833f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d833f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d833f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d833f-113">Makefile</span></span>
