...
---
# <a name="requestreplynamedpipesserverexample"></a><span data-ttu-id="6e51c-103">RequestReplyNamedPipesServerExample</span><span class="sxs-lookup"><span data-stu-id="6e51c-103">RequestReplyNamedPipesServerExample</span></span>

<span data-ttu-id="6e51c-104">Questo esempio mostra un server named pipe che accetta un canale e riceve e risponde ai messaggi.</span><span class="sxs-lookup"><span data-stu-id="6e51c-104">This example shows a named pipes server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="6e51c-105">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="6e51c-105">RequestReplyNamedPipesServer.cpp</span></span>](#requestreplynamedpipesservercpp)
-   [<span data-ttu-id="6e51c-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6e51c-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6e51c-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="6e51c-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesservercpp"></a><span data-ttu-id="6e51c-108">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="6e51c-108">RequestReplyNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6e51c-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6e51c-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6e51c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="6e51c-110">Makefile</span></span>
