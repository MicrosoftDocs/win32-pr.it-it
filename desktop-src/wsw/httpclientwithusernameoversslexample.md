...
description: Questo esempio mostra un client HTTP che invia messaggi request/reply, con nome utente sulla sicurezza in modalità mista SSL.
ms.assetid: aaaad584-d861-4abd-9d76-95aba5090676
keywords:
- HttpClientWithUsernameOverSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044905"
---
# <a name="httpclientwithusernameoversslexample"></a><span data-ttu-id="5afe9-106">HttpClientWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="5afe9-106">HttpClientWithUsernameOverSslExample</span></span>

<span data-ttu-id="5afe9-107">Questo esempio mostra un client HTTP che invia messaggi request/reply, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="5afe9-107">This example shows a HTTP client that sends request-reply messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="5afe9-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="5afe9-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="5afe9-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="5afe9-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="5afe9-110">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="5afe9-110">HttpClientWithUsernameOverSsl.cpp</span></span>](#httpclientwithusernameoversslcpp)
-   [<span data-ttu-id="5afe9-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5afe9-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5afe9-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="5afe9-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a><span data-ttu-id="5afe9-113">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="5afe9-113">HttpClientWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5afe9-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5afe9-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5afe9-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="5afe9-115">Makefile</span></span>
