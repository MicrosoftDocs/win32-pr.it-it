...
description: Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio PurchaseOrder, con Kerberos sulla sicurezza in modalità mista SSL.
ms.assetid: 6756043c-ef4c-4fa6-a27b-7ecb900601f9
keywords:
- HttpPurchaseOrderWithKerberosOverSslClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104396275"
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="23da1-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="23da1-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="23da1-107">Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio PurchaseOrder, con Kerberos sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="23da1-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="23da1-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="23da1-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="23da1-109">L'autenticazione client viene fornita da un ticket APREQ Kerberos in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="23da1-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="23da1-110">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="23da1-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="23da1-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="23da1-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="23da1-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="23da1-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="23da1-113">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="23da1-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="23da1-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="23da1-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="23da1-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="23da1-115">Makefile</span></span>
