...
description: Questo esempio mostra un client TCP che invia messaggi unidirezionali in modalità flusso.
ms.assetid: 29e9e08a-2cff-4467-b889-608a34d4b07e
keywords:
- StreamingTcpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104045312"
---
# <a name="streamingtcpclientexample"></a><span data-ttu-id="9265b-106">StreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="9265b-106">StreamingTcpClientExample</span></span>

<span data-ttu-id="9265b-107">Questo esempio mostra un client TCP che invia messaggi unidirezionali in modalità flusso.</span><span class="sxs-lookup"><span data-stu-id="9265b-107">This example shows a TCP client that sends one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="9265b-108">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9265b-108">StreamingTcpClient.cpp</span></span>](#streamingtcpclientcpp)
-   [<span data-ttu-id="9265b-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9265b-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9265b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9265b-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpclientcpp"></a><span data-ttu-id="9265b-111">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9265b-111">StreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9265b-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9265b-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9265b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9265b-113">Makefile</span></span>
