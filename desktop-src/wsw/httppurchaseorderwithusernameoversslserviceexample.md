...
---
# <a name="httppurchaseorderwithusernameoversslserviceexample"></a><span data-ttu-id="b22f5-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="b22f5-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="b22f5-107">Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="b22f5-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="b22f5-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="b22f5-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="b22f5-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="b22f5-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="b22f5-110">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="b22f5-110">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>](#purchaseorderserviceusernameoversslcpp)
-   [<span data-ttu-id="b22f5-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b22f5-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b22f5-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="b22f5-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderserviceusernameoversslcpp"></a><span data-ttu-id="b22f5-113">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="b22f5-113">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b22f5-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b22f5-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b22f5-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="b22f5-115">Makefile</span></span>
