...
description: Questo esempio mostra il proxy di servizio che comunica con un servizio TerraService ASMX usando la \_ \_ proprietà del \_ \_ canale personalizzato modalità di impostazione proxy WS http \_ .
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- AsmxTerraServiceSampleWithCustomProxy native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104330516"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="60570-106">AsmxTerraServiceSampleWithCustomProxy</span><span class="sxs-lookup"><span data-stu-id="60570-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="60570-107">Questo esempio mostra il proxy di servizio che comunica con un servizio TerraService ASMX usando la proprietà del canale [**\_ \_ \_ \_ \_ personalizzato modalità di impostazione proxy WS http**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .</span><span class="sxs-lookup"><span data-stu-id="60570-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="60570-108">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="60570-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="60570-109">terraserviceusa. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="60570-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="60570-110">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="60570-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="60570-111">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="60570-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="60570-112">terraserviceusa. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="60570-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="60570-113">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="60570-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="60570-114">**\_ \_ \_ \_ modalità \_ personalizzata impostazione proxy WS http**</span><span class="sxs-lookup"><span data-stu-id="60570-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
