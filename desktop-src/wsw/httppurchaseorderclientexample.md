...
description: Questo esempio illustra come usare il proxy del servizio per comunicare con un servizio PurchaseOrder basato su HTTP.
ms.assetid: e577b06c-28b1-4f8f-a6af-025b9672cf27
keywords:
- HttpPurchaseOrderClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044904"
---
# <a name="httppurchaseorderclientexample"></a><span data-ttu-id="2b094-106">HttpPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="2b094-106">HttpPurchaseOrderClientExample</span></span>

<span data-ttu-id="2b094-107">Questo esempio illustra come usare il proxy del servizio per comunicare con un servizio PurchaseOrder basato su HTTP.</span><span class="sxs-lookup"><span data-stu-id="2b094-107">This example show how to use the service proxy to talk to an HTTP based PurchaseOrder service.</span></span>

-   [<span data-ttu-id="2b094-108">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2b094-108">HttpPurchaseOrderClient.cpp</span></span>](#httppurchaseorderclientcpp)
-   [<span data-ttu-id="2b094-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2b094-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2b094-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2b094-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientcpp"></a><span data-ttu-id="2b094-111">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2b094-111">HttpPurchaseOrderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2b094-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2b094-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2b094-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2b094-113">Makefile</span></span>
