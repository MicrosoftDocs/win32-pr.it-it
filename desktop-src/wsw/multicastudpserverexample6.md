...
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="ac25f-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="ac25f-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="ac25f-108">Questo esempio mostra un server UDP che è in ascolto su un indirizzo multicast e risponde alle richieste inviate a tale indirizzo.</span><span class="sxs-lookup"><span data-stu-id="ac25f-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="ac25f-109">In questo esempio viene usato IPv6.</span><span class="sxs-lookup"><span data-stu-id="ac25f-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="ac25f-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="ac25f-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="ac25f-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ac25f-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ac25f-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="ac25f-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="ac25f-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="ac25f-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ac25f-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ac25f-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ac25f-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="ac25f-115">Makefile</span></span>
