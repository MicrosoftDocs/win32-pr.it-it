...
description: Questo esempio mostra un server TCP che accetta un canale e riceve messaggi unidirezionali.
ms.assetid: a43fc6a8-f1ee-4f6b-9737-bfe340bb67f0
keywords:
- OneWayTcpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104222039"
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="49b38-106">OneWayTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="49b38-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="49b38-107">Questo esempio mostra un server TCP che accetta un canale e riceve messaggi unidirezionali.</span><span class="sxs-lookup"><span data-stu-id="49b38-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="49b38-108">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="49b38-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="49b38-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="49b38-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="49b38-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="49b38-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="49b38-111">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="49b38-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="49b38-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="49b38-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="49b38-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="49b38-113">Makefile</span></span>
