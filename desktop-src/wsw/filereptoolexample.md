...
Si tratta dello strumento da riga di comando che guida il [servizio FileRep](filerepserviceexample.md). Una descrizione più dettagliata di questo esempio è disponibile qui.
