...
---
# <a name="filereptoolexample"></a><span data-ttu-id="453f4-106">FileRepToolExample</span><span class="sxs-lookup"><span data-stu-id="453f4-106">FileRepToolExample</span></span>

<span data-ttu-id="453f4-107">Si tratta dello strumento da riga di comando che guida il [servizio FileRep](filerepserviceexample.md).</span><span class="sxs-lookup"><span data-stu-id="453f4-107">This is the command line tool that drives the [FileRep service](filerepserviceexample.md).</span></span> <span data-ttu-id="453f4-108">Una descrizione più dettagliata di questo esempio è disponibile qui.</span><span class="sxs-lookup"><span data-stu-id="453f4-108">A more detailed description of this sample can be found there.</span></span>

<span data-ttu-id="453f4-109">I parametri della riga di comando sono i seguenti:</span><span class="sxs-lookup"><span data-stu-id="453f4-109">The command line parameters are as follows:</span></span>

<span data-ttu-id="453f4-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[ /Encoding: <Binary/text/MTOM>\] \[ /Sync\]</span><span class="sxs-lookup"><span data-stu-id="453f4-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[/encoding:<binary/text/MTOM>\] \[/sync\]</span></span>

<span data-ttu-id="453f4-111">URL servizio client: obbligatorio.</span><span class="sxs-lookup"><span data-stu-id="453f4-111">Client Service Url: Mandatory.</span></span> <span data-ttu-id="453f4-112">URL del servizio client.</span><span class="sxs-lookup"><span data-stu-id="453f4-112">Url of the client service.</span></span>

<span data-ttu-id="453f4-113">URL servizio Server: obbligatorio.</span><span class="sxs-lookup"><span data-stu-id="453f4-113">Server Service Url: Mandatory.</span></span> <span data-ttu-id="453f4-114">URL del servizio Server.</span><span class="sxs-lookup"><span data-stu-id="453f4-114">Url of the server service.</span></span>

<span data-ttu-id="453f4-115">File di origine: obbligatorio.</span><span class="sxs-lookup"><span data-stu-id="453f4-115">Source File: Mandatory.</span></span> <span data-ttu-id="453f4-116">Nome locale completo del file di origine.</span><span class="sxs-lookup"><span data-stu-id="453f4-116">Fully qualified local name of the source file.</span></span> <span data-ttu-id="453f4-117">Il file si trova nel computer in cui viene eseguito il servizio Server.</span><span class="sxs-lookup"><span data-stu-id="453f4-117">The file is located on the machine where the server service runs.</span></span>

<span data-ttu-id="453f4-118">File di destinazione: obbligatorio.</span><span class="sxs-lookup"><span data-stu-id="453f4-118">Destination file: Mandatory.</span></span> <span data-ttu-id="453f4-119">Nome locale completo del file di destinazione.</span><span class="sxs-lookup"><span data-stu-id="453f4-119">Fully qualified local name of the destination file.</span></span> <span data-ttu-id="453f4-120">Il file verrà memorizzato nel computer in cui viene eseguito il servizio client.</span><span class="sxs-lookup"><span data-stu-id="453f4-120">The file will be located on the machine where the client service runs.</span></span>

<span data-ttu-id="453f4-121">Encoding: facoltativo.</span><span class="sxs-lookup"><span data-stu-id="453f4-121">Encoding: Optional.</span></span> <span data-ttu-id="453f4-122">Specifica la codifica dei messaggi inviati tra i servizi client e server.</span><span class="sxs-lookup"><span data-stu-id="453f4-122">Specifies the message encoding for the messages sent between the client and server services.</span></span> <span data-ttu-id="453f4-123">La codifica utilizzata per la comunicazione tra lo strumento da riga di comando e il servizio client non può essere modificata per motivi di semplicità.</span><span class="sxs-lookup"><span data-stu-id="453f4-123">The encoding used for the communication between the command line tool and the client service cannot be changed for simplicity reasons.</span></span> <span data-ttu-id="453f4-124">I parametri validi sono binary, text e MTOM.</span><span class="sxs-lookup"><span data-stu-id="453f4-124">Valid parameters are binary, text and MTOM.</span></span> <span data-ttu-id="453f4-125">Se il parametro non viene specificato, viene utilizzata la codifica predefinita per il trasporto.</span><span class="sxs-lookup"><span data-stu-id="453f4-125">If the parameter is not specified the default encoding for transport is used.</span></span>

<span data-ttu-id="453f4-126">Sync: facoltativo.</span><span class="sxs-lookup"><span data-stu-id="453f4-126">Sync: Optional.</span></span> <span data-ttu-id="453f4-127">Se impostata, la richiesta viene completata in modo sincrono.</span><span class="sxs-lookup"><span data-stu-id="453f4-127">When set, the request completes synchronously.</span></span> <span data-ttu-id="453f4-128">In caso contrario, la richiesta viene completata in modo asincrono.</span><span class="sxs-lookup"><span data-stu-id="453f4-128">Otherwise the request will complete asynchronously.</span></span>

-   [<span data-ttu-id="453f4-129">Strumento. cpp</span><span class="sxs-lookup"><span data-stu-id="453f4-129">Tool.cpp</span></span>](#toolcpp)
-   [<span data-ttu-id="453f4-130">Common. h</span><span class="sxs-lookup"><span data-stu-id="453f4-130">common.h</span></span>](#commonh)
-   [<span data-ttu-id="453f4-131">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="453f4-131">Related topics</span></span>](#related-topics)

## <a name="toolcpp"></a><span data-ttu-id="453f4-132">Strumento. cpp</span><span class="sxs-lookup"><span data-stu-id="453f4-132">Tool.cpp</span></span>
...
## <a name="commonh"></a><span data-ttu-id="453f4-133">common.h</span><span class="sxs-lookup"><span data-stu-id="453f4-133">common.h</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="453f4-134">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="453f4-134">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="453f4-135">FileRepServiceExample</span><span class="sxs-lookup"><span data-stu-id="453f4-135">FileRepServiceExample</span></span>](filerepserviceexample.md)
</dt> </dl>
