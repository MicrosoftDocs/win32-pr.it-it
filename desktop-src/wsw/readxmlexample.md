...
---
# <a name="readxmlexample"></a><span data-ttu-id="720b9-106">ReadXmlExample</span><span class="sxs-lookup"><span data-stu-id="720b9-106">ReadXmlExample</span></span>

<span data-ttu-id="720b9-107">Questo esempio legge il nodo XML in base al nodo.</span><span class="sxs-lookup"><span data-stu-id="720b9-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="720b9-108">ReadXml. cpp</span><span class="sxs-lookup"><span data-stu-id="720b9-108">ReadXml.cpp</span></span>
