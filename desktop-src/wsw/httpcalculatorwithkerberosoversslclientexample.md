...
description: Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio di calcolatrice, con Kerberos sulla sicurezza in modalità mista SSL.
ms.assetid: eb3ae71f-0bbb-42d7-af81-20c5dbb03c3f
keywords:
- HttpCalculatorWithKerberosOverSslClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104332572"
---
# <a name="httpcalculatorwithkerberosoversslclientexample"></a><span data-ttu-id="283d9-106">HttpCalculatorWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="283d9-106">HttpCalculatorWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="283d9-107">Questo esempio mostra un client HTTP che usa il proxy del servizio per comunicare con un servizio di calcolatrice, con Kerberos sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="283d9-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="283d9-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="283d9-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="283d9-109">L'autenticazione client viene fornita da un ticket APREQ Kerberos in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="283d9-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="283d9-110">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="283d9-110">CalculatorClientKerberosOverSsl.cpp</span></span>](#calculatorclientkerberosoversslcpp)
-   [<span data-ttu-id="283d9-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="283d9-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="283d9-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="283d9-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientkerberosoversslcpp"></a><span data-ttu-id="283d9-113">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="283d9-113">CalculatorClientKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="283d9-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="283d9-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="283d9-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="283d9-115">Makefile</span></span>
