...
description: In questo esempio viene illustrato l'utilizzo delle API del buffer XML.
ms.assetid: cf4530c7-48f4-4a76-bd3d-1f21b5469902
keywords:
- XmlBufferExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044779"
---
# <a name="xmlbufferexample"></a><span data-ttu-id="aa72a-106">XmlBufferExample</span><span class="sxs-lookup"><span data-stu-id="aa72a-106">XmlBufferExample</span></span>

<span data-ttu-id="aa72a-107">In questo esempio viene illustrato l'utilizzo delle API del buffer XML.</span><span class="sxs-lookup"><span data-stu-id="aa72a-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="aa72a-108">XmlBuffer. cpp</span><span class="sxs-lookup"><span data-stu-id="aa72a-108">XmlBuffer.cpp</span></span>
