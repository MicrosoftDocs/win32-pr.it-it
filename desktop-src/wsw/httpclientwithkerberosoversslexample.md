...
description: Questo esempio mostra un client HTTP che invia messaggi request/reply, con Kerberos sulla sicurezza in modalità mista SSL.
ms.assetid: 48b20c9b-38e7-472c-9606-b454850e14c1
keywords:
- HttpClientWithKerberosOverSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104045378"
---
# <a name="httpclientwithkerberosoversslexample"></a><span data-ttu-id="6073d-106">HttpClientWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="6073d-106">HttpClientWithKerberosOverSslExample</span></span>

<span data-ttu-id="6073d-107">Questo esempio mostra un client HTTP che invia messaggi request/reply, con Kerberos sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="6073d-107">This example shows a HTTP client that sends request-reply messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="6073d-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="6073d-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="6073d-109">L'autenticazione client viene fornita da un ticket APREQ Kerberos in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="6073d-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="6073d-110">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="6073d-110">HttpClientWithKerberosOverSsl.cpp</span></span>](#httpclientwithkerberosoversslcpp)
-   [<span data-ttu-id="6073d-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6073d-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6073d-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="6073d-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithkerberosoversslcpp"></a><span data-ttu-id="6073d-113">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="6073d-113">HttpClientWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6073d-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6073d-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6073d-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="6073d-115">Makefile</span></span>
