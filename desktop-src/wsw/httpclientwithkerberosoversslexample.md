...
description: In questo esempio viene illustrato un client HTTP che invia messaggi request/reply, con kerberos sulla sicurezza in modalità mista SSL.
