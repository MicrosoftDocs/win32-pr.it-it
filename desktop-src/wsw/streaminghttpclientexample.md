...
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="71103-106">StreamingHttpClientExample</span><span class="sxs-lookup"><span data-stu-id="71103-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="71103-107">Questo esempio mostra un client HTTP che esegue Request/Reply usando le API di streaming.</span><span class="sxs-lookup"><span data-stu-id="71103-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="71103-108">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="71103-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="71103-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="71103-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="71103-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="71103-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="71103-111">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="71103-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="71103-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="71103-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="71103-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="71103-113">Makefile</span></span>
