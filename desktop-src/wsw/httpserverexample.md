...
keywords:
- HttpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298904"
---
# <a name="httpserverexample"></a><span data-ttu-id="46c10-106">HttpServerExample</span><span class="sxs-lookup"><span data-stu-id="46c10-106">HttpServerExample</span></span>

<span data-ttu-id="46c10-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi.</span><span class="sxs-lookup"><span data-stu-id="46c10-107">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="46c10-108">HttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="46c10-108">HttpServer.cpp</span></span>](#httpservercpp)
-   [<span data-ttu-id="46c10-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="46c10-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="46c10-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="46c10-110">Makefile</span></span>](#makefile)

## <a name="httpservercpp"></a><span data-ttu-id="46c10-111">HttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="46c10-111">HttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="46c10-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="46c10-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="46c10-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="46c10-113">Makefile</span></span>
