...
description: Vedere un esempio di server HTTP che usa l Windows aPI dei servizi Web. In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi.
...
ms.locfileid: "119344911"
---
# <a name="httpserverexample"></a>HttpServerExample

In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi.
