...
description: Vedere un esempio di server HTTP che usa l'API dei servizi Web Windows. In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi.
...
ms.locfileid: "112409754"
---
# <a name="httpserverexample"></a><span data-ttu-id="70730-107">HttpServerExample</span><span class="sxs-lookup"><span data-stu-id="70730-107">HttpServerExample</span></span>

<span data-ttu-id="70730-108">In questo esempio viene illustrato un server TCP che accetta un canale e riceve e risponde ai messaggi.</span><span class="sxs-lookup"><span data-stu-id="70730-108">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="70730-109">HttpServer.cpp</span><span class="sxs-lookup"><span data-stu-id="70730-109">HttpServer.cpp</span></span>](#httpservercpp)
-   [<span data-ttu-id="70730-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="70730-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="70730-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="70730-111">Makefile</span></span>](#makefile)

## <a name="httpservercpp"></a><span data-ttu-id="70730-112">HttpServer.cpp</span><span class="sxs-lookup"><span data-stu-id="70730-112">HttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="70730-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="70730-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="70730-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="70730-114">Makefile</span></span>
