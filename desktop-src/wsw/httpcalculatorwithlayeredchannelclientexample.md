...
description: In questo esempio viene illustrato come utilizzare il proxy del servizio per comunicare con un servizio di calcolatrice basato su HTTP utilizzando un canale personalizzato. Il canale personalizzato è un canale su più livelli che delega semplicemente tutte le funzionalità al canale HTTP esistente.
ms.assetid: 897673df-f3a3-4b38-8b79-c9f1119be6d5
keywords:
- HttpCalculatorWithLayeredChannelClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298443"
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="6947a-107">HttpCalculatorWithLayeredChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="6947a-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="6947a-108">In questo esempio viene illustrato come utilizzare il proxy del servizio per comunicare con un servizio di calcolatrice basato su HTTP utilizzando un canale personalizzato.</span><span class="sxs-lookup"><span data-stu-id="6947a-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="6947a-109">Il canale personalizzato è un canale su più livelli che delega semplicemente tutte le funzionalità al canale HTTP esistente.</span><span class="sxs-lookup"><span data-stu-id="6947a-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="6947a-110">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="6947a-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="6947a-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="6947a-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="6947a-112">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="6947a-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="6947a-113">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="6947a-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="6947a-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="6947a-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="6947a-115">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="6947a-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="6947a-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="6947a-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="6947a-117">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="6947a-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="6947a-118">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="6947a-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6947a-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="6947a-119">Makefile</span></span>
