...
description: Questo esempio mostra un client TCP che invia messaggi unidirezionali.
ms.assetid: c5e930b5-da13-459c-8a83-eeeb120a79ed
keywords:
- OneWayTcpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298789"
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="bcd0e-106">OneWayTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="bcd0e-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="bcd0e-107">Questo esempio mostra un client TCP che invia messaggi unidirezionali.</span><span class="sxs-lookup"><span data-stu-id="bcd0e-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="bcd0e-108">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="bcd0e-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="bcd0e-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="bcd0e-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="bcd0e-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="bcd0e-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="bcd0e-111">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="bcd0e-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="bcd0e-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="bcd0e-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="bcd0e-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="bcd0e-113">Makefile</span></span>
