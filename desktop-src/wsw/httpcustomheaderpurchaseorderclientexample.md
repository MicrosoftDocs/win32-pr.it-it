...
description: Questo esempio illustra come usare intestazioni personalizzate con il proxy di servizio.
ms.assetid: d56e68cd-c910-4f41-a672-c894ba134e3b
keywords:
- HttpCustomHeaderPurchaseOrderClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104396278"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="6de7b-106">HttpCustomHeaderPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="6de7b-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="6de7b-107">Questo esempio illustra come usare intestazioni personalizzate con il proxy di servizio.</span><span class="sxs-lookup"><span data-stu-id="6de7b-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="6de7b-108">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="6de7b-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="6de7b-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6de7b-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6de7b-110">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="6de7b-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="6de7b-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="6de7b-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="6de7b-112">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="6de7b-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6de7b-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6de7b-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="6de7b-114">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="6de7b-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6de7b-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="6de7b-115">Makefile</span></span>
