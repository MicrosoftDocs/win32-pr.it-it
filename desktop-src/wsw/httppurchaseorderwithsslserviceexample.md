...
description: Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP, con la sicurezza del trasporto SSL.
ms.assetid: 814660d7-98d7-4038-8243-d2f37929d516
keywords:
- HttpPurchaseOrderWithSslServiceExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103856458"
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="3335d-106">HttpPurchaseOrderWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="3335d-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="3335d-107">Questo esempio illustra come usare l'host del servizio per ospitare un servizio PurchaseOrder su HTTP, con la sicurezza del trasporto SSL.</span><span class="sxs-lookup"><span data-stu-id="3335d-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="3335d-108">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="3335d-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="3335d-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3335d-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3335d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3335d-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="3335d-111">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="3335d-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3335d-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3335d-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3335d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="3335d-113">Makefile</span></span>
