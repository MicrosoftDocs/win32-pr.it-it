...
description: In questo esempio viene illustrato come utilizzare il proxy del servizio per comunicare con un servizio di calcolatrice basato su HTTP utilizzando un canale personalizzato. Il canale usa un codificatore personalizzato.
ms.assetid: cef3db1d-6362-4599-a4bf-f43079848691
keywords:
- HttpCalculatorWithEncodedChannelClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103955835"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a><span data-ttu-id="14ee9-107">HttpCalculatorWithEncodedChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="14ee9-107">HttpCalculatorWithEncodedChannelClientExample</span></span>

<span data-ttu-id="14ee9-108">In questo esempio viene illustrato come utilizzare il proxy del servizio per comunicare con un servizio di calcolatrice basato su HTTP utilizzando un canale personalizzato.</span><span class="sxs-lookup"><span data-stu-id="14ee9-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="14ee9-109">Il canale usa un codificatore personalizzato.</span><span class="sxs-lookup"><span data-stu-id="14ee9-109">The channel is uses a custom encoder.</span></span>

-   [<span data-ttu-id="14ee9-110">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="14ee9-110">HttpCalculatorWithEncodedChannelClient.cpp</span></span>](#httpcalculatorwithencodedchannelclientcpp)
-   [<span data-ttu-id="14ee9-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="14ee9-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="14ee9-112">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="14ee9-112">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="14ee9-113">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="14ee9-113">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="14ee9-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="14ee9-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a><span data-ttu-id="14ee9-115">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="14ee9-115">HttpCalculatorWithEncodedChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="14ee9-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="14ee9-116">CalculatorService.wsdl</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="14ee9-117">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="14ee9-117">EncodedChannel.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="14ee9-118">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="14ee9-118">EncodedChannel.h</span></span>
...
## <a name="makefile"></a><span data-ttu-id="14ee9-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="14ee9-119">Makefile</span></span>
