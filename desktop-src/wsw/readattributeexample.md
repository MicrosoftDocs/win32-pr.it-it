...
description: In questo esempio viene letto un attributo.
ms.assetid: e37946f0-66e0-4fb1-aeee-db4447ed4030
keywords:
- Servizi Web ReadAttributeExample per Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044030"
---
# <a name="readattributeexample"></a><span data-ttu-id="cf406-106">ReadAttributeExample</span><span class="sxs-lookup"><span data-stu-id="cf406-106">ReadAttributeExample</span></span>

<span data-ttu-id="cf406-107">In questo esempio viene letto un attributo.</span><span class="sxs-lookup"><span data-stu-id="cf406-107">This example reads an attribute.</span></span>

## <a name="readattributecpp"></a><span data-ttu-id="cf406-108">ReadAttribute. cpp</span><span class="sxs-lookup"><span data-stu-id="cf406-108">ReadAttribute.cpp</span></span>
