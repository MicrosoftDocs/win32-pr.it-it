...
description: Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio di calcolo tramite HTTP.
ms.assetid: 898bc206-ad64-461c-a734-c8791b6b106d
keywords:
- HttpCalculatorServiceExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104045379"
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="ee774-106">HttpCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="ee774-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="ee774-107">Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio di calcolo tramite HTTP.</span><span class="sxs-lookup"><span data-stu-id="ee774-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="ee774-108">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="ee774-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="ee774-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="ee774-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="ee774-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="ee774-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="ee774-111">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="ee774-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="ee774-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="ee774-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ee774-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="ee774-113">Makefile</span></span>
