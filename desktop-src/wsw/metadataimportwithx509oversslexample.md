...
description: In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta l'utilizzo di un token X509 utilizzando l' \_ \_ \_ associazione di sicurezza del messaggio del token XML \_ \_ con WS \_ SSL \_ \_ \_ .
ms.assetid: 9dbeea65-1752-4fe1-b425-f622e24acef0
keywords:
- MetadataImportWithX509OverSslExample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103708944"
---
# <a name="metadataimportwithx509oversslexample"></a><span data-ttu-id="7b64b-106">MetadataImportWithX509OverSslExample</span><span class="sxs-lookup"><span data-stu-id="7b64b-106">MetadataImportWithX509OverSslExample</span></span>

<span data-ttu-id="7b64b-107">In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta l'utilizzo di un token X509 utilizzando l' [**associazione di sicurezza del \_ \_ messaggio del token \_ \_ \_ XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) con [**WS \_ SSL \_ \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="7b64b-107">This example illustrates importing metadata from an endpoint that supports using a X509 token using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithx509oversslexamplecpp"></a><span data-ttu-id="7b64b-108">MetadataImportWithX509OverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="7b64b-108">MetadataImportWithX509OverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7b64b-109">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="7b64b-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="7b64b-110">**\_associazione di \_ sicurezza del messaggio del token WS XML \_ \_ \_**</span><span class="sxs-lookup"><span data-stu-id="7b64b-110">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="7b64b-111">**\_binding di \_ sicurezza del trasporto \_ \_ di WS SSL**</span><span class="sxs-lookup"><span data-stu-id="7b64b-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
