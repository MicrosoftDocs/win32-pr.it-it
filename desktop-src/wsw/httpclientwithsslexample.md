...
description: Questo esempio mostra un client HTTP che invia messaggi di richiesta-risposta con sicurezza del trasporto SSL.
ms.assetid: 0e73baee-a56d-446e-ae2e-a3aae31d8508
keywords:
- HttpClientWithSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103707090"
---
# <a name="httpclientwithsslexample"></a><span data-ttu-id="365c6-106">HttpClientWithSslExample</span><span class="sxs-lookup"><span data-stu-id="365c6-106">HttpClientWithSslExample</span></span>

<span data-ttu-id="365c6-107">Questo esempio mostra un client HTTP che invia messaggi di richiesta-risposta con sicurezza del trasporto SSL.</span><span class="sxs-lookup"><span data-stu-id="365c6-107">This example shows a HTTP client that sends request-reply messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="365c6-108">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="365c6-108">HttpClientWithSsl.cpp</span></span>](#httpclientwithsslcpp)
-   [<span data-ttu-id="365c6-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="365c6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="365c6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="365c6-110">Makefile</span></span>](#makefile)

## <a name="httpclientwithsslcpp"></a><span data-ttu-id="365c6-111">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="365c6-111">HttpClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="365c6-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="365c6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="365c6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="365c6-113">Makefile</span></span>
