...
description: In questo esempio viene illustrato un client HTTP che invia messaggi request/reply con sicurezza del trasporto SSL.
...
ms.locfileid: "118963340"
---
# <a name="httpclientwithsslexample"></a>HttpClientWithSslExample

In questo esempio viene illustrato un client HTTP che invia messaggi request/reply con sicurezza del trasporto SSL.
