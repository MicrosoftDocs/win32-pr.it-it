...
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a><span data-ttu-id="d2ec5-106">HttpCalculatorWithBasicOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="d2ec5-106">HttpCalculatorWithBasicOverSslClientExample</span></span>

<span data-ttu-id="d2ec5-107">Questo esempio illustra come usare il proxy del servizio per comunicare con un servizio di calcolatrice, con la sicurezza del trasporto SSL e l'autenticazione di base dell'intestazione HTTP.</span><span class="sxs-lookup"><span data-stu-id="d2ec5-107">This example shows how to use the service proxy to talk to a calculator service, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="d2ec5-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="d2ec5-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="d2ec5-109">L'autenticazione client viene fornita da una coppia nome utente/password fornita nelle intestazioni HTTP usando lo schema di base.</span><span class="sxs-lookup"><span data-stu-id="d2ec5-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="d2ec5-110">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="d2ec5-110">HttpCalculatorWithBasicOverSslClient.cpp</span></span>](#httpcalculatorwithbasicoversslclientcpp)
-   [<span data-ttu-id="d2ec5-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="d2ec5-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="d2ec5-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="d2ec5-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithbasicoversslclientcpp"></a><span data-ttu-id="d2ec5-113">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="d2ec5-113">HttpCalculatorWithBasicOverSslClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="d2ec5-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="d2ec5-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d2ec5-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="d2ec5-115">Makefile</span></span>
