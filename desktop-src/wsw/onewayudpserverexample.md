...
---
# <a name="onewayudpserverexample"></a><span data-ttu-id="6d51f-106">OneWayUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="6d51f-106">OneWayUdpServerExample</span></span>

<span data-ttu-id="6d51f-107">Questo esempio mostra un server UDP che accetta un canale e riceve messaggi unidirezionali.</span><span class="sxs-lookup"><span data-stu-id="6d51f-107">This example shows a UDP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="6d51f-108">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="6d51f-108">OneWayUdpServer.cpp</span></span>](#onewayudpservercpp)
-   [<span data-ttu-id="6d51f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6d51f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6d51f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="6d51f-110">Makefile</span></span>](#makefile)

## <a name="onewayudpservercpp"></a><span data-ttu-id="6d51f-111">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="6d51f-111">OneWayUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6d51f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6d51f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6d51f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="6d51f-113">Makefile</span></span>
