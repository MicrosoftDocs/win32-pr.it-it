...
description: Questo esempio mostra un client TCP che invia messaggi unidirezionali in modalità di flusso asincrono.
ms.assetid: b0040b3d-d830-421a-bbf1-afb0cac47599
keywords:
- AsyncStreamingTcpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104330500"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="379c3-106">AsyncStreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="379c3-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="379c3-107">Questo esempio mostra un client TCP che invia messaggi unidirezionali in modalità di flusso asincrono.</span><span class="sxs-lookup"><span data-stu-id="379c3-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="379c3-108">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="379c3-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="379c3-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="379c3-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="379c3-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="379c3-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="379c3-111">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="379c3-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="379c3-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="379c3-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="379c3-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="379c3-113">Makefile</span></span>
