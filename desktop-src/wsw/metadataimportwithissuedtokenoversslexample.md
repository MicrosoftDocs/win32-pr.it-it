...
description: In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta l'utilizzo di un token emesso ottenuto dal servizio token di sicurezza (STS) emesso utilizzando WsRequestSecurityToken e presentato al servizio utilizzando l' \_ associazione di sicurezza del messaggio del \_ token XML \_ \_ \_ con WS \_ SSL binding di sicurezza del \_ trasporto \_ \_ . Per ulteriori informazioni, vedere Federazione.
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- MetadataImportWithIssuedTokenOverSslExample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104395483"
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="166bb-107">MetadataImportWithIssuedTokenOverSslExample</span><span class="sxs-lookup"><span data-stu-id="166bb-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="166bb-108">In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta l'utilizzo di un token emesso ottenuto dal servizio token di sicurezza (STS) emesso utilizzando [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) e presentato al servizio utilizzando l' [**associazione di \_ sicurezza del \_ messaggio del token \_ \_ \_ XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) con [**WS \_ SSL \_ binding di \_ sicurezza \_ del trasporto**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="166bb-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="166bb-109">Per ulteriori informazioni, vedere [Federazione](federation.md) .</span><span class="sxs-lookup"><span data-stu-id="166bb-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="166bb-110">MetadataImportWithIssuedTokenOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="166bb-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="166bb-111">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="166bb-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="166bb-112">**WsRequestSecurityToken**</span><span class="sxs-lookup"><span data-stu-id="166bb-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="166bb-113">**\_associazione di \_ sicurezza del messaggio del token WS XML \_ \_ \_**</span><span class="sxs-lookup"><span data-stu-id="166bb-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="166bb-114">**\_binding di \_ sicurezza del trasporto \_ \_ di WS SSL**</span><span class="sxs-lookup"><span data-stu-id="166bb-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="166bb-115">Federazione</span><span class="sxs-lookup"><span data-stu-id="166bb-115">Federation</span></span>](federation.md)
</dt> </dl>
