...
---
# <a name="calculatorwsdl"></a><span data-ttu-id="c3b3f-106">CalculatorWsdl</span><span class="sxs-lookup"><span data-stu-id="c3b3f-106">CalculatorWsdl</span></span>

<span data-ttu-id="c3b3f-107">Questo è un esempio di WSDL/schema per gli esempi del servizio di calcolatrice.</span><span class="sxs-lookup"><span data-stu-id="c3b3f-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="c3b3f-108">Calculator. WSDL</span><span class="sxs-lookup"><span data-stu-id="c3b3f-108">Calculator.wsdl</span></span>
