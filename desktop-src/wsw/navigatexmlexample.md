...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="7768c-107">NavigateXmlExample</span><span class="sxs-lookup"><span data-stu-id="7768c-107">NavigateXmlExample</span></span>

<span data-ttu-id="7768c-108">Questo esempio scrive codice XML in un buffer XML e quindi lo legge nuovamente.</span><span class="sxs-lookup"><span data-stu-id="7768c-108">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="7768c-109">NavigateXml.cpp</span><span class="sxs-lookup"><span data-stu-id="7768c-109">NavigateXml.cpp</span></span>
