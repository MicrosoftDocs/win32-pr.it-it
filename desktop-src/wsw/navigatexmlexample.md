...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="a83a9-106">NavigateXmlExample</span><span class="sxs-lookup"><span data-stu-id="a83a9-106">NavigateXmlExample</span></span>

<span data-ttu-id="a83a9-107">Questo esempio scrive il codice XML in un buffer XML e quindi lo legge.</span><span class="sxs-lookup"><span data-stu-id="a83a9-107">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="a83a9-108">NavigateXml. cpp</span><span class="sxs-lookup"><span data-stu-id="a83a9-108">NavigateXml.cpp</span></span>
