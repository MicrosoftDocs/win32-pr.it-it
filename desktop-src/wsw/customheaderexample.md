...
description: Questo esempio illustra come aggiungere e recuperare un'intestazione personalizzata.
ms.assetid: 9c0cabee-4645-4b2d-a132-4494911f05b3
keywords:
- Servizi Web CustomHeaderExample per Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298899"
---
# <a name="customheaderexample"></a><span data-ttu-id="5f43a-106">CustomHeaderExample</span><span class="sxs-lookup"><span data-stu-id="5f43a-106">CustomHeaderExample</span></span>

<span data-ttu-id="5f43a-107">Questo esempio illustra come aggiungere e recuperare un'intestazione personalizzata.</span><span class="sxs-lookup"><span data-stu-id="5f43a-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="5f43a-108">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="5f43a-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="5f43a-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5f43a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5f43a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="5f43a-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="5f43a-111">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="5f43a-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5f43a-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5f43a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5f43a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="5f43a-113">Makefile</span></span>
