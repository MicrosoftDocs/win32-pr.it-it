...
description: In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta il \_ binding di sicurezza del messaggio WS nomeutente \_ \_ \_ con binding di sicurezza del trasporto di WS \_ SSL \_ \_ \_ .
ms.assetid: 1bce97e2-a841-4c4b-af5e-f747c3fb6e8d
keywords:
- MetadataImportWithUsernameOverSslExample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106297863"
---
# <a name="metadataimportwithusernameoversslexample"></a><span data-ttu-id="82f1b-106">MetadataImportWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="82f1b-106">MetadataImportWithUsernameOverSslExample</span></span>

<span data-ttu-id="82f1b-107">In questo esempio viene illustrata l'importazione di metadati da un endpoint che supporta il [**\_ binding di sicurezza del \_ messaggio \_ \_ WS nomeutente**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) con binding di sicurezza del [**trasporto di WS \_ SSL \_ \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="82f1b-107">This example illustrates importing metadata from an endpoint that supports [**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithusernameoversslexamplecpp"></a><span data-ttu-id="82f1b-108">MetadataImportWithUsernameOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="82f1b-108">MetadataImportWithUsernameOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="82f1b-109">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="82f1b-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="82f1b-110">**\_binding di \_ \_ sicurezza messaggio WS nomeutente \_**</span><span class="sxs-lookup"><span data-stu-id="82f1b-110">**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding)
</dt> <dt>

[<span data-ttu-id="82f1b-111">**\_binding di \_ sicurezza del trasporto \_ \_ di WS SSL**</span><span class="sxs-lookup"><span data-stu-id="82f1b-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
