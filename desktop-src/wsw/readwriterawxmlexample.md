...
description: Questo esempio illustra la lettura e la scrittura di xml usando la codifica non elaborata.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- ReadWriteRawXmlExample Windows API dei servizi Web
- WWSAPI
- Wws
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118963000"
---
# <a name="readwriterawxmlexample"></a>ReadWriteRawXmlExample

Questo esempio illustra la lettura e la scrittura di xml usando la codifica non elaborata.
