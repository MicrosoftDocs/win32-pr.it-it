...
description: In questo esempio viene illustrata la lettura e la scrittura di XML utilizzando la codifica non elaborata.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- ReadWriteRawXmlExample API per servizi Web Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104044029"
---
# <a name="readwriterawxmlexample"></a><span data-ttu-id="7f7c0-106">ReadWriteRawXmlExample</span><span class="sxs-lookup"><span data-stu-id="7f7c0-106">ReadWriteRawXmlExample</span></span>

<span data-ttu-id="7f7c0-107">In questo esempio viene illustrata la lettura e la scrittura di XML utilizzando la codifica non elaborata.</span><span class="sxs-lookup"><span data-stu-id="7f7c0-107">This example shows reading and writing of xml using the raw encoding.</span></span>

## <a name="readwriterawxmlcpp"></a><span data-ttu-id="7f7c0-108">ReadWriteRawXml. cpp</span><span class="sxs-lookup"><span data-stu-id="7f7c0-108">ReadWriteRawXml.cpp</span></span>
