...
description: Questo esempio mostra un client named pipe che invia messaggi request/reply.
...
ms.locfileid: "104220888"
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="9a363-103">RequestReplyNamedPipesClientExample</span><span class="sxs-lookup"><span data-stu-id="9a363-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="9a363-104">Questo esempio mostra un client named pipe che invia messaggi request/reply.</span><span class="sxs-lookup"><span data-stu-id="9a363-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="9a363-105">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9a363-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="9a363-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9a363-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9a363-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="9a363-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="9a363-108">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9a363-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9a363-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9a363-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9a363-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9a363-110">Makefile</span></span>
