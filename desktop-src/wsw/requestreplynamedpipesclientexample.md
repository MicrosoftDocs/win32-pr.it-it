...
description: In questo esempio viene illustrato named pipe client che invia messaggi request-reply.
...
ms.locfileid: "118192867"
---
# <a name="requestreplynamedpipesclientexample"></a>RequestReplyNamedPipesClientExample

In questo esempio viene illustrato named pipe client che invia messaggi request-reply.
