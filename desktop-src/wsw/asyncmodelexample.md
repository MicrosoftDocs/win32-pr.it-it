...
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="261e5-106">Esempio di funzione asincrona</span><span class="sxs-lookup"><span data-stu-id="261e5-106">Asynchronous Function Example</span></span>

<span data-ttu-id="261e5-107">In questo esempio viene illustrata l'implementazione e la chiamata di funzioni asincrone.</span><span class="sxs-lookup"><span data-stu-id="261e5-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="261e5-108">L'esempio è costituito dalle parti seguenti:</span><span class="sxs-lookup"><span data-stu-id="261e5-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="261e5-109">Funzione Add che consente di aggiungere due numeri in modo sincrono o asincrono.</span><span class="sxs-lookup"><span data-stu-id="261e5-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="261e5-110">Viene creato un thread come dettaglio di implementazione per il case asincrono.</span><span class="sxs-lookup"><span data-stu-id="261e5-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="261e5-111">La funzione CallAddSync richiama in modo sincrono le funzioni Add.</span><span class="sxs-lookup"><span data-stu-id="261e5-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="261e5-112">La funzione CallAddAsync richiama le funzioni Add in modo asincrono.</span><span class="sxs-lookup"><span data-stu-id="261e5-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="261e5-113">AsyncModel. cpp</span><span class="sxs-lookup"><span data-stu-id="261e5-113">AsyncModel.cpp</span></span>
