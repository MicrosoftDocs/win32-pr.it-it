...
description: Questo esempio mostra un client UDP che esegue il multicast di una richiesta e quindi attende i messaggi di risposta dai server, usando IPv6.
ms.assetid: bd19bd5f-0617-4524-aa48-3d0c28c97747
keywords:
- MulticastUdpClientExample6 native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104328839"
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="9ed1d-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="9ed1d-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="9ed1d-107">Questo esempio mostra un client UDP che esegue il multicast di una richiesta e quindi attende i messaggi di risposta dai server, usando IPv6.</span><span class="sxs-lookup"><span data-stu-id="9ed1d-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="9ed1d-108">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="9ed1d-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="9ed1d-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9ed1d-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9ed1d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9ed1d-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="9ed1d-111">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="9ed1d-111">MulticastUdpClient6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9ed1d-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9ed1d-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9ed1d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9ed1d-113">Makefile</span></span>
