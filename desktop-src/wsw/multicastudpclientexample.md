...
description: Questo esempio mostra un client UDP che esegue il multicast di una richiesta e quindi attende i messaggi di risposta dai server.
ms.assetid: 61ca7e05-1a60-43b2-9ff7-cb355fae2f77
keywords:
- MulticastUdpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104221107"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="1b42b-106">MulticastUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="1b42b-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="1b42b-107">Questo esempio mostra un client UDP che esegue il multicast di una richiesta e quindi attende i messaggi di risposta dai server.</span><span class="sxs-lookup"><span data-stu-id="1b42b-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="1b42b-108">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="1b42b-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="1b42b-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1b42b-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="1b42b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b42b-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="1b42b-111">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="1b42b-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="1b42b-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1b42b-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="1b42b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b42b-113">Makefile</span></span>
