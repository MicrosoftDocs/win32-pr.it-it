...
description: In questo esempio viene illustrato un client UDP che multicast di una richiesta e quindi attende i messaggi di risposta dai server.
...
ms.locfileid: "119545891"
---
# <a name="multicastudpclientexample"></a>MulticastUdpClientExample

In questo esempio viene illustrato un client UDP che multicast di una richiesta e quindi attende i messaggi di risposta dai server.
