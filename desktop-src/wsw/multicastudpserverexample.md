...
description: Questo esempio mostra un server UDP che è in ascolto su un indirizzo multicast e risponde alle richieste inviate a tale indirizzo.
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- MulticastUdpServerExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106297862"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="15d86-106">MulticastUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="15d86-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="15d86-107">Questo esempio mostra un server UDP che è in ascolto su un indirizzo multicast e risponde alle richieste inviate a tale indirizzo.</span><span class="sxs-lookup"><span data-stu-id="15d86-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="15d86-108">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="15d86-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="15d86-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="15d86-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="15d86-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="15d86-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="15d86-111">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="15d86-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="15d86-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="15d86-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="15d86-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="15d86-113">Makefile</span></span>
