...
description: Esaminare un esempio C++ di API dei servizi Web Windows (WWSAPI) di una calcolatrice HTTP con servizio canale a più livelli.
...
ms.locfileid: "112404144"
---
# <a name="httpcalculatorwithlayeredchannelserviceexample"></a><span data-ttu-id="38cf1-106">HttpCalculatorWithLayeredChannelServiceExample</span><span class="sxs-lookup"><span data-stu-id="38cf1-106">HttpCalculatorWithLayeredChannelServiceExample</span></span>

<span data-ttu-id="38cf1-107">Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio calcolatrice con un canale personalizzato e un'implementazione del listener su tale livello su HTTP.</span><span class="sxs-lookup"><span data-stu-id="38cf1-107">This example shows how to use service host for hosting a calculator service with a custom channel and listener implementation that layer on top of HTTP.</span></span>

-   [<span data-ttu-id="38cf1-108">HttpCalculatorWithLayeredChannelService.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-108">HttpCalculatorWithLayeredChannelService.cpp</span></span>](#httpcalculatorwithlayeredchannelservicecpp)
-   [<span data-ttu-id="38cf1-109">LayeredChannel.h</span><span class="sxs-lookup"><span data-stu-id="38cf1-109">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="38cf1-110">LayeredChannel.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-110">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="38cf1-111">LayeredListener.h</span><span class="sxs-lookup"><span data-stu-id="38cf1-111">LayeredListener.h</span></span>](#layeredlistenerh)
-   [<span data-ttu-id="38cf1-112">LayeredListener.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-112">LayeredListener.cpp</span></span>](#layeredlistenercpp)
-   [<span data-ttu-id="38cf1-113">CalculatorService.wsdl</span><span class="sxs-lookup"><span data-stu-id="38cf1-113">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="38cf1-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="38cf1-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelservicecpp"></a><span data-ttu-id="38cf1-115">HttpCalculatorWithLayeredChannelService.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-115">HttpCalculatorWithLayeredChannelService.cpp</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="38cf1-116">LayeredChannel.h</span><span class="sxs-lookup"><span data-stu-id="38cf1-116">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="38cf1-117">LayeredChannel.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-117">LayeredChannel.cpp</span></span>
...
## <a name="layeredlistenerh"></a><span data-ttu-id="38cf1-118">LayeredListener.h</span><span class="sxs-lookup"><span data-stu-id="38cf1-118">LayeredListener.h</span></span>
...
## <a name="layeredlistenercpp"></a><span data-ttu-id="38cf1-119">LayeredListener.cpp</span><span class="sxs-lookup"><span data-stu-id="38cf1-119">LayeredListener.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="38cf1-120">CalculatorService.wsdl</span><span class="sxs-lookup"><span data-stu-id="38cf1-120">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="38cf1-121">Makefile</span><span class="sxs-lookup"><span data-stu-id="38cf1-121">Makefile</span></span>
