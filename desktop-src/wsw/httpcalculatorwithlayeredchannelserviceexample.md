...
Questo esempio illustra come usare l'host del servizio per l'hosting di un servizio calcolatrice con un canale personalizzato e un'implementazione del listener su tale livello su HTTP.
