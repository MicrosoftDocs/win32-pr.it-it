...
Questo esempio illustra come usare l'host del servizio per ospitare un servizio di calcolatrice con un'implementazione del canale e del listener personalizzata che si trova su HTTP.
