...
---
# <a name="httpcalculatorwithusernameoversslserviceexample"></a><span data-ttu-id="44c51-106">HttpCalculatorWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="44c51-106">HttpCalculatorWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="44c51-107">Questo esempio illustra come usare l'host del servizio per ospitare un servizio di calcolatrice su HTTP, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="44c51-107">This example shows how to use service host for hosting a calculator service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="44c51-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="44c51-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="44c51-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="44c51-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="44c51-110">CalculatorServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="44c51-110">CalculatorServiceUserNameOverSsl.cpp</span></span>](#calculatorserviceusernameoversslcpp)
-   [<span data-ttu-id="44c51-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="44c51-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="44c51-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="44c51-112">Makefile</span></span>](#makefile)

## <a name="calculatorserviceusernameoversslcpp"></a><span data-ttu-id="44c51-113">CalculatorServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="44c51-113">CalculatorServiceUserNameOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="44c51-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="44c51-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="44c51-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="44c51-115">Makefile</span></span>
