...
description: In questo esempio viene illustrato come inserire un elemento in un buffer XML.
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- InsertElementExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104515901"
---
# <a name="insertelementexample"></a><span data-ttu-id="73b5b-106">InsertElementExample</span><span class="sxs-lookup"><span data-stu-id="73b5b-106">InsertElementExample</span></span>

<span data-ttu-id="73b5b-107">In questo esempio viene illustrato come inserire un elemento in un buffer XML.</span><span class="sxs-lookup"><span data-stu-id="73b5b-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="73b5b-108">InsertElement. cpp</span><span class="sxs-lookup"><span data-stu-id="73b5b-108">InsertElement.cpp</span></span>
