...
description: Questo esempio mostra un client TCP che invia messaggi request/reply.
ms.assetid: 0d9b9581-3563-4fce-8790-af7ebb9e8175
keywords:
- RequestReplyTcpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103707237"
---
# <a name="requestreplytcpclientexample"></a><span data-ttu-id="15d3f-106">RequestReplyTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="15d3f-106">RequestReplyTcpClientExample</span></span>

<span data-ttu-id="15d3f-107">Questo esempio mostra un client TCP che invia messaggi request/reply.</span><span class="sxs-lookup"><span data-stu-id="15d3f-107">This example shows a TCP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="15d3f-108">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="15d3f-108">RequestReplyTcpClient.cpp</span></span>](#requestreplytcpclientcpp)
-   [<span data-ttu-id="15d3f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="15d3f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="15d3f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="15d3f-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientcpp"></a><span data-ttu-id="15d3f-111">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="15d3f-111">RequestReplyTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="15d3f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="15d3f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="15d3f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="15d3f-113">Makefile</span></span>
