...
description: Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con nome utente sulla sicurezza in modalità mista SSL.
ms.assetid: d70ae988-0d7c-4494-a54d-1cd73ab8a8ce
keywords:
- HttpServerWithUsernameOverSslExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106298903"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="c2cd1-106">HttpServerWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="c2cd1-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="c2cd1-107">Questo esempio mostra un server TCP che accetta un canale e riceve e risponde ai messaggi, con nome utente sulla sicurezza in modalità mista SSL.</span><span class="sxs-lookup"><span data-stu-id="c2cd1-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="c2cd1-108">In questa configurazione, la connessione di trasporto è protetta (con firma, crittografata) tramite SSL che fornisce anche l'autenticazione server.</span><span class="sxs-lookup"><span data-stu-id="c2cd1-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="c2cd1-109">L'autenticazione client viene fornita da una coppia nome utente/password in un'intestazione WS-Security nel messaggio.</span><span class="sxs-lookup"><span data-stu-id="c2cd1-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="c2cd1-110">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="c2cd1-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="c2cd1-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c2cd1-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c2cd1-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="c2cd1-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="c2cd1-113">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="c2cd1-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c2cd1-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c2cd1-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c2cd1-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="c2cd1-115">Makefile</span></span>
