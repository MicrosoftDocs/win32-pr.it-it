...
description: Questo esempio mostra un client UDP che invia messaggi unidirezionali.
ms.assetid: 245876f7-dc79-4ecd-b510-cf5e60eaa9fc
keywords:
- OneWayUdpClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103955768"
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="4855f-106">OneWayUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="4855f-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="4855f-107">Questo esempio mostra un client UDP che invia messaggi unidirezionali.</span><span class="sxs-lookup"><span data-stu-id="4855f-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="4855f-108">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4855f-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="4855f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4855f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4855f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4855f-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="4855f-111">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4855f-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4855f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4855f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4855f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4855f-113">Makefile</span></span>
