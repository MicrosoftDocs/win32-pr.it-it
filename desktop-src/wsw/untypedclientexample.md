...
description: Questo esempio mostra un client HTTP che invia messaggi request/reply.
ms.assetid: ea6d8696-fd43-4d3c-bfec-3602658a08a7
keywords:
- UnTypedClientExample native-servizi Web
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104329087"
---
# <a name="untypedclientexample"></a><span data-ttu-id="b0e8d-106">UnTypedClientExample</span><span class="sxs-lookup"><span data-stu-id="b0e8d-106">UnTypedClientExample</span></span>

<span data-ttu-id="b0e8d-107">Questo esempio mostra un client HTTP che invia messaggi request/reply.</span><span class="sxs-lookup"><span data-stu-id="b0e8d-107">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="b0e8d-108">UnTypedClient. cpp</span><span class="sxs-lookup"><span data-stu-id="b0e8d-108">UnTypedClient.cpp</span></span>](#untypedclientcpp)
-   [<span data-ttu-id="b0e8d-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b0e8d-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b0e8d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="b0e8d-110">Makefile</span></span>](#makefile)

## <a name="untypedclientcpp"></a><span data-ttu-id="b0e8d-111">UnTypedClient. cpp</span><span class="sxs-lookup"><span data-stu-id="b0e8d-111">UnTypedClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b0e8d-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b0e8d-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b0e8d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="b0e8d-113">Makefile</span></span>
