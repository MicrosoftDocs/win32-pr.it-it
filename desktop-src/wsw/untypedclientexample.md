...
description: Esaminare un esempio di client non tipid che usa l'API Servizi Web Windows (WWSAPI). In questo esempio viene illustrato un client HTTP che invia messaggi request-reply.
...
ms.locfileid: "112409734"
---
# <a name="untypedclientexample"></a><span data-ttu-id="565aa-107">UnTypedClientExample</span><span class="sxs-lookup"><span data-stu-id="565aa-107">UnTypedClientExample</span></span>

<span data-ttu-id="565aa-108">In questo esempio viene illustrato un client HTTP che invia messaggi request-reply.</span><span class="sxs-lookup"><span data-stu-id="565aa-108">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="565aa-109">UnTypedClient.cpp</span><span class="sxs-lookup"><span data-stu-id="565aa-109">UnTypedClient.cpp</span></span>](#untypedclientcpp)
-   [<span data-ttu-id="565aa-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="565aa-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="565aa-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="565aa-111">Makefile</span></span>](#makefile)

## <a name="untypedclientcpp"></a><span data-ttu-id="565aa-112">UnTypedClient.cpp</span><span class="sxs-lookup"><span data-stu-id="565aa-112">UnTypedClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="565aa-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="565aa-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="565aa-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="565aa-114">Makefile</span></span>
