...
---
# <a name="directdraw-structures"></a>Strutture DirectDraw

In questa sezione vengono fornite informazioni sulle seguenti strutture utilizzate con DirectDraw:
...
> [!Note]  
> Prima di usare la struttura, è necessario inizializzare la memoria per ogni struttura DirectX su 0. Inoltre, per tutte le strutture che contengono un membro **dwSize** , è necessario impostare il membro sulle dimensioni della struttura, in byte, prima che venga utilizzata la struttura. Nell'esempio seguente vengono eseguite queste attività su una struttura comune, [**DDCAPS**](/windows/desktop/api/Ddraw/ns-ddraw-ddcaps_dx3):
