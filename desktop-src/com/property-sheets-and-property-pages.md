...
Queste interfacce sono definite nel modo seguente:
...
-   Chiedere al frame di elaborare le sequenze di tasti [**tramite TranslateAccelerator**](/windows/desktop/api/OCIdl/nf-ocidl-ipropertypagesite-translateaccelerator).
...
Un oggetto può scegliere di supportare (2) senza supporto (1), ad esempio quando l'oggetto non dispone di una finestra delle proprietà.
