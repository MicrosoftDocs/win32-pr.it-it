...
---
# <a name="enumerations-ole-and-data-transfer"></a>Enumerazioni (OLE e Trasferimento dati)

Le enumerazioni seguenti vengono utilizzate per implementare documenti composti ed eseguire il trasferimento dei dati tra le applicazioni.
...
-   [**\_flag WindowState \_ OLECMDID**](/windows/desktop/api/DocObj/ne-docobj-olecmdid_windowstate_flag)
...
-   [**OLERENDERE**](/windows/win32/api/oleidl/ne-oleidl-olerender)
