...
---
# <a name="structures-ole-and-data-transfer"></a>Strutture (OLE e Trasferimento dati)

Le strutture seguenti vengono utilizzate per implementare documenti composti ed eseguire il trasferimento dei dati tra le applicazioni.
