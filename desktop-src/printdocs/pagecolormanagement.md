...
Configura la gestione dei colori per la pagina corrente. Questa operazione viene considerata automatica in SHIM-DM \_ ICMMethod Add System. Descrive il componente che deve eseguire la gestione dei colori, ad esempio il driver.
