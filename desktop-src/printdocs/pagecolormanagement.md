...
Configura la gestione dei colori per la pagina corrente. Questo è considerato automatico in SHIM - DM \_ ICMMethod Add System. Descrive il componente che deve eseguire la gestione dei colori,ad esempio Driver.
