...
Descrive l'impostazione della filigrana dell'output e le caratteristiche della filigrana. Le filigrane si applicano alla pagina logica, non alla pagina fisica. Se, ad esempio, DocumentDuplex è abilitato, verrà visualizzata una filigrana in ogni pagina di nstallazione in ogni foglio. Se DocumentDuplex, PagesPerSheet = 2, ogni foglio avrà 2 filigrane.
...
| Note <br/>          | Le coordinate sono relative a PageImageableSize dell'oggetto, in cui l'origine della filigrana è relativa all'origine di PageImageableSize dell'oggetto.<br/> |
