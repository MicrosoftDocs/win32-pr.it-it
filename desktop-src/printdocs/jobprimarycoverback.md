...
Viene descritto il foglio di copertura back (Ending). Ogni processo avrà un foglio primario separato. Il foglio di copertura deve essere stampato in PageMediaSize e PageMediaType usato per la pagina finale del processo. Il foglio di copertura deve essere integrato in opzioni di elaborazione, ad esempio JobDuplexAllDocumentsContiguously, JobNUpAllDocumentsContiguously, come indicato dall'opzione specificata.
