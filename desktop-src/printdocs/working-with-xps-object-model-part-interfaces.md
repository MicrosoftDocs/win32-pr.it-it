---
description: In questo argomento viene descritto come utilizzare le interfacce che consentono l'accesso alle parti del documento XPS in un OM XPS.
...
ms.locfileid: "119823901"
---
# <a name="xps-om-part-interfaces"></a>Interfacce della parte OM XPS

In questo argomento viene descritto come utilizzare le interfacce che consentono l'accesso alle parti del documento XPS in un OM XPS.
...
Gli esempi di codice seguenti illustrano due esempi di come usare le interfacce della parte per accedere al contenuto OM XPS.

### <a name="get-the-name-of-a-document-part"></a>Ottenere il nome di una parte di documento

Nell'esempio di codice seguente si passa a una parte del documento e si ottiene il nome della parte.
