...
Descrive lo scopo del rendering come definito dalla specifica ICC v2. Questo valore deve essere ignorato se un'immagine o un elemento grafico ha un profilo incorporato che specifica la finalità di rendering.
