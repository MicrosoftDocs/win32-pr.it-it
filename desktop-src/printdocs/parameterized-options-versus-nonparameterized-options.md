...
## <a name="case-2---parameterized-printticket-option-nonparameterized-printcapabilities-document-option"></a>Caso 2- Opzione PrintTicket con parametri, opzione del documento PrintCapabilities non parametrizzata
