---
description: Informazioni sull'elemento JobID, che specifica un ID univoco per il processo. Per le informazioni più aggiornate, vedere Specifica dello schema di stampa.
