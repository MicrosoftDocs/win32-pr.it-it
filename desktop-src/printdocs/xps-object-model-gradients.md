---
description: In questo argomento viene fornito un esempio di utilizzo delle sfumature in un OM XPS.
ms.assetid: c58c9e5a-c871-4b44-a1be-0aceafa2f805
title: Gradienti OM XPS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106310146"
---
# <a name="xps-om-gradients"></a><span data-ttu-id="7e65e-103">Gradienti OM XPS</span><span class="sxs-lookup"><span data-stu-id="7e65e-103">XPS OM Gradients</span></span>

<span data-ttu-id="7e65e-104">In questo argomento viene fornito un esempio di utilizzo delle sfumature in un OM XPS.</span><span class="sxs-lookup"><span data-stu-id="7e65e-104">This topic provides an example of using gradients in an XPS OM.</span></span>

## <a name="add-a-new-stop-to-an-existing-gradient"></a><span data-ttu-id="7e65e-105">Aggiungere una nuova interruzione a una sfumatura esistente</span><span class="sxs-lookup"><span data-stu-id="7e65e-105">Add a new stop to an existing gradient</span></span>

<span data-ttu-id="7e65e-106">Nell'esempio di codice seguente viene aggiunta una nuova interruzione alla sfumatura di un pennello a sfumatura lineare.</span><span class="sxs-lookup"><span data-stu-id="7e65e-106">The following code example adds a new stop to the gradient of a linear-gradient brush.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7e65e-107">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="7e65e-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="7e65e-108">**Interfaccia IXpsOMGradientStop**</span><span class="sxs-lookup"><span data-stu-id="7e65e-108">**IXpsOMGradientStop Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop)
</dt> <dt>

[<span data-ttu-id="7e65e-109">**Interfaccia IXpsOMGradientStopCollection**</span><span class="sxs-lookup"><span data-stu-id="7e65e-109">**IXpsOMGradientStopCollection Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstopcollection)
</dt> </dl>
