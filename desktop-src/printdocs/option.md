...
| Elementi figlio<br/>  | *Proprietà* (zero o più)<br/> *ScoredProperty* (zero o più per Options con attributo XML 'name'; uno o più valori per Options che non utilizzano l'attributo XML \* 'name')<br/> \* solo le opzioni pubbliche definite nello schema di stampa non possono avere un attributo 'name', ad esempio DocumentNUp<br/> |
