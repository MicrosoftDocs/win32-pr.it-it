...
Specifica l'origine di una filigrana rispetto all'origine del PageImageableSize dell'oggetto.
...
| MaxValue<br/>     | numero intero<br/> | Valore minore o uguale a PageImageableSize dell'oggetto-ExtentHeight<br/> |
