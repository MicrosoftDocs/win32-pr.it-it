...
Descrive il foglio di copertura anteriore (iniziale). Ogni documento avrà un foglio separato. Il foglio di copertura deve essere stampato in PageMediaSize e PageMediaType usato per la prima pagina del documento. Il foglio di copertura deve essere integrato in opzioni di elaborazione, ad esempio DocumentDuplex, DocumentNUp, come indicato dall'opzione specificata.
