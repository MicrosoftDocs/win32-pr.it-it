...
Descrive il foglio banner da visualizzare come output per il processo. Il foglio banner deve essere output sul PageMediaSize predefinito e usando il PageMediaType predefinito. Il foglio banner deve essere isolato dalla parte rimanente del processo. Ciò significa che qualsiasi opzione di completamento o elaborazione, ad esempio JobDuplexAllDocumentsContiguously, JobStapleAllDocuments o JobBindAllDocuments, non deve includere il foglio banner. Il foglio banner dovrebbe essere visualizzato come primo foglio del processo.
