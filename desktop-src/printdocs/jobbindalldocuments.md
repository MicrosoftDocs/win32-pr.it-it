...
Descrive il metodo di associazione. Tutti i documenti del processo vengono associati insieme. JobBindAllDocuments e la documentazione si escludono a vicenda. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave.
...
| \_BindingGutterValue\_<br/>  | numero intero<br/> | micron<br/>    | Maggiore di 0.<br/>                                                                                                                                                            | Definisce la barra di associazione minima per l'associazione finale specificata. La gronda viene misurata in micron rispetto al bordo della dimensione media fisica.<br/> |
