...
Descrive il metodo di associazione. Tutti i documenti nel processo sono associati tra loro. JobBindAllDocuments e DocumentBinding si escludono a vicenda. È responsabilità del driver determinare la gestione dei vincoli tra queste parole chiave.
