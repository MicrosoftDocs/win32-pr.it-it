...
Descrive le dimensioni dei supporti fisici utilizzate per l'output.

Il diagramma seguente illustra l'utilizzo delle variabili PageMediaSize (l'opzione ISOA4 viene usata come esempio).
...
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \_OptionName\_<br/>           | string<br/>  | caratteri<br/> | Nome completo valido definito dagli [spazi dei nomi in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/). Se non viene specificato alcuno spazio dei nomi, viene utilizzato lo spazio dei nomi predefinito.<br/> | Specifica il nome del supporto. Per la denominazione è necessario utilizzare la convenzione seguente: " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ ".<br/> |
...
| \_OptionNameStandard\_<br/>   | string<br/>  | caratteri<br/> | ' ISO ',' JIS ',' Japan ',' NorthAmerica ',' OtherMetric ',' PRC ', None.<br/>                                                                                                         | Indica se le dimensioni del supporto sono definite da un particolare standard.<br/>                                                                                               |
| \_OptionNameCommonName\_<br/> | string<br/>  | caratteri<br/> | Nome completo valido definito dagli [spazi dei nomi in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/). Se non viene specificato alcuno spazio dei nomi, viene utilizzato lo spazio dei nomi predefinito.<br/> | Nome comune per le dimensioni dei supporti.<br/>                                                                                                                                |
| \_OptionNameDescriptor\_<br/> | string<br/>  | caratteri<br/> | Grande, busta, extra, più, cartolina, ruotata, foglio,' none '.<br/>                                                                                                              | Grande, busta, extra, più, cartolina, ruotata, foglio,' none '.<br/>                                                                                                  |
| \_MediaSizeWidth\_<br/>       | numero intero<br/> | micron<br/>    | Maggiore di 0, minore delle dimensioni massime dei supporti di supporto per il dispositivo.<br/>                                                                                                           | Specifica la larghezza del supporto fisico.<br/>                                                                                                                     |
| \_MediaSizeHeight\_<br/>      | numero intero<br/> | micron<br/>    | Maggiore di 0, minore delle dimensioni massime dei supporti di supporto per il dispositivo.<br/>                                                                                                           | Specifica l'altezza del supporto fisico.<br/>                                                                                                                    |
