...
---
# <a name="pagemediasize"></a><span data-ttu-id="4fb4c-105">Pagemediasize</span><span class="sxs-lookup"><span data-stu-id="4fb4c-105">PageMediaSize</span></span>

<span data-ttu-id="4fb4c-106">Questo argomento non è corrente.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-106">This topic is not current.</span></span> <span data-ttu-id="4fb4c-107">Per le informazioni più aggiornate, vedere Print [Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="4fb4c-107">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="4fb4c-108">Descrive le dimensioni fisiche dei supporti utilizzate per l'output.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-108">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="4fb4c-109">Il diagramma seguente illustra l'utilizzo della variabile PageMediaSize (come esempio viene usata l'opzione ISOA4).</span><span class="sxs-lookup"><span data-stu-id="4fb4c-109">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![diagramma che mostra le dimensioni della pagina](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="4fb4c-111">Informazioni sull'elemento</span><span class="sxs-lookup"><span data-stu-id="4fb4c-111">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="4fb4c-112">Contenuto strutturale</span><span class="sxs-lookup"><span data-stu-id="4fb4c-112">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="4fb4c-113">Extensible Markup Language (XML) Content</span><span class="sxs-lookup"><span data-stu-id="4fb4c-113">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="4fb4c-114">Informazioni sull'elemento</span><span class="sxs-lookup"><span data-stu-id="4fb4c-114">Element Information</span></span>

| <span data-ttu-id="4fb4c-115">Nome</span><span class="sxs-lookup"><span data-stu-id="4fb4c-115">Name</span></span>                 | <span data-ttu-id="4fb4c-116">Valore</span><span class="sxs-lookup"><span data-stu-id="4fb4c-116">Value</span></span>        |
|----------------------|--------------|
| <span data-ttu-id="4fb4c-117">Tipo di elemento</span><span class="sxs-lookup"><span data-stu-id="4fb4c-117">Element Type</span></span> <br/>   | <span data-ttu-id="4fb4c-118">Funzionalità</span><span class="sxs-lookup"><span data-stu-id="4fb4c-118">Feature</span></span><br/> |
| <span data-ttu-id="4fb4c-119">Prefisso di ambito</span><span class="sxs-lookup"><span data-stu-id="4fb4c-119">Scoping Prefix</span></span> <br/> | <span data-ttu-id="4fb4c-120">Pagina</span><span class="sxs-lookup"><span data-stu-id="4fb4c-120">Page</span></span><br/>    |
| <span data-ttu-id="4fb4c-121">Note</span><span class="sxs-lookup"><span data-stu-id="4fb4c-121">Notes</span></span> <br/>          | <span data-ttu-id="4fb4c-122">nessuno</span><span class="sxs-lookup"><span data-stu-id="4fb4c-122">None</span></span><br/>    |

## <a name="structural-content"></a><span data-ttu-id="4fb4c-123">Contenuto strutturale</span><span class="sxs-lookup"><span data-stu-id="4fb4c-123">Structural Content</span></span>

<span data-ttu-id="4fb4c-124">La struttura XML di questo elemento è:</span><span class="sxs-lookup"><span data-stu-id="4fb4c-124">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="4fb4c-125">Variabili di struttura</span><span class="sxs-lookup"><span data-stu-id="4fb4c-125">Structure Variables</span></span>

<span data-ttu-id="4fb4c-126">Nella tabella seguente vengono descritte le caratteristiche delle variabili definite nella struttura XML.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-126">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="4fb4c-127">Nome</span><span class="sxs-lookup"><span data-stu-id="4fb4c-127">Name</span></span>                                | <span data-ttu-id="4fb4c-128">Tipo di dati</span><span class="sxs-lookup"><span data-stu-id="4fb4c-128">Data type</span></span>          | <span data-ttu-id="4fb4c-129">Unità</span><span class="sxs-lookup"><span data-stu-id="4fb4c-129">Unit</span></span>                  | <span data-ttu-id="4fb4c-130">Valori supportati</span><span class="sxs-lookup"><span data-stu-id="4fb4c-130">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="4fb4c-131">Riepilogo</span><span class="sxs-lookup"><span data-stu-id="4fb4c-131">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="4fb4c-132">\_OptionName\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-132">\_OptionName\_</span></span><br/>           | <span data-ttu-id="4fb4c-133">string</span><span class="sxs-lookup"><span data-stu-id="4fb4c-133">string</span></span><br/>  | <span data-ttu-id="4fb4c-134">caratteri</span><span class="sxs-lookup"><span data-stu-id="4fb4c-134">characters</span></span><br/> | <span data-ttu-id="4fb4c-135">Nome completo valido definito da Spazi [dei nomi in XML.](https://www.w3.org/TR/1999/REC-xml-names-19990114/)</span><span class="sxs-lookup"><span data-stu-id="4fb4c-135">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="4fb4c-136">Se non viene specificato alcuno spazio dei nomi, viene utilizzato lo spazio dei nomi predefinito.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-136">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="4fb4c-137">Specifica il nome del supporto.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-137">Specifies the name of the media.</span></span> <span data-ttu-id="4fb4c-138">La denominazione deve usare la convenzione seguente: " \_ OptionNameStandard \_ "" \_ OptionNameCommonName \_ "" \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="4fb4c-138">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="4fb4c-139">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-139">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="4fb4c-140">string</span><span class="sxs-lookup"><span data-stu-id="4fb4c-140">string</span></span><br/>  | <span data-ttu-id="4fb4c-141">n/d</span><span class="sxs-lookup"><span data-stu-id="4fb4c-141">n/a</span></span><br/>        | <span data-ttu-id="4fb4c-142">True, False.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-142">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="4fb4c-143">Definisce un'opzione che, se selezionata, disabilita questa funzionalità.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-143">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="4fb4c-144">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-144">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="4fb4c-145">string</span><span class="sxs-lookup"><span data-stu-id="4fb4c-145">string</span></span><br/>  | <span data-ttu-id="4fb4c-146">caratteri</span><span class="sxs-lookup"><span data-stu-id="4fb4c-146">characters</span></span><br/> | <span data-ttu-id="4fb4c-147">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-147">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="4fb4c-148">Indica se le dimensioni del supporto sono definite da uno standard specifico.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-148">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="4fb4c-149">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-149">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="4fb4c-150">string</span><span class="sxs-lookup"><span data-stu-id="4fb4c-150">string</span></span><br/>  | <span data-ttu-id="4fb4c-151">caratteri</span><span class="sxs-lookup"><span data-stu-id="4fb4c-151">characters</span></span><br/> | <span data-ttu-id="4fb4c-152">Nome completo valido definito da Spazi [dei nomi in XML.](https://www.w3.org/TR/1999/REC-xml-names-19990114/)</span><span class="sxs-lookup"><span data-stu-id="4fb4c-152">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="4fb4c-153">Se non viene specificato alcuno spazio dei nomi, viene utilizzato lo spazio dei nomi predefinito.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-153">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="4fb4c-154">Nome comune per le dimensioni del supporto.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-154">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="4fb4c-155">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-155">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="4fb4c-156">string</span><span class="sxs-lookup"><span data-stu-id="4fb4c-156">string</span></span><br/>  | <span data-ttu-id="4fb4c-157">caratteri</span><span class="sxs-lookup"><span data-stu-id="4fb4c-157">characters</span></span><br/> | <span data-ttu-id="4fb4c-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="4fb4c-159">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-159">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="4fb4c-160">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-160">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="4fb4c-161">numero intero</span><span class="sxs-lookup"><span data-stu-id="4fb4c-161">integer</span></span><br/> | <span data-ttu-id="4fb4c-162">Micron</span><span class="sxs-lookup"><span data-stu-id="4fb4c-162">microns</span></span><br/>    | <span data-ttu-id="4fb4c-163">Maggiore di 0, minore delle dimensioni massime del supporto per il dispositivo.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-163">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="4fb4c-164">Specifica la larghezza del supporto fisico.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-164">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="4fb4c-165">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="4fb4c-165">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="4fb4c-166">numero intero</span><span class="sxs-lookup"><span data-stu-id="4fb4c-166">integer</span></span><br/> | <span data-ttu-id="4fb4c-167">Micron</span><span class="sxs-lookup"><span data-stu-id="4fb4c-167">microns</span></span><br/>    | <span data-ttu-id="4fb4c-168">Maggiore di 0, minore delle dimensioni massime del supporto per il dispositivo.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-168">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="4fb4c-169">Specifica l'altezza del supporto fisico.</span><span class="sxs-lookup"><span data-stu-id="4fb4c-169">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="4fb4c-170">Extensible Markup Language (XML) Content</span><span class="sxs-lookup"><span data-stu-id="4fb4c-170">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="4fb4c-171">Le parole chiave dello schema di stampa pubblico sono definite nello spazio dei `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` nomi .</span><span class="sxs-lookup"><span data-stu-id="4fb4c-171">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="4fb4c-172">Il contenuto Extensible Markup Language pubblico (XML) per questa parola chiave è definito di seguito:</span><span class="sxs-lookup"><span data-stu-id="4fb4c-172">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="4fb4c-173">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="4fb4c-173">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="4fb4c-174">Specifica dello schema di stampa</span><span class="sxs-lookup"><span data-stu-id="4fb4c-174">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
