...
description: Informazioni sulle funzioni di configurazione del metodo peer EAPHost. Vedere un elenco delle funzioni di configurazione e visualizzare le risorse disponibili aggiuntive.
...
Le funzioni di configurazione dell'API EAP Peer Method sono le seguenti.
...
| [**EapPeerFreeErrorMemory**](/previous-versions/windows/desktop/api/eapmethodpeerapis/nf-eapmethodpeerapis-eappeerfreeerrormemory)                                                  | Libera tutta la memoria specifica degli errori EAP restituita dalle API peer EapHost.                                                                                                                                                                                               |
...
| [**EapPeerQueryCredentialInputFields**](/previous-versions/windows/desktop/api/eapmethodpeerapis/nf-eapmethodpeerapis-eappeerquerycredentialinputfields)                            | Definisce l'implementazione di una funzione specifica del metodo EAP che ottiene i campi di input delle credenziali EAP Single Sign-On (SSO) per tale metodo EAP                                                                                                              |
| [**EapPeerQueryInteractiveUIInputFields**](/previous-versions/windows/desktop/api/eapmethodpeerapis/nf-eapmethodpeerapis-eappeerqueryinteractiveuiinputfields)                      | Definisce l'implementazione di una funzione supplicant EAP che ottiene i campi di input per i componenti interattivi dell'interfaccia utente da generare sul supplicant.                                                                                                     |
...
[Funzioni Run-Time peer EAPHost](eaphost-peer-method-run-time-functions.md)
</dt> </dl>
