---
title: Funzioni del metodo Authenticator EAPHost
description: Informazioni sulle funzioni API Authenticator metodo EAPHost, ad esempio EapMethodAuthenticatorFreeErrorMemory.
...
ms.locfileid: "118984271"
---
# <a name="eaphost-authenticator-method-functions"></a>Funzioni del metodo Authenticator EAPHost

Le funzioni api del Authenticator EAPHost sono le seguenti.



| Funzione                                                                                               | Descrizione                                                                                                                                                                                 |
|--------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EapMethodAuthenticatorBeginSession**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorbeginsession)                       | Crea una nuova sessione di autenticazione EAP nel server EAPHost.                                                                                                                             |
| [**EapMethodAuthenticatorEndSession**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorendsession)                           | Chiude una sessione di autenticazione EAP nel server EAPHost.                                                                                                                                 |
...
| [**EapMethodAuthenticatorGetInfo**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorgetinfo)                                 | Ottiene un set di puntatori a funzione per un'implementazione del metodo autenticatore EAP caricato.                                                                                            |
...
| [**EapMethodAuthenticatorSendPacket**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorsendpacket)                           | Ottiene un pacchetto di autenticazione dal metodo di autenticazione EAP da inviare al supplicant.                                                                                               |
| [**EapMethodAuthenticatorSetAttributes**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorsetattributes)                     | Fornisce attributi di autenticazione EAP aggiornati da impostare nel metodo di autenticazione EAP.                                                                                                      |
...
| [**EapMethodAuthenticatorUpdateInnerMethodParams**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorupdateinnermethodparams) | Aggiorna le impostazioni della sessione di autenticazione EAP stabilite in precedenza da una chiamata a [**EapMethodAuthenticatorBeginSession**](/previous-versions/windows/desktop/api/eapmethodauthenticatorapis/nf-eapmethodauthenticatorapis-eapmethodauthenticatorbeginsession) dal server EAPHost. |
