...
description: Informazioni sull'elemento CredentialsSource (EapType). Questo elemento contiene informazioni sul percorso del certificato EAP-TLS.
...
ms.locfileid: "118984110"
---
# <a name="credentialssource-eaptype-element"></a>Elemento CredentialsSource (EapType)

**L'elemento CredentialsSource (EapType)** contiene informazioni sul percorso del certificato EAP-TLS.
...
**L'elemento CredentialsSource** è definito dall'elemento [**EapType.**](eaptlsconnectionpropertiesv1schema-eaptype-element.md)

## <a name="remarks"></a>Commenti

**L'elemento CredentialSource** è facoltativo.
