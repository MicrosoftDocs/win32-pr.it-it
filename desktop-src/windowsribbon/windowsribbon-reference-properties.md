---
title: Chiavi di proprietà
description: Documentazione di riferimento per le chiavi Windows proprietà del framework della barra multifunzione, una raccolta di coppie chiave-valore PROPERTYKEY e PROPVARIANT usate per descrivere lo stato di un comando del framework della barra multifunzione.
