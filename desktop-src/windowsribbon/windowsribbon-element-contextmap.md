...
keywords:
- Elemento ContextMap Windows ribbon
topic_type:
- apiref
api_name:
- ContextMap
...
<td>xs:string<br/></td>
<td>No<br/></td>
<td>Deve corrispondere a un <a href="windowsribbon-element-contextmenu.md"><strong>nome ContextMenu</strong></a> <em>esistente.</em><br/> <br/>
