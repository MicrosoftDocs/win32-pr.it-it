...
Recupera l'identificatore del tratto per il tratto a cui fa riferimento un valore di indice all'interno dell'oggetto [**IContextNode**](icontextnode.md) .
...
Identificatore del tratto per il tratto a cui fa riferimento il parametro *ulIndex* all'interno dell'oggetto [**IContextNode**](icontextnode.md) corrente.
