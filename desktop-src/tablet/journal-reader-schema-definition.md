...
---
# <a name="journal-reader-schema-definition"></a>Definizione dello schema Reader Journal

In questo argomento è contenuta la definizione dello schema Reader Journal.
