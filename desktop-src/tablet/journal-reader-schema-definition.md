---
description: In questo argomento è contenuta la definizione dello schema Reader Journal.
ms.assetid: 2fa6a5d9-64d6-447f-bf2a-d3bf6ca7c093
title: Definizione dello schema Reader Journal
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106318703"
---
# <a name="journal-reader-schema-definition"></a><span data-ttu-id="cd17b-103">Definizione dello schema Reader Journal</span><span class="sxs-lookup"><span data-stu-id="cd17b-103">Journal Reader Schema Definition</span></span>

<span data-ttu-id="cd17b-104">In questo argomento è contenuta la definizione dello schema Reader Journal.</span><span class="sxs-lookup"><span data-stu-id="cd17b-104">This topic contains the definition of the Journal Reader schema.</span></span>

## <a name="schema"></a><span data-ttu-id="cd17b-105">SCHEMA</span><span class="sxs-lookup"><span data-stu-id="cd17b-105">Schema</span></span>
