...
La piattaforma Tablet PC genera diversi formati di persistenza utili come blocchi predefiniti per i formati elencati in precedenza. I formati seguenti vengono tutti generati e utilizzati usando i [**metodi**](/previous-versions/ms583670(v=vs.100)) [**Load**](/previous-versions/ms569609(v=vs.100)) e [**Save**](/previous-versions/dotnet/netframework-3.5/ms571335(v=vs.90)) dell'oggetto Ink.
