...
---
# <a name="iinkanalyzeraddstrokeforlanguage-method"></a>Metodo IInkAnalyzer:: AddStrokeForLanguage

Aggiunge i dati del tratto per un singolo tratto a [**IInkAnalyzer**](iinkanalyzer.md) e assegna un identificatore di impostazioni cultura specifico al tratto.
...
Puntatore il cui valore è impostato sul puntatore di [**IContextNode**](icontextnode.md) che contiene il tratto appena aggiunto.
