...
---
# <a name="reading-attribute-values-from-a-cd-or-dvd"></a><span data-ttu-id="98aec-114">Lettura di valori di attributo da un CD o DVD</span><span class="sxs-lookup"><span data-stu-id="98aec-114">Reading Attribute Values from a CD or DVD</span></span>

<span data-ttu-id="98aec-115">In questo argomento, l'oggetto **Player** è stato definito nel modo seguente:</span><span class="sxs-lookup"><span data-stu-id="98aec-115">Throughout this topic, the **Player** object was defined in the following manner:</span></span>
...
<span data-ttu-id="98aec-116">Il codice di esempio C# seguente recupera i valori di tutti gli attributi nel disco corrente che si trova nell'unità e li scrive in un file.</span><span class="sxs-lookup"><span data-stu-id="98aec-116">The following C# example code retrieves the values of all attributes in the current disc that is in the drive and writes them to a file.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="98aec-117">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="98aec-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="98aec-118">**Attributi elemento multimediale**</span><span class="sxs-lookup"><span data-stu-id="98aec-118">**Media Item Attributes**</span></span>](media-item-attributes.md)
</dt> <dt>

[<span data-ttu-id="98aec-119">**Oggetto multimediale**</span><span class="sxs-lookup"><span data-stu-id="98aec-119">**Media Object**</span></span>](media-object.md)
</dt> </dl>
