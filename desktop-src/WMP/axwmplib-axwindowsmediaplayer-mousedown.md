...
Il gestore associato a questo evento è di tipo **AxWMPLib. \_ \_MouseDownEventHandler WMPOCXEvents**. Questo gestore riceve un argomento di tipo **AxWMPLib. \_ WMPOCXEvents \_ MouseDownEvent**, che contiene le seguenti proprietà correlate a questo evento.
