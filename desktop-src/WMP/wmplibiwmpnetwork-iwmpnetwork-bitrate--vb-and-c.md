...
---
# <a name="iwmpnetworkbitrate-property"></a>Proprietà IWMPNetwork:: bitrate

La proprietà **bitrate** ottiene la velocità in bit corrente ricevuta.
...
Il valore di questa proprietà è una combinazione della velocità in bit dei flussi video e audio.

## <a name="examples"></a>Esempio

Nell'esempio seguente viene usata la **velocità in bit** per visualizzare la velocità in bit del supporto corrente. Le informazioni vengono visualizzate in un'etichetta in risposta all'evento **PlayStateChange** . L'oggetto **AxWMPLib. AxWindowsMediaPlayer** è rappresentato dalla variabile denominata Player.
