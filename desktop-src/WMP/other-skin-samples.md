...
Per visualizzare esempi di interfaccia funzionante completa, fare clic sul pulsante **Start,** scegliere **Programmi,** **Windows Media,** **Windows Media SDK** e quindi fare clic su Esempi di Player **SDK.** Per usare gli esempi, è necessario installare Windows Media Player SDK.
