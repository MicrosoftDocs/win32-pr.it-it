...
|-------------------|--------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AlbumID           | Intero non negativo. Esempio: 789456<br/>                          | Identificatore dell'album, univoco all'interno album.csv. Deve essere minore di 2^32.                                                                                                                                                                           |
...
| FeedsAreAvailable | Proprietà di tipo Boolean. Può essere 0 o 1.                                                  | Non usato in questa versione. Deve essere 0.                                                                                                                                                                                                               |
