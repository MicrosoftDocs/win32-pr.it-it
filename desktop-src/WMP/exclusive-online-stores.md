...
Un'applicazione può Windows Media Player a uno store online esclusivo solo se Windows Media Player non è già in esecuzione all'avvio dell'applicazione. È responsabilità dell'applicazione informare l'utente che deve chiudere Windows Media Player prima di eseguire l'applicazione.
