...
description: La proprietà Description recupera una descrizione del testo dei metadati.
ms.assetid: df8c9c0f-7ae9-42e8-bca6-9dc42e899212
keywords:
- MetadataText. Description Media Player Windows
topic_type:
- apiref
api_name:
...
ms.locfileid: "106324090"
---
# <a name="metadatatextdescription"></a>MetadataText. Description

La proprietà **Description** recupera una descrizione del testo dei metadati.

## <a name="syntax"></a>Sintassi

*Player*. *currentMedia*. **getItemInfoByType**( *nome*, *lingua*, *Indice*). **Descrizione** di
