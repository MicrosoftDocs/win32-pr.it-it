...
Il diagramma seguente illustra come il contenuto viene inserito in un pacchetto in un file di download multimediale di Windows, pubblicato in un sito Web, scaricato e riprodotto in un computer client usando Windows Media Player.

![come viene ottenuto e riprodotto un file di download di Windows Media.](images/wmd-image.png) Windows Download di file multimediali
