...
|----------------------------------------------------------------------------------|------------------------------------------|
| [Descrizione](wmplibiwmpmetadatatext-iwmpmetadatatext-description--vb-and-c.md) | Ottiene una descrizione del testo dei metadati. |
| [text](wmplibiwmpmetadatatext-iwmpmetadatatext-text--vb-and-c.md)               | Ottiene il testo dei metadati.                  |
