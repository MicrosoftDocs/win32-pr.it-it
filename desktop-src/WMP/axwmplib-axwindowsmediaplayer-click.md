...
---
# <a name="click-event-of-the-axwindowsmediaplayer-object"></a>Evento Click dell'oggetto AxWindowsMediaPlayer

L'evento click si verifica quando l'utente fa clic con un pulsante del mouse su un controllo Media Player di Windows.
...
Il gestore associato a questo evento è di tipo **AxWMPLib. \_ \_ClickEventHandler WMPOCXEvents**. Questo gestore riceve un argomento di tipo **AxWMPLib. \_ WMPOCXEvents \_ ClickEvent**, che contiene le seguenti proprietà correlate a questo evento.
