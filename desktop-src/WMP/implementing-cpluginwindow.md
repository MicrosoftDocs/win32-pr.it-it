...
La procedura guidata fornisce un'implementazione di base di CPluginWindow nel file di intestazione CPluginWindow.h. Per semplicità, il plug-in dell'interfaccia utente di ricerca modificherà direttamente questo file, anche se in genere vengono inserite aggiunte estese in un file CPluginWindow.cpp separato.

Le sezioni seguenti descrivono le operazioni da eseguire per implementare CPluginWindow:
