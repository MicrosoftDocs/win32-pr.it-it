...
---
# <a name="iwmpmediaimagesourceheight-property"></a>Proprietà IWMPMedia:: imageSourceHeight

La proprietà **imageSourceHeight** Ottiene l'altezza in pixel dell'elemento multimediale corrente.
...
**System. Int32** che rappresenta l'altezza dell'elemento multimediale.
...
Nell'esempio seguente viene usato **imageSourceHeight** per visualizzare la dimensione dell'immagine, in pixel, dell'elemento multimediale corrente in una casella di testo. L'oggetto **AxWMPLib. AxWindowsMediaPlayer** è rappresentato dalla variabile denominata Player.
