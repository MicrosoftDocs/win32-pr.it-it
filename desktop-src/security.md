...
| [Host del protocollo di autenticazione estendibile](./eaphost/about-eap-host.md) | EAPHost è un componente microsoft Windows Networking che fornisce un'infrastruttura EAP (Extensible Authentication Protocol) per l'autenticazione di implementazioni del protocollo "supplicant", ad esempio 802.1X e PPP (Point-to-Point). |
...
| [Controllo genitori](./parcon/parental-controls-portal.md) | La tecnologia Controllo genitori in Windows è destinata ad assistere genitori o tutori diligenti per garantire l'accesso ai materiali appropriati in base all'età o al livello di maturità per coloro che sono sotto la loro tutela. Fornisce un'infrastruttura estendibile oltre alle funzionalità incorporate. |
...
| [Security Development Lifecycle (SDL) - Linee guida per i processi](/previous-versions/windows/desktop/cc307891(v=msdn.10)) | Microsoft Security Development Lifecycle (SDL) è un processo di garanzia di sicurezza software leader nel settore. Un'iniziativa a livello di Microsoft e un criterio obbligatorio dal 2004, SDL ha svolto un ruolo fondamentale nell'incorporamento della sicurezza e della privacy nel software e nella cultura Microsoft. Combinando un approccio olistico e pratico, SDL introduce la sicurezza e la privacy in anticipo e in tutte le fasi del processo di sviluppo. |
...
| [Glossario sulla sicurezza](./secgloss/security-glossary.md) | Fornisce un glossario delle condizioni di sicurezza. |
