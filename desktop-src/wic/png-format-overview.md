...
La tabella seguente elenca i GUID usati per identificare i componenti nativi del codec PNG.



| Componente        | Nome descrittivo            | GUID                                |
|------------------|--------------------------|-------------------------------------|
| Formato contenitore | GUID \_ ContainerFormatPng | 1b7cfaf4-713f-473c-netted6137425faeaf |
...
Il codec PNG usa le opzioni del codificatore WIC di base. La tabella seguente elenca le opzioni del codificatore WIC supportate dal codec PNG nativo.
...
Il codec PNG nativo supporta anche [**IWICBitmapSourceTransform**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsourcetransform) nella decodifica dei fotogrammi aggiungendo opzioni avanzate per la decodifica di un flusso di immagini. Per altre informazioni su queste opzioni avanzate, vedere Cenni preliminari [sulle origini bitmap.](-wic-bitmapsources.md)
