...
Windows 7 offre codec predefiniti che supportano la decodifica progressiva per i formati di immagine JPEG, PNG e GIF. Ognuno di questi Windows 7 codec eseguono più passaggi di decodifica su un'immagine. Ogni passaggio corrisponde a un particolare livello e a una parte dell'immagine decodificata, con la fine di ottenere un'immagine completamente decodificata.

Ogni formato di immagine gestisce la decodifica progressiva in modo diverso. Nella tabella seguente vengono fornite informazioni sul numero di livelli progressivi e sul metodo di decodifica supportato dai Windows 7 formati di decodifica progressiva. 
