...
---
# <a name="systemgpstrackref-photo-metadata-policy"></a>Criteri per i metadati delle foto di System. GPS. TrackRef

Criteri per i metadati delle foto per la proprietà [System. GPS. TrackRef](../properties/props-system-gps-trackref.md) .
