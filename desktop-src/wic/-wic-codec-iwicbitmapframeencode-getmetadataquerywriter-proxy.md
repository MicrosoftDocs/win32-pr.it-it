...
---
# <a name="iwicbitmapframeencode_getmetadataquerywriter_proxy-function"></a>IWICBitmapFrameEncode \_ GetMetadataQueryWriter- \_ funzione proxy
...
Puntatore che riceve un writer di query dei metadati per il frame.
