...
keywords:
- EventLog di tipo complesso LevelType
topic_type:
- apiref
api_name:
- LevelType
...
| Valore   | [**UInt8Type**](eventmanifestschema-hexint8type-simpletype.md)   | Valore del livello. È possibile specificare valori nell'intervallo da 16 a 255. Per i valori di livello predefiniti, vedere la sezione Osservazioni.<br/>                                                                                                                                                                                               |
...
|-------------------|-------|---------------------------|-------------------------------------------------------------------------|
| win:Critical      | 1     | WINEVENT \_ LEVEL \_ CRITICAL | Identifica un evento anomalo di uscita o chiusura.<br/>            |
...
| win:Informational | 4     | INFORMAZIONI A \_ LIVELLO DI \_ WINEVENT     | Identifica un evento non di errore, ad esempio un evento di ingresso o di uscita.<br/> |
| win:Verbose       | 5     | LIVELLO \_ WINEVENT \_ DETTAGLIATO  | Identifica un evento di traccia dettagliato.<br/>                           |



 

I numeri più alti implicano che si ottengono anche livelli inferiori. Ad esempio, se si specifica win:Warning, si ricevono tutti gli eventi di avviso, di errore e critici.
