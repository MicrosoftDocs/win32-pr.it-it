...
| **Attività**                                                                     | [**TaskListType**](eventmanifestschema-tasklisttype-complextype.md)       | Definisce un elenco di attività che un provider può usare per raggruppare gli eventi. In genere, le attività vengono usate per raggruppare gli eventi per una funzionalità o un componente del provider.<br/> |
