...
description: Direct2D fornisce le strutture seguenti. Nello spazio dei nomi D2D1 sono definite strutture aggiuntive.
...
| [**D2D \_ POINT \_ 2F**](/windows/desktop/api/dcommon/ns-dcommon-d2d_point_2f) | Rappresenta una coppia di coordinate x e y, espressa come valori a virgola mobile, nello spazio bidimensionale. |
| [**D2D \_ POINT \_ 2L**](/previous-versions/windows/desktop/legacy/jj219217(v=vs.85)) | La struttura D2D \_ POINT \_ 2L definisce le coordinate x e y di un punto. |
...
| [**D2D \_ RECT \_ F**](/windows/desktop/api/dcommon/ns-dcommon-d2d_rect_f) | Rappresenta un rettangolo definito dalle coordinate dell'angolo superiore sinistro (sinistro, superiore) e dalle coordinate dell'angolo inferiore destro (destra, inferiore).  |
| [**D2D \_ RECT \_ L**](/previous-versions/windows/desktop/legacy/jj244059(v=vs.85)) | La [**struttura \_ RECT \_ L D2D**](/previous-versions/windows/desktop/legacy/jj244059(v=vs.85)) definisce le coordinate degli angoli superiore sinistro e inferiore destro di un rettangolo. |
| [**D2D \_ RECT \_ U**](/windows/desktop/api/dcommon/ns-dcommon-d2d_rect_u) | Rappresenta un rettangolo definito dalla coppia di coordinate dell'angolo superiore sinistro (sinistra, superiore) e dall'angolo inferiore destro (destra, inferiore). Queste coordinate sono espresse come valori interi a 32 bit. |
...
| [**VETTORE D2D \_ \_ 3F**](/windows/desktop/api/dcommon/ns-dcommon-d2d_vector_3f) | Vettore 3D costituito da tre valori a virgola mobile e precisione singola (x, y, z). |
| [**D2D \_ VECTOR \_ 4F**](/windows/desktop/api/dcommon/ns-dcommon-d2d_vector_4f) | Vettore 4D costituito da quattro valori a virgola mobile e precisione singola (x, y, z, w). |
| [**SEGMENTO ARC \_ D2D1 \_**](/windows/desktop/api/d2d1/ns-d2d1-d2d1_arc_segment) | Descrive un arco ellittico tra due punti. |
| [**SEGMENTO DI BÉZIER D2D1 \_ \_**](/windows/desktop/api/d2d1/ns-d2d1-d2d1_bezier_segment) | Rappresenta un segmento di Bézier cubica disegnato tra due punti. |
...
| [**PROPRIETÀ DEL PENNELLO \_ BITMAP D2D11 \_ \_**](/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_bitmap_brush_properties1) | Descrive le modalità di estensione e la modalità di interpolazione di [**un oggetto ID2D1BitmapBrush.**](/windows/win32/api/d2d1/nn-d2d1-id2d1bitmapbrush) |
...
| [**PROPRIETÀ BITMAP \_ D2D11 \_**](/windows/desktop/api/D2D1_1/ns-d2d1_1-d2d1_bitmap_properties1) | Questa struttura consente di creare un [**oggetto ID2D1Bitmap1**](/windows/win32/api/d2d1_1/nn-d2d1_1-id2d1bitmap1) con le opzioni bitmap e le informazioni sul contesto del colore disponibili.  |
| [**DESCRIZIONE DI BLEND D2D1 \_ \_**](/windows/desktop/api/D2d1effectauthor/ns-d2d1effectauthor-d2d1_blend_description) | Definisce una descrizione di blend da usare in una particolare trasformazione di blend. |
...
| [**DESCRIZIONE DELLO STATO DI DISEGNO D2D1 \_ \_ \_**](/windows/desktop/api/d2d1/ns-d2d1-d2d1_drawing_state_description) | Descrive lo stato di disegno di una destinazione di rendering.  |
...
| [**D2D1 \_ FEATURE \_ DATA \_ DOUBLES**](/windows/desktop/api/D2d1effectauthor/ns-d2d1effectauthor-d2d1_feature_data_doubles) | Descrive il supporto per double negli shader. |
| [**D2D1 \_ FEATURE \_ DATA \_ D3D10 \_ X OPZIONI \_ HARDWARE \_**](/windows/desktop/api/D2d1effectauthor/ns-d2d1effectauthor-d2d1_feature_data_d3d10_x_hardware_options) | Descrive il supporto dello shader di calcolo, che è un'opzione a livello di funzionalità D3D10. |
| [**PATCH DELLA \_ MESH SFUMATURA D2D1 \_ \_**](/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_gradient_mesh_patch) | Rappresenta una patch tensore con 16 punti di controllo, 4 colori degli angoli e flag limite. Id2D1GradientMesh è costituito da 1 o più patch di mesh a sfumatura. Usare la [**funzione GradientMeshPatch**](/windows/desktop/api/d2d1_3helper/nf-d2d1_3helper-gradientmeshpatch) o [**la funzione GradientMeshPatchFromCoonsPatch**](/windows/desktop/api/d2d1_3helper/nf-d2d1_3helper-gradientmeshpatchfromcoonspatch) per crearne una.  |
...
| [**PROPRIETÀ DEL PENNELLO IMMAGINE D2D1 \_ \_ \_**](/windows/desktop/api/D2D1_1/ns-d2d1_1-d2d1_image_brush_properties) | Descrive le funzionalità del pennello immagine. |
| [**SEGMENTO DI \_ BÉZIER INPUT PENNA D2D1 \_ \_**](/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_bezier_segment) | Rappresenta un segmento di Bézier da usare nella creazione di un [**oggetto ID2D1Ink.**](/windows/win32/api/d2d1_3/nn-d2d1_3-id2d1ink) Questa struttura è diversa da [**D2D1 \_ BEZIER \_ SEGMENT**](/windows/desktop/api/d2d1/ns-d2d1-d2d1_bezier_segment) perché è composta da PUNTI INPUT PENNA [**D2D1, \_ \_**](/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_point)che contengono un raggio oltre alle coordinate x e y.  |
| [**PUNTO INPUT PENNA D2D1 \_ \_**](/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_point) | Rappresenta una coppia di punti e raggio che costituisce parte di un SEGMENTO DI [**\_ \_ BÉZIER \_ INPUT PENNA D2D1.**](/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_bezier_segment) |
| [**DESCRIZIONE DELL'INPUT D2D1 \_ \_**](/windows/desktop/api/D2d1effectauthor/ns-d2d1effectauthor-d2d1_input_description) | Descrive le opzioni che le trasformazioni possono impostare per le trame di input. |
...
| [**PROPRIETÀ DELLA DESTINAZIONE DI RENDERING D2D1 \_ \_ \_**](/windows/desktop/api/d2d1/ns-d2d1-d2d1_render_target_properties) | Contiene opzioni di rendering (hardware o software), formato pixel, informazioni DPI, opzioni di comunicazione remota e requisiti di supporto Direct3D per una destinazione di rendering.  |
