...
---
# <a name="id2d1geometrygetbounds-methods"></a>Metodi ID2D1Geometry:: GetBounds
...
| Metodo                                                                                                                   | Descrizione                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**GetBounds (D2D1 \_ Matrix \_ 3X2 \_ f&, D2D \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | Recupera i limiti della geometria.<br/> |
| [**GetBounds (D2D1 \_ Matrix \_ 3x2 \_ f \* , d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | Recupera i limiti della geometria.<br/> |



## <a name="examples"></a>Esempio

Nel codice seguente viene illustrato come utilizzare **GetBounds** per recuperare i limiti della geometria.
