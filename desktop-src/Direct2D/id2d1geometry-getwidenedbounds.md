...
---
# <a name="id2d1geometrygetwidenedbounds-methods"></a>Metodi ID2D1Geometry:: GetWidenedBounds
...
| Metodo                                                                                                                                                                                                 | Descrizione                                                                                                                                           |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f&, d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | Ottiene i limiti della geometria dopo che è stato ampliato in base alla larghezza e allo stile del tratto specificato e trasformato dalla matrice specificata.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f \* , d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | Ottiene i limiti della geometria dopo che è stato ampliato in base alla larghezza e allo stile del tratto specificato e trasformato dalla matrice specificata.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f&, float, d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | Ottiene i limiti della geometria dopo che è stato ampliato in base alla larghezza e allo stile del tratto specificato e trasformato dalla matrice specificata.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f \* , float, d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | Ottiene i limiti della geometria dopo che è stato ampliato in base alla larghezza e allo stile del tratto specificato e trasformato dalla matrice specificata.<br/> |



## <a name="examples"></a>Esempio

Il codice seguente illustra come usare **GetWidenedBounds** per recuperare i limiti della geometria dopo che è stato ampliato in base alla larghezza e allo stile del tratto specificato e trasformato dalla matrice specificata.
