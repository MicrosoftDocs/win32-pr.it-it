...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a><span data-ttu-id="a83fe-103">Esempi di provider WMI DNS-gestione dei record di risorse DNS</span><span class="sxs-lookup"><span data-stu-id="a83fe-103">DNS WMI Provider Samples—Managing DNS Resource Records</span></span>

<span data-ttu-id="a83fe-104">Questa sezione illustra le attività di scripting associate alla gestione dei record di risorse DNS.</span><span class="sxs-lookup"><span data-stu-id="a83fe-104">This section demonstrates scripting tasks associated with managing DNS resource records.</span></span> <span data-ttu-id="a83fe-105">I collegamenti seguenti consentono di passare alle subroutine nel file di script.</span><span class="sxs-lookup"><span data-stu-id="a83fe-105">The links below jump to subroutines in the script file.</span></span>

-   [<span data-ttu-id="a83fe-106">Elencare i record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-106">List resource records</span></span>](#list-resource-records)
-   [<span data-ttu-id="a83fe-107">Aggiungere un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-107">Add a resource record</span></span>](#add-a-resource-record)
-   [<span data-ttu-id="a83fe-108">Eliminare un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-108">Delete a resource record</span></span>](#delete-a-resource-record)
-   [<span data-ttu-id="a83fe-109">Modificare un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-109">Modify a resource record</span></span>](#modify-a-resource-record)
-   [<span data-ttu-id="a83fe-110">Connettersi al provider WMI DNS</span><span class="sxs-lookup"><span data-stu-id="a83fe-110">Connect to the DNS WMI Provider</span></span>](#connect-to-the-dns-wmi-provider)

<span data-ttu-id="a83fe-111">L'implementazione generale dello script è la seguente:</span><span class="sxs-lookup"><span data-stu-id="a83fe-111">The general implementation of the script is as follows:</span></span>

1.  <span data-ttu-id="a83fe-112">Viene creata una classe per ogni tipo di record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-112">A class is created for each resource record type.</span></span>
2.  <span data-ttu-id="a83fe-113">I dati dei record di risorse vengono forniti tramite gli input della riga di comando utente e le informazioni del provider WMI DNS per ogni classe del tipo di record.</span><span class="sxs-lookup"><span data-stu-id="a83fe-113">Resource record data is provided through user command-line inputs and DNS WMI Provider information for each record type class.</span></span>
3.  <span data-ttu-id="a83fe-114">Vengono create funzioni comuni quali List, DELETE e Modify, che possono essere usate nelle singole classi di tipi di record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-114">Common functions such as list, delete, and modify are created and can be used on individual resource record type classes.</span></span>

<span data-ttu-id="a83fe-115">Questo esempio di codice illustra le attività associate alla gestione dei record di risorse DNS.</span><span class="sxs-lookup"><span data-stu-id="a83fe-115">This code example shows tasks associated with Managing DNS resource records.</span></span>
...
## <a name="list-resource-records"></a><span data-ttu-id="a83fe-116">Elencare i record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-116">List Resource Records</span></span>

<span data-ttu-id="a83fe-117">Questo esempio di codice illustra le attività associate all'elenco dei record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-117">This code example shows tasks associated with listing resource records.</span></span>
...
## <a name="add-a-resource-record"></a><span data-ttu-id="a83fe-118">Aggiungere un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-118">Add a Resource Record</span></span>

<span data-ttu-id="a83fe-119">Questo esempio di codice illustra le attività associate all'aggiunta di record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-119">This code example shows tasks associated with adding resource records.</span></span>
...
## <a name="delete-a-resource-record"></a><span data-ttu-id="a83fe-120">Eliminare un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-120">Delete a Resource Record</span></span>

<span data-ttu-id="a83fe-121">In questo esempio di codice vengono illustrate le attività associate all'eliminazione di record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-121">This code example shows tasks associated with deleting resource records.</span></span>
...
## <a name="modify-a-resource-record"></a><span data-ttu-id="a83fe-122">Modificare un record di risorse</span><span class="sxs-lookup"><span data-stu-id="a83fe-122">Modify a Resource Record</span></span>

<span data-ttu-id="a83fe-123">Questo esempio di codice illustra le attività associate alla modifica dei record di risorse.</span><span class="sxs-lookup"><span data-stu-id="a83fe-123">This code example shows tasks associated with changing resource records.</span></span>
...
## <a name="connect-to-the-dns-wmi-provider"></a><span data-ttu-id="a83fe-124">Connettersi al provider WMI DNS</span><span class="sxs-lookup"><span data-stu-id="a83fe-124">Connect to the DNS WMI Provider</span></span>

<span data-ttu-id="a83fe-125">In questo esempio di codice vengono illustrate le attività associate alla connessione a un provider WMI DNS.</span><span class="sxs-lookup"><span data-stu-id="a83fe-125">This code example shows tasks associated with connecting to a DNS WMI Provider.</span></span>
