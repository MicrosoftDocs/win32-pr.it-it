...
I passaggi generali seguenti consentono di iniziare a creare uno script o un programma personalizzato che usa il provider WMI DNS.

**Per creare uno script o un programma utilizzando il provider WMI DNS**

1.  Connettersi al provider WMI DNS.
    ```VB
...
3.  A seconda dell'azione del tipo che si vuole eseguire, ottenere una zona DNS o un'istanza di record.
    ```VB
