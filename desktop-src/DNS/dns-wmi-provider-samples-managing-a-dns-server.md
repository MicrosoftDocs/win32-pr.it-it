...
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="2efaf-103">Esempi di provider WMI DNS-gestione di un server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="2efaf-104">Questo articolo contiene riferimenti al termine slave, che Microsoft non usa più.</span><span class="sxs-lookup"><span data-stu-id="2efaf-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="2efaf-105">Quando il termine verrà rimosso dal software, verrà rimosso anche dall'articolo.</span><span class="sxs-lookup"><span data-stu-id="2efaf-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="2efaf-106">In questa sezione vengono illustrate le attività di scripting associate alla gestione di un server DNS.</span><span class="sxs-lookup"><span data-stu-id="2efaf-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="2efaf-107">I collegamenti seguenti consentono di passare alle subroutine nel file script:</span><span class="sxs-lookup"><span data-stu-id="2efaf-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="2efaf-108">Elencare le proprietà del server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="2efaf-109">Arrestare, avviare o riavviare un server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="2efaf-110">Modificare le proprietà del server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="2efaf-111">Aggiungere un indirizzo IP</span><span class="sxs-lookup"><span data-stu-id="2efaf-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="2efaf-112">Eliminare un indirizzo IP</span><span class="sxs-lookup"><span data-stu-id="2efaf-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="2efaf-113">Elencare zone</span><span class="sxs-lookup"><span data-stu-id="2efaf-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="2efaf-114">Elencare le proprietà del server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="2efaf-115">Arrestare, avviare o riavviare un server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="2efaf-116">Modificare le proprietà del server DNS</span><span class="sxs-lookup"><span data-stu-id="2efaf-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="2efaf-117">Aggiungere un indirizzo IP</span><span class="sxs-lookup"><span data-stu-id="2efaf-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="2efaf-118">Eliminare un indirizzo IP</span><span class="sxs-lookup"><span data-stu-id="2efaf-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="2efaf-119">Elencare zone</span><span class="sxs-lookup"><span data-stu-id="2efaf-119">List Zones</span></span>
