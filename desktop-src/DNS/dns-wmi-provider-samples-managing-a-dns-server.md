...
-   [Modificare le proprietà del server DNS](#modify-dns-server-properties)
-   [Aggiungere un indirizzo IP](#add-an-ip-address)
-   [Eliminare un indirizzo IP](#delete-an-ip-address)
-   [Elencare zone](#list-zones)
...
## <a name="list-dns-server-properties"></a>Elencare le proprietà del server DNS
...
## <a name="stop-start-or-restart-a-dns-server"></a>Arrestare, avviare o riavviare un server DNS
...
## <a name="modify-dns-server-properties"></a>Modificare le proprietà del server DNS
...
## <a name="add-an-ip-address"></a>Aggiungere un indirizzo IP
...
## <a name="delete-an-ip-address"></a>Eliminare un indirizzo IP
...
## <a name="list-zones"></a>Elencare zone
