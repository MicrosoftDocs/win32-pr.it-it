...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_aaaatype-class"></a>Metodo CreateInstanceFromPropertyData della classe MicrosoftDNS \_ AAAAType

Il metodo **CreateInstanceFromPropertyData** crea un'istanza di un record di risorse di indirizzi IPv6 (aaaa).
