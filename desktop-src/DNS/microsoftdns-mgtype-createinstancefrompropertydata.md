...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_mgtype-class"></a>Metodo CreateInstanceFromPropertyData della classe MicrosoftDNS \_ MGType

Il metodo **CreateInstanceFromPropertyData** crea un'istanza di un record di risorse del gruppo di posta (mg).
