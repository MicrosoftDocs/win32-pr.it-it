...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="41d00-104">Esempi di provider WMI DNS-gestione di Zone DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="41d00-105">In questa sezione vengono illustrate le attività di scripting associate alla gestione delle zone DNS.</span><span class="sxs-lookup"><span data-stu-id="41d00-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="41d00-106">I collegamenti seguenti sono collegati a subroutine nel file di script.</span><span class="sxs-lookup"><span data-stu-id="41d00-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="41d00-107">Creare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="41d00-108">Modificare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="41d00-109">Eliminare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="41d00-110">Aggiungere un indirizzo IP di zona</span><span class="sxs-lookup"><span data-stu-id="41d00-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="41d00-111">Eliminare un indirizzo IP di zona</span><span class="sxs-lookup"><span data-stu-id="41d00-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="41d00-112">Sospendere una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="41d00-113">Riprendere una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="41d00-114">Aggiornare una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="41d00-115">Ricarica una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="41d00-116">Aggiornare una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="41d00-117">Creare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="41d00-118">Modificare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="41d00-119">Eliminare una zona DNS</span><span class="sxs-lookup"><span data-stu-id="41d00-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="41d00-120">Aggiungere un indirizzo IP di zona</span><span class="sxs-lookup"><span data-stu-id="41d00-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="41d00-121">Eliminare un indirizzo IP di zona</span><span class="sxs-lookup"><span data-stu-id="41d00-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="41d00-122">Sospendi una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="41d00-123">Riprendi una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="41d00-124">Aggiorna una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="41d00-125">Ricarica una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="41d00-126">Aggiorna una zona</span><span class="sxs-lookup"><span data-stu-id="41d00-126">Refresh a Zone</span></span>
