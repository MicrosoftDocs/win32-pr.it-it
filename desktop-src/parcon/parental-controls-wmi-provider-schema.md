...
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="4afb1-104">Schema del provider WMI per controlli padre</span><span class="sxs-lookup"><span data-stu-id="4afb1-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="4afb1-105">Il provider WMI dei controlli padre è un'istanza di e un provider di metodi.</span><span class="sxs-lookup"><span data-stu-id="4afb1-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="4afb1-106">La creazione di un'istanza di nuove istanze della classe, la lettura o la modifica delle proprietà dell'istanza esistente e la chiamata dei metodi sono controllate dal file Wpcsprov. mof.</span><span class="sxs-lookup"><span data-stu-id="4afb1-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="4afb1-107">La sintassi seguente è da namespace. mof</span><span class="sxs-lookup"><span data-stu-id="4afb1-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="4afb1-108">La sintassi seguente è da ratings. mof</span><span class="sxs-lookup"><span data-stu-id="4afb1-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="4afb1-109">La sintassi seguente è da WpcSettings. mof</span><span class="sxs-lookup"><span data-stu-id="4afb1-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="4afb1-110">La sintassi seguente è da WpcProvider. mof</span><span class="sxs-lookup"><span data-stu-id="4afb1-110">The following syntax is from WpcProvider.mof</span></span>
