...
Gli utenti che hanno distribuito un sito di Servizi UDDI da Windows Server 2003 o Windows Server 2008 possono scegliere di non aggiornare i server che eseguono Servizi UDDI a Windows Server 2008 R2. Possono anche spostare i servizi UDDI in caselle dedicate Windows Server 2003 o Windows Server 2008 se devono aggiornare le caselle di Servizi UDDI correnti.
