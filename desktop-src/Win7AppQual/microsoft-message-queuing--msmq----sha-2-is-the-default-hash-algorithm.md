...
-   MSMQ in Windows 7 non accetterà messaggi firmati provenienti da Windows 2008 o versioni inferiori

## <a name="mitigation"></a>Strategia di riduzione del rischio

Gli utenti devono prendere in considerazione l'aggiornamento Windows 7 per sfruttare l'algoritmo di firma più avanzato. Per consentire lo scambio di messaggi firmati senza problemi tra Windows 7 e qualsiasi sistema operativo di livello inferiore, l'amministratore deve aggiungere le eccezioni appropriate nei computer MSMQ.
