...
Microsoft Application Compatibility Toolkit (ACT) è uno strumento di gestione del ciclo di vita che consente di identificare e gestire l'intero portfolio di applicazioni, riducendo i costi e i tempi necessari per risolvere i problemi di compatibilità delle applicazioni e consentendo di distribuire rapidamente gli aggiornamenti Windows e Windows.
...
-   Valutare le distribuzioni del sistema operativo, l'impatto degli aggiornamenti del sistema operativo e la compatibilità con i siti Web
-   Gestire centralmente gli analizzatori di compatibilità e le impostazioni di configurazione
