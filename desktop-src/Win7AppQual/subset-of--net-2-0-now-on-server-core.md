...
L'opzione di installazione Server Core per Windows Server 2008 R2 include ora un subset del .NET Framework 2.0. Il subset è la funzionalità in .NET 2.0 allineata alla funzionalità in Server Core. Non sono stati aggiunti file binari alla base di Server Core per consentire il funzionamento di qualsiasi parte di .NET 2.0.

Non è stato disponibile alcun supporto .NET nell'opzione di installazione Server Core per Windows Server 2008.
