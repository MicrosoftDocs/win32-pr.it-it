...
---
# <a name="key-generation-encoded-asn1"></a>ASN codificato per la generazione di chiavi. 1

L'esempio seguente contiene una richiesta di generazione della chiave mostrata nel formato ASN. 1.
