---
description: L'esempio seguente contiene una richiesta di generazione della chiave mostrata nel formato ASN. 1.
ms.assetid: d08c33f8-f372-44d3-8c8e-a26440e85c34
title: ASN codificato per la generazione di chiavi. 1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106314148"
---
# <a name="key-generation-encoded-asn1"></a><span data-ttu-id="1958a-103">ASN codificato per la generazione di chiavi. 1</span><span class="sxs-lookup"><span data-stu-id="1958a-103">Key Generation Encoded ASN.1</span></span>

<span data-ttu-id="1958a-104">L'esempio seguente contiene una richiesta di generazione della chiave mostrata nel formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="1958a-104">The following example contains a key generation request shown in ASN.1 format.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1958a-105">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="1958a-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1958a-106">Richieste di esempio</span><span class="sxs-lookup"><span data-stu-id="1958a-106">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
