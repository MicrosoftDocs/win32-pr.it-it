---
description: L'esempio seguente contiene una richiesta di registrazione CMC per conto di (EOBO). L'esempio è stato generato utilizzando gli strumenti Certreq.exe e Certutil.exe. Il file con estensione inf utilizzato come input per Certreq.exe contiene la configurazione seguente.
ms.assetid: 05ec0b2c-56a5-4d9c-999b-23324134153b
title: Richiesta EOBO di CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103758069"
---
# <a name="cmc-eobo-request"></a>Richiesta EOBO di CMC

L'esempio seguente contiene una richiesta di registrazione CMC per conto di (EOBO). L'esempio è stato generato utilizzando gli strumenti Certreq.exe e Certutil.exe. Il file con estensione inf utilizzato come input per Certreq.exe contiene la configurazione seguente.
