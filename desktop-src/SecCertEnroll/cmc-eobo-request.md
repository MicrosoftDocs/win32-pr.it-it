...
---
# <a name="cmc-eobo-request"></a><span data-ttu-id="acce0-105">Richiesta EOBO di CMC</span><span class="sxs-lookup"><span data-stu-id="acce0-105">CMC EOBO Request</span></span>

<span data-ttu-id="acce0-106">L'esempio seguente contiene una richiesta di registrazione CMC per conto di (EOBO).</span><span class="sxs-lookup"><span data-stu-id="acce0-106">The following example contains a CMC Enroll On Behalf Of (EOBO) request.</span></span> <span data-ttu-id="acce0-107">L'esempio è stato generato utilizzando gli strumenti Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="acce0-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="acce0-108">Il file con estensione inf utilizzato come input per Certreq.exe contiene la configurazione seguente.</span><span class="sxs-lookup"><span data-stu-id="acce0-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="acce0-109">Questa configurazione genera l'output di esempio seguente.</span><span class="sxs-lookup"><span data-stu-id="acce0-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="acce0-110">La configurazione specifica il tipo di richiesta (CMC), il nome dell'entità che richiede la registrazione e il nome del modello.</span><span class="sxs-lookup"><span data-stu-id="acce0-110">The configuration specifies the type of request (CMC), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="acce0-111">Il modello utente specifica che:</span><span class="sxs-lookup"><span data-stu-id="acce0-111">The User template specifies that:</span></span>

-   <span data-ttu-id="acce0-112">La richiesta deve usare il provider di crittografia di base Microsoft 1,0 o Microsoft Enhanced Cryptographic Provider 1,0.</span><span class="sxs-lookup"><span data-stu-id="acce0-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="acce0-113">Il nome del soggetto deve essere compilato da Active Directory.</span><span class="sxs-lookup"><span data-stu-id="acce0-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="acce0-114">La richiesta include il nome del modello di certificato, l'utilizzo chiavi avanzato (EKU) e le estensioni per l'utilizzo delle chiavi.</span><span class="sxs-lookup"><span data-stu-id="acce0-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="acce0-115">L'estensione EKU specifica che il certificato emesso può essere usato per Encrypting File System (EFS), per la posta elettronica sicura e per l'autenticazione client.</span><span class="sxs-lookup"><span data-stu-id="acce0-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="acce0-116">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="acce0-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="acce0-117">Richieste di esempio</span><span class="sxs-lookup"><span data-stu-id="acce0-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
