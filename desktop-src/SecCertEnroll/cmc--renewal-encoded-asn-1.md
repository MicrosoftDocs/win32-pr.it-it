...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="831cb-105">ASN con codifica del rinnovo CMC. 1</span><span class="sxs-lookup"><span data-stu-id="831cb-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="831cb-106">L'esempio seguente contiene una richiesta di rinnovo CMC mostrata in formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="831cb-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="831cb-107">L'esempio è stato generato utilizzando gli strumenti Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="831cb-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="831cb-108">Il file con estensione inf utilizzato come input per Certreq.exe contiene la configurazione seguente.</span><span class="sxs-lookup"><span data-stu-id="831cb-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="831cb-109">La configurazione specifica il tipo di richiesta (CMC) e il numero di serie del certificato su cui è basata la richiesta.</span><span class="sxs-lookup"><span data-stu-id="831cb-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="831cb-110">Viene generato l'output seguente.</span><span class="sxs-lookup"><span data-stu-id="831cb-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="831cb-111">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="831cb-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="831cb-112">Richieste di esempio</span><span class="sxs-lookup"><span data-stu-id="831cb-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
