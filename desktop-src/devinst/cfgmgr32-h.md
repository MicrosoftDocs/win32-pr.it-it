...
<td>La <strong>CM_Add_ID</strong> accoda un <a href="/windows-hardware/drivers/install/device-ids">ID</a> dispositivo specificato (se non è già presente) all'elenco di <a href="/windows-hardware/drivers/install/hardware-ids">ID hardware</a> o <a href="/windows-hardware/drivers/">all'elenco</a> di ID compatibili di un'istanza <a href="/windows-hardware/drivers/install/compatible-ids">del</a> dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Add_Res_Des_Ex</strong> seguente aggiunge un <a href="/windows-hardware/drivers/">descrittore di risorse</a> a una configurazione <a href="/windows-hardware/drivers/kernel/hardware-resources">logica</a>. La configurazione logica può essere nel computer locale o in un computer remoto.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Free_Log_Conf</strong> rimuove una <a href="/windows-hardware/drivers/kernel/hardware-resources">configurazione logica e</a> tutti i <a href="/windows-hardware/drivers/">descrittori di risorse</a> associati dal computer locale.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Free_Log_Conf_Ex</strong> rimuove una configurazione logica <a href="/windows-hardware/drivers/kernel/hardware-resources">e</a> tutti i descrittori di <a href="/windows-hardware/drivers/">risorse</a> associati da un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Class_Property_Keys_Ex</strong> funzione recupera una matrice delle chiavi delle proprietà del dispositivo che rappresentano le proprietà del dispositivo impostate per una classe di <a href="/windows-hardware/drivers/install/device-interface-classes">interfaccia</a> del dispositivo o una classe di configurazione <a href="/windows-hardware/drivers/install/device-setup-classes">del dispositivo.</a><br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Device_ID_Ex</strong> funzione recupera l'ID <a href="/windows-hardware/drivers/install/device-instance-ids">istanza del</a> dispositivo per un'istanza di <a href="/windows-hardware/drivers/">dispositivo</a> specificata in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_device_id_lista"><strong>CM_Get_Device_ID_List</strong></a><br/></td>
<td>La <strong>CM_Get_Device_ID_List</strong> funzione recupera un elenco <a href="/windows-hardware/drivers/install/device-instance-ids">di</a> ID istanza del dispositivo per le istanze del dispositivo del computer <a href="/windows-hardware/drivers/">locale.</a><br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Device_ID_List_Ex</strong> recupera un elenco <a href="/windows-hardware/drivers/install/device-instance-ids"></a> di ID istanza del dispositivo per le istanze <a href="/windows-hardware/drivers/">del</a> dispositivo in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Device_ID_List_Size_Ex</strong> recupera le dimensioni del buffer necessarie <a href="/windows-hardware/drivers/install/device-instance-ids"></a> per contenere un elenco di ID istanza del dispositivo per le istanze del dispositivo di un computer <a href="/windows-hardware/drivers/">locale o remoto.</a><br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Get_Device_Interface_List_Size</strong> recupera le dimensioni del buffer che devono essere passate alla CM_Get_Device_Interface_List <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_device_interface_lista"><strong>funzione.</strong></a><br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Get_DevNode_Property_Keys</strong> recupera una matrice di chiavi di proprietà del dispositivo che rappresentano le proprietà del dispositivo impostate per un'istanza del dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_DevNode_Property_Keys_Ex</strong> recupera una matrice di chiavi di proprietà del dispositivo che rappresentano le proprietà del dispositivo impostate per un'istanza del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_DevNode_Status_Ex</strong> funzione ottiene lo stato di un'istanza del dispositivo dal relativo nodo del dispositivo (<a href="/windows-hardware/drivers/">devnode</a>) in un albero dei dispositivi locale o di un computer <a href="/windows-hardware/drivers/kernel/device-tree">remoto.</a><br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_HW_Prof_Flags</strong> funzione recupera i <a href="/windows-hardware/drivers/">flag</a>di configurazione specifici del profilo hardware per un'istanza <a href="/windows-hardware/drivers/">del</a> dispositivo in un computer locale.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Next_Log_Conf_Ex</strong> ottiene la configurazione logica <a href="/windows-hardware/drivers/kernel/hardware-resources">successiva</a> associata a un'istanza di <a href="/windows-hardware/drivers/">dispositivo specifica</a> in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_res_des"><strong>CM_Get_Next_Res_Des</strong></a><br/></td>
<td>La <strong>CM_Get_Next_Res_Des</strong> ottiene un handle per il descrittore di risorsa successivo <a href="/windows-hardware/drivers/">,</a>di un tipo di risorsa specificato, per una configurazione <a href="/windows-hardware/drivers/kernel/hardware-resources">logica</a> nel computer locale.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Next_Res_Des_Ex</strong> ottiene un handle per il descrittore di risorsa successivo <a href="/windows-hardware/drivers/">,</a> <a href="/windows-hardware/drivers/kernel/hardware-resources"></a> di un tipo di risorsa specificato, per una configurazione logica in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Parent_Ex</strong> ottiene un handle di istanza del dispositivo per il nodo padre di un nodo di dispositivo specificato (<a href="/windows-hardware/drivers/">devnode</a>) in un albero dei dispositivi locale o di un computer <a href="/windows-hardware/drivers/kernel/device-tree">remoto.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_res_des_data"><strong>CM_Get_Res_Des_Data</strong></a><br/></td>
<td>La <strong>CM_Get_Res_Des_Data</strong> recupera le informazioni archiviate in un descrittore <a href="/windows-hardware/drivers/">di risorsa</a> nel computer locale.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Res_Des_Data_Ex</strong> recupera le informazioni archiviate in un descrittore di <a href="/windows-hardware/drivers/">risorsa</a> in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Get_Res_Des_Data_Size</strong> ottiene le dimensioni del buffer necessarie per contenere le informazioni contenute in un descrittore di <a href="/windows-hardware/drivers/">risorsa</a> specificato nel computer locale.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Res_Des_Data_Size_Ex</strong> ottiene le dimensioni del buffer necessarie per contenere le informazioni contenute in un descrittore di risorsa specificato <a href="/windows-hardware/drivers/">in</a> un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>funzione CM_Get_Resource_Conflict_Count</strong> ottiene il numero di conflitti contenuti in un elenco di conflitti di risorse specificato.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Get_Sibling</strong> ottiene un handle di istanza del dispositivo al nodo di pari livello successivo di un nodo di dispositivo specificato (<a href="/windows-hardware/drivers/">devnode</a>) nell'albero dei dispositivi <a href="/windows-hardware/drivers/kernel/device-tree">del computer locale.</a><br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Sibling_Ex</strong> ottiene un handle di istanza del dispositivo al nodo di pari livello successivo di un nodo di dispositivo specificato, in un albero dei dispositivi locale o <a href="/windows-hardware/drivers/kernel/device-tree">remoto.</a><br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Version</strong> restituisce la versione 4.0 della <a href="/windows-hardware/drivers/">DLL</a> Plug and Play (PnP) Gestione configurazione (<em>Cfgmgr32.dll</em>) per un computer locale. <br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Is_Version_Available</strong> funzione indica se una versione specificata della <a href="/windows-hardware/drivers/">DLL</a> Plug and Play (PnP) Gestione configurazione (<em>Cfgmgr32.dll</em>) è supportata da un computer locale.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Modify_Res_Des</strong> modifica un descrittore di risorsa specificato nel computer locale.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Modify_Res_Des_Ex</strong> modifica un descrittore di risorsa specificato in un computer locale o remoto.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Open_Class_Key</strong> funzione apre la chiave del Registro di sistema della classe di configurazione del dispositivo, la chiave del Registro di sistema della classe dell'interfaccia del dispositivo o una sottochiave specifica di una classe.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Open_Device_Interface_Key_ExA</strong> apre la sottochiave del Registro di sistema usata dalle applicazioni e dai driver per archiviare informazioni specifiche di un'interfaccia del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Query_And_Remove_SubTree</strong> verifica se un'istanza del dispositivo e i relativi elementi figlio possono essere rimossi e, in tal caso, li rimuove.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Query_And_Remove_SubTree_Ex</strong> verifica se un'istanza del dispositivo e i relativi elementi figlio possono essere rimossi e, in tal caso, le rimuove.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Query_Resource_Conflict_List</strong> identifica le istanze del dispositivo con requisiti di risorsa che sono in conflitto con la descrizione della risorsa di un'istanza del dispositivo specificata.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_reenumerate_devnode"><strong>CM_Reenumerate_DevNode</strong></a><br/></td>
<td>La <strong>CM_Reenumerate_DevNode</strong> enumera i dispositivi identificati da un nodo di dispositivo specificato e da tutti i relativi elementi figlio.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Request_Device_Eject</strong> prepara un'istanza del dispositivo locale per la rimozione sicura, se il dispositivo è rimovibile. Se il dispositivo può essere espulso fisicamente, lo sarà.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Request_Device_Eject_Ex</strong> prepara un'istanza locale o remota del dispositivo per la rimozione sicura, se il dispositivo è rimovibile. Se il dispositivo può essere espulso fisicamente, lo sarà.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Set_Class_Property_ExW</strong> funzione imposta una proprietà di classe per una classe di configurazione del dispositivo o una classe di interfaccia del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Set_Device_Interface_Property</strong> imposta una proprietà del dispositivo di un'interfaccia del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Set_Device_Interface_Property_ExW</strong> funzione imposta una proprietà del dispositivo di un'interfaccia del dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Set_DevNode_Problem_Ex</strong> imposta un codice di problema per un dispositivo installato in un computer locale o remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Set_DevNode_Property</strong> imposta una proprietà dell'istanza del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La CONFLICT_DETAILS viene usata come parametro per la <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_resource_conflict_detailsw"><strong>CM_Get_Resource_Conflict_Details</strong></a> funzione.<br/></td>
</tr>
<tr class="odd">
...
<td>La CS_RESOURCE struttura viene usata per specificare un elenco di risorse che descrive l'utilizzo delle risorse specifiche della classe del dispositivo per un'istanza del dispositivo. Per altre informazioni sugli elenchi di risorse, vedere <a href="/windows-hardware/drivers/kernel/hardware-resources">Risorse hardware</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La IRQ_RANGE specifica un elenco di requisiti delle risorse che descrive l'utilizzo della linea IRQ per un'istanza del dispositivo. Per altre informazioni sugli elenchi dei requisiti delle risorse, vedere <a href="/windows-hardware/drivers/kernel/hardware-resources">Risorse hardware</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La MFCARD_DES viene usata per specificare un elenco di risorse o un elenco <em></em> di requisiti delle risorse che descrive l'utilizzo delle risorse da parte di una delle funzioni hardware fornite da un'istanza di un dispositivo multifunzione. Per altre informazioni sugli elenchi di risorse e sui requisiti delle risorse, vedere <a href="/windows-hardware/drivers/kernel/hardware-resources">Risorse hardware.</a><br/></td>
</tr>
<tr class="even">
...
<td>La PCCARD_RESOURCE viene usata per specificare un elenco di risorse o un elenco di requisiti delle risorse che descrive l'utilizzo delle risorse da parte di un'PC Card istanza. Per altre informazioni sugli elenchi di risorse e sui requisiti delle risorse, vedere <a href="/windows-hardware/drivers/kernel/hardware-resources">Risorse hardware.</a><br/></td>
</tr>
</tbody>
</table>
