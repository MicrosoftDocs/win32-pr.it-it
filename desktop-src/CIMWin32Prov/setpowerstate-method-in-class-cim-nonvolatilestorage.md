...
---
# <a name="setpowerstate-method-of-the-cim_nonvolatilestorage-class"></a>Metodo SetPowerState della classe CIM \_ NonVolatileStorage
...
[\_NONVOLATILESTORAGE CIM](setpowerstate-method-in-class-cim-nonvolatilestorage.md)
</dt> <dt>
