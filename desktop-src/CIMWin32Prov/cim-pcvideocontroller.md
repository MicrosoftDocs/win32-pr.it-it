---
description: CIM PCVideoController rappresenta le funzionalità e la gestione di un \_ controller video personal computer, un sottotipo di un controller video.
ms.assetid: bf937727-a332-445b-9397-7d87d58c4a5b
ms.tgt_platform: multiple
title: CIM_PCVideoController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118678645"
---
# <a name="cim_pcvideocontroller-class"></a>Classe CIM \_ PCVideoController

**CIM \_ PCVideoController rappresenta** le funzionalità e la gestione di un controller video personal computer, un sottotipo di un controller video.
...
La **classe CIM \_ PCVideoController** ha questi tipi di membri:
...
La **classe CIM \_ PCVideoController** include questi metodi.



| Metodo                                                                       | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcvideocontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ PCVideoController** ha queste proprietà.
...
Qualificatori: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Grafica e funzionalità 3D del controller video.

Questa proprietà viene ereditata da [**CIM \_ VideoController.**](cim-videocontroller.md)
...
<span id="Graphics_Accelerator"></span><span id="graphics_accelerator"></span><span id="GRAPHICS_ACCELERATOR"></span>**Acceleratore di grafica** (2)
...
<span id="3D_Accelerator"></span><span id="3d_accelerator"></span><span id="3D_ACCELERATOR"></span>**Acceleratore 3D** (3)
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Stringhe in formato libero che forniscono spiegazioni dettagliate per le funzionalità dell'acceleratore video indicate nella matrice **AcceleratorCapabilities.**

> [!Note]  
> Ogni voce di matrice è correlata alla voce nella matrice **AcceleratorCapabilities** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.12"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bits")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.11"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixel")
</dt> </dl>
...
Numero di colori supportati nelle risoluzioni correnti.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.14")
</dt> </dl>

Se in modalità carattere, numero di colonne per il controller video; In caso contrario, immettere 0.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.13")
</dt> </dl>

Se in modalità carattere, numero di righe per questo controller video; In caso contrario, immettere 0.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.15"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.8")
</dt> </dl>

Modalità di analisi corrente. Questa proprietà viene ereditata da [**CIM \_ VideoController.**](cim-videocontroller.md)
...
<span id="Interlaced"></span><span id="interlaced"></span><span id="INTERLACED"></span>**Interlacciato** (3)
...
<span id="Non_Interlaced"></span><span id="non_interlaced"></span><span id="NON_INTERLACED"></span>**Non interlacciato** (4)
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.10"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixels")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Bus Port \| 001.9")
</dt> </dl>

Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto o illimitato, deve essere usato il valore 0.

Questa proprietà viene ereditata dal [**\_ controller CIM.**](cim-controller.md)
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.5"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>

Frequenza di aggiornamento massima del controller video in hertz.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.4"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>

Frequenza di aggiornamento minima del controller video in hertz.
...
Numero corrente di piani di colore. Se questo valore non è applicabile per la configurazione video corrente, immettere 0.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) può essere richiamato con il parametro *PowerState* impostato su 5 (Ciclo di alimentazione) e *time* impostato su una data e un'ora o un intervallo specifici per l'accensione.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Bus Port \| 001.2", "MIF. DMTF \| Disks \| 003.3")
</dt> </dl>

Protocollo usato dal controller per accedere ai dispositivi "controllati".

Questa proprietà viene ereditata dal [**\_ controller CIM.**](cim-controller.md) I valori possibili sono:
...
**TWIRP (a raggi infrarossi bidirevi)** (44)
...
**FIR (veloce a raggi infrarossi)** (45)
...
**SIR (seriale a raggi infrarossi)** (46)
...
Data e ora dell'ultima reimpostazione del controller, ovvero il controller è stato spento o reinizializzato.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.2")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.6")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.3")
</dt> </dl>
...
Stringa in formato libero che descrive il processore/controller video.
...
La **classe CIM \_ PCVideoController** è derivata da [**CIM \_ VideoController**](cim-videocontroller.md).

WMI non implementa questa classe. Per le classi WMI derivate [**da CIM \_ PCVideoController,**](cim-videocontroller.md)vedere [Classi Win32](win32-provider.md).
