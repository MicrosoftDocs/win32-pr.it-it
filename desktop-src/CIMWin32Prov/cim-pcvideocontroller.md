...
---
# <a name="cim_pcvideocontroller-class"></a>CIM \_ PCVideoController (classe)

Il **\_ PCVideoController CIM** rappresenta le funzionalità e la gestione di un personal computer controller video, un sottotipo di un controller video.
...
La classe **CIM \_ PCVideoController** presenta questi tipi di membri:
...
La classe **CIM \_ PCVideoController** presenta questi metodi.



| Metodo                                                                       | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcvideocontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ PCVideoController** dispone di queste proprietà.
...
<span id="Graphics_Accelerator"></span><span id="graphics_accelerator"></span><span id="GRAPHICS_ACCELERATOR"></span>**Acceleratore grafico** (2)
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Stringhe in formato libero che forniscono spiegazioni dettagliate per le funzionalità di accelerazione video indicate nella matrice **AcceleratorCapabilities** .

> [!Note]  
> Ogni voce della matrice è correlata alla voce nella matrice **AcceleratorCapabilities** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003,12 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits ")
</dt> </dl>
...
Numero di colori supportati per le risoluzioni correnti.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,14 ")
</dt> </dl>

Se è in modalità carattere, numero di colonne per il controller video; in caso contrario, immettere 0.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,13 ")
</dt> </dl>

Se è in modalità carattere, numero di righe per il controller video; in caso contrario, immettere 0.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003,15 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,8 ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003,10 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" pixel ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Porta bus DMTF \| 001,9 ")
</dt> </dl>

Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto o illimitato, è necessario utilizzare il valore 0.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003,5 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003,4 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Porta bus DMTF \| 001,2 "," MIF. \|Dischi DMTF \| 003,3 ")
</dt> </dl>
...
Data e ora dell'ultima reimpostazione del controller che indica che il controller è stato spento o reinizializzato.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,2 ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,6 ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Video di DMTF \| \| 003,3 ")
</dt> </dl>
...
WMI non implementa questa classe. Per le classi WMI derivate da [**CIM \_ PCVideoController**](cim-videocontroller.md), vedere [Win32 Classes](win32-provider.md).
