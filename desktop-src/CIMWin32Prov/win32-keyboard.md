...
---
# <a name="win32_keyboard-class"></a>\_Classe della tastiera Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) della **\_ tastiera Win32** rappresenta una tastiera installata in un computer che esegue Windows.
...
La classe della **\_ tastiera Win32** presenta questi tipi di membri:
...
La classe della **\_ tastiera Win32** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) nella [**\_ tastiera CIM**](cim-keyboard.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nella [**\_ tastiera CIM**](cim-keyboard.md) per la documentazione.<br/> |
...
La classe della **\_ tastiera Win32** dispone di queste proprietà.
...
Questa proprietà viene ereditata [**dalla \_ tastiera CIM**](cim-keyboard.md).
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sicurezza hardware del sistema DMTF \| 001,2 ")
</dt> </dl>

Stato della password a livello hardware abilitato sulla tastiera (valore = 4), che impedisce l'input locale.
...
La classe della **\_ tastiera Win32** è derivata [**dalla \_ tastiera CIM**](cim-keyboard.md).

## <a name="examples"></a>Esempio

Il codice di PowerShell seguente consente di trovare una tastiera e un mouse senza fili.
...
Nell'esempio VBScript seguente sono elencate le proprietà della tastiera.
