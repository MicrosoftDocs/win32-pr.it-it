---
description: La classe WMI Tastiera Win32 \_ rappresenta una tastiera installata in un computer che esegue Windows.
ms.assetid: f42a8e4f-3db9-4f9a-88ca-336ec883e85b
ms.tgt_platform: multiple
title: Win32_Keyboard classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119878641"
---
# <a name="win32_keyboard-class"></a>Classe Keyboard Win32 \_

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Tastiera Win32** rappresenta una tastiera installata in un computer che esegue Windows.
...
La **classe \_ Tastiera Win32** ha questi tipi di membri:
...
La **classe \_ Tastiera Win32** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) nella [**tastiera CIM \_ per**](cim-keyboard.md) la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nella [**tastiera CIM \_**](cim-keyboard.md) per la documentazione.<br/> |
...
La **classe Win32 \_ Keyboard** ha queste proprietà.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceId"), [**Chiave**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Altre informazioni sull'errore registrato in **LastErrorCode** e sulle azioni correttive che possono essere eseguite.
...
Stringa in formato libero che indica il layout della tastiera.

Questa proprietà viene ereditata dalla [**tastiera CIM. \_**](cim-keyboard.md)
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| System Hardware Security \| 001.2")
</dt> </dl>

Stato della password a livello di hardware abilitata sulla tastiera (valore=4), impedendo l'input locale.
...
La **classe \_ Tastiera Win32** è derivata dalla [**tastiera \_ CIM.**](cim-keyboard.md)

## <a name="examples"></a>Esempio

Il codice di PowerShell seguente trova una tastiera e un mouse wireless.
...
L'esempio DI VBScript seguente elenca le proprietà della tastiera.
