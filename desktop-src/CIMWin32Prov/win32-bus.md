...
---
# <a name="win32_bus-class"></a>\_Classe bus Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) del **\_ bus Win32** rappresenta un bus fisico come visualizzato da un computer che esegue un sistema operativo Windows. Qualsiasi istanza di un bus di Windows è un discendente (o membro) di questa classe.
...
La **classe \_ bus Win32** presenta questi tipi di membri:
...
La **classe \_ bus Win32** presenta questi metodi.
...
La **classe \_ bus Win32** dispone di queste proprietà.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| \| tipo interfaccia Win32API cHwRes \_ ")
</dt> </dl>

Tipo di bus fisico. Questo valore sarà uno dei valori nell'enumerazione del **\_ tipo di interfaccia** definita in bus. h.
...
**Tipo di interfaccia massima** (16)
...
La **classe \_ bus Win32** è derivata da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
