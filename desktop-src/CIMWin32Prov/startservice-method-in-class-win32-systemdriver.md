...
---
# <a name="startservice-method-of-the-win32_systemdriver-class"></a>Metodo StartService della \_ classe SystemDriver Win32

Il metodo **StartService** tenta di collocare il servizio gestito dal driver di sistema nello stato di avvio.
