...
La classe **CIM \_ StorageExtent** presenta questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-storageextent.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ StorageExtent**, vedere [Win32 Classes](win32-provider.md).
