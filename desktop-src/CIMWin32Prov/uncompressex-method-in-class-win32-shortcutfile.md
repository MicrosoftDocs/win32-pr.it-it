...
---
# <a name="uncompressex-method-of-the-win32_shortcutfile-class"></a>Metodo UncompressEx della \_ classe ShortcutFile Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **UncompressEx** decomprime il file di collegamento logico o la directory specificata nel percorso dell'oggetto. Questo metodo è una versione estesa del metodo [**Decompress**](uncompress-method-in-class-win32-directory.md) .
