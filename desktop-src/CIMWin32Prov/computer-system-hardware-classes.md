---
description: La categoria Computer System Hardware raggruppa le classi che rappresentano oggetti correlati all'hardware. Ad esempio dispositivi di input, dischi rigidi, schede di espansione, dispositivi video, dispositivi di rete e alimentazione del sistema.
ms.assetid: 0b6cb410-166e-45cd-8dca-77a111b3cf62
ms.tgt_platform: multiple
title: Classi hardware del sistema informatico
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
---
# <a name="computer-system-hardware-classes"></a>Classi hardware del sistema informatico

La categoria Computer System Hardware raggruppa le classi che rappresentano oggetti correlati all'hardware. Ad esempio dispositivi di input, dischi rigidi, schede di espansione, dispositivi video, dispositivi di rete e alimentazione del sistema.

-   [Classi di dispositivi di raffreddamento](#cooling-device-classes)
-   [Classi di dispositivo di input](#input-device-classes)
-   [Classi di Archiviazione di massa](#mass-storage-classes)
-   [Classi di scheda madre, controller e porta](#motherboard-controller-and-port-classes)
...
La sottocategoria Dispositivi di raffreddamento raggruppa le classi che rappresentano ventole instrumentabili, probe di temperatura e dispositivi refrigeranti.



| Classe                                                     | Descrizione                                                                 |
|-----------------------------------------------------------|-----------------------------------------------------------------------------|
| [**Ventola \_ Win32**](win32-fan.md)                           | Rappresenta le proprietà di un dispositivo a ventola nel sistema del computer.           |
| [**Win32 \_ HeatPipe**](win32-heatpipe.md)                 | Rappresenta le proprietà di un dispositivo di raffreddamento della pipe termica.                    |
| [**Refrigerazione Win32 \_**](win32-refrigeration.md)       | Rappresenta le proprietà di un dispositivo refrigerante.                        |
...
## <a name="input-device-classes"></a>Classi di dispositivo di input
...
| [**Win32 \_ PointingDevice**](win32-pointingdevice.md) | Rappresenta un dispositivo di input utilizzato per puntare e selezionare aree sulla visualizzazione di un computer che esegue Windows. |
...
| [**Win32 \_ CDROMDrive**](win32-cdromdrive.md)             | Rappresenta un'unità CD-ROM in un computer che esegue Windows.                              |
| [**Win32 \_ DiskDrive**](win32-diskdrive.md)               | Rappresenta un'unità disco fisica come vista da un computer che esegue il Windows sistema operativo. |
...
## <a name="motherboard-controller-and-port-classes"></a>Classi di scheda madre, controller e porta
...
| [**AllocatResource Win32 \_**](win32-allocatedresource.md)                 | Correla un dispositivo logico a una risorsa di sistema.<br/>                                                                                                                                                                 |
...
| [**Win32 \_ BIOS**](win32-bios.md)                                           | Rappresenta gli attributi dei servizi di input o output (BIOS) di base del sistema di computer installati nel computer.<br/>                                                                                   |
| [**Win32 \_ Bus**](win32-bus.md)                                             | Rappresenta un bus fisico come visualizzato da un Windows operativo.<br/>                                                                                                                                               |
| [**Win32 \_ CacheMemory**](win32-cachememory.md)                             | Rappresenta la memoria cache (interna ed esterna) in un sistema di computer.<br/>                                                                                                                                          |
| [**Controller \_ Win32HasHub**](/previous-versions/windows/desktop/cimwin32a/win32-controllerhashub)             | Rappresenta gli hub a valle dal controller USB (Universal Serial Bus).<br/>                                                                                                                                 |
| [**Win32 \_ DeviceBus**](win32-devicebus.md)                                 | Mette in relazione un bus di sistema e un dispositivo logico usando il bus.<br/>                                                                                                                                                       |
| [**Win32 \_ DeviceMemoryAddress**](win32-devicememoryaddress.md)             | Rappresenta un indirizzo di memoria del dispositivo in un Windows sistema.<br/>                                                                                                                                                        |
| [**Win32 \_ DeviceSettings**](win32-devicesettings.md)                       | Mette in relazione un dispositivo logico e un'impostazione che può essere applicata.<br/>                                                                                                                                              |
...
| [**Win32 \_ FloppyController**](win32-floppycontroller.md)                   | Rappresenta le funzionalità e la capacità di gestione di un controller di unità disco floppy.<br/>                                                                                                                         |
...
| [**Dispositivo a \_ raggi a raggi raggi win32**](win32-infrareddevice.md)                       | Rappresenta le funzionalità e la gestione di un dispositivo a raggi infrarossi.<br/>                                                                                                                                              |
| [**Win32 \_ IRQResource**](win32-irqresource.md)                             | Rappresenta un numero IRQ (Interrupt Request Line) in un Windows computer.<br/>                                                                                                                                |
| [**Win32 \_ MemoryArray**](win32-memoryarray.md)                             | Rappresenta le proprietà della matrice di memoria di sistema del computer e degli indirizzi mappati.<br/>                                                                                                                            |
| [**Win32 \_ MemoryArrayLocation**](win32-memoryarraylocation.md)             | Mette in relazione una matrice di memoria logica e la matrice di memoria fisica su cui si trova.<br/>                                                                                                                             |
| [**Win32 \_ MemoryDevice**](win32-memorydevice.md)                           | Rappresenta le proprietà del dispositivo di memoria di un sistema computer insieme agli indirizzi mappati associati.<br/>                                                                                                     |
| [**Win32 \_ MemoryDeviceArray**](win32-memorydevicearray.md)                 | Mette in relazione un dispositivo di memoria e la matrice di memoria in cui si trova.<br/>                                                                                                                                              |
| [**Win32 \_ MemoryDeviceLocation**](win32-memorydevicelocation.md)           | Classe di associazione che mette in relazione un dispositivo di memoria e la memoria fisica in cui si trova.<br/>                                                                                                                     |
| [**Scheda madre \_ Win32Device**](win32-motherboarddevice.md)                 | Rappresenta un dispositivo che contiene i componenti centrali del sistema computer che esegue Windows.<br/>                                                                                                               |
...
| [**Memoria fisica Win32 \_**](win32-physicalmemory.md)                       | Rappresenta un dispositivo di memoria fisica che si trova in un computer come disponibile per il sistema operativo.<br/>                                                                                                                |
| [**Win32 \_ PhysicalMemoryArray**](win32-physicalmemoryarray.md)             | Rappresenta i dettagli sulla memoria fisica del sistema del computer.<br/>                                                                                                                                                |
| [**Win32 \_ PhysicalMemoryLocation**](win32-physicalmemorylocation.md)       | Mette in relazione una matrice di memoria fisica e la relativa memoria fisica.<br/>                                                                                                                                                   |
...
| [**Dispositivo PNP Win32 \_**](win32-pnpdevice.md)                                 | Mette in relazione un dispositivo (noto Gestione configurazione come PNPEntity) e la funzione che esegue.<br/>                                                                                                                |
...
| [**Win32 \_ SerialPortConfiguration**](win32-serialportconfiguration.md)     | Rappresenta le impostazioni per la trasmissione dei dati su una Windows seriale.<br/>                                                                                                                                        |
...
| [**Win32 \_ SystemDriverPNPEntity**](win32-systemdriverpnpentity.md)         | Mette in relazione Plug and Play dispositivo nel Windows computer e il driver che supporta il Plug and Play dispositivo.<br/>                                                                                           |
| [**Win32 \_ SystemEnclosure**](win32-systemenclosure.md)                     | Rappresenta le proprietà associate a un enclosure di sistema fisico.<br/>                                                                                                                                         |
...
| [**Win32 \_ SystemSlot**](win32-systemslot.md)                               | Rappresenta i punti di connessione fisici, tra cui porte, slot e periferiche della scheda madre e punti di connessione proprietari.<br/>                                                                                  |
...
La sottocategoria Dispositivi di rete raggruppa le classi che rappresentano il controller dell'interfaccia di rete, le relative configurazioni e le relative impostazioni.
...
| [**Win32 \_ NetworkAdapterConfiguration**](win32-networkadapterconfiguration.md) | Rappresenta gli attributi e i comportamenti di una scheda di rete. Non è garantito che la classe sia supportata dopo l'applicazione della specifica di rete CIM dmtf (Distributed Management Task Force).<br/> |
...
| Classe                                                             | Descrizione                                                                                           |
|-------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| [**Batteria \_ Win32**](win32-battery.md)                           | Rappresenta una batteria connessa al sistema del computer.<br/>                                     |
| [**Win32 \_ CurrentProbe**](win32-currentprobe.md)                 | Rappresenta le proprietà di un sensore di monitoraggio corrente (ammeter).<br/>                        |
| [**Portabile \_ Win32Battery**](win32-portablebattery.md)           | Rappresenta le proprietà di una batteria portatile, ad esempio quella usata per un computer notebook.<br/> |
| [**Win32 \_ PowerManagementEvent**](win32-powermanagementevent.md) | Rappresenta gli eventi di risparmio energia risultanti dalle modifiche dello stato di alimentazione.<br/>                     |
| [**Win32 \_ VoltageProbe**](win32-voltageprobe.md)                 | Rappresenta le proprietà di un sensore di tensione (voltmetro elettronico).<br/>                      |
...
| [**Stampante \_ Win32**](win32-printer.md)                           | Rappresenta un dispositivo connesso a un sistema di computer Windows in grado di riprodurre un'immagine visiva su un supporto.<br/> |
| [**Win32 \_ PrinterConfiguration**](win32-printerconfiguration.md) | Definisce la configurazione per un dispositivo stampante.<br/>                                                                               |
...
| [**Win32 \_ PrinterDriver**](win32-printerdriver.md)               | Rappresenta i driver per [**un'istanza della stampante Win32. \_**](win32-printer.md)<br/>                                                |
| [**Win32 \_ PrinterDriverDll**](win32-printerdriverdll.md)         | Mette in relazione una stampante locale e il relativo file del driver (non il driver stesso).<br/>                                                          |
...
| [**Win32 \_ PrintJob**](win32-printjob.md)                         | Rappresenta un processo di stampa generato da un'Windows basata su criteri.<br/>                                                              |
...
Le classi di sottocategorie Video e Monitoraggi rappresentano monitoraggi, schede video e le relative impostazioni associate.



| Classe                                                                                 | Descrizione                                                                                                                                                                                                                                                                                                                                                                        |
|---------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ DesktopMonitor**](win32-desktopmonitor.md)                                 | Rappresenta il tipo di monitor o dispositivo di visualizzazione collegato al computer.<br/>                                                                                                                                                                                                                                                                                       |
| [**Win32 \_ DisplayControllerConfiguration**](win32-displaycontrollerconfiguration.md) | Rappresenta le informazioni di configurazione della scheda video di un computer che esegue Windows. Questa classe è obsoleta. Al posto di questa classe, usare le proprietà nelle [**classi \_ Win32 VideoController**](win32-videocontroller.md), [**Win32 \_ DesktopMonitor**](win32-desktopmonitor.md)e [CIM \_ VideoControllerResolution.](cim-videocontrollerresolution.md)<br/> |
