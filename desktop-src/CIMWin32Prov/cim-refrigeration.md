...
---
# <a name="cim_refrigeration-class"></a>\_Classe di refrigerazione CIM

La classe di **\_ refrigerazione CIM** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento a freddo.
...
La classe di **\_ refrigerazione CIM** presenta questi tipi di membri:
...
La classe di **\_ refrigerazione CIM** presenta questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-refrigeration.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe di **\_ refrigerazione CIM** dispone di queste proprietà.
...
La classe di **\_ refrigerazione CIM** è derivata da [**CIM \_ CoolingDevice**](cim-coolingdevice.md).
