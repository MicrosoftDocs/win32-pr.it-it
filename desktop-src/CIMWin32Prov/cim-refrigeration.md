---
description: La classe REFRIGERATION CIM \_ rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento per refrigerazione.
ms.assetid: 3ea557d8-6af3-4851-b667-a9afc1219cc7
ms.tgt_platform: multiple
title: CIM_Refrigeration classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119920651"
---
# <a name="cim_refrigeration-class"></a>Classe \_ Refrigeration CIM

La **classe \_ REFRIGERATION CIM** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento per refrigerazione.
...
La **classe \_ REFRIGERATION CIM** ha questi tipi di membri:
...
La **classe \_ REFRIGERATION CIM** include questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-refrigeration.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-refrigeration.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ REFRIGERATION CIM** ha queste proprietà.
...
La **classe \_ REFRIGERATION CIM** è derivata da [**CIM \_ CoolingDevice**](cim-coolingdevice.md).
