...
---
# <a name="uncompress-method-of-the-win32_directory-class"></a>Metodo Decompress della classe di \_ directory Win32

Il metodo di **decompressione** [WMI della classe](/windows/desktop/WmiSdk/retrieving-a-class) decomprime il file di voce o la directory della directory logica specificata nel percorso dell'oggetto.
...
L'esempio VBScript seguente decomprime la cartella c: \\ Scripts.
...
[**Comprimere**](compress-method-in-class-win32-directory.md)
</dt> </dl>
