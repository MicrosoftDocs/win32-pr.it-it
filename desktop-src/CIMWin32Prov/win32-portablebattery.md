...
---
# <a name="win32_portablebattery-class"></a>Win32 \_ PortableBattery (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PortableBattery Win32** contiene le proprietà correlate a una batteria portatile, ad esempio una batteria del computer notebook.
...
La classe **Win32 \_ PortableBattery** presenta questi tipi di membri:
...
La classe **Win32 \_ PortableBattery** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                        |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) nella [**\_ batteria CIM**](cim-battery.md).<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nella [**\_ batteria CIM**](cim-battery.md).<br/> |
...
La classe **Win32 \_ PortableBattery** dispone di queste proprietà.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,14 ")
</dt> </dl>

Descrizione dello stato di carica della batteria. Il valore 10 (undefined) non è valido nello schema Common Information Model (CIM) perché in Desktop Management Interface (DMI) indica che non è installata alcuna batteria. In questo caso, non è necessario creare un'istanza di questo oggetto.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Design Capacity moltiplicatore")
</dt> </dl>

Fattore di moltiplicazione del valore di **DesignCapacity** per garantire che il valore di milliwatt hour non venga sottoposto a overflow per le implementazioni di SBDS (Smart Battery Data Specification).
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,7 ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,8 "), [**unità**](../wmisdk/standard-qualifiers.md) (" milliwatt-ore ")
</dt> </dl>

Capacità di progettazione della batteria in milliwatt ore. Se questa proprietà non è supportata, immettere 0 (zero).
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,9 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>

Tensione di progettazione della batteria in millivolt. Se questo attributo non è supportato, immettere 0 (zero).
...
Altre informazioni sull'errore registrato in **LastErrorCode** ed eventuali azioni correttive che possono essere eseguite.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,15 "), [**unità**](../wmisdk/standard-qualifiers.md) (" minuti ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,11 "), [**unità**](../wmisdk/standard-qualifiers.md) (" milliwatt-ore ")
</dt> </dl>

Capacità di addebito completo della batteria in milliwatt ore. Il confronto di questo valore con la proprietà **DesignCapacity** determina quando la batteria richiede la sostituzione. La fine della durata della batteria è in genere quando la proprietà **FullChargeCapacity** è inferiore al 80% della proprietà **DesignCapacity** . Se questa proprietà non è supportata, immettere 0 (zero).
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| location")
</dt> </dl>

Posizione fisica della batteria. Questa proprietà viene compilata dal produttore del computer.

Esempio: "nella parte posteriore, a sinistra"
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Manufacture Date")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Manufacturer")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| tipo 22 \| errore massimo nei dati della batteria"), [**unità**](../wmisdk/standard-qualifiers.md) ("percentuale")
</dt> </dl>

Differenza tra la quantità più elevata di energia rimanente nella batteria e la quantità corrente indicata dalla batteria.
...
Qualificatori: [**maxlen**](../wmisdk/standard-qualifiers.md) (64), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,10 ")
</dt> </dl>
...
Tempo trascorso in secondi dall'ultima volta in cui l'UPS del sistema informatico passa alla potenza della batteria oppure il tempo trascorso dall'ultimo riavvio del sistema o dell'UPS, a seconda del numero minore. Se la batteria è online, viene restituito 0 (zero).
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable batteria \| 002,16 "), [**unità**](../wmisdk/standard-qualifiers.md) (" minuti ")
</dt> </dl>

Tempo rimanente in minuti per l'addebito completo della batteria alla tariffa e all'utilizzo correnti.
...
La classe **Win32 \_ PortableBattery** è derivata dalla [**\_ batteria CIM**](cim-battery.md).
