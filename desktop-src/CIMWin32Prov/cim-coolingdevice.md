---
description: La classe CIM \_ CoolingDevice rappresenta le funzionalità e la gestione dei dispositivi di raffreddamento.
ms.assetid: ac0f0df4-c174-4306-9325-eaa316ee820a
ms.tgt_platform: multiple
title: CIM_CoolingDevice classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119924891"
---
# <a name="cim_coolingdevice-class"></a>Classe CIM \_ CoolingDevice

La **classe CIM \_ CoolingDevice** rappresenta le funzionalità e la gestione dei dispositivi di raffreddamento.
...
La **classe CIM \_ CoolingDevice** ha questi tipi di membri:
...
La **classe CIM \_ CoolingDevice** include questi metodi.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ CoolingDevice** ha queste proprietà.
...
La **classe CIM \_ CoolingDevice** è derivata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)

WMI non implementa questa classe. Per le classi derivate **da CIM \_ CoolingDevice,** vedere [Classi Win32.](win32-provider.md)
