...
---
# <a name="rename-method-of-the-cim_devicefile-class"></a>Rinominare il metodo della \_ classe CIM DeviceFile

Il metodo **Rename Rinomina** il file del dispositivo o la directory specificata nel percorso dell'oggetto. La ridenominazione non è supportata se la destinazione si trova in un'altra unità o se è necessario sovrascrivere un file logico esistente. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
