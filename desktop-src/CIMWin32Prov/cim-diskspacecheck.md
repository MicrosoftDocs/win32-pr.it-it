...
La classe **CIM \_ DiskSpaceCheck** presenta questi tipi di membri:
...
La classe **CIM \_ DiskSpaceCheck** presenta questi metodi.



| Metodo                                                      | Descrizione                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-diskspacecheck.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ DiskSpaceCheck** dispone di queste proprietà.
...
Qualificatori: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ filesystem**](cim-filesystem.md).**AvailableSpace** "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilobyte ")
</dt> </dl>
