...
title: Metodo SetTcpMaxDataRetransmissions della Win32_NetworkAdapterConfiguration
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119439271"
---
# <a name="settcpmaxdataretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Metodo SetTcpMaxDataRetransmissions della classe NetworkAdapterConfiguration Win32 \_

Il metodo statico della classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpMaxDataRetransmissions** viene usato per impostare il numero di volte in cui TCP ritrasmette un singolo segmento di dati prima di interrompere la connessione.
...
*TcpMaxDataRetransmissions* \[ Pollici\]
</dt> <dd>

Numero di volte in cui TCP ritrasmette un singolo segmento di dati prima di interrompere la connessione. Intervallo valido: 0 - 0xFFFFFFFF.
...
Il timeout di ritrasmissione raddoppia a ogni successiva ritrasmissione in una connessione.

## <a name="examples"></a>Esempio

L'esempio VBScript Modify [the Maximum Allowed TCP Data Retransmissions](https://Gallery.TechNet.Microsoft.Com/8a581692-7950-412e-bd28-74f223b27827) (Modifica numero massimo di ritrasmissioni dati TCP consentite) configura il numero di tentativi di ritrasmissione di un singolo segmento di dati da parte di TCP prima di abbandonare il lavoro richiesto.
