...
---
# <a name="win32_systemservices-class"></a>Win32 \_ SystemServices (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) dell'associazione **\_ SystemServices Win32** mette in correlazione un sistema computer e un programma del servizio esistente nel sistema.
...
La classe **Win32 \_ SystemServices** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ SystemServices** dispone di queste proprietà.
...
Riferimento all'istanza di che rappresenta le proprietà del computer in cui è presente il servizio.
...
Riferimento all'istanza di che rappresenta il servizio esistente nel computer.

</dd> </dl>

## <a name="remarks"></a>Commenti

La classe **Win32 \_ SystemServices** è derivata da [**CIM \_ SystemComponent**](cim-systemcomponent.md).
