...
ms.locfileid: "119917991"
---
# <a name="win32_battery-class"></a>Classe Batteria Win32 \_

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 Battery** rappresenta una batteria connessa al sistema informatico.
...
La **classe Win32 \_ Battery** ha questi tipi di membri:
...
La **classe Win32 \_ Battery** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ Battery**](cim-battery.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ Battery**](cim-battery.md) per la documentazione.<br/> |
...
La **classe Win32 \_ Battery** ha queste proprietà.
...
Qualificatori: [**DEPRECATED,**](/windows/desktop/WmiSdk/standard-wmi-qualifiers) [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ LOCAL MACHINE System \_ \\ \\ \\ \\ CurrentControlSet Services \\ \\ \| Disartierate"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("minuti")
</dt> </dl>

Tempo necessario per caricare completamente la batteria. Questa proprietà non è supportata. **BatteryRechargeTime** non ha una proprietà di sostituzione e ora è considerato obsoleto.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Portable Battery \| 002.14")
</dt> </dl>

Stato della batteria. Il valore 10 (Undefined) non è valido nello schema CIM perché in DMI rappresenta che non è installata alcuna batteria. In questo caso, non è necessario creare un'istanza dell'oggetto.

Questa proprietà viene ereditata da [**CIM \_ Battery**](cim-battery.md).
...
Il sistema ha accesso all'ac, quindi non viene scaricata alcuna batteria. Tuttavia, la batteria non è necessariamente in carica.

</dd> <dt>

<span id="Fully_Charged"></span><span id="fully_charged"></span><span id="FULLY_CHARGED"></span>

<span id="Fully_Charged"></span><span id="fully_charged"></span><span id="FULLY_CHARGED"></span>**Completamente addebitato** (3)
...
<span id="Low"></span><span id="low"></span><span id="LOW"></span>**Basso** (4)
...
<span id="Charging"></span><span id="charging"></span><span id="CHARGING"></span>**Ricarica** (6)
...
<span id="Charging_and_High"></span><span id="charging_and_high"></span><span id="CHARGING_AND_HIGH"></span>**Carica e alta** (7)
...
<span id="Charging_and_Low"></span><span id="charging_and_low"></span><span id="CHARGING_AND_LOW"></span>**Carica e bassa** (8)
...
<span id="Partially_Charged"></span><span id="partially_charged"></span><span id="PARTIALLY_CHARGED"></span>**Addebito parziale** (11)
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Portable Battery \| 002.7")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.8"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliwatt-hours")
</dt> </dl>

Progettare la capacità della batteria in milliwatt-hours. Se la proprietà non è supportata, immettere 0 (zero).

Questa proprietà viene ereditata da [**CIM \_ Battery**](cim-battery.md).

</dd> <dt>

**ProgettazioneVoltage**
</dt> <dd> <dl> <dt>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.9"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

Tensione di progettazione della batteria in millivolts. Se l'attributo non è supportato, immettere 0 (zero).
...
Stima della percentuale di addebito totale rimanente.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.15"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Stimare in minuti il tempo di esaurimento della carica della batteria nelle condizioni di carico attuali se l'alimentazione dell'utilità è spenta o è stata persa e rimane spenta o un portatile è disconnesso da una fonte di alimentazione.
...
Qualificatori: [**DEPRECATED,**](/windows/desktop/WmiSdk/standard-wmi-qualifiers) [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ LOCAL MACHINE System \_ \\ \\ \\ \\ CurrentControlSet Services \\ \\ \| BatteryLife"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Quantità di tempo necessario per svuotare completamente la batteria dopo che è stata completamente addebitata. Questa proprietà non viene più usata ed è considerata obsoleta.
...
Durata prevista della batteria in minuti, presupponendo che la batteria sia completamente carica. La proprietà rappresenta la durata totale prevista della batteria, non la durata rimanente corrente, indicata dalla **proprietà EstimatedRunTime.**
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.11"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliwatt-hours")
</dt> </dl>

Capacità di ricarica completa della batteria in milliwatt-hours. Il confronto del valore con la **proprietà DesignCapacity** determina quando la batteria richiede la sostituzione. La durata di una batteria si verifica in genere quando la **proprietà FullChargeCapacity** scende al di sotto dell'80% **della proprietà DesignCapacity.** Se la proprietà non è supportata, immettere 0 (zero).
...
Tempo massimo, in minuti, per ricaricare completamente la batteria. La proprietà rappresenta il tempo necessario per ricaricare una batteria completamente esaurita, non il tempo di ricarica rimanente corrente, indicato nella **proprietà TimeToFullCharge.**
...
Definisce l'etichetta in base alla quale l'oggetto è noto. In caso di sottoclasse, la proprietà può essere sottoposta a override per essere una proprietà chiave.
...
Qualificatori: [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.10")
</dt> </dl>

Numero di versione della specifica dei dati supportato dalla batteria. Se la batteria non supporta questa funzione, il valore deve essere lasciato vuoto.
...
Tempo trascorso in secondi dall'ultimo passaggio dell'UPS del sistema computer all'alimentazione a batteria o dall'ultimo riavvio del sistema o del gruppo di sicurezza di rete, a seconda del valore minore. Se la batteria è "on line", viene restituito 0 (zero).
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.16"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Tempo rimanente per ricaricare completamente la batteria in minuti alla frequenza di ricarica e all'utilizzo correnti.
...
La **classe Win32 \_ Battery** deriva dalla [**batteria CIM \_**](cim-battery.md) che deriva da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)

Windows Server 2008 contiene i driver ups (APC) nel sistema operativo, che consente di considerare il gruppo di ups come un alimentatore di batteria. In questo modo è possibile monitorare lo stato del gruppo di attività usando uno script ed eseguire azioni quando necessario.

## <a name="examples"></a>Esempio

LToggle-Wireless.ps1di codice di PowerShell esegue una query sulla **batteria Win32 \_** per determinare se attivare o disattivare il wireless per risparmiare energia. [](https://Gallery.TechNet.Microsoft.Com/Toggle-Wirelessps1-2d244a8f)

[L'esempio List UPS Information](https://Gallery.TechNet.Microsoft.Com/7196121e-97de-4290-9939-26d0ce266270) Perl elenca informazioni sulle origini di alimentazione ininterrotti collegate a un computer.
