---
description: Il metodo SetPowerState della classe CIM USBHub imposta lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere \_ inserito in tale stato.
