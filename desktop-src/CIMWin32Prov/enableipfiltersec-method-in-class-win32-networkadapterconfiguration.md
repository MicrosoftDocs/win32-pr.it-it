...
---
# <a name="enableipfiltersec-method-of-the-win32_networkadapterconfiguration-class"></a>Metodo EnableIPFilterSec della \_ classe NetworkAdapterConfiguration Win32

Il metodo statico della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **EnableIPFilterSec** viene usato per abilitare Internet Protocol Security (IPSec) globalmente tra tutte le schede di rete con binding IP.
...
Se **true**, IPSec viene abilitato globalmente in tutte le schede di rete con binding IP. Se **false**, è consentito il flusso non filtrato di tutto il traffico di porta e protocollo.
...
Con la sicurezza abilitata, è possibile controllare le caratteristiche di sicurezza operativa per una scheda di rete usando il metodo [**EnableIPSec**](enableipsec-method-in-class-win32-networkadapterconfiguration.md) specifico della scheda di rete.

## <a name="examples"></a>Esempio

Il codice seguente, tratto dall'esempio [Enable IPFilter Security on all network adattations](https://Gallery.TechNet.Microsoft.Com/f8e56021-5a54-4554-b7b6-d76cc40d8d1d) on TechNet Gallery, Abilita la sicurezza del filtro IP per tutte le schede di rete installate in un computer.
