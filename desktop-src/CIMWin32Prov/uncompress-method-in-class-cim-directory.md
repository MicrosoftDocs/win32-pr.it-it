...
---
# <a name="uncompress-method-of-the-cim_directory-class"></a>Metodo Decompress della classe di \_ directory CIM

Il metodo **uncompress** decomprime il file di voce o la directory logica specificata nel percorso dell'oggetto. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[**\_Directory CIM**](uncompress-method-in-class-cim-directory.md)
</dt> <dt>
