...
ms.locfileid: "119752301"
---
# <a name="stopservice-method-of-the-cim_clusteringservice-class"></a>Metodo StopService della classe CIM \_ ClusteringService

Il **metodo StopService** arresta il servizio rappresentato dall'oggetto derivato da [**CIM \_ ClusteringService.**](cim-clusteringservice.md) Questo metodo viene ereditato dal [**servizio CIM \_**](cim-service.md).
