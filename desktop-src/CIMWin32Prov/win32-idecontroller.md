...
---
# <a name="win32_idecontroller-class"></a>Win32 \_ IDECONTROLLER (classe)

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ IDECONTROLLER** gestisce le funzionalità di un dispositivo controller IDE (Integrated Device Electronics).
...
La classe **Win32 \_ IDECONTROLLER** presenta questi tipi di membri:
...
La classe **Win32 \_ IDECONTROLLER** presenta questi metodi.
...
La classe **Win32 \_ IDECONTROLLER** dispone di queste proprietà.
...
Identificatore univoco del controller IDE con altri dispositivi nel sistema.
...
Altre informazioni sull'errore registrato nella proprietà **LastErrorCode** e informazioni sulle azioni correttive che possono essere eseguite.
...
Produttore del dispositivo controller IDE.
...
ID dispositivo Windows Plug and Play del dispositivo logico.
...
Se **true**, il dispositivo può essere inserito in modalità di sospensione e così via. La proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate, solo che il dispositivo logico è in grado di gestire il risparmio di energia.
...
La classe **Win32 \_ IDECONTROLLER** è derivata dal [**\_ controller CIM**](cim-controller.md).
