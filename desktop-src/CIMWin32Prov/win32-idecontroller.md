---
description: La classe WMI IDEController Win32 gestisce le funzionalità di un dispositivo \_ controller IDE (Integrated Device Electronics).
ms.assetid: 9aff19df-8184-47d6-9d21-30376b6bc9b2
ms.tgt_platform: multiple
title: Win32_IDEController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "120085781"
---
# <a name="win32_idecontroller-class"></a>Classe IDEController Win32 \_

La **classe \_ WMI IDEController Win32** gestisce le funzionalità di un dispositivo controller IDE (Integrated Device Electronics). [](/windows/desktop/WmiSdk/retrieving-a-class)
...
La **classe \_ IDEController Win32** ha questi tipi di membri:
...
La **classe \_ IDEController Win32** include questi metodi.
...
La **classe \_ IDEController Win32** ha queste proprietà.
...
Altre informazioni sull'errore registrato nella **proprietà LastErrorCode** e informazioni su eventuali azioni correttive che possono essere eseguite.
...
Windows Plug and Play ID dispositivo del dispositivo logico.
...
Se **TRUE,** il dispositivo può essere alimentato in modalità di sospensione e così via. La proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate, ma solo che il dispositivo logico è in grado di eseguire il risparmio energia.
...
La **classe \_ IDEController Win32** è derivata dal [**\_ controller CIM**](cim-controller.md).
