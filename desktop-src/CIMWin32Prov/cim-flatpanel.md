---
description: La classe CIM \_ FlatPanel rappresenta le funzionalità e la gestione del dispositivo logico pannello flat.
ms.assetid: 0c515621-4ff9-42af-a281-ac49af6d96ba
ms.tgt_platform: multiple
title: CIM_FlatPanel classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119320931"
---
# <a name="cim_flatpanel-class"></a>Classe \_ CiM FlatPanel

La **classe CIM \_ FlatPanel** rappresenta le funzionalità e la gestione del dispositivo logico pannello flat.
...
La **classe \_ CiM FlatPanel** ha questi tipi di membri:
...
La **classe CIM \_ FlatPanel** include questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-flatpanel.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ FlatPanel** ha queste proprietà.
...
Enumerazione che descrive il tipo di visualizzazione del pannello flat.
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**LCD a matrice passiva** (2)
...
<span id="Cholesteric_LCD"></span><span id="cholesteric_lcd"></span><span id="CHOLESTERIC_LCD"></span>**LCD cholesteric** (4)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Visualizzazione delle emissioni di** campo (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Display elettroluminescente** (6)
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixel")
</dt> </dl>
...
Descrizione del tipo di illuminazione dello schermo.
...
Modalità di analisi che indica una singola o doppia analisi, ad esempio.
...
Se **TRUE,** il pannello flat supporta la visualizzazione a colori.
...
Risoluzione verticale, in pixel.

</dd> </dl>

## <a name="remarks"></a>Commenti

La **classe CIM \_ FlatPanel** deriva da [**CIM \_ Display.**](cim-display.md)
