...
---
# <a name="cim_flatpanel-class"></a>CIM \_ piatto (classe)

La classe **CIM \_ piatto** rappresenta le funzionalità e la gestione del dispositivo logico del pannello flat.
...
La classe **CIM \_ piatto** presenta questi tipi di membri:
...
La classe **CIM \_ piatto** presenta questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-flatpanel.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ piatto** dispone di queste proprietà.
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**LCD Matrix attivo** (3)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Visualizzazione emissione campi** (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Visualizzazione Electro luminescente** (6)


</dt> <dd>

Luminescente electro

</dd> <dt>

<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>

<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**Plasma gas** (7)
...
Modalità di analisi che indica, ad esempio, un'analisi singola o doppia.
...
Se **true**, il pannello flat supporta la visualizzazione dei colori.
...
La classe **CIM \_ piatto** è derivata dalla [**\_ visualizzazione CIM**](cim-display.md).
