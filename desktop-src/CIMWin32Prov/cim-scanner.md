...
---
# <a name="cim_scanner-class"></a>\_Classe CIM scanner
...
La classe **CIM \_ scanner** presenta questi tipi di membri:
...
La classe **CIM \_ scanner** presenta questi metodi.



| Metodo                                                             | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-scanner.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ scanner** dispone di queste proprietà.
