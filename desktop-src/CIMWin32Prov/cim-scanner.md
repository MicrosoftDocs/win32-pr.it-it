---
description: Lo scanner CIM \_ rappresenta le funzionalità e la gestione del dispositivo logico dello scanner.
ms.assetid: a881ba20-2922-45c0-b31c-a3fea221d410
ms.tgt_platform: multiple
title: CIM_Scanner classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119920091"
---
# <a name="cim_scanner-class"></a>Classe dello scanner CIM \_

Lo **\_ scanner CIM** rappresenta le funzionalità e la gestione del dispositivo logico dello scanner.
...
La **classe CIM \_ Scanner** ha questi tipi di membri:
...
La **classe CIM \_ Scanner** include questi metodi.



| Metodo                                                             | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-scanner.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-scanner.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ Scanner** ha queste proprietà.
...
La **classe CIM \_ Scanner** è derivata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
