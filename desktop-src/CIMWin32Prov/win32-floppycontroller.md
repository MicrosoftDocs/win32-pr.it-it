...
---
# <a name="win32_floppycontroller-class"></a>Win32 \_ FloppyController (classe)

\[**Win32 \_ FloppyController** non è più disponibile per l'uso a partire da Windows 10 e Windows Server 2016.\]

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ FloppyController Win32** rappresenta le funzionalità e la capacità di gestione di un controller di unità disco floppy.
...
La classe **Win32 \_ FloppyController** presenta questi tipi di membri:
...
La classe **Win32 \_ FloppyController** presenta questi metodi.
...
La classe **Win32 \_ FloppyController** dispone di queste proprietà.
...
Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto, è necessario usare un valore pari a 0 (zero).
...
Identificatore del dispositivo Plug and Play Windows per il dispositivo logico.
