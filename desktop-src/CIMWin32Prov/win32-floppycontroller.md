---
description: La classe WMI Win32 FloppyController rappresenta le funzionalità e la capacità di gestione di un controller di unità disco \_ floppy.
ms.assetid: 8c02847c-8329-4adc-b2a5-149b36aead88
ms.tgt_platform: multiple
title: Win32_FloppyController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119878661"
---
# <a name="win32_floppycontroller-class"></a>Classe Win32 \_ FloppyController

\[**Win32 \_ FloppyController** non è più disponibile per l'uso a Windows 10 e Windows Server 2016.\]

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ FloppyController** rappresenta le funzionalità e la capacità di gestione di un controller unità disco floppy.
...
La **classe Win32 \_ FloppyController** ha questi tipi di membri:
...
La **classe Win32 \_ FloppyController** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) nel [**\_ controller CIM**](cim-controller.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nel [**\_ controller CIM**](cim-controller.md) per la documentazione.<br/> |
...
La **classe Win32 \_ FloppyController** ha queste proprietà.
...
Risparmio energia - Modalità risparmio energia
...
Identificatore univoco del controller floppy.
...
Nome del produttore del controller floppy.
...
Numero massimo di entità indirizzabili direttamente supportate da questo controller. Se il numero è sconosciuto, è necessario usare il valore 0 (zero).
...
Etichetta per l'oggetto. In caso di sottoclasse, è possibile eseguire l'override della proprietà come proprietà chiave.
...
Windows Plug and Play identificatore di dispositivo per il dispositivo logico.
...
La **classe Win32 \_ FloppyController** è derivata dal [**\_ controller CIM**](cim-controller.md) che deriva da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
