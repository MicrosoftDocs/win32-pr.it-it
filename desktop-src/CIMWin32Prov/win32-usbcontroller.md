---
description: Il controller USB Win32 \_ &\# 32; La classe WMI gestisce le funzionalità di un controller USB (Universal Serial Bus).
ms.assetid: 2b45eb41-fc4f-4a00-a8e6-5b709240958a
ms.tgt_platform: multiple
title: Win32_USBController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119922841"
---
# <a name="win32_usbcontroller-class"></a>Classe USBController Win32 \_
...
La **classe \_ WIN32 USBController** ha questi tipi di membri:
...
La **classe WIN32 \_ USBController** include questi metodi.
...
La **classe WIN32 \_ USBController** ha queste proprietà.
...
<span id="SCSI_Serial_Storage_Architecture"></span><span id="scsi_serial_storage_architecture"></span><span id="SCSI_SERIAL_STORAGE_ARCHITECTURE"></span>**Architettura Archiviazione seriale SCSI** (13)
...
<span id="Power"></span><span id="power"></span><span id="POWER"></span>**Alimentazione** (21)
...
<span id="TWIRP__two-way_infrared_"></span><span id="twirp__two-way_infrared_"></span><span id="TWIRP__TWO-WAY_INFRARED_"></span>**TWIRP (a raggi infrarossi bidirevi)** (44)
...
<span id="FIR__fast_infrared_"></span><span id="fir__fast_infrared_"></span><span id="FIR__FAST_INFRARED_"></span>**FIR (veloce a raggi infrarossi)** (45)
...
<span id="SIR__serial_infrared_"></span><span id="sir__serial_infrared_"></span><span id="SIR__SERIAL_INFRARED_"></span>**SIR (seriale a raggi infrarossi)** (46)
...
È possibile usare la [**classe di associazione Win32 \_ USBControllerDevice**](win32-usbcontrollerdevice.md) per determinare quali dispositivi logici sono associati al controller.

## <a name="examples"></a>Esempio

[L'esempio di PowerShell Elenca informazioni](https://Gallery.TechNet.Microsoft.Com/fc2d92ce-a241-47bf-a5ea-3395d301559e) controller USB restituisce informazioni su tutti i controller USB trovati in un computer.

L'esempio VBScript seguente restituisce informazioni su tutti i controller USB trovati in un computer.
