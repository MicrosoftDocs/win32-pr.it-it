...
---
# <a name="reset-method-of-the-cim_volumeset-class"></a>Reimposta il metodo della \_ classe del volume di volumi CIM

Il metodo **Reset** della classe [**CIM \_ volumet**](cim-volumeset.md) richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Volume del volume CIM](reset-method-in-class-cim-volumeset.md)
</dt> <dt>
