...
---
# <a name="delete-method-of-the-win32_systemdriver-class"></a>Metodo Delete della classe Win32 \_ SystemDriver
...
Restituisce un valore pari a 0 (zero) se il servizio è stato eliminato correttamente, 1 (uno) se la richiesta non è supportata e qualsiasi altro numero per indicare un errore.
