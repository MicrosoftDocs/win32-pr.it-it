...
---
# <a name="cim_removefileaction-class"></a>CIM \_ RemoveFileAction (classe)

La classe **CIM \_ RemoveFileAction** Disinstalla i file.
...
La classe **CIM \_ RemoveFileAction** presenta questi tipi di membri:
...
La classe **CIM \_ RemoveFileAction** presenta questi metodi.



| Metodo                                                        | Descrizione                                                   |
|:--------------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-removefileaction.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ RemoveFileAction** dispone di queste proprietà.
...
La classe **CIM \_ RemoveFileAction** è derivata da [**\_ fileaction CIM**](cim-fileaction.md).
