---
description: La classe CIM \_ RemoveFileAction disinstalla i file.
...
La **classe CIM \_ RemoveFileAction** ha questi tipi di membri:
...
La **classe CIM \_ RemoveFileAction** include questi metodi.
...
La **classe CIM \_ RemoveFileAction** ha queste proprietà.
...
La **classe CIM \_ RemoveFileAction** è derivata da [**CIM \_ FileAction**](cim-fileaction.md).
