---
description: La classe Fan CIM \_ rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento a ventola.
...
ms.locfileid: "119923871"
---
# <a name="cim_fan-class"></a>Classe fan \_ CIM

La **classe Fan CIM \_** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento a ventola.
...
La **classe \_ fan CIM** ha questi tipi di membri:
...
La **classe \_ fan CIM** dispone di questi metodi.



| Metodo                                                         | Descrizione                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-fan.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
| [**SetSpeed**](setspeed-method-in-class-cim-fan.md)           | Imposta la velocità della ventola. Non implementato da WMI.<br/>                                                                                   |
...
La **classe \_ fan CIM** ha queste proprietà.
...
Se **TRUE,** il dispositivo di raffreddamento fornisce raffreddamento attivo (anziché passivo).
...
Velocità richiesta della ventola, definita in rivoluzioni al minuto, quando è supportata una ventola a velocità variabile. La velocità corrente è determinata da un sensore ([**CIM \_ Tachimetro**](cim-tachometer.md)) associato alla ventola usando la [**relazione CIM \_ AssociatedSensor.**](cim-associatedsensor.md)
...
WMI non implementa questa classe. Per le classi derivate **da FAN \_ CIM,** vedere [Classi Win32.](win32-provider.md)
