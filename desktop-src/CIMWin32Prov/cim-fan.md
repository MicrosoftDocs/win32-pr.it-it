...
---
# <a name="cim_fan-class"></a>\_Classe della ventola CIM

La classe **CIM \_ fan** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento ventola.
...
La classe della **\_ ventola CIM** presenta questi tipi di membri:
...
Per la classe **CIM \_ fan** sono disponibili questi metodi.



| Metodo                                                         | Descrizione                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-fan.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
| [**Velocità**](setspeed-method-in-class-cim-fan.md)           | Imposta la velocità della ventola. Non implementato da WMI.<br/>                                                                                   |
...
Per la classe **CIM \_ fan** sono presenti queste proprietà.
...
Velocità della ventola richiesta, definita in rivoluzioni al minuto, quando è supportata una ventola di velocità variabile. La velocità corrente è determinata da un sensore ([**\_ contagiri CIM**](cim-tachometer.md)) associato alla ventola con la relazione [**CIM \_ AssociatedSensor**](cim-associatedsensor.md) .
...
La classe della **\_ ventola CIM** è derivata da [**CIM \_ CoolingDevice**](cim-coolingdevice.md).

WMI non implementa questa classe. Per le classi derivate dalla **\_ ventola CIM**, vedere [classi Win32](win32-provider.md).
