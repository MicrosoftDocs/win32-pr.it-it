---
description: La classe WMI Della ventola Win32 \_ rappresenta le proprietà di un dispositivo a ventola nel sistema del computer. Ad esempio, la ventola di raffreddamento della CPU.
ms.assetid: ff48b788-d759-45cf-812f-a80dba0c9192
ms.tgt_platform: multiple
title: Win32_Fan classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "120085801"
---
# <a name="win32_fan-class"></a>Classe Fan \_ Win32

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Della \_ ventola Win32** rappresenta le proprietà di un dispositivo a ventola nel sistema del computer. Ad esempio, la ventola di raffreddamento della CPU.
...
La **classe Win32 \_ Fan** ha questi tipi di membri:
...
La **classe Win32 \_ Fan** ha questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) nella ventola [**CIM \_**](cim-fan.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nella [**ventola CIM \_**](cim-fan.md) per la documentazione.<br/> |
| **SetSpeed**      | Non implementato.<br/>                                                                                                                                                                  |
...
La **classe Win32 \_ Fan** ha queste proprietà.
...
Se **True,** il dispositivo di raffreddamento fornisce il raffreddamento attivo (anziché passivo).

Questa proprietà viene ereditata da [**CIM \_ CoolingDevice.**](cim-coolingdevice.md)
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>

Velocità della ventola attualmente richiesta, definita in rivoluzioni al minuto, quando è supportata una ventola a velocità variabile **(VariableSpeed** è **TRUE).** La velocità corrente è determinata da un sensore ([**CIM \_ Tachometer**](cim-tachometer.md)) associato alla ventola usando la [**relazione CIM \_ AssociatedSensor.**](cim-associatedsensor.md)

Questa proprietà viene ereditata dalla [**ventola CIM. \_**](cim-fan.md)
...
Identifica il dispositivo a ventola. Questa proprietà viene ereditata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
Se **True,** la ventola supporta velocità variabili.
...
La **classe di \_ ventole Win32** è derivata dalla [**ventola CIM \_**](cim-fan.md).

## <a name="examples"></a>Esempio

L'esempio di PowerShell [List Computer Fan Information](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) recupera informazioni sulle ventole di raffreddamento installate in un computer.

Nell'esempio seguente vengono recuperate informazioni sulle ventole di raffreddamento installate in un computer.
