---
description: Il metodo SetPowerState della classe CIM USBDevice imposta lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve \_ essere inserito in tale stato.
