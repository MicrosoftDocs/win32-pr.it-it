---
description: Il metodo Reset della classe CIM \_ WORMDrive richiede una reimpostazione del dispositivo logico.
ms.assetid: ece4a618-6748-45a7-90fe-34eccf0f59d7
ms.tgt_platform: multiple
title: Metodo Reset della classe CIM_WORMDrive
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119700491"
---
# <a name="reset-method-of-the-cim_wormdrive-class"></a>Metodo Reset della classe CIM \_ WORMDrive

Il **metodo Reset** della classe CIM \_ [**WORMDrive**](cim-wormdrive.md) richiede una reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
