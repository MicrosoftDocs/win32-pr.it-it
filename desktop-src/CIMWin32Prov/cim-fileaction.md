---
description: La classe CIM FileAction consente all'autore di individuare i file già presenti nel computer di un utente e quindi di spostare o copiare tali \_ file in un nuovo percorso.
ms.assetid: 0576e73f-08e1-4f80-af5a-f5d497f57632
ms.tgt_platform: multiple
title: CIM_FileAction classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "122884796"
---
# <a name="cim_fileaction-class"></a>Classe CIM \_ FileAction

La **classe CIM \_ FileAction** consente all'autore di individuare i file già presenti nel computer di un utente e quindi di spostare o copiare tali file in un nuovo percorso.
...
La **classe CIM \_ FileAction** ha questi tipi di membri:
...
La **classe CIM \_ FileAction** dispone di questi metodi.



| Metodo                                                  | Descrizione                                                   |
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Evocare**](invoke-method-in-class-cim-fileaction.md) | Consente di eseguire un'azione specifica. Non implementato da WMI.<br/> |
...
La **classe CIM \_ FileAction** ha queste proprietà.
...
WMI non implementa questa classe. Per le classi derivate **da CIM \_ FileAction,** vedere [Classi Win32.](win32-provider.md)
