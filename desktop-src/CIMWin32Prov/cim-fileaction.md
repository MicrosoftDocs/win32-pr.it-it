...
---
# <a name="cim_fileaction-class"></a>\_Classe Fileaction CIM

La classe **CIM \_ fileaction** consente all'autore di individuare i file già esistenti nel computer di un utente, quindi spostare o copiare tali file in una nuova posizione.
...
La classe **CIM \_ fileaction** presenta questi tipi di membri:
...
La classe **CIM \_ fileaction** presenta questi metodi.



| Metodo                                                  | Descrizione                                                   |
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-fileaction.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ fileaction** dispone di queste proprietà.
...
WMI non implementa questa classe. Per le classi derivate da **CIM \_ fileaction**, vedere [Win32 Classes](win32-provider.md).
