---
description: La classe CIM Check rappresenta una condizione o una caratteristica che dovrebbe essere true in un ambiente definito o con ambito da un'istanza di \_ una classe CIM \_ ComputerSystem.
ms.assetid: f7862fe5-4412-4d57-b5fa-03c939ddba02
ms.tgt_platform: multiple
title: CIM_Check classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **classe CIM \_ Check** ha questi tipi di membri:
...
La **classe CIM \_ Check** include questi metodi.
...
La **classe CIM \_ Check** ha queste proprietà.
