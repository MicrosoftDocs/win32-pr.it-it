---
description: Il metodo statico della classe WMI SetDatabasePath imposta il percorso dei file di database Internet standard (HOSTS, LMHOSTS, NETWORKS e PROTOCOLS).
...
ms.locfileid: "119760131"
---
# <a name="setdatabasepath-method-of-the-win32_networkadapterconfiguration-class"></a>Metodo SetDatabasePath della classe NetworkAdapterConfiguration Win32 \_

Il metodo statico della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetDatabasePath** imposta il percorso dei file di database Internet standard (HOSTS, LMHOSTS, NETWORKS e PROTOCOLS).
...
*DatabasePath* \[ Pollici\]
</dt> <dd>

Percorso valido dei file di database Internet standard (HOSTS, LMHOSTS, NETWORKS e PROTOCOLS) usati dall'interfaccia Windows Sockets.
...
Questo metodo viene usato dall'Windows Sockets. Il percorso predefinito è %SystemRoot% \\ system32 \\ driver \\ .

## <a name="examples"></a>Esempio

L'esempio Modify [the Database Path for all Network Adapters](https://Gallery.TechNet.Microsoft.Com/94bfa42f-f6a3-482f-8d5a-5445a2475bee) VBScript (Modificare il percorso del database per tutte le schede di rete) nella raccolta TechNet usa **SetDatabasePath** per impostare il percorso dei file di database Internet standard (HOSTS, LMHOSTS, NETWORKS, PROTOCOLS) usati dall'interfaccia Windows Sockets.
