...
---
# <a name="win32_pnpdevicepropertybooleanarray-class"></a>Win32 \_ PnPDevicePropertyBooleanArray (classe)

Rappresenta una proprietà del dispositivo PnP costituita da una matrice di elementi **booleani** .
...
La classe **Win32 \_ PnPDevicePropertyBooleanArray** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ PnPDevicePropertyBooleanArray** dispone di queste proprietà.
