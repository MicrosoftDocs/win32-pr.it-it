...
---
# <a name="cim_powersupply-class"></a>CIM \_ alimentatore (classe)

La classe **CIM \_ alimentatore** rappresenta le funzionalità e la gestione del dispositivo logico dell'alimentatore.
...
La classe **CIM \_ alimentatore** presenta questi tipi di membri:
...
La classe **CIM \_ alimentatore** presenta questi metodi.



| Metodo                                                                 | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-powersupply.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ alimentatore** dispone di queste proprietà.
...
Intervallo di tensione attualmente in uso. Se la fornitura non è attualmente in fase di disegno, è possibile specificare il valore 6 ("nessuno"). Queste informazioni sono necessarie nel caso di un gruppo di continuità (UPS, Power Supply), una sottoclasse di **CIM \_ alimentatore**.
...
Se **true**, l'alimentatore è un rifornimento di cambio (rispetto lineare).
...
Frequenza, espressa in Hertz, alla fine dell'intervallo di frequenza di input 1 dell'alimentatore. Il valore 0 implica il controller di dominio.
...
Frequenza (in Hertz) al lato inferiore dell'intervallo di frequenza di input dell'alimentatore 1. Il valore 0 implica il controller di dominio.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Alimentatore DMTF \| \| 002,8 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolt ")
</dt> </dl>

Tensione elevata dell'intervallo di tensione di input 1 per l'alimentatore, in millivolt. Il valore 0 indica "Unknown".
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Alimentatore DMTF \| \| 002,7 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolt ")
</dt> </dl>

Bassa tensione dell'intervallo di tensione di input 1 per l'alimentatore, in millivolt. Il valore 0 indica "Unknown".
...
Frequenza (espressa in Hertz) alla fine dell'intervallo di frequenza di input dell'alimentatore 2. Il valore 0 implica il controller di dominio.
...
Frequenza (in Hertz) al lato inferiore dell'intervallo di frequenza di input dell'alimentatore 2. Il valore 0 implica il controller di dominio.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Alimentatore DMTF \| \| 002,12 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolt ")
</dt> </dl>

Tensione elevata dell'intervallo di tensione di input 2 per l'alimentatore, in millivolt. Il valore 0 indica "Unknown".
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Alimentatore DMTF \| \| 002,11 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolt ")
</dt> </dl>

Bassa tensione dell'intervallo di tensione di input 2 per questo alimentatore, in millivolt. Il valore 0 indica "Unknown".
...
Potenza di output totale dell'alimentatore, in milliwatt. Il valore 0 indica "Unknown".
...
La classe **CIM \_ alimentatore** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI non implementa questa classe. Per WMI con classi derivate da **CIM \_ alimentatore**, vedere [le classi Win32](win32-provider.md).
