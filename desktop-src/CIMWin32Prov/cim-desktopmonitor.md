---
description: La classe CIM \_ DesktopMonitor rappresenta le funzionalità e la gestione del dispositivo logico CRT (Desktop Monitor).
ms.assetid: dc65aa38-5255-4a40-8ffc-f05f9af71dc6
ms.tgt_platform: multiple
title: CIM_DesktopMonitor (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119924551"
---
# <a name="cim_desktopmonitor-class-cimwin32-wmi-providers"></a>CIM_DesktopMonitor (provider WMI CIMWin32)

La **classe CIM \_ DesktopMonitor** rappresenta le funzionalità e la gestione del dispositivo logico CRT (Desktop Monitor).
...
La **classe \_ CIM DesktopMonitor** ha questi tipi di membri:
...
La **classe \_ CIM DesktopMonitor** include questi metodi.



| Metodo                                                                    | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-desktopmonitor.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-desktopmonitor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ DesktopMonitor** ha queste proprietà.
...
Larghezza di banda del monitoraggio in MHz. Se sconosciuto, usare 0 (zero).
...
**Questo dispositivo usa una risorsa richiesta di interrupt (IRQ) in uso da un altro dispositivo.** (30)
...
La **classe CIM \_ DesktopMonitor** è derivata da [**CIM \_ Display**](cim-display.md).

WMI non implementa questa classe. Per altre informazioni sulle classi derivate **da CIM \_ DesktopMonitor,** vedere [Classi Win32](win32-provider.md).
