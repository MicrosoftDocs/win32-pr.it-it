...
---
# <a name="cim_desktopmonitor-class-cimwin32-wmi-providers"></a>Classe CIM_DesktopMonitor (provider WMI CIMWin32)

La classe **CIM \_ DesktopMonitor** rappresenta le funzionalità e la gestione del dispositivo logico monitor desktop (CRT).
...
La classe **CIM \_ DesktopMonitor** presenta questi metodi.



| Metodo                                                                    | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-desktopmonitor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ DesktopMonitor** è derivata dalla [**\_ visualizzazione CIM**](cim-display.md).

WMI non implementa questa classe. Per ulteriori informazioni sulle classi derivate da **CIM \_ DesktopMonitor**, vedere [Win32 Classes](win32-provider.md).
