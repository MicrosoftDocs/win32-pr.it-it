...
---
# <a name="reset-method-of-the-cim_cdromdrive-class"></a>Metodo Reset della classe CIM \_ CDROMDrive

Il metodo **Reset** della classe CIM \_ CDROMDrive richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
