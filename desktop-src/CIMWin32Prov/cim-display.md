---
description: La classe CIM Display è una classe padre per il raggruppamento di \_ dispositivi di visualizzazione vari.
ms.assetid: e7cd03b1-bc43-4eb0-a591-104a0d250e82
ms.tgt_platform: multiple
title: CIM_Display classe (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119321231"
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>CIM_Display classe (provider WMI CIMWin32)

La **classe CIM \_ Display** è una classe padre per il raggruppamento di dispositivi di visualizzazione vari.
...
La **classe CIM \_ Display** ha questi tipi di membri:
...
La **classe CIM \_ Display** include questi metodi.
...
La **classe CIM \_ Display** ha queste proprietà.
...
Stringa in formato libero che fornisce informazioni sull'errore registrato nelle azioni correttive della proprietà **LastErrorCode** da eseguire.
...
La **classe CiM \_ Display** è derivata da [**CIM \_ UserDevice.**](cim-userdevice.md)

WMI non implementa questa classe. Per le classi derivate **da CIM \_ Display,** vedere [Classi Win32.](win32-provider.md)
