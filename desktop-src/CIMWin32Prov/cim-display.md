...
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>Classe CIM_Display (provider WMI CIMWin32)

La classe di **\_ visualizzazione CIM** è una classe padre per il raggruppamento di periferiche di visualizzazione varie.
...
La classe di **\_ visualizzazione CIM** presenta questi tipi di membri:
...
La classe di **\_ visualizzazione CIM** presenta questi metodi.
...
La classe di **\_ visualizzazione CIM** presenta queste proprietà.
...
La classe di **\_ visualizzazione CIM** è derivata da [**CIM \_ UserDevice**](cim-userdevice.md).

WMI non implementa questa classe. Per le classi derivate dalla **\_ visualizzazione CIM**, vedere [classi Win32](win32-provider.md).
