...
La **classe CIM \_ VersionCompatibilityCheck** ha queste proprietà.
...
Se **TRUE,** l'elemento software può passare allo stato successivo indipendentemente dal fatto che nell'ambiente esista già un elemento software della stessa versione.
