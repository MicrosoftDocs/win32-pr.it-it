...
---
# <a name="cim_versioncompatibilitycheck-class"></a>CIM \_ VersionCompatibilityCheck (classe)
...
La classe **CIM \_ VersionCompatibilityCheck** presenta questi tipi di membri:
...
La classe **CIM \_ VersionCompatibilityCheck** presenta questi metodi.



| Metodo                                                                 | Descrizione                                                   |
|:-----------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-versioncompatibilitycheck.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ VersionCompatibilityCheck** dispone di queste proprietà.
...
Se **true**, l'elemento software è in grado di passare allo stato successivo indipendentemente dal fatto che sia già presente nell'ambiente una versione superiore o più recente dell'elemento software.
...
Controlla la possibilità di configurare più versioni di un prodotto in un sistema.
...
Se **true**, l'elemento software può passare allo stato successivo indipendentemente dal fatto che un elemento software della stessa versione esista già nell'ambiente.
