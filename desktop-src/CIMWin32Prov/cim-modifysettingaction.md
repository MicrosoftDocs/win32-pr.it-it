...
---
# <a name="cim_modifysettingaction-class"></a>CIM \_ ModifySettingAction (classe)

La classe **CIM \_ ModifySettingAction** rappresenta le informazioni per la modifica di un file di impostazioni specifico, per una voce specifica, con un valore specifico.
...
La classe **CIM \_ ModifySettingAction** presenta questi tipi di membri:
...
La classe **CIM \_ ModifySettingAction** presenta questi metodi.



| Metodo                                                           | Descrizione                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-modifysettingaction.md) | Esegue un'azione specifica. Non implementato da WMI.<br/> |
...
La classe **CIM \_ ModifySettingAction** dispone di queste proprietà.
...
Tipo di azione da eseguire sulla voce di impostazione specificata. Si presuppone che le aggiunte siano sensibili alla distinzione tra maiuscole e minuscole. Tuttavia, si presuppone che non venga fatta distinzione tra maiuscole e minuscole.

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**Creazione** (0)


</dt> <dd>

Crea la voce specificata.

</dd> <dt>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Elimina** (1)


</dt> <dd>

Elimina la voce specificata.

</dd> <dt>

<span id="Append"></span><span id="append"></span><span id="APPEND"></span>

<span id="Append"></span><span id="append"></span><span id="APPEND"></span>**Accoda** (2)


</dt> <dd>

Aggiunge alla fine della voce specificata.

</dd> <dt>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**Rimuovi** (3)


</dt> <dd>

Rimuove il valore dalla voce specificata.
...
Valore da aggiungere, aggiungere o per sostituire l'impostazione specificata.
...
Nome file della voce del file di impostazione da modificare.
...
Chiave della sezione della voce di impostazione da modificare.
...
La classe **CIM \_ ModifySettingAction** è derivata dall' [**\_ azione CIM**](cim-action.md).
