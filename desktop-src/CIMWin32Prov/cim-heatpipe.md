...
---
# <a name="cim_heatpipe-class"></a>CIM \_ HeatPipe (classe)

La classe **CIM \_ HeatPipe** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento con pipe di calore.
...
La classe **CIM \_ HeatPipe** presenta questi tipi di membri:
...
La classe **CIM \_ HeatPipe** presenta questi metodi.



| Metodo                                                              | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-heatpipe.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ HeatPipe** dispone di queste proprietà.
...
WMI non implementa questa classe. Per le classi derivate da **CIM \_ HeatPipe**, vedere [Win32 Classes](win32-provider.md).
