---
description: La classe CIM \_ HeatPipe rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento a pipe termica.
ms.assetid: 55cbf645-12d8-4f17-a894-43195d42de0e
ms.tgt_platform: multiple
title: CIM_HeatPipe classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119923711"
---
# <a name="cim_heatpipe-class"></a>Classe \_ CIM HeatPipe

La **classe CIM \_ HeatPipe** rappresenta le funzionalità e la gestione di un dispositivo di raffreddamento a pipe termica.
...
La **classe \_ CIM HeatPipe** ha questi tipi di membri:
...
La **classe \_ CIM HeatPipe** include questi metodi.



| Metodo                                                              | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-heatpipe.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CIM HeatPipe** ha queste proprietà.
...
La **classe CIM \_ HeatPipe** è derivata da [**CIM \_ CoolingDevice**](cim-coolingdevice.md).

WMI non implementa questa classe. Per le classi derivate **da CIM \_ HeatPipe,** vedere [Classi Win32](win32-provider.md).
