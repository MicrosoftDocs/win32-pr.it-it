...
---
# <a name="copy-method-of-the-cim_logicalfile-class"></a>Metodo Copy della classe CIM \_ LogicalFile

Il metodo **Copy** copia il file logico o la directory specificata nel percorso dell'oggetto nel percorso specificato dal parametro di input.
