---
description: Oggetto ParallelPort Win32 \_ &\# 32; La classe WMI rappresenta le proprietà di una porta parallela in un computer che esegue Windows.
ms.assetid: 986bd27f-71b0-4a40-a421-a8bfc0f081be
ms.tgt_platform: multiple
title: Win32_ParallelPort classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119972251"
---
# <a name="win32_parallelport-class"></a>Classe ParallelPort Win32 \_

La classe [WMI](../wmisdk/retrieving-a-class.md) **Win32 \_ ParallelPort** rappresenta le proprietà di una porta parallela in un computer che esegue Windows.
...
La **classe \_ ParallelPort Win32** include questi tipi di membri:
...
La **classe \_ ParallelPort Win32** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ ParallelController.**](cim-parallelcontroller.md)<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ ParallelController.**](cim-parallelcontroller.md)<br/> |
...
La **classe \_ ParallelPort Win32** ha queste proprietà.
...
Qualificatori: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Parallel Ports \| 003.8"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Matrice delle funzionalità del controller parallelo.

Questa proprietà viene ereditata da [**CIM \_ ParallelController.**](cim-parallelcontroller.md)
...
Qualificatori: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**Funzionalità di**")
</dt> </dl>

Matrice di spiegazioni più dettagliate per qualsiasi funzionalità del controller parallelo indicata nella matrice **Capabilities.** Ogni voce di questa matrice è correlata alla voce nella matrice **Capabilities** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Parallel Ports \| 003.7")
</dt> </dl>

Se **TRUE,** la porta parallela supporta DMA.
...
Se **TRUE,** l'errore segnalato in **LastErrorCode** viene cancellato.
...
Altre informazioni sull'errore registrato in **LastErrorCode** e informazioni sulle azioni correttive che potrebbero essere eseguite.
...
Se **TRUE,** la porta parallela è stata rilevata automaticamente dal sistema operativo. Se **FALSE,** la porta è stata rilevata con altri mezzi, ad esempio l'aggiunta manuale tramite il Pannello di controllo.
...
Se **TRUE,** il dispositivo può essere gestito dall'alimentazione, ovvero può essere messo in modalità di sospensione e così via. La proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate, ma solo che il dispositivo logico è in grado di eseguire il risparmio energia.
...
Questa proprietà viene ereditata dal [**\_ controller CIM.**](cim-controller.md) I valori sono indicati nell'elenco seguente.
...
La **classe \_ ParallelPort Win32** è derivata da [**CIM \_ ParallelController.**](cim-parallelcontroller.md)
