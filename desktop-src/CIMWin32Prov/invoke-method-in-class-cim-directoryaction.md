...
---
# <a name="invoke-method-of-the-cim_directoryaction-class"></a>Metodo Invoke della classe CIM \_ DirectoryAction

Il metodo **Invoke** della classe [**CIM \_ DirectoryAction**](cim-directoryaction.md) esegue una determinata azione. I dettagli relativi all'esecuzione dell'azione da parte del metodo sono specifici dell'implementazione. Questo metodo viene ereditato dall' [**\_ azione CIM**](cim-action.md).
