...
---
# <a name="reset-method-of-the-cim_scsicontroller-class"></a>Metodo Reset della classe CIM \_ controller SCSI

Il metodo **Reset** della classe CIM \_ controller SCSI richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Controller SCSI CIM](reset-method-in-class-cim-scsicontroller.md)
</dt> <dt>
