...
---
# <a name="win32_systemslot-class"></a>Win32 \_ SystemSlot (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ SystemSlot Win32** rappresenta punti di connessione fisici, tra cui porte, slot della scheda madre e periferiche e punti di connessione proprietari.
...
La classe **Win32 \_ SystemSlot** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ SystemSlot** dispone di queste proprietà.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| tipo 9 \| bus number")
</dt> </dl>

Numero del bus di SMBIOS.

Questo valore deriva dal membro **bus number** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Stringa in formato libero che descrive la configurazione del PIN e l'utilizzo del segnale di un connettore fisico.
...
Qualificatori: [**override**](../wmisdk/standard-qualifiers.md) ("ConnectorType"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| tipo di slot di tipo 9 SMBIOS \| ")
</dt> </dl>

Matrice di attributi fisici del connettore usato da questo slot.

Questo valore deriva dal membro di **tipo slot** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Nome della prima classe concreta visualizzata nella catena di ereditarietà utilizzata per la creazione di un'istanza. Se utilizzata con le altre proprietà chiave di una classe, questa proprietà consente di identificare in modo univoco tutte le istanze di questa classe e le relative sottoclassi.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| tipo 9 \| Current Usage")
</dt> </dl>

Stato di utilizzo dello slot di sistema.

Questo valore deriva dal membro di **utilizzo corrente** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| tipo 9 \| dispositivo numero")
</dt> </dl>

Numero del dispositivo SMBIOS.

Questo valore deriva dal membro del **numero di dispositivo/funzione** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 9 \| Function Number")
</dt> </dl>

Numero della funzione SMBIOS.
...
Altezza massima di una scheda di scheda che può essere inserita nello slot, in pollici.

Questa proprietà viene ereditata [**dallo \_ slot CIM**](cim-slot.md).
...
Lunghezza massima di una scheda di scheda che può essere inserita nello slot, in pollici.
...
Qualificatori: [**override**](../wmisdk/standard-qualifiers.md) ("MaxDataWidth"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| System Slot \| 004,3 "), [**unità**](../wmisdk/standard-qualifiers.md) (" bits ")
</dt> </dl>

Larghezza massima del bus delle schede di scheda che possono essere inserite in questo slot, in bit. Può corrispondere a uno dei valori seguenti.

Questo valore deriva dal membro della **larghezza del bus di dati dello slot** della struttura degli slot di **sistema** nelle informazioni SMBIOS.
...
Larghezza dati massima (bit): 128
...
Etichetta per l'oggetto. Quando è sottoclassata, è possibile eseguire l'override di questa proprietà in modo che sia una proprietà chiave.
...
Numero di slot fisico che può essere usato come indice in una tabella degli slot di sistema, indipendentemente dal fatto che lo slot sia fisicamente vuoto.

Questo valore deriva dal membro dello **slot ID** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Dati aggiuntivi, ovvero più di informazioni sui tag asset, che possono essere usati per identificare un elemento fisico. Un esempio è costituito dai dati del codice a barre associati a un elemento che dispone anche di un tag asset. Si noti che se sono disponibili solo i dati del codice a barre ed è univoco o può essere utilizzato come chiave di elemento, questa proprietà è **null** e i dati di codice a barre vengono utilizzati come chiave della classe nella proprietà **tag** .
...
Numero di parte che il produttore o il produttore assegna all'elemento fisico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 9 \| slot caratteristiche 2")
</dt> </dl>

Se **true**, questo slot supporta il segnale di risparmio energia (PME) del bus PCI.

Questo valore deriva dal membro **slot caratteristiche 2** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ slot**](cim-slot.md).**SpecialPurpose**")
</dt> </dl>

Stringa in formato libero che descrive il modo in cui questo slot è fisicamente univoco e può mantenere tipi speciali di hardware. Questa proprietà ha un significato solo quando la proprietà corrispondente **SpecialPurpose** è **true**.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("numero di gruppo di segmenti SMBIOS di \| tipo 9 \| ")
</dt> </dl>

Numero del gruppo di segmenti SMBIOS.

Questo valore deriva dal membro **numero di gruppo segmento** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 9 \| slot Caratteristiche 1")
</dt> </dl>

Se il valore è **true**, due o più slot condividono un percorso sul battiscopa, ad esempio uno slot condiviso PCI/EISA.

Questo valore deriva dal membro **slot Caratteristiche 1** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 9 \| slot designation")
</dt> </dl>

Stringa SMBIOS che identifica la designazione dello slot di sistema dello slot sulla scheda madre.

Esempio: "PCI-1"

Questo valore deriva dal membro della **designazione slot** della struttura degli **slot di sistema** nelle informazioni SMBIOS.
...
Qualificatori: [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ slot**](cim-slot.md).**PurposeDescription**")
</dt> </dl>

Se **true**, questo slot è fisicamente univoco e può ospitare tipi speciali di hardware, ad esempio uno slot del processore di grafica. Se **true**, **PurposeDescription** deve specificare la natura dell'unicità o lo scopo dello slot.
...
Slot di sistema rappresentato da un'istanza di questa classe.

Questa proprietà viene ereditata da [**CIM \_ PhysicalElement**](cim-physicalelement.md).

Esempio: "System slot 1"
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Slot di sistema DMTF \| 004,11 "), [**unità**](../wmisdk/standard-qualifiers.md) (" milliwatt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Slot di sistema DMTF \| 004,9 ")
</dt> </dl>

Matrice di interi enumerati che indica la tensione Vcc supportata da questo slot.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Slot di sistema DMTF \| 004,10 ")
</dt> </dl>

Matrice di interi enumerati che indica la tensione VPP supportata da questo slot.
...
La classe **Win32 \_ SystemSlot** è derivata dallo [**\_ slot CIM**](cim-slot.md).
