...
---
# <a name="cim_alarmdevice-class"></a>CIM \_ AlarmDevice (classe)

La classe **CIM \_ AlarmDevice** è un dispositivo di allarme che emette indicazioni udibili o visibili correlate alla situazione di un problema.
...
La classe **CIM \_ AlarmDevice** presenta questi tipi di membri:
...
La classe **CIM \_ AlarmDevice** presenta questi metodi.



| Metodo                                                                 | Descrizione                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-alarmdevice.md)                 | Richiede la reimpostazione di un dispositivo logico. Non implementato da WMI.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | Imposta lo stato di alimentazione desiderato per un dispositivo logico e quando il dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
| [**SetUrgency**](seturgency-method-in-class-cim-alarmdevice.md)       | Imposta il livello di urgenza desiderato per l'allarme. Non implementato da WMI.<br/>                                                        |
...
La classe **CIM \_ AlarmDevice** dispone di queste proprietà.
...
Valore enumerato che indica la frequenza relativa con cui l'allarme lampeggia, vibra o emette toni acustici.
...
<span id="Informational"></span><span id="informational"></span><span id="INFORMATIONAL"></span>**Informativo** (3)
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**Non critico** (4)
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**Irreversibile** (6)
...
Se **true**, l'allarme è visibile.

</dd> </dl>

## <a name="remarks"></a>Commenti

La classe **CIM \_ AlarmDevice** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
