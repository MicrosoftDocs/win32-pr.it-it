...
title: Win32_PnPDevicePropertySint8 classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118008753"
---
# <a name="win32_pnpdevicepropertysint8-class"></a>Classe Win32 \_ PnPDevicePropertySint8

Rappresenta una proprietà del dispositivo PnP di tipo **Sint8.**
...
La **classe Win32 \_ PnPDevicePropertySint8** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe Win32 \_ PnPDevicePropertySint8** ha queste proprietà.
...
Nome della coppia di chiavi Name-Value che identifica la **proprietà** Data.
