...
---
# <a name="win32_pcmciacontroller-class"></a>Win32 \_ PCMCIAController (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **Win32 \_ PCMCIAController** gestisce le funzionalità di un dispositivo controller scheda di interfaccia della scheda di memoria (PCMCIA) del computer personale.
...
La classe **Win32 \_ PCMCIAController** presenta questi tipi di membri:
...
La classe **Win32 \_ PCMCIAController** presenta questi metodi.
...
La classe **Win32 \_ PCMCIAController** dispone di queste proprietà.
...
Questa proprietà viene ereditata [**dal \_ controller CIM**](cim-controller.md). I valori vengono visualizzati nell'elenco seguente.
...
La classe **Win32 \_ PCMCIAController** è derivata da [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
