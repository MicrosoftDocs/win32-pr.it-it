...
---
# <a name="reset-method-of-the-cim_logicaldisk-class"></a>Metodo Reset della classe CIM \_ disco logico

Il metodo **Reset** della classe CIM \_ disco logico richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Disco logico CIM](reset-method-in-class-cim-logicaldisk.md)
</dt> <dt>
