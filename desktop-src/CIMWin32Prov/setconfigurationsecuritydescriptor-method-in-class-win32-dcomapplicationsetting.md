---
description: Aggiorna il descrittore di sicurezza di configurazione dell'applicazione DCOM con un nuovo descrittore di sicurezza definito da un'istanza di una classe \_ SecurityDescriptor Win32.
...
ms.locfileid: "119760161"
---
# <a name="setconfigurationsecuritydescriptor-method-of-the-win32_dcomapplicationsetting-class"></a>Metodo SetConfigurationSecurityDescriptor della classe \_ DCOMApplicationSetting Win32

Il **metodo SetConfigurationSecurityDescriptor** aggiorna il descrittore di sicurezza di configurazione dell'applicazione DCOM con un nuovo descrittore di sicurezza definito da un'istanza di una [**classe \_ SecurityDescriptor Win32.**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor) Questo descrittore di sicurezza controlla chi è autorizzato a configurare l'applicazione. L'account che esegue lo script o l'applicazione che chiama questo metodo deve avere i privilegi **SeSecurityPrivilege** e **SeRestorePrivilege.** Per altre informazioni, vedere [Modifica della sicurezza degli accessi in oggetti a protezione diretta](/windows/desktop/WmiSdk/changing-access-security-on-securable-objects).
