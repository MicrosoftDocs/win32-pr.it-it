---
description: La classe CiM Sensor rappresenta un dispositivo hardware in grado di misurare le caratteristiche di una proprietà fisica, ad esempio le caratteristiche di temperatura o tensione di un \_ sistema informatico unitario.
ms.assetid: e14629db-830d-4bb8-8d1e-4f01c24f4082
ms.tgt_platform: multiple
title: CIM_Sensor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119919941"
---
# <a name="cim_sensor-class"></a>Classe sensore \_ CIM

La **classe CiM \_ Sensor** rappresenta un dispositivo hardware in grado di misurare le caratteristiche di una proprietà fisica, ad esempio le caratteristiche di temperatura o tensione di un sistema informatico unitario.
...
La **classe CiM \_ Sensor** ha questi tipi di membri:
...
La **classe CiM \_ Sensor** include questi metodi.



| Metodo                                                            | Descrizione                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-sensor.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-sensor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CiM \_ Sensor** ha queste proprietà.
...
La **classe \_ Sensor CIM** è derivata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)

WMI non implementa questa classe. Per le classi WMI derivate **dal \_ sensore CIM,** vedere [Classi Win32.](win32-provider.md)
