...
---
# <a name="cim_sensor-class"></a>\_Classe del sensore CIM

La classe del **\_ sensore CIM** rappresenta un dispositivo hardware in grado di misurare le caratteristiche di una proprietà fisica, ad esempio le caratteristiche di temperatura o di tensione di un sistema di computer.
...
La classe del **\_ sensore CIM** presenta questi tipi di membri:
...
La classe del **\_ sensore CIM** presenta questi metodi.



| Metodo                                                            | Descrizione                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-sensor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe del **\_ sensore CIM** dispone di queste proprietà.
...
La classe del **\_ sensore CIM** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
