---
description: Il metodo SetPowerState della classe CIM VolatileStorage imposta lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve \_ essere inserito in tale stato.
ms.assetid: e96a9a99-74c3-48a6-b697-9fcbc14abc27
ms.tgt_platform: multiple
title: Metodo SetPowerState della CIM_VolatileStorage classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
