...
---
# <a name="cim_processor-class-cimwin32-wmi-providers"></a>Classe CIM_Processor (provider WMI CIMWin32)

La classe del **\_ processore CIM** rappresenta le funzionalità e la gestione del dispositivo logico del processore.
...
La classe del **\_ processore CIM** presenta questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-processor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-processor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
Larghezza degli indirizzi del processore, in bit.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 006,6 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" megahertz ")
</dt> </dl>

Velocità corrente (in megahertz) del processore.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 014,3 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processore CIM**.**OtherFamilyDescription**")
</dt> </dl>

Tipo di famiglia del processore.

Questa proprietà viene ereditata **dal \_ processore CIM**.
...
<span id="Pentium_R__processor_with_MMX_TM__technology"></span><span id="pentium_r__processor_with_mmx_tm__technology"></span><span id="PENTIUM_R__PROCESSOR_WITH_MMX_TM__TECHNOLOGY"></span>**Processore Pentium (R) con tecnologia MMX (TM)** (14)


</dt> <dd>

Processore Pentium con tecnologia MMX
...
<span id="M1_Family"></span><span id="m1_family"></span><span id="M1_FAMILY"></span>**Famiglia M1** (18)
...
<span id="M2_Family"></span><span id="m2_family"></span><span id="M2_FAMILY"></span>**Famiglia m2** (19)
...
<span id="K5_Family"></span><span id="k5_family"></span><span id="K5_FAMILY"></span>**Famiglia K5** (24)


</dt> <dd>

Famiglia di processori AMD Duron

</dd> <dt>

<span id="K6_Family"></span><span id="k6_family"></span><span id="K6_FAMILY"></span>

<span id="K6_Family"></span><span id="k6_family"></span><span id="K6_FAMILY"></span>**Famiglia K6** (25)
...
<span id="AMD_Athlon_TM__Processor_Family"></span><span id="amd_athlon_tm__processor_family"></span><span id="AMD_ATHLON_TM__PROCESSOR_FAMILY"></span>**Famiglia di processori AMD Athlon (TM)** (28)
...
<span id="AMD_R__Duron_TM__Processor"></span><span id="amd_r__duron_tm__processor"></span><span id="AMD_R__DURON_TM__PROCESSOR"></span>**Processore AMD (R) Duron (TM)** (29)


</dt> <dd>

Processore AMD Duron

</dd> <dt>

<span id="AMD29000_Family"></span><span id="amd29000_family"></span><span id="AMD29000_FAMILY"></span>

<span id="AMD29000_Family"></span><span id="amd29000_family"></span><span id="AMD29000_FAMILY"></span>**Famiglia AMD29000** (30)
...
<span id="Power_PC_Family"></span><span id="power_pc_family"></span><span id="POWER_PC_FAMILY"></span>**Famiglia Power PC** (32)
...
<span id="Alpha_Family"></span><span id="alpha_family"></span><span id="ALPHA_FAMILY"></span>**Famiglia alfa** (48)
...
<span id="Alpha_21064"></span><span id="alpha_21064"></span><span id="ALPHA_21064"></span>**Alfa 21064** (49)
...
<span id="Alpha_21066"></span><span id="alpha_21066"></span><span id="ALPHA_21066"></span>**Alfa 21066** (50)
...
<span id="Alpha_21164"></span><span id="alpha_21164"></span><span id="ALPHA_21164"></span>**Alfa 21164** (51)
...
<span id="Alpha_21164PC"></span><span id="alpha_21164pc"></span><span id="ALPHA_21164PC"></span>**21164PC alfa** (52)
...
<span id="Alpha_21164a"></span><span id="alpha_21164a"></span><span id="ALPHA_21164A"></span>**21164A alfa** (53)
...
<span id="Alpha_21264"></span><span id="alpha_21264"></span><span id="ALPHA_21264"></span>**Alfa 21264** (54)
...
<span id="Alpha_21364"></span><span id="alpha_21364"></span><span id="ALPHA_21364"></span>**Alfa 21364** (55)
...
<span id="MIPS_Family"></span><span id="mips_family"></span><span id="MIPS_FAMILY"></span>**Famiglia MIPS** (64)
...
<span id="MIPS_R4000"></span><span id="mips_r4000"></span>**R4000 MIPS** (65)
...
<span id="MIPS_R4200"></span><span id="mips_r4200"></span>**R4200 MIPS** (66)
...
<span id="MIPS_R4400"></span><span id="mips_r4400"></span>**R4400 MIPS** (67)
...
<span id="MIPS_R4600"></span><span id="mips_r4600"></span>**R4600 MIPS** (68)
...
<span id="MIPS_R10000"></span><span id="mips_r10000"></span>**R10000 MIPS** (69)
...
<span id="SPARC_Family"></span><span id="sparc_family"></span><span id="SPARC_FAMILY"></span>**Famiglia Sparc** (80)
...
<span id="68xxx_Family"></span><span id="68xxx_family"></span><span id="68XXX_FAMILY"></span>**famiglia 68xxx** (97)
...
<span id="Hobbit_Family"></span><span id="hobbit_family"></span><span id="HOBBIT_FAMILY"></span>**Famiglia Hobbit** (112)
...
<span id="Itanium_TM__Processor"></span><span id="itanium_tm__processor"></span><span id="ITANIUM_TM__PROCESSOR"></span>**Processore Itanium (TM)** (130)
...
<span id="AMD_Athlon_TM__64_Processor_Family"></span><span id="amd_athlon_tm__64_processor_family"></span><span id="AMD_ATHLON_TM__64_PROCESSOR_FAMILY"></span>**Famiglia di processori AMD Athlon (TM) 64** (131)
...
<span id="AMD_Opteron_TM__Family"></span><span id="amd_opteron_tm__family"></span><span id="AMD_OPTERON_TM__FAMILY"></span>**Famiglia AMD Opteron (TM)** (132)


</dt> <dd>

Famiglia AMD Opteron

</dd> <dt>

<span id="PA-RISC_Family"></span><span id="pa-risc_family"></span><span id="PA-RISC_FAMILY"></span>

<span id="PA-RISC_Family"></span><span id="pa-risc_family"></span><span id="PA-RISC_FAMILY"></span>**Famiglia PA-RISC** (144)
...
<span id="V30_Family"></span><span id="v30_family"></span><span id="V30_FAMILY"></span>**Famiglia V30** (160)
...
<span id="Pentium_R__III_Processor_with_Intel_R__SpeedStep_TM__Technology"></span><span id="pentium_r__iii_processor_with_intel_r__speedstep_tm__technology"></span><span id="PENTIUM_R__III_PROCESSOR_WITH_INTEL_R__SPEEDSTEP_TM__TECHNOLOGY"></span>**Processore Pentium (r) III con tecnologia Intel (r) SpeedStep (TM)** (177)


</dt> <dd>

Processore Pentium III con tecnologia Intel SpeedStep
...
<span id="AS400_Family"></span><span id="as400_family"></span><span id="AS400_FAMILY"></span>**Famiglia AS400** (180)
...
<span id="Intel_R__Xeon_TM__processor_MP"></span><span id="intel_r__xeon_tm__processor_mp"></span><span id="INTEL_R__XEON_TM__PROCESSOR_MP"></span>**MP processore Intel (R) Xeon (TM)** (181)


</dt> <dd>

MP processore Intel Xeon

</dd> <dt>

<span id="AMD_AthlonXP_TM__Family"></span><span id="amd_athlonxp_tm__family"></span><span id="AMD_ATHLONXP_TM__FAMILY"></span>

<span id="AMD_AthlonXP_TM__Family"></span><span id="amd_athlonxp_tm__family"></span><span id="AMD_ATHLONXP_TM__FAMILY"></span>**Famiglia AMD AthlonXP (TM)** (182)


</dt> <dd>

Famiglia AMD AthlonXP

</dd> <dt>

<span id="AMD_AthlonMP_TM__Family"></span><span id="amd_athlonmp_tm__family"></span><span id="AMD_ATHLONMP_TM__FAMILY"></span>

<span id="AMD_AthlonMP_TM__Family"></span><span id="amd_athlonmp_tm__family"></span><span id="AMD_ATHLONMP_TM__FAMILY"></span>**Famiglia AMD AthlonMP (TM)** (183)


</dt> <dd>

Famiglia AMD AthlonMP
...
<span id="Intel_Pentium_M_Processor"></span><span id="intel_pentium_m_processor"></span><span id="INTEL_PENTIUM_M_PROCESSOR"></span>**Processore Intel Pentium M** (185)
...
<span id="IBM390_Family"></span><span id="ibm390_family"></span><span id="IBM390_FAMILY"></span>**Famiglia IBM390** (200)
...
<span id="z_Architecture_base"></span><span id="z_architecture_base"></span><span id="Z_ARCHITECTURE_BASE"></span>**base z/Architecture** (204)
...
<span id="i960"></span><span id="I960"></span>**1960** (251)
...
<span id="Video_Processor"></span><span id="video_processor"></span><span id="VIDEO_PROCESSOR"></span>**Processore video** (500)
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIB. IETF \| host-Resources-MIB. hrProcessorLoad "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" percentuale ")
</dt> </dl>

Caricamento del processore, medio nell'ultimo minuto, in percentuale.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 006,5 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" megahertz ")
</dt> </dl>

Velocità massima (in megahertz) del processore.
...
Descrizione del tipo di famiglia del processore. Questa proprietà viene utilizzata quando la proprietà **Family** è impostata su 1 ("other"). Questa stringa deve essere impostata su null se la proprietà **Family** è un valore diverso da 1.
...
Identificatore Plug and Play dispositivo del dispositivo logico. Questa proprietà viene ereditata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
Stringa in formato libero che descrive il ruolo del processore. Ad esempio, "Central Processor" o "Math Processor".
...
Stringa in formato libero che indica il livello di revisione del processore all'interno della famiglia di processori.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 006,7 ")
</dt> </dl>

Informazioni sul socket della CPU, che includono i dati su come aggiornare il processore (se sono supportati gli aggiornamenti).
...
<span id="Daughter_Board"></span><span id="daughter_board"></span><span id="DAUGHTER_BOARD"></span>**Scheda figlia** (3)
...
<span id="ZIF_Socket"></span><span id="zif_socket"></span><span id="ZIF_SOCKET"></span>**Socket** se (4)
...
<span id="Replacement_Piggy_Back"></span><span id="replacement_piggy_back"></span><span id="REPLACEMENT_PIGGY_BACK"></span>**Sostituzione/piggy indietro** (5)


</dt> <dd>

Sostituzione o Piggy Back

</dd> <dt>

<span id="None"></span><span id="none"></span><span id="NONE"></span>

<span id="None"></span><span id="none"></span><span id="NONE"></span>**Nessuno** (6)
...
<span id="LIF_Socket"></span><span id="lif_socket"></span><span id="LIF_SOCKET"></span>**Socket LIF** (7)
...
<span id="370_Pin_Socket"></span><span id="370_pin_socket"></span><span id="370_PIN_SOCKET"></span>**socket Pin 370** (10)
...
La classe del **\_ processore CIM** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI non implementa questa classe. Per le classi WMI derivate dal **\_ processore CIM**, vedere [classi Win32](win32-provider.md).
