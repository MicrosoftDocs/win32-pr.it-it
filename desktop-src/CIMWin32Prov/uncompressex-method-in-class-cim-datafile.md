...
---
# <a name="uncompressex-method-of-the-cim_datafile-class"></a>Metodo UncompressEx della classe del file di \_ DataFile CIM

Il metodo **UncompressEx** decomprime il file di dati logico o la directory specificata nel percorso dell'oggetto. Questo metodo è una versione estesa del metodo [**Decompress**](uncompress-method-in-class-cim-datafile.md) ed è ereditato da [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
Il metodo **UncompressEx** nel file di [**\_ DataFile CIM**](cim-datafile.md) viene implementato da WMI.
...
[**File di \_ DataFile CIM**](uncompressex-method-in-class-cim-datafile.md)
</dt> <dt>
