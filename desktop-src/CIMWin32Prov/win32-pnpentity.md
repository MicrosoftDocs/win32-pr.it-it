---
description: Rappresenta le proprietà di un Plug and Play dispositivo.
ms.assetid: 621f4410-8d8f-4afa-b0f0-beed263f3a13
ms.tgt_platform: multiple
title: Win32_PnPEntity classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118417139"
---
# <a name="win32_pnpentity-class"></a>Classe \_ Win32 PnPEntity

La classe [WMI](../wmisdk/retrieving-a-class.md) **\_ Win32 PnPEntity** rappresenta le proprietà di un Plug and Play dispositivo. Plug and Play entità vengono visualizzate come voci in Gestione dispositivi che si trova in Pannello di controllo.
...
La **classe \_ Win32 PnPEntity** ha questi tipi di membri:
...
La **classe \_ Win32 PnPEntity** include questi metodi.



| Metodo                                                             | Descrizione                                                                                                                                                                                    |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Disabilita**](disable-win32-pnpentity.md)                         | Disabilita questo Plug and Play dispositivo.<br/>                                                                                                                                                 |
| [**Abilita**](enable-win32-pnpentity.md)                           | Abilita questo Plug and Play dispositivo.<br/>                                                                                                                                                  |
| [**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) | Ottiene le proprietà specificate di questo Plug and Play dispositivo.<br/>                                                                                                                         |
...
La **classe \_ Win32 PnPEntity** ha queste proprietà.
...
Identificatore univoco globale (GUID) di questo Plug and Play dispositivo.
...
Identificatore del Plug and Play dispositivo.
...
Stringa di identificazione definita dal fornitore utilizzata dal programma di installazione per associare un dispositivo a un file INF. In genere, a un dispositivo è associato un elenco di ID hardware. Un'eccezione è il driver del bus 1394, che non usa ID hardware. Il primo ID hardware nell'elenco deve essere l'ID dispositivo. Gli ID rimanenti devono essere elencati in ordine di idoneità decrescente.

Gli ID hardware vengono visualizzati in uno dei formati seguenti:

-   \\Enumeratore enumerator-specific-device-ID
...
-   \*ID specifico dell'enumeratore
    ...
    Un asterisco ( \* ) indica l'utilizzo da parte di più di un enumeratore.

-   ID specifico della classe di dispositivi
...
Nome del produttore del dispositivo Plug and Play dispositivo.
...
> [!WARNING]
> Questa proprietà, nonostante sia elencata nel file MOF, non esiste effettivamente nella classe . La proprietà viene descritta qui solo per motivi di completezza e per chiarire il file MOF stesso.

 

Nome del tipo di questo Plug and Play dispositivo.
...
Indica se Plug and Play dispositivo è attualmente nel sistema.
...
Nome del servizio che supporta questo Plug and Play dispositivo. Per altre informazioni, vedere [**Win32 \_ SystemDriverPnPEntity**](win32-systemdriverpnpentity.md).
