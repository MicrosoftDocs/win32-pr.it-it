...
---
# <a name="win32_pnpdevicepropertyuint8-class"></a>Win32 \_ PnPDevicePropertyUint8 (classe)

Rappresenta una proprietà del dispositivo PnP di tipo **Uint8**.
...
La classe **Win32 \_ PnPDevicePropertyUint8** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ PnPDevicePropertyUint8** dispone di queste proprietà.
