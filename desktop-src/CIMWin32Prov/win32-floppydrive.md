---
description: La classe \_ WMI Win32 FloppyDrive gestisce le funzioni di un'unità disco floppy.
ms.assetid: 41823eeb-4831-4deb-a798-7b3589ebf3e2
ms.tgt_platform: multiple
title: Win32_FloppyDrive classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119816671"
---
# <a name="win32_floppydrive-class"></a>Classe \_ FloppyDrive Win32

\[**Win32 \_ FloppyDrive** non è più disponibile per l'uso a Windows 10 e Windows Server 2016.\]

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 FloppyDrive** gestisce le funzioni di un'unità disco floppy.
...
La **classe Win32 \_ FloppyDrive** include questi tipi di membri:
...
La **classe \_ FloppyDrive Win32** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                                   |
|:------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per altre informazioni su come implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ DisketteDrive.**](cim-diskettedrive.md)<br/>                 |
| **SetPowerState** | Non implementato. Per altre informazioni su come implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ DisketteDrive.**](cim-diskettedrive.md)<br/> |
...
La **classe \_ FloppyDrive Win32** ha queste proprietà.
...
Risparmio energia - Modalità risparmio energia basso
...
Il dispositivo non funziona, ma può essere ripristinato rapidamente a pieno consumo.
...
Matrice di funzionalità del dispositivo di accesso ai supporti. Ad esempio, il dispositivo può supportare accesso casuale, supporti rimovibili e pulizia automatica. In questo caso, i valori 3, 7 e 9 vengono scritti nella matrice .
...
Se **True,** il dispositivo di accesso ai supporti richiede la pulizia. La proprietà Capabilities indica se è possibile eseguire la pulizia manuale **o** automatica.
...
Modalità risparmio energia immesse automaticamente
...
La **classe Win32 \_ FloppyDrive** è derivata da [**CIM \_ DisketteDrive**](cim-diskettedrive.md) che deriva da [**CIM \_ MediaAccessDevice.**](cim-mediaaccessdevice.md) La **classe \_ CIM MediaAccessDevice** deriva da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
