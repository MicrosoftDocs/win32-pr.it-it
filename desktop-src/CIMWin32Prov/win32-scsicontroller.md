---
description: La classe WMI Win32 \_ SCSIController rappresenta un controller SCSI in un computer che esegue Windows.
ms.assetid: 14ed523e-d505-40fa-81d5-3a71eb9f078e
ms.tgt_platform: multiple
title: Win32_SCSIController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119917591"
---
# <a name="win32_scsicontroller-class"></a>Classe SCSIController Win32 \_

La classe [WMI](../wmisdk/retrieving-a-class.md) **Win32 \_ SCSIController** rappresenta un controller SCSI in un computer che esegue Windows.
...
La **classe \_ SCSIController Win32** ha questi tipi di membri:
...
La **classe \_ SCSIController Win32** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ SCSIController.**](cim-scsicontroller.md)<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ SCSIController.**](cim-scsicontroller.md)<br/> |
...
La **classe \_ SCSIController Win32** ha queste proprietà.
...
Numero di timeout che si sono verificati dopo il **valore TimeOfLastReset.**

Questa proprietà viene ereditata da [**CIM \_ SCSIController.**](cim-scsicontroller.md)
...
Qualificatori: [**Chiave**](../wmisdk/key-qualifier.md), [**Override**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi")
</dt> </dl>

Identificatore univoco del controller SCSI con altri dispositivi nel sistema.
...
Qualificatori: [**DEPRECATO,**](../wmisdk/standard-wmi-qualifiers.md) [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort")
</dt> </dl>

Ordine in cui i dispositivi sono elencati con questo controller SCSI.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Services Class \\ \\ \| PortDriver")
</dt> </dl>

Nome file del driver del controller SCSI.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| HWRevision")
</dt> </dl>

Numero di versione hardware del controller SCSI.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort")
</dt> </dl>

Numero di indice del controller SCSI nel Registro di sistema.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| Mfg")
</dt> </dl>

Nome del produttore del controller SCSI.
...
Larghezza massima dei dati (in bit) supportata dal controller SCSI.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DmTF \| Bus Port \| 001.9")
</dt> </dl>

Numero massimo di entità indirizzabili direttamente supportate da questo controller. Se il numero è sconosciuto, deve essere usato il valore 0 (zero).
...
Velocità massima di trasferimento (in bit al secondo) supportata dal controller SCSI.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Archiviazione Controller \| 001.3")
</dt> </dl>

Supporto del controller SCSI per la ridondanza o la protezione da errori del dispositivo.
...
**Protetto tramite SCC (comando controller SCSI-3)** (5)
...
**Protetto tramite SCC-2 (comando controller SCSI-3)** (6)
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DmTF \| Bus Port \| 001.2", "MIF. DMTF \| Disks \| 003.3")
</dt> </dl>

Protocollo usato dal controller per accedere ai dispositivi "controllati".

Questa proprietà viene ereditata dal [**\_ controller CIM.**](cim-controller.md) L'elenco seguente mostra i valori possibili.
...
La **classe \_ SCSIController Win32** è derivata da [**CIM \_ SCSIController**](cim-scsicontroller.md).
