...
Il metodo **Reset** della classe CIM \_ MagnetoOpticalDrive richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
