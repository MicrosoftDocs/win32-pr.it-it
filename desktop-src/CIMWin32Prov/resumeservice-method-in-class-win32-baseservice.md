...
---
# <a name="resumeservice-method-of-the-win32_baseservice-class"></a>Metodo ResumeService della \_ classe BaseService Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ResumeService** tenta di collocare il servizio nello stato resumed.
