...
---
# <a name="win32_pnpdevicepropertystring-class"></a>Win32 \_ PnPDevicePropertyString (classe)

Rappresenta una proprietà del dispositivo PnP di tipo **String**.
...
La classe **Win32 \_ PnPDevicePropertyString** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ PnPDevicePropertyString** dispone di queste proprietà.
