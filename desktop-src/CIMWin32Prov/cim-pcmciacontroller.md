...
---
# <a name="cim_pcmciacontroller-class"></a>CIM \_ PCMCIAController (classe)

La classe **CIM \_ PCMCIAController** rappresenta le funzionalità e la gestione di un controller PCMCIA (Personal Computer Memory Card International Association).
...
La classe **CIM \_ PCMCIAController** presenta questi tipi di membri:
...
La classe **CIM \_ PCMCIAController** presenta questi metodi.



| Metodo                                                                      | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcmciacontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ PCMCIAController** dispone di queste proprietà.
...
Il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("ciclo di alimentazione").
...
Il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("ciclo di alimentazione") e il parametro *ora* impostato su una data e un'ora specifiche, o su un intervallo, per l'accensione.
...
La classe **CIM \_ PCMCIAController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ PCMCIAController**, vedere [Win32 Classes](win32-provider.md).
