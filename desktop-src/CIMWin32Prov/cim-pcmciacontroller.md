---
description: La classe CIM PCMCIAController rappresenta le funzionalità e la gestione di un \_ controller PCMCIA (Personal Computer Memory Card International Association).
ms.assetid: 341cbc6c-dd25-4dea-bcce-cd4e3f4d5324
ms.tgt_platform: multiple
title: CIM_PCMCIAController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118678841"
---
# <a name="cim_pcmciacontroller-class"></a>Classe \_ CIM PCMCIAController

La **classe \_ CIM PCMCIAController** rappresenta le funzionalità e la gestione di un controller PCMCIA (Personal Computer Memory Card International Association).
...
La **classe \_ CIM PCMCIAController** ha questi tipi di membri:
...
La **classe \_ CIM PCMCIAController** dispone di questi metodi.



| Metodo                                                                      | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcmciacontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CIM PCMCIAController** ha queste proprietà.
...
Disponibilità e stato del dispositivo. Questa proprietà viene ereditata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
Il dispositivo è noto per essere in modalità di risparmio energia, ma lo stato esatto in questa modalità è sconosciuto.
...
Il controller PCMCIA non è disponibile.
...
Nome del produttore del controller PCMCIA.
...
Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto o illimitato, è necessario usare il valore 0.
...
Win32 Plug and Play dispositivo del dispositivo logico. Questa proprietà viene ereditata da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
Funzionalità specifiche correlate all'alimentazione del dispositivo logico.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) è supportato.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) può essere richiamato con il *parametro PowerState* impostato su 5 ("Power Cycle").
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("Power Cycle") e il parametro *Time* impostato su una data e un intervallo specifico per l'accensione.
...
La **classe \_ CIM PCMCIAController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ PCMCIAController,** vedere [Classi Win32.](win32-provider.md)
