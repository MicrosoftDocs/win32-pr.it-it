---
description: La classe CIM FileSpecification rappresenta un file che si trova \_ all'esterno o all'esterno del sistema.
ms.assetid: 25d6cc79-1497-4615-9251-8e00524dff1b
ms.tgt_platform: multiple
title: CIM_FileSpecification classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **classe CIM \_ FileSpecification** ha questi tipi di membri:
...
La **classe CIM \_ FileSpecification** include questi metodi.



| Metodo                                                         | Descrizione                                                      |
|:---------------------------------------------------------------|:-----------------------------------------------------------------|
| [**evocare**](invoke-method-in-class-cim-filespecification.md) | Valuta un controllo specifico. Non implementato da WMI.<br/> |
...
La **classe CIM \_ FileSpecification** ha queste proprietà.
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Software Signature \| 002.4")
</dt> </dl>
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Software Signature \| 002.5")
</dt> </dl>

Valore CRC calcolato usando i 512 KB intermedi.
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Software Signature \| 002.6")
</dt> </dl>

Valore CRC per i 512 KB intermedi del file, modulo 3.
...
Qualificatori: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (16)
</dt> </dl>

Algoritmo per il calcolo di un checksum a 128 bit per qualsiasi file o oggetto. La probabilità che due file diversi produca lo stesso checksum MD5 siano molto piccoli (circa 1 in 2^64) e il checksum MD5 di un file può essere usato per costruire un identificatore di contenuto affidabile che probabilmente identifitti in modo univoco il file. È anche vero il contrario. Se due file hanno lo stesso checksum MD5, è molto probabile che i file siano identici. Ai fini della specifica MOF della proprietà MD5, l'algoritmo MD5 genera sempre una stringa di 32 caratteri. Ad esempio, la stringa "abcdefghijklmnopqrstuvwxyz" genera la stringa "c3fcd3d76192e4007dfb496cca67e13b". Per altre informazioni sull'implementazione dell'algoritmo MD5, vedere [RFC 1321](https://www.ietf.org/rfc/rfc1321.txt).
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) (Name), [**Fixed**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (1024)
</dt> </dl>

Nome del file o nome del file con un prefisso di directory.
...
WMI non implementa questa classe. Per le classi derivate **da CIM \_ FileSpecification,** vedere [Classi Win32](win32-provider.md).
