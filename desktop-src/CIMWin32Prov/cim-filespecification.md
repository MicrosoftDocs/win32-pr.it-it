...
La classe **CIM \_ filespecification** presenta questi tipi di membri:
...
La classe **CIM \_ filespecification** presenta questi metodi.



| Metodo                                                         | Descrizione                                                      |
|:---------------------------------------------------------------|:-----------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-filespecification.md) | Valuta un particolare controllo. Non implementato da WMI.<br/> |
...
La classe **CIM \_ filespecification** dispone di queste proprietà.
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Firma del software DMTF \| 002,4 ")
</dt> </dl>
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Firma del software DMTF \| 002,5 ")
</dt> </dl>

Valore CRC calcolato con il medio 512 KB.
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Firma del software DMTF \| 002,6 ")
</dt> </dl>

Valore CRC per la media di 512 KB del file, modulo 3.
...
WMI non implementa questa classe. Per le classi derivate dalla **\_ specifica del filecim**, vedere [classi Win32](win32-provider.md).
