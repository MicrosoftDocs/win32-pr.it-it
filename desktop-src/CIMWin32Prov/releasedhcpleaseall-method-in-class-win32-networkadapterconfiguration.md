...
ms.locfileid: "120077501"
---
# <a name="releasedhcpleaseall-method-of-the-win32_networkadapterconfiguration-class"></a>Metodo ReleaseDHCPLeaseAll della classe NetworkAdapterConfiguration Win32 \_

Il metodo statico della classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ReleaseDHCPLeaseAll** rilascia gli indirizzi IP associati a tutte le schede di rete abilitate per DHCP.

> [!Note]  
> Avviso Se DHCP è abilitato nel sistema del computer locale, l'opzione terminerà tutte le connessioni TCP/IP DHCP.
...
L'esempio di codice VBScript seguente rilascia tutti i lease DHCP attualmente in uso in un computer.
