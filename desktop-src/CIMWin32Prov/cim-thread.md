...
---
# <a name="cim_thread-class"></a>\_Classe thread CIM

La classe di **\_ thread CIM** rappresenta la possibilità di eseguire unità di un processo o di un'attività, in parallelo. Un processo può avere molti thread, ognuno dei quali è debole per il processo.
...
La classe di **\_ thread CIM** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe di **\_ thread CIM** dispone di queste proprietà.
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**CSCreationClassName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**CSName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>
...
Indica la condizione operativa corrente del thread.
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**OSCreationClassName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**OSName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>
...
Urgenza per l'esecuzione di un thread. Un thread può avere una priorità diversa rispetto al processo proprietario. Se queste informazioni non sono disponibili per un thread, è necessario usare un valore pari a 0 (zero).
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**CreationClassName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>

Nome della classe di creazione del processo di definizione dell'ambito.
...
Qualificatori: [**propagato**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ processo CIM**](cim-process.md).**Handle**"), [**chiave**](/windows/desktop/WmiSdk/key-qualifier), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256)
</dt> </dl>

Handle del processo di definizione dell'ambito.
...
La classe di **\_ thread CIM** è derivata da [**CIM \_ LogicalElement**](cim-logicalelement.md).

WMI non implementa questa classe. Per le classi WMI derivate dal **\_ thread CIM**, vedere [classi Win32](win32-provider.md).
