---
description: Il metodo CopyEx copia il file logico (o la directory) specificato nel percorso dell'oggetto nel percorso specificato dal parametro FileName. Questo metodo è una versione estesa del metodo Copy ed è ereditato da CIM \_ LogicalFile.
...
ms.locfileid: "119504881"
---
# <a name="copyex-method-of-the-cim_directory-class"></a>Metodo CopyEx della classe Directory CIM \_

Il **metodo CopyEx** copia il file logico (o la directory) specificato nel percorso dell'oggetto nel percorso specificato dal *parametro FileName.* Questo metodo è una versione estesa del [**metodo Copy**](copy-method-in-class-cim-directory.md) ed è ereditato da [**CIM \_ LogicalFile.**](cim-logicalfile.md)
...
[CIM \_ Directory](copyex-method-in-class-cim-directory.md)
</dt> <dt>
