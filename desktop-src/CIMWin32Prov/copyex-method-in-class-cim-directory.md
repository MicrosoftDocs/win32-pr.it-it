...
---
# <a name="copyex-method-of-the-cim_directory-class"></a>Metodo CopyEx della classe di \_ directory CIM

Il metodo **CopyEx** copia il file logico o la directory specificata nel percorso dell'oggetto nella posizione specificata dal parametro *filename* . Questo metodo è una versione estesa del metodo [**Copy**](copy-method-in-class-cim-directory.md) ed è ereditato da [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[\_Directory CIM](copyex-method-in-class-cim-directory.md)
</dt> <dt>
