...
---
# <a name="win32_refrigeration-class"></a>\_Classe di refrigerazione Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) di **\_ refrigerazione Win32** rappresenta le proprietà di un dispositivo di raffreddamento.
...
La classe di **\_ refrigerazione Win32** presenta questi tipi di membri:
...
La classe di **\_ refrigerazione Win32** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) nella [**\_ refrigerazione CIM**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) nella [**\_ refrigerazione CIM**](cim-refrigeration.md).<br/> |
...
La classe di **\_ refrigerazione Win32** dispone di queste proprietà.
...
Se **true**, il dispositivo di raffreddamento fornisce il raffreddamento attivo, non il raffreddamento passivo.
...
Identificatore univoco del dispositivo di raffreddamento.
...
La classe di **\_ refrigerazione Win32** è derivata [**dalla \_ refrigerazione CIM**](cim-refrigeration.md).
