---
description: Il metodo Elimina classe WMI elimina il file di collegamento logico (o directory) specificato nel percorso dell'oggetto.
...
ms.locfileid: "119080105"
---
# <a name="delete-method-of-the-win32_shortcutfile-class"></a>Metodo Delete della classe ShortcutFile Win32 \_

Il **metodo Elimina** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) elimina il file di collegamento logico (o directory) specificato nel percorso dell'oggetto.
