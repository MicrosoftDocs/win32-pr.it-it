...
---
# <a name="reset-method-of-the-cim_pcicontroller-class"></a>Metodo Reset della classe CIM \_ PCIController

Il metodo **Reset** della classe CIM \_ PCIController richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_PCICONTROLLER CIM](reset-method-in-class-cim-pcicontroller.md)
</dt> <dt>
