...
---
# <a name="win32_programgrouporitem-class"></a>Win32 \_ ProgramGroupOrItem (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) astratta **Win32 \_ ProgramGroupOrItem** rappresenta un raggruppamento logico di programmi nel menu **Start \\ Programs** dell'utente. Contiene gruppi di programmi ed elementi del gruppo di programmi.
...
La classe **Win32 \_ ProgramGroupOrItem** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ ProgramGroupOrItem** dispone di queste proprietà.
...
La classe **Win32 \_ ProgramGroupOrItem** deriva da [**CIM \_ LogicalElement**](cim-logicalelement.md).
