---
description: La classe WMI di associazione DeviceBus Win32 mette in relazione un bus di \_ sistema e un dispositivo logico usando il bus. Questa classe viene usata per individuare i dispositivi su cui si trova il bus.
...
Qualificatori: [**Key,**](/windows/desktop/WmiSdk/key-qualifier) [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Antecedent"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("WMI \| Win32 \_ Bus")
</dt> </dl>

Bus [**Win32 \_**](win32-bus.md) che descrive le proprietà del bus di sistema usato dal dispositivo logico.
...
[**LogicalDevice \_ CIM**](cim-logicaldevice.md) che descrive le proprietà del dispositivo logico che usa il bus di sistema.

</dd> </dl>

## <a name="remarks"></a>Commenti

La **classe \_ DeviceBus Win32** è derivata dalla [**dipendenza CIM \_**](cim-dependency.md).
