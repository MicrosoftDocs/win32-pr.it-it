...
---
# <a name="changesecuritypermissions-method-of-the-win32_shortcutfile-class"></a>Metodo ChangeSecurityPermissions della \_ classe ShortcutFile Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ChangeSecurityPermissions** modifica le autorizzazioni di sicurezza per il file di collegamento logico specificato nel percorso dell'oggetto. Se il file logico è una directory, **ChangeSecurityPermissions** è ricorsivo e modifica le autorizzazioni di sicurezza di tutti i file e le sottodirectory in esso contenuti. **ChangeSecurityPermissions** restituisce un valore intero pari a 0 (zero) se le autorizzazioni vengono modificate e un numero diverso per indicare un errore.
...
Espressione che viene risolta in un'istanza di [**Win32 \_ securityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor). Questo descrittore contiene nuove autorizzazioni di sicurezza per l'istanza del [**\_ paging Win32**](win32-pagefile.md).
...
Privilegi di sicurezza effettivi da modificare. Per modificare, ad esempio, la sicurezza del proprietario e del DACL, usare:
