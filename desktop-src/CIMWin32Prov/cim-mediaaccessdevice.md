---
description: La classe CIM MediaAccessDevice rappresenta la possibilità di accedere a uno o più supporti e quindi di usare i supporti per \_ archiviare e recuperare dati.
ms.assetid: 224a7b08-1566-4b0b-90d8-9991fa188d93
ms.tgt_platform: multiple
title: CIM_MediaAccessDevice classe (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119548231"
---
# <a name="cim_mediaaccessdevice-class-cimwin32-wmi-providers"></a>CIM_MediaAccessDevice classe (provider WMI CIMWin32)

La **classe CIM \_ MediaAccessDevice** rappresenta la possibilità di accedere a uno o più supporti e quindi di usare i supporti per archiviare e recuperare dati.
...
| Metodo                                                                       | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-mediaaccessdevice.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-mediaaccessdevice.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
Stringa in formato libero che indica l'algoritmo o lo strumento utilizzato per comprimere il file logico. Se non è possibile descrivere lo schema di compressione (perché è sconosciuto), usare il comando seguente:Se , usare "Sconosciuto". Se , usare "Compressed". , usare "Not Compressed".
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Sequential Access Devices \| 001.2"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("kilobytes")
</dt> </dl>

Dimensioni massime, in kilobyte, dei supporti supportati da questo dispositivo. I kilobyte vengono interpretati come il numero di byte moltiplicato per 1000 (non il numero di byte moltiplicato per 1024).
...
Se **TRUE,** il dispositivo di accesso ai supporti deve essere pulito. La possibilità di eseguire la pulizia manuale o automatica è indicata nella proprietà della matrice **Capabilities.**
...
La **classe CIM \_ MediaAccessDevice** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI non implementa questa classe. Per le classi derivate **da CIM \_ MediaAccessDevice,** vedere [Classi Win32](win32-provider.md).
