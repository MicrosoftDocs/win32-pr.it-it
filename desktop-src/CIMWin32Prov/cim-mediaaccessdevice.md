...
---
# <a name="cim_mediaaccessdevice-class-cimwin32-wmi-providers"></a>Classe CIM_MediaAccessDevice (provider WMI CIMWin32)

La classe **CIM \_ MediaAccessDevice** rappresenta la possibilità di accedere a uno o più supporti e quindi di usare il supporto per archiviare e recuperare i dati.
...
| Metodo                                                                       | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-mediaaccessdevice.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
WMI non implementa questa classe. Per le classi derivate da **CIM \_ MediaAccessDevice**, vedere [Win32 Classes](win32-provider.md).
