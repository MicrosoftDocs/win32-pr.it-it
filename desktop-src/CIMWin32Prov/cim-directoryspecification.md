...
---
# <a name="cim_directoryspecification-class"></a>CIM \_ DirectorySpecification (classe)

La classe **CIM \_ DirectorySpecification** acquisisce la struttura di directory principale di un elemento software. Questa classe viene utilizzata per organizzare i file di un elemento software in unità gestibili che possono essere rilocate in un sistema di computer.
...
La classe **CIM \_ DirectorySpecification** presenta questi tipi di membri:
...
La classe **CIM \_ DirectorySpecification** presenta questi metodi.



| Metodo                                                              | Descrizione                                                                     |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-directoryspecification.md) | Valuta un particolare controllo. Questo metodo non è implementato da WMI.<br/> |
...
La classe **CIM \_ DirectorySpecification** dispone di queste proprietà.
...
Se **true**, la condizione dovrebbe esistere nell'ambiente. Un file, ad esempio, dovrebbe trovarsi in un sistema, quindi il metodo [**Invoke**](invoke-method-in-class-cim-check.md) deve restituire **true**.

Se **false**, la condizione non è prevista. Un file, ad esempio, non si trova in un sistema, quindi il metodo [**Invoke**](invoke-method-in-class-cim-check.md) deve restituire **false**.
...
Nome della directory. Il valore fornito da un provider di applicazioni è un nome di percorso predefinito o consigliato. Il valore può essere modificato per un ambiente specifico.
...
Qualificatori: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Percorso DMTF \| 001,2 ")
</dt> </dl>

Tipo di directory da descrivere.
...
**Directory eseguibile prodotto** (1)
...
**Directory della raccolta di prodotti** (2)
...
**Directory di inclusione prodotto** (4)
...
**Directory delle librerie condivise** (9)
...
**Directory libreria di sistema** (13)
...
**Directory di configurazione di sistema** (14)
...
**Directory di inclusione sistema** (15)
...
**Directory registro di sistema** (16)
...
WMI non implementa questa classe. Per le classi derivate da **CIM \_ DirectorySpecification**, vedere [Win32 Classes](win32-provider.md).
