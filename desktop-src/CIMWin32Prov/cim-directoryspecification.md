---
description: La classe CIM \_ DirectorySpecification acquisisce la struttura di directory principale di un elemento software. Questa classe viene usata per organizzare i file di un elemento software in unità gestibili che possono essere rilocate in un computer.
ms.assetid: faeab356-e470-477b-97d2-1a19ce1d8d21
ms.tgt_platform: multiple
title: CIM_DirectorySpecification classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119924211"
---
# <a name="cim_directoryspecification-class"></a>Classe \_ CiM DirectorySpecification

La **classe CIM \_ DirectorySpecification** acquisisce la struttura di directory principale di un elemento software. Questa classe viene usata per organizzare i file di un elemento software in unità gestibili che possono essere rilocate in un computer.
...
La **classe \_ CIM DirectorySpecification** ha questi tipi di membri:
...
La **classe \_ CIM DirectorySpecification** include questi metodi.



| Metodo                                                              | Descrizione                                                                     |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------|
| [**evocare**](invoke-method-in-class-cim-directoryspecification.md) | Valuta un controllo specifico. Questo metodo non è implementato da WMI.<br/> |
...
La **classe \_ CIM DirectorySpecification** ha queste proprietà.
...
Qualificatori: [**mappingstring**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Location \| 001.2")
</dt> </dl>

Tipo di directory da descrizione.
...
**Directory della raccolta prodotti** (2)
...
**Directory dei log del** prodotto (6)
...
**Directory della libreria condivisa** (9)
...
**Directory di base del** sistema (11)
...
**Directory del registro di** sistema (16)
...
WMI non implementa questa classe. Per le classi derivate **da CIM \_ DirectorySpecification,** vedere [Classi Win32.](win32-provider.md)
