---
description: Il metodo Reset della classe CIM \_ ProtectedSpaceExtent richiede una reimpostazione del dispositivo logico.
ms.assetid: 601e6b0d-4f3c-4a99-aec1-1a769213cf6e
ms.tgt_platform: multiple
title: Metodo Reset della classe CIM_ProtectedSpaceExtent
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701181"
---
# <a name="reset-method-of-the-cim_protectedspaceextent-class"></a>Metodo Reset della classe CIM \_ ProtectedSpaceExtent

Il **metodo Reset** della classe CIM \_ ProtectedSpaceExtent richiede una reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
