---
description: La classe \_ CIM CDROMDrive rappresenta un'unità CD-ROM nel computer.
ms.assetid: 044c9687-fc25-4a8c-b2ef-bd7ea332af7b
ms.tgt_platform: multiple
title: CIM_CDROMDrive classe (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119700971"
---
# <a name="cim_cdromdrive-class-cimwin32-wmi-providers"></a>CIM_CDROMDrive classe (provider WMI CIMWin32)

La **classe \_ CIM CDROMDrive** rappresenta un'unità CD-ROM nel computer.

> [!Note]  
> Il nome dell'unità non corrisponde alla lettera di unità logica assegnata al dispositivo, ovvero il nome del dispositivo di archiviazione logico dipendente dall'unità.
...
La **classe \_ CIM CDROMDrive** ha questi tipi di membri:
...
La **classe \_ CIM CDROMDrive** include questi metodi.



| Metodo                                                                | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-cdromdrive.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-cdromdrive.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CIM CDROMDrive** ha queste proprietà.
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Archiviazione dispositivi \| 001.9", "MIF. DMTF \| Archiviazione dispositivi \| 001.11", "MIF. DMTF \| Archiviazione dispositivi \| 001.12", "MIF. DMTF \| Disks \| 003.7"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**CapabilityDescriptions**")
</dt> </dl>

Funzionalità del dispositivo di accesso ai supporti.
...
Distingue un dispositivo che può accedere a entrambi i lati dei supporti a doppio lato da un dispositivo che legge solo un lato singolo e richiede che il supporto sia attivato.
...
Indica che il supporto non deve essere espulso in modo esplicito dal dispositivo prima di essere accessibile da un elemento di selezione.
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funzionalità**")
</dt> </dl>

Matrice di stringhe in formato libero che fornisce spiegazioni dettagliate per l'accesso alle funzionalità del dispositivo indicate nella matrice **Capabilities.**
...
Stringa in formato libero che indica l'algoritmo o lo strumento usato per comprimere il file logico. Se non è possibile descrivere lo schema di compressione (perché è sconosciuto), usare quanto segue: Se , usare "Sconosciuto". Se , usare "Compressed". , usare "Not Compressed".
...
Dimensioni predefinite del blocco, in byte, per il dispositivo.
...
Stringa in formato libero che descrive i tipi di rilevamento e correzione degli errori supportati dal dispositivo.
...
Dimensioni massime del blocco, in byte, per i supporti a cui il dispositivo accede.
...
Dimensioni massime, in kilobyte, dei supporti supportati da questo dispositivo. I kilobyte vengono interpretati come il numero di byte moltiplicati per 1000 (non il numero di byte moltiplicati per 1024).
...
Dimensioni minime del blocco, in byte, per i supporti a cui il dispositivo accede.
...
Se **TRUE,** il dispositivo di accesso ai supporti deve essere pulito. La proprietà della matrice Capabilities indica se è possibile eseguire la pulizia manuale **o** automatica.
...
Numero massimo di singoli supporti che possono essere supportati o inseriti.
...
Il **metodo SetPowerState** è supportato. Questo metodo si trova nella classe [**CIM \_ LogicalDevice**](cim-logicaldevice.md) padre e può essere implementato. Per altre informazioni, vedere [Progettazione di Managed Object Format (MOF).](/windows/desktop/WmiSdk/designing-managed-object-format--mof--classes)
...
Il **metodo SetPowerState** può essere richiamato con il parametro *PowerState* impostato su 5 ("Ciclo di alimentazione") e il parametro *Time* impostato su una data e un'ora o un intervallo specifico per l'accensione.
...
La **classe \_ CIM CDROMDrive** deriva da [**CIM \_ MediaAccessDevice.**](cim-mediaaccessdevice.md)

WMI non implementa questa classe. Per altre informazioni sulle classi derivate **da CIM \_ CDROMDrive,** vedere [Classi Win32](win32-provider.md).
