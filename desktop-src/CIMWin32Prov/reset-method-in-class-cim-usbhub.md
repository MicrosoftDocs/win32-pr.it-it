...
Il metodo **Reset** della classe CIM \_ USBHub richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Usbhub CIM](reset-method-in-class-cim-usbhub.md)
</dt> <dt>
