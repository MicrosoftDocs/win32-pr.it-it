...
---
# <a name="compress-method-of-the-cim_directory-class"></a>Metodo Compress della classe di \_ directory CIM

Il metodo **Compress comprime** il file di voce o la directory della directory logica specificata nel percorso dell'oggetto. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Directory CIM](compress-method-in-class-cim-directory.md)
</dt> <dt>
