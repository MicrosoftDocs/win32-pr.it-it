...
---
# <a name="setpowerstate-method-of-the-cim_multistatesensor-class"></a>Metodo SetPowerState della classe CIM \_ MultiStateSensor
...
[\_MULTISTATESENSOR CIM](setpowerstate-method-in-class-cim-multistatesensor.md)
</dt> <dt>
