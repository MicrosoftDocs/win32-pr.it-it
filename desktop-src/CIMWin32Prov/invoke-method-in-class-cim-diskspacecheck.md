...
---
# <a name="invoke-method-of-the-cim_diskspacecheck-class"></a>Metodo Invoke della classe CIM \_ DiskSpaceCheck

Il metodo **Invoke** della classe [**CIM \_ DiskSpaceCheck**](cim-diskspacecheck.md) valuta un particolare controllo. I dettagli relativi al modo in cui il metodo valuta un particolare controllo in un contesto CIM sono descritti dalla sottoclasse [**del \_ controllo CIM**](cim-check.md) non astratto.
