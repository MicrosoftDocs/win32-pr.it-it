...
---
# <a name="cim_process-class"></a>\_Classe di processo CIM

La classe di **\_ processo CIM** rappresenta una singola istanza di un programma in esecuzione. Un utente visualizza in genere un processo come un'applicazione o un'attività. Un processo è definito da un'area di lavoro di risorse di memoria e impostazioni ambientali allocate. In un sistema multitasking, l'area di lavoro impedisce l'intrusione di risorse da parte di altri processi. Inoltre, un processo può essere eseguito come più thread, tutti eseguiti nella stessa area di lavoro.
...
La classe di **\_ processo CIM** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe di **\_ processo CIM** dispone di queste proprietà.
...
Qualificatori: [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("nome classe")
</dt> </dl>
...
Qualificatori: [**fixed**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("CreationDate")
</dt> </dl>

Ora di inizio dell'esecuzione del processo.
...
Qualificatori: [**propagati**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**CSCreationClassName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) (" nome classe di sistema computer ")
</dt> </dl>
...
Qualificatori: [**propagati**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**CSName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) (" nome sistema computer ")
</dt> </dl>
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("stato esecuzione")
</dt> </dl>
...
Qualificatori: [**Key**](/windows/desktop/WmiSdk/key-qualifier), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("handle")
</dt> </dl>

Identifica il processo. Un identificatore di processo è un tipo di handle di processo.
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("tempo del modello kernel"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("millisecondi")
</dt> </dl>
...
Qualificatori: [**propagati**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**CreationClassName**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) (" nome classe sistema operativo ")
</dt> </dl>

Nome della classe di creazione dell'ambito del sistema operativo.
...
Qualificatori: [**propagati**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**Nome**"), [**\_ chiave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) (" nome sistema operativo ")
</dt> </dl>

Nome dell'ambito del sistema operativo.
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("Priority")
</dt> </dl>

Urgenza o importanza per l'esecuzione del processo. Se per un processo non è definita una priorità, è necessario utilizzare un valore pari a 0 (zero).
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("data di terminazione")
</dt> </dl>

Ora in cui il processo è stato interrotto o terminato.
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("ora modalità utente"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("millisecondi")
</dt> </dl>
...
Qualificatori: [**DisplayName**](/windows/desktop/WmiSdk/standard-qualifiers) ("working set size"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>
...
La classe di **\_ processo CIM** è derivata da [**CIM \_ LogicalElement**](cim-logicalelement.md).

WMI non implementa questa classe. Per le classi WMI derivate dal **\_ processo CIM**, vedere [classi Win32](win32-provider.md).
