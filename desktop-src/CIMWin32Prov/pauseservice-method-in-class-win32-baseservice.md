...
---
# <a name="pauseservice-method-of-the-win32_baseservice-class"></a>Metodo PauseService della \_ classe BaseService Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **PauseService** tenta di collocare il servizio a cui si fa riferimento nello stato sospeso.
