...
---
# <a name="setpowerstate-method-of-the-cim_controller-class"></a>Metodo SetPowerState della classe del \_ controller CIM
...
[\_Controller CIM](setpowerstate-method-in-class-cim-controller.md)
</dt> <dt>
