...
---
# <a name="compress-method-of-the-win32_codecfile-class"></a>Metodo Compress della \_ classe Sqlcfile Win32

Il metodo **Compress** [WMI class](/windows/desktop/WmiSdk/retrieving-a-class) comprime il file di codec logico (o directory) specificato nel percorso dell'oggetto.
...
Restituisce un valore intero pari a 0 (zero) se il file è stato compresso correttamente e qualsiasi altro numero per indicare un errore.
