...
---
# <a name="win32_temperatureprobe-class"></a>Win32 \_ TemperatureProbe (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ TemperatureProbe Win32** rappresenta le proprietà di un sensore di temperatura (termometro elettronico).

La maggior parte delle informazioni fornite dalla classe WMI **Win32 \_ TemperatureProbe** deriva da SMBIOS. Le letture in tempo reale per la proprietà **CurrentReading** non possono essere estratte dalle tabelle SMBIOS. Per questo motivo, le implementazioni correnti di WMI non popolano la proprietà **CurrentReading** . La presenza della proprietà **CurrentReading** è riservata per un utilizzo futuro.
...
La classe **Win32 \_ TemperatureProbe** presenta questi tipi di membri:
...
La classe **Win32 \_ TemperatureProbe** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                                     |
|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-temperaturesensor.md) in [**CIM \_ sensore**](cim-temperaturesensor.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-temperaturesensor.md) in [**CIM \_ sensore**](cim-temperaturesensor.md) per la documentazione.<br/> |
...
La classe **Win32 \_ TemperatureProbe** dispone di queste proprietà.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,19 ")
</dt> </dl>

Accuratezza del sensore per la proprietà misurata. Il valore viene registrato come più o meno centesimi di percentuale. L'accuratezza, la risoluzione e la tolleranza vengono utilizzate per calcolare il valore effettivo della proprietà fisica misurata. L'accuratezza può variare e varia a seconda che il dispositivo sia lineare o meno sull'intervallo dinamico.
...
Nome della prima classe concreta visualizzata nella catena di ereditarietà utilizzata per la creazione di un'istanza. Se utilizzata con le altre proprietà chiave di una classe, questa proprietà consente di identificare in modo univoco tutte le istanze della classe e le relative sottoclassi.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,5 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Valore corrente indicato dal sensore.

Le implementazioni correnti di WMI non popolano la proprietà **CurrentReading** . La presenza della proprietà **CurrentReading** è riservata per un utilizzo futuro.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,13 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Valore soglia sensore per specificare gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **LowerThresholdCritical** e **LowerThresholdFatal**, lo stato corrente è critico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,15 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Valore soglia sensore per specificare gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è inferiore a **LowerThresholdFatal**, lo stato corrente è irreversibile.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,11 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Valore soglia sensore per specificare gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, il sensore segnala un valore normale. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **LowerThresholdCritical**, lo stato corrente è non critico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,9 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,10 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,6 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,7 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,8 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Linee guida per l'utente sull'intervallo minimo normale per il sensore numerico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,17 "), [**unità**](../wmisdk/standard-qualifiers.md) (" centesimi di gradi centigradi ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,18 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

Tolleranza del sensore per la proprietà misurata. La tolleranza, insieme a risoluzione e accuratezza, viene utilizzata per calcolare il valore effettivo della proprietà fisica misurata. La tolleranza può variare a seconda che il dispositivo sia lineare sull'intervallo dinamico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,14 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

I valori di soglia del sensore specificano gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **UpperThresholdCritical** e **UpperThresholdFatal**, lo stato corrente è critico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,16 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

I valori di soglia del sensore specificano gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è maggiore di **UpperThresholdFatal**, lo stato corrente è irreversibile.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe temperatura DMTF \| 001,12 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di gradi centigradi ")
</dt> </dl>

I valori di soglia del sensore specificano gli intervalli (valori minimo e massimo) che identificano le condizioni operative del sensore, che possono essere condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, il sensore segnala un valore normale. Se **CurrentReading** è compreso tra **UpperThresholdNonCritical** e **UpperThresholdCritical**, lo stato corrente è non critico.
...
La classe **Win32 \_ TemperatureProbe** è derivata da [**CIM \_ sensore**](cim-temperaturesensor.md).

## <a name="examples"></a>Esempio

Nell'esempio seguente vengono restituiti i dati di probe di temperatura per il computer locale.
