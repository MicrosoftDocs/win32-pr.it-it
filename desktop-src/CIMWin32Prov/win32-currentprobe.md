---
description: La classe \_ WMI Win32 CurrentProbe rappresenta le proprietà di un sensore di monitoraggio corrente (ammeter).
ms.assetid: 2e1da856-b787-404b-ac4b-080c4950bad8
ms.tgt_platform: multiple
title: Win32_CurrentProbe classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119504171"
---
# <a name="win32_currentprobe-class"></a>Classe CurrentProbe Win32 \_

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 CurrentProbe** rappresenta le proprietà di un sensore di monitoraggio corrente (ammeter).
...
La **classe \_ Win32 CurrentProbe** ha questi tipi di membri:
...
La **classe Win32 \_ CurrentProbe** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ CurrentSensor per**](cim-currentsensor.md) la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ CurrentSensor per**](cim-currentsensor.md) la documentazione.<br/> |
...
La **classe Win32 \_ CurrentProbe** ha queste proprietà.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.5"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.13"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **LowerThresholdCritical** e **LowerThresholdFatal,** lo stato corrente è critico.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.15"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading è** inferiore **a LowerThresholdFatal,** lo stato corrente è irreversibile.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.11"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** il sensore segnala un valore normale. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **LowerThresholdCritical,** lo stato corrente è non critico.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.9"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.10"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.6"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.7"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.8"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.17"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("tenths of milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.18"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.14"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimi e massimi) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o fatali. Se **CurrentReading** è compreso **tra UpperThresholdCritical** **e UpperThresholdFatal,** lo stato corrente è critico.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.16"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimi e massimi) per determinare se il sensore opera in condizioni normali, non critiche, critiche o fatali. Se **CurrentReading è** superiore **a UpperThresholdFatal,** lo stato corrente è irreversibile.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.12"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

I valori soglia del sensore specificano gli intervalli (valori minimi e massimi) per determinare se il sensore opera in condizioni normali, non critiche, critiche o fatali. Se **CurrentReading** è compreso tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** il sensore segnala un valore normale. Se **CurrentReading** è compreso tra **UpperThresholdNonCritical** **e UpperThresholdCritical,** lo stato corrente è non critico.
...
La **classe \_ CurrentProbe Win32** deriva da [**CIM \_ CurrentSensor**](cim-currentsensor.md).
