...
---
# <a name="cim_managedsystemelement-class-cimwin32-wmi-providers"></a>Classe CIM_ManagedSystemElement (provider WMI CIMWin32)

La classe **CIM \_ ManagedSystemElement** è la classe di base per la gerarchia degli elementi di sistema. Qualsiasi componente di sistema distinguibile è un candidato per l'inclusione in questa classe. Gli esempi includono componenti software, ad esempio file; dispositivi, ad esempio unità disco e controller; e componenti fisici, ad esempio chip e schede.
...
WMI non implementa questa classe. Per le classi WMI derivate da questa classe, vedere [classi Win32](win32-provider.md).
