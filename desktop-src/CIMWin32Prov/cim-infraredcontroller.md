...
---
# <a name="cim_infraredcontroller-class"></a>CIM \_ InfraredController (classe)

La classe **CIM \_ InfraredController** rappresenta le funzionalità e la gestione di un controller a infrarossi.
...
La classe **CIM \_ InfraredController** presenta questi tipi di membri:
...
La classe **CIM \_ InfraredController** presenta questi metodi.



| Metodo                                                                        | Descrizione                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-infraredcontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ InfraredController** dispone di queste proprietà.
...
Data e ora dell'ultima reimpostazione del controller, che può indicare che il controller è stato spento o reinizializzato.
...
La classe **CIM \_ InfraredController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi derivate da **CIM \_ InfraredController**, vedere [Win32 Classes](win32-provider.md).
