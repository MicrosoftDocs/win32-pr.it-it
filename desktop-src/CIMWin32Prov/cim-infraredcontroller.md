---
description: La classe CIM \_ Microcontroller rappresenta le funzionalità e la gestione di un controller a windows media.
ms.assetid: c3643c1c-a3c0-4600-b432-4f4be925aeb5
ms.tgt_platform: multiple
title: CIM_InfraredController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119438731"
---
# <a name="cim_infraredcontroller-class"></a>Classe CIM \_ MicroedController

La **classe CIM \_ Microcontroller rappresenta** le funzionalità e la gestione di un controller a windows media.
...
La **classe CIM \_ MicroedController** ha questi tipi di membri:
...
La **classe CIM \_ Microcontroller** dispone di questi metodi.



| Metodo                                                                        | Descrizione                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-infraredcontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ Microcontroller** ha queste proprietà.
...
Data e ora dell'ultima reimpostazione del controller, che potrebbe significare che il controller è stato spento o reinizializzato.
...
La **classe CIM \_ InfraredController** è derivata da [**CIM \_ Controller**](cim-controller.md).

WMI non implementa questa classe. Per le classi derivate **da CIM \_ InfraredController,** vedere [Classi Win32](win32-provider.md).
