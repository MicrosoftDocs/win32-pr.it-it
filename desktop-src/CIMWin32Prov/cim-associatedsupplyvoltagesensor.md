...
---
# <a name="cim_associatedsupplyvoltagesensor-class"></a>CIM \_ AssociatedSupplyVoltageSensor (classe)

La classe **CIM \_ AssociatedSupplyVoltageSensor** associa un alimentatore a un sensore di tensione che monitora la tensione di input.
...
La classe **CIM \_ AssociatedSupplyVoltageSensor** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ AssociatedSupplyVoltageSensor** dispone di queste proprietà.
...
Un [**\_ sensore CIM**](cim-voltagesensor.md) che descrive il sensore di tensione.
...
Un [**\_ alimentatore CIM**](cim-powersupply.md) che descrive l'alimentatore associato al sensore di tensione.
...
Indica l'intervallo di tensione di input dell'alimentatore misurato dal sensore associato.
...
La classe **CIM \_ AssociatedSupplyVoltageSensor** è derivata da [**CIM \_ AssociatedSensor**](cim-associatedsensor.md).
