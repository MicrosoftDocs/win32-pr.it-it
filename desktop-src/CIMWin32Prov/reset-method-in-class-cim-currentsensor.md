---
description: Il metodo Reset della classe CIM \_ CurrentSensor richiede una reimpostazione del dispositivo logico.
ms.assetid: 4c1f500b-bc8b-428f-8f4e-cbf5a18f9405
ms.tgt_platform: multiple
title: Metodo Reset della classe CIM_CurrentSensor
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701521"
---
# <a name="reset-method-of-the-cim_currentsensor-class"></a>Metodo Reset della classe CIM \_ CurrentSensor

Il **metodo Reset** della classe CIM \_ CurrentSensor richiede una reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
