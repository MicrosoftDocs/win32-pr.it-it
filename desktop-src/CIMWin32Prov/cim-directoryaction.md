...
---
# <a name="cim_directoryaction-class"></a>CIM \_ DirectoryAction (classe)

La classe **CIM \_ DirectoryAction** Abstract gestisce le directory. La creazione della directory viene gestita dalla classe [**CIM \_ CreateDirectoryAction**](cim-createdirectoryaction.md) e la rimozione della directory viene gestita dalla classe [**CIM \_ RemoveDirectoryAction**](cim-removedirectoryaction.md) .
...
La classe **CIM \_ DirectoryAction** presenta questi tipi di membri:
...
La classe **CIM \_ DirectoryAction** presenta questi metodi.



| Metodo                                                       | Descrizione                                                                  |
|:-------------------------------------------------------------|:-----------------------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-directoryaction.md) | Esegue una determinata azione. Questo metodo non è implementato da WMI.<br/> |
...
La classe **CIM \_ DirectoryAction** dispone di queste proprietà.
