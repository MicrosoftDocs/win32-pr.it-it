...
---
# <a name="pause-method-of-the-win32_printer-class"></a>Metodo pause della \_ classe Printer Win32

Il metodo **Sospendi** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) sospende la coda di stampa. Nessun processo è in grado di stampare finché la coda non viene ripresa.
