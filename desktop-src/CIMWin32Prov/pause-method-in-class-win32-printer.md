...
Il metodo [della classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Pause** sospende la coda di stampa. Nessun processo può essere stampato fino a quando la coda non viene ripresa.
