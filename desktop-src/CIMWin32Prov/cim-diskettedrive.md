...
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>Classe CIM_DisketteDrive (provider WMI CIMWin32)

La classe **CIM \_ DisketteDrive** rappresenta le funzionalità e la gestione di un'unità floppy.
...
La classe **CIM \_ DisketteDrive** presenta questi tipi di membri:
...
La classe **CIM \_ DisketteDrive** presenta questi metodi.
...
La classe **CIM \_ DisketteDrive** dispone di queste proprietà.
...
La classe **CIM \_ DisketteDrive** è derivata da [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).

WMI non implementa questa classe. Per le classi derivate da **CIM \_ DisketteDrive**, vedere [Win32 Classes](win32-provider.md).
