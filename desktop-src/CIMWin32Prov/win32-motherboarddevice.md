---
description: La classe WMI Win32 MotherboardDevice rappresenta un dispositivo che contiene i componenti centrali del \_ Windows computer.
ms.assetid: 2aed5fff-e994-4ce1-8a2e-aadb01adf28d
ms.tgt_platform: multiple
title: Win32_MotherboardDevice classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119973071"
---
# <a name="win32_motherboarddevice-class"></a>Classe MotherboardDevice Win32 \_

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 MotherboardDevice** rappresenta un dispositivo che contiene i componenti centrali del Windows computer.
...
La **classe \_ MotherboardDevice Win32** ha questi tipi di membri:
...
La **classe \_ MotherboardDevice Win32** include questi metodi.
...
La **classe \_ MotherboardDevice Win32** ha queste proprietà.
...
Identificatore univoco della scheda madre.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION System \_ \\ \\ \\ \\ \\ \\ \\ \\ MultifunctionAdapter \| Identifier")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION \_ \\ \\ \\ \\ \\ \\ System")
</dt> </dl>
...
La **classe \_ MotherboardDevice Win32** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
L'esempio di codice VBScript seguente recupera le informazioni sulla scheda madre.
