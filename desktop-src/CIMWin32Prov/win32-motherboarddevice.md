...
---
# <a name="win32_motherboarddevice-class"></a>Win32 \_ MotherboardDevice (classe)

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ MotherboardDevice Win32** rappresenta un dispositivo che contiene i componenti centrali del sistema di computer Windows.
...
La classe **Win32 \_ MotherboardDevice** presenta questi tipi di membri:
...
La classe **Win32 \_ MotherboardDevice** presenta questi metodi.
...
La classe **Win32 \_ MotherboardDevice** dispone di queste proprietà.
...
Identificatore univoco di questa scheda madre.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ Local \_ Machine \\ \\ hardware \\ \\ Description \\ \\ System \\ \\ MultifunctionAdapter \| Identifier")
</dt> </dl>

Tipo di bus primario della scheda madre.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ Local \_ Machine \\ \\ hardware \\ \\ Description \\ \\ System")
</dt> </dl>

Numero di revisione della scheda madre.
...
Tipo di bus secondario della scheda madre.
...
La classe **Win32 \_ MotherboardDevice** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

## <a name="examples"></a>Esempio

Gli esempi di codice [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) e [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) seguenti recuperano le informazioni sulla scheda madre.

Nell'esempio di codice VBScript seguente vengono recuperate le informazioni sulla scheda madre.
