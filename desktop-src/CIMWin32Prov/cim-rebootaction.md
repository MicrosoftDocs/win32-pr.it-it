...
---
# <a name="cim_rebootaction-class"></a>CIM \_ rebootaction (classe)

La classe **CIM \_ rebootaction** causa un riavvio del sistema in cui è installato l'elemento software.
...
La classe **CIM \_ rebootaction** presenta questi tipi di membri:
...
La classe **CIM \_ rebootaction** presenta questi metodi.



| Metodo                                                    | Descrizione                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-rebootaction.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ rebootaction** dispone di queste proprietà.
