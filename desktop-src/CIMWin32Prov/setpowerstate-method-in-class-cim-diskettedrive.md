...
WMI non implementa questa classe. Per le classi derivate da [**CIM \_ DisketteDrive**](cim-diskettedrive.md), vedere [Win32 Classes](win32-provider.md).
...
[\_DISKETTEDRIVE CIM](setpowerstate-method-in-class-cim-diskettedrive.md)
</dt> <dt>
