...
title: Win32_1394Controller classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119546591"
---
# <a name="win32_1394controller-class"></a>Classe Win32 \_ 1394Controller

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ 1394Controller** rappresenta le funzionalità e la gestione di un controller 1394. IEEE 1394 è una specifica per un bus seriale ad alta velocità.
...
La **classe Win32 \_ 1394Controller** ha questi tipi di membri:
...
La **classe Win32 \_ 1394Controller** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) nel [**controller CIM \_ per**](cim-controller.md) la documentazione.<br/>                 |
...
La **classe Win32 \_ 1394Controller** ha queste proprietà.
...
Identificatore univoco di questo controller.
...
La **classe Win32 \_ 1394Controller** è derivata da [**CIM \_ Controller**](cim-controller.md).

## <a name="examples"></a>Esempio

L'esempio di codice di PowerShell seguente recupera le informazioni sul controller.
