...
---
# <a name="win32_1394controller-class"></a>Win32 \_ 1394Controller (classe)

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ 1394Controller Win32** rappresenta le funzionalità e la gestione di un controller 1394. IEEE 1394 è una specifica per un bus seriale ad alta velocità.
...
La classe **Win32 \_ 1394Controller** presenta questi tipi di membri:
...
La classe **Win32 \_ 1394Controller** presenta questi metodi.
...
La classe **Win32 \_ 1394Controller** dispone di queste proprietà.
...
Identificatore univoco del controller.
...
La classe **Win32 \_ 1394Controller** è derivata dal [**\_ controller CIM**](cim-controller.md).

## <a name="examples"></a>Esempio

L'esempio di codice PowerShell seguente recupera le informazioni sul controller.
