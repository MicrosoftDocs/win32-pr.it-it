...
---
# <a name="cim_parallelcontroller-class"></a>CIM \_ ParallelController (classe)
...
La classe **CIM \_ ParallelController** presenta questi tipi di membri:
...
La classe **CIM \_ ParallelController** presenta questi metodi.



| Metodo                                                                        | Descrizione                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-parallelcontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ ParallelController** dispone di queste proprietà.
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Parallel ports \| 003,8 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**CapabilityDescriptions**")
</dt> </dl>
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**Funzionalità**")
</dt> </dl>

Stringhe in formato libero che forniscono spiegazioni dettagliate per le funzionalità del controller parallelo indicate nell'array delle **funzionalità** .
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| porte parallele \| 003,7 ")
</dt> </dl>
...
Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto o illimitato, è necessario usare un valore pari a 0 (zero).
...
La classe **CIM \_ ParallelController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ ParallelController**, vedere [Win32 Classes](win32-provider.md).
