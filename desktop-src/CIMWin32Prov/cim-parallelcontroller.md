---
description: L'associazione CIM \_ ParallelController è correlata alle funzionalità e alla gestione del dispositivo logico della porta parallela.
ms.assetid: c05e79b6-f3a6-48cc-a831-b67e216f43eb
ms.tgt_platform: multiple
title: CIM_ParallelController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118679087"
---
# <a name="cim_parallelcontroller-class"></a>Classe CIM \_ ParallelController

**L'associazione CIM \_ ParallelController** è correlata alle funzionalità e alla gestione del dispositivo logico della porta parallela.
...
La **classe CIM \_ ParallelController** ha questi tipi di membri:
...
La **classe CIM \_ ParallelController** include questi metodi.



| Metodo                                                                        | Descrizione                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-parallelcontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-parallelcontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ ParallelController** ha queste proprietà.
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Parallel Ports \| 003.8"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**CapabilityDescriptions**")
</dt> </dl>

Funzionalità del controller parallelo.
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**Funzionalità**")
</dt> </dl>

Stringhe in formato libero che forniscono spiegazioni dettagliate per le funzionalità del controller parallelo indicate nella matrice **Capabilities.**
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Parallel Ports \| 003.7")
</dt> </dl>

Se **TRUE,** è supportato l'accesso diretto alla memoria (DMA).
...
Numero massimo di entità indirizzabili direttamente supportate dal controller. Se il numero è sconosciuto o illimitato, deve essere usato il valore 0 (zero).
...
La **classe CIM \_ ParallelController** è derivata da [**CIM \_ Controller**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ ParallelController,** vedere [Classi Win32](win32-provider.md).
