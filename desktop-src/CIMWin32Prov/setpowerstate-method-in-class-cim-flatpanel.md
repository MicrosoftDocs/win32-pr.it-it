---
description: Il metodo SetPowerState della classe CIM FlatPanel imposta lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo \_ deve essere inserito in tale stato.
ms.assetid: 75f5f588-f3d3-471c-bff4-a511abcee576
ms.tgt_platform: multiple
title: Metodo SetPowerState della CIM_FlatPanel classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
