...
---
# <a name="win32_pnpdevicepropertysint8array-class"></a>Win32 \_ PnPDevicePropertySint8Array (classe)

Rappresenta una proprietà del dispositivo PnP costituita da una matrice di elementi **Sint8** .
...
La classe **Win32 \_ PnPDevicePropertySint8Array** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ PnPDevicePropertySint8Array** dispone di queste proprietà.
