...
---
# <a name="takeownership-method-of-the-cim_datafile-class"></a>Metodo TakeOwnerShip della classe del file di \_ DataFile CIM

Il metodo **TakeOwnership** ottiene la proprietà del file logico specificato nel percorso dell'oggetto. Se il file logico è una directory, questo metodo agirà in modo ricorsivo, assumendo la proprietà di tutti i file e le sottodirectory contenute nella directory. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
Il metodo **TakeOwnership** nel file di [**\_ DataFile CIM**](cim-datafile.md) viene implementato da WMI.
...
[File di \_ DataFile CIM](takeownership-method-in-class-cim-datafile.md)
</dt> <dt>
