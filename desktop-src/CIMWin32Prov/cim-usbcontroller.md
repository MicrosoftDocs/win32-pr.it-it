...
---
# <a name="cim_usbcontroller-class"></a>CIM \_ USBController (classe)

La classe **CIM \_ USBController** rappresenta le funzionalità e la gestione di un controller USB.
...
La classe **CIM \_ USBController** presenta questi tipi di membri:
...
La classe **CIM \_ USBController** presenta questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-usbcontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La classe **CIM \_ USBController** dispone di queste proprietà.
...
Nome del produttore del controller USB.
...
La classe **CIM \_ USBController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ USBController**, vedere [Win32 Classes](win32-provider.md).
