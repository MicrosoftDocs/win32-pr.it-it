---
description: La classe CIM \_ USBController rappresenta le funzionalità e la gestione di un controller USB.
ms.assetid: fa891db5-9995-4532-895f-bded8dd0bdac
ms.tgt_platform: multiple
title: CIM_USBController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118420978"
---
# <a name="cim_usbcontroller-class"></a>Classe CIM \_ USBController
...
La **classe CIM \_ USBController** ha questi tipi di membri:
...
La **classe CIM \_ USBController** include questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-usbcontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La **classe CIM \_ USBController** ha queste proprietà.
...
WMI non implementa questa classe. Per le classi WMI derivate **da CIM \_ USBController,** vedere [Classi Win32.](win32-provider.md)
