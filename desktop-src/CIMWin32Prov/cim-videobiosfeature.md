...
---
# <a name="cim_videobiosfeature-class"></a>CIM \_ VideoBIOSFeature (classe)

La classe **CIM \_ VideoBIOSFeature** rappresenta le funzionalità del software di basso livello utilizzato per configurare e accedere al controller video e alla visualizzazione di un sistema di computer.
...
La classe **CIM \_ VideoBIOSFeature** presenta questi tipi di membri:
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| video BIOS caratteristica \| 001,4 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoBIOSFeature**.**Caratteristiche**")
</dt> </dl>

Stringhe in formato libero che forniscono descrizioni dettagliate per le funzionalità del BIOS video indicate nella matrice di **caratteristiche** .

> [!Note]  
> Ogni voce di questa matrice è correlata alla voce nella matrice di **caratteristiche** che si trova nello stesso indice.
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| video BIOS caratteristica \| 001,3 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoBIOSFeature**.**CharacteristicDescriptions**")
</dt> </dl>

Funzionalità supportate dal BIOS del video. Ad esempio, è possibile indicare il supporto per il risparmio di energia VESA o lo shadowing del BIOS del video. Il valore 3 ("Unknown") non è valido nello schema CIM perché rappresenta che non sono supportate funzionalità BIOS in DMI. In tal caso, non è necessario creare un'istanza dell'oggetto.
...
Supporto per il risparmio di **energia VESA** (6)
...
**Supporto del canale dati di visualizzazione VESA** (7)
...
**Shadowing del BIOS video consentito** (8)
...
**Aggiornamento del BIOS video** (9)
...
Identificazione del prodotto, ad esempio un numero di serie del software o un numero di dado su un chip hardware. Questa proprietà viene ereditata da [**CIM \_ SoftwareFeature**](cim-softwarefeature.md).
...
Etichetta con cui l'oggetto è noto all'esterno del sistema di elaborazione dei dati. Questa etichetta è un nome che identifica in modo univoco l'elemento nel contesto dello spazio dei nomi dell'elemento.
...
Nome del fornitore del prodotto, che corrisponde alla proprietà del **Fornitore** nell'oggetto prodotto di DMTF Solution Exchange standard (SES).
...
Informazioni sulla versione del prodotto, che corrisponde alla proprietà **Version** nell'oggetto Product di DMTF ses.
