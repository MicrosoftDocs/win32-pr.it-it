---
description: La classe WMI \_ Win32 TapeDrive rappresenta un'unità nastro in un computer che esegue Windows. Le unità nastro sono principalmente distinte dal fatto che è possibile accedervi solo in sequenza.
ms.assetid: ceefec7b-a904-4b2f-a6b6-b84917a33023
ms.tgt_platform: multiple
title: Win32_TapeDrive classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119020099"
---
# <a name="win32_tapedrive-class"></a>Classe TapeDrive Win32 \_

La **classe WMI \_ Win32 TapeDrive** [rappresenta](../wmisdk/retrieving-a-class.md) un'unità nastro in un computer che esegue Windows. Le unità nastro sono principalmente distinte dal fatto che è possibile accedervi solo in sequenza.
...
La **classe \_ TapeDrive Win32** ha questi tipi di membri:
...
La **classe \_ TapeDrive Win32** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ TapeDrive**](cim-tapedrive.md).<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ TapeDrive.**](cim-tapedrive.md)<br/> |
...
La **classe \_ TapeDrive Win32** ha queste proprietà.
...
Qualificatori: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Archiviazione dispositivi \| 001.9", "MIF. DMTF \| Archiviazione dispositivi \| 001.11", "MIF. DMTF \| Archiviazione dispositivi \| 001.12", "MIF. DMTF \| Disks \| 003.7"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**CapabilityDescriptions**")
</dt> </dl>

Matrice di funzionalità del dispositivo di accesso ai supporti. Ad esempio, il dispositivo può supportare l'accesso casuale, i supporti rimovibili e la pulizia automatica. In questo caso, i valori 3, 7 e 9 vengono scritti nella matrice.
...
Qualificatori: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indicizzato"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funzionalità**")
</dt> </dl>

Matrice di stringhe in formato libero che forniscono spiegazioni più dettagliate per qualsiasi funzionalità del dispositivo di accesso indicata nella matrice **Capabilities.** Si noti che ogni voce di questa matrice è correlata alla voce nella matrice **Capabilities** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Strutture di backup su nastro Win32API \| TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| Compression")
</dt> </dl>

Se **TRUE,** la compressione dei dati hardware è abilitata.
...
Stringa in formato libero che indica l'algoritmo o lo strumento usato dal dispositivo per supportare la compressione. Se non è possibile o non si desidera descrivere lo schema di compressione ,ad esempio perché non è noto, usare le parole seguenti: "Sconosciuto" per indicare che non è noto se il dispositivo supporta o meno le funzionalità di compressione; "Compresso" per indicare che il dispositivo supporta le funzionalità di compressione, ma il relativo schema di compressione non è noto o non viene divulgato; e "Non compressi" per rappresentare che il dispositivo non supporta le funzionalità di compressione.
...
Qualificatori: [**Key,**](../wmisdk/key-qualifier.md) [**Override**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| File Functions \| CreateFile")
</dt> </dl>

Identificatore univoco dell'unità nastro con altri dispositivi nel sistema.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Strutture di backup su nastro Win32API \| TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC")
</dt> </dl>

Se **TRUE,** il dispositivo supporta la correzione degli errori hardware.
...
Dimensioni della zona per l'avviso di fine nastro (EOT).

Questa proprietà viene ereditata da [**CIM \_ TapeDrive.**](cim-tapedrive.md)
...
Stringa in formato libero che fornisce altre informazioni sull'errore registrato in **LastErrorCode** e informazioni su eventuali azioni correttive che possono essere eseguite.
...
Stringa in formato libero che descrive il tipo di rilevamento e correzione degli errori supportati da questo dispositivo.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

32 bit di alto livello del flag delle funzionalità del dispositivo.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

32 bit di basso livello del flag delle funzionalità del dispositivo.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Funzioni file Win32API") \|
</dt> </dl>

Nome identificativo del produttore dell'Windows CD ROM.

Esempio: "PLEXTOR CD-ROM PX-12CS 1.01"
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry")
</dt> </dl>

Produttore dell'Windows CD-ROM.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Sequential Access Devices \| 001.2"), [**Units**](../wmisdk/standard-qualifiers.md) ("kilobyte")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32 \_ TapeDrive \| MediaType \| Tape Drive")
</dt> </dl>

Tipo di supporto usato da (o a cui accede) questo dispositivo. In questo caso, è impostato su "Unità nastro".
...
Numero massimo di singoli supporti che possono essere supportati o inseriti nel dispositivo di accesso ai supporti (se supportato).
...
Numero di byte inseriti tra blocchi su un supporto nastro.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Se **TRUE,** la segnalazione setmark è abilitata. La creazione di report Setmark usa un elemento registrato specializzato che non contiene dati utente. Questo elemento registrato viene usato per fornire uno schema di segmentazione gerarchicamente superiore ai contrassegni file. I contrassegni consentono un posizionamento più rapido su nastri ad alta capacità.
...
La **classe \_ TapeDrive Win32** è derivata da [**CIM \_ TapeDrive.**](cim-tapedrive.md)
