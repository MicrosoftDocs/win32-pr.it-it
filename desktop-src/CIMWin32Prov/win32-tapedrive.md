...
---
# <a name="win32_tapedrive-class"></a>Win32 \_ TapeDrive (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ TapeDrive Win32** rappresenta un'unità nastro in un sistema di computer che esegue Windows. Le unità nastro si distinguono principalmente dal fatto che è possibile accedervi solo in modo sequenziale.
...
La classe **Win32 \_ TapeDrive** presenta questi tipi di membri:
...
La classe **Win32 \_ TapeDrive** presenta questi metodi.
...
La classe **Win32 \_ TapeDrive** dispone di queste proprietà.
...
Qualificatori: [**arrayType**](../wmisdk/standard-qualifiers.md) ("indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funzionalità**")
</dt> </dl>

Matrice di stringhe in formato libero che fornisce spiegazioni più dettagliate per tutte le funzionalità di accesso ai dispositivi indicate nell'array delle **funzionalità** . Si noti che ogni voce di questa matrice è correlata alla voce nella matrice delle **funzionalità** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| backup su nastro strutture \| [**nastro \_ ottenere compressione \_ \_ parametri unità**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API di \| backup su nastro su \| [**nastro \_ ottenere i \_ \_ parametri di unità**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ecc")
</dt> </dl>
...
Dimensioni della zona per l'avviso di fine del nastro (EOT).
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API nastri di backup su nastro \| \| [**nastro \_ get \_ unità \_ parametri**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

32 bit di ordine superiore del flag delle funzionalità del dispositivo.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API nastri di backup su nastro \| \| [**nastro \_ get \_ unità \_ parametri**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

32 bit di ordine inferiore del flag delle funzionalità del dispositivo.
...
Nome di identificazione del produttore dell'unità CD-ROM di Windows.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Dispositivi di accesso sequenziale DMTF \| 001,2 "), [**unità**](../wmisdk/standard-qualifiers.md) (" kilobyte ")
</dt> </dl>
...
Tipo di supporto usato dal dispositivo o a cui si accede da questo dispositivo. In questo caso, è impostato su "unità nastro".
...
Numero di byte inseriti tra blocchi su un supporto a nastro.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API nastri di backup su nastro \| \| [**nastro \_ get \_ unità \_ parametri**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Se il valore è **true**, la creazione di report è abilitata. Per la creazione di report viene utilizzato un elemento registrato specializzato che non contiene dati utente. Questo elemento registrato viene usato per fornire uno schema di segmentazione gerarchicamente superiore ai filemark. I contrassegni consentono un posizionamento più veloce sui nastri ad alta capacità.
...
La classe **Win32 \_ TapeDrive** è derivata da [**CIM \_ TapeDrive**](cim-tapedrive.md).
