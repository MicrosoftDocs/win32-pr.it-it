---
description: La classe CIM VolumeSet rappresenta un intervallo contiguo di blocchi logici presentati all'ambiente operativo per la lettura e \_ la scrittura dei dati utente.
ms.assetid: f0350185-6210-4f95-a2a2-23de61b1af1f
ms.tgt_platform: multiple
title: CIM_VolumeSet classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118677046"
---
# <a name="cim_volumeset-class"></a>Classe \_ CIM VolumeSet

La **classe \_ CIM VolumeSet** rappresenta un intervallo contiguo di blocchi logici presentati all'ambiente operativo per la lettura e la scrittura dei dati utente. I set di volumi non devono sovrapporsi tra loro e sono basati su uno o più extent fisici, extent dello spazio protetto o extent aggregati (tutti dello stesso tipo). Le associazioni basate su devono essere istanziate o sottoclassate in base alle esigenze.
...
La **classe \_ CIM VolumeSet** ha questi tipi di membri:
...
La **classe \_ CIM VolumeSet** dispone di questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-volumeset.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-volumeset.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CIM VolumeSet** ha queste proprietà.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Volume Set \| 001.5")
</dt> </dl>

Numero di extent di spazio protetto da stripe come set collettivo. In SCC questo valore è definito come numero di stripe da contare prima di continuare a eseguire il mapping al successivo set contiguo di extent, oltre lo stripe corrente.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Volume Set \| 001.4")
</dt> </dl>

Numero di extent di spazio protetto contigui conteggiati prima di tornare al primo extent dello spazio protetto dello striping corrente. È il numero di extent che formano lo striping dei dati utente.
...
La **classe \_ CIM VolumeSet** è derivata da [**CIM \_ StorageExtent.**](cim-storageextent.md)
