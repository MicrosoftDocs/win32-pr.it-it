...
---
# <a name="cim_managementcontroller-class"></a>CIM \_ ManagementController (classe)
...
La classe **CIM \_ ManagementController** presenta questi tipi di membri:
...
La classe **CIM \_ ManagementController** presenta questi metodi.



| Metodo                                                                          | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-managementcontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ ManagementController** dispone di queste proprietà.
