---
description: La classe CIM \_ ManagementController è correlata alle funzionalità e alla gestione di un controller di gestione.
ms.assetid: 47ad29d1-5021-4469-87c0-bd9403faa70c
ms.tgt_platform: multiple
title: CIM_ManagementController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119021089"
---
# <a name="cim_managementcontroller-class"></a>Classe CIM \_ ManagementController

La **classe CIM \_ ManagementController** è correlata alle funzionalità e alla gestione di un controller di gestione.
...
La **classe CIM \_ ManagementController** ha questi tipi di membri:
...
La **classe CIM \_ ManagementController** include questi metodi.



| Metodo                                                                          | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-managementcontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-managementcontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ ManagementController** ha queste proprietà.
...
La **classe CIM \_ ManagementController** è derivata dal [**\_ controller CIM**](cim-controller.md).
