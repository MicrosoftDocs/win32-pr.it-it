...
---
# <a name="win32_voltageprobe-class"></a>Win32 \_ VoltageProbe (classe)

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ VoltageProbe Win32** rappresenta le proprietà di un sensore di tensione (voltmetro elettronico).
...
La classe **Win32 \_ VoltageProbe** presenta questi tipi di membri:
...
La classe **Win32 \_ VoltageProbe** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ sensore**](cim-voltagesensor.md).<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ sensore**](cim-voltagesensor.md).<br/> |
...
La classe **Win32 \_ VoltageProbe** dispone di queste proprietà.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,19 ")
</dt> </dl>

Accuratezza del sensore per la proprietà misurata. Il valore di accuratezza viene registrato come più o meno centesimi di percentuale. L'accuratezza, insieme a risoluzione e tolleranza, viene utilizzata per calcolare il valore effettivo della proprietà fisica misurata. L'accuratezza può variare e varia a seconda che il dispositivo sia lineare o meno nell'intervallo dinamico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,5 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Identificatore univoco del probe di tensione.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,13 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,15 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,11 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,9 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>

Valore più grande della proprietà misurata che il sensore numerico può leggere.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,10 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>

Valore più piccolo della proprietà misurata che il sensore numerico può leggere.
...
Etichetta per un oggetto. Quando è sottoclassata, è possibile eseguire l'override della proprietà in modo che sia una proprietà chiave.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,6 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,7 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,8 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>

Indicazioni per l'utente per indicare l'intervallo minimo normale per il sensore numerico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,17 "), [**unità**](../wmisdk/standard-qualifiers.md) (" decimi di millivolt ")
</dt> </dl>

Capacità del sensore di risolvere le differenze nella proprietà misurata. Questo valore può variare e varia a seconda che il dispositivo sia lineare nell'intervallo dinamico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,18 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>

Tolleranza del sensore per la proprietà misurata. La tolleranza, insieme a risoluzione e accuratezza, viene utilizzata per calcolare il valore effettivo della proprietà fisica misurata. La tolleranza può variare e varia a seconda che il dispositivo sia lineare nell'intervallo dinamico.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,14 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,16 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Probe di tensione DMTF \| 001,12 "), [**unità**](../wmisdk/standard-qualifiers.md) (" millivolt ")
</dt> </dl>
...
La classe **Win32 \_ VoltageProbe** è derivata da [**CIM \_ sensore**](cim-voltagesensor.md).
