...
---
# <a name="cim_keyboard-class"></a>\_Classe CIM Keyboard

La classe **CIM \_ Keyboard** rappresenta le funzionalità e la gestione del dispositivo logico da tastiera.
...
La classe **CIM \_ Keyboard** presenta questi tipi di membri:
...
La classe della **\_ tastiera CIM** presenta questi metodi.



| Metodo                                                              | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-keyboard.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe della **\_ tastiera CIM** presenta queste proprietà.
...
Valore intero che indica se sulla tastiera è abilitata una password a livello hardware per impedire l'input locale.
...
La classe **CIM \_ Keyboard** è derivata da [**CIM \_ UserDevice**](cim-userdevice.md).

WMI non implementa questa classe. Per le classi derivate dalla **\_ tastiera CIM**, vedere [classi Win32](win32-provider.md).
