---
description: La classe \_ CiM Keyboard rappresenta le funzionalità e la gestione del dispositivo logico da tastiera.
ms.assetid: c465a731-03dd-4418-8b16-96dc2c8b60b5
ms.tgt_platform: multiple
title: CIM_Keyboard classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119438451"
---
# <a name="cim_keyboard-class"></a>Classe \_ CiM Keyboard

La **classe \_ CiM Keyboard** rappresenta le funzionalità e la gestione del dispositivo logico da tastiera.
...
La **classe \_ CiM Keyboard** ha questi tipi di membri:
...
La **classe \_ CiM Keyboard** include questi metodi.



| Metodo                                                              | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-keyboard.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CiM Keyboard** ha queste proprietà.
...
Stringa in formato libero che indica il formato e il layout della tastiera.
...
Valore intero che indica se sulla tastiera è abilitata una password a livello di hardware per impedire l'input locale.
...
Win32 Plug and Play identificatore del dispositivo logico.
...
La **classe \_ CiM Keyboard** è derivata da [**CIM \_ UserDevice.**](cim-userdevice.md)

WMI non implementa questa classe. Per le classi derivate **da CIM \_ Keyboard,** vedere [Classi Win32.](win32-provider.md)
