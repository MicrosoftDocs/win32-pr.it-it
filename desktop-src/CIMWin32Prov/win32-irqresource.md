---
description: Oggetto IRQResource Win32 \_ &\# 160; La classe WMI rappresenta un numero IRQ (Interrupt Request Line) in un computer che esegue Windows.
ms.assetid: bae0c28e-2b66-40ac-9679-b2dfe9269306
ms.tgt_platform: multiple
title: Win32_IRQResource classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119699501"
---
# <a name="win32_irqresource-class"></a>Classe \_ IRQResource Win32

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 IRQResource** rappresenta un numero di riga di richiesta di interrupt (IRQ) in un computer che esegue Windows.   Una richiesta di interrupt è un segnale inviato alla CPU da un dispositivo o un programma per gli eventi time critical. IRQ può essere basato su hardware o su software.
...
La **classe \_ IRQResource Win32** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ IRQResource Win32** ha queste proprietà.
...
Questa proprietà viene ereditata da [**CIM \_ IRQ.**](cim-irq.md)
...
In uso e disponibile o condivisione
...
In uso e disponibile/gestibile
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Strutture di sistema Win32API \| RESOURCE \| \_ DESCRIPTOR \| InterfaceType")
</dt> </dl>

Se **TRUE,** l'interrupt è basato su hardware o software. Un IRQ hardware è un collegamento fisico dalla periferica al chip PIC (Programmable Interrupt Controller) tramite il quale la CPU può ricevere una notifica degli eventi time critical. Alcune linee IRQ sono riservate per i dispositivi standard, ad esempio la tastiera, le unità disco floppy e l'orologio di sistema. Un interrupt software consente alle applicazioni di ottenere l'attenzione del processore.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| System Resource IRQ Info \| 001.3")
</dt> </dl>

Livello di trigger IRQ che indica se l'interrupt viene attivato dal segnale hardware che sta per essere elevato (4) o basso (3).
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 001.3", "MIF. DMTF \| System Resource IRQ Info \| 001.2")
</dt> </dl>

Tipo di trigger IRQ che indica se si verificano interruzioni attivate da edge (4) o a livello (3).
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| System Structures CM PARTIAL \| [**RESOURCE \_ \_ \_ DESCRIPTOR**](/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_cm_partial_resource_descriptor) \| Interrupt \| Level")
</dt> </dl>

Vettore della Windows IRQ. Un vettore contiene l'indirizzo di memoria per la funzione che verrà eseguita dopo che la richiesta di interrupt è stata riconosciuta dalla CPU.

</dd> </dl>

## <a name="remarks"></a>Commenti

La **classe \_ Win32 IRQResource** è derivata da [**CIM \_ IRQ.**](cim-irq.md)
