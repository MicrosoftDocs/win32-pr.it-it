...
---
# <a name="changesecuritypermissions-method-of-the-win32_pagefile-class"></a>Metodo ChangeSecurityPermissions della classe di \_ paging Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ChangeSecurityPermissions** modifica le autorizzazioni di sicurezza per il file di paging logico specificato nel percorso dell'oggetto. Se il file logico è una directory, **ChangeSecurityPermissions** è ricorsivo e modifica le autorizzazioni di sicurezza di tutti i file e le sottodirectory in esso contenuti.
