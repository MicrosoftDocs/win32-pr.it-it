...
---
# <a name="cim_systemresource-class"></a>CIM \_ SystemResource (classe)

La classe **CIM \_ SystemResource** rappresenta un'entità gestita dal BIOS o un sistema operativo che è disponibile per l'uso da parte di software e dispositivi logici.
...
La classe **CIM \_ SystemResource** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ SystemResource** dispone di queste proprietà.
...
La classe **CIM \_ SystemResource** è derivata da [**CIM \_ LogicalElement**](cim-logicalelement.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ SystemResource**, vedere [Win32 Classes](win32-provider.md).
