...
---
# <a name="cim_filesystem-class"></a>\_Classe FileSystem CIM

La classe **CIM \_ filesystem** rappresenta un file o un set di dati locale in un sistema di computer o montato in modalità remota da un file server.
...
La classe **CIM \_ filesystem** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ filesystem** dispone di queste proprietà.
...
Quantità di spazio disponibile, in byte, per la file system. Se è sconosciuto, immettere 0.
...
Dimensioni del file system, in byte. Se è sconosciuto, immettere 0 (zero).
...
Lunghezza massima del nome di un file all'interno del file system. Il valore 0 (zero) indica che non esiste alcun limite alla lunghezza del nome file.
...
La classe **CIM \_ filesystem** deriva da [**CIM \_ LogicalElement**](cim-logicalelement.md).
