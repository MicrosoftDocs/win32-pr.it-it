...
---
# <a name="cim_multistatesensor-class"></a>CIM \_ MultiStateSensor (classe)

La classe **CIM \_ MultiStateSensor** rappresenta un set di sensori binari a più membri in cui ogni sensore binario segnala un risultato booleano.
...
La classe **CIM \_ MultiStateSensor** presenta questi tipi di membri:
...
La classe **CIM \_ MultiStateSensor** presenta questi metodi.



| Metodo                                                                      | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-multistatesensor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La classe **CIM \_ MultiStateSensor** dispone di queste proprietà.
...
La classe **CIM \_ MultiStateSensor** è derivata dal [**\_ sensore CIM**](cim-sensor.md).
