...
---
# <a name="uncompressex-method-of-the-win32_pagefile-class"></a>Metodo UncompressEx della classe di \_ paging Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **UncompressEx** decomprime il file di paging logico o la directory specificata nel percorso dell'oggetto. Questo metodo è una versione estesa del metodo [**Decompress**](uncompress-method-in-class-win32-directory.md) .
