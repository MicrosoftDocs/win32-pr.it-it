...
| Metodo                                                           | Descrizione                                                                                 |
|:-----------------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| [**StartService**](startservice-method-in-class-cim-service.md) | Tenta di inserire il servizio nello stato di avvio. Non implementato da WMI.<br/>     |
| [**StopService**](stopservice-method-in-class-cim-service.md)   | Metodo della classe che inserisce il servizio nello stato interrotto. Non implementato da WMI.<br/> |
...
La classe del **\_ servizio CIM** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI non implementa questa classe. Per le classi WMI derivate **dal \_ servizio CIM**, vedere [classi Win32](win32-provider.md).
