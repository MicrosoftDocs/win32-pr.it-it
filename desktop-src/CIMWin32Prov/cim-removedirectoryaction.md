...
---
# <a name="cim_removedirectoryaction-class"></a>CIM \_ RemoveDirectoryAction (classe)

La classe **CIM \_ RemoveDirectoryAction** rimuove le directory per gli elementi software.
...
La classe **CIM \_ RemoveDirectoryAction** presenta questi tipi di membri:
...
La classe **CIM \_ RemoveDirectoryAction** presenta questi metodi.



| Metodo                                                             | Descrizione                                                   |
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-removedirectoryaction.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ RemoveDirectoryAction** dispone di queste proprietà.
...
Se **true**, la directory deve essere vuota per essere rimossa.
...
La classe **CIM \_ RemoveDirectoryAction** è derivata da [**CIM \_ DirectoryAction**](cim-directoryaction.md).
