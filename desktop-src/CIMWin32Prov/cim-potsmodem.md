---
description: La classe CIM POTSModem rappresenta un dispositivo che converte i dati binari in modulazioni delle onde per la trasmissione basata sul suono connettendosi alla rete \_ POTS (Plain Old Telephone System).
...
ms.locfileid: "118677543"
---
# <a name="cim_potsmodem-class"></a>Classe CIM \_ POTSModem

La **classe CIM \_ POTSModem** rappresenta un dispositivo che converte i dati binari in modulazioni delle onde per la trasmissione basata sul suono connettendosi alla rete POTS (Plain Old Telephone System).
...
La **classe CIM \_ POTSModem** ha questi tipi di membri:
...
La **classe CIM \_ POTSModem** include questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-potsmodem.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La **classe CIM \_ POTSModem** ha queste proprietà.
...
Impostazione di risposta automatica o di richiamo corrente per il modem.
...
Paesi o aree geografiche in cui il modem può operare.
...
Paese o area geografica per cui è attualmente programmato il modem. Quando sono supportati più paesi o aree geografiche, questa proprietà definisce quale è attualmente selezionato per l'uso.
...
Tipo di composizione utilizzato.
...
Numero massimo di password definibili nel modem stesso. Se questa funzionalità non è supportata, immettere 0 (zero).
...
Livello di volume dei toni udibili del modem. Ad esempio, il volume alto, medio o basso può essere segnalato.
...
Se **TRUE,** è supportata la comunicazione sincrona e asincrona.
...
WMI non implementa questa classe. Per le classi WMI derivate **da CIM \_ POTSModem,** vedere [Classi Win32](win32-provider.md).
