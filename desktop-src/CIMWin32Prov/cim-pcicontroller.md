...
---
# <a name="cim_pcicontroller-class"></a>CIM \_ PCIController (classe)

La classe **CIM \_ PCIController** rappresenta le proprietà e la gestione di un controller PCI. Le proprietà di questa classe e delle relative sottoclassi sono definite nelle diverse specifiche PCI pubblicate da PCI SIG.
...
La classe **CIM \_ PCIController** presenta questi tipi di membri:
...
La classe **CIM \_ PCIController** presenta questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcicontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ PCIController** dispone di queste proprietà.
...
In esecuzione o a potenza intera.
...
Il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("ciclo di alimentazione").
...
Il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("ciclo di alimentazione") e il parametro *ora* impostato su una data e un'ora specifiche, o su un intervallo, per l'accensione.
...
La classe **CIM \_ PCIController** è derivata dal [**\_ controller CIM**](cim-controller.md).
