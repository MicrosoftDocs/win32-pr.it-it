---
description: La classe CIM \_ PCIController rappresenta le proprietà e la gestione di un controller PCI. Le proprietà in questa classe e nelle relative sottoclassi sono definite nelle varie specifiche PCI pubblicate dal SIG PCI.
ms.assetid: 0f2aec01-362d-49d7-95ea-23487214188c
ms.tgt_platform: multiple
title: CIM_PCIController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118678961"
---
# <a name="cim_pcicontroller-class"></a>Classe \_ CIM PCIController

La **classe CIM \_ PCIController** rappresenta le proprietà e la gestione di un controller PCI. Le proprietà in questa classe e nelle relative sottoclassi sono definite nelle varie specifiche PCI pubblicate dal SIG PCI.
...
La **classe \_ CIM PCIController** ha questi tipi di membri:
...
La **classe CIM \_ PCIController** include questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcicontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ PCIController** ha queste proprietà.
...
Il controller PCI non è disponibile.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) è supportato.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) può essere richiamato con il *parametro PowerState* impostato su 5 ("Power Cycle").
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("Power Cycle") e il parametro *Time* impostato su una data e un intervallo specifico per l'accensione.
...
La **classe \_ CIM PCIController** è derivata dal [**\_ controller CIM**](cim-controller.md).
