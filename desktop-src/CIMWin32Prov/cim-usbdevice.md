...
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>Classe CIM_USBDevice (provider WMI CIMWin32)
...
| [**Reset**](reset-method-in-class-cim-usbdevice.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ usbdevice** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
