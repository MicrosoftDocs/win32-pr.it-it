...
---
# <a name="cim_settingcheck-class"></a>CIM \_ SettingCheck (classe)

La classe **CIM \_ SettingCheck** specifica le informazioni necessarie per controllare un determinato file di impostazioni per una voce specifica che contiene un valore uguale al valore specificato. Si presuppone che non venga fatta distinzione tra maiuscole e minuscole.
...
La classe **CIM \_ SettingCheck** presenta questi tipi di membri:
...
La classe **CIM \_ SettingCheck** presenta questi metodi.



| Metodo                                                    | Descrizione                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-settingcheck.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ SettingCheck** dispone di queste proprietà.
...
Identificatore utilizzato insieme ad altre chiavi per identificare in modo univoco il controllo. Questa proprietà viene ereditata [**dal \_ controllo CIM**](cim-check.md).
...
Valore associato alla voce denominata da verificare.
...
Nome file del file di impostazioni da controllare.
...
Nome utilizzato per identificare l'elemento software. Questa proprietà viene ereditata [**dal \_ controllo CIM**](cim-check.md).
