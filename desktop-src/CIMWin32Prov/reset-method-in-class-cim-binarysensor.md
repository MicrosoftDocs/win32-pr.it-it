...
---
# <a name="reset-method-of-the-cim_binarysensor-class"></a>Metodo Reset della classe CIM \_ BinarySensor

Il metodo **Reset** della classe CIM \_ BinarySensor richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
