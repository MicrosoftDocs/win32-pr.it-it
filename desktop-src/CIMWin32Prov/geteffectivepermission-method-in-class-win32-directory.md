...
---
# <a name="geteffectivepermission-method-of-the-win32_directory-class"></a>Metodo GetEffectivePermission della classe di \_ directory Win32
...
<span id="FILE_EXECUTE__file_______FILE_TRAVERSE__directory_"></span><span id="file_execute__file_______file_traverse__directory_"></span><span id="FILE_EXECUTE__FILE_______FILE_TRAVERSE__DIRECTORY_"></span>**File \_ Attraversamento FILE di esecuzione (file) ( \_ Directory)** (32 (0x20))
