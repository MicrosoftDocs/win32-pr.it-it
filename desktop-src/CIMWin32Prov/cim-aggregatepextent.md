...
---
# <a name="cim_aggregatepextent-class"></a>CIM \_ AggregatePExtent (classe)

La classe **CIM \_ AggregatePExtent** fornisce informazioni di riepilogo sui blocchi logici indirizzabili, che si trovano nello stesso gruppo di ridondanza di archiviazione e si trovano nello stesso supporto fisico.

La classe **CIM \_ AggregatePExtent** è un raggruppamento alternativo per gli extent fisici quando sono necessarie solo informazioni di riepilogo o quando si usa la configurazione automatica. La configurazione automatica può causare la definizione di migliaia di extent fisici.
...
La classe **CIM \_ AggregatePExtent** presenta questi tipi di membri:
...
La classe **CIM \_ AggregatePExtent** presenta questi metodi.



| Metodo                                                                      | Descrizione                                                                                                                                |
|:----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-aggregatepextent.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepextent.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando il dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La classe **CIM \_ AggregatePExtent** dispone di queste proprietà.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Proprietà NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extent fisico di aggregazione DMTF \| 001,2 ")
</dt> </dl>

Numero totale di blocchi (inclusi i blocchi di dati di controllo) contenuti in questo extent fisico aggregato. Le dimensioni del blocco (una proprietà ereditata) devono essere impostate sullo stesso valore del dispositivo di accesso multimediale associato a questo extent.
...
La classe **CIM \_ AggregatePExtent** è derivata da [**CIM \_ StorageExtent**](cim-storageextent.md).
