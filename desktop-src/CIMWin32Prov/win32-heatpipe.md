---
description: La classe WMI \_ Win32 HeatPipe rappresenta le proprietà di un dispositivo di raffreddamento della pipe termica.
ms.assetid: c6e24cb2-e29a-4cd5-af62-b8e48a5936f9
ms.tgt_platform: multiple
title: Win32_HeatPipe classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119751291"
---
# <a name="win32_heatpipe-class"></a>Classe HeatPipe Win32 \_

La **classe WMI \_ Win32 HeatPipe** [rappresenta](/windows/desktop/WmiSdk/retrieving-a-class) le proprietà di un dispositivo di raffreddamento della pipe termica.
...
La **classe \_ Win32 HeatPipe** ha questi tipi di membri:
...
La **classe Win32 \_ HeatPipe** include questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il [**metodo Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ HeatPipe per**](cim-heatpipe.md) la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ HeatPipe per**](cim-heatpipe.md) la documentazione.<br/> |
...
La **classe Win32 \_ HeatPipe** ha queste proprietà.
...
Se **TRUE,** il dispositivo di raffreddamento fornisce il raffreddamento attivo non passivo.
...
Identificatore univoco della pipe termica.
...
Se **TRUE,** il dispositivo può essere gestito dall'alimentazione in modalità di sospensione e così via. La proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate, ma solo che il dispositivo logico è in grado di eseguire la gestione del risparmio energia.
...
La **classe \_ HeatPipe Win32** è derivata da [**\_ CIM HeatPipe.**](cim-heatpipe.md)
