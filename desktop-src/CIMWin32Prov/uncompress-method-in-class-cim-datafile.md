...
---
# <a name="uncompress-method-of-the-cim_datafile-class"></a>Metodo Decompress della classe di file di \_ Codice CIM

Il metodo **uncompress** decomprime il file di dati logico o la directory specificata nel percorso dell'oggetto. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
Il metodo **Decompress** in file di file [**CIM \_**](cim-datafile.md) viene implementato da WMI.
...
[**File di \_ DataFile CIM**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
