---
description: Win32 \_ OSRecoveryConfiguration&\# 8194; La classe WMI rappresenta i tipi di informazioni che verranno raccolte dalla memoria in caso di errore del sistema operativo. Sono inclusi gli errori di avvio e gli arresti anomali del sistema.
ms.assetid: 0c8a2aeb-2fd9-44b7-8f91-d19afb8d2de6
ms.tgt_platform: multiple
title: Win32_OSRecoveryConfiguration classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119972291"
---
# <a name="win32_osrecoveryconfiguration-class"></a>Classe \_ OSRecoveryConfiguration Win32

La classe  [WMI](../wmisdk/retrieving-a-class.md) **\_ Win32 OSRecoveryConfiguration** rappresenta i tipi di informazioni che verranno raccolte dalla memoria in caso di errore del sistema operativo. Sono inclusi gli errori di avvio e gli arresti anomali del sistema.
...
La **classe \_ Win32 OSRecoveryConfiguration** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe Win32 \_ OSRecoveryConfiguration** ha queste proprietà.
...
Qualificatori: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| SYSTEM \\ \\ CurrentControlSet \\ \\ Control \\ \\ CrashControl \| AutoReboot")
</dt> </dl>
...
Percorso completo del file di debug. Viene creato un file di debug con lo stato di memoria del computer dopo un errore del computer.
...
**Dump della memoria di piccole** dimensioni (3)
...
Directory in cui verranno registrati e accumulati file di dump della memoria di piccole dimensioni.
...
Nome di identificazione per questa istanza della **classe \_ Win32 OSRecoveryConfiguration.**
...
Gli eventi verranno scritti in un log di sistema.

</dd> </dl>

## <a name="remarks"></a>Commenti

La **classe \_ Win32 OSRecoveryConfiguration** è derivata dall'impostazione [**CIM \_**](cim-setting.md).
