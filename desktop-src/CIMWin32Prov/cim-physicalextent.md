---
description: La classe CIM \_ PhysicalExtent rappresenta un'implementazione RAID SCC.
ms.assetid: d1950464-e17a-4651-aa53-6385659994ff
ms.tgt_platform: multiple
title: CIM_PhysicalExtent classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **classe CIM \_ PhysicalExtent** ha questi tipi di membri:
...
La **classe CIM \_ PhysicalExtent** include questi metodi.



| Metodo                                                                    | Descrizione                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-physicalextent.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ PhysicalExtent** ha queste proprietà.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("BlockSize"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.4")
</dt> </dl>

Dimensioni, in byte, dei blocchi che formano l'extent di archiviazione. Se la dimensione del blocco variabile è variabile, è necessario specificare la dimensione massima in byte del blocco. Se la dimensione del blocco è sconosciuta o se un concetto di blocco non è valido (ad esempio, per extent aggregati, memoria o dischi logici), immettere un valore 1 (uno).
...
Stringa in formato libero che descrive il tipo di rilevamento e correzione degli errori supportati dall'extent di archiviazione.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.3")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.6"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Numero di byte di dati utente da ignorare prima di avviare l'interleave check-data.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.7"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Numero di byte da riservare per i dati di controllo.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.8"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Numero di byte da riservare ai dati utente.
...
La **classe CIM \_ PhysicalExtent** è derivata da [**CIM \_ StorageExtent.**](cim-storageextent.md)
