...
---
# <a name="cim_executeprogram-class"></a>CIM \_ ExecuteProgram (classe)
...
La classe **CIM \_ ExecuteProgram** presenta questi tipi di membri:
...
La classe **CIM \_ ExecuteProgram** presenta questi metodi.



| Metodo                                                      | Descrizione                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-executeprogram.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ ExecuteProgram** dispone di queste proprietà.
...
Stringa che può essere richiamata in una riga di comando di sistema.
