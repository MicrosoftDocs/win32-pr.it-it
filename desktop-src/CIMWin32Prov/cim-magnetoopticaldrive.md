---
description: La classe CIM MagnetoOpticalDrive rappresenta le funzionalità e la gestione di \_ un'unità magneto-ottica, un sottotipo del dispositivo di accesso ai supporti.
ms.assetid: 82a4604d-3bef-4378-812b-550849e30b8c
ms.tgt_platform: multiple
title: CIM_MagnetoOpticalDrive classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119923021"
---
# <a name="cim_magnetoopticaldrive-class"></a>Classe CIM \_ MagnetoOpticalDrive

La **classe CIM \_ MagnetoOpticalDrive** rappresenta le funzionalità e la gestione di un'unità magneto-ottica, un sottotipo del dispositivo di accesso ai supporti.
...
La **classe CIM \_ MagnetoOpticalDrive** ha questi tipi di membri:
...
La **classe CIM \_ MagnetoOpticalDrive** include questi metodi.



| Metodo                                                                         | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-magnetoopticaldrive.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-magnetoopticaldrive.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ MagnetoOpticalDrive** ha queste proprietà.
...
> [!Note]  
> Ogni voce di matrice è correlata alla voce nella matrice **Capabilities,** che si trova nello stesso indice.
...
Se il dispositivo di accesso ai supporti supporta più supporti singoli, questa proprietà definisce il numero massimo che può essere supportato o inserito.
...
La **classe CIM \_ MagnetoOpticalDrive** deriva da [**CIM \_ MediaAccessDevice.**](cim-mediaaccessdevice.md)
