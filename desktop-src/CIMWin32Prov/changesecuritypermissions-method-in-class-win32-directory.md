...
---
# <a name="changesecuritypermissions-method-of-the-win32_directory-class"></a>Metodo ChangeSecurityPermissions della classe di \_ directory Win32

Il metodo della **classe WMI ChangeSecurityPermissions** modifica le autorizzazioni di sicurezza per il file di voce della directory logica specificato nel percorso dell'oggetto. Se il file logico è una directory, **ChangeSecurityPermissions** è ricorsivo e modifica le autorizzazioni di sicurezza di tutti i file e le sottodirectory in esso contenuti. La classe **ChangeSecurityPermissions** restituisce un valore intero pari a 0 (zero) se le autorizzazioni vengono modificate e un numero diverso per indicare un errore.
...
Modificare il DACL discrezionale del file logico.
