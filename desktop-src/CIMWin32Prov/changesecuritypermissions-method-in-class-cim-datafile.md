...
---
# <a name="changesecuritypermissions-method-of-the-cim_datafile-class"></a>Metodo ChangeSecurityPermissions della classe del file di \_ DataFile CIM

Il metodo **ChangeSecurityPermissions** modifica le autorizzazioni di sicurezza per il file di dati logico specificato nel percorso dell'oggetto. Se il file logico è una directory, questo metodo agirà in modo ricorsivo, modificando le autorizzazioni di sicurezza per tutti i file e le sottodirectory presenti nella directory. Questo metodo viene ereditato da [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
> [!Note]  
> Un elenco di controllo di accesso (ACL) **null** nella struttura del [**\_ descrittore di sicurezza**](/windows/desktop/api/winnt/ns-winnt-security_descriptor) concede un accesso illimitato. Per informazioni sulle implicazioni dell'accesso illimitato, vedere [creazione di un descrittore di sicurezza per un nuovo oggetto](/windows/desktop/SecAuthZ/creating-a-security-descriptor-for-a-new-object-in-c--).
...
Il metodo **ChangeSecurityPermissions** nel file di [**\_ DataFile CIM**](cim-datafile.md) viene implementato da WMI.
...
[**File di \_ DataFile CIM**](changesecuritypermissions-method-in-class-cim-datafile.md)
</dt> <dt>
