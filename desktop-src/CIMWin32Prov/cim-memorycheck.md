...
---
# <a name="cim_memorycheck-class"></a>CIM \_ MemoryCheck (classe)

La classe **CIM \_ MemoryCheck** specifica una condizione per la quantità minima di memoria che deve essere disponibile in un sistema. Il valore specificato nella proprietà **MemorySize** . I dettagli dei controlli vengono confrontati con il valore della proprietà **FreePhysicalMemory** dell'oggetto [**CIM \_ OperatingSystem**](cim-operatingsystem.md) a cui fa riferimento un'associazione [**CIM \_ installato**](cim-installedos.md) per l'oggetto [**CIM \_ ComputerSystem**](cim-computersystem.md) che descrive l'ambiente. Se il valore della proprietà **FreePhysicalMemory** è maggiore o uguale al valore specificato in **MemorySize**, la condizione viene soddisfatta.
...
La classe **CIM \_ MemoryCheck** presenta questi tipi di membri:
...
La classe **CIM \_ MemoryCheck** presenta questi metodi.



| Metodo                                                   | Descrizione                                                   |
|:---------------------------------------------------------|:--------------------------------------------------------------|
| [**Richiamare**](invoke-method-in-class-cim-memorycheck.md) | Esegue una determinata azione. Non implementato da WMI.<br/> |
...
La classe **CIM \_ MemoryCheck** dispone di queste proprietà.
...
Quantità di memoria che deve esistere in un sistema di computer per l'esecuzione corretta di un elemento software.
...
La classe **CIM \_ MemoryCheck** viene ereditata [**dal \_ controllo CIM**](cim-check.md).
