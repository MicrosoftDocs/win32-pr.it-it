---
description: La classe CIM UserDevice è una classe padre da cui discendono altre classi, ad esempio CIM Keyboard o \_ \_ CIM \_ DesktopMonitor. I dispositivi utente sono dispositivi logici che consentono all'utente di un computer di immettere, visualizzare o ascoltare i dati.
ms.assetid: 311a065a-df9b-4c4b-bdc4-d3de89ce2f3d
ms.tgt_platform: multiple
title: CIM_UserDevice classe (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118420496"
---
# <a name="cim_userdevice-class-cimwin32-wmi-providers"></a>CIM_UserDevice classe (provider WMI CIMWin32)

La **classe CIM \_ UserDevice** è una classe padre da cui discendono altre classi, ad esempio [**CIM \_ Keyboard**](cim-keyboard.md) o [**CIM \_ DesktopMonitor.**](cim-desktopmonitor.md) I dispositivi utente sono dispositivi logici che consentono all'utente di un computer di immettere, visualizzare o ascoltare i dati.
...
La **classe CIM \_ UserDevice** ha questi tipi di membri:
...
La **classe CIM \_ UserDevice** include questi metodi.



| Metodo                                                                | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-userdevice.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-userdevice.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ UserDevice** ha queste proprietà.
...
La **classe CIM \_ UserDevice** è derivata da [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI non implementa questa classe. Per le classi WMI derivate **da CIM \_ UserDevice,** vedere [Classi Win32](win32-provider.md).
