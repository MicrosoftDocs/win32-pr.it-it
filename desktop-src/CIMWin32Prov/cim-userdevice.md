...
---
# <a name="cim_userdevice-class-cimwin32-wmi-providers"></a>Classe CIM_UserDevice (provider WMI CIMWin32)

La classe **CIM \_ UserDevice** è una classe padre da cui discendono altre classi, ad esempio [**CIM \_ Keyboard**](cim-keyboard.md) o [**CIM \_ DesktopMonitor**](cim-desktopmonitor.md). I dispositivi utente sono dispositivi logici che consentono all'utente di un sistema informatico di immettere, visualizzare o ascoltare i dati.
...
La classe **CIM \_ UserDevice** presenta questi metodi.



| Metodo                                                                | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-userdevice.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ UserDevice**, vedere [Win32 Classes](win32-provider.md).
