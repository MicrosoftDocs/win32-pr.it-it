---
description: Decomprime il file di paging logico (o directory) specificato nel percorso dell'oggetto.
ms.assetid: 9bd98ba8-068e-49af-8dd4-e5ee987eb31d
ms.tgt_platform: multiple
title: Decomprimere il metodo della Win32_PageFile classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119834580"
---
# <a name="uncompress-method-of-the-win32_pagefile-class"></a>Metodo Uncompress della classe PageFile Win32 \_

Il **metodo decomprime** la classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) decomprime il file di paging logico (o directory) specificato nel percorso dell'oggetto.
