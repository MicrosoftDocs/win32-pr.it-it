---
description: La classe CIM \_ ConnectedTo rappresenta un'associazione che indica che due o più connettori fisici sono connessi.
...
La **classe CIM \_ ConnectedTo** viene ereditata dalla [**dipendenza CIM \_**](cim-dependency.md).
