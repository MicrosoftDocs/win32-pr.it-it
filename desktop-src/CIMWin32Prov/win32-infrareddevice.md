...
---
# <a name="win32_infrareddevice-class"></a>Win32 \_ InfraredDevice (classe)

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ InfraredDevice Win32** rappresenta le funzionalità e la gestione di un dispositivo a infrarossi.
...
La classe **Win32 \_ InfraredDevice** presenta questi tipi di membri:
...
La classe **Win32 \_ InfraredDevice** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                                |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) in [**CIM \_ InfraredController**](cim-infraredcontroller.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ InfraredController**](cim-infraredcontroller.md) per la documentazione.<br/> |
...
La classe **Win32 \_ InfraredDevice** dispone di queste proprietà.
...
Identificatore univoco del dispositivo a infrarossi.
...
Numero massimo di entità indirizzabili direttamente supportate da questo dispositivo. Se il numero è sconosciuto, è necessario usare un valore pari a 0 (zero).
...
La classe **Win32 \_ InfraredDevice** è derivata da [**CIM \_ InfraredController**](cim-infraredcontroller.md).
