---
description: La classe CIM BIOSElement rappresenta il software di basso livello caricato nell'archiviazione non volatile e usato per avviare e \_ configurare un computer.
ms.assetid: c203244a-51e0-4733-a0bc-cf9b7957f364
ms.tgt_platform: multiple
title: CIM_BIOSElement (provider WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701027"
---
# <a name="cim_bioselement-class-cimwin32-wmi-providers"></a>CIM_BIOSElement (provider WMI CIMWin32)

La **classe \_ CIM BIOSElement** rappresenta il software di basso livello caricato nell'archiviazione non volatile e usato per avviare e configurare un computer.
...
Edizione del linguaggio dell'elemento software. È consigliabile usare i codici di lingua definiti in ISO 639. Se l'elemento software rappresenta versioni multilingue o internazionali di un prodotto, è necessario usare la stringa "multilingue".
...
Produttore e tipo di sistema operativo per un elemento software quando il valore della **proprietà TargetOperatingSystem** è 1 ("Altro"). Quando il valore della proprietà **TargetOperatingSystem** è 1, questa proprietà deve avere un valore non Null. Per tutti gli **altri valori TargetOperatingSystem,** questa proprietà è Null.
...
Se **TRUE,** si tratta del BIOS primario del computer.
...
Identificatore dell'elemento software. È progettato per essere usato in combinazione con altre chiavi per creare una rappresentazione univoca di [**questo \_ CiM SoftwareElement.**](cim-softwareelement.md)
...
Ambiente del sistema operativo. Il valore di questa proprietà non garantisce l'esecuzione binaria. Sono necessarie altre informazioni. La versione del sistema operativo deve essere specificata usando il controllo della versione del sistema operativo. È necessaria anche l'architettura in cui viene eseguito il sistema operativo. La combinazione di questi costrutti consente al provider di identificare chiaramente il livello del sistema operativo necessario per un particolare elemento software.
...
La **classe \_ CIM BIOSElement** è derivata da [**CIM \_ SoftwareElement**](cim-softwareelement.md).

WMI non implementa questa classe. Per altre informazioni sulle classi derivate **da CIM \_ BIOSElement,** vedere [Classi Win32](win32-provider.md).
