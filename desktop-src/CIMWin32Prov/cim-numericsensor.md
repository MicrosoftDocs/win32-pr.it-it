...
---
# <a name="cim_numericsensor-class"></a>CIM \_ NumericSensor (classe)
...
| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-numericsensor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-numericsensor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La classe **CIM \_ NumericSensor** è derivata dal [**\_ sensore CIM**](cim-sensor.md).

WMI non implementa questa classe. Per le classi derivate da **CIM \_ NumericSensor**, vedere [Win32 Classes](win32-provider.md).
