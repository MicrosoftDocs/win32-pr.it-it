...
---
# <a name="reset-method-of-the-cim_flatpanel-class"></a>Metodo Reset della classe CIM \_ piatto

Il metodo **Reset** della classe CIM \_ piatto richiede la reimpostazione del dispositivo logico. Questo metodo viene ereditato da [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Piatto CIM](reset-method-in-class-cim-flatpanel.md)
</dt> <dt>
