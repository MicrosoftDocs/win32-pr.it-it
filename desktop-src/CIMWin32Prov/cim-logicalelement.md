...
---
# <a name="cim_logicalelement-class-cimwin32-wmi-providers"></a>Classe CIM_LogicalElement (provider WMI CIMWin32)

La classe **CIM \_ LogicalElement** è la classe di base per tutti i componenti di sistema che rappresentano componenti di sistema astratti, ad esempio profili, processi o funzionalità del sistema, sotto forma di dispositivi logici.
...
La classe **CIM \_ LogicalElement** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ LogicalElement** dispone di queste proprietà.
...
WMI non implementa questa classe. Per le classi derivate da **CIM \_ LogicalElement**, vedere [classi Win32](win32-provider.md).
