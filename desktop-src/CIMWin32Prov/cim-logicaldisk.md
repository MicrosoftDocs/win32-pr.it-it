...
---
# <a name="cim_logicaldisk-class-cimwin32-wmi-providers"></a>Classe CIM_LogicalDisk (provider WMI CIMWin32)
...
La classe **CIM \_ disco logico** presenta questi metodi.



| Metodo                                                                 | Descrizione                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-logicaldisk.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
Descrive se i supporti sono leggibili, scrivibili o entrambi, ad esempio. Questa proprietà viene ereditata da [**CIM \_ StorageExtent**](cim-storageextent.md).
...
Dimensioni, in byte, del disco logico.
...
La classe **CIM \_ disco logico** è derivata da [**CIM \_ StorageExtent**](cim-storageextent.md).

WMI non implementa questa classe. Per le classi derivate da **CIM \_ disco logico**, vedere [Win32 Classes](win32-provider.md).
