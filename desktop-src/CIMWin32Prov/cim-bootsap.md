...
---
# <a name="cim_bootsap-class"></a>CIM \_ BootSAP (classe)
...
La classe **CIM \_ BootSAP** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ BootSAP** dispone di queste proprietà.
