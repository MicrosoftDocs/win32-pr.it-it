...
---
# <a name="win32_memoryarray-class"></a>Win32 \_ MemoryArray (classe)

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ MemoryArray Win32** rappresenta le proprietà della matrice di memoria di sistema del computer e degli indirizzi mappati.
...
La classe **Win32 \_ MemoryArray** presenta questi tipi di membri:
...
La classe **Win32 \_ MemoryArray** presenta questi metodi.



| Metodo            | Descrizione                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reimpostazione**         | Non implementato. Per implementare questo metodo, vedere il metodo [**Reset**](reset-method-in-class-cim-controller.md) in [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) per la documentazione.<br/>                 |
| **SetPowerState** | Non implementato. Per implementare questo metodo, vedere il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) in [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) per la documentazione.<br/> |
...
La classe **Win32 \_ MemoryArray** dispone di queste proprietà.
...
Questo valore deriva dalla struttura dell' **indirizzo mappato della matrice di memoria** nelle informazioni sulla versione di SMBIOS. Per SMBIOS versioni da 2,1 a 2,6, il valore deriva dal membro dell' **indirizzo finale** . Per SMBIOS versione 2.7 + il valore deriva dal membro dell' **indirizzo finale esteso** .
...
**4** (livello partizione di memoria)
...
Questa proprietà viene ereditata da [**CIM \_ StorageExtent**](cim-storageextent.md). I valori possibili sono:

<dl> <dd>Altri</dd> <dd>Sconosciuto</dd> <dd>"None"</dd> <dd>Parità</dd> <dd>"ECC a bit singolo"</dd> <dd>"ECC a più bit"</dd> <dd>CRC</dd> </dl>
...
Questo valore deriva dalla struttura dell' **indirizzo mappato della matrice di memoria** nelle informazioni sulla versione di SMBIOS. Per SMBIOS versioni da 2,1 a 2,6, il valore deriva dal membro dell' **indirizzo iniziale** . Per SMBIOS versione 2.7 + il valore deriva dal membro dell' **indirizzo iniziale esteso** .
...
La classe **Win32 \_ MemoryArray** è derivata da [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md).
