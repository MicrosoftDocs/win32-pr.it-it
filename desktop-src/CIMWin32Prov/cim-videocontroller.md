---
description: La classe CIM \_ VideoController rappresenta le funzionalità e la gestione del controller video.
ms.assetid: 7cf6bf2a-62a5-46fa-8c8f-976604360461
ms.tgt_platform: multiple
title: CIM_VideoController classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119817501"
---
# <a name="cim_videocontroller-class"></a>Classe CiM \_ VideoController

La **classe CIM \_ VideoController** rappresenta le funzionalità e la gestione del controller video.
...
La **classe CIM \_ VideoController** ha questi tipi di membri:
...
La **classe CIM \_ VideoController** include questi metodi.



| Metodo                                                                     | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-videocontroller.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-videocontroller.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ VideoController** ha queste proprietà.
...
Qualificatori: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**CapabilityDescriptions**")
</dt> </dl>
...
Qualificatori: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indicizzato"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**AcceleratorCapabilities**")
</dt> </dl>

Stringhe in formato libero che forniscono descrizioni dettagliate per le funzionalità dell'acceleratore video indicate nella matrice **AcceleratorCapabilities.**

> [!Note]  
> Ogni voce di questa matrice è correlata alla voce nella matrice **AcceleratorCapabilities** che si trova nello stesso indice.
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.11"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixels")
</dt> </dl>
...
Se in modalità carattere, numero di righe per il controller video; In caso contrario, immettere 0.
...
Data e ora dell'ultima reimpostazione del controller, vale a dire che il controller è stato spento o reinizializzato.
...
Stringa in formato libero che descrive il processore video o il controller.

</dd> </dl>

## <a name="remarks"></a>Commenti

La **classe CIM \_ VideoController** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate **da CIM \_ VideoController,** vedere [Classi Win32.](win32-provider.md)
