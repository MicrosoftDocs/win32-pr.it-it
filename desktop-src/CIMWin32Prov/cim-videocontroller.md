...
---
# <a name="cim_videocontroller-class"></a>CIM \_ VideoController (classe)
...
La classe **CIM \_ VideoController** presenta questi tipi di membri:
...
La classe **CIM \_ VideoController** presenta questi metodi.



| Metodo                                                                     | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-videocontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ VideoController** dispone di queste proprietà.
...
Qualificatori: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**AcceleratorCapabilities**")
</dt> </dl>

Stringhe in formato libero che forniscono descrizioni dettagliate per le funzionalità di accelerazione video indicate nella matrice **AcceleratorCapabilities** .
...
WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ VideoController**, vedere [Win32 Classes](win32-provider.md).
