---
description: La classe CIM \_ Tachometer esiste per garantire la compatibilità con le versioni precedenti delle definizioni dello schema CIM.
ms.assetid: 30b7c23e-05c6-4fd6-80bc-3f729855ab45
ms.tgt_platform: multiple
title: CIM_Tachometer classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119547831"
---
# <a name="cim_tachometer-class"></a>Classe CIM \_ Tachometer

La **classe CIM \_ Tachometer esiste** per garantire la compatibilità con le versioni precedenti delle definizioni dello schema CIM. Con le aggiunte [**alle classi CiM \_ Sensor**](cim-sensor.md) e [**CIM \_ NumericSensor**](cim-numericsensor.md) nella versione 2.2, non è più necessario. È possibile definire un tachimetro impostando la proprietà **SensorType,** ereditata dal sensore **\_ CIM,** su 5 ("Tachometer"). Altre proprietà di questa classe sono hard coded in base a valori costanti che corrispondono alle definizioni nella gerarchia dei sensori.
...
La **classe CIM \_ Tachometer** ha questi tipi di membri:
...
La **classe CIM \_ Tachometer** include questi metodi.



| Metodo                                                                | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-tachometer.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-tachometer.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ Tachometer** ha queste proprietà.
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("centesimi di percentuale")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Se **TRUE,** il sensore è lineare sul relativo intervallo dinamico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>

Valore soglia che specifica gli intervalli (minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdCritical** e **LowerThresholdFatal,** lo stato corrente è critico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>

Valore soglia che specifica gli intervalli (minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se la **proprietà CurrentReading** è inferiore a **LowerThresholdFatal,** lo stato corrente è irreversibile.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>

Valore soglia che specifica gli intervalli (minimo e massimo) per determinare se il sensore funziona in condizioni normali, non critiche, critiche o irreversibili. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** il sensore segnala un valore normale. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdNonCritical** e **LowerThresholdCritical,** lo stato corrente è non critico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>

Valore massimo della proprietà misurata che può essere letto dal sensore numerico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Risoluzione"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("decime di rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolleranza"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**Unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
La **classe CIM \_ Tachometer** è derivata da [**CIM \_ NumericSensor**](cim-numericsensor.md).
