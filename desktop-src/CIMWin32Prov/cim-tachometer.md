...
---
# <a name="cim_tachometer-class"></a>\_Classe CIM contagiri

La classe **CIM \_ contagiri** esiste per la compatibilità con le versioni precedenti delle definizioni dello schema CIM. Con aggiunte alle classi CIM [**\_ Sensor**](cim-sensor.md) e [**cim \_ NumericSensor**](cim-numericsensor.md) nella versione 2,2, non è più necessario. È possibile definire un contagiri impostando la proprietà **SensorType** , ereditata **dal \_ sensore CIM**, su 5 ("contagiri"). Altre proprietà di questa classe sono hardcoded per i valori costanti che corrispondono alle definizioni nella gerarchia del sensore.
...
La classe **CIM \_ contagiri** presenta questi tipi di membri:
...
La classe **CIM \_ contagiri** presenta questi metodi.



| Metodo                                                                | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-tachometer.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ contagiri** presenta queste proprietà.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Risoluzione"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("decimi di rivoluzioni al minuto")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerance"), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("rivoluzioni al minuto")
</dt> </dl>
...
La classe **CIM \_ contagiri** è derivata da [**CIM \_ NumericSensor**](cim-numericsensor.md).
