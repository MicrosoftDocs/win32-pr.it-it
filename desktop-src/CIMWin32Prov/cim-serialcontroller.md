...
---
# <a name="cim_serialcontroller-class-cimwin32-wmi-providers"></a>Classe CIM_SerialController (provider WMI CIMWin32)

La classe **CIM \_ controller seriale** rappresenta le funzionalità e la gestione del dispositivo logico della porta seriale.
...
La classe **CIM \_ controller seriale** presenta questi metodi.



| Metodo                                                                      | Descrizione                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-serialcontroller.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
Compatibilità a livello di chip per il controller seriale. Questa proprietà descrive il buffering e altre funzionalità del controller seriale, che potrebbero essere inerenti all'hardware del chip. Questa proprietà è un intero enumerato.
...
Stringhe in formato libero che forniscono spiegazioni dettagliate per le funzionalità del controller seriale indicate nell'array delle **funzionalità** .
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| porte seriali \| 004,6 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" bit al secondo ")
</dt> </dl>

Velocità in baud massima, in bit al secondo, supportata dal controller seriale.
...
La classe **CIM \_ controller seriale** è derivata dal [**\_ controller CIM**](cim-controller.md).

WMI non implementa questa classe. Per le classi WMI derivate da **CIM \_ controller seriale**, vedere [Win32 Classes](win32-provider.md).
