...
---
# <a name="setpowerstate-method-of-the-cim_parallelcontroller-class"></a>Metodo SetPowerState della classe CIM \_ ParallelController
...
[\_PARALLELCONTROLLER CIM](setpowerstate-method-in-class-cim-parallelcontroller.md)
</dt> <dt>
