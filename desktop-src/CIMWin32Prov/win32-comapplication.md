---
description: La classe \_ WMI astratta WIN32 COMApplication rappresenta un'Component Object Model (COM). In questo contesto, un'applicazione COM è un raggruppamento logico di classi COM.
...
ms.locfileid: "119917971"
---
# <a name="win32_comapplication-class"></a>Classe COMApplication Win32 \_

La classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **astratta \_ COMApplication Win32** rappresenta un'Component Object Model (COM). In questo contesto, un'applicazione COM è un raggruppamento logico di classi COM.
...
La **classe \_ COMApplication Win32** include i tipi di membri seguenti:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ COMApplication Win32** ha queste proprietà.
...
La **classe \_ COMApplication Win32** è derivata da [**CIM \_ LogicalElement.**](cim-logicalelement.md)
