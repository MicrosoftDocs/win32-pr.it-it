...
---
# <a name="cim_associatedprocessormemory-class"></a>CIM \_ AssociatedProcessorMemory (classe)
...
La classe **CIM \_ AssociatedProcessorMemory** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **CIM \_ AssociatedProcessorMemory** dispone di queste proprietà.
...
Un [**\_ processore CIM**](cim-processor.md) che descrive il processore che accede alla memoria o utilizza la cache.
...
WMI non implementa questa classe. Per ulteriori informazioni sulle classi derivate da **CIM \_ AssociatedProcessorMemory**, vedere [Win32 Classes](win32-provider.md).
