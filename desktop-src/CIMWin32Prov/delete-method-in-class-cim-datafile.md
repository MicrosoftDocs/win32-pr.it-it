...
---
# <a name="delete-method-of-the-cim_datafile-class"></a>Metodo Delete della classe del file di \_ DataFile CIM
...
Il metodo **Delete** in file di [**\_ DataFile CIM**](cim-datafile.md) viene implementato da WMI.
...
[File di \_ DataFile CIM](delete-method-in-class-cim-datafile.md)
</dt> <dt>
