...
---
# <a name="interrogateservice-method-of-the-win32_baseservice-class"></a>Metodo InterrogateService della \_ classe BaseService Win32

Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **InterrogateService** richiede che il servizio aggiorni lo stato a Service Manager.
