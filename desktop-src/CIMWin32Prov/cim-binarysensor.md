...
La classe **CIM \_ BinarySensor** presenta questi tipi di membri:
...
La classe **CIM \_ BinarySensor** presenta questi metodi.



| Metodo                                                                  | Descrizione                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-binarysensor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                                 |
...
La classe **CIM \_ BinarySensor** dispone di queste proprietà.
...
La classe **CIM \_ BinarySensor** è derivata dal [**\_ sensore CIM**](cim-sensor.md).
