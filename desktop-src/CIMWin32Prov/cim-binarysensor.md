---
description: La classe CIM \_ BinarySensor fornisce un output booleano.
ms.assetid: 51396a51-78ea-4c49-8dcc-7fb815f334ae
ms.tgt_platform: multiple
title: CIM_BinarySensor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **classe \_ CiM BinarySensor** ha questi tipi di membri:
...
La **classe \_ CiM BinarySensor** include questi metodi.



| Metodo                                                                  | Descrizione                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-binarysensor.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando il dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe \_ CIM BinarySensor** ha queste proprietà.
...
Descrizione di un valore "False" dal sensore binario. Queste informazioni possono essere visualizzate a un utente.
...
Descrizione di un valore "True" dal sensore binario. Queste informazioni possono essere visualizzate a un utente.
...
La **classe CIM \_ BinarySensor** è derivata da [**CIM \_ Sensor**](cim-sensor.md).
