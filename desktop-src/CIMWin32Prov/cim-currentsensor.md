---
description: La classe CIM \_ CurrentSensor esiste per garantire la compatibilità con le versioni precedenti delle definizioni dello schema CIM.
ms.assetid: d1835b09-4286-4586-92ec-f5f77791aea6
ms.tgt_platform: multiple
title: CIM_CurrentSensor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119924631"
---
# <a name="cim_currentsensor-class"></a>Classe CIM \_ CurrentSensor

La **classe CIM \_ CurrentSensor esiste** per garantire la compatibilità con le versioni precedenti delle definizioni dello schema CIM.

Le aggiunte [**a CIM \_ Sensor**](cim-sensor.md) e [**CIM \_ NumericSensor**](cim-numericsensor.md) nella versione 2.2 lo rendono non più necessario. È possibile definire una classe **\_ CIM CurrentSensor** impostando la proprietà **SensorType,** ereditata dal sensore **CIM, \_** su 4 ("Current"). Altre proprietà di questa classe sono hard coded in valori costanti, che corrispondono alle definizioni nella gerarchia dei sensori.
...
La **classe CIM \_ CurrentSensor** ha questi tipi di membri:
...
La **classe CIM \_ CurrentSensor** include questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-currentsensor.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ CurrentSensor** ha queste proprietà.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Accuracy"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.19")
</dt> </dl>

Accuratezza del sensore per la proprietà misurata. Il valore viene registrato come più o meno centesimi di percentuale. Questa proprietà e le **proprietà Resolution** e **Tolerance** vengono usate per calcolare il valore effettivo della proprietà fisica misurata. L'accuratezza può variare a seconda che il dispositivo sia lineare o meno nel relativo intervallo dinamico.
...
Il dispositivo è in modalità di risparmio energia, ma lo stato esatto è sconosciuto.
...
Il dispositivo è in modalità di risparmio energia e continua a funzionare, ma può presentare prestazioni ridotte.
...
Avviso di risparmio energia.

Il dispositivo è in uno stato di avviso e in modalità di risparmio energia.
...
Il sensore corrente non è disponibile.
...
Indica se il dispositivo usa una configurazione definita dall'utente.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.5"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.13"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore opera in condizioni critiche. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdCritical** e **LowerThresholdFatal,** lo stato corrente è critico.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.15"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore opera in condizioni fatali. Se la **proprietà CurrentReading** è inferiore **a LowerThresholdFatal,** lo stato corrente è irreversibile.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.11"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore funziona in condizioni normali o non critiche. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** il sensore segnala un valore normale. Se tuttavia la **proprietà CurrentReading** è compresa tra **LowerThresholdNonCritical** e **LowerThresholdCritical,** lo stato corrente non è critico.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.9"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.10"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.6"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore previsto per il sensore numerico.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.7"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.8"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>
...
Win32 Plug and Play identificatore di dispositivo del dispositivo logico.
...
Funzionalità specifiche relative all'alimentazione del dispositivo logico.
...
Il dispositivo può modificare lo stato di alimentazione in base all'uso o ad altri criteri.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) è supportato.
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) può essere richiamato con il *parametro PowerState* impostato su 5 ("Ciclo di alimentazione").
...
Il [**metodo SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("Ciclo di alimentazione") e il parametro *Time* impostato su una data e un'ora o un intervallo specifico per l'accensione.
...
Se **TRUE,** il dispositivo può essere gestito dall'alimentazione, vale a dire inserito in uno stato di risparmio energia. Questa proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate o, se abilitate, quali funzionalità sono supportate. Per altre informazioni, vedere la matrice **PowerManagementCapabilities.**

Se **FALSE,** il valore intero 1, per la stringa "Non supportato", deve essere l'unica voce nella matrice **PowerManagementCapabilities.**
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Resolution"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.17"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("decime di milliamps")
</dt> </dl>

Capacità del sensore di risolvere le differenze nella proprietà misurata. Questa proprietà e le **proprietà Accuratezza** **e Tolleranza** vengono usate per calcolare il valore effettivo della proprietà fisica misurata. Questo valore può variare a seconda che il dispositivo sia lineare rispetto all'intervallo dinamico.
...
Definizione dell'ambito della **proprietà CreationClassName del** sistema.
...
Definizione dell'ambito della **proprietà Name del** sistema.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerance"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.18"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Tolleranza del sensore per la proprietà misurata. Questa proprietà e le **proprietà Resolution** e **Accuracy** vengono usate per calcolare il valore effettivo della proprietà fisica misurata. La tolleranza può variare a seconda che il dispositivo sia lineare rispetto all'intervallo dinamico.
...
Qualificatori: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.14"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore funziona in condizioni critiche. Se la **proprietà CurrentReading** è compresa tra **UpperThresholdCritical** e **UpperThresholdFatal,** lo stato corrente è critico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.16"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore opera in condizioni irreversibili. Se la **proprietà CurrentReading** è superiore **a UpperThresholdFatal,** lo stato corrente è irreversibile.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.12"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milliamps")
</dt> </dl>

Valore soglia che specifica se il sensore funziona in condizioni normali o non critiche. Se la **proprietà CurrentReading** è compresa tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** il sensore segnala un valore normale. Se tuttavia la proprietà **CurrentReading** è compresa tra **UpperThresholdNonCritical** e **UpperThresholdCritical,** lo stato corrente è non critico.
...
La **classe CIM \_ CurrentSensor** è derivata da [**CIM \_ NumericSensor**](cim-numericsensor.md).

WMI non implementa questa classe. Per altre informazioni sulle classi WMI derivate da **CIM \_ CurrentSensor,** vedere [Classi Win32.](win32-provider.md)
