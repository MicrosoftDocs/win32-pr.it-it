...
---
# <a name="cim_currentsensor-class"></a>CIM \_ CurrentSensor (classe)

La classe **CIM \_ CurrentSensor** esiste per compatibilità con le versioni precedenti delle definizioni dello schema CIM.

Le aggiunte a [**CIM \_ Sensor**](cim-sensor.md) e [**cim \_ NumericSensor**](cim-numericsensor.md) nella versione 2,2 ne rendono non più necessario. Una classe **CIM \_ CurrentSensor** può essere definita impostando la proprietà **SensorType** , ereditata dal **\_ sensore CIM**, su 4 ("Current"). Le altre proprietà di questa classe sono hardcoded in valori costanti, che corrispondono alle definizioni nella gerarchia del sensore.
...
La classe **CIM \_ CurrentSensor** presenta questi tipi di membri:
...
La classe **CIM \_ CurrentSensor** presenta questi metodi.



| Metodo                                                                   | Descrizione                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-currentsensor.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ CurrentSensor** dispone di queste proprietà.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("accuratezza"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,19 ")
</dt> </dl>
...
Il dispositivo è in modalità di risparmio energia e funziona ancora, ma può presentare prestazioni ridotte.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,5 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,13 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni critiche. Se la proprietà **CurrentReading** è compresa tra **LowerThresholdCritical** e **LowerThresholdFatal**, lo stato corrente è critical.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,15 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni irreversibili. Se la proprietà **CurrentReading** è inferiore a **LowerThresholdFatal**, lo stato corrente è irreversibile.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,11 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni normali o non critiche. Se la proprietà **CurrentReading** è compresa tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, il sensore segnala un valore normale. Se la proprietà **CurrentReading** è tuttavia compresa tra **LowerThresholdNonCritical** e **LowerThresholdCritical**, lo stato corrente è non critico.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,9 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,10 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,6 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,7 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,8 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Win32 Plug and Play identificatore dispositivo del dispositivo logico.
...
Funzionalità specifiche relative al risparmio di energia del dispositivo logico.
...
Il metodo [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) può essere richiamato con il parametro *PowerState* impostato su 5 ("ciclo di alimentazione") e il parametro *ora* impostato su una data e un'ora specifiche, o su un intervallo, per l'accensione.
...
Se **true**, il dispositivo può essere gestito da energia elettrica, ovvero viene inserito in uno stato di risparmio energia. Questa proprietà non indica che le funzionalità di risparmio energia sono attualmente abilitate o se abilitate, quali funzionalità sono supportate. Per ulteriori informazioni, vedere la matrice **PowerManagementCapabilities** .

Se **false**, il valore intero 1, per la stringa "non supportata", deve essere l'unica voce nella matrice **PowerManagementCapabilities** .
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Risoluzione"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Probe corrente elettrico \| 001,17 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" decimi di milliampere ")
</dt> </dl>

Capacità del sensore di risolvere le differenze nella proprietà misurata. Questa proprietà e le proprietà di **accuratezza** e **tolleranza** vengono utilizzate per calcolare il valore effettivo della proprietà fisica misurata. Questo valore può variare a seconda che il dispositivo sia lineare sull'intervallo dinamico.
...
Proprietà **CreationClassName** del sistema di ambito.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerance"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,18 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,14 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni critiche. Se la proprietà **CurrentReading** è compresa tra **UpperThresholdCritical** e **UpperThresholdFatal**, lo stato corrente è critical.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,16 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni irreversibili. Se la proprietà **CurrentReading** è sopra **UpperThresholdFatal**, lo stato corrente è irreversibile.
...
Qualificatori: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Probe corrente elettrica DMTF \| 001,12 "), [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampere ")
</dt> </dl>

Valore di soglia che specifica se il sensore funziona in condizioni normali o non critiche. Se la proprietà **CurrentReading** è compresa tra **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, il sensore segnala un valore normale. Se la proprietà **CurrentReading** è tuttavia compresa tra **UpperThresholdNonCritical** e **UpperThresholdCritical**, lo stato corrente è non critico.
...
WMI non implementa questa classe. Per ulteriori informazioni sulle classi WMI derivate da **CIM \_ CurrentSensor**, vedere [Win32 Classes](win32-provider.md).
