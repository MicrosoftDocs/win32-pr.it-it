---
description: La classe CIM \_ WORMDrive rappresenta le funzionalità e la gestione di un'unità WORM, un sottotipo del dispositivo di accesso ai supporti.
ms.assetid: df77084a-01f2-4cca-b395-d74ee64ef526
ms.tgt_platform: multiple
title: CIM_WORMDrive classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119505431"
---
# <a name="cim_wormdrive-class"></a>Classe CIM \_ WORMDrive

La **classe CIM \_ WORMDrive** rappresenta le funzionalità e la gestione di un'unità WORM, un sottotipo del dispositivo di accesso ai supporti.
...
La **classe CIM \_ WORMDrive** include questi tipi di membri:
...
La **classe CIM \_ WORMDrive** include questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-wormdrive.md)                 | Richiede una reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-wormdrive.md) | Definisce lo stato di alimentazione desiderato per un dispositivo logico e quando un dispositivo deve essere inserito in tale stato. Non implementato da WMI.<br/> |
...
La **classe CIM \_ WORMDrive** ha queste proprietà.
...
Stringhe in formato libero che forniscono descrizioni dettagliate per le funzionalità di accesso del dispositivo indicate nella **matrice Capabilities.**
...
Se **TRUE,** il dispositivo di accesso ai supporti deve essere pulito. Se è possibile eseguire la pulizia manuale o automatica, è indicato nella proprietà della matrice **Capabilities.**
...
La **classe CIM \_ WORMDrive** deriva da [**CIM \_ MediaAccessDevice.**](cim-mediaaccessdevice.md)
