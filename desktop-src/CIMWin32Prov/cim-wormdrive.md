...
---
# <a name="cim_wormdrive-class"></a>CIM \_ WORMDrive (classe)

La classe **CIM \_ WORMDrive** rappresenta le funzionalità e la gestione di un'unità worm, un sottotipo del dispositivo di accesso multimediale.
...
La classe **CIM \_ WORMDrive** presenta questi tipi di membri:
...
La classe **CIM \_ WORMDrive** presenta questi metodi.



| Metodo                                                               | Descrizione                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-wormdrive.md)                 | Richiede la reimpostazione del dispositivo logico. Non implementato da WMI.<br/>                                                               |
...
La classe **CIM \_ WORMDrive** dispone di queste proprietà.
...
Stringhe in formato libero che forniscono descrizioni dettagliate per le funzionalità di accesso ai dispositivi indicate nell'array delle **funzionalità** .
...
La classe **CIM \_ WORMDrive** è derivata da [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).
