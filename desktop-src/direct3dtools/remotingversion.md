...
Valore che indica che viene usato il Windows 10 remoto remoto (a partire da Windows 10, la diagnostica della grafica è un componente del sistema operativo)
...
Valore che indica che viene Windows 10 protocollo di comunicazione remota Windows 10 (gennaio 2015, v2). Questa versione del protocollo ha introdotto richieste per la visualizzazione di risorse affiancate.
...
Valore che indica che viene Windows 10 protocollo di comunicazione remota Windows 10 (gennaio 2015, v3). Questa versione del protocollo ha introdotto IPixEngine7, ora deprecato, per il controllo del supporto della versione dell'interfaccia.
