...
---
# <a name="span-idvspixengineicallstackrequest_requestasync_eventid_icallstackcallback_ptr_dword_dwordspanicallstackrequestrequestasync-method"></a><span id="vspixengine.icallstackrequest_requestasync_eventid_icallstackcallback_ptr_dword_dword"></span>Metodo ICallStackRequest:: RequestAsync

Richiesta asincrona di ottenere lo stack di chiamate RVA (relativi indirizzi virtuali) dell'evento specificato.
