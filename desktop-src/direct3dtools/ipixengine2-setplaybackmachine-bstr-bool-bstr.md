---
description: Imposta il computer di riproduzione corrente per il log grafico specificato.
...
Imposta il computer di riproduzione corrente per il log grafico specificato.
...
*Logfile*   
Stringa COM che rappresenta il nome del log grafico.
