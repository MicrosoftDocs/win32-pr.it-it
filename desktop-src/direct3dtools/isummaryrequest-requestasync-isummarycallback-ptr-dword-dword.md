...
ms.locfileid: "122624887"
---
# <a name="span-idvspixengineisummaryrequest_requestasync_isummarycallback_ptr_dword_dwordspanisummaryrequestrequestasync-method"></a><span id="vspixengine.isummaryrequest_requestasync_isummarycallback_ptr_dword_dword"></span>Metodo ISummaryRequest::RequestAsync

Richiesta asincrona per ottenere informazioni di riepilogo su un log di grafica.
