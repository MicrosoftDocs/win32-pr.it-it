---
description: Ottiene informazioni sulle colonne (tipi di dati degli eventi) supportate dall'elenco di eventi.
...
Ottiene informazioni sulle colonne (tipi di dati degli eventi) supportate dall'elenco di eventi.
...
*Numcolumns*   
Numero di colonne supportate da

*count0 \_ pID*   
ID di ogni colonna supportata dall'elenco di eventi.

*count0 \_ pBstrNames*   
Nomi di ogni colonna, come stringa COM, supportati dall'elenco di eventi.
