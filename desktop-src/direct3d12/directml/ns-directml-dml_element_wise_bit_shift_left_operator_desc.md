...
---
# <a name="dml_element_wise_bit_shift_left_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_BIT_SHIFT_LEFT_OPERATOR_DESC struttura (directml.h)

Esegue uno spostamento logico a sinistra di ogni elemento di *ATensor* di un numero di bit specificato dall'elemento corrispondente di *BTensor,* inserendo il risultato nell'elemento corrispondente di *OutputTensor.*
