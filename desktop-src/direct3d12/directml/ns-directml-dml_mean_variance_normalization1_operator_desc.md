...
Questo tensore è obbligatorio se *viene usato BiasTensor.*
...
Un livello di attivazione fuso facoltativo da applicare dopo la normalizzazione.
...
*BiasTensor,* *InputTensor,* *OutputTensor* e *ScaleTensor* devono avere gli stessi *DataType* *e DimensionCount.*
