...
Esegue la funzione di attivazione CELU (Exponential Linear Unit) continuamente differenziale su ogni elemento in *InputTensor,* inserendo il risultato nell'elemento corrispondente di *OutputTensor.*
...
Dove:
* exp(x) è la funzione di elevamento a esponente naturale
* max(a,b) restituisce il più grande dei due valori a,b
