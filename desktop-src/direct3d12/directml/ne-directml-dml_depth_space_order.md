...
| Nome | Descrizione |
| ---- |:---- |
| DML_DEPTH_SPACE_ORDER_DEPTH_COLUMN_ROW | Fa in modo che i [tensori](./ns-directml-dml_depth_to_space1_operator_desc.md) DML_DEPTH_TO_SPACE1_OPERATOR_DESC e [DML_SPACE_TO_DEPTH1_OPERATOR_DESC](./ns-directml-dml_space_to_depth1_operator_desc.md) siano interpretati con i layout seguenti, in cui le dimensioni tra parentesi vengono appiattite insieme.<br><br>- **Versione depth:**[Batch, (BlockHeight, BlockWidth, Channels), Height, Width]<br>- **Versione spazio:**[Batch, Canali, (Height, BlockHeight), (Width, BlockWidth)] |
| DML_DEPTH_SPACE_ORDER_COLUMN_ROW_DEPTH | Fa in modo che i [tensori](./ns-directml-dml_depth_to_space1_operator_desc.md) DML_DEPTH_TO_SPACE1_OPERATOR_DESC e [DML_SPACE_TO_DEPTH1_OPERATOR_DESC](./ns-directml-dml_space_to_depth1_operator_desc.md) siano interpretati con i layout seguenti, in cui le dimensioni tra parentesi vengono appiattite insieme.<br><br>- **Versione depth:**[Batch, (Channels, BlockHeight, BlockWidth), Height, Width]<br>- **Versione spazio:**[Batch, Canali, (Height, BlockHeight), (Width, BlockWidth)] |
