---
title: Intrinseci del valore di sistema HLSL raytracing direct3D 12
description: Visualizzare i collegamenti ad articoli che descrivono funzioni intrinseche del valore di sistema HLSL (High-Level Shader Language) che supportano la pipeline di raytracing Direct3D 12.
ms.assetid: ''
...
---
# <a name="direct3d-12-raytracing-hlsl-system-value-intrinsics"></a>Intrinseci del valore di sistema HLSL raytracing direct3D 12
...
### <a name="ray-dispatch-system-values"></a>Valori di sistema di Ray dispatch
...
### <a name="ray-system-values"></a>Valori di sistema ray

| Argomento | Descrizione |
|-|-|
| [**WorldRayOrigin**](worldrayorigin.md) | Origine dello spazio mondiale del raggio corrente. |
...
| [**Instanceid**](instanceid.md) | Identificatore fornito dall'utente per l'istanza dell'istanza della struttura di accelerazione di livello inferiore all'interno della struttura di primo livello. |
...
| [**ObjectToWorld3x4**](objecttoworld3x4.md) | Matrice per la trasformazione da spazio oggetto a spazio-mondo. |
| [**ObjectToWorld4x3**](objecttoworld4x3.md) | Matrice per la trasformazione da spazio oggetto a spazio-mondo. |
| [**WorldToObject3x4**](worldtoobject3x4.md) | Matrice per la trasformazione da spazio del mondo a spazio oggetto |
| [**WorldToObject4x3**](worldtoobject4x3.md) | Matrice per la trasformazione da spazio del mondo a spazio oggetto |
