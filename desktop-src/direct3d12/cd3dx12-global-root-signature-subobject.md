...
description: Classe helper per la creazione di un sottooggetto di stato della firma radice globale.
keywords:
- CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT classe
topic_type:
- apiref
api_name:
...
ms.locfileid: "121812484"
---
# <a name="cd3dx12_global_root_signature_subobject-class"></a>CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT classe

Classe helper per la creazione di un sottooggetto di stato della firma radice globale.
...
Costruttore predefinito. Crea una nuova istanza inizializzata per impostazione predefinita di un **CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT**.

`CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT(CD3DX12_STATE_OBJECT_DESC&)`

Costruttore che crea una nuova istanza di un **CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT** inizializzato con il contenuto di un [**CD3DX12_STATE_OBJECT_DESC**](cd3dx12-state-object-desc.md) oggetto .
...
Recupera il tipo del sottooggetto, rappresentato dalla [D3D12_STATE_SUBOBJECT_TYPE_GLOBAL_ROOT_SIGNATURE](/windows/win32/api/d3d12/ne-d3d12-d3d12_state_subobject_type) costante.
