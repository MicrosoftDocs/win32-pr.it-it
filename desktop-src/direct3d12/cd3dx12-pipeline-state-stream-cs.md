...
---
# <a name="cd3dx12_pipeline_state_stream_cs-structure"></a>\_ \_ \_ Struttura CS del flusso di stato della pipeline CD3DX12 \_

Struttura di supporto utilizzata per descrivere un compute shader come singolo oggetto adatto per la descrizione di un flusso.
...
**\_ \_ CS flusso di stato della pipeline CD3DX12 \_ \_**
</dt> <dd>
...
**CD3DX12 \_ pipeline \_ state \_ Stream \_ cs (D3D12 \_ shader \_ BYTECODE const &i)**
</dt> <dd>
...
\_ \_ \_ Il flusso di stato \_ della pipeline CD3DX12 CS è una specializzazione typedef del modello di [**\_ \_ \_ \_ sottooggetto flusso di stato della pipeline CD3DX12**](cd3dx12-pipeline-state-stream-subobject.md) e viene definito come segue:
