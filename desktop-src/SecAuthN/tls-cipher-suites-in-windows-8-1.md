...
ms.locfileid: "118916130"
---
# <a name="tls-cipher-suites-in-windows-81"></a>Pacchetti di crittografia TLS in Windows 8.1
...
-   Consentito quando l'applicazione passa SCH USE STRONG CRYPTO: il provider Microsoft Schannel filtra i pacchetti di crittografia deboli noti quando l'applicazione usa il \_ flag SCH USE STRONG \_ \_ \_ \_ \_ CRYPTO. In Windows 8.1, le suite di crittografia RC4 vengono filtrate.
...
Windows 8.1 e Windows Server 2012 R2 vengono aggiornati da Windows Update dal [](https://support.microsoft.com/kb/2919355) 2919355 di aggiornamento applicato che aggiunge i nuovi pacchetti di crittografia e modifica l'ordine di priorità. Le suite di crittografia seguenti sono abilitate e in questo ordine di priorità per impostazione predefinita dal provider Microsoft Schannel:
