...
---
# <a name="iscardcmdput_instructionid-method"></a>ISCardCmd::p UT \_ InstructionId metodo
...
Per ottenere l'identificatore di istruzioni esistente, chiamare [**get \_ InstructionId**](iscardcmd-get-instructionid.md).
...
Nell'esempio seguente viene illustrato come impostare un identificatore di istruzione nell' [*unità dati del protocollo dell'applicazione*](../secgloss/a-gly.md) (APDU). Nell'esempio si presuppone che pISCardCmd sia un puntatore valido a un'istanza dell'interfaccia [**ISCardCmd**](iscardcmd.md) .
...
[**ottenere \_ InstructionId**](iscardcmd-get-instructionid.md)
</dt> <dt>
