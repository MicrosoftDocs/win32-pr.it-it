---
description: Consente a un'applicazione di trasporto di eseguire query sul pacchetto [*di sicurezza*](../secgloss/s-gly.md) Kerberos per determinati attributi di un contesto [*di sicurezza.*](../secgloss/s-gly.md)
...
ms.locfileid: "118920166"
---
# <a name="querycontextattributes-kerberos-function"></a>Funzione QueryContextAttributes (Kerberos)

La **funzione QueryContextAttributes (Kerberos)** consente a un'applicazione di trasporto di eseguire query sul [*pacchetto*](../secgloss/s-gly.md) di sicurezza Kerberos per determinati [*attributi*](../secgloss/a-gly.md#_security_attribute_gly) di un contesto [*di sicurezza.*](../secgloss/s-gly.md)
