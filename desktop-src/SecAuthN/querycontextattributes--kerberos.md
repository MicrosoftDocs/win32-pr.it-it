...
La funzione **QueryContextAttributes (Kerberos)** consente a un'applicazione di trasporto di eseguire una query sul [*pacchetto di sicurezza*](../secgloss/s-gly.md) Kerberos per determinati [*attributi*](../secgloss/a-gly.md#_security_attribute_gly) di un [*contesto di sicurezza*](../secgloss/s-gly.md).
