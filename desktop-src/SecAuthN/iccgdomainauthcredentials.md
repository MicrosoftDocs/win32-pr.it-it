...
L'interfaccia **ICcgDomainAuthCredentials** eredita dall'interfaccia [**IUnknown**](/windows/win32/api/unknwn/nn-unknwn-iunknown) . **ICcgDomainAuthCredentials** dispone anche di questi tipi di membri:

-   [Metodi](#methods)

### <a name="methods"></a>Metodi

L'interfaccia **ICcgDomainAuthCredentials** dispone di questi metodi.



| Metodo                                           | Descrizione                                                                                               |
|:-------------------------------------------------|:----------------------------------------------------------------------------------------------------------|
| [**GetPasswordCredentials**](iccgdomainauthcredentials-getpasswordcredentials.md)               | Restituisce le credenziali per autenticare un contenitore non appartenente a un dominio con Active Directory.<br/>                                                              |
