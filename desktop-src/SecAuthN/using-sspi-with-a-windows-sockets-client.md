...
---
# <a name="using-sspi-with-a-windows-sockets-client"></a><span data-ttu-id="61644-103">Uso di SSPI con un client Windows Sockets</span><span class="sxs-lookup"><span data-stu-id="61644-103">Using SSPI with a Windows Sockets Client</span></span>

<span data-ttu-id="61644-104">Questo programma di esempio funziona con il programma server [usando SSPI con un server Windows Sockets](using-sspi-with-a-windows-sockets-server.md).</span><span class="sxs-lookup"><span data-stu-id="61644-104">This sample program works with the server program [Using SSPI with a Windows Sockets Server](using-sspi-with-a-windows-sockets-server.md).</span></span> <span data-ttu-id="61644-105">I programmi di esempio client e server sono progettati per interagire.</span><span class="sxs-lookup"><span data-stu-id="61644-105">The client and server sample programs are designed to work together.</span></span> <span data-ttu-id="61644-106">Entrambi i programmi utilizzano il file di intestazione SspiExample. h, disponibile nel [file di intestazione per gli esempi di client e server SSPI](header-file-for-sspi-client-and-server.md).</span><span class="sxs-lookup"><span data-stu-id="61644-106">Both programs use the header file SspiExample.h, which can be found in [Header File for SSPI Client and Server Samples](header-file-for-sspi-client-and-server.md).</span></span> <span data-ttu-id="61644-107">Questo programma include le chiamate alle funzioni in Secur32. lib e WS2 \_ 32. lib, che devono essere incluse tra le librerie di collegamento.</span><span class="sxs-lookup"><span data-stu-id="61644-107">This program includes calls to functions in Secur32.lib and Ws2\_32.lib, which must be included among the link libraries.</span></span>

<span data-ttu-id="61644-108">Questo programma dimostra quanto segue:</span><span class="sxs-lookup"><span data-stu-id="61644-108">This program demonstrates the following:</span></span>

-   <span data-ttu-id="61644-109">Creazione di una connessione Windows Sockets con un server.</span><span class="sxs-lookup"><span data-stu-id="61644-109">Establishing a Windows Sockets connection with a server.</span></span>
-   <span data-ttu-id="61644-110">Inizializzazione di una sessione SSPI autenticata con SSP Negotiate.</span><span class="sxs-lookup"><span data-stu-id="61644-110">Initializing an authenticated SSPI session with the Negotiate SSP.</span></span>
-   <span data-ttu-id="61644-111">Connessione a un server e creazione di una sessione di comunicazione protetta.</span><span class="sxs-lookup"><span data-stu-id="61644-111">Connecting with a server and establishing a secure communication session.</span></span>
-   <span data-ttu-id="61644-112">Ricezione e decrittografia di un messaggio dal server all'interno della sessione protetta.</span><span class="sxs-lookup"><span data-stu-id="61644-112">Receiving and decrypt a message from the server within the secure session.</span></span>

<span data-ttu-id="61644-113">Questo programma di esempio usa la gestione degli errori limitata.</span><span class="sxs-lookup"><span data-stu-id="61644-113">This sample program uses limited error handling.</span></span>
