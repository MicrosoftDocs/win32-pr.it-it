...
ms.locfileid: "106306551"
---
# <a name="querycontextattributes-negotiate-function"></a>Funzione QueryContextAttributes (Negotiate)

La funzione **QueryContextAttributes (Negotiate)** consente a un'applicazione di trasporto di eseguire una query sul [*pacchetto di sicurezza*](../secgloss/s-gly.md) Negotiate per determinati [*attributi*](../secgloss/a-gly.md#_security_attribute_gly) di un contesto di [*sicurezza*](../secgloss/s-gly.md).
