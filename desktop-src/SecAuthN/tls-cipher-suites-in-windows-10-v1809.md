...
-   Consentito quando l'applicazione passa SCH USE STRONG CRYPTO: il provider Microsoft Schannel filtra i pacchetti di crittografia deboli noti quando l'applicazione usa \_ il flag SCH USE STRONG \_ \_ \_ \_ \_ CRYPTO. I pacchetti di crittografia RC4, DES, export e null vengono filtrati.
