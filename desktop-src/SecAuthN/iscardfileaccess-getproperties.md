...
Il metodo **GetProperties** recupera i dati primitivi a cui fa riferimento TLVs (tag, length, value) per l'oggetto specificato.
...
Puntatore a strutture TLV il cui valore è stato recuperato.
