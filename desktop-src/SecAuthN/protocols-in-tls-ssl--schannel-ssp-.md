...
SSP Schannel implementa le versioni dei protocolli TLS, DTLS e SSL. Versioni di Windows diverse supportano versioni del protocollo diverse.
...
Di seguito è elencato il supporto microsoft Schannel Provider delle versioni del protocollo DTLS.
