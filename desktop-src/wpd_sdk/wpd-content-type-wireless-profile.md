...
ms.locfileid: "119445091"
---
# <a name="wpd_content_type_wireless_profile"></a>PROFILO WIRELESS \_ DEL TIPO DI CONTENUTO \_ WPD \_ \_

Un oggetto che descrive il tipo come WPD CONTENT TYPE WIRELESS PROFILE rappresenta le \_ informazioni usate per accedere a una rete \_ \_ \_ wireless.
...
|--------------------------------------------------------|-------------------------------------------------------|---------------------------|
| [**IMPOSTAZIONE PREDEFINITA DELLA RISORSA WPD \_ \_**](wpd-resource-default.md) | Obbligatorio se l'oggetto è rappresentato da dati binari. | Contiene i dati binari. |
