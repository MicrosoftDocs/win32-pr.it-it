...
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="053fd-103">Emissione del comando GetDevicePropValue</span><span class="sxs-lookup"><span data-stu-id="053fd-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="053fd-104">L'esempio in questa sezione richiama il comando **GetDevicePropValue** MTP per recuperare la proprietà del dispositivo **BatteryLevel** .</span><span class="sxs-lookup"><span data-stu-id="053fd-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="053fd-105">Per una descrizione completa di questo comando e dei relativi parametri, vedere la [specifica MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).</span><span class="sxs-lookup"><span data-stu-id="053fd-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="053fd-106">Nel caso di **GetDevicePropValue**, il codice di esempio usa la sequenza seguente:</span><span class="sxs-lookup"><span data-stu-id="053fd-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="053fd-107">comando \_ WPD \_ MTP \_ ext \_ Execute \_ \_ con \_ dati \_ da \_ leggere</span><span class="sxs-lookup"><span data-stu-id="053fd-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="053fd-108">\_comando WPD \_ MTP \_ ext \_ Read \_ Data</span><span class="sxs-lookup"><span data-stu-id="053fd-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="053fd-109">\_comando WPD \_ MTP \_ ext \_ End \_ data \_ Transfer</span><span class="sxs-lookup"><span data-stu-id="053fd-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="053fd-110">Nell'esempio di codice seguente viene illustrato il modo in cui l'applicazione initates la sequenza di comandi.</span><span class="sxs-lookup"><span data-stu-id="053fd-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="053fd-111">Nell'esempio di codice seguente viene illustrato il modo in cui l'applicazione recupera i dati della proprietà.</span><span class="sxs-lookup"><span data-stu-id="053fd-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="053fd-112">L'esempio di codice seguente mostra come l'applicazione recupera la risposta del dispositivo al comando.</span><span class="sxs-lookup"><span data-stu-id="053fd-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="053fd-113">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="053fd-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="053fd-114">Supporto delle estensioni MTP</span><span class="sxs-lookup"><span data-stu-id="053fd-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
