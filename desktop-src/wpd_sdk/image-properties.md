...
| **RISOLUZIONE ORIZZONTALE DELL'IMMAGINE WPD \_ \_ \_**                                                                                                         | **VT \_ R8**  | Indica la risoluzione orizzontale di un'immagine, in punti per pollice (DPI).                                                                                                                                                                                                                                                                       |
