...
---
# <a name="issuing-the-getnumobjects-command"></a><span data-ttu-id="0e43a-103">Emissione del comando GetNumObjects</span><span class="sxs-lookup"><span data-stu-id="0e43a-103">Issuing the GetNumObjects Command</span></span>

<span data-ttu-id="0e43a-104">Nell'esempio riportato in questa sezione viene richiamato il comando **GetNumObjects** MTP.</span><span class="sxs-lookup"><span data-stu-id="0e43a-104">The example in this section invokes the **GetNumObjects** MTP command.</span></span> <span data-ttu-id="0e43a-105">Per una descrizione completa di questo comando e dei relativi parametri, vedere la [specifica MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).</span><span class="sxs-lookup"><span data-stu-id="0e43a-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="0e43a-106">Prima di richiamare questo comando, è necessario innanzitutto impostare i parametri del comando.</span><span class="sxs-lookup"><span data-stu-id="0e43a-106">Before you invoke this command, you must first set up the command parameters.</span></span>
...
<span data-ttu-id="0e43a-107">Una volta impostati i parametri, l'applicazione richiama il comando.</span><span class="sxs-lookup"><span data-stu-id="0e43a-107">After the parameters are set up, the application invokes the command.</span></span>
...
<span data-ttu-id="0e43a-108">Dopo che l'applicazione ha richiamato il comando, elabora la risposta dal driver MTP.</span><span class="sxs-lookup"><span data-stu-id="0e43a-108">After the application invokes the command, it processes the response from the MTP driver.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0e43a-109">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="0e43a-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0e43a-110">Supporto delle estensioni MTP</span><span class="sxs-lookup"><span data-stu-id="0e43a-110">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
