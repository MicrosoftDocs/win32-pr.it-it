...
---
# <a name="wpd_content_type_generic_file"></a>\_ \_ file generico di tipo di contenuto WPD \_ \_

Un oggetto che descrive il tipo come \_ file generico di tipo di contenuto WPD \_ \_ \_ rappresenta un oggetto generico con un file fisico sottostante. La differenza tra questo tipo e il \_ tipo di contenuto WPD \_ \_ non specificato è che un oggetto non specificato è più generico e non è necessario che disponga di un file sottostante. Questo tipo di oggetto può essere creato in modo da contenere i dati di un tipo non specificato che il dispositivo non intende utilizzare.
...
|--------------------------------------------------------|----------------------|-------------------------|
| [**\_impostazione predefinita della risorsa WPD \_**](wpd-resource-default.md) | Obbligatorio.            | Contiene i dati del file. |
