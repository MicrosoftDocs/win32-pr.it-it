...
---
# <a name="value-map-annotation-sample"></a><span data-ttu-id="da22c-103">Esempio di annotazione mappa di valori</span><span class="sxs-lookup"><span data-stu-id="da22c-103">Value Map Annotation Sample</span></span>

<span data-ttu-id="da22c-104">Tagliare, incollare e modificare l'esempio di codice seguente per uso personale.</span><span class="sxs-lookup"><span data-stu-id="da22c-104">Cut, paste, and modify the following code sample for your own use.</span></span> <span data-ttu-id="da22c-105">Seguire le istruzioni riportate nei commenti contrassegnati con/ \* todo \* /.</span><span class="sxs-lookup"><span data-stu-id="da22c-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
