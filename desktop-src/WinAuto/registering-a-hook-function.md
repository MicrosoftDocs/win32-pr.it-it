...
description: Le applicazioni client ricevono WinEvents in una funzione di callback WinEventProc. Le azioni eseguite dalla funzione di callback sono definite dall'applicazione, ma la sintassi deve essere specificata nel prototipo.
...
Le applicazioni client ricevono WinEvents in una funzione di callback [*WinEventProc.*](/windows/desktop/api/Winuser/nc-winuser-wineventproc) Le azioni eseguite dalla funzione di callback sono definite dall'applicazione, ma la sintassi deve essere specificata nel prototipo.
