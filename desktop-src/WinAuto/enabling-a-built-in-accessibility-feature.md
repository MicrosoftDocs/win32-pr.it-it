...
---
# <a name="enabling-a-built-in-accessibility-feature"></a>Abilitazione di una funzionalità di accessibilità incorporata

Il frammento di codice seguente usa la funzione [**SystemParametersInfo**](/windows/desktop/api/winuser/nf-winuser-systemparametersinfoa) per abilitare la funzionalità filtro tasti:
