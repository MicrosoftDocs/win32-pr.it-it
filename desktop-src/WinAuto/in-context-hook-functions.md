...
description: 'Altre informazioni su: In-Context hook'
ms.topic: article
ms.date: 05/31/2018
...
-   Le funzioni hook nel contesto devono trovarsi in una libreria a collegamento dinamico (DLL) mappata dal sistema nello spazio degli indirizzi del server.
...
-   Alcuni eventi possono essere recapitati out-of-process, anche se si richiede che siano recapitati in-process (usando il \_ flag WINEVENT INCONTEXT). Questa situazione può verificarsi con problemi di interoperabilità delle applicazioni a 64 e 32 bit e con eventi Windows console.
