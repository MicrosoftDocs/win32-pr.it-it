---
title: Esempio di annotazione server
description: Esempio di annotazione server
...
ms.locfileid: "106297899"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="3310e-103">Esempio di annotazione server</span><span class="sxs-lookup"><span data-stu-id="3310e-103">Server Annotation Sample</span></span>

<span data-ttu-id="3310e-104">Di seguito è riportato un esempio di annotazione del server.</span><span class="sxs-lookup"><span data-stu-id="3310e-104">The following is an example of server annotation.</span></span> <span data-ttu-id="3310e-105">Seguire le istruzioni riportate nei commenti contrassegnati con/ \* todo \* /.</span><span class="sxs-lookup"><span data-stu-id="3310e-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
