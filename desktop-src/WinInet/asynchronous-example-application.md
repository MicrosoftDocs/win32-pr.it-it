---
title: Applicazione di esempio asincrona
description: Nell'esempio seguente viene illustrato come inviare una richiesta in modo asincrono.
...
ms.locfileid: "104221591"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="fb1fd-103">Applicazione di esempio asincrona</span><span class="sxs-lookup"><span data-stu-id="fb1fd-103">Asynchronous Example Application</span></span>

<span data-ttu-id="fb1fd-104">Nell'esempio seguente viene illustrato come inviare una richiesta in modo asincrono.</span><span class="sxs-lookup"><span data-stu-id="fb1fd-104">The following example demonstrated sending a request asynchronously.</span></span>
