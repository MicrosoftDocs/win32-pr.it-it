...
---
# <a name="asynchronous-example-header"></a>Intestazione di esempio asincrona

Di seguito è riportato il file di intestazione per l' [applicazione di esempio asincrona](asynchronous-example-application.md).
