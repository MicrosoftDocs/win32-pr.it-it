---
title: Intestazione di esempio asincrona
description: Di seguito è riportato il file di intestazione per l'applicazione di esempio asincrona.
...
ms.locfileid: "104221170"
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="9eb0f-103">Intestazione di esempio asincrona</span><span class="sxs-lookup"><span data-stu-id="9eb0f-103">Asynchronous Example Header</span></span>

<span data-ttu-id="9eb0f-104">Di seguito è riportato il file di intestazione per l' [applicazione di esempio asincrona](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="9eb0f-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
