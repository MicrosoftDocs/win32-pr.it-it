...
description: Nell'elenco seguente sono incluse tutte le funzioni WinINet
...
ms.locfileid: "104399434"
---
# <a name="wininet-functions"></a>Funzioni WinINet

Nell'elenco seguente sono incluse tutte le funzioni WinINet:
...
[**La InternetQueryDataAvailable**](/windows/desktop/api/Wininet/nf-wininet-internetquerydataavailable)  
...
L'elenco seguente include le funzioni di protezione e privacy di WinInet:
