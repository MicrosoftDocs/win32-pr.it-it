...
Il formato più recente è supportato a partire da Windows XP. I file del Registro di sistema creati in questo formato non possono essere caricati Windows 2000. [**RegSaveKeyEx può**](/windows/desktop/api/Winreg/nf-winreg-regsavekeyexa) salvare i file del Registro di sistema in entrambi i formati specificando REG \_ STANDARD FORMAT o REG LATEST \_ \_ \_ FORMAT. Pertanto, può essere usato per convertire i file del Registro di sistema che usano il formato standard nel formato più recente.
