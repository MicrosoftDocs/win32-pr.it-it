---
description: Recupera i livelli di retroilluminazione CORRENTE CA e DC e lo stato di alimentazione corrente.
ms.assetid: c7b7c302-6e92-46a7-b9a6-e3f2a3e44d1b
title: IOCTL_VIDEO_QUERY_DISPLAY_BRIGHTNESS codice di controllo (Ntddvdeo.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119143414"
---
# <a name="ioctl_video_query_display_brightness-control-code"></a>Codice di controllo DISPLAY \_ \_ BRIGHTNESS DELLA \_ QUERY VIDEO IOCTL \_
...
Recupera i livelli di retroilluminazione CORRENTE CA e DC e lo stato di alimentazione corrente.
...
Codice di controllo per l'operazione. Questo valore identifica l'operazione specifica da eseguire e il tipo di dispositivo in cui eseguirla. Usare **IOCTL \_ VIDEO QUERY DISPLAY BRIGHTNESS \_ \_ \_ per** questa operazione.
...
Puntatore a un buffer che riceverà una [**struttura DISPLAY \_ BRIGHTNESS.**](/previous-versions/windows/desktop/legacy/aa372686(v=vs.85))
...
[**LUMINOSITÀ DELLO \_ SCHERMO DEL SET DI VIDEO IOCTL \_ \_ \_**](ioctl-video-set-display-brightness.md)
</dt> </dl>
