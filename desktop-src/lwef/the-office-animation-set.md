...
Nella tabella seguente sono elencate le animazioni definite per Microsoft Office 2000 caratteri. Se si prevede di usare il carattere in Microsoft Office, è consigliabile supportare tutte le animazioni in questa tabella. È anche possibile aggiungere qualsiasi altra animazione live, ma tenere presente che Microsoft Office non le chiamerà. Le animazioni con asterischi ( \* ) devono essere cicli al 100%. Altre animazioni dovrebbero essere brevi.
...
| **CheckingSomething\*** | Nessuno           | Controllo ortografico, controllo grammaticale                                                                            | Il carattere cerca qualcosa in un libro di riferimento                                                                                          |
| **Congratularmi con**        | Nessuno           | Completare una procedura guidata                                                                                    | Big Big, look of effie, happy but happy                                                                                                 |
| **EmptyTrash**          | Nessuno           | Il Cestino viene svuotato in Outlook                                                                          | Il cestino delle luci dei caratteri è in incendio                                                                                                        |
...
| **GestureLeft**         | GesturingLeft  | Il carattere indica qualcosa sullo schermo, ad esempio un argomento della Guida o una parte dell'interfaccia utente                  | Il carattere esamina l'utente e quindi punta e guarda lo schermo                                                                           |
...
| **GetArtsy\***          | Nessuno           | Formattazione automatica                                                                                           | Il carattere mette in primo posto, mantiene la tavolozza e disegna                                                                                        |
| **GetAttention**        | Nessuno           | Suggerimento con priorità alta                                                                                    | Movimenti per ottenere l'attenzione dell'utente; ad esempio, si alzano e si insondondono le braci                                                 |
| **GetTechy**            | Nessuno           | Viene eseguito in un ambiente di programmazione                                                                | Character pulls out calculator or soldering iron                                                                                          |
| **GetWizardy\***        | Nessuno           | Creazione guidata grafico in esecuzione mentre il carattere è visibile (azione ri triggerata con ogni nuovo pannello della procedura guidata)        | Character puts on wizard hat and waves wand                                                                                               |
| **Addio**             | Nessuno           | Viene scelto un altro carattere                                                                          | Si tratta di una sparizione elaborata che inizia in **RestPose** e termina con un frame vuoto                                                      |
| **Greeting (Messaggio introduttivo)**            | Nessuno           | Carattere scelto                                                                                  | Si tratta di un'immagine elaborata che inizia con un frame vuoto e termina in **RestPose**                                                      |
| **Udito \_ 1\***        | Nessuno           | File lungo aperto                                                                                    | Ascolto a terra, ascolto del computer                                                                                              |
| **Nascondi**                | Nascondere         | Il carattere esce temporaneamente                                                                         | Lascia rapidamente in una nuvola di fuma                                                                                                         |
| **\_Inattivo1 1**            | Nessun input utente  | In ascolto attivo, quindi si arriccia e passa alla sospensione. (opportunità di mostrare la personalità dei caratteri) | Lampeggiare, guardarsi attorno, attendere con paziente attesa                                                                                               |
| **Inattivo2**               | Nessun input utente  | Periodi di inattività più lunghi                                                                                  | Il carattere sguarda e sembra sospitoso                                                                                                          |
...
| **IdleHit**             | Nessuno           | Si tratta di un esempio rappresentativo non mappato di animazioni di livello di inattività 1                                | Tutte le animazioni inattive                                                                                                                |
