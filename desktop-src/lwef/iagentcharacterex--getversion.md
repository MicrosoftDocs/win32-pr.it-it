...
Il numero di versione del set di animazioni standard viene impostato automaticamente quando lo si compila con l'editor dei caratteri di Microsoft Agent.
