...
![figura che mostra la barra, il dispositivo di scorrimento e i segni di graduazione ](images/ctrl-sliders-image1.png)

Dispositivo di scorrimento tipico.
...
-   **L'impostazione sembra una quantità relativa?** In caso contrario, usare [i pulsanti di](ctrl-radio-buttons.md)opzione o un elenco a discesa [o](/windows/desktop/uxguide/ctrl-drop) a [selezione singola](ctrl-list-boxes.md).
...
-   **È consigliabile usare una scala non lineare se l'intervallo di valori è elevato e gli utenti selezioneranno probabilmente i valori a un'estremità dell'intervallo.** Ad esempio, il valore dell'ora potrebbe essere 1 minuto, 1 ora, 1 giorno o 1 mese.
-   **Quando possibile, inviare commenti e suggerimenti immediati mentre o dopo che un utente effettua una selezione.** Microsoft, ad esempio, Windows il controllo del volume per indicare il volume audio risultante.
...
-   **Usare segni di graduazione quando gli utenti devono conoscere il valore approssimativo dell'impostazione.**
-   **Usare segni di graduazione e un'etichetta di valore quando gli utenti devono conoscere il valore esatto dell'impostazione scelta.** Usare sempre un'etichetta di valore se un utente deve conoscere le unità per determinare l'impostazione.
...
-   **Non usare un dispositivo di scorrimento e una casella di testo numerica per la stessa impostazione.** Usare solo il controllo più appropriato.
...
-   **Non modificare le dimensioni dell'indicatore del dispositivo di scorrimento rispetto alle dimensioni predefinite.**

    **Non corretto:**

    ![figura del dispositivo di scorrimento più piccolo del valore predefinito ](images/ctrl-sliders-image5.png)
...
![figura del ridimensionamento e della spaziatura del dispositivo di scorrimento consigliati ](images/ctrl-sliders-image7.png)
...
-   Usare un'etichetta di testo statico che termina con due punti o un'etichetta della casella di gruppo senza punteggiatura finale.
...
-   Usare solo parole, se possibile, per ogni etichetta.
...
-   Usare il testo esatto dell'etichetta, inclusa l'uso di maiuscole e minuscole, e includere il dispositivo di scorrimento della parola. Non includere il carattere di sottolineatura del tasto di scelta o i due punti.
