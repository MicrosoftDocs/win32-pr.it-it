---
description: Nell'esempio seguente viene illustrato come utilizzare gli eventi per calcolare l'utilizzo della CPU per una serie di istruzioni. In questo esempio si presuppone che il provider includa il set di istruzioni con un tipo di evento Start e un tipo di evento End.
ms.assetid: 7bc15ed3-d299-40dd-9838-520f896921e3
title: Uso di eventi per calcolare l'utilizzo della CPU
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104977786"
---
# <a name="using-events-to-calculate-cpu-usage"></a><span data-ttu-id="ba49c-104">Uso di eventi per calcolare l'utilizzo della CPU</span><span class="sxs-lookup"><span data-stu-id="ba49c-104">Using Events to Calculate CPU Usage</span></span>

<span data-ttu-id="ba49c-105">Nell'esempio seguente viene illustrato come utilizzare gli eventi per calcolare l'utilizzo della CPU per una serie di istruzioni.</span><span class="sxs-lookup"><span data-stu-id="ba49c-105">The following example shows you how to use events to calculate the CPU usage for a set of instructions.</span></span> <span data-ttu-id="ba49c-106">In questo esempio si presuppone che il provider includa il set di istruzioni con un tipo di evento Start e un tipo di evento End.</span><span class="sxs-lookup"><span data-stu-id="ba49c-106">This example assumes the provider wraps the instruction set with a start event type and an end event type.</span></span>
