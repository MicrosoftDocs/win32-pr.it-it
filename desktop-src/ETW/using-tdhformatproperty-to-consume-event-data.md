...
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="238c8-103">Utilizzo di TdhFormatProperty per utilizzare i dati degli eventi</span><span class="sxs-lookup"><span data-stu-id="238c8-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="238c8-104">Nell'esempio seguente viene illustrato come utilizzare i dati degli eventi utilizzando la funzione [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .</span><span class="sxs-lookup"><span data-stu-id="238c8-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
