---
description: Nell'esempio seguente viene illustrato come utilizzare la funzione GetNPPBlobTable per recuperare una tabella BLOB NPP che rappresenta le schede di interfaccia di rete registrate nel computer locale.
ms.assetid: 7267f658-103d-4290-8ebf-b78866bd1fe8
title: Uso di GetNPPBlobTable
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106312834"
---
# <a name="using-getnppblobtable"></a><span data-ttu-id="fa18c-103">Uso di GetNPPBlobTable</span><span class="sxs-lookup"><span data-stu-id="fa18c-103">Using GetNPPBlobTable</span></span>

<span data-ttu-id="fa18c-104">Nell'esempio seguente viene illustrato come utilizzare la funzione [**GetNPPBlobTable**](getnppblobtable.md) per recuperare una tabella BLOB NPP che rappresenta le schede di interfaccia di rete registrate nel computer locale.</span><span class="sxs-lookup"><span data-stu-id="fa18c-104">The following example shows how to use the [**GetNPPBlobTable**](getnppblobtable.md) function to retrieve a NPP BLOB table that represents the registered network interface cards on the local computer.</span></span>
