...
Usare questa struttura come parte del processo di creazione del filtro di acquisizione. Per ulteriori informazioni sull'implementazione di questa struttura, vedere [Capture filters](capture-filters.md).
