...
Nella tabella seguente sono elencati i flag delle proprietà del membro Action.
...
| <span id="FILTERACTION_PROPERTYEXIST"></span><span id="filteraction_propertyexist"></span><dl> <dt>**PROPRIETÀ \_ FILTERACTIONEXIST**</dt> </dl> | Indica che una proprietà dell'azione filtro è già definita.<br/> |



 

Nella tabella seguente sono elencati i flag del valore del membro Action.
...
| <span id="FILTERACTION_ADDRESSANY"></span><span id="filteraction_addressany"></span><dl> <dt>**INDIRIZZO \_ FILTERACTIONANY**</dt> </dl>  | Corrisponde a qualsiasi indirizzo MAC.<br/>                                         |
| <span id="FILTERACTION_FROM"></span><span id="filteraction_from"></span><dl> <dt>**FILTERACTION \_ FROM**</dt> </dl>                    | Indica **l'indirizzo MAC da.**<br/>                              |
| <span id="FILTERACTION_TO"></span><span id="filteraction_to"></span><dl> <dt>**FILTERACTION \_ A**</dt> </dl>                          | Indica **l'indirizzo MAC to.**<br/>                                |
| <span id="FILTERACTION_FROMTO"></span><span id="filteraction_fromto"></span><dl> <dt>**FILTERACTION \_ FROMTO**</dt> </dl>              | Indica **un'associazione Da/A** di indirizzi MAC.<br/>                |
...
| <span id="FILTERACTION_TIME"></span><span id="filteraction_time"></span><dl> <dt>**TEMPO \_ FILTERACTION**</dt> </dl>                    | Contiene una **struttura SYSTEMTIME.**<br/>                             |
...
| <span id="FILTERACTION_XOR"></span><span id="filteraction_xor"></span><dl> <dt>**FILTERACTION \_ XOR**</dt> </dl>                                       | Indica un'istruzione **OR esclusivo** logica (XOR).<br/>                                                                |
...
| <span id="FILTERACTION_EQUALNC"></span><span id="filteraction_equalnc"></span><dl> <dt>**FILTERACTION \_ EQUALNC**</dt> </dl>                           | L'azione filtro è uguale e non fa distinzione tra maiuscole e minuscole.<br/>                                                                         |
| <span id="FILTERACTION_EQUAL"></span><span id="filteraction_equal"></span><dl> <dt>**FILTERACTION \_ UGUALE**</dt> </dl>                                 | L'azione filtro è uguale e fa distinzione tra maiuscole e minuscole.<br/>                                                                           |
| <span id="FILTERACTION_NOTEQUALNC"></span><span id="filteraction_notequalnc"></span><dl> <dt>**NOTA \_ FILTERACTIONQUALNC**</dt> </dl>                  | **L'istruzione NOT** logica è uguale e non fa distinzione tra maiuscole e minuscole.<br/>                                                             |
...
| <span id="FILTERACTION_GREATERNC"></span><span id="filteraction_greaternc"></span><dl> <dt>**FILTERACTION \_ GREATERNC**</dt> </dl>                     | L'azione filtro è maggiore di (>) e non fa distinzione tra maiuscole e minuscole.<br/>                                                           |
| <span id="FILTERACTION_GREATER"></span><span id="filteraction_greater"></span><dl> <dt>**FILTERACTION \_ MAGGIORE**</dt> </dl>                           | L'azione filtro è maggiore di (>) e fa distinzione tra maiuscole e minuscole.<br/>                                                             |
| <span id="FILTERACTION_LESSNC"></span><span id="filteraction_lessnc"></span><dl> <dt>**FILTERACTION \_ LESSNC**</dt> </dl>                              | L'azione filtro è minore di (<) e non fa distinzione tra maiuscole e minuscole.<br/>                                                              |
| <span id="FILTERACTION_LESS"></span><span id="filteraction_less"></span><dl> <dt>**FILTERACTION \_ LESS**</dt> </dl>                                    | L'azione filtro è minore di (<) e fa distinzione tra maiuscole e minuscole.<br/>                                                                |
| <span id="FILTERACTION_GREATEREQUALNC"></span><span id="filteraction_greaterequalnc"></span><dl> <dt>**FILTERACTION \_ GREATEREQUALNC**</dt> </dl>      | L'azione filtro è maggiore o uguale a (>=) e non fa distinzione tra maiuscole e minuscole.<br/>                                              |
| <span id="FILTERACTION_GREATEREQUAL"></span><span id="filteraction_greaterequal"></span><dl> <dt>**FILTERACTION \_ GREATEREQUAL**</dt> </dl>            | L'azione filtro è maggiore o uguale a (>=) e fa distinzione tra maiuscole e minuscole.<br/>                                                |
| <span id="FILTERACTION_LESSEQUALNC"></span><span id="filteraction_lessequalnc"></span><dl> <dt>**FILTERACTION \_ LESSEQUALNC**</dt> </dl>               | L'azione filtro è minore o uguale a (<=) e non fa distinzione tra maiuscole e minuscole.<br/>                                                 |
| <span id="FILTERACTION_LESSEQUAL"></span><span id="filteraction_lessequal"></span><dl> <dt>**FILTERACTION \_ LESSEQUAL**</dt> </dl>                     | L'azione filtro è minore o uguale a (<=) e fa distinzione tra maiuscole e minuscole.<br/>                                                |
| <span id="FILTERACTION_PLUS"></span><span id="filteraction_plus"></span><dl> <dt>**FILTERACTION \_ PLUS**</dt> </dl>                                    | Operatore Add (+).<br/>                                                                                                    |
| <span id="FILTERACTION_MINUS"></span><span id="filteraction_minus"></span><dl> <dt>**FILTERACTION \_ MENO**</dt> </dl>                                 | Operatore subtract (-).<br/>                                                                                               |
...
| <span id="FILTERACTION_DEREFPROPERTY"></span><span id="filteraction_derefproperty"></span><dl> <dt>**FILTERACTION \_ DEREFPROPERTY**</dt> </dl>         | Descrive una corrispondenza di criteri in corrispondenza di un offset (in byte) dal protocollo.<br/>                                                |
| <span id="FILTERACTION_OID_CONTAINS"></span><span id="filteraction_oid_contains"></span><dl> <dt>**FILTERACTION \_ OID \_ CONTAINS**</dt> </dl>           | Valuta una sottostringa all'interno di un identificatore di oggetto. L'azione deve essere utilizzata con la **struttura \_ OID FILTERACTION.**<br/> |
...
| <span id="FILTERACTION_ADDR_VINES"></span><span id="filteraction_addr_vines"></span><dl> <dt>**FILTERACTION \_ ADDR \_ VINES**</dt> </dl>                 | Contiene un indirizzo MAC vines.<br/>                                                                                        |
...
| <span id="FILTER_DIRECTION_NEXT"></span><span id="filter_direction_next"></span><dl> <dt>**FILTER \_ DIRECTION \_ NEXT**</dt> </dl>                       | Controlla la direzione sequenziale (fotogramma successivo) all'interno di un file di acquisizione.<br/>                                                    |
| <span id="FILTER_DIRECTION_PREV"></span><span id="filter_direction_prev"></span><dl> <dt>**FILTER \_ DIRECTION \_ PREV**</dt> </dl>                       | Controlla la direzione sequenziale (frame precedente) all'interno di un file di acquisizione.<br/>                                                |
...
Valore **DWORD doppio** utilizzato in un'Windows NT o Windows 2000.
...
Valore byte di offset della struttura FILTEROBJECT utilizzato per confrontare le matrici.
