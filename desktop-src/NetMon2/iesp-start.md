...
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>**\_acquisizione NMERR \_ sospesa**</dt> </dl> | L'acquisizione viene sospesa e deve essere arrestata prima di poter essere riavviata. Chiamare [IESP:: Stop](iesp-stop.md) per arrestare l'acquisizione.<br/> |
...
> [!Note]  
> È anche possibile avviare e arrestare l'acquisizione usando i metodi [IESP::P ause](iesp-pause.md) e [IESP:: Resume](iesp-resume.md) . Quando si usano questi due metodi, i dati acquisiti vengono archiviati nello stesso file di acquisizione.
