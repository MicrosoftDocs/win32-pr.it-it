...
---
# <a name="processing-frame-data"></a><span data-ttu-id="cd225-103">Elaborazione dei dati del frame</span><span class="sxs-lookup"><span data-stu-id="cd225-103">Processing Frame Data</span></span>

<span data-ttu-id="cd225-104">Nell'esempio di codice seguente il monitoraggio imposta un filtro di acquisizione che specifica **solo IP** e i dati del protocollo richiesti.</span><span class="sxs-lookup"><span data-stu-id="cd225-104">In the following example code, the monitor sets a capture filter that specifies **IP only** and requested protocol data.</span></span>
