...
-   Pacchetti accessibili solo dopo l'arresto dell'acquisizione.

Questa sezione include gli argomenti seguenti:

-   [Selezione di una scheda di interfaccia di rete](selecting-a-nic-using-getnppblobfromui.md)
-   [Uso di GetNPPBlobTable](using-getnppblobtable.md)
