...
Per praticità, i BLOB vengono visualizzati nel formato Proprietario:Categoria:Tag:Valore in cui vengono visualizzati quando vengono salvati in un file. La struttura interna del BLOB è opaca perché rappresenta puntatori e tabelle. Ad esempio, di seguito è illustrata una voce di un BLOB che può essere usata per configurare un NPP:

``` syntax
NPP:Configure:BufferSize=32768
```

Il proprietario è NPP. Category è Configure, Tag è BufferSize e Value è 32768.
