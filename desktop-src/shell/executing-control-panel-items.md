...
> [!Note]  
> Se si sta cercando l'elenco dei nomi canonici e dei moduli per Pannello di controllo elementi, vedere [Nomi canonici Pannello di controllo elementi](controlpanel-canonical-names.md).
...
Quando si usa la [**funzione WinExec,**](/windows/win32/api/winbase/nf-winbase-winexec) il sistema può riconoscere comandi Pannello di controllo speciali. Questi comandi precedono Windows Vista.
...
<td>Avvia la finestra <strong>Proprietà dello schermo.</strong>
<blockquote>
[!Note]<br />
...
<td>Avvia la finestra <strong>Proprietà data e</strong> ora.</td>
</tr>
<tr class="even">
<td>control.exe internazionale</td>
<td>Avvia la finestra <strong>Opzioni internazionali e della</strong> lingua.</td>
</tr>
<tr class="odd">
...
<td>Visualizza la <strong>cartella Stampanti e</strong> fax.</td>
</tr>
<tr class="even">
...
| control.exe acontrol.exe       | Avvia la finestra **Monitoraggio a volta a** volta (se installata). |
...
[Estensione di elementi di Pannello di controllo sistema](extending-system-control-panel-items.md)
</dt> <dt>
