...
---
# <a name="shellisrestricted-method"></a>Shell. Unrestricted (metodo)
...
_ *Unrestricted** cerca prima di tutto un nome di sottochiave che corrisponde a *sGroup* nella chiave seguente.
