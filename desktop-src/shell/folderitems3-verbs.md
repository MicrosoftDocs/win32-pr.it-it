...
---
# <a name="folderitems3verbs-property"></a>FolderItems3. Verbs (proprietà)

Ottiene l'elenco di verbi comuni a tutti gli elementi della cartella.
...
Indirizzo di un puntatore alla raccolta di verbi. Vedere [**folderitemverbs**](folderitemverbs.md).

## <a name="examples"></a>Esempio

Nell'esempio seguente viene illustrato l'utilizzo corretto dei **verbi** per JScript, VBScript e Visual Basic.
