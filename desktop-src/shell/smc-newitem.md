---
description: Notifica un nuovo elemento, come specificato dalla struttura SMDATA che lo accompagna.
title: SMC_NEWITEM messaggio (Shobjidl.h)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118046992"
---
# <a name="smc_newitem-message"></a>Messaggio \_ NEWITEM di SMC

Notifica un nuovo elemento, come specificato dalla struttura [**SMDATA**](/windows/win32/api/shobjidl_core/ns-shobjidl_core-smdata) che lo accompagna.
