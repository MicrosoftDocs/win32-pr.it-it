...
Impostare la riga di destinazione del file di collegamento Explorer.exe con un flag /root. La forma esatta del comando dipende dalla posizione del punto di giunzione:
...
-   Se il punto di giunzione è una file system, usare:
...
-   Se il punto di giunzione è una sottocartella di una cartella virtuale di sistema, usare:
    ...
    Le cartelle virtuali di sistema che possono contenere punti di giunzione hanno gli identificatori di classe (CLSID) seguenti:

    

    | Cartella di sistema     | Identificatore di classe                       |
    |-------------------|----------------------------------------|
