...
---
# <a name="folderitemtype-property"></a>Proprietà FolderItem. Type

Contiene una rappresentazione di stringa del tipo dell'elemento.
...
Variabile di tipo [**BSTR**](/previous-versions/windows/desktop/automat/bstr) che riceve il tipo dell'elemento.

## <a name="examples"></a>Esempio

Nell'esempio seguente viene usato il **tipo** per recuperare il tipo dell'elemento. L'utilizzo corretto viene visualizzato per JScript, VBScript e Visual Basic.
