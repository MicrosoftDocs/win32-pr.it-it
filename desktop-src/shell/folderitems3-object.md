...
| Metodo                                | Descrizione                                                       |
|:--------------------------------------|:------------------------------------------------------------------|
| [**Filtro**](folderitems3-filter.md) | Imposta un filtro con caratteri jolly da applicare agli elementi restituiti.<br/> |
...
|:-----------------------------------------------|:---------------------|:------------------------------------------------------------------|
| [**Verbi**](folderitems3-verbs.md)<br/> | Sola lettura<br/> | Ottiene l'elenco di verbi comuni a tutti gli elementi della cartella.<br/> |
