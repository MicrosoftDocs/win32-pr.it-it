...
> [!Note]  
> [**IExplorerCommand è**](/windows/desktop/api/shobjidl_core/nn-shobjidl_core-iexplorercommand) un ibrido tra un verbo statico e dinamico. **IExplorerCommand è** stato dichiarato in Windows Vista, ma la possibilità di implementare un verbo in un menu di scelta rapida è una novità Windows 7.
...
| Windows 7 e versioni successive: [ **IExplorerCommand**](/windows/desktop/api/shobjidl_core/nn-shobjidl_core-iexplorercommand)                         | Questa scelta consente un'implementazione comune di verbi e comandi di esplorazione visualizzati nel modulo dei comandi in Windows Explorer.                                                                                                                                                                                                                                                                                                                                                                                               |
