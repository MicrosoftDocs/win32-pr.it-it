...
La directory %windir% System32 è riservata alle applicazioni a \\ 64 bit in Windows a 64 bit. La maggior parte dei nomi di file DLL non è stata modificata quando sono state create versioni a 64 bit delle DLL, quindi le versioni a 32 bit delle DLL vengono archiviate in una directory diversa. WOW64 nasconde questa differenza usando un file system *redirector .*
