...
description: Il redirector del Registro di sistema fornisce l'accesso remoto al Registro di sistema Windows tramite la funzione RegConnectRegistry.
ms.assetid: 7873c1e2-53fb-4c93-bf4c-251a13cd8db7
keywords:
- accesso remoto al Registro di sistema a 64 bit Windows programmazione
ms.topic: article
ms.date: 05/31/2018
...
Il redirector del Registro di sistema fornisce l'accesso remoto al Registro di sistema Windows tramite la [**funzione RegConnectRegistry.**](/windows/desktop/api/winreg/nf-winreg-regconnectregistrya)
