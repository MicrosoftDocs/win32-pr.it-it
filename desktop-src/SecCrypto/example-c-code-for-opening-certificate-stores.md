...
---
# <a name="example-c-code-for-opening-certificate-stores"></a><span data-ttu-id="5237b-104">Codice C di esempio per l'apertura di archivi certificati</span><span class="sxs-lookup"><span data-stu-id="5237b-104">Example C Code for Opening Certificate Stores</span></span>

<span data-ttu-id="5237b-105">Gli esempi seguenti forniscono il codice per aprire un'ampia gamma di archivi certificati comuni.</span><span class="sxs-lookup"><span data-stu-id="5237b-105">The following examples provide code to open a variety of common certificate stores.</span></span> <span data-ttu-id="5237b-106">Questi esempi sono costituiti da una serie di frammenti di codice e non da programmi autonomi.</span><span class="sxs-lookup"><span data-stu-id="5237b-106">These examples are a series of code fragments and are not stand-alone programs.</span></span>

<span data-ttu-id="5237b-107">Nell'esempio seguente viene aperto l'archivio di sistema My.</span><span class="sxs-lookup"><span data-stu-id="5237b-107">The following example opens the My system store.</span></span>
...
<span data-ttu-id="5237b-108">Nell'esempio seguente viene aperto un archivio di memoria.</span><span class="sxs-lookup"><span data-stu-id="5237b-108">The following example opens a memory store.</span></span>
...
<span data-ttu-id="5237b-109">Nell'esempio seguente viene aperto un archivio dal disco.</span><span class="sxs-lookup"><span data-stu-id="5237b-109">The following example opens a store from disk.</span></span> <span data-ttu-id="5237b-110">Nell'esempio viene utilizzata la funzione **CreateMyDACL** , definita nell'argomento [Creating a DACL](../secbp/creating-a-dacl.md) , per garantire che il file aperto venga creato con un DACL appropriato.</span><span class="sxs-lookup"><span data-stu-id="5237b-110">The example uses the **CreateMyDACL** function, defined in the [Creating a DACL](../secbp/creating-a-dacl.md) topic, to ensure the open file is created with a proper DACL.</span></span>
...
<span data-ttu-id="5237b-111">Nell'esempio seguente viene aperto un archivio basato su file usando CERT \_ Store \_ prov \_ filename.</span><span class="sxs-lookup"><span data-stu-id="5237b-111">The following example opens a file-based store using CERT\_STORE\_PROV\_FILENAME.</span></span>
...
<span data-ttu-id="5237b-112">Nell'esempio seguente viene aperto un archivio di raccolta.</span><span class="sxs-lookup"><span data-stu-id="5237b-112">The following example opens a collection store.</span></span>
...
<span data-ttu-id="5237b-113">Nell'esempio seguente viene aperto un archivio di registrazione.</span><span class="sxs-lookup"><span data-stu-id="5237b-113">The following example opens a register store.</span></span>
...
<span data-ttu-id="5237b-114">Nell'esempio seguente viene aperto un archivio certificati basato su un \# messaggio PKCS 7.</span><span class="sxs-lookup"><span data-stu-id="5237b-114">The following example opens a certificate store based on a PKCS \#7 message.</span></span>
