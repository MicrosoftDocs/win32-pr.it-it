...
---
# <a name="icertificates2clear-method"></a>Metodo ICertificates2:: Clear
...
Il metodo **Clear** rimuove tutti gli oggetti [**certificato**](certificate.md) dalla raccolta. Questo metodo è stato introdotto in capicol 2,0.
