...
---
# <a name="request-sample-in-c"></a>Esempio di richiesta in C++

Nell'esempio seguente viene illustrato il modo in cui il controllo di registrazione certificati può essere utilizzato con l'oggetto [**ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) per creare e inviare una richiesta di certificato.
