...
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a><span data-ttu-id="2f82f-103">Diffie-Hellman del codice server per la creazione della chiave master</span><span class="sxs-lookup"><span data-stu-id="2f82f-103">Diffie-Hellman Server Code for Creating the Master Key</span></span>

<span data-ttu-id="2f82f-104">Nell'esempio seguente viene illustrato il codice del lato Server/Schannel di [*Diffie-Hellman*](../secgloss/d-gly.md)tipico per la creazione di una [*chiave master*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="2f82f-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
