---
description: Nell'esempio seguente viene illustrato il codice lato client RSA/SChannel tipico per la creazione di una chiave master.
ms.assetid: 9ce4877f-e6e6-4b94-9503-092d2702b31f
title: Codice client RSA per la creazione della chiave master
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106307221"
---
# <a name="rsa-client-code-for-creating-the-master-key"></a><span data-ttu-id="d5265-103">Codice client RSA per la creazione della chiave master</span><span class="sxs-lookup"><span data-stu-id="d5265-103">RSA Client Code for Creating the Master Key</span></span>

<span data-ttu-id="d5265-104">Nell'esempio seguente viene illustrato il codice lato client RSA/SChannel tipico per la creazione di una [*chiave master*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="d5265-104">The following example shows typical RSA/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
