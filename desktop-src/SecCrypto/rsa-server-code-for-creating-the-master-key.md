...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a>Codice server RSA per la creazione della chiave master

Nell'esempio seguente viene illustrato il codice lato server RSA/SChannel tipico per la creazione di una [*chiave master*](../secgloss/m-gly.md).
