...
---
# <a name="certificate-object"></a>Oggetto Certificate
...
L'oggetto **certificato** rappresenta un singolo [*certificato digitale*](../secgloss/d-gly.md).

L'oggetto **Certificate** espone le interfacce seguenti:

-   **ICertificate** : introdotta in capicol 1,0.
-   **ICertificate2** : introdotta in capicol 2,0.

## <a name="when-to-use"></a>Utilizzo

L'oggetto **certificato** viene utilizzato per eseguire le attività seguenti:

-   Caricare i dati del certificato, inclusa la chiave privata, da un file.
-   Ottenere informazioni dal certificato.
-   Restituisce vincoli di base, EKU, proprietà estese, estensioni, utilizzo chiave, chiave pubblica e oggetti modello associati al certificato.
...
L'oggetto **certificato** presenta questi tipi di membri:
...
L'oggetto **certificato** presenta questi metodi.



| Metodo                                                       | Descrizione                                                                                                                                                                                                                                              |
|:-------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**BasicConstraints**](certificate-basicconstraints.md)     | Restituisce un oggetto [**BasicConstraints**](basicconstraints.md) che rappresenta l'estensione dei vincoli di base del certificato.<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                                   |
| [**Visualizza**](certificate-display.md)                       | Visualizza un certificato.<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                                                                                                                                             |
| [**Esportazione**](certificate-export.md)                         | Copia un certificato in una stringa codificata. La stringa codificata può essere scritta in un file o importata in un nuovo oggetto **certificato** .<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                               |
...
| [**GetInfo**](certificate-getinfo.md)                       | Recupera le informazioni dal certificato.<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                                                                                                                         |
| [**HasPrivateKey**](certificate-hasprivatekey.md)           | Determina se al certificato è associata una [*chiave privata*](../secgloss/p-gly.md) .<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                    |
| [**Importa**](certificate-import.md)                         | Importa un certificato codificato in precedenza da una stringa nell'oggetto **certificato** .<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                                                                             |
...
| [**KeyUsage**](certificate-keyusage.md)                     | Restituisce un oggetto [**DataUsage**](keyusage.md) che indica l'utilizzo chiave valido del certificato.<br/> (Ereditato da **CertificateICertificate2ICertificate**)                                                                                |
...
L'oggetto **certificato** dispone di queste proprietà.
...
| [**Thumbprint**](certificate-thumbprint.md)<br/>       | Sola lettura<br/>  | Recupera una stringa esadecimale contenente l'hash SHA-1 del certificato.<br/> (Ereditato da **CertificateICertificate2ICertificate**) |
...
È possibile creare l'oggetto **certificato** ed è sicuro per lo scripting. Il ProgID per l'oggetto **certificato** è "CAPICOM. Certificato. 2 ".

**CAPICOM 1. *x*:** il ProgID per l'oggetto **certificato** è "CAPICOM. Certificate. 1 ".
