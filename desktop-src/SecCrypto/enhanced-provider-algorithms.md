...
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CALG \_ 3DES         | Triple DES.                                                                                                                                                     | Lunghezza della chiave: 168 bit. Modalità predefinita: concatenamento di blocchi di crittografia.<br/> Dimensioni del blocco: 64 bit.<br/> Non è consentito alcun valore salt.<br/>                           |
| CALG \_ 3DES \_ 112    | Crittografia DES [*tripla a due*](../secgloss/t-gly.md) chiavi.                                                            | Lunghezza della chiave: 112 bit. Modalità predefinita: concatenamento di blocchi di crittografia.<br/> Dimensioni del blocco: 64 bit.<br/> Non è consentito alcun valore salt.<br/>                           |
| CALG \_ DES          | Crittografia DES.                                                                                                                                                 | Lunghezza della chiave: 56 bit. Modalità predefinita: concatenamento di blocchi di crittografia.<br/> Dimensioni del blocco: 64 bit.<br/> Non è consentito alcun valore salt.<br/>                            |
