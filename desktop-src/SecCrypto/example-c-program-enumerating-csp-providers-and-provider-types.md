...
---
# <a name="example-c-program-enumerating-csp-providers-and-provider-types"></a><span data-ttu-id="d0151-103">Programma C di esempio: enumerazione dei provider CSP e dei tipi di provider</span><span class="sxs-lookup"><span data-stu-id="d0151-103">Example C Program: Enumerating CSP Providers and Provider Types</span></span>

<span data-ttu-id="d0151-104">Nell'esempio seguente vengono elencati i CSP disponibili in un computer e vengono utilizzate le funzioni [*CryptoAPI*](../secgloss/c-gly.md) seguenti:</span><span class="sxs-lookup"><span data-stu-id="d0151-104">The following example lists the CSPs available on a computer and uses the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="d0151-105">**CryptEnumProviderTypes**</span><span class="sxs-lookup"><span data-stu-id="d0151-105">**CryptEnumProviderTypes**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumprovidertypesa)
-   [<span data-ttu-id="d0151-106">**CryptEnumProviders**</span><span class="sxs-lookup"><span data-stu-id="d0151-106">**CryptEnumProviders**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumprovidersa)
-   [<span data-ttu-id="d0151-107">**CryptGetDefaultProvider**</span><span class="sxs-lookup"><span data-stu-id="d0151-107">**CryptGetDefaultProvider**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetdefaultprovidera)
-   [<span data-ttu-id="d0151-108">**CryptGetProvParam**</span><span class="sxs-lookup"><span data-stu-id="d0151-108">**CryptGetProvParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetprovparam)

<span data-ttu-id="d0151-109">In questo esempio viene usata la funzione [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="d0151-109">This example uses the function [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="d0151-110">Il codice per questa funzione è incluso in questo esempio.</span><span class="sxs-lookup"><span data-stu-id="d0151-110">The code for this function is included in this example.</span></span> <span data-ttu-id="d0151-111">Il codice per questa e altre funzioni ausiliarie è elencato anche in [funzioni per utilizzo generico](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="d0151-111">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>

<span data-ttu-id="d0151-112">Nell'esempio seguente viene illustrata l'enumerazione dei CSP e dei tipi di provider.</span><span class="sxs-lookup"><span data-stu-id="d0151-112">The following example shows enumerating CSPs and provider types.</span></span>
