---
description: Nell'esempio seguente viene illustrato il codice sul lato client Diffie-Hellman/SChannel tipico per la creazione di una chiave master.
ms.assetid: 37b35cd6-b3c9-4a75-83a9-129bcf7a84a3
title: Diffie-Hellman codice client per la creazione della chiave master
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104350151"
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a><span data-ttu-id="17b60-103">Diffie-Hellman codice client per la creazione della chiave master</span><span class="sxs-lookup"><span data-stu-id="17b60-103">Diffie-Hellman Client Code for Creating the Master Key</span></span>

<span data-ttu-id="17b60-104">L'esempio seguente mostra il codice del lato client/SChannel di [*Diffie-Hellman*](../secgloss/d-gly.md)tipico per la creazione di una [*chiave master*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="17b60-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
