...
Questa proprietà deve essere inizializzata prima che venga [**chiamato il**](signeddata-sign.md) metodo Sign. Quando il valore di questa proprietà viene reimpostato, [](../secgloss/s-gly.md) direttamente o indirettamente, l'intero stato dell'oggetto viene reimpostato e qualsiasi firma associata all'oggetto prima della modifica della proprietà viene persa.
