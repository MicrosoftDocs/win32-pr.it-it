---
description: 'Esempio di programma C: utilizzo di identificatori di chiave'
ms.assetid: 5ca160fd-8a63-46fa-99ce-e01a6acb81f4
title: 'Esempio di programma C: utilizzo di identificatori di chiave'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106318240"
---
# <a name="example-c-program-working-with-key-identifiers"></a><span data-ttu-id="bf443-103">Esempio di programma C: utilizzo di identificatori di chiave</span><span class="sxs-lookup"><span data-stu-id="bf443-103">Example C Program: Working with Key Identifiers</span></span>

<span data-ttu-id="bf443-104">Nell'esempio seguente vengono illustrate le modalità di utilizzo degli identificatori di chiave.</span><span class="sxs-lookup"><span data-stu-id="bf443-104">The following example demonstrates ways of working with key identifiers.</span></span> <span data-ttu-id="bf443-105">In questo esempio vengono illustrate le attività e le funzioni CryptoAPI seguenti:</span><span class="sxs-lookup"><span data-stu-id="bf443-105">This example illustrates the following tasks and CryptoAPI functions:</span></span>

-   <span data-ttu-id="bf443-106">Creazione di un identificatore di chiave utilizzando [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp).</span><span class="sxs-lookup"><span data-stu-id="bf443-106">Creating a key identifier using [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp).</span></span>
-   <span data-ttu-id="bf443-107">Impostazione di una proprietà in un identificatore di chiave utilizzando [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty).</span><span class="sxs-lookup"><span data-stu-id="bf443-107">Setting a property on a key identifier using [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty).</span></span>
-   <span data-ttu-id="bf443-108">Recupero del contenuto di una proprietà dell'identificatore di chiave utilizzando [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty).</span><span class="sxs-lookup"><span data-stu-id="bf443-108">Retrieving the contents of a key identifier property using [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty).</span></span>
-   <span data-ttu-id="bf443-109">Elenco delle proprietà di un identificatore di chiave utilizzando [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties).</span><span class="sxs-lookup"><span data-stu-id="bf443-109">Listing the properties of a key identifier using [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties).</span></span>
-   <span data-ttu-id="bf443-110">Dichiarazione, definizione e utilizzo di una funzione di callback.</span><span class="sxs-lookup"><span data-stu-id="bf443-110">Declaring, defining, and using a callback function.</span></span>
