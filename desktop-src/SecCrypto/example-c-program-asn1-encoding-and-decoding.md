---
description: Mostra l'uso di CryptEncodeObjectEx e CryptDecodeObjectEx.
ms.assetid: 78108cd5-531e-4d0c-96cf-6f6264b7716c
title: 'Programma C di esempio: codifica e decodifica ASN. 1'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104057968"
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a><span data-ttu-id="043f5-103">Programma C di esempio: codifica e decodifica ASN. 1</span><span class="sxs-lookup"><span data-stu-id="043f5-103">Example C Program: ASN.1 Encoding and Decoding</span></span>

<span data-ttu-id="043f5-104">Nell'esempio seguente viene illustrato l'utilizzo di [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) e [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span><span class="sxs-lookup"><span data-stu-id="043f5-104">The following example shows using [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) and [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span></span> <span data-ttu-id="043f5-105">Questo esempio può essere modificato facilmente per l'uso di [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) e [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span><span class="sxs-lookup"><span data-stu-id="043f5-105">This example can easily be modified to use [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) and [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span></span>

<span data-ttu-id="043f5-106">Questo esempio usa anche una versione modificata della funzione [**ByteToStr**](bytetostr.md) per stampare una serie di ottetti con codifica ASN. 1 ( [*Abstract Syntax Notation One*](../secgloss/a-gly.md) ).</span><span class="sxs-lookup"><span data-stu-id="043f5-106">This example also uses a modified version of the function [**ByteToStr**](bytetostr.md) to print an [*Abstract Syntax Notation One*](../secgloss/a-gly.md) (ASN.1) encoded series of octets.</span></span> <span data-ttu-id="043f5-107">USA anche [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="043f5-107">It also uses [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="043f5-108">Il codice per queste funzioni è incluso nell'esempio.</span><span class="sxs-lookup"><span data-stu-id="043f5-108">Code for these functions is included with the sample.</span></span>
