---
description: Ottiene e imposta le proprietà del certificato e illustra le seguenti attività e funzioni CryptoAPI.
ms.assetid: 4cc20a59-d8e9-4c9b-9438-21bccbbe4a64
title: 'Esempio di programma C: recupero e impostazione delle proprietà di un certificato'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104058226"
---
# <a name="example-c-program-getting-and-setting-certificate-properties"></a><span data-ttu-id="0f293-103">Esempio di programma C: recupero e impostazione delle proprietà di un certificato</span><span class="sxs-lookup"><span data-stu-id="0f293-103">Example C Program: Getting and Setting Certificate Properties</span></span>

<span data-ttu-id="0f293-104">Nell'esempio seguente vengono recuperate e impostate le proprietà del certificato e vengono illustrate le attività e le funzioni [*CryptoAPI*](../secgloss/c-gly.md) seguenti.</span><span class="sxs-lookup"><span data-stu-id="0f293-104">The following example gets and sets certificate properties, and illustrates the following tasks and [*CryptoAPI*](../secgloss/c-gly.md) functions.</span></span>

-   <span data-ttu-id="0f293-105">Apertura di un archivio di sistema tramite [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea).</span><span class="sxs-lookup"><span data-stu-id="0f293-105">Opening a system store by using [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea).</span></span>
-   <span data-ttu-id="0f293-106">Uso di [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) per elencare tutti i certificati nell'archivio aperto.</span><span class="sxs-lookup"><span data-stu-id="0f293-106">Using [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) to list all of the certificates in the open store.</span></span>
-   <span data-ttu-id="0f293-107">Recupero e stampa del nome del soggetto dal certificato tramite [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span><span class="sxs-lookup"><span data-stu-id="0f293-107">Retrieving and printing the subject name from the certificate by using [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span></span>
-   <span data-ttu-id="0f293-108">Impostazione della proprietà [*utilizzo chiavi avanzato*](../secgloss/e-gly.md) per i certificati tramite la funzione [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) .</span><span class="sxs-lookup"><span data-stu-id="0f293-108">Setting the [*enhanced key usage*](../secgloss/e-gly.md) property on certificates by using the [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) function.</span></span>
-   <span data-ttu-id="0f293-109">Impostazione della proprietà nome visualizzato sul certificato tramite [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).</span><span class="sxs-lookup"><span data-stu-id="0f293-109">Setting the display name property on the certificate by using [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="0f293-110">Recupero delle proprietà di un certificato tramite [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).</span><span class="sxs-lookup"><span data-stu-id="0f293-110">Retrieving a certificate's properties by using [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="0f293-111">Chiusura di un archivio certificati utilizzando [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) con il \_ flag di controllo del contrassegno di chiusura dell' \_ archivio certificati \_ \_ .</span><span class="sxs-lookup"><span data-stu-id="0f293-111">Closing a certificate store by using [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) with the CERT\_CLOSE\_STORE\_CHECK\_FLAG flag.</span></span>
