...
---
# <a name="oidsremove-method"></a>Metodo OID. Remove
...
Il metodo **Remove** rimuove l'oggetto [**OID**](oid.md) specificato dalla raccolta.
...
Indice dell'oggetto [**OID**](oid.md) da rimuovere. Può essere un indice nella raccolta o il valore punteggiato dell'OID.
