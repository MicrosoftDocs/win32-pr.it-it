...
L'oggetto **EncodedData** dispone di questi tipi di membri:
...
| Metodo                                 | Descrizione                                                     |
|:---------------------------------------|:----------------------------------------------------------------|
| [**Decodificatore**](encodeddata-decoder.md) | Ottiene un oggetto decodificatore, se ne esiste uno.<br/>             |
...
L'oggetto **EncodedData** dispone di queste proprietà.
