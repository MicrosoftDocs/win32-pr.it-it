...
Se un thread ha attualmente un dispositivo bloccato (comunica attivamente con tale dispositivo) e un altro thread tenta di chiamare un metodo che comunica attivamente con il dispositivo, il metodo restituisce un errore WIA \_ ERROR \_ BUSY.
