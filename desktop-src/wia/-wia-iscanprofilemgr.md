...
**L'interfaccia IScanProfileMgr** include questi metodi.
...
| [**DeleteAllProfilesForUser**](-wia-iscanprofilemgr-deleteallprofilesforuser.md)   | Elimina tutti i profili di analisi disponibili per l'utente nel sistema in cui viene eseguita l'applicazione. <br/> |
...
| [**GetProfiles**](-wia-iscanprofilemgr-getprofiles.md)                             | Ottiene tutti i profili di analisi disponibili per l'utente nel sistema in cui viene eseguita l'applicazione.<br/>     |
