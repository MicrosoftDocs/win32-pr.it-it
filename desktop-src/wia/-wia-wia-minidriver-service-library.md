...
title: Libreria del servizio minidriver WIA
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="wia-minidriver-service-library"></a>Libreria del servizio minidriver WIA
...
Le funzioni della libreria di servizi di base eseguono funzioni helper che la maggior parte dei driver di dispositivo dovrà implementare. Queste funzioni leggono e scrivono proprietà. Creano anche oggetti elemento driver e copiano le proprietà delle informazioni sul dispositivo.
