...
---
# <a name="wm_mousehover-message"></a>\_Messaggio MOUSEHOVER WM

Inserito in una finestra quando il cursore passa sull'area client della finestra per il periodo di tempo specificato in una chiamata precedente a [**TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent).
...
| <span id="MK_MBUTTON"></span><span id="mk_mbutton"></span><dl> <dt>**MK \_**</dt> <dt>0x0010</dt> MBUTTON </dl>    | Il pulsante centrale del mouse è premuto.<br/> |
| <span id="MK_RBUTTON"></span><span id="mk_rbutton"></span><dl> <dt>**MK \_**</dt> <dt>0x0002</dt> RBUTTON </dl>    | Il pulsante destro del mouse è premuto.<br/>  |
...
Il rilevamento del passaggio del mouse si interrompe quando viene generato **WM \_ MOUSEHOVER** . Se è necessario tenere traccia del comportamento del passaggio del mouse, l'applicazione deve chiamare nuovamente [**TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent) .
