---
title: WM_MOUSEHOVER messaggio (Winuser.h)
description: Inviato a una finestra quando il cursore passa il puntatore del mouse sull'area client della finestra per il periodo di tempo specificato in una chiamata precedente a TrackMouseEvent.
ms.assetid: efba7f04-2d26-44f1-89df-a565c03ad944
keywords:
- WM_MOUSEHOVER messaggio Input tastiera e mouse
topic_type:
- apiref
api_name:
- WM_MOUSEHOVER
...
ms.locfileid: "119451501"
---
# <a name="wm_mousehover-message"></a>Messaggio WM \_ MOUSEHOVER

Inviato a una finestra quando il cursore passa il puntatore del mouse sull'area client della finestra per il periodo di tempo specificato in una chiamata precedente a [**TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent).
...
| <span id="MK_LBUTTON"></span><span id="mk_lbutton"></span><dl> <dt>**MK \_ LBUTTON**</dt> <dt>0x0001</dt> </dl>    | Il pulsante sinistro del mouse è premuto.<br/>   |
| <span id="MK_MBUTTON"></span><span id="mk_mbutton"></span><dl> <dt>**MK \_ MBUTTON**</dt> <dt>0x0010</dt> </dl>    | Il pulsante centrale del mouse è premuto.<br/> |
| <span id="MK_RBUTTON"></span><span id="mk_rbutton"></span><dl> <dt>**MK \_ RBUTTON**</dt> <dt>0x0002</dt> </dl>    | Il pulsante destro del mouse è premuto.<br/>  |
...
Il rilevamento del passaggio del mouse si arresta quando viene generato **WM \_ MOUSEHOVER.** L'applicazione deve chiamare [**nuovamente TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent) se richiede un ulteriore rilevamento del comportamento del passaggio del mouse.
