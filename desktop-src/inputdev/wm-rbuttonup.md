---
title: WM_RBUTTONUP messaggio (Winuser.h)
description: Pubblicato quando l'utente rilascia il pulsante destro del mouse mentre il cursore si trova nell'area client di una finestra.
ms.assetid: 12d148ba-9324-4db3-b537-b2cd4d0b8f32
keywords:
- WM_RBUTTONUP messaggio Input tastiera e mouse
topic_type:
- apiref
api_name:
- WM_RBUTTONUP
...
ms.locfileid: "119557131"
---
# <a name="wm_rbuttonup-message"></a>Messaggio \_ RBUTTONUP WM
...
| <span id="MK_LBUTTON"></span><span id="mk_lbutton"></span><dl> <dt>**MK \_ LBUTTON**</dt> <dt>0x0001</dt> </dl>    | Il pulsante sinistro del mouse è verso il basso.<br/>   |
...
| <span id="MK_RBUTTON"></span><span id="mk_rbutton"></span><dl> <dt>**MK \_ RBUTTON**</dt> <dt>0x0002</dt> </dl>    | Il tasto MAIUSC è premuto.<br/>           |
