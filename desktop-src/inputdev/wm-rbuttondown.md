---
title: WM_RBUTTONDOWN messaggio (Winuser.h)
...
keywords:
- WM_RBUTTONDOWN messaggio Input da tastiera e mouse
topic_type:
- apiref
api_name:
- WM_RBUTTONDOWN
...
ms.locfileid: "119964341"
---
# <a name="wm_rbuttondown-message"></a>Messaggio \_ WM RBUTTONDOWN

Inviato quando l'utente preme il pulsante destro del mouse mentre il cursore si trova nell'area client di una finestra. Se il mouse non viene acquisito, il messaggio viene inserito nella finestra sotto il cursore. In caso contrario, il messaggio viene inviato alla finestra che ha acquisito il mouse.
