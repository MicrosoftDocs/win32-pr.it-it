...
---
# <a name="wm_mousemove-message"></a>Messaggio di WM \_ MOUSEMOVE

Inserito in una finestra quando il cursore viene spostato. Se il mouse non viene acquisito, il messaggio viene inserito nella finestra che contiene il cursore. In caso contrario, il messaggio viene inserito nella finestra che ha acquisito il mouse.
