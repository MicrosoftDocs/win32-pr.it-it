---
title: WM_MBUTTONDOWN messaggio (Winuser.h)
...
keywords:
- WM_MBUTTONDOWN messaggio Input da tastiera e mouse
topic_type:
- apiref
api_name:
- WM_MBUTTONDOWN
...
ms.locfileid: "119451651"
---
# <a name="wm_mbuttondown-message"></a>Messaggio \_ MBUTTONDOWN WM

Inviato quando l'utente preme il pulsante centrale del mouse mentre il cursore si trova nell'area client di una finestra. Se il mouse non viene acquisito, il messaggio viene inserito nella finestra sotto il cursore. In caso contrario, il messaggio viene inviato alla finestra che ha acquisito il mouse.
...
Per rilevare che è stato premuto alt, controllare se [**GetKeyState**](/windows/win32/api/winuser/nf-winuser-getkeystate) con **VK \_ MENU** < 0. Si noti che non deve essere [**GetAsyncKeyState.**](/windows/win32/api/winuser/nf-winuser-getasynckeystate)
