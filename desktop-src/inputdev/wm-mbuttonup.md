---
title: WM_MBUTTONUP messaggio (Winuser.h)
description: Pubblicato quando l'utente rilascia il pulsante centrale del mouse mentre il cursore si trova nell'area client di una finestra.
ms.assetid: fb8dee71-11bd-4405-855d-a5d120442271
keywords:
- WM_MBUTTONUP messaggio Input tastiera e mouse
topic_type:
- apiref
api_name:
- WM_MBUTTONUP
...
ms.locfileid: "119451541"
---
# <a name="wm_mbuttonup-message"></a>Messaggio \_ DI WM MBUTTONUP
...
Si noti che quando un menu di scelta rapida è presente (visualizzato), le coordinate sono relative alla schermata, non all'area client. Poiché [**TrackPopupMenu**](/windows/desktop/api/winuser/nf-winuser-trackpopupmenu) è una chiamata asincrona e la notifica **WM \_ MBUTTONUP** non ha un flag speciale che indica la derivazione delle coordinate, un'applicazione non è in grado di determinare se le coordinate x,y contenute in *lParam* sono relative alla schermata o all'area client.
