...
---
# <a name="wm_lbuttondblclk-message"></a>\_Messaggio LBUTTONDBLCLK WM

Inviato quando l'utente fa doppio clic con il pulsante sinistro del mouse mentre il cursore si trova nell'area client di una finestra. Se il mouse non viene acquisito, il messaggio viene inserito nella finestra sotto il cursore. In caso contrario, il messaggio viene inserito nella finestra che ha acquisito il mouse.
...
Solo le finestre con lo stile **cs \_ DBLCLKS** possono ricevere messaggi **WM \_ LBUTTONDBLCLK** , generati dal sistema ogni volta che l'utente preme, rilascia e preme di nuovo il pulsante sinistro del mouse nel limite di tempo doppio clic del sistema. Se si fa doppio clic con il pulsante sinistro del mouse, viene generata una sequenza di quattro messaggi: [**WM \_ LBUTTONDOWN**](wm-lbuttondown.md), [**WM \_ LBUTTONUP**](wm-lbuttonup.md), **WM \_ LBUTTONDBLCLK** e **WM \_ LBUTTONUP**.
