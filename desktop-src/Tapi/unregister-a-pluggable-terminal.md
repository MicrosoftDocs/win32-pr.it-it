...
---
# <a name="unregister-a-pluggable-terminal"></a><span data-ttu-id="93dea-104">Annulla la registrazione di un terminale collegabile</span><span class="sxs-lookup"><span data-stu-id="93dea-104">Unregister a Pluggable Terminal</span></span>

<span data-ttu-id="93dea-105">In generale, questo metodo verrà chiamato da **DllUnregisterServer**.</span><span class="sxs-lookup"><span data-stu-id="93dea-105">In general, this method will be called from **DllUnregisterServer**.</span></span> <span data-ttu-id="93dea-106">Il codice di esempio seguente può essere inserito nel codice per **DllUnregisterServer**.</span><span class="sxs-lookup"><span data-stu-id="93dea-106">The following sample code can be put into the code for **DllUnregisterServer**.</span></span>
