---
description: Il messaggio LINE GROUPSTATUS viene inviato quando lo stato di un gruppo ACD cambia in un gestore dell'agente per cui l'applicazione ha \_ attualmente una riga aperta. Questo messaggio viene generato usando la funzione lineProxyMessage.
...
---
# <a name="line_groupstatus-message"></a>MESSAGGIO LINE \_ GROUPSTATUS

Il **messaggio LINE \_ GROUPSTATUS** viene inviato quando lo stato di un gruppo ACD cambia in un gestore dell'agente per cui l'applicazione ha attualmente una riga aperta. Questo messaggio viene generato usando la [**funzione lineProxyMessage.**](/windows/desktop/api/Tapi/nf-tapi-lineproxymessage)
