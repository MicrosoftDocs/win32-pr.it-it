...
Puntatore **Variant** a un SAFEARRAY di **BSTR** s che elenca i numeri di telefono.
...
| <dl> <dt>**\_puntatore E**</dt> </dl>     | Il parametro *pNumbers* o *pNames* non è un puntatore valido.<br/> |
...
Gli elenchi a cui *pNumbers* e *pNames* puntano sono della stessa lunghezza.
