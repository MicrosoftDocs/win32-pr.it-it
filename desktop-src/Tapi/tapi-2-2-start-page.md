...
Le possibili applicazioni TAPI 2.2 includono:
...
TAPI/C è progettato per l'uso da parte dei programmatori C/C++. L'esperienza di sviluppo con le telecomunicazioni o altre applicazioni di telefonia è utile, ma non necessaria.

## <a name="run-time-requirements"></a>Requisiti di runtime

TAPI versione 2.2 consente lo sviluppo di applicazioni di comunicazione per i sistemi operativi Windows Server 2003, Windows XP, Windows 2000, Windows NT, Windows Me, Windows 98 e Windows 95. Per altre informazioni sui sistemi operativi che supportano una determinata funzione, vedere la sezione Requisiti della documentazione relativa a tale funzione.
...
|------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| [Overview](tapi-2-2-overview.md)<br/>   | Informazioni generali sull'architettura e sui componenti TAPI.<br/>                                            |
| [Riferimento](tapi-2-2-reference.md)<br/> | Documentazione di funzioni, strutture, messaggi, costanti e classi di dispositivi disponibili in TAPI 2.2.<br/> |
