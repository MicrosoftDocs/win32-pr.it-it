...
Questo metodo è interscambiabile con [**get \_ \_ NewEnum**](itmediacollection-get--newenum.md) , ad eccezione del fatto che restituisce [**IEnumMedia**](ienummedia.md) anziché **IUnknown**.

TAPI chiama il metodo **AddRef** sull'interfaccia [**IEnumMedia**](ienummedia.md) restituita da **ITMediaCollection:: Get \_ Enumerationlf**. L'applicazione deve chiamare **Release** sull'interfaccia **IEnumMedia** per liberare risorse associate.
