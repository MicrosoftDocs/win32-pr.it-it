---
title: Archiviare i requisiti di certificazione Windows app desktop v3.0
description: Versione del documento 3.0Dati del documento 29 giugno 2012In questo documento sono contenuti i requisiti tecnici e le qualifica di idoneità che un'app desktop deve soddisfare per partecipare al programma di certificazione app desktop Windows 8.
...
ms.locfileid: "117666818"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v30"></a>Archivio: Requisiti di certificazione per Windows App desktop v3.0

**Versione del documento:** 3.0

**Data del documento:** 29 giugno 2012

Questo documento contiene i requisiti tecnici e le qualifica di idoneità che un'app desktop deve soddisfare per partecipare Windows 8 programma di certificazione delle app desktop. Per Windows 7, questo programma era noto come Windows Software Logo Program.
...
Il Windows di certificazione app di Windows 7 viene usato per convalidare la conformità a questi requisiti e sostituisce il WSLK usato per la convalida nel programma Windows 7 Software Logo. Il kit Windows app è uno dei componenti inclusi in Windows Software Development Kit (SDK) per Windows 8. È anche integrato in Microsoft Visual Studio 2012 Express per Windows 8.
