---
title: Requisiti di certificazione dell'archivio per le app desktop di Windows v 1.2
description: "Documento versione 1.2 del documento: il documento 2012This contiene i requisiti tecnici e le qualifiche di idoneità che un'app desktop deve soddisfare per partecipare al programma di certificazione delle applicazioni desktop di Windows 8."
...
ms.locfileid: "104338815"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v12"></a>Archivio: requisiti di certificazione per le applicazioni desktop di Windows v 1.2

**Versione documento:** 1,2

**Data documento:** 31 maggio 2012
...
## <a name="summary-of-the-tests-performed-on-desktop-apps"></a>Riepilogo dei test eseguiti sulle app desktop
...
| Attenersi ai messaggi di gestione riavvio del sistema                               | Superato/non superato               |
| Installazione reversibile pulita                                                | Superato/non superato/avviso     |
| Test di resilienza & di compatibilità                                         | Superato/non superato/avviso     |
| Test di file con firma digitale                                              | Superato/non superato/avviso     |
| Eseguire l'installazione nel test delle cartelle corrette                                     | Avviso                   |
| Test della sessione multiutente                                                  | Avviso                   |
| Verifica della versione del sistema operativo                                                | Superato/non superato               |
| Test in modalità provvisoria                                                          | Superato/non superato               |
| Supporto di Windows test x64                                                | Superato/non superato               |
| Testare le modifiche apportate alle funzionalità di sicurezza di Windows (Attack Surface Analyzer) | Superato/non superato/avviso     |
| Testare le modifiche apportate alle funzionalità di sicurezza di Windows (BinScope Binary Analyzer) | Avviso                   |
| Test controllo dell'account utente (UAC)                                         | Superato/non superato/avviso     |
