---
title: Archiviare i requisiti di certificazione per Windows Desktop Apps v3.1
...
ms.locfileid: "122883319"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v31"></a>Archivio: Requisiti di certificazione per Windows Desktop Apps v3.1

**Versione del documento:** 3.1

**Data del documento:** 18 giugno 2013

Questo documento contiene i requisiti tecnici e le qualifica di idoneità che un'app desktop deve soddisfare per partecipare al programma Windows 8.1 Di certificazione app desktop. Per Windows 7, questo programma era noto come Windows Software Logo Program.
...
Il Windows App Certification Kit viene usato per convalidare la conformità a questi requisiti e sostituisce il WSLK usato per la convalida nel programma Windows 7 Software Logo. Il Windows App Certification Kit è uno dei componenti inclusi in Windows Software Development Kit (SDK) per Windows 8.1.
...
-   Non deve comunicare con le app Windows Store tramite meccanismi locali, inclusi file e chiavi del Registro di sistema
