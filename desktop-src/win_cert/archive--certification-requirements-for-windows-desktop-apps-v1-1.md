---
title: Archiviare i requisiti di certificazione per Windows Desktop Apps v1.1
...
ms.locfileid: "122885990"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v11"></a>Archivio: Requisiti di certificazione per Windows Desktop Apps v1.1

**Versione del documento:** 1.1

**Data del documento:** 26 gennaio 2012

Questo documento contiene i requisiti tecnici e le qualifica di idoneità che un'app desktop deve soddisfare per partecipare al programma di certificazione app desktop Windows 8. Per Windows 7, questo programma era noto come Windows Software Logo Program.
