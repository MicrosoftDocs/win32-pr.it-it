...
---
# <a name="crawl-scope-interfaces"></a>Interfacce ambito di ricerca per indicizzazione


Questa sezione di riferimento di Windows Search è costituita dalle seguenti interfacce dell'ambito di ricerca:
