---
description: L'esempio di codice SearchEvents illustra come classificare in ordine di priorità gli eventi di indicizzazione.
...
L'esempio di codice SearchEvents illustra come classificare in ordine di priorità gli eventi di indicizzazione.
...
2. Al prompt dei comandi immettere o in Windows Explorer fare doppio clic `Eventing.exe` sull'icona per Eventing.exe.
