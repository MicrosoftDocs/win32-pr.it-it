...
| *%System%* \\ Windows.\*\\                                                              | **Esclusione**        | Nessun effetto               | Le Windows nell'unità di sistema.                                                                                                                                                                             |
| *%System%* \\ Programdata\\                                                             | **Esclusione**        | **Esclusione**            | Si noti che la sottocartella del menu Start condiviso è indicizzata.                                                                                                                                                                     |
| *%System%* \\ AppData \\ \* \\ per gli utenti\\                                                      | **Esclusione**        | **Esclusione**            | Dati dell'applicazione degli utenti (inclusi i dati temporanei).                                                                                                                                                                              |
...
| *%System%* \\ Impostazione \\ predefinita degli utenti\\                                                          | Nessun effetto           | **Esclusione**            | Percorso dei dati del profilo utente predefinito nell'unità di sistema.                                                                                                                                                             |
