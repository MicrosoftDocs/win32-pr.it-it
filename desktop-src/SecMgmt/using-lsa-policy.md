---
description: Descrivere come usare le funzioni dei criteri LSA.
...
ms.locfileid: "119004749"
---
# <a name="using-lsa-policy"></a>Uso dei criteri LSA

Negli argomenti seguenti viene descritto come usare le funzioni criteri LSA.

-   [L'uso di stringhe Unicode LSA](using-lsa-unicode-strings.md) illustra come convertire le stringhe nel formato di struttura usato da alcune funzioni dei criteri LSA.
-   [L'apertura di un handle di](opening-a-policy-object-handle.md) oggetto criteri descrive come aprire un handle per l'oggetto [**Criteri**](policy-object.md) locale. Questo handle è richiesto da molte delle funzioni dei criteri LSA come parametro di input.
-   [Gestione delle informazioni sui](managing-policy-information.md) criteri illustra in dettaglio come impostare ed eseguire query sulle informazioni sui criteri globali per il sistema locale e il dominio.
