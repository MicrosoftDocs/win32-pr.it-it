...
---
# <a name="idxtkeyget_luminance-method"></a>Metodo IDxtKey:: Get \_ Luminance
...
Il `get_Luminance` metodo recupera il valore di luminanza su cui eseguire la chiave. Questa proprietà si applica solo quando il tipo di chiave è DXTKEY \_ luminanza.
...
Riceve il valore di luminanza su cui eseguire la chiave.
