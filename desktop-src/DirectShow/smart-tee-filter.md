...
Il filtro Smart Tee viene usato nei grafici di acquisizione video per suddividere il flusso video in un flusso di anteprima e un flusso di acquisizione. Questa operazione viene eseguita senza alcuna copia aggiuntiva dei dati. I pin di output supportano qualsiasi tipo di supporto supportato nella connessione downstream.
