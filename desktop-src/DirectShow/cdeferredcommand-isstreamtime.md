...
---
# <a name="cdeferredcommandisstreamtime-method"></a>CDeferredCommand. IsStreamTime, metodo

Il `IsStreamTime` metodo specifica se il comando deve essere eseguito in fase di flusso o di presentazione.
...
Restituisce **true** se impostato sull'ora del flusso; in caso contrario, restituisce **false**.
