...
Restituisce un **valore DWORD** contenente il numero di versione. Ogni volta che il formato del flusso viene modificato, è necessario modificare questa funzione per restituire un numero maggiore di quello precedente.
