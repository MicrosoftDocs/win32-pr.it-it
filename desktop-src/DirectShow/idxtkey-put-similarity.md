...
---
# <a name="idxtkeyput_similarity-method"></a>IDxtKey: metodo di \_ somiglianza ut:p
...
Il `put_Similarity` metodo specifica l'intervallo di dati del colore che diventa trasparente. Con valori superiori, una gamma più ampia di colori simili è trasparente. Questa proprietà si applica solo quando il tipo di chiave è DXTKEY \_ RGB o DXTKEY \_ NONRED.
