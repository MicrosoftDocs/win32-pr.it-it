...
---
# <a name="adding-region-change-support-to-an-application"></a>Aggiunta del supporto Region-Change a un'applicazione

Le funzioni seguenti vengono fornite per gli sviluppatori che desiderano integrare il supporto per la modifica dell'area nei rispettivi decodificatori o applicazioni DVD.
