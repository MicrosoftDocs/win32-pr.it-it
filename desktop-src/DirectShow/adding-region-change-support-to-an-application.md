---
description: Aggiunta Region-Change a un'applicazione
ms.assetid: 4a5c049d-b59f-4130-9252-bc28662a7931
title: Aggiunta Region-Change a un'applicazione
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119690521"
---
# <a name="adding-region-change-support-to-an-application"></a>Aggiunta Region-Change a un'applicazione

Le funzioni seguenti sono disponibili per gli sviluppatori che desiderano integrare il supporto per la modifica dell'area nei decodificatori o nelle applicazioni DVD.
