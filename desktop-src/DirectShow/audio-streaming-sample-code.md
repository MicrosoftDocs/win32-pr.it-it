---
description: Codice di esempio di streaming audio
ms.assetid: f3ba32c5-c3de-4f6b-bc89-f7860ca5f65b
title: Codice di esempio di streaming audio
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106304269"
---
# <a name="audio-streaming-sample-code"></a><span data-ttu-id="9384e-103">Codice di esempio di streaming audio</span><span class="sxs-lookup"><span data-stu-id="9384e-103">Audio Streaming Sample Code</span></span>

> [!Note]  
> <span data-ttu-id="9384e-104">Queste API sono deprecate.</span><span class="sxs-lookup"><span data-stu-id="9384e-104">These APIs are deprecated.</span></span> <span data-ttu-id="9384e-105">Le applicazioni devono usare il filtro [**grabber di esempio**](sample-grabber-filter.md) o implementare un filtro personalizzato per ottenere i dati da un grafico filtro DirectShow.</span><span class="sxs-lookup"><span data-stu-id="9384e-105">Applications should use the [**Sample Grabber**](sample-grabber-filter.md) filter or implement a custom filter to get data from a DirectShow filter graph.</span></span>

 

<span data-ttu-id="9384e-106">Nell'esempio di codice seguente viene illustrato come eseguire lo streaming di dati audio usando le interfacce [**IAudioMediaStream**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiomediastream), [**IAudioStreamSample**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiostreamsample), [**IMemoryData**](/previous-versions/windows/desktop/api/austream/nn-austream-imemorydata)e [**IAudioData**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiodata) .</span><span class="sxs-lookup"><span data-stu-id="9384e-106">The following code sample demonstrates how to stream audio data using the [**IAudioMediaStream**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiomediastream), [**IAudioStreamSample**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiostreamsample), [**IMemoryData**](/previous-versions/windows/desktop/api/austream/nn-austream-imemorydata), and [**IAudioData**](/previous-versions/windows/desktop/api/austream/nn-austream-iaudiodata) interfaces.</span></span> <span data-ttu-id="9384e-107">Per brevità, in questo esempio viene eseguito il controllo minimo degli errori.</span><span class="sxs-lookup"><span data-stu-id="9384e-107">For brevity, this example performs minimal error checking.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9384e-108">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="9384e-108">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9384e-109">Codice di esempio per lo streaming multimediale</span><span class="sxs-lookup"><span data-stu-id="9384e-109">Multimedia Streaming Sample Code</span></span>](multimedia-streaming-sample-code.md)
</dt> </dl>
