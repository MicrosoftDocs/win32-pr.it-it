...
Il `ZeroBetween` metodo rimuove tutti gli elementi dalla traccia tra le ore specificate. Questo metodo suddivide tutti gli oggetti che si estendono nell'intervallo di tempo specificato e rimuove le parti che rientrano nell'intervallo.
...
Inizio dell'intervallo da cancellare, in unità 100-nanosecondi.
...
Fine dell'intervallo da cancellare, in unità 100-nanosecondi.
