...
---
# <a name="cmediacontrolgetidsofnames-method"></a>CMediaControl. GetIDsOfNames, metodo

Esegue il mapping di una singola funzione membro e di un set facoltativo di parametri a un set corrispondente di identificatori di invio di numeri interi (DISPID), che possono essere usati durante le chiamate successive alla funzione membro [**CMediaControl:: Invoke**](cmediacontrol-invoke.md) .
