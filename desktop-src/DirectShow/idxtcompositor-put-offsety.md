...
---
# <a name="idxtcompositorput_offsety-method"></a>IDxtCompositor::p \_ metodo di offset UT
...
Il `put_OffsetY` metodo specifica l'offset verticale del rettangolo di destinazione.
...
Offset verticale del rettangolo di destinazione, espresso in pixel.
