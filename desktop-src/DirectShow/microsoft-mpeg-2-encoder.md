---
description: Il filtro microsoft MPEG-2 Encoder codifica audio e video MPEG-2 e multiplex per generare un flusso di programma MPEG-2 o un flusso di trasporto.
...
ms.locfileid: "120051231"
---
# <a name="microsoft-mpeg-2-encoder"></a>Codificatore Microsoft MPEG-2

Il filtro microsoft MPEG-2 Encoder codifica audio e video MPEG-2 e multiplex per generare un flusso di programma MPEG-2 o un flusso di trasporto.
...
**CLSID \_ CMPEG2EncoderDS** (dichiarato in wmcodecdsp.h)
...
-   [**Codificatore audio MPEG-2 Microsoft**](microsoft-mpeg-2-audio-encoder.md)
-   [**Codificatore video MPEG-2 Microsoft**](microsoft-mpeg-2-video-encoder.md)

Ad eccezione di quanto specificato, questo filtro supporta le stesse funzionalità di codifica di questi due codificatori.
...
-   Audio visivo in un flusso di programma MPEG-2
-   Audio-visivo in un flusso di trasporto MPEG-2

Corrispondono ai tipi di output seguenti:

-   **MEDIATYPE \_ Stream,** **MEDIASUBTYPE \_ MPEG2 \_ PROGRAM**
-   **MEDIATYPE \_ Flusso,** **MEDIASUBTYPE \_ MPEG2 \_ TRANSPORT**

Questo filtro non può eseguire il multiplex dei flussi codificati in precedenza. I flussi di input devono essere audio/video non compressi, codificati dal filtro prima del multiplexing. Il flusso multiplexed è limitato a un programma, contenente un massimo di un flusso audio e un flusso video.
