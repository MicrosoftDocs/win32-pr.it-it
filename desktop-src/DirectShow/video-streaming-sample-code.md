...
Questo codice di esempio legge un file e ne esegue il rendering in una superficie DirectDraw primaria. Per brevità, in questo esempio viene eseguito il controllo minimo degli errori.
