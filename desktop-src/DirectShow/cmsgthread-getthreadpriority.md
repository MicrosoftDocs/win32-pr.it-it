...
---
# <a name="cmsgthreadgetthreadpriority-method"></a>CMsgThread. GetThreadPriority, metodo

Usa la funzione **GetThreadPriority** di Microsoft Win32 per recuperare la priorità del thread di lavoro corrente.
...
Restituisce la priorità del thread come Integer.
