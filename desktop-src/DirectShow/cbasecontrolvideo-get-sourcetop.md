...
---
# <a name="cbasecontrolvideoget_sourcetop-method"></a>Metodo CBaseControlVideo. Get \_ SourceTop

Il `get_SourceTop` metodo recupera la coordinata superiore del rettangolo di origine corrente.
...
Questa funzione membro implementa il metodo [**IBasicVideo:: Get \_ SourceTop**](/windows/desktop/api/Control/nf-control-ibasicvideo-get_sourcetop) .
