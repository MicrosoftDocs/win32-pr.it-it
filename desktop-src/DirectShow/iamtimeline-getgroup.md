...
Riceve un puntatore all'interfaccia [**IAMTimelineObj**](iamtimelineobj.md) del gruppo.
...
Indice del gruppo da recuperare in base all'ordine in cui i gruppi sono stati aggiunti alla sequenza temporale. Il primo gruppo aggiunto alla sequenza temporale ha un indice pari a 0.
