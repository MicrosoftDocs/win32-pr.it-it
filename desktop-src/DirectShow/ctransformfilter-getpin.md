...
---
# <a name="ctransformfiltergetpin-method"></a>CTransformFilter. GetPin, metodo
...
Se il filtro usa i pin predefiniti [**CTransformInputPin**](ctransforminputpin.md) e [**CTransformOutputPin**](ctransformoutputpin.md) , probabilmente non è necessario eseguire l'override di questo metodo. Se il filtro usa pin che estendono tali classi, tuttavia, è necessario eseguire l'override di questo metodo per creare pin di quel tipo.
