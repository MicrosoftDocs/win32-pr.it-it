...
Questa sezione contiene argomenti di riferimento per [le interfacce DirectShow Editing Services](directshow-editing-services.md) (DES).
...
| [**IAMTimelineEffectable**](iamtimelineeffectable.md)     | Fornisce metodi per aggiungere effetti a un oggetto sequenza temporale.                                                                      |
| [**IAMTimelineGroup**](iamtimelinegroup.md)               | Imposta e recupera le proprietà sui gruppi.                                                                                       |
| [**IAMTimelineObj**](iamtimelineobj.md)                   | Fornisce metodi per la modifica degli oggetti sequenza temporale.                                                                            |
| [**IAMTimelineSplittable**](iamtimelinesplittable.md)     | Suddivide un oggetto sequenza temporale.                                                                                                      |
...
| [**IAMTimelineVirtualTrack**](iamtimelinevirtualtrack.md) | Fornisce metodi per l'uso di tracce virtuali.                                                                              |
| [**IDxtAlphaSetter**](idxtalphasetter.md)                 | Imposta le proprietà [dell'effetto Setter](alpha-setter-effect.md) alfa.                                                         |
| [**IDxtCompositor**](idxtcompositor.md)                   | Imposta le proprietà per la [transizione Compositor.](compositor-transition.md)                                                     |
| [**IDxtJpeg**](idxtjpeg.md)                               | Imposta le proprietà per la [transizione di cancellazione SMPTE.](smpte-wipe-transition.md)                                                     |
...
| [**IRenderEngine**](irenderengine.md)                     | Esegue il rendering di un progetto DES creando un grafo di filtro da una sequenza temporale.                                                          |
...
| [**ISampleGrabber**](isamplegrabber.md)                   | Recupera singoli campioni di supporti mentre si spostano nel grafico dei filtri.                                                      |
...
[DirectShow Informazioni di riferimento su C++ per i servizi di modifica](directshow-editing-services-c---reference.md)
</dt> </dl>
