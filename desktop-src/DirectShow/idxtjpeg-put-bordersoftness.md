...
---
# <a name="idxtjpegput_bordersoftness-method"></a>IDxtJpeg::p UT \_ BorderSoftness metodo
...
Il `put_BorderSoftness` metodo specifica la larghezza dell'area sfocata intorno ai bordi del pattern di cancellazione.
...
Larghezza, in pixel, dell'area sfocata.
