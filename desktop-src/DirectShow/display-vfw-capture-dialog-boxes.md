...
|---------------|-------------------------------------------------------------------------------------------------------|
| Origine video  | Consente di selezionare l'input video e di regolare le impostazioni del dispositivo, ad esempio la luminosità o il contrasto dell'immagine. |
| Formato video  | Consente di selezionare le dimensioni dell'immagine e la profondità in bit.                                                    |
| Visualizzazione video | Usato per controllare l'aspetto del video sottoposto a rendering.                                                 |
