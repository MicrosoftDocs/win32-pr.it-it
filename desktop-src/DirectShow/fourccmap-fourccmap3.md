---
description: Metodo del costruttore che fornisce il mapping tra i tipi DWORD in formato multimediale precedente e i sottotipi GUID. Questo metodo usa il parametro 'pguid'.
...
| Requisito | Valore |
|-|-|
| Intestazione  | Fourcc.h (includere Flussi.h) |
