...
La transizione Chiave esegue la keying in base al valore RGB, al valore alfa, alla tonalità o alla luminance.
...
| Inverti     | BOOL  | **FALSE** o **TRUE** | Valore booleano che indica se invertire l'operazione predefinita della chiave. Se **FALSE,** i pixel nell'immagine sovrasparente vengono resi trasparenti nel modo predefinito. Se **TRUE,** l'operazione viene invertita.                                                   | Chroma, Hue, Luminance, Nonred |
...
| RGB        | DWORD | 0x0: 0xFFFFFF        | Colore su cui eseguire la chiave. Il valore è un numero esadecimale nel formato 0x *RRGGBB,* dove *RR* è il valore rosso, *GG* è il valore verde e *BB* è il valore blu. (rosso puro, verde e blu sono rispettivamente 0xFF0000, 0x00FF00 e 0x0000FF. | Chroma                         |
...
|-------|-------------------|-------------------------------------------------------|
| 0     | DXTKEY \_ RGB       | Chiave croma (chiave per valore RGB).                        |
| 1     | DXTKEY \_ NONRED    | Chiave non privata. Rende trasparenti le aree blu e verde. |
| 2     | DXTKEY \_ LUMINANCE | Chiave di luminance.                                        |
| 3     | DXTKEY \_ ALPHA     | Chiave per valore alfa.                                   |
| 4     | DXTKEY \_ HUE       | Chiave in base alla tonalità.                                           |



 

Il tipo di chiave predefinito è DXTKEY \_ ALPHA.
