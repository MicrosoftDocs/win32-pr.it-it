---
title: Macro RPC
description: In questa sezione vengono illustrate in dettaglio le macro utilizzate con la libreria di runtime RPC.
...
ms.locfileid: "104473979"
---
# <a name="rpc-macros"></a>Macro RPC

In questa sezione vengono illustrate in dettaglio le macro utilizzate con la libreria di runtime RPC.

-   [**Macro di portabilità**](portability-macros.md)
