...
---
# <a name="examples-of-incremental-encoding"></a><span data-ttu-id="ee3dd-104">Esempi di codifica incrementale</span><span class="sxs-lookup"><span data-stu-id="ee3dd-104">Examples of Incremental Encoding</span></span>

<span data-ttu-id="ee3dd-105">Nella sezione seguente viene fornito un esempio di utilizzo dell'handle di serializzazione dello stile incrementale per la codifica dei tipi.</span><span class="sxs-lookup"><span data-stu-id="ee3dd-105">The following section provides an example of how to use the incremental style serializing handle for type encoding.</span></span>
...
<span data-ttu-id="ee3dd-106">L'estratto seguente rappresenta i frammenti dell'applicazione pertinenti.</span><span class="sxs-lookup"><span data-stu-id="ee3dd-106">The following excerpt represents the relevant application fragments.</span></span>
