...
| <span id="ncadg_ipx"></span><span id="NCADG_IPX"></span><dl> <dt>**ncadg \_ ipx**</dt> <dt>Datagram (connectionless) IPX</dt> </dl>                                                           | Solo client: MS-DOS, Windows 3. *x* Client e Server: Windows Server 2003, Windows XP, Windows 2000, Windows NT<br/>                                                          |
