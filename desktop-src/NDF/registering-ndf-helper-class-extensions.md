...
1.  Pubblicare i nomi delle classi helper implementate dalla DLL e le relative dipendenze creando una chiave per la DLL in
    ...
    **HKLM \\ Controllo \\ System CurrentControlSet \\ \\ NetDiagFx** \\ *VendorName* \\ **Classe** helper DLL helper \\  \\ **HelperClasses** \\ *Nome* classe helper

    Sostituire *VendorName,* *Helper Class DLL* e Helper Class *Name* con i valori definiti dall'utente, come descritto di seguito.
...
2.  In ogni *chiave Nome classe helper* pubblicare le informazioni seguenti.
    ...
    | **Version**   | REG \_ SZ    | Stringa che contiene le versioni principale e secondaria della classe helper nel formato <major> <minor> .                                                        |
    ...
    | **Parent**    | REG \_ SZ    | Stringa che specifica la classe helper estendibile Microsoft da estendere.                                                                                       |
...
3.  Per ogni classe helper, pubblicare l'elenco di attributi corrispondenti creando una chiave in
    ...
    **HKLM \\ Controllo \\ System CurrentControlSet \\ \\ NetDiagFx** \\ *VendorName* \\ **Classe** \\ *helper DLL* Helper \\ **HelperClasses** Nome classe \\ *helper* \\ **MatchAttributes**
