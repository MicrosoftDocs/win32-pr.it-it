...
|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| [**StorageAdapterActivate**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_activate_fn)<br/>                           | Offre all Archiviazione adapter la possibilità di eseguire qualsiasi operazione necessaria per portare il componente di archiviazione fuori da uno stato di inattività.<br/>         |
