...
---
# <a name="ipv4-only-client-code"></a><span data-ttu-id="57209-103">Codice client solo IPv4</span><span class="sxs-lookup"><span data-stu-id="57209-103">IPv4-only Client Code</span></span>

<span data-ttu-id="57209-104">Il codice seguente è il file SIMPLEC. c, che è un client Windows Sockets solo IPv4 (la versione abilitata per IPv6 del file SIMPLEC. c si trova nell'Appendice B).</span><span class="sxs-lookup"><span data-stu-id="57209-104">The following code is the Simplec.c file, which is an IPv4-only Windows Sockets client (an IPv6 enabled version of the Simplec.c file can be found in Appendix B).</span></span> <span data-ttu-id="57209-105">Questo codice viene fornito solo a scopo di confronto: usare l'Appendice B per un esempio di come scrivere un client abilitato per IPv6.</span><span class="sxs-lookup"><span data-stu-id="57209-105">This code is provided for comparison purposes only — use Appendix B for an example of how to write an IPv6-enabled client.</span></span>
