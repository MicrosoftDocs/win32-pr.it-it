---
description: Il codice seguente è il file client. c indipendente dall'IP, che è una versione abilitata per IPv6 del file SIMPLEC. c.
ms.assetid: a68439cd-0b27-447b-9766-e661c32eee09
title: Codice client di IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103966679"
---
# <a name="ipv6-enabled-client-code"></a><span data-ttu-id="d1e3d-103">Codice client di IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="d1e3d-103">IPv6-Enabled Client Code</span></span>

<span data-ttu-id="d1e3d-104">Il codice seguente è il file client. c indipendente dall'IP, che è una versione abilitata per IPv6 del file SIMPLEC. c.</span><span class="sxs-lookup"><span data-stu-id="d1e3d-104">The following code is the IP agnostic Client.c file, which is an IPv6-enabled version of the Simplec.c file.</span></span>
