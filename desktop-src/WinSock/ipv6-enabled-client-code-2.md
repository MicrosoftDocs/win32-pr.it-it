...
---
# <a name="ipv6-enabled-client-code"></a>Codice client di IPv6-Enabled

Il codice seguente è il file client. c indipendente dall'IP, che è una versione abilitata per IPv6 del file SIMPLEC. c.
