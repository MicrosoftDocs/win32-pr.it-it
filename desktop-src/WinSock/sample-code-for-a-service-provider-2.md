---
description: Questa sezione contiene un esempio di codice sorgente che illustra come implementare le funzioni GetXbyY usando le nuove funzioni RNR indipendenti dal protocollo.
ms.assetid: d6246d47-11c2-4e4b-8a2b-17fd9cb041fc
title: Codice di esempio per un provider di servizi
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103755082"
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="724a6-103">Codice di esempio per un provider di servizi</span><span class="sxs-lookup"><span data-stu-id="724a6-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="724a6-104">Questa sezione contiene un esempio di codice sorgente che illustra come implementare le funzioni **GetXbyY** usando le nuove funzioni RNR indipendenti dal protocollo.</span><span class="sxs-lookup"><span data-stu-id="724a6-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="724a6-105">Uno sviluppatore deve implementare queste funzioni come punto di partenza.</span><span class="sxs-lookup"><span data-stu-id="724a6-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="724a6-106">Per garantire la conformità con la specifica di Windows Sockets, sono necessarie molte altre funzioni.</span><span class="sxs-lookup"><span data-stu-id="724a6-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="724a6-107">Il codice seguente non è garantito per la compilazione.</span><span class="sxs-lookup"><span data-stu-id="724a6-107">The following code is not guaranteed to compile.</span></span>
