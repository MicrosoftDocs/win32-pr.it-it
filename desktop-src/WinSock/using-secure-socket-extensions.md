...
---
# <a name="using-secure-socket-extensions"></a><span data-ttu-id="112c9-103">Uso delle estensioni Secure Socket</span><span class="sxs-lookup"><span data-stu-id="112c9-103">Using Secure Socket Extensions</span></span>

<span data-ttu-id="112c9-104">Nell'esempio di codice riportato di seguito viene illustrato l'utilizzo delle funzioni di estensione del socket sicuro Winsock.</span><span class="sxs-lookup"><span data-stu-id="112c9-104">The following example code demonstrates the usage of the Winsock secure socket extension functions.</span></span>

## <a name="securing-a-socket"></a><span data-ttu-id="112c9-105">Protezione di un socket</span><span class="sxs-lookup"><span data-stu-id="112c9-105">Securing a Socket</span></span>
...
## <a name="querying-the-security-on-a-socket"></a><span data-ttu-id="112c9-106">Esecuzione di query sulla sicurezza in un socket</span><span class="sxs-lookup"><span data-stu-id="112c9-106">Querying the Security on a Socket</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="112c9-107">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="112c9-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="112c9-108">Informazioni sulla piattaforma filtro Windows</span><span class="sxs-lookup"><span data-stu-id="112c9-108">About Windows Filtering Platform</span></span>](../fwp/about-windows-filtering-platform.md)
</dt> <dt>

[<span data-ttu-id="112c9-109">Esempi avanzati di Winsock con estensioni Secure Socket</span><span class="sxs-lookup"><span data-stu-id="112c9-109">Advanced Winsock Samples Using Secure Socket Extensions</span></span>](advanced-winsock-samples-using-secure-socket-extensions.md)
</dt> <dt>

[<span data-ttu-id="112c9-110">Application Layer Enforcement (ALE)</span><span class="sxs-lookup"><span data-stu-id="112c9-110">Application Layer Enforcement (ALE)</span></span>](../fwp/application-layer-enforcement--ale-.md)
</dt> <dt>

[<span data-ttu-id="112c9-111">Configurazione IPsec</span><span class="sxs-lookup"><span data-stu-id="112c9-111">IPsec Configuration</span></span>](../fwp/ipsec-configuration.md)
</dt> <dt>

[<span data-ttu-id="112c9-112">Funzioni IPsec</span><span class="sxs-lookup"><span data-stu-id="112c9-112">IPsec Functions</span></span>](../fwp/fwp-ipsec-functions.md)
</dt> <dt>

[<span data-ttu-id="112c9-113">Security Support Provider Interface (SSPI)</span><span class="sxs-lookup"><span data-stu-id="112c9-113">Security Support Provider Interface (SSPI)</span></span>](../rpc/security-support-provider-interface-sspi-.md)
</dt> <dt>

[<span data-ttu-id="112c9-114">Piattaforma filtro Windows</span><span class="sxs-lookup"><span data-stu-id="112c9-114">Windows Filtering Platform</span></span>](../fwp/windows-filtering-platform-start-page.md)
</dt> <dt>

[<span data-ttu-id="112c9-115">Funzioni API della piattaforma filtro Windows</span><span class="sxs-lookup"><span data-stu-id="112c9-115">Windows Filtering Platform API Functions</span></span>](../fwp/fwp-functions.md)
</dt> <dt>

[<span data-ttu-id="112c9-116">Estensioni Secure socket Winsock</span><span class="sxs-lookup"><span data-stu-id="112c9-116">Winsock Secure Socket Extensions</span></span>](winsock-secure-socket-extensions.md)
</dt> </dl>
