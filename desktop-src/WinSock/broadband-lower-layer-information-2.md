---
description: In questa sezione viene elencata la definizione del tipo per le informazioni di livello inferiore a banda larga.
ms.assetid: b987dd6b-a611-4297-abaa-fd080cc94f6f
title: Informazioni sul livello inferiore a banda larga
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103751479"
---
# <a name="broadband-lower-layer-information"></a><span data-ttu-id="9e381-103">Informazioni sul livello inferiore a banda larga</span><span class="sxs-lookup"><span data-stu-id="9e381-103">Broadband Lower Layer Information</span></span>

<span data-ttu-id="9e381-104">In questa sezione viene elencata la definizione del tipo per le informazioni di livello inferiore a banda larga.</span><span class="sxs-lookup"><span data-stu-id="9e381-104">This section lists the type definition for the broadband lower-layer information.</span></span>
