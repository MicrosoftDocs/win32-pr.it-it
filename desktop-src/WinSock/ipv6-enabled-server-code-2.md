---
description: Il codice seguente è il file server. c indipendente dall'IP, che è una versione abilitata per IPv6 del file simples. c.
ms.assetid: 5e27c731-c9c7-4c49-91bd-6f4dee60460b
title: Codice server IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104129171"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="fadef-103">Codice server IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="fadef-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="fadef-104">Il codice seguente è il file server. c indipendente dall'IP, che è una versione abilitata per IPv6 del file simples. c.</span><span class="sxs-lookup"><span data-stu-id="fadef-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
