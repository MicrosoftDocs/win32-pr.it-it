...
---
# <a name="ipv6-enabled-server-code"></a>Codice server IPv6-Enabled

Il codice seguente è il file server. c indipendente dall'IP, che è una versione abilitata per IPv6 del file simples. c.
