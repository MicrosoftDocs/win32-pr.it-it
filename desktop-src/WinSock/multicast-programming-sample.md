...
ms.locfileid: "119858231"
---
# <a name="multicast-programming-sample"></a>Esempio di programmazione multicast

Il codice di esempio seguente illustra come includere funzionalità multicast in un'applicazione Windows Sockets usando le opzioni socket.
