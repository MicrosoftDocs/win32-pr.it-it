...
description: Imposta le coordinate della trama corrente. | Funzione glTexCoord2dv (Gl.h)
...
ms.locfileid: "119491291"
---
# <a name="gltexcoord2dv-function"></a>Funzione glTexCoord2dv
