...
description: Controlla la generazione delle coordinate della trama. | Funzione glTexGendv (Gl.h)
...
ms.locfileid: "119490401"
---
# <a name="gltexgendv-function"></a>Funzione glTexGendv
...
e x?, y?, z?e w? sono le coordinate oculare del vertice, p1, p2, p3 e p4 sono i valori forniti in *param* e M è la matrice modelview quando si **chiamaglTexGen**. Se M è scarsamente condizionato o singolare, le coordinate di trama generate dalla funzione risultante possono essere imprecise o non definite.
