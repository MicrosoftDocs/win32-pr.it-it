...
---
# <a name="gltexgendv-function"></a>glTexGendv (funzione)
...
Matrice che contiene i coefficienti per la funzione di generazione della trama corrispondente.
...
e x?, y?, z? e w? le coordinate oculari dei vertici, P1, P2, P3 e P4 sono i valori specificati in *param* e M è la matrice Modelview quando si **callglTexGen**. Se M è scarsamente condizionato o singolare, le coordinate di trama generate dalla funzione risultante possono non essere accurate o indefinite.
