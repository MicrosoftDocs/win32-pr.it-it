...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos2iv (Gl.h)
...
ms.locfileid: "119492521"
---
# <a name="glrasterpos2iv-function"></a>Funzione glRasterPos2iv
