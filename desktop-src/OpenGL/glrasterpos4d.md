...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos4d (Gl.h)
...
ms.locfileid: "118614587"
---
# <a name="glrasterpos4d-function"></a>Funzione glRasterPos4d
