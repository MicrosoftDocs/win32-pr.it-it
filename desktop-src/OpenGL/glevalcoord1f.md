...
---
# <a name="glevalcoord1f-function"></a>glEvalCoord1f (funzione)

La funzione **glEvalCoord1f** valuta i mapping unidimensionali abilitati.
...
Valore che rappresenta la coordinata di dominio *u* per la funzione di base definita in una funzione [**glMap1**](glmap1.md) precedente.
...
La funzione **glEvalCoord1f** valuta le mappe unidimensionali abilitate all'argomento *u*. Definire Maps con [**glMap1**](glmap1.md). Abilitarli o disabilitarli con [**glEnable**](glenable.md) e [**glDisable**](gldisable.md).
...
Le funzioni seguenti consentono di recuperare informazioni correlate alla funzione **glEvalCoord1f** :
