...
description: La funzione glEvalCoord1f valuta le mappe unidimensionali abilitate.
...
ms.locfileid: "118616208"
---
# <a name="glevalcoord1f-function"></a>Funzione glEvalCoord1f

La **funzione glEvalCoord1f** valuta le mappe unidimensionali abilitate.
...
La **funzione glEvalCoord1f** valuta le mappe unidimensionali abilitate nell'argomento *u*. Definire le mappe [**con glMap1.**](glmap1.md) Abilitarli o disabilitarli [**con glEnable**](glenable.md) [**e glDisable**](gldisable.md).
...
Le funzioni seguenti recuperano informazioni correlate **alla funzione glEvalCoord1f:**
