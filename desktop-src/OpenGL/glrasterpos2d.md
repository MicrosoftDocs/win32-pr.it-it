...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos2d (Gl.h)
...
ms.locfileid: "118614795"
---
# <a name="glrasterpos2d-function"></a>Funzione glRasterPos2d
