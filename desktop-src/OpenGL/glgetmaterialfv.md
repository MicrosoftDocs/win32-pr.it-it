...
---
# <a name="glgetmaterialfv-function"></a>glGetMaterialfv (funzione)

Le funzioni **glGetMaterialfv** e [**glGetMaterialiv**](glgetmaterialiv.md) restituiscono parametri di materiale.
