...
description: La funzione glEvalCoord2dv valuta le mappe bidimensionali abilitate.
...
ms.locfileid: "119625641"
---
# <a name="glevalcoord2dv-function"></a>Funzione glEvalCoord2dv

La **funzione glEvalCoord2dv** valuta le mappe bidimensionali abilitate.
...
La **funzione glEvalCoord2dv** valuta le mappe bidimensionali abilitate usando due valori di dominio, *u* *e v*. Definire le mappe con [**glMap1**](glmap1.md). Abilitarli o disabilitarli [**con glEnable**](glenable.md) [**e glDisable**](gldisable.md).
...
Se la generazione normale automatica è abilitata, **glEvalCoord2dv** chiama [**glEnable**](glenable.md) con l'argomento GL AUTO NORMAL per generare le normali di superficie in modo analitico, indipendentemente dal contenuto o dall'abilitazione della mappa \_ GL \_ \_ MAP2 \_ NORMAL. Let
