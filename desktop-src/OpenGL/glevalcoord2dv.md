...
---
# <a name="glevalcoord2dv-function"></a>glEvalCoord2dv (funzione)

La funzione **glEvalCoord2dv** valuta i mapping bidimensionali abilitati.
...
La funzione **glEvalCoord2dv** valuta le mappe bidimensionali abilitate usando due valori di dominio, *u* e *v*. Definire Maps con [**glMap1**](glmap1.md). Abilitarli o disabilitarli con [**glEnable**](glenable.md) e [**glDisable**](gldisable.md).
...
Se è abilitata la generazione automatica normale, **glEvalCoord2dv** chiama [**glEnable**](glenable.md) con argomento GL \_ auto \_ Normal per generare le normalità della superficie in modo analitico, indipendentemente dal contenuto o abilitando la \_ \_ mappa normale GL map2. Let
...
Le funzioni seguenti consentono di recuperare informazioni correlate alla funzione **glEvalCoord2dv** :
