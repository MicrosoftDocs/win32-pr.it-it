...
---
# <a name="glutessbeginpolygon-function"></a>gluTessBeginPolygon (funzione)
...
Quando si chiama [**gluTessEndPolygon**](glutessendpolygon.md), il poligono è tassellati e i triangoli risultanti vengono descritti tramite callback. Per le descrizioni delle funzioni di callback, vedere [*gluTessCallback*](glutess.md).
