...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos3d (Gl.h)
...
ms.locfileid: "119519981"
---
# <a name="glrasterpos3d-function"></a>Funzione glRasterPos3d
