---
title: Funzione glTexParameteriv (Gl.h)
description: Imposta i parametri di trama. | Funzione glTexParameteriv (Gl.h)
...
ms.locfileid: "119490041"
---
# <a name="gltexparameteriv-function"></a>Funzione glTexParameteriv
...
| <span id="GL_LINEAR_MIPMAP_LINEAR"></span><span id="gl_linear_mipmap_linear"></span><dl> <dt>**GL \_ LINEAR \_ MIPMAP \_ LINEAR**</dt> </dl>       | Sceglie le due mipmap più vicine alle dimensioni del pixel da trame e usa il criterio GL LINEAR (media ponderata dei quattro elementi di trama più vicini al centro del pixel) per produrre un valore di trama da \_ ogni mipmap. Il valore finale della trama è una media ponderata di questi due valori.<br/>                                                                                                                                                                    |
