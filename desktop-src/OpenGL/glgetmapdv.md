...
description: Le funzioni glGetMapdv, glGetMapfv e glGetMapiv restituiscono parametri dell'analizzatore. | Funzione glGetMapdv (Gl.h)
...
ms.locfileid: "118360309"
---
# <a name="glgetmapdv-function"></a>Funzione glGetMapdv

Le **funzioni glGetMapdv**, [**glGetMapfv**](glgetmapfv.md)e [**glGetMapiv**](glgetmapiv.md) restituiscono parametri dell'analizzatore.
