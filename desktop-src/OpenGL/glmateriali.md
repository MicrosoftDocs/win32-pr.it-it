...
---
# <a name="glmateriali-function"></a>glMateriali (funzione)

La funzione **glMateriali** specifica i parametri del materiale per il modello di illuminazione.
...
I parametri Material possono essere aggiornati in qualsiasi momento. In particolare, è possibile chiamare **glMateriali** tra una chiamata a [**glBegin**](glbegin.md) e la chiamata corrispondente a [**glEnd**](glend.md). Se è necessario modificare un solo parametro Material per ogni vertice, tuttavia, [**glColorMaterial**](glcolormaterial.md) è preferibile rispetto a **glMateriali**.
