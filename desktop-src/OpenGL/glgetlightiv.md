...
---
# <a name="glgetlightiv-function"></a>glGetLightiv (funzione)

Le funzioni [**glGetLightfv**](glgetlightfv.md) e **glGetLightiv** restituiscono valori di parametro di origine Light.
