...
description: Imposta le coordinate della trama corrente. | Funzione glTexCoord3s (Gl.h)
...
ms.locfileid: "119490991"
---
# <a name="gltexcoord3s-function"></a>Funzione glTexCoord3s
