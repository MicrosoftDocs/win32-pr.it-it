...
description: Imposta le coordinate della trama corrente. | Funzione glTexCoord4d (Gl.h)
...
ms.locfileid: "118613750"
---
# <a name="gltexcoord4d-function"></a>Funzione glTexCoord4d
