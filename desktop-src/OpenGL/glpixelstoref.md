...
ms.locfileid: "104563927"
---
# <a name="glpixelstoref-function"></a>glPixelStoref (funzione)
...
Nome simbolico del parametro da impostare. Sei parametri di archiviazione influiscono sul modo in cui i dati dei pixel vengono restituiti alla memoria del client e sono pertanto significativi solo per i comandi [**glReadPixels**](glreadpixels.md) . Ecco quali sono:
...
La funzione **glPixelStoref** può essere usata per impostare qualsiasi parametro di archivio pixel. Se il tipo di parametro è booleano e se *param* è 0,0, il parametro è false; in caso contrario, è impostato su true. Se *pname* è un parametro di tipo Integer, *param* viene arrotondato all'intero più vicino.
