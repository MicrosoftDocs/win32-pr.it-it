...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos3s (Gl.h)
...
ms.locfileid: "117795072"
---
# <a name="glrasterpos3s-function"></a>Funzione glRasterPos3s
