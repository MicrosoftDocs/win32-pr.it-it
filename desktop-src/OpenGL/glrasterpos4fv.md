...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos4fv (Gl.h)
...
ms.locfileid: "119492261"
---
# <a name="glrasterpos4fv-function"></a>Funzione glRasterPos4fv
