...
description: Imposta il colore corrente da una matrice già esistente di valori di colore. | Funzione glColor3ubv (Gl.h)
...
ms.locfileid: "118617423"
---
# <a name="glcolor3ubv-function"></a>Funzione glColor3ubv
