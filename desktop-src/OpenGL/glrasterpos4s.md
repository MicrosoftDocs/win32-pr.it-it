...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos4s (Gl.h)
...
ms.locfileid: "118614597"
---
# <a name="glrasterpos4s-function"></a>Funzione glRasterPos4s
