...
---
# <a name="glindexdv-function"></a>glIndexdv (funzione)

La funzione **glIndexdv** imposta l'indice dei colori corrente.
...
La funzione **glIndexdv** aggiorna l'indice dei colori corrente (a valore singolo). Accetta un solo argomento: il nuovo valore per l'indice dei colori corrente.
...
L'indice corrente può essere aggiornato in qualsiasi momento. In particolare, è possibile chiamare **glIndexdv** tra una chiamata a [**glBegin**](/windows/desktop/OpenGL/glbegin) e la chiamata corrispondente a [**glEnd**](glend.md).

La funzione seguente recupera le informazioni correlate a **glIndexdv**:
