...
---
# <a name="glrasterpos4sv-function"></a>glRasterPos4sv (funzione)
...
Puntatore a una matrice di quattro elementi, che specifica le coordinate x, y, z e w per la posizione raster corrente.
