...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos4sv (Gl.h)
...
ms.locfileid: "118614491"
---
# <a name="glrasterpos4sv-function"></a>Funzione glRasterPos4sv
