...
description: La funzione glEvalCoord1dv valuta le mappe unidimensionali abilitate.
...
ms.locfileid: "118616238"
---
# <a name="glevalcoord1dv-function"></a>Funzione glEvalCoord1dv

La [**funzione glEvalCoord1dv**](glevalcoord1d.md) valuta le mappe unidimensionali abilitate.
...
La **funzione glEvalCoord1dv** valuta le mappe unidimensionali abilitate nell'argomento *u*. Definire le mappe [**con glMap1.**](glmap1.md) Abilitarli o disabilitarli [**con glEnable**](glenable.md) [**e glDisable**](gldisable.md).
...
Le funzioni seguenti recuperano informazioni correlate **alla funzione glEvalCoord1dv:**
