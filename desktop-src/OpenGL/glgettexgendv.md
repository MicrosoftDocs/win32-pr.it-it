...
ms.locfileid: "119493801"
---
# <a name="glgettexgendv-function"></a>Funzione glGetTexGendv

Le **funzioni glGetTexGendv**, [**glGetTexGenfv**](glgettexgenfv.md)e [**glGetTexGeniv**](glgettexgeniv.md) restituiscono parametri di generazione delle coordinate di trama.
