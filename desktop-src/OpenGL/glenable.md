...
Le funzioni **glEnable** e [**glDisable**](gldisable.md) abilitano o disabilitano le funzionalità di OpenGL.
...
Le funzioni **glEnable** e **glDisable** abilitano e disabilitano diverse funzionalità grafiche OpenGL. Usare [**glIsEnabled**](glisenabled.md) o [**glGet**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) per determinare l'impostazione corrente di tutte le funzionalità.
