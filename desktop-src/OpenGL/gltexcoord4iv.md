...
description: Imposta le coordinate della trama corrente. | Funzione glTexCoord4iv (Gl.h)
...
ms.locfileid: "119777811"
---
# <a name="gltexcoord4iv-function"></a>Funzione glTexCoord4iv
