...
---
# <a name="glloadmatrixd-function"></a>glLoadMatrixd (funzione)

Le funzioni **glLoadMatrixd** e [**glLoadMatrixf**](glloadmatrixf.md) sostituiscono la matrice corrente con una matrice arbitraria.
