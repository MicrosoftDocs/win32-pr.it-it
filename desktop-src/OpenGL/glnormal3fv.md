...
---
# <a name="glnormal3fv-function"></a>glNormal3fv (funzione)
...
Il normale corrente viene impostato sulle coordinate specificate ogni volta che si chiama la funzione **glNormal3fv**.
