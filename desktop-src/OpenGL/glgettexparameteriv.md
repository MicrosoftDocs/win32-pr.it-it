...
---
# <a name="glgettexparameteriv-function"></a>glGetTexParameteriv (funzione)

Le funzioni [**glGetTexParameterfv**](glgettexparameterfv.md) e **glGetTexParameteriv** restituiscono i valori dei parametri della trama.
