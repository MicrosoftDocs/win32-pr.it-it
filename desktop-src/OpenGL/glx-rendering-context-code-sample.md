...
---
# <a name="glx-rendering-context-code-sample"></a><span data-ttu-id="76962-108">Esempio di codice del contesto di rendering GLX</span><span class="sxs-lookup"><span data-stu-id="76962-108">GLX Rendering Context Code Sample</span></span>

<span data-ttu-id="76962-109">Nell'esempio di codice seguente viene illustrato come un programma OpenGL del sistema X Window usa le funzioni del contesto di rendering GLX.</span><span class="sxs-lookup"><span data-stu-id="76962-109">The following code sample shows how an X Window System OpenGL program uses GLX rendering context functions.</span></span>
