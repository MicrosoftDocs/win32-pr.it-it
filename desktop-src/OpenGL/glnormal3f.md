...
---
# <a name="glnormal3f-function"></a>glNormal3f (funzione)
...
Il normale corrente viene impostato sulle coordinate specificate ogni volta che si chiama la funzione **glNormal3f** .
