...
ms.locfileid: "118938186"
---
# <a name="glpixelstorei-function"></a>Funzione glPixelStorei
...
Nome simbolico del parametro da impostare. Sei dei parametri di archiviazione influiscono sul modo in cui i dati pixel vengono restituiti alla memoria client e pertanto sono significativi solo per [**i comandi glReadPixels.**](glreadpixels.md) Sono i seguenti.
...
La [**funzione glPixelStoref**](glpixelstoref.md) può essere usata per impostare qualsiasi parametro dell'archivio pixel. Se il tipo di parametro è booleano e *se param* è 0,0, il parametro è false. in caso contrario, è impostato su true. Se *pname* è un parametro di tipo Integer, *il parametro* viene arrotondato all'intero più vicino.
