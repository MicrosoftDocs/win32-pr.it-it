...
---
# <a name="glevalcoord1d-function"></a>glEvalCoord1d (funzione)

La funzione **glEvalCoord1d** valuta i mapping unidimensionali abilitati.
...
La funzione **glEvalCoord1d** valuta le mappe unidimensionali abilitate all'argomento *u*. Definire Maps con [**glMap1**](glmap1.md). Abilitarli o disabilitarli con [**glEnable**](glenable.md) e [**glDisable**](gldisable.md).
...
Le funzioni seguenti consentono di recuperare informazioni correlate alla funzione **glEvalCoord1d** :
