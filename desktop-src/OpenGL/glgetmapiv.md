...
---
# <a name="glgetmapiv-function"></a>glGetMapiv (funzione)

Le funzioni [**glGetMapdv**](glgetmapdv.md), [**glGetMapfv**](glgetmapfv.md)e **glGetMapiv** restituiscono parametri di valutazione.
...
Le funzioni **glGetMap** restituiscono parametri di valutazione. Le funzioni **glMap1** e **glMap2** definiscono gli analizzatori. Il parametro *target* specifica una mappa, *query* seleziona un parametro specifico e *v* punta alla risorsa di archiviazione in cui verranno restituiti i valori.
