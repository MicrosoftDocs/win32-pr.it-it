...
---
# <a name="glnormal3b-function"></a>glNormal3b (funzione)
...
Il normale corrente viene impostato sulle coordinate specificate ogni volta che si chiama la funzione **glNormal3b** .
