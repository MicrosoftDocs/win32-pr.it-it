...
---
# <a name="an-x-window-system-opengl-program"></a>Programma OpenGL del sistema X Window

Il programma seguente è un programma OpenGL del sistema X Window con lo stesso codice OpenGL usato in AUXEDEMO. Programma di esempio C fornito con Microsoft Platform SDK. Confrontare il programma con il programma Windows OpenGL nel [programma trasferito a Windows](the-program-ported-to-win32.md).
