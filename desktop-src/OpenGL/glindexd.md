...
ms.locfileid: "118359637"
---
# <a name="glindexd-function"></a>Funzione glIndexd
...
La **funzione glIndexd** aggiorna l'indice dei colori corrente (a valore singolo). Accetta un argomento: il nuovo valore per l'indice colori corrente.
...
L'indice corrente può essere aggiornato in qualsiasi momento. In particolare, **glIndexd** può essere chiamato tra una chiamata a [**glBegin**](/windows/desktop/OpenGL/glbegin) e la chiamata corrispondente a [**glEnd**](glend.md).
