...
description: Specifica la posizione raster per le operazioni in pixel. | Funzione glRasterPos4dv (Gl.h)
...
ms.locfileid: "117795062"
---
# <a name="glrasterpos4dv-function"></a>Funzione glRasterPos4dv
