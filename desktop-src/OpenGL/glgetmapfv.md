...
---
# <a name="glgetmapfv-function"></a>glGetMapfv (funzione)

Le funzioni [**glGetMapdv**](glgetmapdv.md), **glGetMapfv** e [**glGetMapiv**](glgetmapiv.md) restituiscono parametri di valutazione.
