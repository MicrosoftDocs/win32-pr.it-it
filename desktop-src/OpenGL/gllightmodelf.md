...
Tutti e tre i contributi delle sorgenti di luce vengono attenuati in modo uniforme in base alla distanza dal vertice alla sorgente di luce e alla direzione della sorgente di luce, all'esponente diffusione e all'angolo di taglio della diffusione. Tutti i prodotti punto vengono sostituiti con zero se restituiscono un valore negativo.
