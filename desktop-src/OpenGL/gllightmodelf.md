...
---
# <a name="gllightmodelf-function"></a>glLightModelf (funzione)
...
La funzione **glLightModelf** imposta il parametro del modello di illuminazione. Il parametro *pname* denomina un parametro e *param* fornisce il nuovo valore. il valore o i valori dei singoli parametri della sorgente di luce.
...
Le funzioni seguenti consentono di recuperare informazioni correlate alla funzione **glLightModelf** :
