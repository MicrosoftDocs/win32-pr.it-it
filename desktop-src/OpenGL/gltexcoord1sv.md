...
description: Imposta le coordinate della trama corrente. | Funzione glTexCoord1sv (Gl.h)
...
ms.locfileid: "119491311"
---
# <a name="gltexcoord1sv-function"></a>Funzione glTexCoord1sv
