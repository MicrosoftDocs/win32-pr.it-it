...
---
# <a name="opening-a-simple-device-by-using-the-device-name"></a><span data-ttu-id="974e6-104">Apertura di un dispositivo semplice con il nome del dispositivo</span><span class="sxs-lookup"><span data-stu-id="974e6-104">Opening a Simple Device by Using the Device Name</span></span>

<span data-ttu-id="974e6-105">Nell'esempio seguente viene aperto un dispositivo audio CD specificando il nome del dispositivo mediante la funzione [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="974e6-105">The following example opens a CD audio device by specifying the device name using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
