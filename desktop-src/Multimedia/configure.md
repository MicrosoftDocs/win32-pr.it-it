...
---
# <a name="configure-command"></a>Configura comando

Il comando Configura Visualizza una finestra di dialogo usata per configurare il dispositivo. I dispositivi digitali video riconoscono questo comando.
