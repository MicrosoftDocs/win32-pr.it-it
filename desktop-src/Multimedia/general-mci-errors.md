...
- informazioni di riferimento multimediali, errori MCI
...
- Informazioni di riferimento su MCI, errori generali
...
| MCIERR \_ NON PUÒ CARICARE IL \_ \_ DRIVER     | Il driver di dispositivo specificato non verrà caricato correttamente.                                                                                                         |
| MCIERR \_ NON PUÒ USARE \_ \_ TUTTI         | Il nome del dispositivo "all" non è consentito per questo comando.                                                                                                      |
...
| DISPOSITIVO MCIERR \_ \_ BLOCCATO           | Il dispositivo è ora in fase di chiusura. Attendere alcuni secondi, quindi riprovare.                                                                                         |
| DISPOSITIVO MCIERR \_ \_ NON \_ INSTALLATO   | Il dispositivo specificato non è installato nel sistema. Usare l'opzione Driver dal Pannello di controllo per installare il dispositivo.                                   |
...
| \_ALIAS DUPLICATO DI MCIERR \_         | L'alias specificato è già usato in questa applicazione. Usare un alias univoco.                                                                                |
...
| CARATTERI AGGIUNTIVI \_ DI MCIERR \_        | È necessario racchiudere una stringa tra virgolette. I caratteri che segue le virgolette di chiusura non sono validi.                                              |
...
| FILE MCIERR \_ \_ NON \_ SALVATO         | Il file non è stato salvato. Assicurarsi che lo spazio su disco del sistema sia sufficiente o che la connessione di rete sia intatta.                                                |
| MCIERR \_ FILE \_ READ               | Una lettura dal file non è riuscita. Assicurarsi che il file sia presente nel sistema o che il sistema abbia una connessione di rete intatta.                             |
| MCIERR \_ FILE \_ WRITE              | Impossibile scrivere nel file. Assicurarsi che lo spazio su disco del sistema sia sufficiente o che la connessione di rete sia intatta.                                            |
| NOME FILE MCIERR \_ \_ OBBLIGATORIO       | Il nome file non è valido. Assicurarsi che il nome file non sia più lungo di otto caratteri, seguito da un punto e da un'estensione.                                  |
...
| MCIERR \_ NON VALIDO PER \_ \_ L'APERTURA \_ AUTOMATICA | MCI non eseguirà il comando specificato in un dispositivo aperto automaticamente. Attendere la chiusura del dispositivo, quindi provare a eseguire il comando .             |
...
| MCIERR \_ NOME DISPOSITIVO NON \_ \_ VALIDO    | Il dispositivo specificato non è aperto né riconosciuto da MCI.                                                                                                     |
| FILE MCIERR \_ NON \_ VALIDO            | Il file specificato non può essere riprodotto nel dispositivo MCI specificato. Il file potrebbe essere danneggiato o potrebbe usare un formato di file non corretto.                               |
| PARAMETRO MCIERR \_ \_ MANCANTE       | Il comando specificato richiede un parametro, che è necessario fornire.                                                                                          |
