...
---
# <a name="mciwndm_setactivetimer-message"></a>\_Messaggio MCIWNDM SETACTIVETIMER
...
Periodo di aggiornamento, in millisecondi. Il valore predefinito è 500 millisecondi.
