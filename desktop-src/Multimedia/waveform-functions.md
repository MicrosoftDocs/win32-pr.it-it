---
title: Funzioni di forma d'onda
description: Funzioni di forma d'onda
ms.assetid: 6c8aaa54-0477-484f-91e1-d2152aa9c185
keywords:
- audio multimediale, funzioni di forma d'onda
- audio, funzioni di forma d'onda
- audio Waveform, funzioni
- riferimento audio Waveform, funzioni
- informazioni di riferimento sull'audio wavefore, funzioni
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104046739"
---
# <a name="waveform-functions"></a>Funzioni di forma d'onda

Le funzioni seguenti vengono usate con l'audio della forma d'onda.
