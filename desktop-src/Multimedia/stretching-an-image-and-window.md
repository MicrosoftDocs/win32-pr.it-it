...
---
# <a name="stretching-an-image-and-window"></a>Estensione di un'immagine e di una finestra

Nell'esempio seguente si estendono le immagini di un clip video e si modificano le proporzioni dei frame visualizzati. I frame visualizzati nella finestra MCIWnd sono due volte l'altezza e tre volte la larghezza del frame originale. Le macro [**MCIWndGetDest**](/windows/desktop/api/Vfw/nf-vfw-mciwndgetdest) e [**MCIWndPutDest**](/windows/desktop/api/Vfw/nf-vfw-mciwndputdest) recuperano e ridefiniscono le coordinate del rettangolo di destinazione. Le funzioni [GetWindowRect](/windows/win32/api/winuser/nf-winuser-getwindowrect) e [SetWindowPos](/windows/win32/api/winuser/nf-winuser-setwindowpos) gestiscono le modifiche apportate alle dimensioni della finestra MCIWnd.
