...
description: Il comando MCI UNDO inverte il comando \_ MCI \_ CUT, MCI \_ COPY, MCI \_ DELETE o MCI PASTE riuscito \_ più recente. I dispositivi video digitali riconoscono questo comando.
...
ms.locfileid: "119784183"
---
# <a name="mci_undo-command"></a>Comando MCI \_ UNDO

Il comando MCI UNDO inverte il comando \_ [MCI \_ CUT,](mci-cut.md) [MCI \_ COPY,](mci-copy.md) [MCI \_ DELETE](mci-delete.md)o [MCI \_ PASTE](mci-paste.md) riuscito più recente. I dispositivi video digitali riconoscono questo comando.
