...
---
# <a name="performing-file-io-on-riff-files"></a><span data-ttu-id="64d6e-112">Esecuzione di operazioni di I/O di file in file RIFF</span><span class="sxs-lookup"><span data-stu-id="64d6e-112">Performing File I/O on RIFF Files</span></span>

<span data-ttu-id="64d6e-113">Nell'esempio seguente viene illustrato come aprire un file RIFF per I/O memorizzato nel buffer, nonché come descendre, ascendere e leggere I blocchi "RIFF".</span><span class="sxs-lookup"><span data-stu-id="64d6e-113">The following example shows how to open a RIFF file for buffered I/O, as well as how to descend, ascend, and read "RIFF" chunks.</span></span>
