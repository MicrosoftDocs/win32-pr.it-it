...
---
# <a name="resume-command"></a>Resume (comando)

Il comando Resume continua la riproduzione o la registrazione in un dispositivo che è stato sospeso usando il comando [pause](pause.md) . Digital-video, VCR e waveform-i dispositivi audio riconoscono questo comando. Anche se i dispositivi CD audio, MIDI sequencer e videodisco riconoscono questo comando, i driver di dispositivo MCICDA, MCISEQ e MCIPIONR non lo supportano.
...
Il seguente comando continua la riproduzione o la registrazione del dispositivo "Newsound".
