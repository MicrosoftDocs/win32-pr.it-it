...
Nell'esempio seguente viene connessa la finestra di acquisizione con l'handle *hWndC* al driver msvideo e quindi le si disconnette utilizzando la macro [**capDriverDisconnect**](/windows/desktop/api/Vfw/nf-vfw-capdriverdisconnect) :
