...
---
# <a name="mci_play_parms-structure"></a>\_Struttura parametri della riproduzione MCI \_

La **struttura \_ \_ parametri di MCI Play** contiene informazioni sul posizionamento del comando [**MCI \_ Play**](mci-play.md) .
