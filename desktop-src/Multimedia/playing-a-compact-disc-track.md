...
---
# <a name="playing-a-compact-disc-track"></a>Riproduzione di una traccia Compact Disc

Nell'esempio seguente viene aperto un dispositivo audio CD, viene riprodotta la traccia specificata dal parametro *bTrack* e il dispositivo viene chiuso al termine della riproduzione. Usa la funzione [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .
...
Per specificare una posizione relativa a una traccia in un disco Compact, è necessario usare il formato di ora Track/minute/second/frame (TMSF).
