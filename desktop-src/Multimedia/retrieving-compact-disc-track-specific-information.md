...
---
# <a name="retrieving-compact-disc-track-specific-information"></a>Recupero delle informazioni Track-Specific Compact Disc

Per i dispositivi audio CD è possibile ottenere la posizione iniziale e la lunghezza di una traccia specificando il \_ flag di traccia MCI e impostando il membro **dwTrack** dello [**\_ stato MCI \_ parametri**](mci-status-parms.md) sul numero di traccia desiderato. Per ottenere la posizione iniziale di una traccia, impostare il membro **dwItem** sulla \_ posizione di stato MCI \_ . Per ottenere la lunghezza di una traccia, impostare **dwItem** su MCI \_ status \_ length. Ad esempio, nell'esempio seguente viene recuperato il numero totale di tracce nel Compact Disc e la posizione iniziale di ogni traccia. USA quindi la funzione [MessageBox](/windows/win32/api/winuser/nf-winuser-messagebox) per segnalare i percorsi iniziali delle tracce.
