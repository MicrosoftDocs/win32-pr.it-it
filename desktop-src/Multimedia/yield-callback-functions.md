...
Le applicazioni possono usare funzioni di callback yield durante l'acquisizione del flusso. Una funzione di callback yield è in genere costituita da un ciclo di messaggi che chiama [PeekMessage,](/windows/win32/api/winuser/nf-winuser-peekmessagea) [TranslateMessage](/windows/win32/api/winuser/nf-winuser-translatemessage)e [DispatchMessage.](/windows/win32/api/winuser/nf-winuser-dispatchmessage) La finestra di acquisizione chiama la funzione di callback yield almeno una volta per ogni fotogramma video acquisito, ma la frequenza esatta dipende dalla frequenza dei fotogrammi e dall'overhead del driver e del disco di acquisizione.
