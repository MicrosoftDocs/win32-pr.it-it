...
<span id="base.vssgloss_hidden_shadow_copy"></span><span id="BASE.VSSGLOSS_HIDDEN_SHADOW_COPY"></span>**copia shadow nascosta**
</dt> <dd>

Un volume nascosto, ovvero un volume non montato e non esposto nello spazio dei nomi Windows come lettera di unità o cartella montata.
