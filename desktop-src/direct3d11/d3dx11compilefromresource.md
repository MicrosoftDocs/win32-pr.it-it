...
ms.locfileid: "118536765"
---
# <a name="d3dx11compilefromresource-function"></a>Funzione D3DX11CompileFromResource
...
Inoltre, se si specifica un valore non **NULL** a *pHResult* quando si specifica **NULL** a *pPump,* **D3DX11CompileFromResource** restituisce il codice di errore E \_ INVALIDARG.
