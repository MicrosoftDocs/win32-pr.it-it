...
Ottenere un puntatore a un'interfaccia di stato di Blend.
...
Indirizzo di un puntatore a un'interfaccia di stato di Blend (vedere [**ID3D11BlendState**](/windows/desktop/api/D3D11/nn-d3d11-id3d11blendstate)).
