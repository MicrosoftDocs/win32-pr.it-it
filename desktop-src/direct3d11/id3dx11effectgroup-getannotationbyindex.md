...
---
# <a name="id3dx11effectgroupgetannotationbyindex-method"></a>Metodo ID3DX11EffectGroup:: GetAnnotationByIndex
...
Puntatore a un'interfaccia [**ID3DX11EffectVariable**](id3dx11effectvariable.md) .
