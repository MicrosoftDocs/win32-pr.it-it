...
Le risorse affiancate disaccontivano un oggetto risorsa D3D dalla memoria di backup (le risorse in passato avevano una relazione 1:1 con la memoria di backup). Ciò consente un'ampia gamma di scenari interessanti, ad esempio lo streaming dei dati di trama e il riutilizzo o la riduzione dell'utilizzo della memoria
...
Si noti che i formati seguenti non sono supportati con le risorse affiancate: formati 96bpp, formati video, R1 \_ UNORM, \_ R8G8 B8G8 \_ UNORM, R8R8 \_ G8B8 \_ UNORM.

Nei diagrammi sottostanti il grigio scuro rappresenta riquadri NULL.

-   [Mapping predefinito della risorsa affiancata 3D con trama (mip più dettagliato)](#texture-3d-tiled-resource-default-mapping-most-detailed-mip)
-   [Mapping predefinito della risorsa affiancata 3D (secondo mip più dettagliato)](#texture-3d-tiled-resource-default-mapping-second-most-detailed-mip)
-   [Trama 3D Tiled Resource (mip più dettagliato)](#texture-3d-tiled-resource-most-detailed-mip)
-   [Trama 3D Tiled Resource (secondo mip più dettagliato)](#texture-3d-tiled-resource-second-most-detailed-mip)
-   [Risorsa affiancata 3D con trama (riquadro singolo)](#texture-3d-tiled-resource-single-tile)
-   [Trama 3D Tiled Resource (Uniform Box)](#texture-3d-tiled-resource-uniform-box)

### <a name="texture-3d-tiled-resource-default-mapping-most-detailed-mip"></a>Mapping predefinito della risorsa affiancata 3D con trama (mip più dettagliato)

![mapping predefinito del mip più dettagliato](images/vtr-tex3d-default-1.png)

### <a name="texture-3d-tiled-resource-default-mapping-second-most-detailed-mip"></a>Mapping predefinito della risorsa affiancata 3D (secondo mip più dettagliato)

![mapping predefinito del secondo mip più dettagliato](images/vtr-tex3d-default-2.png)

### <a name="texture-3d-tiled-resource-most-detailed-mip"></a>Trama 3D Tiled Resource (mip più dettagliato)
...
### <a name="texture-3d-tiled-resource-second-most-detailed-mip"></a>Trama 3D Tiled Resource (secondo mip più dettagliato)
...
### <a name="texture-3d-tiled-resource-single-tile"></a>Risorsa affiancata 3D con trama (riquadro singolo)
...
![una scatola uniforme](images/vtr-tex3d-uniform.png)
...
-   [**D3D11 \_ TILED \_ RESOURCE \_ COORDINATE**](/windows/desktop/api/D3D11_2/ns-d3d11_2-d3d11_tiled_resource_coordinate) : contiene il riferimento alle coordinate x, y e z e alle sottorisorse. Si noti che è presente una classe helper: CD3D11 \_ TILED \_ RESOURCE \_ COORDINATE.
