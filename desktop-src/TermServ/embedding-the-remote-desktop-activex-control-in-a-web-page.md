...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="f3da3-103">Incorporamento del controllo ActiveX Desktop remoto in una pagina Web</span><span class="sxs-lookup"><span data-stu-id="f3da3-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="f3da3-104">È possibile incorporare il controllo ActiveX Desktop remoto in una pagina Web utilizzando codice simile al seguente.</span><span class="sxs-lookup"><span data-stu-id="f3da3-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="f3da3-105">Il CLSID è per il controllo ActiveX ospitato da Connessione Desktop remoto (RDP) 6,0.</span><span class="sxs-lookup"><span data-stu-id="f3da3-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="f3da3-106">Questo controllo ActiveX implementa [**IMsRdpClient**](imsrdpclient-interface.md).</span><span class="sxs-lookup"><span data-stu-id="f3da3-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="f3da3-107">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="f3da3-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f3da3-108">Uso del controllo ActiveX Desktop remoto</span><span class="sxs-lookup"><span data-stu-id="f3da3-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
