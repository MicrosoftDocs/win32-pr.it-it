...
description: Controllo client MICROSOFT RDP (ridistribuibile) - versione 5a.
...
ms.locfileid: "117756553"
---
# <a name="msrdpclient4a-class"></a>Classe MsRdpClient4a

Controllo client MICROSOFT RDP (ridistribuibile) - versione 5a
...
**MsRdpClient4a** ha questi tipi di membri:
...
La **classe MsRdpClient4a** include questi metodi.
...
La **classe MsRdpClient4a** ha queste proprietà.
