...
Controllo client RDP Microsoft (ridistribuibile)-versione 7
...
**MsRdpClient6** dispone di questi tipi di membri:
...
La classe **MsRdpClient6** dispone di questi metodi.
...
La classe **MsRdpClient6** dispone di queste proprietà.
