...
description: Controllo client MICROSOFT RDP (ridistribuibile) - versione 11.
ms.assetid: 9D0F2312-0D85-402D-874D-9FA477435210
ms.tgt_platform: multiple
keywords:
- Classe MsRdpClient10 Servizi Desktop remoto
- Classe MsRdpClient10 Servizi Desktop remoto , descritto
topic_type:
- apiref
api_name:
- MsRdpClient10
...
ms.locfileid: "119989021"
---
# <a name="msrdpclient10-class"></a>Classe MsRdpClient10

Controllo client MICROSOFT RDP (ridistribuibile) - versione 11
...
**MsRdpClient10** ha questi tipi di membri:
...
La **classe MsRdpClient10** include questi metodi.
...
<td style="text-align: left;">Sola scrittura<br/></td>
<td style="text-align: left;">Specifica se il controllo Desktop remoto ActiveX deve disabilitare la barra di connessione.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Sola lettura<br/></td>
<td style="text-align: left;">Specifica il rettangolo di delimitazione del monitoraggio remoto.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Lettura/Scrittura<br/></td>
<td style="text-align: left;">Specifica se deve essere visualizzata la finestra di dialogo Richiedi credenziali.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Lettura/Scrittura<br/></td>
<td style="text-align: left;">Specifica se il controllo client visualizza una finestra di dialogo che richiede le credenziali.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Lettura/Scrittura<br/></td>
<td style="text-align: left;">Specifica se le unità PnP collegate in modo dinamico enumerate durante una sessione sono disponibili per il reindirizzamento.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Sola lettura<br/></td>
<td style="text-align: left;">Specifica se il layout del monitoraggio remoto è identico al layout del monitor locale.<br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><a href="imsrdpclient5-remoteprogram.md"><strong>RemoteProgram</strong></a><br/></td>
<td style="text-align: left;">Sola lettura<br/></td>
<td style="text-align: left;">Impostazione remoteApp client.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Lettura/Scrittura<br/></td>
<td style="text-align: left;">Handle di finestra che deve essere la finestra padre per il controllo . In questo modo tutte le finestre visualizzate dal controllo possono essere modali correttamente rispetto alle finestre visualizzate dall'applicazione padre.<br/></td>
</tr>
<tr class="odd">
