---
title: Esempio di modulo server DVC
description: Esempio di codice C++ che Mostra come creare il modulo canale virtuale dinamico lato server (DVC).
...
ms.locfileid: "104221327"
---
# <a name="dvc-server-module-example"></a><span data-ttu-id="6e932-103">Esempio di modulo server DVC</span><span class="sxs-lookup"><span data-stu-id="6e932-103">DVC Server Module Example</span></span>

<span data-ttu-id="6e932-104">Nell'esempio di codice C++ riportato di seguito viene fornito un esempio di creazione del modulo canale virtuale dinamico (DVC) sul lato server.</span><span class="sxs-lookup"><span data-stu-id="6e932-104">The following C++ code sample provides an example of how to create the server-side dynamic virtual channel (DVC) module.</span></span>
