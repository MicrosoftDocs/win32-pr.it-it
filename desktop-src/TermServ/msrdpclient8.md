...
Controllo client RDP Microsoft (ridistribuibile)-versione 9
...
**MsRdpClient8** dispone di questi tipi di membri:
...
La classe **MsRdpClient8** dispone di questi metodi.
...
La classe **MsRdpClient8** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient8 è definito come 5F681803-2900-4C43-A1CC-CF405404A676<br/>      |
