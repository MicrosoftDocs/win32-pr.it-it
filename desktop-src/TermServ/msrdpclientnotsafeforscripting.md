...
ms.locfileid: "119866151"
---
# <a name="msrdpclientnotsafeforscripting-class"></a>Classe MsRdpClientNotSafeForScripting

Controllo client MICROSOFT RDP - versione 2
...
**MsRdpClientNotSafeForScripting** include questi tipi di membri:
...
La **classe MsRdpClientNotSafeForScripting** include questi metodi.
...
La **classe MsRdpClientNotSafeForScripting** dispone di queste proprietà.
...
| [**Connessione di testo**](imstscax-connectingtext.md)<br/>                         | Lettura/Scrittura<br/> | Testo visualizzato al centro nel controllo mentre il controllo è connesso.<br/>                                                                                 |
...
| [**SecuredSettings**](imstscax-securedsettings.md)<br/>                       | Sola lettura<br/>  | Puntatore [**a interfaccia IMsTscSecuredSettings.**](imstscsecuredsettings-interface.md)<br/>                                                                          |
...
| CLSID<br/>                    | CLSID \_ MsRdpClientNotSafeForScripting è definito come 7CACBD7B-0D99-468F-AC33-22E495C0AFE5<br/> |
