...
Controllo client RDP Microsoft-versione 2
...
**MsRdpClientNotSafeForScripting** dispone di questi tipi di membri:
...
La classe **MsRdpClientNotSafeForScripting** dispone di questi metodi.
