...
Espone metodi che consentono ai plug-in di risorse di archiviare oggetti quali sessioni e destinazioni. Questi metodi aggiungono, eliminano ed esere query su questi oggetti.
...
| [**AddSessionToStore**](/windows/desktop/api/sbtsv/nf-sbtsv-itssbresourcepluginstore-addsessiontostore)                                           | Aggiunge una nuova sessione all'archivio plug-in delle risorse.<br/>                                                    |
...
| [**EnumerateFarms**](/windows/desktop/api/sbtsv/nf-sbtsv-itssbresourcepluginstore-enumeratefarms)                                                 | Enumera tutte le farm aggiunte all'archivio plug-in delle risorse.<br/>                         |
...
| [**EnumerateTargets**](/windows/desktop/api/sbtsv/nf-sbtsv-itssbresourcepluginstore-enumeratetargets)                                             | Restituisce una matrice contenente le destinazioni specificate presenti nell'archivio plug-in delle risorse.<br/> |
...
| [**RemoveEnvironmentFromStore**](/windows/desktop/api/sbtsv/nf-sbtsv-itssbresourcepluginstore-removeenvironmentfromstore)                         | Rimuove l'ambiente specificato dall'archivio plug-in delle risorse.<br/>                                   |
...
[Desktop remoto interfacce di virtualizzazione](remote-desktop-virtualization-interfaces.md)
</dt> </dl>
