...
Controllo client RDP Microsoft (ridistribuibile)-versione 6
...
**MsRdpClient5** dispone di questi tipi di membri:
...
La classe **MsRdpClient5** dispone di questi metodi.
...
La classe **MsRdpClient5** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient5 è definito come 4EB89FF4-7F78-4A0F-8B8D-2BF02E94E4B2<br/>      |
