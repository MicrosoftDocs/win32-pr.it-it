...
description: Controllo client MICROSOFT RDP (ridistribuibile) - versione 6.
ms.assetid: 30DC49A8-A9B1-4F74-B578-5761FA0C1315
ms.tgt_platform: multiple
keywords:
- Classe MsRdpClient5 Servizi Desktop remoto
- Classe MsRdpClient5 Servizi Desktop remoto , descritto
topic_type:
- apiref
api_name:
- MsRdpClient5
...
ms.locfileid: "122473377"
---
# <a name="msrdpclient5-class"></a>Classe MsRdpClient5

Controllo client MICROSOFT RDP (ridistribuibile) - versione 6
...
**MsRdpClient5** ha questi tipi di membri:
...
| CLSID<br/>                    | CLSID MsRdpClient5 è definito come \_ 4EB89FF4-7F78-4A0F-8B8D-2BF02E94E4B2<br/>      |
