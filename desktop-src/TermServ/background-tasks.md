...
Le attività in background, ovvero le attività eseguite quando il ciclo di messaggi di un'applicazione è inattivo, forniscono un meccanismo per la gestione delle attività con priorità bassa in un ambiente a utente singolo. In un Servizi Desktop remoto, tuttavia, l'attività in background di un utente è in competizione per i cicli della CPU con le attività in primo piano di un altro utente. Quando più utenti eseguono attività in primo piano e in background, le richieste di CPU sono molto più elevate rispetto a quando tutti gli utenti eseguono solo attività in primo piano. Per ottimizzare la disponibilità della CPU per tutti gli utenti, disabilitare le attività in background durante l'esecuzione in un ambiente Servizi Desktop remoto o creare attività in background efficienti che non richiedono un uso intensivo delle risorse.
