...
---
# <a name="win32_tsstartmenuapplication-class"></a>Win32 \_ TSStartMenuApplication (classe)

Descrive le applicazioni presenti nel menu Start di un server di host sessione Desktop remoto (host sessione Desktop remoto).
...
La classe **Win32 \_ TSStartMenuApplication** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ TSStartMenuApplication** dispone di queste proprietà.
...
Argomenti della riga di comando da utilizzare.
...
Percorso virtuale dell'applicazione. Sono incluse le variabili di ambiente di sistema, ad esempio% windir%.
