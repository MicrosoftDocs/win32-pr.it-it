...
---
# <a name="msrdpclient4notsafeforscripting-class"></a>Classe MsRdpClient4NotSafeForScripting
...
**MsRdpClient4NotSafeForScripting** dispone di questi tipi di membri:
...
La classe **MsRdpClient4NotSafeForScripting** dispone di queste proprietà.
...
| [**AdvancedSettings6**](imsrdpclient5-advancedsettings6.md)<br/>                    | Sola lettura<br/>  | Interfaccia per [**IMsRdpClientAdvancedSettings5**](imsrdpclientadvancedsettings5.md).<br/>                                                                                                          |
...
| [**RemoteProgram**](imsrdpclient5-remoteprogram.md)<br/>                            | Sola lettura<br/>  | Impostazione RemoteApp del client.<br/>                                                                                                                                                                     |
...
| [**TransportSettings**](imsrdpclient5-transportsettings.md)<br/>                    | Sola lettura<br/>  | Impostazione del Gateway Desktop remoto del client.<br/>                                                                                                                                                                    |
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4NotSafeForScripting è definito come 6AE29350-321B-42BE-BBE5-12FB5270C0DE<br/> |
