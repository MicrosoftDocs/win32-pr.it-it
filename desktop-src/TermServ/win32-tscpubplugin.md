...
---
# <a name="win32_tscpubplugin-class"></a>Win32 \_ TSCPubPlugin (classe)

Rappresenta un plug-in configurato per l'utilizzo tramite il servizio Servizio di gestione Connessione RemoteApp e desktop.
...
La classe **Win32 \_ TSCPubPlugin** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **Win32 \_ TSCPubPlugin** dispone di queste proprietà.
...
Specifica se il plug-in è abilitato.
