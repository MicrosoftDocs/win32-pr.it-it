...
description: Controllo client di Servizi terminal Microsoft (ridistribuibile) - versione 1.
ms.assetid: 8B8FEF40-89A5-47C0-94EE-4F4B2B5738AB
ms.tgt_platform: multiple
keywords:
- Classe MsTscAx Servizi Desktop remoto
- Classe MsTscAx Servizi Desktop remoto , descritto
topic_type:
- apiref
api_name:
- MsTscAx
...
ms.locfileid: "117756344"
---
# <a name="mstscax-class"></a>Classe MsTscAx

Controllo client di Servizi terminal Microsoft (ridistribuibile) - versione 1
...
**MsTscAx** ha questi tipi di membri:
...
La **classe MsTscAx** include questi metodi.
...
| CLSID<br/>                    | CLSID MsTscAx è definito come \_ 1FB464C8-09BB-4017-A2F5-EB742F04392F<br/>           |
