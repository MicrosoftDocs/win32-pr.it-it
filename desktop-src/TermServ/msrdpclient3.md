...
ms.locfileid: "119866321"
---
# <a name="msrdpclient3-class"></a>Classe MsRdpClient3

Controllo client MICROSOFT RDP (ridistribuibile) - versione 4
...
**MsRdpClient3** include questi tipi di membri:
...
La **classe MsRdpClient3** include questi metodi.
...
La **classe MsRdpClient3** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient3 è definito come 7584C670-2274-4EFB-B00B-D6AABA6D3850<br/>      |
