...
---
# <a name="setsecureidallowed-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Metodo SetSecureIdAllowed della \_ classe TSGatewayConnectionAuthorizationPolicy Win32

Questo metodo è riservato per utilizzi futuri.

Imposta la proprietà **SecureIdAllowed** , riservata per un utilizzo futuro.
...
Nuovo valore di **SecureIdAllowed** .
