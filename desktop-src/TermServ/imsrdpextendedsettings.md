---
title: Interfaccia IMsRdpExtendedSettings
description: Utilizzato per impostare e recuperare le proprietà denominate per il controllo client.
...
|:---------------------------------------------------------------|:----------------------|:--------------------------------------|
| [**Proprietà**](imsrdpextendedsettings-property.md)<br/> | Lettura/Scrittura<br/> | Contiene una proprietà denominata.<br/> |
