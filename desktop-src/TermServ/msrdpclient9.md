...
**MsRdpClient9 ha** questi tipi di membri:
...
La **classe MsRdpClient9** include questi metodi.
...
La **classe MsRdpClient9** ha queste proprietà.
...
| <a href="imsrdpclientnonscriptable5-disableremoteappcapscheck.md"><strong>DisableRemoteAppCapsCheck</strong></a><br /> | Lettura/Scrittura<br /> | Specifica se il controllo Desktop remoto ActiveX controllo non deve controllare le funzionalità di RemoteApp nel server.<br /> | 
