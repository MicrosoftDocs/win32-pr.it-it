...
---
# <a name="msrdpclient9-class"></a>Classe MsRdpClient9

Controllo client RDP Microsoft (ridistribuibile)-versione 10
...
**MsRdpClient9** dispone di questi tipi di membri:
...
La classe **MsRdpClient9** dispone di questi metodi.
...
La classe **MsRdpClient9** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient9 è definito come 301B94BA-5D25-4A12-BFFE-3B6E7A616585<br/>      |
