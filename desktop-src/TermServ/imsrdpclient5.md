...
L'interfaccia **IMsRdpClient5** eredita da [**IMsRdpClient4**](imsrdpclient4.md). **IMsRdpClient5** dispone anche di questi tipi di membri:
...
L'interfaccia **IMsRdpClient5** dispone di questi metodi.
...
L'interfaccia **IMsRdpClient5** ha queste proprietà.
...
L'interfaccia **IMsRdpClient5** è stata estesa dalle interfacce seguenti, in cui ogni nuova interfaccia eredita tutti i metodi e le proprietà delle interfacce precedenti:
