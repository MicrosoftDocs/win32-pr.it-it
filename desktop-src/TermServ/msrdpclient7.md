...
description: Controllo client MICROSOFT RDP (ridistribuibile) - versione 8.
ms.assetid: DC401CD5-7C54-43C9-937E-17D3367472AB
ms.tgt_platform: multiple
keywords:
- Classe MsRdpClient7 Servizi Desktop remoto
- Classe MsRdpClient7 Servizi Desktop remoto , descritto
topic_type:
- apiref
api_name:
- MsRdpClient7
...
ms.locfileid: "117756597"
---
# <a name="msrdpclient7-class"></a>Classe MsRdpClient7

Controllo client MICROSOFT RDP (ridistribuibile) - versione 8
...
**MsRdpClient7** ha questi tipi di membri:
...
La **classe MsRdpClient7** ha queste proprietà.
