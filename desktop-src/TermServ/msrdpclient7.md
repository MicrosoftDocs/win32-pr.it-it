...
---
# <a name="msrdpclient7-class"></a>Classe MsRdpClient7

Controllo client RDP Microsoft (ridistribuibile)-versione 8
...
**MsRdpClient7** dispone di questi tipi di membri:
...
La classe **MsRdpClient7** dispone di questi metodi.
...
La classe **MsRdpClient7** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient7 è definito come A9D7038D-B5ED-472E-9C47-94BEA90A5910<br/>      |
