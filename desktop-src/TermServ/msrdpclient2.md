...
description: Controllo client MICROSOFT RDP (ridistribuibile) - versione 3.
...
ms.locfileid: "119138084"
---
# <a name="msrdpclient2-class"></a>Classe MsRdpClient2

Controllo client MICROSOFT RDP (ridistribuibile) - versione 3
...
**MsRdpClient2** ha questi tipi di membri:
...
La **classe MsRdpClient2** dispone di questi metodi.
...
La **classe MsRdpClient2** dispone di queste proprietà.
...
| CLSID<br/>                    | CLSID MsRdpClient2 è definito come \_ 9059F30F-4EB1-4BD2-9FDC-36F43A218F4A<br/>      |
