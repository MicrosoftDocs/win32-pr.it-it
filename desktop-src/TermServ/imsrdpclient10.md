...
L'interfaccia **IMsRdpClient10** eredita da [**IMsRdpClient9**](imsrdpclient9.md). **IMsRdpClient10** dispone anche di questi tipi di membri:
...
L'interfaccia **IMsRdpClient10** dispone di questi metodi.
...
L'interfaccia **IMsRdpClient10** ha queste proprietà.
