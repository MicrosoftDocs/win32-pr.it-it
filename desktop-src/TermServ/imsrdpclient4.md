...
L'interfaccia **IMsRdpClient4** eredita da [**IMsRdpClient3**](imsrdpclient3.md). **IMsRdpClient4** dispone anche di questi tipi di membri:
...
L'interfaccia **IMsRdpClient4** è stata estesa dalle interfacce seguenti, in cui ogni nuova interfaccia eredita tutti i metodi e le proprietà delle interfacce precedenti:
...
| IID<br/>                      | IID \_ IMsRdpClient4 è definito come 095E0738-D97D-488b-B9F6-DD0E8D66C0DE<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
