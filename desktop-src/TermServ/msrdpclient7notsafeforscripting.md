...
description: '\ 0034; Controllo client MICROSOFT RDP - versione 8.'
...
ms.locfileid: "122467028"
---
# <a name="msrdpclient7notsafeforscripting-class"></a>Classe MsRdpClient7NotSafeForScripting

"Controllo client RDP Microsoft - versione 8
...
**MsRdpClient7NotSafeForScripting** ha questi tipi di membri:
...
La **classe MsRdpClient7NotSafeForScripting** include questi metodi.
...
La **classe MsRdpClient7NotSafeForScripting** ha queste proprietà.
...
| <a href="imsrdpclientnonscriptable5-allowpromptingforcredentials.md"><strong>AllowPromptingForCredentials</strong></a><br /> | Lettura/Scrittura<br /> | Specifica se il controllo Desktop remoto ActiveX può richiedere all'utente le credenziali.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-disableconnectionbar.md"><strong>DisableConnectionBar</strong></a><br /> | Sola scrittura<br /> | Specifica se il controllo Desktop remoto ActiveX deve disabilitare la barra di connessione.<br /> | 
| <a href="imsrdpclientnonscriptable5-disableremoteappcapscheck.md"><strong>DisableRemoteAppCapsCheck</strong></a><br /> | Lettura/Scrittura<br /> | Specifica se il controllo Desktop remoto ActiveX controllo non deve controllare la presenza di funzionalità RemoteApp nel server.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-getremotemonitorsboundingbox.md"><strong>GetRemoteMonitorsBoundingBox</strong></a><br /> | Sola lettura<br /> | Specifica il rettangolo di delimitazione del monitoraggio remoto.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-remotemonitorlayoutmatcheslocal.md"><strong>RemoteMonitorLayoutMatchesLocal</strong></a><br /> | Sola lettura<br /> | Specifica se il layout del monitoraggio remoto è identico al layout del monitor locale.<br /> | 
...
| <a href="imsrdpclient7-transportsettings3.md"><strong>TransportSettings3</strong></a><br /> | Sola lettura<br /> | Oggetto che supporta <a href="imsrdpclienttransportsettings3.md"><strong>l'interfaccia IMsRdpClientTransportSettings3.</strong></a><br /> | 
...
| <a href="imsrdpclientnonscriptable5-usemultimon.md"><strong>UseMultimon</strong></a><br /> | Lettura/Scrittura<br /> | Specifica se il controllo Desktop remoto ActiveX deve usare più monitor.<br /> | 
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a><br /> | Lettura/Scrittura<br /> | Indica se usare il nome del server di reindirizzamento.<br /> | 
...
| CLSID<br/>                    | CLSID \_ MsRdpClient7NotSafeForScripting è definito come 54D38BF7-B1EF-4479-9674-1BD6EA465258<br/> |
