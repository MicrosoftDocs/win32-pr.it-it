...
---
# <a name="imsrdpcameraredirconfigsymboliclink-property"></a>Proprietà IMsRdpCameraRedirConfig:: SymbolicLink

Ottiene il collegamento simbolico dell'interfaccia **KSCATEGORY_VIDEO_CAMERA** per la fotocamera.
...
Collegamento simbolico dell'interfaccia **KSCATEGORY_VIDEO_CAMERA** per la fotocamera.
