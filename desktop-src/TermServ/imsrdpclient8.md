...
L'interfaccia **IMsRdpClient8** eredita da [**IMsRdpClient7**](imsrdpclient7.md). **IMsRdpClient8** dispone anche di questi tipi di membri:
...
L'interfaccia **IMsRdpClient8** dispone di questi metodi.
...
L'interfaccia **IMsRdpClient8** ha queste proprietà.
...
L'interfaccia **IMsRdpClient8** è stata estesa dalle interfacce seguenti, in cui ogni nuova interfaccia eredita tutti i metodi e le proprietà delle interfacce precedenti:
