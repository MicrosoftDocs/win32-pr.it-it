---
title: Metodo StopService della classe Win32_Service (Sdoias.h) (Terminal Service)
description: Posiziona il servizio, rappresentato dall'oggetto \_ TerminalService Win32, nello stato arrestato.
ms.assetid: 228711DC-369B-48B6-96EE-DF4026904E26
ms.tgt_platform: multiple
keywords:
- Metodo StopService Servizi Desktop remoto
- Il metodo StopService Servizi Desktop remoto , Win32_Service classe
- Win32_Service classe Servizi Desktop remoto , metodo StopService
topic_type:
- apiref
api_name:
...
Il metodo della [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **StopService** posiziona il servizio, rappresentato dall'oggetto [**\_ TerminalService Win32,**](win32-terminalservice.md) nello stato arrestato.
...
Dopo aver determinato quali servizi possono essere arrestati o sospesi, è possibile usare i **metodi StopService** e [**PauseService**](win32-terminalservice-pauseservice.md) per arrestare e sospendere i servizi. La decisione di arrestare un servizio anziché sospenderlo o viceversa dipende da diversi fattori, tra cui:
...
Se si arresta un servizio, controllare immediatamente [**\_ TerminalService Win32.**](win32-terminalservice.md)**Proprietà** State, poiché il valore può comunque mostrare il servizio come in esecuzione.
