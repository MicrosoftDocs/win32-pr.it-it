...
---
# <a name="setsessiontimeout-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Metodo SetSessionTimeout della \_ classe TSGatewayConnectionAuthorizationPolicy Win32

Imposta le proprietà **SessionTimeout** e **SessionTimeoutAction** .
...
Specifica l'azione da intraprendere in caso di timeout della sessione. Può corrispondere a uno dei valori seguenti.
