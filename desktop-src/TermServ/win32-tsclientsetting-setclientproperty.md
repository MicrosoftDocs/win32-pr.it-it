...
---
# <a name="setclientproperty-method-of-the-win32_tsclientsetting-class"></a>Metodo SetClientProperty della \_ classe TSClientSetting Win32
...
Specifica la proprietà client che il metodo sta impostando.
...
Il metodo sta impostando la proprietà **AudioMapping** .
...
Il metodo sta impostando la proprietà **ClipboardMapping** .
...
Il metodo sta impostando la proprietà **COMPortMapping** .
...
Il metodo sta impostando la proprietà **DriveMapping** .
...
Il metodo sta impostando la proprietà **LPTPortMapping** .
...
Il metodo sta impostando la proprietà **PNPRedirection** .
...
Il metodo sta impostando la proprietà **WindowsPrinterMapping** .
...
Restituisce 0 in caso di esito positivo, in caso contrario restituisce un codice di errore WMI. Per un elenco di questi valori, vedere [Servizi Desktop remoto codici di errore del provider WMI](terminal-services-wmi-provider-error-codes.md) . Il metodo restituisce un errore se la proprietà client specificata non è sotto il controllo criteri di gruppo o se l'impostazione della proprietà non è idonea per l'override da parte del server.
