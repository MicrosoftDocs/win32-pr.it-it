...
Nuova dimensione della cache. I valori validi sono compresi tra 1 e 32 inclusi. Si noti che le dimensioni massime per tutti i file della cache virtuale sono pari a 128 MB.
