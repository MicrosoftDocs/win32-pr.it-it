---
description: Gli autori di pacchetti possono monitorare i messaggi interni Windows Installer tramite la creazione di un'applicazione eseguibile che contiene sia un gestore di callback per ricevere i messaggi che la funzionalità per avviare un'installazione.
...
Gli autori di pacchetti possono monitorare i messaggi interni Windows Installer tramite la creazione di un'applicazione eseguibile che contiene sia un gestore di callback per ricevere i messaggi che la funzionalità per avviare un'installazione.
