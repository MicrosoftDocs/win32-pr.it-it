...
---
# <a name="sample-ice-in-c"></a><span data-ttu-id="399ef-106">Esempio di ghiaccio in C++</span><span class="sxs-lookup"><span data-stu-id="399ef-106">Sample ICE in C++</span></span>

<span data-ttu-id="399ef-107">Questo codice di esempio è da un'azione personalizzata ICE ( [ICE01](ice01.md)).</span><span class="sxs-lookup"><span data-stu-id="399ef-107">This sample code is from an ICE custom action ( [ICE01](ice01.md)).</span></span> <span data-ttu-id="399ef-108">Verifica che il meccanismo di ghiaccio funzioni visualizzando l'ora.</span><span class="sxs-lookup"><span data-stu-id="399ef-108">It validates that the ICE mechanism is working by displaying the time.</span></span> <span data-ttu-id="399ef-109">Il ghiaccio pubblica un messaggio che indica l'ora in cui il programma di installazione ha chiamato il ghiaccio.</span><span class="sxs-lookup"><span data-stu-id="399ef-109">The ICE posts a message giving the time the installer called the ICE.</span></span> <span data-ttu-id="399ef-110">Questo ghiaccio non dovrebbe mai restituire un errore.</span><span class="sxs-lookup"><span data-stu-id="399ef-110">This ICE should never return an error.</span></span>
