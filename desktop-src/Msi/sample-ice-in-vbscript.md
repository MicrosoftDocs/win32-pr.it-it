...
---
# <a name="sample-ice-in-vbscript"></a><span data-ttu-id="d9631-105">Esempio di ghiaccio in VBScript</span><span class="sxs-lookup"><span data-stu-id="d9631-105">Sample ICE in VBScript</span></span>

<span data-ttu-id="d9631-106">Questo codice di esempio è da un'azione personalizzata ICE ( [ICE08](ice08.md)).</span><span class="sxs-lookup"><span data-stu-id="d9631-106">This sample code is from an ICE custom action ( [ICE08](ice08.md)).</span></span> <span data-ttu-id="d9631-107">Il ghiaccio verifica che ogni componente della tabella dei [componenti](component-table.md) disponga di un [GUID](guid.md)univoco.</span><span class="sxs-lookup"><span data-stu-id="d9631-107">The ICE validates that every component in the [Component table](component-table.md) has a unique [GUID](guid.md).</span></span> <span data-ttu-id="d9631-108">Se la tabella dei componenti non esiste, non viene eseguita alcuna convalida.</span><span class="sxs-lookup"><span data-stu-id="d9631-108">No validation is done if the Component table does not exist.</span></span>
