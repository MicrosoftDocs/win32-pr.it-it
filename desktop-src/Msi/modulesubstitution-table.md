...
Per garantire la compatibilità con le versioni di Mergemod.dll precedenti alla versione 2.0, la tabella [ModuleConfiguration](moduleconfiguration-table.md) e le tabelle ModuleSubstitution devono essere incluse nella tabella [ModuleIgnoreTable](moduleignoretable-table.md) di ogni modulo.
