...
---
# <a name="moduleadvtexecutesequence-table"></a>Tabella ModuleAdvtExecuteSequence

Uno strumento di merge valuta la tabella ModuleAdvtExecuteSequence e quindi inserisce le azioni calcolate nella [tabella AdvtExecuteSequence](advtexecutesequence-table.md) con un numero di sequenza corretto.

La tabella ModuleAdvtExecuteSequence include le colonne seguenti.
...
Se questa tabella è presente, è necessario che la [tabella AdvtExecuteSequence](advtexecutesequence-table.md) sia presente anche nel modulo merge.
