---
description: Le azioni personalizzate scritte in JScript o Visual Basic, Scripting Edition (VBScript) possono chiamare una funzione facoltativa. Queste funzioni devono restituire uno dei valori illustrati nella tabella seguente.
ms.assetid: f05d0b94-e79e-440e-9f2b-99fe0e9e2646
title: Valori restituiti di JScript e azioni personalizzate VBScript
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="return-values-of-jscript-and-vbscript-custom-actions"></a>Valori restituiti di JScript e azioni personalizzate VBScript
...
Se questo VBScript è stato incorporato nella tabella [Binary](binary-table.md) del pacchetto di installazione come MyCA.vbs, la voce [CustomAction Table](customaction-table.md) per lo script sarà la seguente:
