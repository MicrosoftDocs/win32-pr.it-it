...
![modello a oggetti per mergemod.dll](images/mergobj.png)

[L'oggetto](merge-object.md) Merge è l'oggetto principale del modello. [**L'oggetto GetFiles**](getfiles-object.md) è un oggetto secondario. Le dipendenze sono raccolte di [**oggetti Dependency**](dependency-object.md). Gli errori sono raccolte di [**oggetti Error**](error-object.md).
