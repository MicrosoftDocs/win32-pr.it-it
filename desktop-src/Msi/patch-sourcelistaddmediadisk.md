...
---
# <a name="patchsourcelistaddmediadisk-method"></a>Patch. SourceListAddMediaDisk, metodo
...
Questo parametro fornisce la richiesta di disco del disco da aggiungere o aggiornare. Un aggiornamento sovrascrive il prompt del disco esistente nel registro di sistema. Per modificare solo l'etichetta del volume, ottenere la richiesta del disco esistente dal registro di sistema e fornirla con la nuova etichetta del volume. Una stringa NULL o vuota registra una stringa vuota (di lunghezza 0 byte) come richiesta del disco.
