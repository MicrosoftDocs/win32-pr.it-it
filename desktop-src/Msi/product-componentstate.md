...
GUID del codice del componente trovato nella colonna ComponentID della [tabella Component](component-table.md).
...
Se la chiamata non riesce, la proprietà contiene un codice di errore [**da MsiQueryComponentState.**](/windows/desktop/api/Msi/nf-msi-msiquerycomponentstatea)



| Errore                     | Significato                                                                                                            |
|---------------------------|--------------------------------------------------------------------------------------------------------------------|
| ERRORE \_ DI \_ ACCESSO NEGATO     | Il processo chiamante deve avere privilegi amministrativi per ottenere informazioni per un utente diverso dall'utente corrente. |
