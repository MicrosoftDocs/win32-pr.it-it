---
description: Per abilitare Windows installer nell'applicazione, è necessario usare le funzioni del programma di installazione. Le tabelle di questo argomento identificano le funzioni in base alla categoria.
...
Per abilitare Windows installer nell'applicazione, è necessario usare le funzioni del programma di installazione. Le tabelle di questo argomento identificano le funzioni in base alla categoria.
...
| [**MsiSetExternalUIRecord**](/windows/desktop/api/Msi/nf-msi-msisetexternaluirecord) | Abilita un gestore dell'interfaccia utente esterno che riceve messaggi in un formato di record. |
| [**MsiEnableLog**](/windows/desktop/api/Msi/nf-msi-msienableloga)                     | Imposta la modalità di log per tutte le installazioni nel processo chiamante.                       |
...
| [**MsiSourceListSetInfo**](/windows/desktop/api/Msi/nf-msi-msisourcelistsetinfoa)                     | Imposta l'origine usata più di recente per un prodotto o una patch in un contesto specificato. Disponibile in Windows Installer 3.0.                                                                                                       |
...
| [**MsiSourceListAddMediaDisk**](/windows/desktop/api/Msi/nf-msi-msisourcelistaddmediadiska)           | Aggiunge o aggiorna un disco dell'origine multimediale di un prodotto o di una patch registrata. Disponibile in Windows Installer 3.0.                                                                                                            |
| [**MsiSourceListClearMediaDisk**](/windows/desktop/api/Msi/nf-msi-msisourcelistclearmediadiska)      | Rimuove un disco registrato esistente nell'origine del supporto per un prodotto o una patch in un contesto specifico. Disponibile in Windows Installer 3.0.                                                                                |
...
| [**MsiGetShortcutTarget**](/windows/desktop/api/Msi/nf-msi-msigetshortcuttargeta)               | Esamina un collegamento e restituisce il prodotto, il nome della funzionalità e il componente, se disponibili. |
...
| [**MsiJoinTransaction**](/windows/desktop/api/Msi/nf-msi-msijointransaction)   | Richiede che il Windows di installazione rendi il processo corrente il proprietario della transazione installando un'installazione con più pacchetti. Questa funzione è disponibile a partire da Windows Installer 4.5. |
