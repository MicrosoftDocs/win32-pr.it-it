---
description: Un'applicazione deve chiamare diverse funzioni per richiedere le funzionalità.
...
Un'applicazione deve chiamare diverse funzioni per richiedere le funzionalità. Prima di richiedere una funzionalità, l'applicazione deve assicurarsi che la funzionalità sia installata. Se l'applicazione chiama [**MsiUseFeature**](/windows/desktop/api/Msi/nf-msi-msiusefeaturea) prima che l'applicazione accedono a una funzionalità, l'applicazione può usare le informazioni restituite per mantenere le metriche di utilizzo.
