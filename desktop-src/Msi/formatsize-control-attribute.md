...
I valori numerici del testo originale sono specificati in unità di 512. Nella tabella precedente la stringa 20.480 corrisponde alla stringa KB perché 20.480 per 512 restituisce un risultato di 10.485.760 byte o 10.240 KB.
...
Per altre informazioni, vedere [Attributi e controlli](control-attributes.md) di [controllo.](controls.md)
