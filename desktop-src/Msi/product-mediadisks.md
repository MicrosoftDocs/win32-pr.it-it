...
title: Product.MediaDisks - proprietà
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "120042201"
---
# <a name="productmediadisks-property"></a>Product.MediaDisks - proprietà
...
In ogni record il primo campo contiene l'ID disco, il secondo contiene l'etichetta di volume e il terzo campo contiene il prompt del disco registrato per il disco.
