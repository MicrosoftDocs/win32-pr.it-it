---
description: 'In questa sezione sono elencate le proprietà definite dal Windows installer:'
...
ms.locfileid: "119828471"
---
# <a name="property-reference"></a>Informazioni di riferimento sulla proprietà

In questa sezione sono elencate le proprietà definite dal Windows installer:
...
| [**ARPCONTACT**](arpcontact.md)<br/>                                             | Fornisce un contatto per **Installazione applicazioni** in **Pannello di controllo**.<br/>                                                                                                                                                                                                                                                                                                          |
...
| [**REBOOTPROMPT**](rebootprompt.md)<br/>                                         | Elimina la visualizzazione delle richieste di riavvio all'utente. Eventuali riavvii necessari vengono esersi automaticamente.<br/>                                                                                                                                                                                                                                                                     |
...
Nell'elenco seguente vengono forniti collegamenti a ulteriori informazioni sulle proprietà delle opzioni di installazione delle funzionalità.



| Proprietà                                                                | Descrizione                                                                                                                                                                       |
|-------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ADDDEFAULT**](adddefault.md)<br/>                             | Elenco delle funzionalità da installare nella configurazione predefinita.<br/>                                                                                                         |
| [**ADDLOCAL**](addlocal.md)<br/>                                 | Elenco delle funzionalità da installare in locale.<br/>                                                                                                                              |
...
| [**MSIDISABLELUAPATCHING**](msidisableluapatching.md)<br/>       | L'impostazione di questa proprietà impedisce l'applicazione di patch all'utente con privilegi minimi (LUA) di un'applicazione.<br/>                                                                                 |
| [**MsiPatchRemovalList**](msipatchremovallist.md)<br/>           | Elenco di patch da rimuovere durante l'installazione.<br/>                                                                                                                 |
| [**MSIRESTARTMANAGERCONTROL**](msirestartmanagercontrol.md)<br/> | Specifica se il pacchetto utilizza la funzionalità [Gestione riavvio](../rstmgr/restart-manager-portal.md) o [FilesInUse.](filesinuse-dialog.md)<br/>                                          |
| [**MSIDISABLERMRESTART**](msidisablermrestart.md)<br/>           | Specifica il modo in cui le applicazioni o i servizi che attualmente usano file interessati da un aggiornamento devono essere arrestato e riavviato per abilitare l'installazione dell'aggiornamento.<br/> |
| [**MSIRMSHUTDOWN**](msirmshutdown.md)<br/>                       | Specifica la modalità di arresto delle applicazioni o dei servizi che attualmente usano file interessati da un aggiornamento per abilitare l'installazione dell'aggiornamento.<br/>               |
...
| [**REINSTALL**](reinstall.md)<br/>                               | Elenco delle funzionalità da reinstallare.<br/>                                                                                                                                    |
...
Nell'elenco seguente vengono identificate le proprietà hardware impostate dal Windows di installazione all'avvio.
...
<td>Livello del processore numerico durante l'esecuzione in un processore Alpha.<br/>
<blockquote>
[!Note]<br />
Questa proprietà è obsoleta, la piattaforma Alpha non è supportata Windows Installer.
</blockquote>
<br/></td>
</tr>
<tr class="even">
<td><a href="borderside.md"><strong>Bordo bordo</strong></a><br/></td>
...
<td>Altezza dell'area del sottotitolo normale, in pixel.<br/></td>
</tr>
<tr class="odd">
...
<td>Livello del processore numerico durante l'esecuzione in un processore Intel.<br/></td>
</tr>
<tr class="odd">
<td><a href="intel64.md"><strong>Intel64</strong></a><br/></td>
<td>Livello del processore numerico durante l'esecuzione in un processore Itanium.<br/></td>
</tr>
<tr class="even">
<td><a href="msix64.md"><strong>Msix64</strong></a><br/></td>
<td>Livello del processore numerico durante l'esecuzione in un processore x64.<br/></td>
</tr>
<tr class="odd">
...
<td>Quantità di spazio disponibile in megabyte per il file di pagina.<br/></td>
</tr>
</tbody>
</table>
...
| [**MsiNTSuiteDataCenter**](msintsuitedatacenter.md)<br/>                           | Nei Windows 2000 e versioni successive, il programma di installazione imposta questa proprietà su 1 (uno) solo se Windows 2000 Datacenter Server è installato.<br/>                                                                                                                                        |
...
| [**MsiNTSuitePersonal**](msintsuitepersonal.md)<br/>                               | Nei Windows XP e versioni successive, il programma di installazione imposta questa proprietà su 1 (uno) solo se il sistema operativo è Home (non Professional).<br/>                                                                                                                                      |
...
| [**MsiWin32AssemblySupport**](msiwin32assemblysupport.md)<br/>                     | Nei sistemi che supportano assembly Win32, il programma di installazione imposta il valore di questa proprietà sulla versione del file sxs.dll. Il programma di installazione non imposta questa proprietà se il sistema operativo non supporta gli assembly Win32.<br/>                                                          |
| [**OLEAdvtSupport**](oleadvtsupport.md)<br/>                                       | Impostare se OLE supporta il programma di Windows programma di installazione.<br/>                                                                                                                                                                                                                                           |
...
| [**ShellAdvtSupport**](shelladvtsupport.md)<br/>                                   | Impostare se la shell supporta la pubblicità delle funzionalità.<br/>                                                                                                                                                                                                                                       |
...
| [**Versione9X**](version9x.md)<br/>                                                 | Numero di versione per il Windows sistema operativo.<br/>                                                                                                                                                                                                                                     |
...
Nell'elenco seguente vengono forniti collegamenti a altre informazioni sulle proprietà specifiche del prodotto specificate nella [tabella delle proprietà](property-table.md).
...
| [**ParentProductCode**](parentoriginaldatabase.md)<br/> | Il programma di installazione imposta questa proprietà per le installazioni eseguite da [un'azione Di installazione](concurrent-installations.md) simultanea.<br/> |
| [**PIDTemplate**](pidtemplate.md)<br/>                  | Stringa usata come modello per la [**proprietà PIDKEY.**](pidkey.md)<br/>                                                           |
...
Le proprietà seguenti vengono impostate solo dalle trasformazioni nei file con estensione msp usate per aggiornare il flusso di informazioni di riepilogo di un'immagine amministrativa.
...
Nell'elenco seguente vengono forniti collegamenti ad altre informazioni sulle cartelle di sistema impostate dal programma di installazione al momento dell'installazione.
...
| [**Cartella CommonAppDataFolder**](commonappdatafolder.md)<br/>   | Percorso completo dei dati dell'applicazione per tutti gli utenti.<br/>                           |
| [**Cartella CommonFiles64**](commonfiles64folder.md)<br/>   | Percorso completo della cartella dei file **comuni a 64 bit** predefinita.<br/>            |
| [**Cartella CommonFiles**](commonfilesfolder.md)<br/>       | Percorso completo della cartella **File comuni** per l'utente corrente.<br/>         |
| [**Cartella Desktop**](desktopfolder.md)<br/>               | Percorso completo della cartella **Desktop.**<br/>                                   |
| [**Cartella Preferiti**](favoritesfolder.md)<br/>           | Percorso completo della cartella **Preferiti** per l'utente corrente.<br/>            |
| [**Cartella Tipi di carattere**](fontsfolder.md)<br/>                   | Percorso completo della cartella **Fonts.**<br/>                                     |
| [**LocalAppDataFolder**](localappdatafolder.md)<br/>     | Percorso completo della cartella che contiene le applicazioni locali (non di roaming).<br/> |
| [**Cartella MyPictures**](mypicturesfolder.md)<br/>         | Percorso completo della **cartella** Immagini.<br/>                                  |
| [**NetFolder**](nethoodfolder.md)<br/>               | Percorso completo della cartella **Net Sistema.**<br/>                                   |
| [**PersonalFolder**](personalfolder.md)<br/>             | Percorso completo della cartella **Documenti** per l'utente corrente.<br/>            |
| [**PrintFolder**](printhoodfolder.md)<br/>           | Percorso completo della **cartella Print Completamente.**<br/>                                 |
| [**Cartella ProgramFiles64**](programfiles64folder.md)<br/> | Percorso completo della cartella programmi **a 64 bit** predefinita.<br/>           |
| [**Cartella ProgramFilesFolder**](programfilesfolder.md)<br/>     | Percorso completo della cartella programmi **a 32 bit** predefinita.<br/>           |
| [**CartellaMenu Programma**](programmenufolder.md)<br/>       | Percorso completo della cartella **Menu di** programma.<br/>                              |
| [**Cartella recente**](recentfolder.md)<br/>                 | Percorso completo della **cartella** Recenti.<br/>                                    |
...
| [**Cartella System16**](system16folder.md)<br/>             | Percorso completo della cartella per le DLL di sistema a 16 bit.<br/>                            |
| [**Cartella System64**](system64folder.md)<br/>             | Percorso completo della cartella **System64** predefinita.<br/>                       |
...
| [**Cartella Modello**](templatefolder.md)<br/>             | Percorso completo della cartella **Template** per l'utente corrente.<br/>             |
| [**Cartella Windows**](windowsfolder.md)<br/>               | Percorso completo della cartella **Windows.**<br/>                                   |
| [**WindowsVolume**](windowsvolume.md)<br/>               | Volume della cartella **Windows.**<br/>                                      |
...
Nell'elenco seguente vengono forniti collegamenti a ulteriori informazioni sulle informazioni fornite dall'utente.



| Proprietà                                                      | Descrizione                                                                             |
|---------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| [**AdminProperties**](adminproperties.md)<br/>         | Elenco delle proprietà impostate durante un'installazione di amministrazione.<br/>       |
| [**Companyname**](companyname.md)<br/>                 | Nome dell'organizzazione dell'utente che esegue l'installazione.<br/>            |
| [**Logonuser**](logonuser.md)<br/>                     | Nome utente dell'utente attualmente connesso.<br/>                           |
| [**MsiHiddenProperties**](msihiddenproperties.md)<br/> | Elenco di proprietà a cui non è consentito scrivere nel log.<br/>       |
...
| [**UserSID - proprietà**](usersid.md)<br/>                | Impostato dal programma di installazione in base all'ID di sicurezza (SID) dell'utente.<br/> |
