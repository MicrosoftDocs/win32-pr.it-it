...
|------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AbortPath**](/windows/desktop/api/Wingdi/nf-wingdi-abortpath)                 | Chiude e rimuove tutti i percorsi nel contesto di dispositivo specificato.                                                                                                   |
...
| [**FillPath**](/windows/desktop/api/Wingdi/nf-wingdi-fillpath)                   | Chiude tutte le figure aperte nel percorso corrente e riempie l'interno del percorso usando la modalità pennello e riempimento poligono corrente.                                   |
| [**FlattenPath**](/windows/desktop/api/Wingdi/nf-wingdi-flattenpath)             | Trasforma tutte le curve nel percorso selezionato nel contesto di dispositivo corrente, trasformando ogni curva in una sequenza di linee.                            |
...
| [**SetMiterLimit**](/windows/desktop/api/Wingdi/nf-wingdi-setmiterlimit)         | Imposta il limite per la lunghezza dei join miter per il contesto di dispositivo specificato.                                                                                   |
| [**StrokeAndFillPath**](/windows/desktop/api/Wingdi/nf-wingdi-strokeandfillpath) | Chiude tutte le figure aperte in un tracciato, traccia il contorno del tracciato usando la penna corrente e riempie l'interno usando il pennello corrente.                  |
...
| [**WidenPath**](/windows/desktop/api/Wingdi/nf-wingdi-widenpath)                 | Ridefinisce il percorso corrente come area che verrebbe disegnata se il tracciato fosse tracciato usando la penna attualmente selezionata nel contesto di dispositivo specificato.            |
