...
La funzione [**SetDIBitsToDevice**](/windows/desktop/api/Wingdi/nf-wingdi-setdibitstodevice) usa i dati di colore di una DIB per impostare i pixel nel rettangolo specificato sul dispositivo associato al contesto di dispositivo di destinazione.

[**SetDIBitsToDevice**](/windows/desktop/api/Wingdi/nf-wingdi-setdibitstodevice) è stato esteso per consentire il passaggio di un'immagine JPEG o png come immagine di origine.
