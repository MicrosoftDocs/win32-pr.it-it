---
description: Le strutture seguenti vengono usate con tipi di carattere e testo.
ms.assetid: 93726d5c-d4ed-4681-bf45-cb899f195b5d
title: Strutture di tipo di carattere e testo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119889251"
---
# <a name="font-and-text-structures"></a>Strutture di tipo di carattere e testo

Le strutture seguenti vengono usate con tipi di carattere e testo.
...
[**Fisso**](/windows/desktop/api/Wingdi/ns-wingdi-fixed)  
[**RISULTATI \_ GCP**](/windows/win32/api/wingdi/ns-wingdi-gcp_resultsa)  
...
[**STATO \_ RASTERIZZAZIONE**](/windows/desktop/api/Wingdi/ns-wingdi-rasterizer_status)  
[**Dimensione**](/previous-versions//dd145106(v=vs.85))  
