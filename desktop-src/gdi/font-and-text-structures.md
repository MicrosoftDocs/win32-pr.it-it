...
---
# <a name="font-and-text-structures"></a>Strutture di tipi di carattere e testo

Le strutture seguenti vengono usate con i tipi di carattere e il testo.

<dl>

[**ABC**](/windows/desktop/api/Wingdi/ns-wingdi-abc)  
[**ABCFLOAT**](/windows/desktop/api/Wingdi/ns-wingdi-abcfloat)  
[**Degli assi**](/windows/win32/api/wingdi/ns-wingdi-axeslista)  
...
[**FISSA**](/windows/desktop/api/Wingdi/ns-wingdi-fixed)  
[**risultati di GCP \_**](/windows/win32/api/wingdi/ns-wingdi-gcp_resultsa)  
...
[**Testo in formato testo**](/windows/win32/api/wingdi/ns-wingdi-polytexta)  
[**stato di RASTERIZZAzione \_**](/windows/desktop/api/Wingdi/ns-wingdi-rasterizer_status)  
[**DIMENSIONI**](/previous-versions//dd145106(v=vs.85))  
