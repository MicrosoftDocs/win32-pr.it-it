...
---
# <a name="using-rectangles-windows-gdi"></a>Uso di rettangoli (Windows GDI)

Nell'esempio riportato in questa sezione viene illustrato come utilizzare le funzioni Rectangle. È costituito dalla routine della finestra principale di un'applicazione che consente all'utente di spostare e ridimensionare una bitmap.

All'avvio dell'applicazione, viene disegnata una bitmap di 32 pixel per 32 pixel nell'angolo superiore sinistro dello schermo. L'utente può spostare la bitmap trascinandolo. Per ridimensionare la bitmap, l'utente crea un rettangolo di destinazione trascinando il mouse, quindi trascina la bitmap e la "Elimina" sul rettangolo di destinazione. L'applicazione risponde copiando la bitmap nel rettangolo di destinazione.

La routine della finestra che consente all'utente di spostare e ridimensionare la bitmap è indicata nell'esempio seguente.
