---
description: Viene descritto come trovare la classe WMI corretta e le procedure da utilizzare negli script e nelle applicazioni che eseguono attività comuni di amministrazione di computer e rete.
...
Nelle sezioni seguenti vengono descritte varie attività di amministrazione di computer e di rete e vengono forniti collegamenti alla classe o alle classi WMI utilizzate per eseguire tali attività. Per altre informazioni, vedere [Creazione di un'applicazione WMI o script.](creating-a-wmi-application-or-script.md) Per altre informazioni sull'uso di WMI, vedere [Ulteriori informazioni.](further-information.md) Per altre informazioni sull'uso di WMI, vedere [TechNet ScriptCenter.](https://www.microsoft.com/technet/scriptcenter/default.mspx) Queste risorse potrebbero non essere disponibili in ogni lingua o paese/area geografica.

Per altre informazioni su come fornire dati a WMI, vedere Utilizzo di [WMI](using-wmi.md), che farà riferimento ad argomenti sulla scrittura di un [*provider*](gloss-p.md)WMI.

Le operazioni illustrate negli esempi di script possono essere eseguite dalle applicazioni in C++ o Visual Basic. Per altre informazioni, vedere [Creazione di un'applicazione WMI tramite C++](creating-a-wmi-application-using-c-.md) e Esempi di applicazioni [WMI C++.](wmi-c---application-examples.md)
...
| [Computer Software](wmi-tasks--computer-software.md)                         | Ottenere informazioni quali il software installato dal programma di installazione di Windows (MSI) e le versioni del software.                                                                                                                                                                                                                                              |
...
| [Gestione desktop](wmi-tasks--desktop-management.md)                       | Ottenere dati da desktop remoti o controllarne i dati. Ad esempio, è possibile determinare se lo screen screen screen richiede o meno una password. WMI offre anche la possibilità di arrestare un computer remoto.                                                                                                                                                               |
...
| [Rete](wmi-tasks--networking.md)                                       | Gestire e ottenere informazioni sulle connessioni e sugli indirizzi IP o MAC.                                                                                                                                                                                                                                                                                  |
...
| [Services](wmi-tasks--services.md)                                           | Ottenere informazioni sui servizi, inclusi i servizi dipendenti o meno.                                                                                                                                                                                                                                                                            |
