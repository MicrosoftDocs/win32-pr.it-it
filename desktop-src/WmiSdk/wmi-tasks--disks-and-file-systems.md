...
Le attività WMI per i dischi e i file System ottengono informazioni sullo stato dell'hardware dell'unità disco e sui volumi logici. Per altri esempi, vedere il sito TechNet ScriptCenter all'indirizzo [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
<tbody>
<tr class="odd">
<td>... individuare la quantità di spazio su disco attualmente utilizzata da ogni utente in un computer.</td>
<td>Se si usano le quote disco, usare la classe <a href="/previous-versions/windows/desktop/wmipdskq/win32-diskquota"><strong>Win32_DiskQuota</strong></a> e recuperare i valori delle proprietà <strong>User</strong> e <strong>DiskSpaceUsed</strong> .<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<td><p>Usare uno script di monitoraggio che esegue una query sulla classe <a href="/windows/desktop/CIMWin32Prov/win32-volumechangeevent"><strong>Win32_VolumeChangeEvent</strong></a> .</p>
<div class="code">
...
<tr class="odd">
<td>... determinare se un CD è in un'unità CD-ROM?</td>
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-cdromdrive"><strong>win32_cdromdrive</strong></a> e la proprietà <strong>MediaLoaded</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> e controllare la proprietà <strong>FreeSpace</strong> . Se il valore è null, nessun disco si trova nell'unità.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> e controllare il valore della proprietà <strong>DriveType</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... determinare quale file system è in uso in un'unità?</td>
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> e la proprietà <strong>filesystem</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinare la quantità di spazio libero disponibile in un'unità.</td>
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> e la proprietà <strong>FreeSpace</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> e la proprietà <strong>size</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... informazioni sulle unità mappate in un computer</td>
<td><p>Usare la classe <a href="/windows/desktop/CIMWin32Prov/win32-mappedlogicaldisk"><strong>Win32_MappedLogicalDisk</strong></a> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Usare la classe <a href="/previous-versions/windows/desktop/legacy/aa394515(v=vs.85)"><strong>Win32_Volume</strong></a> e il metodo <a href="/previous-versions/windows/desktop/vdswmi/defrag-method-in-class-win32-volume"><strong>Defrag</strong></a> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... rilevare quale lettera di unità è associata a una partizione disco logica?</td>
<td><ol>
<li>Iniziare con la classe <a href="/windows/desktop/CIMWin32Prov/win32-diskdrive"><strong>Win32_DiskDrive</strong></a> ed eseguire una query per le istanze di <a href="/windows/desktop/CIMWin32Prov/win32-diskpartition"><strong>Win32_DiskPartition</strong></a> utilizzando la proprietà <strong>DeviceID</strong> e la classe di associazione <a href="/windows/desktop/CIMWin32Prov/win32-diskdrivetodiskpartition"><strong>Win32_DiskDriveToDiskPartition</strong></a> . A questo punto si dispone di una raccolta di partizioni nell'unità fisica.</li>
<li>Eseguire una query per la <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk</strong></a> che rappresenta la partizione utilizzando la proprietà <a href="/windows/desktop/CIMWin32Prov/win32-diskpartition"><strong>Win32_DiskPartition. DeviceID</strong></a> e <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisktopartition"><strong>Win32_LogicalDiskToPartition</strong></a> classe di associazione.</li>
<li>Ottenere la lettera di unità dal <a href="/windows/desktop/CIMWin32Prov/win32-logicaldisk"><strong>Win32_LogicalDisk. DeviceID</strong></a>.</li>
</ol>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
