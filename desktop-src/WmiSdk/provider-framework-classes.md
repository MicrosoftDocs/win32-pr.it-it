...
| [**CWbemGlueFactory**](/windows/desktop/api/WbemGlue/nl-wbemglue-cwbemgluefactory)   | Parte del framework del provider WMI. Il framework del provider implementa internamente i metodi di questa interfaccia per creare nuove istanze delle classi per il provider.                                                     |
