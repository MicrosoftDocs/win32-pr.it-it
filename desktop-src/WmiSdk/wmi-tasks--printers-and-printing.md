---
description: Le attività WMI per le stampanti e la stampa gestiscono e ottengono dati sulle stampanti, ad esempio la ricerca o l'impostazione della stampante predefinita. Per altri esempi, vedere TechNet ScriptCenter all'indirizzo https://www.microsoft.com/technet .
...
Le attività WMI per le stampanti e la stampa gestiscono e ottengono dati sulle stampanti, ad esempio la ricerca o l'impostazione della stampante predefinita. Per altri esempi, vedere TechNet ScriptCenter all'indirizzo [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
<tbody>
<tr class="odd">
<td>... aggiungere una nuova connessione stampante a un computer remoto?</td>
...
<td><p>Usare la <a href="/windows/desktop/CIMWin32Prov/win32-printer"><strong>Win32_Printer</strong></a> e il <a href="/windows/desktop/CIMWin32Prov/setdefaultprinter-method-in-class-win32-printer"><strong>metodo SetDefaultPrinter.</strong></a></p>
<div class="code">
...
<td><p>Usare la <a href="/windows/desktop/CIMWin32Prov/win32-printer"><strong>Win32_Printer</strong></a> e il <a href="/windows/desktop/CIMWin32Prov/cancelalljobs-method-in-class-win32-printer"><strong>metodo CancelAllJobs.</strong></a></p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Usare la <a href="/windows/desktop/CIMWin32Prov/win32-printer"><strong>Win32_Printer</strong></a> e verificare se la <strong>proprietà Default</strong> è <strong>True.</strong></p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
