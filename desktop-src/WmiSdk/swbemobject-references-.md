...
Il **metodo \_ References** dell'oggetto [**SWbemObject**](swbemobject.md) restituisce una raccolta di tutte le classi di associazione o di istanze che fanno riferimento all'oggetto corrente.

Questo metodo esegue la stessa funzione dei [riferimenti della](references-of-statement.md) query WQL.
...
Dopo il completamento del metodo **References \_** , l'oggetto **Err** può contenere uno dei codici di errore elencati di seguito.
