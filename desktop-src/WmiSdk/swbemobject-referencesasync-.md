---
description: Il metodo ReferencesAsync di SWbemObject fornisce una raccolta di tutte le classi o istanze di associazione che \_ fanno riferimento all'oggetto corrente. Questo metodo esegue la stessa funzione eseguita dalla query REFERENCES OF WQL.
ms.assetid: 44989726-3f68-453b-b9f5-e76fb0fbb152
ms.tgt_platform: multiple
title: SWbemObject.ReferencesAsync_ metodo (Wbemdisp.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119640071"
---
# <a name="swbemobjectreferencesasync_-method"></a>Metodo SWbemObject.ReferencesAsync \_

Il **metodo \_ ReferencesAsync** di [**SWbemObject**](swbemobject.md) fornisce una raccolta di tutte le classi o istanze di associazione che fanno riferimento all'oggetto corrente. Questo metodo esegue la stessa funzione eseguita dalla query [REFERENCES OF](references-of-statement.md) WQL.
...
Obbligatorio. Sink dell'oggetto che riceve gli oggetti in modo asincrono.
...
Stringa che contiene il nome di una proprietà. Se specificato, questo parametro indica che gli oggetti associazione restituiti devono essere limitati a quelli in cui l'oggetto di origine svolge un ruolo specifico. Il nome di una proprietà di riferimento specificata definisce il ruolo di un'associazione.
...
Fa Windows Wmi (Management Instrumentation) restituisce i dati di modifica della classe con la definizione della classe di base. Per altre informazioni, vedere [Localizzazione di informazioni sulle classi WMI.](localizing-wmi-class-information.md)
...
Dopo il completamento del **metodo ReferencesAsync, \_** l'oggetto [Err](/previous-versions//sbf5ze0e(v=vs.85)) può contenere uno dei codici di errore nell'elenco seguente.
