...
La proprietà **UTC** dell'oggetto [**SWbemDateTime**](swbemdatetime.md) Ottiene o imposta la rappresentazione UTC (Coordinated Universal Time) del valore **DateTime** . L'ora UTC è l'ora impostata in base allo standard temporale. UTC ha sostituito l'ora di Greenwich (GMT). Un valore UTC con un offset pari a zero corrisponde a GMT con un offset pari a zero. Il numero con segno deve essere compreso tra-720 e 720 o viene restituito l'errore **wbemErrValueOutOfRange** .
...
Dopo avere ottenuto o impostato la proprietà **UTC** , l'oggetto [Err](/previous-versions//sbf5ze0e(v=vs.85)) può contenere il codice di errore riportato di seguito.
...
Il valore non è compreso nell'intervallo tra-720 e 720.
