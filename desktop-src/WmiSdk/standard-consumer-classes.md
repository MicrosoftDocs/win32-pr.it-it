...
| [**NTEventLogEventConsumer**](nteventlogeventconsumer.md)                   | Registra un messaggio specifico nel Windows eventi quando viene recapitato un evento.<br/> Esempio: [registrazione nel registro eventi NT in base a un evento](logging-to-nt-event-log-based-on-an-event.md)<br/>                                          |
...
| [**SMTPEventConsumer**](smtpeventconsumer.md)                               | Invia un messaggio di posta elettronica tramite SMTP ogni volta che viene recapitato un evento.<br/> Esempio: [Invio di posta elettronica in base a un evento](sending-e-mail-based-on-an-event.md)<br/>                                                                       |
