...
---
# <a name="swbemdatetimemonth-property"></a>Proprietà SWbemDateTime. month

La proprietà **Month** dell'oggetto [**SWbemDateTime**](swbemdatetime.md) Ottiene o imposta un valore che rappresenta il componente month del valore DateTime. Il numero deve essere compreso tra 01 e 12 o viene restituito l'errore **wbemValueOutOfRange** .
