...
title: Supporto dell'istanza di classe per valori a 64 bit
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
---
# <a name="class-instance-support-for-64-bit-values"></a>Supporto dell'istanza di classe per valori a 64 bit

È possibile usare un valore di chiave a 64 bit come parte di un percorso, con le restrizioni seguenti:

-   Se non si supera l'intervallo a 32 bit, è possibile assegnare e recuperare i valori dalla chiave come si farebbe con una proprietà a 32 bit.
-   Dopo aver superato il valore intero di 0x7FFFFFFF (per i tipi con segno), 0x80000000 (per i tipi senza segno) o 32 bit, è necessario utilizzare le virgolette.
