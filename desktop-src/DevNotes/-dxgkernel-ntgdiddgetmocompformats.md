...
---
# <a name="ntgdiddgetmocompformats-function"></a>NtGdiDdGetMoCompFormats (funzione)
...
*puGetMoCompFormatsData* \[ in uscita\]
</dt> <dd>

Puntatore a una struttura [**DD \_ GETMOCOMPFORMATSDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompformatsdata) che contiene le informazioni sul formato non compresso per l'hardware.
