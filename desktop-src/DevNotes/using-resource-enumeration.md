---
description: Nell'esempio seguente viene illustrato come utilizzare la funzione VerifierEnumerateResource e gli elementi di programmazione correlati per astrarre e categorizzare le informazioni sulle risorse specifiche del processo.
ms.assetid: e0c2c795-2960-44f9-8b63-2329f5b42e15
title: Uso dell'enumerazione delle risorse
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103965917"
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="c4023-103">Uso dell'enumerazione delle risorse</span><span class="sxs-lookup"><span data-stu-id="c4023-103">Using Resource Enumeration</span></span>

<span data-ttu-id="c4023-104">Nell'esempio seguente viene illustrato come utilizzare la funzione [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) e gli elementi di programmazione correlati per astrarre e categorizzare le informazioni sulle risorse specifiche del processo.</span><span class="sxs-lookup"><span data-stu-id="c4023-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
