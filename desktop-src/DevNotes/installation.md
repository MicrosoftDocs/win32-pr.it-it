---
description: Questo articolo contiene collegamenti ad articoli sull'installazione nelle note per gli sviluppatori. Usare questi articoli per installare i componenti.
...
ms.locfileid: "111989276"
---
# <a name="installation-developer-notes"></a>Installazione (note per gli sviluppatori)
...
-   [**ricaricare la \_ configurazione**](reload-config.md)
