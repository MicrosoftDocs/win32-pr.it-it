...
---
# <a name="extracting-files-from-a-cabinet"></a><span data-ttu-id="e7e75-104">Estrazione di file da un archivio</span><span class="sxs-lookup"><span data-stu-id="e7e75-104">Extracting Files from a Cabinet</span></span>

<span data-ttu-id="e7e75-105">La sintassi seguente illustra la creazione di un file cab.</span><span class="sxs-lookup"><span data-stu-id="e7e75-105">The following syntax illustrates the creation of a cabinet.</span></span>

> [!Note]  
> <span data-ttu-id="e7e75-106">Questo codice è solo a scopo illustrativo.</span><span class="sxs-lookup"><span data-stu-id="e7e75-106">This code is for illustrative purposes only.</span></span> <span data-ttu-id="e7e75-107">Per la compilazione, è necessario definire le funzioni di callback.</span><span class="sxs-lookup"><span data-stu-id="e7e75-107">To compile, the callback functions must be defined.</span></span>

 

## <a name="example"></a><span data-ttu-id="e7e75-108">Esempio</span><span class="sxs-lookup"><span data-stu-id="e7e75-108">Example</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e7e75-109">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="e7e75-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e7e75-110">**FDICrea**</span><span class="sxs-lookup"><span data-stu-id="e7e75-110">**FDICreate**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdicreate)
</dt> <dt>

[<span data-ttu-id="e7e75-111">**FDICopy**</span><span class="sxs-lookup"><span data-stu-id="e7e75-111">**FDICopy**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdicopy)
</dt> <dt>

[<span data-ttu-id="e7e75-112">**FDIDestroy**</span><span class="sxs-lookup"><span data-stu-id="e7e75-112">**FDIDestroy**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdidestroy)
</dt> <dt>

[<span data-ttu-id="e7e75-113">Macro dell'API Cabinet</span><span class="sxs-lookup"><span data-stu-id="e7e75-113">Cabinet API Macros</span></span>](cabinet-api-macros.md)
</dt> </dl>
