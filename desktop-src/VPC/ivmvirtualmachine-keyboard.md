---
title: Proprietà Tastiera IVMVirtualMachine (VPCCOMInterfaces.h)
...
ms.locfileid: "119653041"
---
# <a name="ivmvirtualmachinekeyboard-property"></a>Proprietà IVMVirtualMachine::Keyboard

\[Windows Virtual PC non è più disponibile per l'uso a Windows 8. Usare invece il [provider WMI Hyper-V (V2).](/windows/desktop/HyperV_v2/windows-virtualization-portal)\]

Recupera il dispositivo da tastiera per la macchina virtuale.
...
Oggetto [**IVMKeyboard.**](ivmkeyboard.md)
