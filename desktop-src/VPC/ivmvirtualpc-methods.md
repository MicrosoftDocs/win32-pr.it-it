...
-   [**Metodo CreateDifferencingVirtualHardDisk**](ivmvirtualpc-createdifferencingvirtualharddisk.md)
-   [**Metodo CreateDynamicVirtualHardDisk**](ivmvirtualpc-createdynamicvirtualharddisk.md)
-   [**Metodo CreateFixedVirtualHardDisk**](ivmvirtualpc-createfixedvirtualharddisk.md)
-   [**Metodo CreateFloppyDiskImage**](ivmvirtualpc-createfloppydiskimage.md)
-   [**Metodo CreateVirtualMachine**](ivmvirtualpc-createvirtualmachine.md)
-   [**Metodo DeleteVirtualMachine**](ivmvirtualpc-deletevirtualmachine.md)
-   [**Metodo FindVirtualMachine**](ivmvirtualpc-findvirtualmachine.md)
-   [**Metodo FindVirtualNetwork**](ivmvirtualpc-findvirtualnetwork.md)
-   [**Metodo GetConfigurationValue**](ivmvirtualpc-getconfigurationvalue.md)
...
-   [**Metodo RemoveConfigurationValue**](ivmvirtualpc-removeconfigurationvalue.md)
