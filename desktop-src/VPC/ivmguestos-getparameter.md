---
title: Metodo IVMGuestOS GetParameter (VPCCOMInterfaces.h)
...
La macchina virtuale deve essere in esecuzione e i componenti di integrazione devono essere installati quando viene richiamato questo metodo. Questo metodo è supportato solo per Windows sistemi operativi guest basati su più sistemi operativi.
...
All'avvio del sistema operativo guest, i valori della stringa del Registro di sistema seguenti vengono popolati nella **chiave Parameters:**
