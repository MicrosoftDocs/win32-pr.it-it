---
title: Proprietà IVMVirtualPC UpTime (VPCCOMInterfaces.h)
description: Recupera il numero di secondi di Windows'applicazione Virtual PC in esecuzione.
ms.assetid: 3007a961-2e8c-4674-aab6-4424d0d73eca
keywords:
- Proprietà UpTime Virtual PC
- Proprietà UpTime Virtual PC , interfaccia IVMVirtualPC
- Interfaccia IVMVirtualPC Virtual PC, proprietà UpTime
topic_type:
- apiref
api_name:
- IVMVirtualPC.UpTime
...
ms.locfileid: "117752010"
---
# <a name="ivmvirtualpcuptime-property"></a>Proprietà IVMVirtualPC::UpTime

\[Windows Virtual PC non è più disponibile per l'uso a Windows 8. Usare invece il [provider WMI Hyper-V (V2).](/windows/desktop/HyperV_v2/windows-virtualization-portal)\]

Recupera il numero di secondi di Windows'applicazione Virtual PC in esecuzione.
...
Numero di secondi di esecuzione Windows'applicazione Virtual PC.
