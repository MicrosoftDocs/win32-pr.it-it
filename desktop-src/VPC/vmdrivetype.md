...
ms.locfileid: "119394321"
---
# <a name="vmdrivetype-enumeration"></a>Enumerazione VMDriveType

\[Windows Virtual PC non è più disponibile per l'uso a Windows 8. Usare invece il [provider WMI Hyper-V (V2).](/windows/desktop/HyperV_v2/windows-virtualization-portal)\]

Specifica il tipo di unità collegata a una posizione del bus.
...
Non è presente alcuna unità collegata.

</dd> <dt>

<span id="vmDriveType_HardDisk"></span><span id="vmdrivetype_harddisk"></span><span id="VMDRIVETYPE_HARDDISK"></span>**Disco rigido \_ vmDriveType**
</dt> <dd>

È presente un disco rigido collegato.
...
È presente un'unità CD o DVD collegata.
