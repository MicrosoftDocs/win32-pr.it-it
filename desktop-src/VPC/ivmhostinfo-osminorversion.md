---
title: Proprietà OSMinorVersion IVMHostInfo (VPCCOMInterfaces.h)
...
ms.locfileid: "118593533"
---
# <a name="ivmhostinfoosminorversion-property"></a>Proprietà IVMHostInfo::OSMinorVersion

\[Windows Virtual PC non è più disponibile per l'uso a Windows 8. Usare invece il [provider WMI Hyper-V (V2).](/windows/desktop/HyperV_v2/windows-virtualization-portal)\]

Recupera la versione secondaria del sistema operativo in esecuzione nel computer host.
