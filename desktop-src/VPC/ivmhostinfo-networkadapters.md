...
---
# <a name="ivmhostinfonetworkadapters-property"></a>Proprietà IVMHostInfo:: I NetworkAdapter

\[Windows Virtual PC non è più disponibile per l'uso a partire da Windows 8. Usare invece il [provider WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Recupera una raccolta enumerabile di schede di rete nel computer host.
...
Raccolta di schede di interfaccia di rete. Si tratta di una matrice di valori **BSTR** .
