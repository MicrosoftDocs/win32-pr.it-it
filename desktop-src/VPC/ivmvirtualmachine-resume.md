...
---
# <a name="ivmvirtualmachineresume-method"></a>Metodo IVMVirtualMachine:: Resume

\[Windows Virtual PC non è più disponibile per l'uso a partire da Windows 8. Usare invece il [provider WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Riprende la macchina virtuale (VM).
...
| <dl> <dt>**E \_ ERRORE**</dt> <dt>0x80004005</dt> </dl>                                     | La macchina virtuale non è sospesa.<br/>                                              |
| <dl> <dt>**HRESULT \_ DA \_ Win32 ( \_ accesso errore \_ negato)**</dt> <dt>0x80070005</dt> </dl> | Il chiamante deve avere le autorizzazioni di accesso Execute per riprendere questa macchina virtuale.<br/> |
