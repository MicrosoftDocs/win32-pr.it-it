...
Crea un disco rigido virtuale a dimensione fissa.
...
Dimensione, in megabyte, dell'immagine. La dimensione massima è 2.088.960 MB (2040GB).
...
| <dl> <dt>**HRESULT \_ Da \_ Win32 (overflow del buffer degli errori \_ \_ )**</dt> <dt>0x8007006f</dt> </dl> | Il percorso specificato dal parametro *imagePath* è troppo lungo. La lunghezza del percorso deve essere minore di **Max \_ path** (260) caratteri.<br/>                |
...
| <dl> <dt>**Macchina virtuale \_ Dimensioni dell'immagine E 0xA0040683 \_ \_ \_ troppo \_ grandi**</dt> <dt></dt> </dl>                | Il parametro *size* deve essere minore di 2.088.960 MB. Se il formato è FAT16, il parametro *size* deve essere minore di 2000 MB.<br/>                    |
...
| <dl> <dt>**Macchina virtuale \_ Il \_ file E è \_ troppo \_ grande \_ per il \_ volume**</dt> <dt>0xA0040679</dt> </dl>          | Il volume host non può supportare le dimensioni di un file. Le dimensioni massime del file per un volume FAT32 sono pari a 4 GB. Le dimensioni massime del file per un volume FAT16 sono pari a 2 GB.<br/> |
