...
---
# <a name="ivmvirtualpcmaximumfloppydrivespervm-property"></a>Proprietà IVMVirtualPC:: MaximumFloppyDrivesPerVM

\[Windows Virtual PC non è più disponibile per l'uso a partire da Windows 8. Usare invece il [provider WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Recupera il numero massimo di unità floppy per macchina virtuale.
...
Numero massimo di unità floppy per macchina virtuale.
