...
keywords:
- Proprietà mouse Virtual PC
- Proprietà mouse Virtual PC, interfaccia IVMVirtualMachine
...
ms.locfileid: "118344655"
---
# <a name="ivmvirtualmachinemouse-property"></a>Proprietà IVMVirtualMachine::Mouse

\[Windows Virtual PC non è più disponibile per l'uso a Windows 8. Usare invece il [provider WMI Hyper-V (V2).](/windows/desktop/HyperV_v2/windows-virtualization-portal)\]

Recupera il dispositivo mouse per la macchina virtuale.
