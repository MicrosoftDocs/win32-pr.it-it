...
Coordinata x che indica la nuova posizione del mouse. Quando si usano le coordinate assolute, questo valore specifica la nuova coordinata x del mouse. Quando si usano le coordinate relative, questo valore specifica il numero di pixel che il mouse deve spostare nella direzione x.
