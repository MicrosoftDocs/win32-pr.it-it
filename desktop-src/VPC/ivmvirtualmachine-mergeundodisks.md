...
| <dl> <dt>**HRESULT \_ FROM \_ WIN32(ERROR \_ PATH NOT \_ \_ FOUND)**</dt> <dt>0X80070003</dt> </dl> | Il sistema non riesce a trovare il percorso specificato dal *parametro convertedDiskImagePath* oppure uno dei dischi padre non è valido.<br/> |
