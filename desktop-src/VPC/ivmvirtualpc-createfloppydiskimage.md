...
---
# <a name="ivmvirtualpccreatefloppydiskimage-method"></a>Metodo IVMVirtualPC:: CreateFloppyDiskImage

\[Windows Virtual PC non è più disponibile per l'uso a partire da Windows 8. Usare invece il [provider WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Consente di creare un file di immagine disco floppy.
...
Tipo di immagine del disco floppy da creare. Sono supportati solo **vmFloppyDiskImage \_ LowDensity** (1) e **vmFloppyDiskImage \_ ad alta densità** (2). Vedere [**VMFloppyDiskImageType**](vmfloppydiskimagetype.md).
...
| <dl> <dt>**E \_**</dt> <dt>0x80000003</dt> INVALIDARG </dl>                                 | Il parametro *ImageType* non è [**vmFloppyDiskImage \_ LowDensity**](vmfloppydiskimagetype.md) (1) o **vmFloppyDiskImage \_ ad alta densità** (2).<br/> |
...
| <dl> <dt>**HRESULT \_ DA \_ Win32 (errore \_ disco \_ completo)**</dt> <dt>0x80070070</dt> </dl>       | Spazio insufficiente nel volume host per creare l'immagine del disco floppy virtuale.<br/>                                                        |
