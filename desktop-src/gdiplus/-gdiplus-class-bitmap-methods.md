---
description: Questo argomento elenca i metodi della classe bitmap. Per un elenco completo delle classi, vedere classe bitmap.
...
ms.locfileid: "104528789"
---
# <a name="bitmap-methods"></a>Metodi bitmap

Questo argomento elenca i metodi della classe [**bitmap**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-bitmap) . Per un elenco completo delle classi, vedere **classe bitmap**.
...
-   [**ApplyEffect (effetto \* , Rect \* )**](/previous-versions//ms536321(v=vs.85))
...
-   [**Getistogramma**](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-bitmap-gethistogram)
...
-   [**Risoluzione dei problemi**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-bitmap-setresolution)
