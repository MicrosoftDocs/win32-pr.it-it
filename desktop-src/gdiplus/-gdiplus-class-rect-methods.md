...
---
# <a name="rect-methods"></a>Metodi Rect

Questo argomento elenca i metodi della classe [**Rect**](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rect) . Per un elenco completo delle classi, vedere **classe Rect**.
...
-   [**Uguale a**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-equals)
...
-   [**Inflate (punto&)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rect-inflate(inconstpoint_))
...
-   [**Offset (punto&)**](/previous-versions//ms534979(v=vs.85))
