---
description: Questo argomento elenca i costruttori della classe Graphics. Per un elenco completo delle classi, vedere Classe Graphics.
ms.assetid: 76c4c444-cd6f-43ff-8ab7-96469d4505b9
title: Costruttori graphics.Graphics
ms.date: 07/02/2019
ms.topic: reference
...
ms.locfileid: "119964801"
---
# <a name="graphicsgraphics-constructors"></a>Costruttori graphics.Graphics

Questo argomento elenca i costruttori della [**classe**](/windows/win32/api/gdiplusgraphics/nl-gdiplusgraphics-graphics) Graphics. Per un elenco completo delle classi, vedere **Classe Graphics**.
