---
description: Windows GDI+ un'API flat costituita da circa 600 funzioni. Microsoft .NET Framework fornisce un set di classi wrapper di codice gestito per GDI+.
...
In alternativa ai wrapper C++, Microsoft .NET Framework un set di classi wrapper di codice gestito per GDI+. I wrapper di codice gestito per GDI+ appartengono agli spazi dei nomi seguenti.
...
Negli argomenti seguenti viene illustrata la relazione tra l'API GDI+ flat e i metodi wrapper C++.
...
-   [Funzioni di HatchBrush](-gdiplus-hatchbrush-flat.md)
-   [Funzioni immagine](-gdiplus-image-flat.md)
-   [Funzioni ImageAttributes](-gdiplus-imageattributes-flat.md)
-   [Funzioni LinearGradientBrush](-gdiplus-lineargradientbrush-flat.md)
-   [Funzioni matrice](-gdiplus-matrix-flat.md)
...
-   [Funzioni penna](-gdiplus-pen-flat.md)
