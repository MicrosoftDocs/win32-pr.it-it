...
description: Questo argomento descrive il supporto per le chiamate annidate a SRSetRestorePoint tramite i tipi di evento BEGIN \_ NESTED SYSTEM CHANGE ed END NESTED SYSTEM \_ \_ \_ \_ \_ CHANGE.
...
Questo argomento descrive il supporto per le chiamate annidate a [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) tramite i tipi di evento BEGIN \_ NESTED SYSTEM CHANGE ed END NESTED SYSTEM \_ \_ \_ \_ \_ CHANGE.
