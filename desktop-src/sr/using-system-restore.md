...
---
# <a name="using-system-restore"></a><span data-ttu-id="1b186-104">Uso di ripristino configurazione di sistema</span><span class="sxs-lookup"><span data-stu-id="1b186-104">Using System Restore</span></span>

<span data-ttu-id="1b186-105">Gli esempi seguenti illustrano come creare e annullare i punti di ripristino usando la funzione [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) .</span><span class="sxs-lookup"><span data-stu-id="1b186-105">The following examples demonstrate how to create and cancel restore points using the [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) function.</span></span>

<span data-ttu-id="1b186-106">Il primo passaggio per l'uso di ripristino configurazione di sistema è la configurazione delle chiamate COM a [**CoInitializeEx**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializeex) e [**CoInitializeSecurity**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializesecurity).</span><span class="sxs-lookup"><span data-stu-id="1b186-106">The first step to using using System Restore is setting up the COM calls to [**CoInitializeEx**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializeex) and [**CoInitializeSecurity**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializesecurity).</span></span> <span data-ttu-id="1b186-107">Questa operazione è necessaria per tutti i processi che usano la funzione [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) .</span><span class="sxs-lookup"><span data-stu-id="1b186-107">This is required for any process that uses the [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) function.</span></span> <span data-ttu-id="1b186-108">È necessario consentire a NetworkService, LocalService e System di effettuare chiamate al processo.</span><span class="sxs-lookup"><span data-stu-id="1b186-108">The NetworkService, LocalService, and System must be allowed make calls to the process.</span></span> <span data-ttu-id="1b186-109">La funzione **InitializeCOMSecurity** seguente è un esempio di come inizializzare la sicurezza com.</span><span class="sxs-lookup"><span data-stu-id="1b186-109">The following **InitializeCOMSecurity** function is an example of how to initialize COM security.</span></span> <span data-ttu-id="1b186-110">Potrebbe essere necessario modificare i parametri per la funzione **CoInitializeSecurity** per l'applicazione.</span><span class="sxs-lookup"><span data-stu-id="1b186-110">You may need to modify the parameters to the **CoInitializeSecurity** function for your application.</span></span>
...
## <a name="example-1-create-a-restore-point"></a><span data-ttu-id="1b186-111">Esempio 1: creare un punto di ripristino.</span><span class="sxs-lookup"><span data-stu-id="1b186-111">Example 1: Create a restore point.</span></span>
...
## <a name="example-2-create-and-cancel-a-restore-point"></a><span data-ttu-id="1b186-112">Esempio 2: creare e annullare un punto di ripristino.</span><span class="sxs-lookup"><span data-stu-id="1b186-112">Example 2: Create and cancel a restore point.</span></span>
