...
---
# <a name="mf_sd_asf_extstrmprop_avg_buffersize-attribute"></a>\_ \_ \_ \_ \_ Attributo bufferSize AVG di MF SD ASF EXTSTRMPROP

Specifica la dimensione media del buffer, in byte, necessaria per un flusso in un file di formato Advanced Systems (ASF).
...
Questo attributo si applica ai descrittori di flusso per il contenuto ASF. Corrisponde al campo dimensione del buffer nell'oggetto proprietà del flusso esteso e definisce la dimensione del bucket utilizzata nel modello di "bucket a perdita". Per ulteriori informazioni, vedere la specifica ASF.
