...
Questo attributo si applica ai descrittori di presentazione per il contenuto asf. Se il valore è **TRUE,** il file ha almeno un flusso video. In caso contrario, il file non contiene flussi video.
