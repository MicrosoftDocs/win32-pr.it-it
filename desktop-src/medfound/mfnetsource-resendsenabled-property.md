...
---
# <a name="mfnetsource_resendsenabled-property"></a>\_Proprietà RESENDSENABLED di MFNETSOURCE

Specifica se l'origine di rete invia le richieste di reinvio UDP in risposta a pacchetti persi.
...
La costante **MFNETSOURCE \_ RESENDSENABLED** definisce il GUID per la chiave della proprietà. L'identificatore di proprietà (PID) è zero.
