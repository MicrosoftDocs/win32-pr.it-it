...
title: Gestori di schemi e gestori Byte-Stream schema
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="scheme-handlers-and-byte-stream-handlers"></a>Gestori di schemi e gestori Byte-Stream schema
...
I gestori di schema espongono [**l'interfaccia IMFSchemeHandler.**](/windows/desktop/api/mfidl/nn-mfidl-imfschemehandler) Se il sistema di risoluzione di origine trova un gestore dello schema che corrisponde a quello dell'URL, il sistema di risoluzione di origine chiama [**IMFSchemeHandler::BeginCreateObject**](/windows/desktop/api/mfidl/nf-mfidl-imfschemehandler-begincreateobject), passando l'URL originale. Il gestore dello schema aprirà l'URL e tenterà di analizzare il contenuto. A questo punto, il gestore dello schema ha due opzioni:
