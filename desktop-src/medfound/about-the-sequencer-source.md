...
Per creare una playlist, l'applicazione crea una o più topologie di riproduzione e le accoda nell'origine sequencer nell'ordine di riproduzione desiderato. Internamente, l'origine sequencer modifica le topologie in modo che i nodi di origine puntino all'origine sequencer anziché all'origine nativa. L'applicazione invia queste topologie modificate, anziché le topologie originali, alla sessione multimediale. In questo modo l'origine sequencer può aggregare le origini native e comunicare con la sessione multimediale.
