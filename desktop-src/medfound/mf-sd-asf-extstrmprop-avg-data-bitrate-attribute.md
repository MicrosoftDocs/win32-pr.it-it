...
---
# <a name="mf_sd_asf_extstrmprop_avg_data_bitrate-attribute"></a>\_Attributo MF SD \_ ASF \_ EXTSTRMPROP \_ Avg \_ data \_ bitrate

Specifica la velocità in bit dei dati media, in bit al secondo, di un flusso in un file di formato Advanced Systems (ASF).
...
Questo attributo si applica ai descrittori di flusso per il contenuto ASF. Corrisponde al campo velocità in bit di dati nell'oggetto proprietà del flusso esteso e definisce la velocità di perdita utilizzata nel modello di "bucket a perdita". Per ulteriori informazioni, vedere la specifica ASF.
