...
---
# <a name="vml-ruleproxy-attribute"></a>Attributo RuleProxy di la
...
Determina se verrà utilizzato un proxy per il motore regole. Proprietà di lettura/scrittura. **VgTriState**.
...
Il valore predefinito è **False**. Se **true**, viene utilizzato un proxy.

*Attributo Microsoft Office Extensions*

**Esempio**

Viene utilizzato un proxy per elaborare la forma.
