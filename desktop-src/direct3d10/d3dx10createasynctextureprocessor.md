...
---
# <a name="d3dx10createasynctextureprocessor-function"></a>D3DX10CreateAsyncTextureProcessor (funzione)
...
Puntatore a Devive (vedere l' [**interfaccia ID3D10Device**](/windows/desktop/api/D3D10/nn-d3d10-id3d10device)).
...
Questa API crea un'interfaccia del processore dati e carica la trama; [**D3DX10CreateAsyncTextureInfoProcessor**](d3dx10createasynctextureinfoprocessor.md) crea l'interfaccia del processore dati.
