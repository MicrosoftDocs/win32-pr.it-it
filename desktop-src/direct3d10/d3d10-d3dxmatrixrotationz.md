...
Angolo di rotazione, in radianti. Gli angoli sono misurati in senso orario quando vengono visualizzati dall'asse di rotazione (lato positivo) verso l'origine.
...
Il valore restituito per questa funzione corrisponde al valore restituito nel parametro broncio. In questo modo, la funzione D3DXMatrixRotationZ può essere utilizzata come parametro per un'altra funzione.
