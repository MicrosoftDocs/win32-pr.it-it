...
---
# <a name="d3dxshmultiply5-function"></a>D3DXSHMultiply5 (funzione)

Calcola il prodotto di due funzioni di armonica sferica (f e g). Entrambe le funzioni sono di ordine N = 5.
...
Il prodotto di due funzioni SH di order N = 5 genera una funzione SH di Order 2 × *N* -1 = 9, ma i risultati vengono troncati. Ciò significa che il prodotto si sposta ( *f* × *g*  =  *g* × *f* ) ma non associa ( *f* × ( *g* × *h* ) ≠ ( *f* × *g* ) × *h* ).
