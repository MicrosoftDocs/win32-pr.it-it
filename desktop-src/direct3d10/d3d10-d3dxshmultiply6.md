...
---
# <a name="d3dxshmultiply6-function"></a>D3DXSHMultiply6 (funzione)

Calcola il prodotto di due funzioni di armonica sferica (f e g). Entrambe le funzioni sono di ordine N = 6.
...
Il prodotto di due funzioni SH dell'ordine N = 6 genera una funzione SH dell'ordine 2 × *N* -1 = 11, ma i risultati vengono troncati. Ciò significa che il prodotto si sposta ( *f* × *g*  =  *g* × *f* ) ma non associa ( *f* × ( *g* × *h* ) ≠ ( *f* × *g* ) × *h* ).
