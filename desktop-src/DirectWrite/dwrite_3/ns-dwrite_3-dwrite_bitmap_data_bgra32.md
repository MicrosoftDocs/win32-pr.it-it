...
---
# <a name="dwrite_bitmap_data_bgra32-structure-dwrite_3h"></a>Struttura DWRITE_BITMAP_DATA_BGRA32 (dwrite_3. h)

Rappresenta i dati bitmap nel formato BGRA32.
...
Tipo: \_ dimensioni del campo \_ \_ (larghezza * altezza)**[UInt32](../../winprog/windows-data-types.md)\***
