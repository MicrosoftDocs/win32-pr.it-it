...
description: Indica che Windows'animazione può ritardare l'avvio pianificato di uno storyboard per il tempo necessario per evitare conflitti di pianificazione.
