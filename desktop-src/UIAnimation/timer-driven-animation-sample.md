...
---
# <a name="timer-driven-animation-sample"></a>Esempio di animazione Timer-Driven

Viene illustrato come utilizzare l'animazione Windows con il timer animazione, mentre si utilizza GDI+ per animare il colore di sfondo di una finestra.
...
1.  Aprire la finestra del prompt dei comandi e passare alla directory del progetto TimerDriven. Ad esempio, il percorso di installazione predefinito per questo esempio è C: \\ programmi \\ Microsoft SDK \\ Windows \\ v 7.0 \\ Samples \\ Multimedia \\ WindowsAnimation \\ TimerDriven.
...
1.  Aprire Esplora risorse e passare alla directory del progetto TimerDriven.

2.  Fare doppio clic sull'icona per il file TimerDriven. sln per aprire il progetto in Visual Studio.
...
2.  Eseguire **TimerDriven.exe** al prompt dei comandi oppure fare doppio clic sull'icona TimerDriven.exe in Esplora risorse.
