...
---
# <a name="monitoring-filter-changes"></a><span data-ttu-id="1b882-103">Monitoraggio delle modifiche al filtro</span><span class="sxs-lookup"><span data-stu-id="1b882-103">Monitoring Filter Changes</span></span>

<span data-ttu-id="1b882-104">Nell'esempio di codice seguente viene illustrato come monitorare l'aggiunta e l'eliminazione di filtri che potrebbero influire su un'applicazione server.</span><span class="sxs-lookup"><span data-stu-id="1b882-104">The following sample code demonstrates how to monitor the addition and deletion of filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="1b882-105">Le condizioni di filtro sono le stesse supportate dall'API **IsPortAllowed** di livello inferiore.</span><span class="sxs-lookup"><span data-stu-id="1b882-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
