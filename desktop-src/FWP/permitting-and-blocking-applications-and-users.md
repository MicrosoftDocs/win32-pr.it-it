...
---
# <a name="permitting-and-blocking-applications-and-users"></a><span data-ttu-id="f3069-103">Consentire e bloccare applicazioni e utenti</span><span class="sxs-lookup"><span data-stu-id="f3069-103">Permitting and Blocking Applications and Users</span></span>

<span data-ttu-id="f3069-104">Nell'esempio di codice riportato di seguito viene illustrato come aggiungere un filtro che restituisce l'ID dell'utente o dell'applicazione.</span><span class="sxs-lookup"><span data-stu-id="f3069-104">The following sample code demonstrates how to add a filter that evaluates by user or application ID.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f3069-105">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="f3069-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f3069-106">**Condizioni di filtro disponibili a ogni livello di filtro**</span><span class="sxs-lookup"><span data-stu-id="f3069-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
