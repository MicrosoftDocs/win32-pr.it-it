---
title: Prevenzione dell'analisi delle porte
description: Il codice di esempio seguente illustra come impedire l'analisi delle porte usando le eliminazioni Stealth e le gocce silenziose.
...
ms.locfileid: "104044898"
---
# <a name="preventing-port-scanning"></a><span data-ttu-id="9052e-103">Prevenzione dell'analisi delle porte</span><span class="sxs-lookup"><span data-stu-id="9052e-103">Preventing Port Scanning</span></span>

<span data-ttu-id="9052e-104">Il codice di esempio seguente illustra come impedire l'analisi delle porte usando le eliminazioni Stealth e le gocce silenziose.</span><span class="sxs-lookup"><span data-stu-id="9052e-104">The following sample code demonstrates how to prevent port scanning using stealth discards and silent drops.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9052e-105">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="9052e-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9052e-106">**Condizioni di filtro disponibili a ogni livello di filtro**</span><span class="sxs-lookup"><span data-stu-id="9052e-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
