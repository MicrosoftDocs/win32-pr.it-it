---
title: Eliminazione del filtro intralciata
description: Nell'esempio di codice seguente viene illustrato come rendere difficile l'eliminazione di un filtro impostando un DACL.
...
ms.locfileid: "104330967"
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="72e69-103">Eliminazione del filtro intralciata</span><span class="sxs-lookup"><span data-stu-id="72e69-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="72e69-104">Nell'esempio di codice seguente viene illustrato come rendere difficile l'eliminazione di un filtro impostando un DACL.</span><span class="sxs-lookup"><span data-stu-id="72e69-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
