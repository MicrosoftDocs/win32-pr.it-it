...
---
# <a name="uninstalling-a-provider"></a>Disinstallazione di un provider

Nell'esempio di codice riportato di seguito viene illustrato il processo necessario per rimuovere un'installazione del provider.
