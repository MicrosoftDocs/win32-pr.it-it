...
description: Nell'esempio di codice seguente viene illustrato il processo necessario per rimuovere un'installazione del provider.
...
ms.locfileid: "119755171"
---
# <a name="uninstalling-a-provider"></a>Disinstallazione di un provider

Nell'esempio di codice seguente viene illustrato il processo necessario per rimuovere un'installazione del provider.
