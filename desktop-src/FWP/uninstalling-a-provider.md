---
title: Disinstallazione di un provider
description: Il codice di esempio seguente illustra il processo necessario per rimuovere un'installazione del provider.
...
ms.locfileid: "103712973"
---
# <a name="uninstalling-a-provider"></a><span data-ttu-id="0c9f2-103">Disinstallazione di un provider</span><span class="sxs-lookup"><span data-stu-id="0c9f2-103">Uninstalling a Provider</span></span>

<span data-ttu-id="0c9f2-104">Nell'esempio di codice riportato di seguito viene illustrato il processo necessario per rimuovere un'installazione del provider.</span><span class="sxs-lookup"><span data-stu-id="0c9f2-104">The following sample code demonstrates the process required to remove a provider installation.</span></span>
