...
ms.locfileid: "104336919"
---
# <a name="event-management"></a>Gestione degli eventi

## <a name="in-this-section"></a>Contenuto della sezione

-   [**\_Evento FWPM \_ net \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback0)
-   [*\_Evento FWPM \_ net \_ CALLBACK1*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback1)
-   [*\_Evento FWPM \_ net \_ CALLBACK2*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback2)
