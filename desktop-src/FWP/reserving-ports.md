...
---
# <a name="reserving-ports"></a>Riserva di porte

Il codice di esempio seguente illustra come usare i livelli di assegnazione delle risorse per riservare un intervallo di porte per gli amministratori.
