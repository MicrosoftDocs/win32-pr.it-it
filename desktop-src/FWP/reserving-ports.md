---
title: Riserva di porte
description: Il codice di esempio seguente illustra come usare i livelli di assegnazione delle risorse per riservare un intervallo di porte per gli amministratori.
...
ms.locfileid: "104396942"
---
# <a name="reserving-ports"></a><span data-ttu-id="7ac45-103">Riserva di porte</span><span class="sxs-lookup"><span data-stu-id="7ac45-103">Reserving Ports</span></span>

<span data-ttu-id="7ac45-104">Il codice di esempio seguente illustra come usare i livelli di assegnazione delle risorse per riservare un intervallo di porte per gli amministratori.</span><span class="sxs-lookup"><span data-stu-id="7ac45-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7ac45-105">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="7ac45-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="7ac45-106">**Condizioni di filtro disponibili a ogni livello di filtro**</span><span class="sxs-lookup"><span data-stu-id="7ac45-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
