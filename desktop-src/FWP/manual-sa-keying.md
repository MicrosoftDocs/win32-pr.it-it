---
title: Digitazione manuale SA
description: Nell'esempio di codice riportato di seguito viene illustrato come creare associazioni di sicurezza utilizzando la piattaforma filtro Windows.
...
ms.locfileid: "104515433"
---
# <a name="manual-sa-keying"></a><span data-ttu-id="1091f-103">Digitazione manuale SA</span><span class="sxs-lookup"><span data-stu-id="1091f-103">Manual SA Keying</span></span>

<span data-ttu-id="1091f-104">Nell'esempio di codice seguente viene illustrato come creare associazioni di sicurezza utilizzando la piattaforma filtro Windows.</span><span class="sxs-lookup"><span data-stu-id="1091f-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
