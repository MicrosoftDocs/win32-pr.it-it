...
---
# <a name="using-tunnel-mode"></a><span data-ttu-id="be623-103">Uso della modalità tunnel</span><span class="sxs-lookup"><span data-stu-id="be623-103">Using Tunnel Mode</span></span>

<span data-ttu-id="be623-104">Nell'esempio di codice seguente viene illustrato come configurare un tunnel IPsec Point-to-Point utilizzando l'API Windows Filtering Platform (PAM).</span><span class="sxs-lookup"><span data-stu-id="be623-104">The following sample code demonstrates how to configure a point-to-point IPsec tunnel using the Windows Filtering Platform (WFP) API.</span></span>
