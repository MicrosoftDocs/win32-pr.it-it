...
---
# <a name="installing-a-provider"></a>Installazione di un provider

Nell'esempio di codice seguente viene illustrata l'operazione di installazione del provider della piattaforma filtro Windows.
