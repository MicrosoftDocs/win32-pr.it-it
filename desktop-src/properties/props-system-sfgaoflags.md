...
ms.locfileid: "118464791"
---
# <a name="systemsfgaoflags"></a>System.SFGAOFlags

[**Valori SFGAO**](../shell/sfgao.md) usati in [**IShellFolder::GetAttributesOf**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-ishellfolder-getattributesof).
...
Alcuni [**valori SFGAO**](../shell/sfgao.md) considerati come causa di calcoli lenti o di mancanza di contesto sono esclusi dall'applicazione della maschera [****SFGAO \_ PKEYSFGAOMASK*****.](../shell/sfgao.md)
