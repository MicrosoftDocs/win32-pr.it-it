...
È possibile che l'elemento non esista in un file system, ovvero che non venga aperto tramite CreateFile. Tuttavia, se l'elemento è rappresentato come file e il nome segue la sintassi di denominazione dei file Win32 standard, l'origine dati deve generare questa proprietà. Se l'elemento non è un file, l'origine dati deve generare questa proprietà come VT \_ EMPTY.
...
L'elemento potrebbe non esistere in un file system, ovvero potrebbe non essere aperto tramite CreateFile, ma se l'elemento è rappresentato come file dal senso logico e il nome segue la sintassi di denominazione dei file Win32 standard, l'origine dati deve generare questa proprietà. Se un elemento non è un file, il valore di questa proprietà è VT \_ EMPTY. Vedere System.ItemNameDisplay. Ha lo stesso valore di System.ParsingName per gli elementi forniti dalla cartella file della shell.
...
| c: \\ Stuff \\ MyFolder                | Cartella       |
| \[Messaggio di posta elettronica\]                  | VT \_ EMPTY      |
| \[song.wma nel dispositivo portatile\]    | song.wma       |
