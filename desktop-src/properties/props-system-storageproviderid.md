---
description: Questa proprietà rappresenta la Archiviazione ID provider dell'identificatore del \[ \] provider completo&\# 0034; \[ Archiviazione ID provider \] ! \[ Windows SID \] ! \[ ID account \] & \# 0034;.
...
ms.locfileid: "119774431"
---
# <a name="systemstorageproviderid"></a>System.StorageProviderId

Questa proprietà rappresenta la \[ Archiviazione dell'ID provider completo" Archiviazione \] Provider ID \[ \] ! \[ Windows SID \] ! \[ ID account \] ".
