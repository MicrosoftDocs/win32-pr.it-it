---
description: Informazioni sulla versione del protocollo del chiamante del provider di archiviazione. Il formato di questa proprietà è specifico del provider. Per altre informazioni, vedere la documentazione del provider di archiviazione.
...
ms.locfileid: "119553301"
---
# <a name="systemstorageprovidercallerversioninformation"></a>System.StorageProviderCallerVersionInformation

Informazioni sulla versione del protocollo del chiamante del provider di archiviazione. Il formato di questa proprietà è specifico del provider. Per altre informazioni, vedere la documentazione del provider di archiviazione.
