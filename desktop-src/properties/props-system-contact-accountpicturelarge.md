---
description: Si tratta di un flusso contenente i dati necessari per eseguire il rendering dell'immagine dell'account di grandi dimensioni di un contatto.
...
ms.locfileid: "117867251"
---
# <a name="systemcontactaccountpicturelarge"></a>System.Contact.AccountPictureLarge

Si tratta di un flusso contenente i dati necessari per eseguire il rendering dell'immagine dell'account di grandi dimensioni di un contatto.
