...
È stato aggiunto il requisito di un riferimento alla stringa indiretta specifico per l'attributo `label` **di labelInfo** per Windows Vista con Service Pack 1 (SP1).
