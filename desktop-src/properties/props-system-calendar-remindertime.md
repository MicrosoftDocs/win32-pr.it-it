---
description: Archivia l'ora in cui l'utente sceglie di ricordare l'evento.
...
ms.locfileid: "117867261"
---
# <a name="systemcalendarremindertime"></a>System.Calendar.ReminderTime

Archivia l'ora in cui l'utente sceglie di ricordare l'evento.
