---
description: Windows Tipo di dispositivo Acquisizione immagine (WIA).
...
ms.locfileid: "119822791"
---
# <a name="systemdeviceswiadevicetype"></a>System.Devices.WiaDeviceType

Windows Tipo di dispositivo Acquisizione immagine (WIA).
...
```
propertyDescription
   name = System.Devices.WiaDeviceType
   shellPKey = PKEY_Devices_WiaDeviceType
   formatID = 6BDD1FC6-810F-11D0-BEC7-08002BE2092F
   propID = 2
   SearchInfo
