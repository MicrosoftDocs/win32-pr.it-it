---
description: Questa proprietà rappresenta lo stato di condivisione più permissivo per il file o la cartella specificata dal provider di archiviazione. Gli stati di condivisione dal più grande al meno permissivo sono Owned > Co-owned > Public > Shared > Private.StorageProviderSharingStatus è una proprietà di sola lettura.
...
ms.locfileid: "119095668"
---
# <a name="systemstorageprovidersharingstatus"></a>System.StorageProviderSharingStatus

Questa proprietà rappresenta lo stato di condivisione più permissivo per il file o la cartella specificata dal provider di archiviazione. Gli stati di condivisione dal più grande al meno permissivo sono Owned > Co-owned > Public > Shared > Private.StorageProviderSharingStatus è una proprietà di sola lettura.
