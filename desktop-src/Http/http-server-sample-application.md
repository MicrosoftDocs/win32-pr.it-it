...
## <a name="receive-a-request"></a>Ricevere una richiesta
...
## <a name="send-an-http-response"></a>Inviare una risposta HTTP
...
## <a name="send-an-http-post-response"></a>Inviare una risposta HTTP POST
