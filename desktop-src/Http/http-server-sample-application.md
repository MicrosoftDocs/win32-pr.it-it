...
---
# <a name="http-server-sample-application"></a><span data-ttu-id="a189c-103">Applicazione di esempio server HTTP</span><span class="sxs-lookup"><span data-stu-id="a189c-103">HTTP Server Sample Application</span></span>

<span data-ttu-id="a189c-104">Nell'applicazione di esempio seguente viene illustrato come utilizzare l'API del server HTTP per eseguire attività lato server.</span><span class="sxs-lookup"><span data-stu-id="a189c-104">The following sample application shows how to use the HTTP Server API to perform server-side tasks.</span></span> <span data-ttu-id="a189c-105">Il file "PRECOMP. h" incluso nel primo esempio include tutte le intestazioni necessarie per eseguire gli esempi, ad esempio:</span><span class="sxs-lookup"><span data-stu-id="a189c-105">The "precomp.h" file included in the first example includes all the headers necessary to run the samples, for example:</span></span>
...
## <a name="main-and-preliminaries"></a><span data-ttu-id="a189c-106">Principale e preliminare</span><span class="sxs-lookup"><span data-stu-id="a189c-106">Main and Preliminaries</span></span>
...
## <a name="initialize-the-http-service"></a><span data-ttu-id="a189c-107">Inizializzare il servizio HTTP</span><span class="sxs-lookup"><span data-stu-id="a189c-107">Initialize the HTTP Service</span></span>
...
## <a name="register-the-urls-to-listen-on"></a><span data-ttu-id="a189c-108">Registrare gli URL per l'ascolto</span><span class="sxs-lookup"><span data-stu-id="a189c-108">Register the URLs to Listen On</span></span>
...
## <a name="call-the-routine-to-receive-a-request"></a><span data-ttu-id="a189c-109">Chiamare la routine per ricevere una richiesta</span><span class="sxs-lookup"><span data-stu-id="a189c-109">Call the Routine to Receive a Request</span></span>
...
## <a name="cleanup-the-http-server-api"></a><span data-ttu-id="a189c-110">Pulire l'API del server HTTP</span><span class="sxs-lookup"><span data-stu-id="a189c-110">Cleanup the HTTP Server API</span></span>
...
## <a name="receive-a-request"></a><span data-ttu-id="a189c-111">Ricevere una richiesta</span><span class="sxs-lookup"><span data-stu-id="a189c-111">Receive a Request</span></span>
...
## <a name="handle-the-http-request"></a><span data-ttu-id="a189c-112">Gestire la richiesta HTTP</span><span class="sxs-lookup"><span data-stu-id="a189c-112">Handle the HTTP Request</span></span>
...
## <a name="send-an-http-response"></a><span data-ttu-id="a189c-113">Inviare una risposta HTTP</span><span class="sxs-lookup"><span data-stu-id="a189c-113">Send an HTTP Response</span></span>
...
## <a name="send-an-http-post-response"></a><span data-ttu-id="a189c-114">Inviare una risposta HTTP POST</span><span class="sxs-lookup"><span data-stu-id="a189c-114">Send an HTTP POST Response</span></span>
