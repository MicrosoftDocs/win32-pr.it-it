...
---
# <a name="requeststatechange-method-of-the-msvm_serialcontroller-class"></a>Metodo RequestStateChange della classe Msvm \_ SerialController
...
| Requisito | Valore |
|-------------------------------------|---------------------------------------------------------------------------------------------------------|
| Client minimo supportato<br/> | Windows 8.1, versione 1703<br/>                                                                    |
