...
---
# <a name="msvm_serialport-class"></a>\_Classe SerialPort MSVM
...
La **classe \_ SerialPort di MSVM** dispone di questi tipi di membri:
...
La **classe \_ SerialPort MSVM** presenta questi metodi.
...
La **classe \_ SerialPort di MSVM** dispone di queste proprietà.
...
Questa proprietà viene ereditata da [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)ed è impostata su "Microsoft:*GUID* \\ *Device-Specific-Data*", in cui *i dati specifici del dispositivo* sono facoltativi.
...
Stato abilitato dell'elemento. Può inoltre indicare le transizioni tra questi stati richiesti. Questa proprietà viene ereditata da [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85)).
...
L'accesso alla **classe \_ SerialPort MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
