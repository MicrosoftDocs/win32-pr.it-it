---
description: Per alcuni esempi di virtualizzazione C# vengono usate le utilità seguenti.
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: Utilità comuni per gli esempi di virtualizzazione (v2)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103883061"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="e7bee-103">Utilità comuni per gli esempi di virtualizzazione (v2)</span><span class="sxs-lookup"><span data-stu-id="e7bee-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="e7bee-104">Per alcuni esempi di virtualizzazione C# vengono usate le utilità seguenti.</span><span class="sxs-lookup"><span data-stu-id="e7bee-104">The following utilities are used by some of the C# virtualization samples.</span></span>
