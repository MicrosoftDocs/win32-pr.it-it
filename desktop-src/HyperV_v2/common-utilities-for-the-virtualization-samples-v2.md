...
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a>Utilità comuni per gli esempi di virtualizzazione (v2)

Per alcuni esempi di virtualizzazione C# vengono usate le utilità seguenti.
