...
La **classe \_ InstalledEthernetSwitchExtension di MSVM** dispone di questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ InstalledEthernetSwitchExtension di MSVM** dispone di queste proprietà.
...
Versione dell'estensione in un formato "Major. minor", ad esempio "2,0".
