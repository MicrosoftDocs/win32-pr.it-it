...
---
# <a name="checkvirtualsystemismigratabletohost-method-of-the-msvm_virtualsystemmigrationservice-class"></a>Metodo CheckVirtualSystemIsMigratableToHost della classe MSVM \_ VirtualSystemMigrationService

Determina se è possibile eseguire la migrazione del sistema virtuale specificato a un host di destinazione specificato da un nome di rete o un indirizzo IP.
...
Riferimento a un'istanza della classe [**MSVM \_ ComputerSystem**](msvm-computersystem.md) che rappresenta la macchina virtuale di cui verificare la capacità di migrazione.
...
Riceve il risultato del controllo della migrazione che indica se è possibile eseguire correttamente la migrazione del sistema virtuale.
