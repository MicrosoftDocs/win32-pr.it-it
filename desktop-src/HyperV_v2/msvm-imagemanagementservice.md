...
---
# <a name="msvm_imagemanagementservice-class"></a>\_Classe MSVM servizio

Gestisce i file multimediali virtuali (file con estensione VHD, VHDX, ISO o VFD) per una macchina virtuale.
...
La **classe \_ servizio di MSVM** dispone di questi tipi di membri:
...
La **classe \_ servizio di MSVM** dispone di questi metodi.



| Metodo                                                                                                           | Descrizione                                                                                                                                                                                                                                 |
|:-----------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AttachVirtualHardDisk**](attachvirtualharddisk-msvm-imagemanagementservice.md)                               | Connette un file di immagine del disco virtuale in modalità loopback.<br/>                                                                                                                                                                             |
| [**CompactVirtualHardDisk**](compactvirtualharddisk-msvm-imagemanagementservice.md)                             | Compatta un file di disco rigido virtuale.<br/>                                                                                                                                                                                               |
...
| [**ConvertVirtualHardDiskToVHDSet**](msvm-imagemanagementservice-convertvirtualharddisktovhdset.md)             | Converte un file di disco rigido virtuale creando un nuovo file di set VHD insieme al disco rigido virtuale esistente.<br/>                                                                                                                       |
| [**CreateVirtualFloppyDisk**](createvirtualfloppydisk-msvm-imagemanagementservice.md)                           | Consente di creare un file di disco floppy virtuale.<br/>                                                                                                                                                                                              |
| [**CreateVirtualHardDisk**](createvirtualharddisk-msvm-imagemanagementservice.md)                               | Crea un file di disco rigido virtuale.<br/>                                                                                                                                                                                                |
| [**DeleteVHDSnapshot**](msvm-imagemanagementservice-deletevhdsnapshot.md)                                       | Elimina una voce di snapshot VHD all'interno di un file di set VHD.<br/>                                                                                                                                                                              |
| [**FindMountedStorageImageInstance**](msvm-imagemanagementservice-findmountedstorageimageinstance.md)           | Trova un \_ oggetto MSVM MountedStorageImage per un determinato percorso dell'immagine disco.<br/>                                                                                                                                                            |
| [**GetVHDSetInformation**](msvm-imagemanagementservice-getvhdsetinformation.md)                                 | Recupera le informazioni su un file di set VHD.<br/>                                                                                                                                                                                      |
| [**GetVHDSnapshotInformation**](msvm-imagemanagementservice-getvhdsnapshotinformation.md)                       | Recupera le informazioni su uno snapshot del disco rigido virtuale all'interno di un file di set VHD.<br/>                                                                                                                                                                |
| [**GetVirtualDiskChanges**](msvm-imagemanagementservice-getvirtualdiskchanges.md)                               | Recupera un elenco di modifiche nell'area specificata di un disco virtuale a partire dall'ID di Rilevamento modifiche resiliente fornito o dall'ID dello snapshot VHDSet.<br/>                                                                                     |
| [**GetVirtualHardDiskSettingData**](getvirtualharddisksettingdata-msvm-imagemanagementservice.md)               | Recupera i dati di impostazione associati ai file del disco rigido virtuale.<br/>                                                                                                                                                                  |
...
| [**MergeVirtualHardDisk**](mergevirtualharddisk-msvm-imagemanagementservice.md)                                 | Unisce un disco rigido virtuale figlio in una catena di differenze con uno o più dischi rigidi virtuali padre nella catena.<br/>                                                                                                                |
| [**OptimizeVHDSet**](msvm-imagemanagementservice-optimizevhdset.md)                                             | Ottimizza un file di set VHD in modo da utilizzare meno spazio su disco.<br/>                                                                                                                                                                                 |
...
| [**SetParentVirtualHardDisk**](setparentvirtualharddisk-msvm-imagemanagementservice.md)                         | Aggiorna l'elemento padre per i file di disco rigido virtuale foglia e figlio specificati.<br/>                                                                                                                                                     |
| [**SetVHDSnapshotInformation**](msvm-imagemanagementservice-setvhdsnapshotinformation.md)                       | Modifica una voce di snapshot VHD all'interno di un file di set VHD. Se l'ID dello snapshot in questione esiste già, la voce di snapshot esistente verrà sovrascritta con la nuova voce. In caso contrario, la nuova voce verrà aggiunta al file di set VHD.<br/> |
| [**SetVirtualHardDiskSettingData**](setvirtualharddisksettingdata-msvm-imagemanagementservice.md)               | Imposta un file di disco rigido virtuale.<br/>                                                                                                                                                                                                   |
...
| [**ValidatePersistentReservationSupport**](msvm-imagemanagementservice-validatepersistentreservationsupport.md) | Verifica se un file system può supportare un disco rigido virtuale con prenotazioni permanenti abilitate.<br/>                                                                                                                            |
| [**ValidateVirtualHardDisk**](validatevirtualharddisk-msvm-imagemanagementservice.md)                           | Verifica se un'immagine del disco virtuale può essere aperta in modalità di sola lettura.<br/>                                                                                                                                                          |
...
La **classe \_ servizio di MSVM** dispone di queste proprietà.
...
Breve descrizione dell'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Hyper-V Image Management Service".
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "MSVM \_ servizio".
...
Descrizione dell'oggetto . Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "fornisce la manutenzione delle immagini per Hyper-V".
...
Nome visualizzato per l'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Hyper-V Image Management Service".
...
Qualificatori: **chiave**, **override** ("Name"), **maxlen** (256)
</dt> </dl>

Etichetta con cui l'oggetto è noto. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "vhdsvc".
...
Stato corrente dell'oggetto. Questa proprietà viene ereditata da [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)e ogni elemento della matrice è sempre impostato su 2 (OK).
...
Stringa che fornisce informazioni sul modo in cui è possibile raggiungere il proprietario principale del servizio (ad esempio, numero di telefono, indirizzo di posta elettronica e così via). Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su **null**.
...
Ultimo stato richiesto o desiderato per l'elemento. Lo stato effettivo dell'elemento è rappresentato da **EnabledState**. Questa proprietà viene fornita per confrontare l'ultimo stato richiesto e corrente abilitato o disabilitato. Una particolare istanza di **EnabledLogicalElement** potrebbe non supportare **RequestedStateChange**. In tal caso, viene utilizzato il valore 12 (non applicabile). Questa proprietà viene ereditata da [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85))ed è sempre impostata su 12 (non applicabile).
...
Indica se il servizio è stato avviato. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su **true**.
...
L'accesso alla **classe \_ servizio di MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
