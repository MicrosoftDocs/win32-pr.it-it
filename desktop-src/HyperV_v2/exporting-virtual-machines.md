---
description: Gli esempi C# e Visual Basic Scripting Edition (VBScript) seguenti illustrano l'esportazione di uno snapshot di una macchina virtuale.
...
---
# <a name="exporting-a-snapshot-of-a-virtual-machine"></a><span data-ttu-id="11c1d-103">Esportazione di uno snapshot di una macchina virtuale</span><span class="sxs-lookup"><span data-stu-id="11c1d-103">Exporting a snapshot of a virtual machine</span></span>

<span data-ttu-id="11c1d-104">Gli esempi C# e Visual Basic Scripting Edition (VBScript) seguenti illustrano l'esportazione di uno snapshot di una macchina virtuale.</span><span class="sxs-lookup"><span data-stu-id="11c1d-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting a snapshot of a virtual machine.</span></span> <span data-ttu-id="11c1d-105">Gli esempi che illustrano l'esportazione di una macchina virtuale sono disponibili nell'argomento [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) .</span><span class="sxs-lookup"><span data-stu-id="11c1d-105">Samples that demonstrate exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) topic.</span></span>

<span data-ttu-id="11c1d-106">Le utilità C# a cui si fa riferimento sono disponibili in [utilità comuni per gli esempi di virtualizzazione (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="11c1d-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="11c1d-107">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="11c1d-107">Related topics</span></span>

[<span data-ttu-id="11c1d-108">Esportazione della configurazione di una macchina virtuale</span><span class="sxs-lookup"><span data-stu-id="11c1d-108">Exporting the configuration of a virtual machine</span></span>](exporting-the-configuration-of-a-virtual-machine.md)

[<span data-ttu-id="11c1d-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="11c1d-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
