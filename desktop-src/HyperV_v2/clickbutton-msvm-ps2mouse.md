...
Simula un clic del pulsante del dispositivo specificato. Questa operazione equivale a chiamare due volte [**SetButtonState**](setbuttonstate-msvm-syntheticmouse.md) , prima di tutto per premere il pulsante e di nuovo per rilasciarlo.
