...
---
# <a name="msvm_virtualethernetswitch-class"></a>\_Classe MSVM VirtualEthernetSwitch

Rappresenta un Commuter Ethernet virtuale. Ogni Commuter dispone di molte porte diverse a cui è possibile collegare le schede di rete. Il Commuter non è altamente configurabile e funge principalmente da segnaposto.
...
La **classe \_ VirtualEthernetSwitch di MSVM** dispone di questi tipi di membri:
...
La **classe \_ VirtualEthernetSwitch di MSVM** dispone di questi metodi.



| Metodo                                                                      | Descrizione                              |
|:----------------------------------------------------------------------------|:-----------------------------------------|
| [**RequestStateChange**](msvm-virtualethernetswitch-requeststatechange.md) | Richiede una modifica dello stato.<br/>      |
...
La **classe \_ VirtualEthernetSwitch di MSVM** dispone di queste proprietà.
...
Breve descrizione dell'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Virtual Switch".
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ sistema CIM**](/windows/desktop/CIMWin32Prov/cim-system)ed è sempre impostata su "MSVM \_ VirtualEthernetSwitch".
...
Descrizione dell'oggetto . Questa proprietà viene ereditata da [**CIM \_ managementelement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Microsoft Virtual Switch".
...
Il numero massimo di offload della funzione virtuale Single root IO Virtualization (SR-IOV) disponibili in questa opzione.
...
Numero massimo di offload della coda della macchina virtuale (VMQ) consentiti per una porta in questa opzione.
...
Questa proprietà viene ereditata da [**CIM \_ ComputerSystem**](/windows/desktop/CIMWin32Prov/cim-computersystem)ed è sempre impostata su 5 (non implementato).
