...
ms.locfileid: "118146774"
---
# <a name="msvm_syntheticfcport-class"></a>Classe Msvm \_ SyntheticFcPort
...
Rappresenta una porta Fibre Channel sintetica.
...
La **classe Msvm \_ SyntheticFcPort** ha questi tipi di membri:
...
La **classe Msvm \_ SyntheticFcPort** include questi metodi.
...
| [**RequestStateChange**](msvm-syntheticfcport-requeststatechange.md) | Richiede una modifica dello stato.<br/>      |
| [**Reset**](msvm-syntheticfcport-reset.md)                           | Reimposta il dispositivo virtuale.<br/>    |
...
La **classe Msvm \_ SyntheticFcPort** ha queste proprietà.
...
Configurazione predefinita o di avvio di un amministratore per la **proprietà EnabledState** di un elemento. Questa proprietà viene ereditata da [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85))ed è sempre impostata su 2 (abilitato).
...
Matrice di interi che indica le Fibre Channel di servizio (COS) supportate. L'elemento COS attivo viene specificato **dalla proprietà ActiveCOS.** Questa proprietà viene ereditata da **CIM \_ FCPort.**
...
Matrice di numeri interi che indica Fibre Channel i protocolli FC-4 supportati. I protocolli attivi e in esecuzione vengono specificati dalla **proprietà ActiveFC4Types.** Questa proprietà viene ereditata da **CIM \_ FCPort.**
...
<span id="BBL_802.3_Encapsulated_LAN_PDU"></span><span id="bbl_802.3_encapsulated_lan_pdu"></span><span id="BBL_802.3_ENCAPSULATED_LAN_PDU"></span>**BBL 802.3 PDU LAN incapsulata** (82)
</dt> <dt>
...
Unità massima di trasmissione (MTU) che può essere supportata, in byte. Questa proprietà viene ereditata da [**CIM \_ NetworkPort.**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)
