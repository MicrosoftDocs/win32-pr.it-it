...
La **classe \_ SyntheticFcPort di MSVM** dispone di questi tipi di membri:
...
La **classe \_ SyntheticFcPort di MSVM** dispone di questi metodi.
...
La **classe \_ SyntheticFcPort di MSVM** dispone di queste proprietà.
