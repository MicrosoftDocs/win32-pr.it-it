...
---
# <a name="querying-networking-objects"></a><span data-ttu-id="e96a2-103">Esecuzione di query sugli oggetti di rete</span><span class="sxs-lookup"><span data-stu-id="e96a2-103">Querying networking objects</span></span>

<span data-ttu-id="e96a2-104">Nell'esempio C# seguente vengono recuperate e visualizzate informazioni sulla rete fisica e virtuale per l'opzione specificata.</span><span class="sxs-lookup"><span data-stu-id="e96a2-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="e96a2-105">Questo codice viene tratto dall' [esempio di rete Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span><span class="sxs-lookup"><span data-stu-id="e96a2-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="e96a2-106">La sintassi della riga di comando per eseguire questo esempio è:</span><span class="sxs-lookup"><span data-stu-id="e96a2-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="e96a2-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span><span class="sxs-lookup"><span data-stu-id="e96a2-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="e96a2-108">dove *SwitchName* è il nome dell'opzione per la quale visualizzare le informazioni.</span><span class="sxs-lookup"><span data-stu-id="e96a2-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="e96a2-109">Il nome dell'opzione è contenuto nella proprietà [**MSVM \_ VirtualEthernetSwitch. ElementName**](msvm-virtualethernetswitch.md) .</span><span class="sxs-lookup"><span data-stu-id="e96a2-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
