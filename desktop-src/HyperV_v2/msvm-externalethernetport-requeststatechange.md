...
---
# <a name="requeststatechange-method-of-the-msvm_externalethernetport-class"></a>Metodo RequestStateChange della classe MSVM \_ ExternalEthernetPort
...
[**\_ExternalEthernetPort MSVM**](msvm-externalethernetport.md)
</dt> </dl>
