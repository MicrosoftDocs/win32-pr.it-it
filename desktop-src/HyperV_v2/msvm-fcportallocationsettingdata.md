...
Rappresenta lo stato configurato di una porta Fibre Channel sintetica o di una porta di commutazione Fibre Channel.
...
La **classe \_ FcPortAllocationSettingData di MSVM** dispone di questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ FcPortAllocationSettingData di MSVM** dispone di queste proprietà.
