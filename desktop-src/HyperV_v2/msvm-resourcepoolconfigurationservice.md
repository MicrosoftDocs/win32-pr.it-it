...
title: Msvm_ResourcePoolConfigurationService classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119561501"
---
# <a name="msvm_resourcepoolconfigurationservice-class"></a>Classe \_ Msvm ResourcePoolConfigurationService
...
La **classe Msvm \_ ResourcePoolConfigurationService** ha questi tipi di membri:
...
La **classe Msvm \_ ResourcePoolConfigurationService** dispone di questi metodi.
...
La **classe Msvm \_ ResourcePoolConfigurationService** ha queste proprietà.
...
Nome della classe o della sottoclasse utilizzata nella creazione di un'istanza. Questa proprietà viene ereditata dal [**servizio CIM. \_**](/windows/desktop/CIMWin32Prov/cim-service)
