...
---
# <a name="destroycollection-method-of-the-msvm_collectionmanagementservice-class"></a>Metodo destroycollection della \_ classe CollectionManagementService di MSVM

Elimina l'oggetto [**\_ CollectionOfMSEs CIM**](cim-collectionofmses.md) specificato.
...
Raccolta da eliminare definitivamente.
