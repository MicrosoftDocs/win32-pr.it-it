...
---
# <a name="requeststatechange-method-of-the-msvm_externalfcport-class"></a>Metodo RequestStateChange della classe MSVM \_ ExternalFcPort
...
[**\_ExternalFcPort MSVM**](msvm-externalfcport.md)
</dt> </dl>
