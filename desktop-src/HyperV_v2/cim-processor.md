...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Processore DMTF \| \| 017.3"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**Processore CIM \_**.**OtherFamilyDescription**")
</dt> </dl>
...
**AMD Athlon(TM) 64 X2 Dual-Core processori** (136)
...
**Processore mobile Intel(R) Core(TM)2 Extreme** (195)
...
**Processore mobile Intel(R) Core(TM)2 Solo** (197)
...
**AmD Phenom(TM) Triple-Core processore** (231)
...
**Famiglia di processori SI AMD Sempron(TM)** (235)
...
Ruolo del processore, ad esempio "Processore centrale" o "Processore matematico".
...
Qualificatori: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**Processore CIM \_**.**Famiglia**")
</dt> </dl>
...
Identificatore univoco globale per il processore, all'interno dell'ambito della famiglia di processori.
