...
---
# <a name="cim_processor-class-hyper-v-management"></a>Classe CIM_Processor (gestione Hyper-V)
...
La classe del **\_ processore CIM** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe del **\_ processore CIM** dispone di queste proprietà.
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("bits"), **punible** ("bit")
</dt> </dl>
...
**CPU disabilitata dall'utente** (2)
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("megahertz"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 017,6 "), **punito** (" Hertz \* 10 ^ 6 ")
</dt> </dl>
...
Qualificatori: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 017,3 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processore CIM**.**OtherFamilyDescription**")
</dt> </dl>

Tipo di famiglia del processore.
...
**Processore Intel (R) Core (TM) Duo Mobile** (41)
...
**Processore Intel (R) Core (TM) solo per dispositivi mobili** (42)
...
**Famiglia di processori AMD Turion (TM) II Ultra Dual-Core mobile M** (56)
...
**Famiglia di processori AMD Turion (TM) II Dual-Core mobile M** (57)
...
**Famiglia di processori AMD Athlon (TM) II Dual-Core mobile M** (58)
...
**Processore di serie AMD Opteron (TM) 6100** (59)
...
**Processore di serie AMD Opteron (TM) 4100** (60)
...
**Tecnologia mobile AMD Turion (TM) 64** (134)
...
**Famiglia di processori AMD Athlon (TM) 64 X2 Dual-Core** (136)
...
**Tecnologia mobile AMD Turion (TM) 64 X2** (137)
...
**Famiglia di processori AMD Phenom (TM) FX Quad-Core** (140)
...
**Famiglia di processori AMD Phenom (TM) X4 Quad-Core** (141)
...
**Famiglia di processori AMD Phenom (TM) X2 Dual-Core** (142)
...
**Famiglia di processori AMD Athlon (TM) X2 Dual-Core** (143)
...
**Serie 3200 processore Intel (r) Xeon (r) quad core** (161)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 3000** (162)
...
**Serie 5300 processore Intel (r) Xeon (r) quad core** (163)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 5100** (164)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 5000** (165)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 7100** (168)
...
**Serie 5400 processore Intel (r) Xeon (r) quad core** (169)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 5200** (171)
...
**Serie processore Intel (r) Xeon (r) Dual-Core 7200** (172)
...
**Serie 7300 processore Intel (r) Xeon (r) quad core** (173)
...
**Serie 7400 processore Intel (r) Xeon (r) quad core** (174)
...
**Serie di processori Intel (r) Xeon (r) a più Core 7400** (175)
...
**MP processore Intel (R) Xeon (TM)** (181)
...
**Intel (R) Core (TM) 2 processore singolo** (192)
...
**Processore Intel (R) Core (TM) 2 Duo Mobile** (196)
...
**Processore Intel (R) Core (TM) 2 solo per dispositivi mobili** (197)
...
**Processore Intel (r) Celeron (r) Dual-Core** (199)
...
**Famiglia di processori via C7 (TM)-M** (210)
...
**Famiglia di processori via C7 (TM)-D** (211)
...
**Famiglia di processori via Eden (TM)** (213)
...
**Processore Intel (r) Xeon (r) multicore** (214)
...
**Serie 3xxx processore Intel (r) Xeon (r) Dual Core** (215)
...
**Serie 3xxx processore Intel (r) Xeon (r) quad core** (216)
...
**Serie 5xxx processore Intel (r) Xeon (r) Dual Core** (218)
...
**Serie 5xxx processore Intel (r) Xeon (r) quad core** (219)
...
**Serie 7xxx processore Intel (r) Xeon (r) Dual Core** (221)
...
**Serie 7xxx processore Intel (r) Xeon (r) quad core** (222)
...
**Serie 7xxx processori Intel (r) Xeon (r) multicore** (223)
...
**Serie di processori Intel (r) Xeon (r) a più Core 3400** (224)
...
**Famiglia di processori AMD Phenom (TM) Triple-Core** (231)
...
**Famiglia di processori AMD Turion (TM) Ultra Dual-Core mobile** (232)
...
**Famiglia di processori AMD Turion (TM) Dual-Core mobile** (233)
...
**Famiglia di processori AMD Athlon (TM) Dual-Core** (234)
...
**Riservato (per assegnazione speciale per scopi futuri)** (65534)
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("percentuale"), [**misuratore**](/windows/desktop/WmiSdk/standard-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIB. IETF \| host-Resources-MIB. hrProcessorLoad "), **punito** (" percent ")
</dt> </dl>

Il caricamento del processore, medio nell'ultimo minuto, come percentuale.
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("megahertz"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processore DMTF \| 017,5 "), **punito** (" Hertz \* 10 ^ 6 ")
</dt> </dl>
...
Qualificatori: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processore CIM**.**Famiglia**")
</dt> </dl>

Tipo di famiglia del processore quando la proprietà **Family** è impostata su **other** ("1"). Questa stringa deve essere impostata su NULL se la proprietà Family è un valore diverso da **other**.
...
Ruolo del processore, ad esempio "Central Processor" o "Math Processor".
...
Qualificatori: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processore CIM**.**Famiglia**")
</dt> </dl>

Livello di revisione del processore all'interno della famiglia di processori.
...
Identificatore univoco globale per il processore, nell'ambito della famiglia di processori.
