...
Rappresenta il servizio di virtualizzazione presente in un singolo sistema host. **MSVM \_ VirtualSystemManagementService** viene usato per controllare la definizione, la modifica e l'eliminazione delle macchine virtuali. Dispone inoltre di metodi per l'esecuzione di operazioni sulle macchine virtuali, ad esempio la clonazione, istantanee, e l'importazione o l'esportazione di macchine virtuali. Per recuperare le informazioni per macchina virtuale, usare [**MSVM \_ ComputerSystem**](msvm-computersystem.md).
...
La **classe \_ VirtualSystemManagementService di MSVM** dispone di questi tipi di membri:
...
La **classe \_ VirtualSystemManagementService di MSVM** dispone di questi metodi.



| Metodo                                                                                                                 | Descrizione                                                                                                                                                                                                                                        |
|:-----------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddBootSourceSettings**](msvm-virtualsystemmanagementservice-addbootsourcesettings.md)                             | Aggiunge origini di avvio a una configurazione di sistema virtuale quando viene applicata a una configurazione di sistema virtuale "stato".<br/>                                                                                                                             |
| [**AddFeatureSettings**](addfeaturesettings-msvm-virtualsystemmanagementservice.md)                                   | Aggiunge le impostazioni delle funzionalità Ethernet alla configurazione di una connessione Ethernet della macchina virtuale.<br/>                                                                                                                                           |
| [**AddFibreChannelChap**](addfibrechannelchap-msvm-virtualsystemmanagementservice.md)                                 | Aggiunge i parametri DH-CHAP a una porta Fibre Channel sintetica in una macchina virtuale.<br/>                                                                                                                                                         |
| [**AddGuestServiceSettings**](msvm-virtualsystemmanagementservice-addguestservicesettings.md)                         | Aggiunge le impostazioni del servizio Guest a una configurazione di sistema virtuale.<br/> Quando applicato alle parti di una configurazione di sistema virtuale "corrente", è possibile che vengano modificati i servizi guest di un effetto collaterale del sistema virtuale attivo.<br/>              |
| [**AddKvpItems**](addkvpitems-msvm-virtualsystemmanagementservice.md)                                                 | Aggiunge coppie chiave-valore a una macchina virtuale.<br/>                                                                                                                                                                                              |
| [**AddResourceSettings**](addresourcesettings-msvm-virtualsystemmanagementservice.md)                                 | Aggiunge risorse a una configurazione di macchina virtuale.<br/>                                                                                                                                                                                      |
| [**AddSystemComponentSettings**](msvm-virtualsystemmanagementservice-addsystemcomponentsettings.md)                   | Aggiunge impostazioni generiche a una configurazione di sistema virtuale.<br/>                                                                                                                                                                                |
| [**DefinePlannedSystem**](msvm-virtualsystemmanagementservice-defineplannedsystem.md)                                 | Definisce un sistema virtuale pianificato.<br/> L'input non completamente specificato può essere compilato con i valori predefiniti.<br/>                                                                                                              |
| [**DefineSystem**](definesystem-msvm-virtualsystemmanagementservice.md)                                               | Crea una nuova definizione di macchina virtuale.<br/>                                                                                                                                                                                               |
| [**DestroySystem**](destroysystem-msvm-virtualsystemmanagementservice.md)                                             | Elimina una definizione di macchina virtuale esistente.<br/>                                                                                                                                                                                         |
| [**DiagnoseNetworkConnection**](msvm-virtualsystemmanagementservice-diagnosenetworkconnection.md)                     | Diagnostica la connettività di rete di una macchina virtuale in un ambiente di virtualizzazione rete Windows.<br/>                                                                                                                                             |
| [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)                           | Esporta in un file una macchina virtuale o uno snapshot di una macchina virtuale.<br/>                                                                                                                                                               |
| [**FormatError**](formaterror-msvm-virtualsystemmanagementservice.md)                                                 | Restituisce una stringa del messaggio di errore formattato per la matrice specificata di istanze di [**\_ errore MSVM**](msvm-error.md) incorporate.<br/>                                                                                                               |
| [**GenerateWwpn**](generatewwpn-msvm-virtualsystemmanagementservice.md)                                               | Genera un set di nomi di porta universali (WWPNs).<br/>                                                                                                                                                                                       |
| [**GetCurrentWwpnFromGenerator**](getcurrentwwpnfromgenerator-msvm-virtualsystemmanagementservice.md)                 | Offre la possibilità di visualizzare in anteprima il nome della porta universale (WWPN) corrente senza il WWPN riservato.<br/>                                                                                                                                |
| [**GetDefinitionFileSummaryInformation**](getdefinitionfilesummaryinformation-msvm-virtualsystemmanagementservice.md) | Restituisce le informazioni di riepilogo della macchina virtuale per i file di definizione della macchina virtuale specificati.<br/>                                                                                                                                         |
| [**GetSizeOfSystemFiles**](getsizeofsystemfiles-msvm-virtualsystemmanagementservice.md)                               | Recupera le dimensioni totali dei file di sistema della macchina virtuale.<br/>                                                                                                                                                                        |
| [**GetSummaryInformation**](getsummaryinformation-msvm-virtualsystemmanagementservice.md)                             | Restituisce informazioni di riepilogo sulla macchina virtuale.<br/>                                                                                                                                                                                            |
| [**GetVirtualSystemThumbnailImage**](getvirtualsystemthumbnailimage-msvm-virtualsystemmanagementservice.md)           | Recupera un'immagine di anteprima di una macchina virtuale esistente.<br/>                                                                                                                                                                             |
| [**ImportSnapshotDefinitions**](importsnapshotdefinitions-msvm-virtualsystemmanagementservice.md)                     | Cerca nella cartella specificata tutti i file di definizione dello snapshot associati al sistema del computer pianificato specificato e crea un nuovo snapshot nel sistema del computer pianificato per ogni file di definizione associato in questo percorso.<br/> |
| [**ImportSystemDefinition**](importsystemdefinition-msvm-virtualsystemmanagementservice.md)                           | Crea un nuovo sistema di computer pianificato in base alla definizione della macchina virtuale specificata.<br/>                                                                                                                                                |
| [**ModifyDiskMergeSettings**](modifydiskmergesettings-msvm-virtualsystemmanagementservice.md)                         | Modifica i dati delle impostazioni di merge del disco.<br/>                                                                                                                                                                                                   |
| [**ModifyFeatureSettings**](modifyfeaturesettings-msvm-virtualsystemmanagementservice.md)                             | Modifica le impostazioni correnti della funzionalità di una connessione Ethernet della macchina virtuale.<br/>                                                                                                                                                         |
| [**ModifyGuestServiceSettings**](msvm-virtualsystemmanagementservice-modifyguestservicesettings.md)                   | Modifica le impostazioni del servizio Guest.<br/> Quando applicato alle parti di una configurazione di sistema virtuale "corrente", è possibile che vengano modificati i servizi guest di un effetto collaterale del sistema virtuale attivo.<br/>                                            |
| [**ModifyKvpItems**](modifykvpitems-msvm-virtualsystemmanagementservice.md)                                           | Modifica le coppie chiave-valore esistenti in una macchina virtuale.<br/>                                                                                                                                                                                 |
| [**ModifyResourceSettings**](modifyresourcesettings-msvm-virtualsystemmanagementservice.md)                           | Modifica le impostazioni delle risorse virtuali.<br/>                                                                                                                                                                                                     |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-virtualsystemmanagementservice.md)                             | Modifica i dati di impostazione del servizio.<br/>                                                                                                                                                                                                    |
| [**ModifySystemComponentSettings**](msvm-virtualsystemmanagementservice-modifysystemcomponentsettings.md)             | Modifica le impostazioni del componente di sistema generico.<br/>                                                                                                                                                                                             |
| [**ModifySystemSettings**](modifysystemsettings-msvm-virtualsystemmanagementservice.md)                               | Modifica le impostazioni della macchina virtuale.<br/>                                                                                                                                                                                                      |
| [**RealizePlannedSystem**](realizeplannedsystem-msvm-virtualsystemmanagementservice.md)                               | Convalida la configurazione di una macchina virtuale pianificata e la converte in una macchina virtuale realizzata.<br/>                                                                                                                                 |
| [**RemoveBootSourceSettings**](msvm-virtualsystemmanagementservice-removebootsourcesettings.md)                       | Rimuove le impostazioni delle risorse virtuali da una configurazione di sistema virtuale.<br/> Quando applicato alle parti di una configurazione di sistema virtuale "corrente", è possibile che vengano rimosse le risorse degli effetti collaterali del sistema virtuale attivo.<br/>            |
| [**RemoveFeatureSettings**](removefeaturesettings-msvm-virtualsystemmanagementservice.md)                             | Rimuove le impostazioni della funzionalità da una connessione Ethernet della macchina virtuale.<br/>                                                                                                                                                                    |
| [**RemoveFibreChannelChap**](removefibrechannelchap-msvm-virtualsystemmanagementservice.md)                           | Rimuove i parametri DH-CHAP da una porta Fibre Channel sintetica in una macchina virtuale.<br/>                                                                                                                                                    |
| [**RemoveGuestServiceSettings**](msvm-virtualsystemmanagementservice-removeguestservicesettings.md)                   | Rimuove le impostazioni del servizio Guest da una configurazione di sistema virtuale.<br/> Quando applicato alle parti di una configurazione di sistema virtuale "corrente", è possibile che vengano modificati i servizi guest di un effetto collaterale del sistema virtuale attivo.<br/>         |
| [**RemoveKvpItems**](removekvpitems-msvm-virtualsystemmanagementservice.md)                                           | Rimuove le coppie chiave-valore esistenti da una macchina virtuale.<br/>                                                                                                                                                                                |
| [**RemoveResourceSettings**](removeresourcesettings-msvm-virtualsystemmanagementservice.md)                           | Rimuove le impostazioni delle risorse virtuali da una configurazione di macchina virtuale.<br/>                                                                                                                                                                 |
| [**RemoveSystemComponentSettings**](msvm-virtualsystemmanagementservice-removesystemcomponentsettings.md)             | Rimuove le impostazioni del componente generico da una configurazione di sistema virtuale.<br/>                                                                                                                                                                 |
| [**RequestStateChange**](msvm-virtualsystemmanagementservice-requeststatechange.md)                                   | Questo metodo non è supportato.<br/>                                                                                                                                                                                                           |
| [**SetGuestNetworkAdapterConfiguration**](setguestnetworkadapterconfiguration-msvm-virtualsystemmanagementservice.md) | Configura le schede di rete all'interno del sistema operativo guest.<br/>                                                                                                                                                                      |
| [**SetInitialMachineConfigurationData**](msvm-virtualsystemmanagementservice-setinitialmachineconfigurationdata.md)   | Imposta i dati di configurazione iniziale della macchina virtuale.<br/>                                                                                                                                                                                         |
| [**StartService**](msvm-virtualsystemmanagementservice-startservice.md)                                               | Questo metodo non è supportato.<br/>                                                                                                                                                                                                           |
| [**StopService**](msvm-virtualsystemmanagementservice-stopservice.md)                                                 | Questo metodo non è supportato.<br/>                                                                                                                                                                                                           |
| [**TestNetworkConnection**](msvm-virtualsystemmanagementservice-testnetworkconnection.md)                             | Verifica la connettività di rete di una macchina virtuale in un ambiente di virtualizzazione rete Windows.<br/>                                                                                                                                                 |
| [**UpgradeSystemVersion**](msvm-virtualsystemmanagementservice-upgradesystemversion.md)                               | Aggiorna il sistema virtuale.<br/> Quando applicato alle impostazioni di sistema di una configurazione di sistema virtuale "corrente"<br/>                                                                                                                 |
| [**ValidatePlannedSystem**](validateplannedsystem-msvm-virtualsystemmanagementservice.md)                             | Convalida il sistema pianificato specificato.<br/>                                                                                                                                                                                                 |
...
La **classe \_ VirtualSystemManagementService di MSVM** dispone di queste proprietà.
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "MSVM \_ VirtualSystemManagementService".
...
Descrizione dell'oggetto . Questa proprietà viene ereditata da [**CIM \_ managementelement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Service per la creazione, la manipolazione e la gestione delle macchine virtuali".
...
Nome visualizzato per l'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Hyper-V Virtual System Management Service".
...
L'accesso alla **classe \_ VirtualSystemManagementService di MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
