...
> [!Note]  
> A partire da Windows 8.1, è consigliabile non usare più **GetReplicationStatistics** per recuperare le statistiche di replica. Usare invece [**GetReplicationStatisticsEx**](getreplicationstatisticsex-msvm-replicationservice.md).
...
In caso di esito positivo, riceve un'istanza incorporata della classe [**MSVM \_ ReplicationStatistics**](msvm-replicationstatistics.md) contenente le statistiche di replica per la macchina virtuale richiesta.
