...
-   *SourceHost* è il nome dell'host corrente della macchina virtuale.
-   *DestinationHost* è il nome dell'host di destinazione.
-   *VmName* è il nome della macchina virtuale.
...
Il codice C# seguente contiene l'implementazione della maggior parte dei metodi di utilità chiamati dall'esempio precedente.
