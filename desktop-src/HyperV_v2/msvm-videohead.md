...
Descrive la superficie di disegno principale in un controller di visualizzazione.
...
La **classe \_ VideoHead di MSVM** dispone di questi tipi di membri:
...
La **classe \_ VideoHead di MSVM** dispone di questi metodi.
...
| [**RequestStateChange**](msvm-videohead-requeststatechange.md) | Richiede una modifica dello stato.<br/>      |
| [**Reset**](msvm-videohead-reset.md)                           | Reimposta il dispositivo virtuale.<br/>    |
...
La **classe \_ VideoHead di MSVM** dispone di queste proprietà.
...
Numero di bit utilizzati per visualizzare ogni pixel. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Qualificatori: **unità** ("pixel")
</dt> </dl>

Numero corrente di pixel orizzontali. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Il numero di colori supportati alle risoluzioni correnti. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Se è in modalità carattere, il numero di colonne per il controller di visualizzazione. Altrimenti, è impostato su 0. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Se è in modalità carattere, il numero di righe per questo controller video. Altrimenti, è impostato su 0. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Qualificatori: **unità** ("Hertz")
</dt> </dl>

Frequenza di aggiornamento corrente, in Hertz. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Modalità di analisi corrente. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
<span id="Non-Interlaced_Operation"></span><span id="non-interlaced_operation"></span><span id="NON-INTERLACED_OPERATION"></span>**Operazione non interlacciata** (3)
</dt> <dt>

<span id="Interlaced_Operation"></span><span id="interlaced_operation"></span><span id="INTERLACED_OPERATION"></span>**Operazione interlacciata** (4)
</dt> </dl>
...
Numero corrente di pixel verticali. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Questa proprietà viene ereditata da [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)ed è impostata su "Microsoft:*GUID* \\ Head \\ *index*".
...
Frequenza di aggiornamento massima del controller di visualizzazione, in Hertz. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Frequenza di aggiornamento minima del controller video, in Hertz. Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)).
...
Modalità di analisi corrente quando la proprietà **CurrentScanMode** dell'istanza è 1 (other). Questa proprietà viene ereditata da [**CIM \_ VideoHead**](/previous-versions//cc136948(v=vs.85)) ed è impostata su **null**.
...
Ultimo stato richiesto o desiderato per l'elemento. Lo stato effettivo dell'elemento è rappresentato da **EnabledState**. Questa proprietà viene ereditata da [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85)).
...
L'accesso alla **classe \_ VideoHead di MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
