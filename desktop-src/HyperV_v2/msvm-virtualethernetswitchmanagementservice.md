...
Rappresenta il servizio di virtualizzazione presente in un singolo sistema host. MSVM \_ VirtualEthernetSwitchManagementService viene usato per controllare la definizione, la modifica e l'eliminazione dei commutatori Ethernet virtuali.
...
La **classe \_ VirtualEthernetSwitchManagementService di MSVM** dispone di questi tipi di membri:
...
La **classe \_ VirtualEthernetSwitchManagementService di MSVM** dispone di questi metodi.



| Metodo                                                                                               | Descrizione                                                                       |
|:-----------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|
| [**AddFeatureSettings**](addfeaturesettings-msvm-virtualethernetswitchmanagementservice.md)         | Aggiunge le impostazioni della funzionalità alla configurazione di una porta di commutazione Ethernet.<br/> |
| [**AddResourceSettings**](addresourcesettings-msvm-virtualethernetswitchmanagementservice.md)       | Aggiunge risorse a una configurazione di Commuter virtuale.<br/>                      |
| [**DefineSystem**](definesystem-msvm-virtualethernetswitchmanagementservice.md)                     | Crea un nuovo commutire virtuale.<br/>                                          |
| [**DestroySystem**](destroysystem-msvm-virtualethernetswitchmanagementservice.md)                   | Elimina definitivamente un commutire virtuale.<br/>                                             |
| [**ModifyFeatureSettings**](modifyfeaturesettings-msvm-virtualethernetswitchmanagementservice.md)   | Modifica le impostazioni delle funzionalità di una porta di commutazione Ethernet.<br/>              |
| [**ModifyResourceSettings**](modifyresourcesettings-msvm-virtualethernetswitchmanagementservice.md) | Modifica le impostazioni delle risorse per un commutire virtuale.<br/>                       |
| [**ModifySystemSettings**](modifysystemsettings-msvm-virtualethernetswitchmanagementservice.md)     | Modifica le impostazioni del Commuter virtuale.<br/>                                      |
| [**RemoveFeatureSettings**](removefeaturesettings-msvm-virtualethernetswitchmanagementservice.md)   | Rimuove le impostazioni della funzionalità da una porta di commutazione Ethernet.<br/>                 |
| [**RemoveResourceSettings**](removeresourcesettings-msvm-virtualethernetswitchmanagementservice.md) | Rimuove le impostazioni delle risorse virtuali da una configurazione di commutiri virtuali.<br/> |
...
La **classe \_ VirtualEthernetSwitchManagementService di MSVM** dispone di queste proprietà.
...
Breve descrizione dell'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Hyper-V virtual networking Management Service".
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "MSVM \_ VirtualEthernetSwitchManagementService".
...
Descrizione dell'oggetto . Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "fornisce la gestione WMI per la rete Hyper-V".
...
Nome visualizzato per l'oggetto. Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "Hyper-V networking Management Service".
