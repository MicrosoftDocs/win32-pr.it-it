---
description: Gli esempi C# e Visual Basic Scripting Edition (VBScript) seguenti recuperano il nome DNS della macchina virtuale.
ms.assetid: 1E1F7E6F-5CF6-475F-8351-6A5F56B4FC8E
title: Recupero del nome DNS della macchina virtuale
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103885877"
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="85ac1-103">Recupero del nome DNS della macchina virtuale</span><span class="sxs-lookup"><span data-stu-id="85ac1-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="85ac1-104">Gli esempi C# e Visual Basic Scripting Edition (VBScript) seguenti recuperano il nome DNS della macchina virtuale.</span><span class="sxs-lookup"><span data-stu-id="85ac1-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="85ac1-105">Per eseguire questo codice di esempio, è necessario installare i servizi di integrazione client e il sistema operativo client deve essere in esecuzione.</span><span class="sxs-lookup"><span data-stu-id="85ac1-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="85ac1-106">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="85ac1-106">Related topics</span></span>

[<span data-ttu-id="85ac1-107">Utilità comuni per gli esempi di virtualizzazione (v2)</span><span class="sxs-lookup"><span data-stu-id="85ac1-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="85ac1-108">**\_ComputerSystem MSVM**</span><span class="sxs-lookup"><span data-stu-id="85ac1-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="85ac1-109">**\_KvpExchangeComponent MSVM**</span><span class="sxs-lookup"><span data-stu-id="85ac1-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
