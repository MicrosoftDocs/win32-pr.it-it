...
---
# <a name="getting-the-virtual-machine-dns-name"></a>Recupero del nome DNS della macchina virtuale

Gli esempi C# e Visual Basic Scripting Edition (VBScript) seguenti recuperano il nome DNS della macchina virtuale.

Per eseguire questo codice di esempio, è necessario installare i servizi di integrazione client e il sistema operativo client deve essere in esecuzione.
...
[Utilità comuni per gli esempi di virtualizzazione (v2)](common-utilities-for-the-virtualization-samples-v2.md)
