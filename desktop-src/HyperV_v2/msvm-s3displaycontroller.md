...
---
# <a name="msvm_s3displaycontroller-class"></a>\_Classe MSVM S3DisplayController
...
La **classe \_ S3DisplayController di MSVM** dispone di questi tipi di membri:
...
La **classe \_ S3DisplayController di MSVM** dispone di questi metodi.
...
La **classe \_ S3DisplayController di MSVM** dispone di queste proprietà.
...
Funzionalità grafiche e 3D del controller di visualizzazione. Questa proprietà viene ereditata da [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85)).
...
Matrice di stringhe in formato libero che fornisce spiegazioni più dettagliate per tutte le funzionalità di accelerazione video indicate nella matrice **AcceleratorCapabilities** . Ogni voce di questa matrice è correlata alla voce nella matrice **AcceleratorCapabilities** che si trova nello stesso indice. Questa proprietà viene ereditata da [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85)).
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata da [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)ed è sempre impostata su "MSVM \_ S3DisplayController".
...
L'accesso alla **classe \_ S3DisplayController di MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
