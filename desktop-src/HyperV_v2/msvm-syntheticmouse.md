...
Rappresenta un dispositivo mouse sintetico.
...
La **classe \_ SyntheticMouse di MSVM** dispone di questi tipi di membri:
...
La **classe \_ SyntheticMouse di MSVM** dispone di questi metodi.



| Metodo                                                                 | Descrizione                                                                   |
|:-----------------------------------------------------------------------|:------------------------------------------------------------------------------|
| [**ClickButton**](clickbutton-msvm-syntheticmouse.md)                 | Simula un clic del pulsante del dispositivo specificato.<br/>           |
| **EnableDevice**                                                       | Questo metodo non è supportato.<br/>                                      |
| [**GetButtonState**](getbuttonstate-msvm-syntheticmouse.md)           | Recupera lo stato corrente del pulsante del dispositivo specificato.<br/>        |
| **OnlineDevice**                                                       | Questo metodo non è supportato.<br/>                                      |
| **QuiesceDevice**                                                      | Questo metodo non è supportato.<br/>                                      |
| [**RequestStateChange**](msvm-syntheticmouse-requeststatechange.md)   | Richiede una modifica dello stato<br/>                                            |
| [**Reset**](msvm-syntheticmouse-reset.md)                             | Reimposta il dispositivo.<br/>                                                 |
| **RestoreProperties**                                                  | Questo metodo non è supportato.<br/>                                      |
| **SaveProperties**                                                     | Questo metodo non è supportato.<br/>                                      |
| [**SetAbsolutePosition**](setabsoluteposition-msvm-syntheticmouse.md) | Imposta la posizione orizzontale e verticale del cursore del mouse.<br/>     |
| [**SetButtonState**](setbuttonstate-msvm-syntheticmouse.md)           | Imposta lo stato corrente del pulsante del dispositivo specificato.<br/>             |
| **SetPowerState**                                                      | Questo metodo non è supportato.<br/>                                      |
| [**SetScrollPosition**](setscrollposition-msvm-syntheticmouse.md)     | Imposta la coordinata z del controllo rotellina del dispositivo di puntamento.<br/> |
...
La **classe \_ SyntheticMouse di MSVM** dispone di queste proprietà.
...
Indica se il dispositivo opera su coordinate assolute o relative.



| Valore                                                                                | Significato                                           |
|--------------------------------------------------------------------------------------|---------------------------------------------------|
| <dl> <dt>**Vero**</dt> </dl>  | Le coordinate del dispositivo sono assolute.<br/> |
| <dl> <dt>**False**</dt> </dl> | Le coordinate del dispositivo sono relative.<br/> |
...
Configurazione predefinita o di avvio di un amministratore per la **EnabledState** di un elemento. Questa proprietà viene ereditata da [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85)).
...
| Valore                                                                                                                                                                                                                           | Significato                                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Abilitato**</dt> <dt>2</dt> </dl>     | La macchina virtuale guest supporta un mouse sintetico.<br/>         |
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabilitato**</dt> <dt>3</dt> </dl> | La macchina virtuale guest non supporta un mouse sintetico.<br/> |
...
Coordinata x assoluta del dispositivo di puntamento.
...
Tipo di dispositivo di puntamento. Questa proprietà viene ereditata da [**CIM \_ PointingDevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice).
...
Qualificatori: [**unità**](/windows/desktop/WmiSdk/standard-qualifiers) ("Mickey")
</dt> </dl>

Posizione della coordinata z del dispositivo mouse.
...
Stringhe che descrivono i vari valori della matrice [**OperationalStatus**](msvm-bioselement.md) . Questa proprietà viene ereditata da [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement).
...
Coordinata y assoluta del dispositivo di puntamento.

</dd> </dl>

## <a name="remarks"></a>Commenti

L'accesso alla **classe \_ SyntheticMouse di MSVM** potrebbe essere limitato dal filtraggio del controllo dell'account utente. Per ulteriori informazioni, vedere [controllo dell'account utente e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
