...
---
# <a name="modifynetworksettings-method-of-the-msvm_virtualsystemmigrationservice-class"></a>Metodo ModifyNetworkSettings della classe MSVM \_ VirtualSystemMigrationService

Modifica le subnet della rete di migrazione del servizio di migrazione del sistema virtuale.
