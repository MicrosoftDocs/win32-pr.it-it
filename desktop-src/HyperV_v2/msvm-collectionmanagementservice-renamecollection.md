---
description: Aggiorna il nome dell'elemento per l'oggetto CIM \_ CollectionOfMSEs specificato.
...
ms.locfileid: "119681931"
---
# <a name="renamecollection-method-of-the-msvm_collectionmanagementservice-class"></a>Metodo RenameCollection della classe Msvm \_ CollectionManagementService

Aggiorna il nome dell'elemento per [**l'oggetto CIM \_ CollectionOfMSEs**](cim-collectionofmses.md) specificato.
