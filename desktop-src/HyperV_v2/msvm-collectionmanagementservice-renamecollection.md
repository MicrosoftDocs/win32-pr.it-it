...
---
# <a name="renamecollection-method-of-the-msvm_collectionmanagementservice-class"></a>Metodo rinominacollection della \_ classe MSVM CollectionManagementService

Aggiorna il nome dell'elemento per l' [**oggetto \_ CollectionOfMSEs CIM**](cim-collectionofmses.md) specificato.
