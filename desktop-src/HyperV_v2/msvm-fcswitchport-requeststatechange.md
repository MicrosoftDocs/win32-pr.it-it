...
---
# <a name="requeststatechange-method-of-the-msvm_fcswitchport-class"></a>Metodo RequestStateChange della classe MSVM \_ FcSwitchPort
...
[**\_FcSwitchPort MSVM**](msvm-fcswitchport.md)
</dt> </dl>
