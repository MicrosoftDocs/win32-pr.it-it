...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a>Esportazione della configurazione di una macchina virtuale

Negli esempi seguenti di C# e Visual Basic Scripting Edition (VBScript) viene illustrata l'esportazione della configurazione di una macchina virtuale. Gli esempi che mostrano l'esportazione di una macchina virtuale sono reperibili nella [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) ed [esportazione di uno snapshot di una macchina virtuale](exporting-virtual-machines.md) argomenti.
...
[Esportazione di uno snapshot di una macchina virtuale](exporting-virtual-machines.md)
