...
Rappresenta un'opzione di Fibre Channel virtuale. Ogni opzione è associata a una porta Fibre Channel fisica a cui è possibile connettere molte porte Fibre Channel sintetiche. Il Commuter non è altamente configurabile e funge principalmente da segnaposto.
...
La **classe \_ VirtualFcSwitch di MSVM** dispone di questi tipi di membri:
...
La **classe \_ VirtualFcSwitch di MSVM** dispone di questi metodi.
...
La **classe \_ VirtualFcSwitch di MSVM** dispone di queste proprietà.
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ sistema CIM**](/windows/desktop/CIMWin32Prov/cim-system).
...
Etichetta con cui l'oggetto è noto. Questa proprietà viene ereditata [**dal \_ sistema CIM**](/windows/desktop/CIMWin32Prov/cim-system).
