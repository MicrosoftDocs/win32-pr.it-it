...
---
# <a name="msvm_replicationserviceresetreplicationstatisticsex-method"></a>\_Metodo MSVM ReplicationService:: ResetReplicationStatisticsEx
...
Riferimento a un'istanza di [**CIM \_ ComputerSystem**](/windows/desktop/CIMWin32Prov/cim-computersystem) che rappresenta la macchina virtuale abilitata per la replica.
...
Rappresentazione di stringa di un'istanza incorporata della classe [**MSVM \_ ReplicationRelationship**](msvm-replicationrelationship.md) che definisce la relazione di replica per la quale reimpostare le statistiche di replica.
