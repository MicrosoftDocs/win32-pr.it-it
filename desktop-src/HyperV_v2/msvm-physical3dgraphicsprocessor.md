---
description: Descrive l'unità di elaborazione grafica 3D fisica.
ms.assetid: 24e3d141-cbfe-4d40-907c-9a467c586c46
title: Msvm_Physical3dGraphicsProcessor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119520875"
---
# <a name="msvm_physical3dgraphicsprocessor-class"></a>Classe Msvm \_ Physical3dGraphicsProcessor

Descrive l'unità di elaborazione grafica 3D fisica.
...
La **classe Msvm \_ Physical3dGraphicsProcessor** ha questi tipi di membri:
...
La **classe Msvm \_ Physical3dGraphicsProcessor** include questi metodi.
...
La **classe Msvm \_ Physical3dGraphicsProcessor** ha queste proprietà.
...
Specifica l'identificatore di indice della scheda allocato al dispositivo.
...
Specifica il verison di DirectX supportato dalla GPU.
...
Specifica il nome del provider di driver.
...
Specifica se l'adapter è stato abilitato per l'uso con RemoteFX.
...
Contiene l'identificatore GPU per la scheda.
...
Specifica il pixel shader versione supportata dalla GPU.
...
Specifica la classificazione RemoteFX GPU per questo dispositivo. Questa proprietà non è attualmente utilizzata.
