...
---
# <a name="controlmetrics-method-of-the-cim_metricservice-class"></a>Metodo ControlMetrics della classe CIM \_ MetricService
...
Oggetto [**\_ gestito CIM**](cim-managedelement.md) che identifica gli elementi gestiti per i quali verranno controllate le metriche.
