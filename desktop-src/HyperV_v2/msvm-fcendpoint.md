---
description: Rappresenta il punto di connessione logico per una Fibre Channel porta.
ms.assetid: 54e9cb76-04f2-417b-b250-1b3156772694
title: Msvm_FcEndpoint classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119523391"
---
# <a name="msvm_fcendpoint-class"></a>Classe Msvm \_ FcEndpoint

Rappresenta il punto di connessione logico per una Fibre Channel porta. Quando l'endpoint Fibre Channel è connesso a una porta del commutatore, la porta Fibre Channel connessa all'endpoint Fibre Channel è Fibre Channel connettività.
...
La **classe Msvm \_ FcEndpoint** ha questi tipi di membri:
...
La **classe Msvm \_ FcEndpoint** dispone di questi metodi.



| Metodo                                                           | Descrizione                         |
|:-----------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-fcendpoint-requeststatechange.md) | Richiede una modifica dello stato.<br/> |
...
La **classe Msvm \_ FcEndpoint** ha queste proprietà.
...
Questa proprietà è impostata **su True** se questo endpoint Fibre Channel è connesso attivamente a un altro endpoint Fibre Channel locale.
...
<span id="ISO_802.4_Token_Bus"></span><span id="iso_802.4_token_bus"></span><span id="ISO_802.4_TOKEN_BUS"></span>**Bus di token ISO 802.4** (8)
</dt> <dt>
...
<span id="Basic_ISDN"></span><span id="basic_isdn"></span><span id="BASIC_ISDN"></span>**ISDN di** base (20)
</dt> <dt>

<span id="Primary_ISDN"></span><span id="primary_isdn"></span><span id="PRIMARY_ISDN"></span>**ISDN primario** (21)
</dt> <dt>

<span id="Proprietary_Point-to-Point_Serial"></span><span id="proprietary_point-to-point_serial"></span><span id="PROPRIETARY_POINT-TO-POINT_SERIAL"></span>**Seriale point-to-point proprietaria** (22)
</dt> <dt>
...
<span id="Proprietary_Multiplexor"></span><span id="proprietary_multiplexor"></span><span id="PROPRIETARY_MULTIPLEXOR"></span>**Multiplexor proprietario** (54)
</dt> <dt>
...
<span id="G703_at_64K"></span><span id="g703_at_64k"></span><span id="G703_AT_64K"></span>**G703 a 64.000** (66)
</dt> <dt>
...
<span id="Data_Link_Switching"></span><span id="data_link_switching"></span><span id="DATA_LINK_SWITCHING"></span>**Cambio di collegamento dati** (74)
</dt> <dt>
...
<span id="IP_Switch"></span><span id="ip_switch"></span><span id="IP_SWITCH"></span>**Commutatore IP** (78)
</dt> <dt>

<span id="Remote_Source_Route_Bridging"></span><span id="remote_source_route_bridging"></span><span id="REMOTE_SOURCE_ROUTE_BRIDGING"></span>**Bridging route di origine remota** (79)
</dt> <dt>
...
<span id="Async"></span><span id="async"></span><span id="ASYNC"></span>**Asincrono** (84)
</dt> <dt>
...
<span id="ITU_X.29_Host_PAD"></span><span id="itu_x.29_host_pad"></span><span id="ITU_X.29_HOST_PAD"></span>**PAD host X.29 ITU** (90)
</dt> <dt>

<span id="ITU_X.3_Terminal_PAD"></span><span id="itu_x.3_terminal_pad"></span><span id="ITU_X.3_TERMINAL_PAD"></span>**PAD del terminale ITU X.3** (91)
</dt> <dt>
...
<span id="Voice_Receive_and_Transmit"></span><span id="voice_receive_and_transmit"></span><span id="VOICE_RECEIVE_AND_TRANSMIT"></span>**Ricezione e trasmissione vocali** (100)
</dt> <dt>
...
<span id="IP_over_CLAW"></span><span id="ip_over_claw"></span><span id="IP_OVER_CLAW"></span>**IP su CLAW** (110)
</dt> <dt>

<span id="Stack_to_Stack"></span><span id="stack_to_stack"></span><span id="STACK_TO_STACK"></span>**Stack in stack** (111)
</dt> <dt>
...
<span id="ISO_802.5j_Fibre_Token_Ring"></span><span id="iso_802.5j_fibre_token_ring"></span><span id="ISO_802.5J_FIBRE_TOKEN_RING"></span>**Fibre Token Ring ISO 802.5j** (115)
</dt> <dt>
...
<span id="X.25_Hunt_Group"></span><span id="x.25_hunt_group"></span><span id="X.25_HUNT_GROUP"></span>**Gruppo di risposta X.25** (122)
</dt> <dt>
...
<span id="IP__for_APPN_HPR_in_IP_Networks_"></span><span id="ip__for_appn_hpr_in_ip_networks_"></span><span id="IP__FOR_APPN_HPR_IN_IP_NETWORKS_"></span>**IP (per HPR APPN nelle reti IP)** (126)
</dt> <dt>
...
<span id="Avalon_12MPP_Switch"></span><span id="avalon_12mpp_switch"></span><span id="AVALON_12MPP_SWITCH"></span>**Interruttore Avalon 12MPP** (130)
</dt> <dt>
...
<span id="Circuit_Emulation_Service"></span><span id="circuit_emulation_service"></span><span id="CIRCUIT_EMULATION_SERVICE"></span>**Servizio di emulazione dei** circuiti (133)
</dt> <dt>

<span id="ATM_SubInterface"></span><span id="atm_subinterface"></span><span id="ATM_SUBINTERFACE"></span>**AtM SubInterface** (134)
</dt> <dt>

<span id="Layer_2_VLAN_using_802.1Q"></span><span id="layer_2_vlan_using_802.1q"></span><span id="LAYER_2_VLAN_USING_802.1Q"></span>**VLAN di livello 2 con 802.1Q** (135)
</dt> <dt>

<span id="Layer_3_VLAN_using_IP"></span><span id="layer_3_vlan_using_ip"></span><span id="LAYER_3_VLAN_USING_IP"></span>**VLAN di livello 3 tramite IP** (136)
</dt> <dt>
...
<span id="Multimedia_Mail_over_IP"></span><span id="multimedia_mail_over_ip"></span><span id="MULTIMEDIA_MAIL_OVER_IP"></span>**Posta multimediale su IP** (139)
</dt> <dt>
...
<span id="IP_Forwarding"></span><span id="ip_forwarding"></span><span id="IP_FORWARDING"></span>**Inoltro IP** (142)
</dt> <dt>
...
<span id="Frame_Forward"></span><span id="frame_forward"></span><span id="FRAME_FORWARD"></span>**Avanzamento fotogramma** (158)
</dt> <dt>
...
<span id="IEEE_802.3ad_Link_Aggregate"></span><span id="ieee_802.3ad_link_aggregate"></span><span id="IEEE_802.3AD_LINK_AGGREGATE"></span>**Aggregazione collegamento IEEE 802.3ad** (161)
</dt> <dt>
...
<span id="Multi-Frequency_Signaling_Link"></span><span id="multi-frequency_signaling_link"></span><span id="MULTI-FREQUENCY_SIGNALING_LINK"></span>**Collegamento di segnalazione a più frequenze** (167)
</dt> <dt>
...
<span id="Packet_over_SONET_SDH"></span><span id="packet_over_sonet_sdh"></span><span id="PACKET_OVER_SONET_SDH"></span>**Pacchetto su SONET/SDH** (171)
</dt> <dt>
...
<span id="Non_Facility_Associated_Signaling"></span><span id="non_facility_associated_signaling"></span><span id="NON_FACILITY_ASSOCIATED_SIGNALING"></span>**Segnalazione non associata alla funzionalità** (175)
</dt> <dt>
...
<span id="Proprietary_Wireless_Downstream"></span><span id="proprietary_wireless_downstream"></span><span id="PROPRIETARY_WIRELESS_DOWNSTREAM"></span>**Downstream wireless proprietario** (181)
</dt> <dt>

<span id="Proprietary_Wireless_Upstream"></span><span id="proprietary_wireless_upstream"></span><span id="PROPRIETARY_WIRELESS_UPSTREAM"></span>**Upstream wireless proprietario** (182)
</dt> <dt>

<span id="HIPERLAN_Type_2"></span><span id="hiperlan_type_2"></span><span id="HIPERLAN_TYPE_2"></span>**HIPERLAN Tipo 2** (183)
</dt> <dt>

<span id="Proprietary_Broadband_Wireless_Access_Point_to_Multipoint"></span><span id="proprietary_broadband_wireless_access_point_to_multipoint"></span><span id="PROPRIETARY_BROADBAND_WIRELESS_ACCESS_POINT_TO_MULTIPOINT"></span>**Wireless Access Point to Multipoint** (184) a banda larga proprietaria
</dt> <dt>
...
<span id="Inter_Machine_Trunk"></span><span id="inter_machine_trunk"></span><span id="INTER_MACHINE_TRUNK"></span>**Trunk tra macchine** (190)
</dt> <dt>
...
<span id="Proprietary_ATM"></span><span id="proprietary_atm"></span><span id="PROPRIETARY_ATM"></span>**Bancomat proprietario** (197)
</dt> <dt>
...
<span id="Virtual_Trunk_Group"></span><span id="virtual_trunk_group"></span><span id="VIRTUAL_TRUNK_GROUP"></span>**Gruppo di trunk virtuali** (202)
</dt> <dt>
...
<span id="Voice___Feature_Group"></span><span id="voice___feature_group"></span><span id="VOICE___FEATURE_GROUP"></span>**Gruppo & funzionalità voce** (211)
</dt> <dt>
...
<span id="Optical_Channel_Group"></span><span id="optical_channel_group"></span><span id="OPTICAL_CHANNEL_GROUP"></span>**Gruppo di canali ottici** (219)
</dt> <dt>
...
<span id="ISDN_B_Channel_Endpoint"></span><span id="isdn_b_channel_endpoint"></span><span id="ISDN_B_CHANNEL_ENDPOINT"></span>**Endpoint canale ISDN B** (4106)
</dt> <dt>

<span id="ISDN_D_Channel_Endpoint"></span><span id="isdn_d_channel_endpoint"></span><span id="ISDN_D_CHANNEL_ENDPOINT"></span>**Endpoint canale D ISDN** (4107)
</dt> <dt>
...
Questa proprietà è deprecata al posto della **proprietà ProtocolIFType.** Questa proprietà viene ereditata dal [**protocollo \_ CIMEndpoint.**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint)
...
Nome del nodo a livello mondiale della Fibre Channel a cui è connesso l'endpoint.
...
Nome della porta a livello mondiale della Fibre Channel a cui è connesso l'endpoint.
