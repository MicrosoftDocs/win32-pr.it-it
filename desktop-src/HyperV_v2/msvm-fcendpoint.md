...
---
# <a name="msvm_fcendpoint-class"></a>\_Classe MSVM FcEndpoint

Rappresenta il punto di connessione logico per una porta Fibre Channel. Quando l'endpoint del Fibre Channel è connesso a una porta di commutazione, la porta Fibre Channel connessa all'endpoint di Fibre Channel ha Fibre Channel connettività.
...
La **classe \_ FcEndpoint di MSVM** dispone di questi tipi di membri:
...
La **classe \_ FcEndpoint di MSVM** dispone di questi metodi.
...
La **classe \_ FcEndpoint di MSVM** dispone di queste proprietà.
...
Questa proprietà è impostata su **true** se l'endpoint Fibre Channel è attivamente connesso a un altro endpoint Fibre Channel.
...
Nome del nodo universale della porta Fibre Channel a cui è connesso questo endpoint.
...
Nome della porta universale della porta Fibre Channel a cui è connesso questo endpoint.
