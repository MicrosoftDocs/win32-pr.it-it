...
Offre la possibilità di gestire le metriche.
...
La **classe \_ MetricService di MSVM** dispone di questi tipi di membri:
...
La **classe \_ MetricService di MSVM** dispone di questi metodi.



| Metodo                                                                    | Descrizione                                                                             |
|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| [**ControlMetrics**](controlmetrics-msvm-metricservice.md)               | Usato per controllare la raccolta di metriche per un elemento o elementi gestiti.<br/> |
| [**ControlMetricsByClass**](msvm-metricservice-controlmetricsbyclass.md) | Controlla la metrica in base alla classe.<br/>                                               |
| [**ControlSampleTimes**](msvm-metricservice-controlsampletimes.md)       | Imposta i tempi di campionamento del controllo.<br/>                                               |
| [**GetMetricValues**](msvm-metricservice-getmetricvalues.md)             | Recupera i valori della metrica.<br/>                                                 |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-metricservice.md) | Modifica i dati dell'impostazione per il servizio.<br/>                                   |
| [**RequestStateChange**](msvm-metricservice-requeststatechange.md)       | Richiede una modifica dello stato.<br/>                                                     |
| [**ShowMetrics**](msvm-metricservice-showmetrics.md)                     | Mostra la metrica specificata.<br/>                                                 |
| [**ShowMetricsByClass**](msvm-metricservice-showmetricsbyclass.md)       | Mostra le metriche per classe.<br/>                                                  |
| [**StartService**](msvm-metricservice-startservice.md)                   | avvia il servizio.<br/>                                                          |
| [**StopService**](msvm-metricservice-stopservice.md)                     | arresta il servizio.<br/>                                                           |
...
La **classe \_ MetricService di MSVM** dispone di queste proprietà.
...
Breve descrizione dell'oggetto. Questa proprietà viene ereditata da [**CIM \_ managementelement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "servizio metrica Hyper-V".
...
Nome della classe o della sottoclasse utilizzata per la creazione di un'istanza di. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "MSVM \_ MetricService".
...
Descrizione dell'oggetto . Questa proprietà viene ereditata da [**CIM \_ Managed**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "fornisce la gestione WMI della metrica Hyper-V".
...
Nome visualizzato per l'oggetto. Questa proprietà viene ereditata da [**CIM \_ managementelement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)ed è sempre impostata su "servizio metrica Hyper-V".
...
Etichetta con cui l'oggetto è noto. Questa proprietà viene ereditata [**dal \_ servizio CIM**](/windows/desktop/CIMWin32Prov/cim-service)ed è sempre impostata su "metricsvc".
