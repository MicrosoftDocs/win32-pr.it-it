---
description: Metodo per spostare, migrare o spostare un sistema virtuale in un sistema di destinazione.
ms.assetid: 210d31f1-093f-4fd5-afd7-5f028b4cb343
title: Metodo MigrateVirtualSystemToSystem della CIM_VirtualSystemMigrationService classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Metodo per spostare, migrare o spostare un sistema virtuale in un sistema di destinazione.
...
Riferimento a un'istanza della [**classe \_ ComputerSystem CIM**](cim-computersystem.md) che rappresenta il sistema di computer virtuale dopo la migrazione.
...
| <dl> <dt>**Errore**</dt> <dt>2</dt> </dl>                                     | La migrazione del sistema virtuale non è riuscita per motivi non specificato.<br/>                                                                                                                                                                                                                                        |
...
| <dl> <dt>**Parametri del metodo verificati - Processo avviato**</dt> <dt>4096</dt> </dl> |                                                                                                                                                                                                                                                                                                            |
