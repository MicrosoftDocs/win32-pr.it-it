...
---
# <a name="msvm_rdvcomponent-class"></a>\_Classe MSVM RdvComponent

Rappresenta lo stato del componente RDV, che è responsabile della fornitura di un trasporto per l'elemento padre al Guest per scopi di configurazione.
...
La **classe \_ RdvComponent di MSVM** dispone di questi tipi di membri:
...
La **classe \_ RdvComponent di MSVM** dispone di questi metodi.
...
| [**EnableEndPoints**](enableendpoints-msvm-rdvcomponent.md) | Richiede all'Servizi Desktop remoto dispositivo virtuale di avviare una connessione tramite pipe alla macchina virtuale. Se viene restituito zero (0), l'operazione ha avuto esito positivo. Qualsiasi altro codice restituito indica una condizione di errore.<br/> |
...
La **classe \_ RdvComponent di MSVM** dispone di queste proprietà.
