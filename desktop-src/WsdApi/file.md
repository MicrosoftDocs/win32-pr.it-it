...
Indica al generatore di codice di generare un file e specifica il nome del file di output.
...
|---------------------|----------------------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| **nome**<br/> | stringa pathname<br/> | Sì<br/> | Nome file di output per il contenuto generato. La stringa del nome file deve includere informazioni complete sul percorso.<br/> <br/> |
...
| [**hostBuilderDeclaration**](hostbuilderdeclaration.md)<br/>                                     | Genera una dichiarazione per una funzione che crea un host tipidato.<br/> <br/>                                                                                                                              |
| [**hostBuilderImplementation**](hostbuilderimplementation.md)<br/>                               | Genera una funzione che crea un host tipiato.<br/> <br/>                                                                                                                                                |
...
| [**Includono**](include.md)<br/>                                                                   | Include il contenuto di una macro o di un file nell'output generato.<br/> <br/>                                                                                                                              |
...
| [**literalInclude**](literalinclude.md)<br/>                                                     | Inserisce un'istruzione include C o IDL nel codice generato. <br/> <br/>                                                                                                                                    |
...
| [**proxyBuilderDeclarations**](proxybuilderdeclarations.md)<br/>                                 | Genera dichiarazioni per le funzioni per creare proxy tipici.<br/> <br/>                                                                                                                                  |
| [**proxyBuilderImplementations**](proxybuilderimplementations.md)<br/>                           | Genera funzioni per creare proxy tipiati.<br/> <br/>                                                                                                                                                   |
...
| [**relationshipMetadataDeclaration**](relationshipmetadatadeclaration.md)<br/>                   | Genera una dichiarazione con inoltro per i metadati di hosting specificati [**nell'elemento hostMetadata.**](hostmetadata.md) <br/> <br/>                                                                       |
| [**relationshipMetadataDefinition**](relationshipmetadatadefinition.md)<br/>                     | Genera una definizione di costante C per i metadati di hosting specificati [**nell'elemento hostMetadata.**](hostmetadata.md) <br/> <br/>                                                                     |
| [**structDeclarations**](structdeclarations.md)<br/>                                             | Genera dichiarazioni di struttura C per tipi noti.<br/> <br/>                                                                                                                                            |
...
| [**thisModelMetadataDeclaration**](thismodelmetadatadeclaration.md)<br/>                         | Genera una dichiarazione con inoltro per la costante C per i metadati del produttore specificati [**nell'elemento thisModelMetadata.**](thismodelmetadata.md)<br/> <br/>                                      |
...
| [**typeTableDeclarations**](typetabledeclarations.md)<br/>                                       | Genera dichiarazioni di costanti C per le tabelle di XML Schema per i tipi noti.<br/> <br/>                                                                                                                       |
| [**typeTableDefinitions**](typetabledefinitions.md)<br/>                                         | Genera costanti C per le tabelle di XML Schema per i tipi noti.<br/> <br/>                                                                                                                                   |
...
Il nome del file è determinato dal valore dell'attributo name o dell'elemento figlio. Il contenuto del file è determinato dagli altri elementi figlio, text e CDATA **nell'elemento file.** Il testo e CDATA vengono copiati nel file senza modifiche. Gli elementi figlio vengono sostituiti con il codice generato. Testo, CDATA ed elementi figlio possono essere presenti in qualsiasi ordine e possono essere ripetuti per un periodo illimitato.
