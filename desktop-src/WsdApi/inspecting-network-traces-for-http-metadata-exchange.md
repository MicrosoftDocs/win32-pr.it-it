...
title: Controllo delle tracce di rete per i metadati HTTP Exchange
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="inspecting-network-traces-for-http-metadata-exchange"></a>Controllo delle tracce di rete per i metadati HTTP Exchange
