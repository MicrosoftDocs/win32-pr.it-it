...
description: Quando si verifica un errore, l'Gestione connessioni di accesso remoto richiama il gestore di notifica del client.
...
Quando si verifica un errore, l'Gestione connessioni di accesso remoto richiama il gestore di notifica del client. La notifica indica lo stato della connessione quando si è verificato l'errore e un codice che identifica l'errore. In questi casi, il gestore di notifica deve chiamare [**RasHangUp**](/windows/desktop/api/Ras/nf-ras-rashangupa) per terminare la connessione RAS.
