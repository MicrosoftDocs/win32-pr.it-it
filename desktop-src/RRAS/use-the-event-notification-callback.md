...
---
# <a name="use-the-event-notification-callback"></a><span data-ttu-id="37170-104">USA callback di notifica degli eventi</span><span class="sxs-lookup"><span data-stu-id="37170-104">Use the Event Notification Callback</span></span>

<span data-ttu-id="37170-105">Nella procedura riportata di seguito vengono descritti i passaggi che il client deve utilizzare per ricevere i messaggi di notifica delle modifiche dal \_ callback dell'evento RTM \_ .</span><span class="sxs-lookup"><span data-stu-id="37170-105">The following procedure outlines the steps the client should use to receive change notification messages from the RTM\_EVENT\_CALLBACK.</span></span> <span data-ttu-id="37170-106">Il codice di esempio seguente illustra come implementare la procedura.</span><span class="sxs-lookup"><span data-stu-id="37170-106">The sample code that follows shows how to implement the procedure.</span></span>

<span data-ttu-id="37170-107">**Come recuperare i messaggi di notifica delle modifiche**</span><span class="sxs-lookup"><span data-stu-id="37170-107">**How to retrieve the change notification messages**</span></span>

1.  <span data-ttu-id="37170-108">Chiamare [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) per recuperare un set di modifiche.</span><span class="sxs-lookup"><span data-stu-id="37170-108">Call [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) to retrieve a set of changes.</span></span>
2.  <span data-ttu-id="37170-109">Elaborare le modifiche.</span><span class="sxs-lookup"><span data-stu-id="37170-109">Process the changes.</span></span>
3.  <span data-ttu-id="37170-110">Rilasciare le destinazioni usando [**RtmReleaseChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmreleasechangeddests).</span><span class="sxs-lookup"><span data-stu-id="37170-110">Release the destinations using [**RtmReleaseChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmreleasechangeddests).</span></span>
4.  <span data-ttu-id="37170-111">Ripetere i passaggi 1, 2 e 3 fino [](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) a quando RtmGetChangedDests \_ non restituisce \_ più \_ elementi.</span><span class="sxs-lookup"><span data-stu-id="37170-111">Repeat steps 1, 2, and 3 until [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) returns ERROR\_NO\_MORE\_ITEMS.</span></span>

<span data-ttu-id="37170-112">Nell'esempio di codice seguente viene illustrato come elaborare un callback di [**\_ \_ callback di evento RTM**](/windows/win32/api/rtmv2/nc-rtmv2-_event_callback) ricevuto da Gestione tabelle di routing.</span><span class="sxs-lookup"><span data-stu-id="37170-112">The following sample code shows how to process an [**RTM\_EVENT\_CALLBACK**](/windows/win32/api/rtmv2/nc-rtmv2-_event_callback) callback received from the routing table manager.</span></span>
