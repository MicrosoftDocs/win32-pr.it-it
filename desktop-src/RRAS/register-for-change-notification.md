...
---
# <a name="register-for-change-notification"></a><span data-ttu-id="a1ef8-104">Registra per notifica modifiche</span><span class="sxs-lookup"><span data-stu-id="a1ef8-104">Register For Change Notification</span></span>

<span data-ttu-id="a1ef8-105">Nell'esempio di codice seguente viene illustrato come eseguire la registrazione per le notifiche di modifica nella tabella di routing.</span><span class="sxs-lookup"><span data-stu-id="a1ef8-105">The following sample code shows how to register for change notifications in the routing table.</span></span> <span data-ttu-id="a1ef8-106">Nell'argomento "[use the Event Notification callback](use-the-event-notification-callback.md)" viene illustrato come utilizzare le notifiche di modifica.</span><span class="sxs-lookup"><span data-stu-id="a1ef8-106">The topic "[Use the Event Notification Callback](use-the-event-notification-callback.md)" demonstrates how to utilize those change notifications.</span></span>
