...
---
# <a name="register-with-the-routing-table-manager"></a><span data-ttu-id="fcd6f-103">Eseguire la registrazione con gestione tabelle di routing</span><span class="sxs-lookup"><span data-stu-id="fcd6f-103">Register with the Routing Table Manager</span></span>

<span data-ttu-id="fcd6f-104">Nell'esempio di codice seguente viene illustrato come registrare una nuova entità con gestione tabelle di routing.</span><span class="sxs-lookup"><span data-stu-id="fcd6f-104">The following sample code shows how to register a new entity with the routing table manager.</span></span>
