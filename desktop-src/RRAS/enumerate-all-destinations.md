...
---
# <a name="enumerate-all-destinations"></a><span data-ttu-id="bf835-103">Enumera tutte le destinazioni</span><span class="sxs-lookup"><span data-stu-id="bf835-103">Enumerate All Destinations</span></span>

<span data-ttu-id="bf835-104">Nell'esempio di codice riportato di seguito viene illustrato come enumerare tutte le destinazioni nella tabella di routing.</span><span class="sxs-lookup"><span data-stu-id="bf835-104">The following sample code shows how to enumerate all destinations in the routing table.</span></span>
