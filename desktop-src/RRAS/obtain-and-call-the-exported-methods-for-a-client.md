---
title: Ottenere e chiamare i metodi esportati per un client
description: Nell'esempio di codice seguente viene illustrato come ottenere un elenco di metodi esportati da un client e come richiamare un metodo per tale client.
...
ms.locfileid: "104470795"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="5b75c-103">Ottenere e chiamare i metodi esportati per un client</span><span class="sxs-lookup"><span data-stu-id="5b75c-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="5b75c-104">Nell'esempio di codice seguente viene illustrato come ottenere un elenco di metodi esportati da un client e come richiamare un metodo per tale client.</span><span class="sxs-lookup"><span data-stu-id="5b75c-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
