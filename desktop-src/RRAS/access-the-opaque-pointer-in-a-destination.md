---
title: Accedere al puntatore opaco in una destinazione
description: Nell'esempio di codice seguente viene illustrato come accedere al puntatore opaco in una destinazione.
...
ms.locfileid: "104044835"
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="08471-103">Accedere al puntatore opaco in una destinazione</span><span class="sxs-lookup"><span data-stu-id="08471-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="08471-104">Nell'esempio di codice seguente viene illustrato come accedere al puntatore opaco in una destinazione.</span><span class="sxs-lookup"><span data-stu-id="08471-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
