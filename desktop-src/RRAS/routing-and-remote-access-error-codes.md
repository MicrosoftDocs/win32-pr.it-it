...
<td>L'handle di porta fornito non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>È stato rilevato un evento non valido.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il buffer fornito non è valido.<br/></td>
</tr>
<tr class="even">
...
<td>Buffer disponibili insufficienti.<br/></td>
</tr>
<tr class="even">
...
<td>La porta o il dispositivo specificato è già in disconnessione.<br/></td>
</tr>
<tr class="odd">
...
<td>Le informazioni trovate nella rubrica specificata non sono valide.<br/></td>
</tr>
<tr class="odd">
...
<td>Dimensioni della struttura non corrette.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata è già in uso o non è configurata per la connessione remota.<br/></td>
</tr>
<tr class="odd">
...
<td>Non è disponibile alcuna rete asincrona.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore che interessa NetBIOS.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>il server non può allocare le risorse NetBIOS necessarie per supportare il client.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non si riceveranno popup di messaggi di rete.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>L'account specificato non è autorizzato ad accedere in questa ora del giorno.<br/></td>
</tr>
<tr class="even">
...
<td>Il dispositivo ha restituito una risposta non riconosciuta.<br/></td>
</tr>
<tr class="even">
...
<td>Macro <defaultoff> nel dispositivo . La sezione del file INF contiene una macro non definita.<br/></td>
</tr>
<tr class="even">
...
<td>Il dispositivo . Impossibile aprire il file INF.<br/></td>
</tr>
<tr class="odd">
...
<td>Nome del dispositivo nel dispositivo . FILE INF o file .INI file è troppo lungo. <br/></td>
</tr>
<tr class="even">
...
<td>Tentativo di impostare una macro non elencata nel dispositivo . Sezione del file INF.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere il file di .INI multimediale.<br/></td>
</tr>
<tr class="odd">
...
<td>Il parametro di utilizzo nel file di .ini non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile leggere il nome della sezione dal file di .INI multimediale.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere il tipo di dispositivo dal file di .INI multimediale.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile leggere il nome del dispositivo dal file di .INI multimediale.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere l'utilizzo dal file di .INI multimediale.<br/></td>
</tr>
<tr class="odd">
...
<td>Non è presente alcun segnale acustico.<br/></td>
</tr>
<tr class="even">
...
<td>Si è verificato un errore durante la scrittura della velocità massima di connessione.<br/></td>
</tr>
<tr class="odd">
...
<td>Accesso negato perché il nome utente, la password o entrambi non sono validi nel dominio.<br/></td>
</tr>
<tr class="odd">
...
<td>Le macchine a stati non vengono avviate.<br/></td>
</tr>
<tr class="odd">
...
<td>Il dispositivo è stato spostato a una velocità di connessione non supportata dal driver COM.<br/></td>
</tr>
<tr class="odd">
...
<td>Sono stati rilevati errori di overrun seriale durante la comunicazione con il modem.<br/></td>
</tr>
<tr class="even">
...
<td>Inizializzazione della porta bidirezionale in corso. Attendere alcuni secondi e ripetere l'attesa.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non sono disponibili canali ISDN per effettuare la chiamata.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un timeout PPP.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione è stata terminata dal computer remoto.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo IPX non può essere usato per la connessione remota su più di una porta alla volta.<br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile accedere TCPCFG.DLL.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non è possibile usare SLIP a meno che non sia installato il protocollo IP.<br/></td>
</tr>
<tr class="odd">
...
<td>La registrazione del computer non è stata completata.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo di controllo del collegamento PPP è stato terminato.<br/></td>
</tr>
<tr class="even">
...
<td>Il computer remoto ha terminato il protocollo di controllo.<br/></td>
</tr>
<tr class="even">
...
<td>Il server remoto non può usare la Windows NT password crittografata.<br/></td>
</tr>
<tr class="odd">
...
<td>I dispositivi TAPI configurati per l'accesso remoto non sono stati inizializzati o non sono stati installati correttamente.<br/></td>
</tr>
<tr class="even">
...
<td>Il sistema non può usare il numero di rete IPX assegnato dal computer remoto. Nel registro eventi sono disponibili informazioni aggiuntive.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il modulo di gestione sessione (SMM) non è valido.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>È stato specificato il valore SMM errato.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Impossibile disconnettere la connessione perché è stata creata dal router multi-protocollo.<br/></td>
</tr>
<tr class="odd">
...
<td>Il sistema non è stato in grado di trovare il bundle a più collegamenti.<br/></td>
</tr>
<tr class="even">
...
<td>Il sistema non può eseguire una chiamata automatica perché per questa connessione è specificato un dialer personalizzato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione è già in corso di composizione.<br/></td>
</tr>
<tr class="even">
...
<td>Ras non può essere avviato automaticamente. Nel registro eventi sono disponibili informazioni aggiuntive.<br/></td>
</tr>
<tr class="odd">
...
<td>Condivisione connessione Internet (ICS) è già abilitato nella connessione.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante la modifica delle impostazioni di Condivisione connessione Internet esistenti.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante l'a attivazione delle funzionalità di routing.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante l'a attivazione di Condivisione connessione Internet per la connessione.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La Condivisione connessione Internet non può essere abilitata. È presente più di una connessione LAN diversa dalla connessione da condividere.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non smart card lettore.<br/></td>
</tr>
<tr class="even">
...
<td>La Condivisione connessione Internet non può essere abilitata. Una connessione LAN è già configurata con l'indirizzo IP necessario per l'indirizzamento IP automatico. <br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile trovare un certificato. Le connessioni che usano il protocollo L2TP su IPSec richiedono l'installazione di un certificato computer, noto anche come certificato computer. <br/></td>
</tr>
<tr class="even">
...
<td>La Condivisione connessione Internet non può essere abilitata. Per la connessione LAN selezionata come rete privata sono configurati più indirizzi IP. Riconfigurare la connessione LAN con un singolo indirizzo IP prima di abilitare Condivisione connessione Internet. <br/></td>
</tr>
<tr class="odd">
...
<td>Il tentativo di connessione non è riuscito a causa di un errore di crittografia dei dati. <br/></td>
</tr>
<tr class="even">
...
<td>L'hardware di rete del computer remoto non è compatibile con il tipo di chiamata richiesto. <br/></td>
</tr>
<tr class="even">
...
<td>La chiamata non è stata connessa perché il computer remoto ha richiamato la funzionalità Non disturbare. <br/></td>
</tr>
<tr class="even">
...
<td>Condivisione connessione (NAT) è attualmente installato come protocollo di routing e deve essere rimosso prima di abilitare Condivisione connessione Internet.<br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione L2TP non è riuscito perché il livello di sicurezza non è riuscito a negoziare parametri compatibili con il computer remoto. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione L2TP non è riuscito perché i criteri di sicurezza per la connessione non sono stati trovati. <br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile stabilire una connessione al computer remoto perché il modem non è stato trovato o era occupato. <br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
Windows 7 e versioni successive: l'host deve essere configurato per l'uso <strong>di 192.168.137.1</strong>
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile stabilire la connessione VPN. Il server VPN potrebbe non essere raggiungibile o i parametri di sicurezza potrebbero non essere configurati correttamente per questa connessione. <br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>È stata avviata una connessione tra il computer e il server VPN, ma non è possibile completare la connessione VPN. La causa più comune è che almeno un dispositivo Internet (ad esempio, un firewall o un router) tra il computer e il server VPN non è configurato per consentire pacchetti di protocollo GRE (Generic Routing Encapsulation).<br/>
<blockquote>
[!Note]<br />
...
<td>Non è stato possibile stabilire la connessione di rete tra il computer e il server VPN perché il server remoto non risponde. Ciò potrebbe essere dovuto al fatto che uno dei dispositivi di rete (ad esempio, firewall, NAT, router) tra il computer e il server remoto non è configurato per consentire le connessioni VPN.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>È stata avviata una connessione di rete tra il computer e il server VPN, ma la connessione VPN non è stata completata. Ciò è in genere causato dall'uso di un certificato errato o scaduto per l'autenticazione tra il client e il server.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows
</blockquote>
...
<td>impossibile stabilire la connessione a causa di un criterio configurato nel server RAS/VPN. In particolare, il metodo di autenticazione usato dal server per verificare il nome utente e la password potrebbe non corrispondere al metodo di autenticazione configurato nel profilo di connessione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è provato a stabilire una seconda connessione a banda larga mentre è già stata stabilita una connessione a banda larga precedente usando lo stesso dispositivo o la stessa porta.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Impossibile eliminare una connessione mentre è connessa.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione di Protezione accesso alla rete non è stato in grado di creare risorse di sistema per le connessioni di accesso remoto. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il servizio Agente protezione accesso alla rete è stato disabilitato o non è installato nel computer. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione di Protezione accesso alla rete non è riuscito a eseguire la registrazione con il servizio Agente protezione accesso alla rete. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione protezione accesso alla rete non è riuscito a elaborare la richiesta perché la connessione di accesso remoto non esiste.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione di Protezione accesso alla rete non ha risposto. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il Crypto-Binding type-length-value (TLV) ricevuto non è valido.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Crypto-Binding TLV non è stata ricevuta.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo PPTP (Point-to-Point Tunneling Protocol) non è compatibile con IPv6. Modificare il tipo di rete privata virtuale in Layer Two Tunneling Protocol (L2TP).<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non è possibile completare la connessione L2TP/IPsec perché il servizio Moduli di chiave IPSec IKE e AuthIP e/o il servizio Base Filtering Engine non è in esecuzione. Questi servizi sono necessari per stabilire una connessione L2TP/IPSec.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata a causa di un timeout di inattività.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata perché l'utente si è disconnesso.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata perché si è verificato un cambio utente.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata a causa dell'ibernazione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata perché il sistema è stato sospeso.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata perché Gestione connessione Accesso remoto è stata arrestata.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il tentativo di connessione L2TP non è riuscito perché il livello di sicurezza non è stato in grado di autenticare il computer remoto. È possibile che uno o più campi del certificato presentato dal server remoto non siano stati convalidati come appartenenti alla destinazione di destinazione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>È in corso un'altra richiesta di aggiornamento della connessione. RAS consente una sola richiesta di connessione di aggiornamento alla volta.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La negoziazione con il protocollo configurato è disabilitata. Modificare le proprietà di connessione, selezionare un protocollo diverso per la negoziazione e riprovare.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Negoziazione dell'indirizzo interno non riuscita.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Negoziazione dei selettori di traffico non riuscita.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La connessione VPN è ancora in connessione o si sta autenticando di nuovo a causa di una modifica dello stato di quarantena. Avviare l'aggiornamento dei dispositivi mobili solo quando lo stato della connessione è "Connesso".<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>L'autenticazione client è stata rifiutata dal server a causa della mancata corrispondenza di valori o TLV imprevisti.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La credenziale smart card cache non è valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Tentativo di connessione VPN non riuscito a causa di un errore interno durante l'aggiunta di cookie al protocollo SSTP (Secure Socket Tunneling Protocol). Per informazioni dettagliate, vedere il registro eventi di sistema.<br/></td>
</tr>
<tr class="even">
...
<td>Il tipo di protocollo Extensible Authentication Protocol necessario per l'autenticazione della connessione di accesso remoto non è installato nel computer.<br/></td>
</tr>
<tr class="even">
...
<td>Il tipo extensible authentication protocol configurato nella connessione di accesso remoto non supporta l'accesso Single Sign-On.<br/></td>
</tr>
<tr class="odd">
...
<td>Il tipo extensible authentication protocol configurato nella connessione di accesso remoto non supporta l'operazione richiesta.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client per il server non è valido. Verificare che il certificato usato per l'autenticazione sia valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client per il server è scaduto. Rinnovare il certificato.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client per il server è stato revocato. Usare un certificato che non è stato revocato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato utilizzato dal client per autenticare il server non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato utilizzato dal client per autenticare il server è scaduto.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato utilizzato dal client per autenticare il server è stato revocato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché non è stato trovato un certificato radice attendibile che convalida il certificato utente nell'archivio Autorità di certificazione radice disponibile nell'elenco locale certificati.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato radice attendibile utilizzato per convalidare il certificato utente non è valido.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato nell'archivio certificati Autorità di certificazione radice disponibile nell'elenco locale che autentica il certificato utente è scaduto. Rinnovare il certificato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché un certificato che convalida il certificato del server non è stato trovato nell'Autorità di certificazione radice disponibile nell'elenco locale certificati.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato nell'archivio certificati Autorità di certificazione radice disponibile nell'elenco locale che convalida il certificato del server non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché per il certificato nel computer server non è specificato un nome di server.<br/></td>
</tr>
<tr class="even">
...
<td>L'identità esterna PEAP non corrisponde all'identità interna quando la privacy dell'identità è disattivata.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione remota non è stata stabilita perché il nome del server di accesso remoto non è stato risolto.<br/></td>
</tr>
<tr class="even">
...
<td>L'interfaccia non può essere abilitata perché è stata creata più di un'interfaccia con la stessa destinazione con il metodo di autenticazione con chiave precondi condivisa. Modificare il metodo di destinazione/autenticazione e abilitare l'interfaccia .<br/></td>
</tr>
</tbody>
</table>
...
<td>Questa interfaccia è già in corso di connessione.<br/></td>
</tr>
<tr class="even">
...
<td>La configurazione dell'interfaccia non è valida. Esiste già un'altra interfaccia connessa alla stessa interfaccia sul router remoto.<br/></td>
</tr>
<tr class="even">
...
<td>Non sono disponibili porte abilitate per il routing per l'uso da parte di questa interfaccia di connessione a richiesta.<br/></td>
</tr>
<tr class="odd">
...
<td>L'interfaccia non è al momento raggiungibile.<br/></td>
</tr>
<tr class="odd">
...
<td>Nessun server RADIUS si trova nella rete.<br/></td>
</tr>
<tr class="even">
...
<td>Non si dispone dell'autorizzazione per connettersi usando il tipo di dispositivo corrente.<br/></td>
</tr>
<tr class="odd">
...
<td>La configurazione del router salvata non è compatibile con il router corrente.<br/></td>
</tr>
<tr class="odd">
...
<td>Accesso remoto ha rilevato account utente in formato precedente di cui non verrà eseguita automaticamente la migrazione.<br/></td>
</tr>
<tr class="even">
...
<td>Il pacchetto ricevuto dal server RADIUS in non è valido.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>Authenticator non corrisponde nel pacchetto dal server RADIUS.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
