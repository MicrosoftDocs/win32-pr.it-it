...
I codici di errore API RRAS (routing e accesso remoto) seguenti sono definiti in raserror. h. Tutti i codici di errore sono supportati in Windows 2000 o versioni successive di Windows, a meno che non sia specificato diversamente.
...
<td>L'handle di porta specificato non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta specificata è già aperta.<br/></td>
</tr>
<tr class="even">
...
<td>Il buffer fornito è troppo piccolo.<br/></td>
</tr>
<tr class="odd">
...
<td>Le informazioni sulla porta specificate non sono corrette.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile impostare le informazioni sulla porta specificate.<br/>
<blockquote>
[!Note]<br />
...
<td>La porta specificata non è connessa.<br/></td>
</tr>
<tr class="even">
...
<td>Rilevato un evento non valido.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il dispositivo specificato non esiste.<br/></td>
</tr>
<tr class="even">
...
<td>Il tipo di dispositivo specificato non esiste.<br/></td>
</tr>
<tr class="odd">
...
<td>Il buffer specificato non è valido.<br/></td>
</tr>
<tr class="even">
...
<td>È stata specificata una route non disponibile.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La route specificata non è allocata.<br/></td>
</tr>
<tr class="even">
...
<td>La compressione specificata non è valida.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Buffer insufficienti disponibili.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata non è stata trovata.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta o il dispositivo specificato è già in stato di disconnessione.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta specificata non è aperta.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata è disconnessa.<br/></td>
</tr>
<tr class="odd">
...
<td>Le informazioni contenute nella rubrica specificata non sono valide.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile trovare la chiave specificata.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta specificata è stata disconnessa.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata è stata disconnessa dal computer remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta specificata è stata disconnessa a causa di un errore hardware.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata è stata disconnessa dall'utente.<br/></td>
</tr>
<tr class="odd">
...
<td>Dimensione della struttura non corretta.<br/></td>
</tr>
<tr class="even">
...
<td>La porta specificata è già in uso o non è configurata per la connessione remota di accesso remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un errore sconosciuto.<br/></td>
</tr>
<tr class="odd">
...
<td>Il dispositivo errato è collegato alla porta specificata.<br/></td>
</tr>
<tr class="even">
...
<td>Timeout della richiesta.<br/></td>
</tr>
<tr class="even">
...
<td>Nessuna rete asincrona disponibile.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore relativo a NetBIOS.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>il server non è in grado di allocare le risorse NetBIOS necessarie per supportare il client.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Uno dei nomi NetBIOS del computer è già registrato nella rete remota.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Una scheda di rete nel server non è riuscita.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non si riceveranno popup del messaggio di rete.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore di autenticazione interno.<br/></td>
</tr>
<tr class="odd">
...
<td>L'account specificato non è autorizzato ad accedere a questa ora del giorno.<br/></td>
</tr>
<tr class="even">
...
<td>L'account specificato è disabilitato.<br/></td>
</tr>
<tr class="odd">
...
<td>La password specificata è scaduta.<br/></td>
</tr>
<tr class="even">
...
<td>L'account specificato non dispone delle autorizzazioni di accesso remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Il server di accesso remoto non risponde.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il modem o un altro dispositivo di connessione ha segnalato un errore.<br/></td>
</tr>
<tr class="odd">
...
<td>Una risposta non riconosciuta è stata restituita dal dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>Una macro richiesta dal dispositivo non è stata trovata nel dispositivo. Sezione del file INF.<br/></td>
</tr>
<tr class="odd">
...
<td>Comando o risposta nel dispositivo. La sezione del file INF fa riferimento a una macro non definita.<br/></td>
</tr>
<tr class="even">
...
<td>La <defaultoff> macro nel dispositivo. La sezione del file INF contiene una macro non definita.<br/></td>
</tr>
<tr class="even">
...
<td>Il dispositivo. Non è stato possibile aprire il file INF.<br/></td>
</tr>
<tr class="odd">
...
<td>Nome del dispositivo nel dispositivo. INF o supporti. Il file INI è troppo lungo. <br/></td>
</tr>
<tr class="even">
...
<td>Supporti. Il file INI fa riferimento a un nome di dispositivo sconosciuto.<br/></td>
</tr>
<tr class="odd">
...
<td>Il dispositivo. Il file INF non contiene risposte per il comando.<br/></td>
</tr>
<tr class="even">
...
<td>Il dispositivo. Nel file INF manca un comando.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è tentato di impostare una macro non elencata nel dispositivo. Sezione del file INF.<br/></td>
</tr>
<tr class="even">
...
<td>Supporti. Il file INI fa riferimento a un tipo di dispositivo sconosciuto.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile allocare memoria.<br/></td>
</tr>
<tr class="even">
...
<td>La porta non è configurata per l'accesso remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Il modem o un altro dispositivo di connessione non funziona.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere i supporti. File INI.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione è stata rimossa.<br/></td>
</tr>
<tr class="even">
...
<td>Il parametro Usage nel file media. ini non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile leggere il nome della sezione dal supporto. File INI.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere il tipo di dispositivo dal supporto. File INI.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile leggere il nome del dispositivo dal supporto. File INI.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile leggere l'utilizzo dal supporto. File INI.<br/></td>
</tr>
<tr class="odd">
...
<td>Il sistema non è riuscito a leggere la velocità massima di connessione del vettore dal supporto. File INI.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Nessun segnale di connessione.<br/></td>
</tr>
<tr class="even">
<td><span id="ERROR_IN_COMMAND"></span><span id="error_in_command"></span><dl> <dt><strong>ERROR_IN_COMMAND</strong></dt> <dt>681</dt> </dl></td>
<td>Il modem (o un altro dispositivo di connessione) ha segnalato un errore generale.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante la scrittura del nome della sezione.<br/></td>
</tr>
<tr class="even">
...
<td>Si è verificato un errore durante la scrittura del tipo di dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un errore durante la scrittura del nome del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>Si è verificato un errore durante la scrittura della velocità massima della connessione.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un errore durante la scrittura della velocità massima del vettore.<br/></td>
</tr>
<tr class="even">
...
<td>Si è verificato un errore durante la scrittura dell'utilizzo.<br/></td>
</tr>
<tr class="odd">
...
<td>Supporti. Il file INI è vuoto.<br/></td>
</tr>
<tr class="even">
...
<td>Accesso negato perché il nome utente, la password o entrambi non sono validi per il dominio.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un errore hardware nella porta o nel dispositivo collegato<br/></td>
</tr>
<tr class="even">
...
<td>La macro non è una macro binaria.<br/></td>
</tr>
<tr class="odd">
...
<td>Le macchine a Stati non sono avviate.<br/></td>
</tr>
<tr class="odd">
...
<td>Le macchine a Stati sono già avviate.<br/></td>
</tr>
<tr class="even">
...
<td>Ciclo di risposta parziale.<br/></td>
</tr>
<tr class="odd">
...
<td>La risposta del dispositivo ha causato un overflow del buffer.<br/></td>
</tr>
<tr class="odd">
...
<td>Comando espanso nel dispositivo. Il file INF è troppo lungo.<br/></td>
</tr>
<tr class="even">
...
<td>Il dispositivo è stato spostato in una velocità di connessione non supportata dal driver COM.<br/></td>
</tr>
<tr class="odd">
...
<td>Risposta del dispositivo ricevuta quando non è previsto alcun valore.<br/></td>
</tr>
<tr class="even">
...
<td>È stato specificato un numero di callback non valido.<br/></td>
</tr>
<tr class="even">
...
<td>Lo stato di autenticazione specificato non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un errore durante la scrittura della velocità di connessione iniziale.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>È stata ricevuta un'indicazione di diagnostica X. 25.<br/></td>
</tr>
<tr class="odd">
...
<td>L'account specificato è scaduto.<br/></td>
</tr>
<tr class="even">
...
<td>Si è verificato un errore durante il tentativo di modificare la password nel dominio.<br/></td>
</tr>
<tr class="odd">
<td><span id="ERROR_OVERRUN"></span><span id="error_overrun"></span><dl> <dt><strong>ERROR_OVERRUN</strong></dt> <dt>710</dt> </dl></td>
<td>Sono stati rilevati errori di sovraccarico seriale durante la comunicazione con il modem.<br/></td>
</tr>
<tr class="even">
...
<td>Errore di inizializzazione di RasMan. Controllare il registro eventi.<br/></td>
</tr>
<tr class="odd">
...
<td>Inizializzazione della porta bidirezionale. Attendere alcuni secondi e ricomporre.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Nessun canale ISDN disponibile per effettuare la chiamata.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La configurazione IP di accesso remoto è inutilizzabile.<br/></td>
</tr>
<tr class="even">
...
<td>Non sono disponibili indirizzi IP nel pool statico di indirizzi IP di accesso remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Si è verificato un timeout di PPP.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione è stata interrotta dal computer remoto.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non sono configurati protocolli di controllo PPP.<br/></td>
</tr>
<tr class="even">
...
<td>Il peer PPP remoto non risponde.<br/></td>
</tr>
<tr class="odd">
...
<td>Il pacchetto PPP non è valido.<br/></td>
</tr>
<tr class="even">
...
<td>Il numero di telefono, inclusi il prefisso e il suffisso, è troppo lungo.<br/></td>
</tr>
<tr class="odd">
...
<td>Il protocollo IPX non può comparire sul modem (o su un altro dispositivo di connessione) perché il computer non è configurato per la connessione (si tratta di un router IPX).<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo IPX non è in grado di connettersi al modem (o a un altro dispositivo di connessione) perché il computer non è configurato per la connessione (il router IPX non è installato).<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo IPX non può essere utilizzato per la connessione remota su più di una porta alla volta.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile accedere TCPCFG.DLL.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Impossibile trovare una scheda IP associata all'accesso remoto.<br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile utilizzare SLIP a meno che non sia installato il protocollo IP.<br/></td>
</tr>
<tr class="odd">
...
<td>La registrazione del computer non è completa.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il protocollo specificato non è configurato.<br/></td>
</tr>
<tr class="odd">
...
<td>La negoziazione PPP non è convergente.<br/></td>
</tr>
<tr class="even">
...
<td>il protocollo di controllo PPP per il protocollo di rete specificato non è disponibile nel server.<br/></td>
</tr>
<tr class="odd">
...
<td>Il protocollo di controllo dei collegamenti PPP è stato terminato.<br/></td>
</tr>
<tr class="even">
...
<td>L'indirizzo richiesto è stato rifiutato dal server.<br/></td>
</tr>
<tr class="odd">
...
<td>Il protocollo di controllo è stato terminato dal computer remoto.<br/></td>
</tr>
<tr class="even">
...
<td>Il server non ha assegnato un indirizzo.<br/></td>
</tr>
<tr class="even">
...
<td>Il server remoto non è in grado di utilizzare la password crittografata di Windows NT.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile inizializzare o non installare correttamente i dispositivi TAPI configurati per l'accesso remoto.<br/></td>
</tr>
<tr class="even">
...
<td>Il computer locale non supporta la crittografia.<br/></td>
</tr>
<tr class="odd">
...
<td>Il server remoto non supporta la crittografia.<br/></td>
</tr>
<tr class="even">
...
<td>Il computer remoto richiede la crittografia dei dati.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il sistema non è in grado di utilizzare il numero di rete IPX assegnato dal computer remoto. Nel registro eventi vengono fornite informazioni aggiuntive.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il modulo di gestione della sessione (SMM) non è valido.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il SMM non è inizializzato.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>È stato specificato un numero di telefono non valido.<br/></td>
</tr>
<tr class="odd">
...
<td>Il SMM errato è stato specificato.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Il numero di callback contiene un carattere non valido. Sono consentiti solo i 18 caratteri seguenti: da 0 a 9, T, P, W, (,),-, @ e spazio.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore di sintassi durante l'elaborazione di uno script.<br/></td>
</tr>
<tr class="even">
...
<td>Non è stato possibile disconnettere la connessione perché è stata creata dal router multiprotocollo.<br/></td>
</tr>
<tr class="odd">
...
<td>Il sistema non è riuscito a trovare il bundle a più collegamenti.<br/></td>
</tr>
<tr class="even">
...
<td>Il sistema non è in grado di eseguire la connessione automatica perché per questa connessione è stato specificato un dialer personalizzato.<br/></td>
</tr>
<tr class="odd">
...
<td>Questa connessione è già in corso di composizione.<br/></td>
</tr>
<tr class="even">
...
<td>Non è stato possibile avviare automaticamente RAS. Nel registro eventi vengono fornite informazioni aggiuntive.<br/></td>
</tr>
<tr class="odd">
...
<td>Condivisione connessione Internet (ICS) è già abilitata per la connessione.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante la modifica delle impostazioni di condivisione della connessione Internet esistenti.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante l'abilitazione delle funzionalità di routing.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante l'abilitazione della condivisione della connessione Internet per la connessione.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Si è verificato un errore durante la configurazione della rete locale per la condivisione.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Non è possibile abilitare la condivisione della connessione Internet. È presente più di una connessione LAN diversa dalla connessione da condividere.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Nessun lettore di smart card installato.<br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile abilitare la condivisione della connessione Internet. Una connessione LAN è già configurata con l'indirizzo IP richiesto per l'indirizzamento automatico degli indirizzi IP. <br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile trovare un certificato. Per le connessioni che utilizzano il protocollo L2TP su IPSec è richiesta l'installazione di un certificato del computer, noto anche come certificato del computer. <br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile abilitare la condivisione della connessione Internet. Per la connessione LAN selezionata come rete privata è stato configurato più di un indirizzo IP. Riconfigurare la connessione LAN con un singolo indirizzo IP prima di abilitare la condivisione della connessione Internet. <br/></td>
</tr>
<tr class="odd">
...
<td>Tentativo di connessione non riuscito a causa dell'impossibilità di crittografare i dati. <br/></td>
</tr>
<tr class="even">
...
<td>La destinazione specificata non è raggiungibile. <br/></td>
</tr>
<tr class="odd">
...
<td>Il computer remoto ha rifiutato il tentativo di connessione. <br/></td>
</tr>
<tr class="even">
<td><span id="ERROR_CONGESTION"></span><span id="error_congestion"></span><dl> <dt><strong>ERROR_CONGESTION</strong></dt> <dt>771</dt> </dl></td>
<td>Il tentativo di connessione non è riuscito perché la rete è occupata. <br/></td>
</tr>
<tr class="odd">
...
<td>L'hardware di rete del computer remoto non è compatibile con il tipo di chiamata richiesta. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione non è riuscito perché il numero di destinazione è stato modificato. <br/></td>
</tr>
<tr class="odd">
...
<td>La chiamata è stata bloccata dal computer remoto. <br/></td>
</tr>
<tr class="odd">
...
<td>Non è stato possibile connettere la chiamata perché il computer remoto ha richiamato la funzionalità non disturbare. <br/></td>
</tr>
<tr class="even">
<td><span id="ERROR_OUTOFORDER"></span><span id="error_outoforder"></span><dl> <dt><strong>ERROR_OUTOFORDER</strong></dt> <dt>777</dt> </dl></td>
<td>Il tentativo di connessione non è riuscito perché il modem o un altro dispositivo di connessione nel computer remoto non è in ordine. <br/></td>
</tr>
<tr class="odd">
...
<td>Non è stato possibile verificare l'identità del server. <br/></td>
</tr>
<tr class="even">
...
<td>Per eseguire la connessione utilizzando questa connessione, è necessario utilizzare una smart card.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>Una funzione tentata non è valida per questa connessione. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di crittografia non è riuscito perché non è stato trovato alcun certificato valido.<br/>
<blockquote>
[!Note]<br />
Deprecato in Windows Vista e versioni successive di Windows.
</blockquote>
...
<td>La condivisione della connessione (NAT) è attualmente installata come protocollo di routing e deve essere rimossa prima di abilitare la condivisione della connessione Internet.<br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile abilitare la condivisione della connessione Internet. La connessione LAN selezionata come rete privata non è presente o è disconnessa dalla rete. Verificare che la scheda LAN sia connessa prima di abilitare la condivisione della connessione Internet. <br/></td>
</tr>
<tr class="odd">
...
<td>Non è possibile comporre utilizzando questa connessione al momento dell'accesso perché è configurata per l'utilizzo di un nome utente diverso da quello della smart card. Se si desidera utilizzare questa connessione al momento dell'accesso, è necessario configurarla in modo che utilizzi il nome utente nella smart card. <br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile comporre utilizzando questa connessione al momento dell'accesso perché non è configurata per l'utilizzo di una smart card. Se si desidera utilizzarlo al momento dell'accesso, è necessario modificare le proprietà della connessione in modo che utilizzi una smart card. <br/></td>
</tr>
<tr class="odd">
...
<td>Il tentativo di connessione L2TP non è riuscito perché non è presente alcun certificato computer valido per l'autenticazione di sicurezza. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione L2TP non è riuscito perché il livello di protezione non è stato in grado di autenticare il computer remoto. <br/></td>
</tr>
<tr class="odd">
...
<td>Il tentativo di connessione L2TP non è riuscito perché il livello di sicurezza non è riuscito a negoziare i parametri compatibili con il computer remoto. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione L2TP non è riuscito perché si è verificato un errore di elaborazione durante le negoziazioni iniziali con il computer remoto. <br/></td>
</tr>
<tr class="odd">
...
<td>Il tentativo di connessione L2TP non è riuscito perché la convalida del certificato nel computer remoto non è riuscita. <br/></td>
</tr>
<tr class="even">
...
<td>Tentativo di connessione L2TP non riuscito. Impossibile trovare i criteri di sicurezza per la connessione. <br/></td>
</tr>
<tr class="odd">
...
<td>Tentativo di connessione L2TP non riuscito perché si è verificato il timeout della negoziazione di sicurezza. <br/></td>
</tr>
<tr class="even">
...
<td>Il tentativo di connessione L2TP non è riuscito perché si è verificato un errore durante la negoziazione della sicurezza. <br/></td>
</tr>
<tr class="odd">
...
<td>L'attributo RADIUS del tipo di tunnel per questo utente non è corretto. <br/></td>
</tr>
<tr class="odd">
...
<td>L'attributo RADIUS del tipo di servizio per questo utente non è Framed né un callback con frame. <br/></td>
</tr>
<tr class="even">
...
<td>Impossibile stabilire una connessione al computer remoto perché il modem non è stato trovato o è occupato. <br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile trovare un certificato che può essere utilizzato con il protocollo EAP (Extensible Authentication Protocol). <br/></td>
</tr>
<tr class="even">
...
<td>Non è possibile abilitare la condivisione della connessione Internet (ICS) a causa di un conflitto di indirizzi IP nella rete. ICS richiede che l'host sia configurato per l'uso di <strong>192.168.0.1</strong>. Assicurarsi che nessun altro client nella rete sia configurato per l'uso di <strong>192.168.0.1</strong>.<br/>
<blockquote>
[!Note]<br />
...
<blockquote>
[!Note]<br />
Windows 7 e versioni successive: l'host deve essere configurato per l'uso di <strong>192.168.137.1</strong>
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td>Non è possibile stabilire la connessione VPN. Il server VPN potrebbe non essere raggiungibile oppure è possibile che i parametri di sicurezza non siano configurati correttamente per questa connessione. <br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>Questa connessione è configurata in modo da convalidare l'identità del server di accesso, ma Windows non è in grado di verificare il certificato digitale inviato dal server.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>La scheda specificata non è stata riconosciuta. Verificare che la scheda sia inserita correttamente e che si trovi in modo sicuro.<br/>
<blockquote>
[!Note]<br />
...
<td>L'identità PEAP archiviata nel cookie di sessione non corrisponde all'identità corrente.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP con SP1 e versioni successive di Windows.
</blockquote>
...
<td>Non è possibile comporre utilizzando questa connessione al momento dell'accesso perché è configurata per l'utilizzo delle credenziali dell'utente attualmente connesso.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP con SP1 e versioni successive di Windows.
</blockquote>
...
<td>Una connessione tra il computer e il server VPN è stata avviata, ma non è possibile completare la connessione VPN. La ragione più comune è che almeno un dispositivo Internet (ad esempio un firewall o un router) tra il computer e il server VPN non è configurato per consentire i pacchetti di protocollo GRE (Generic Routing Encapsulation).<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di rete tra il computer e il server VPN è stata interrotta. Ciò può essere causato da un problema nella trasmissione VPN ed è in genere il risultato della latenza Internet o semplicemente che il server VPN ha raggiunto la capacità. Provare a riconnettersi al server VPN.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Non è stato possibile stabilire la connessione di rete tra il computer e il server VPN perché il server remoto non risponde. Il problema potrebbe essere dovuto al fatto che uno dei dispositivi di rete (ad esempio, firewall, NAT, router) tra il computer e il server remoto non è configurato per consentire le connessioni VPN.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Una connessione di rete tra il computer e il server VPN è stata avviata, ma la connessione VPN non è stata completata. Questo è in genere causato dall'utilizzo di un certificato non corretto o scaduto per l'autenticazione tra il client e il server.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows
</blockquote>
...
<td>Non è stato possibile stabilire la connessione di rete tra il computer e il server VPN perché il server remoto non risponde. Questa situazione è in genere causata da un problema di chiave precondivisa tra il client e il server. Viene usata una chiave precondivisa per garantire che l'utente si trovi in un ciclo di comunicazione di protezione IP (IPSec).<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>impossibile stabilire la connessione a causa di un criterio configurato nel server RAS/VPN. In particolare, il metodo di autenticazione utilizzato dal server per verificare il nome utente e la password potrebbe non corrispondere al metodo di autenticazione configurato nel profilo di connessione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Si è provato a stabilire una seconda connessione a banda larga mentre è già stata stabilita una connessione a banda larga precedente con lo stesso dispositivo o la stessa porta.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>La connettività Ethernet sottostante necessaria per la connessione a banda larga non è stata trovata.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Non è stato possibile stabilire la connessione di rete a banda larga nel computer perché il server remoto non risponde. Il problema potrebbe essere causato da un valore non valido per il campo ' nome servizio ' della connessione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Una funzionalità o un'impostazione che si è tentato di abilitare non è più supportata dal servizio di accesso remoto.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Non è possibile eliminare una connessione mentre è connessa.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione Protezione accesso alla rete non è stato in grado di creare risorse di sistema per le connessioni di accesso remoto. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il servizio agente protezione accesso alla rete (agente NAP) è stato disabilitato o non è installato nel computer. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione Protezione accesso alla rete non è riuscito a eseguire la registrazione con il servizio agente protezione accesso alla rete (NAP). Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione di protezione accesso alla rete non è stato in grado di elaborare la richiesta perché la connessione di accesso remoto non esiste.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il client di imposizione di protezione accesso alla rete (NAP) non ha risposto. Alcuni servizi o risorse di rete potrebbero non essere disponibili.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il Crypto-Binding tipo-lunghezza-valore (TLV) ricevuto non è valido.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Crypto-Binding TLV non è stato ricevuto.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il protocollo PPTP (Point-to-Point Tunneling Protocol) non è compatibile con IPv6. Modificare il tipo di rete privata virtuale in L2TP (Layer Two Tunneling Protocol).<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Convalida EAPTLS delle credenziali memorizzate nella cache non riuscita. Rimuovere le credenziali memorizzate nella cache.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Impossibile completare la connessione L2TP/IPsec perché il servizio moduli di chiavi IPSec IKE e AuthIP e/o il servizio motore di filtro di base non è in esecuzione. Questi servizi sono necessari per stabilire una connessione L2TP/IPSec.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Connessione terminata a causa di un timeout di inattività.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il modem (o un altro dispositivo di connessione) è stato disconnesso a causa di un errore di collegamento.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata interrotta perché l'utente si è disconnesso.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata interrotta perché si è verificato un cambio utente.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata terminata a causa della sospensione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>La connessione è stata interrotta perché il sistema è stato sospeso.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Connessione terminata perché la gestione connessione di accesso remoto è stata arrestata.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il tentativo di connessione L2TP non è riuscito perché il livello di protezione non è stato in grado di autenticare il computer remoto. Questo potrebbe essere dovuto al fatto che uno o più campi del certificato presentato dal server remoto non possono essere convalidati come appartenenti alla destinazione di destinazione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>Il computer non supporta protezione accesso alla rete.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows Vista e nelle versioni successive di Windows.
</blockquote>
...
<td>È in corso un'altra richiesta di aggiornamento della connessione. RAS consente solo una richiesta di aggiornamento della connessione alla volta.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La negoziazione con il protocollo configurato è disabilitata. Modificare le proprietà di connessione e selezionare un protocollo diverso per la negoziazione, quindi riprovare.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Negoziazione di indirizzi interni non riuscita.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Il client deve richiedere un indirizzo IPv4 o IPv6 interno.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Negoziazione di selettori di traffico non riuscita.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La mobilità è disabilitata per questa connessione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La connessione VPN sta ancora eseguendo la connessione o la ripetizione dell'autenticazione a causa della modifica dello stato di quarantena. Avviare l'aggiornamento per dispositivi mobili solo quando lo stato della connessione è "connesso".<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Il server ha rifiutato l'autenticazione client, a causa di un TLV imprevisto o di un valore non corrispondente per un TLV.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>La preferenza di destinazione VPN non è selezionata dall'utente o non è più valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Credenziale smart card memorizzata nella cache non valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
...
<td>Il tentativo di connessione VPN non è riuscito a causa di un errore interno durante l'aggiunta di cookie al protocollo SSTP (Secure Socket Tunneling Protocol). Per informazioni dettagliate, vedere il registro eventi di sistema.<br/></td>
</tr>
<tr class="even">
...
<td>Gli attributi del metodo interno PEAP archiviati nel cookie non sono validi.<br/></td>
</tr>
<tr class="odd">
...
<td>Il tipo di protocollo di autenticazione estendibile richiesto per l'autenticazione della connessione di accesso remoto non è installato nel computer.<br/></td>
</tr>
<tr class="even">
...
<td>Il tipo di protocollo di autenticazione estendibile configurato nella connessione di accesso remoto non supporta Single Sign-On.<br/></td>
</tr>
<tr class="odd">
...
<td>Il tipo di protocollo di autenticazione estendibile configurato nella connessione di accesso remoto non supporta l'operazione richiesta.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client nel server non è valido. Verificare che il certificato utilizzato per l'autenticazione sia valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client sul server è scaduto. Rinnovare il certificato.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato che autentica il client sul server viene revocato. Usare un certificato che non è stato revocato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita a causa di un errore nel certificato che autentica il client nel server.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato usato dal client per autenticare il server non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato usato dal client per autenticare il server è scaduto.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato usato dal client per autenticare il server è revocato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita a causa di un errore nel certificato utilizzato dal client per autenticare il server.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché un certificato radice attendibile che convalida il certificato utente non è stato trovato nell'archivio certificati delle autorità di certificazione radice attendibili.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato radice attendibile usato per convalidare il certificato utente non è valido.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato nell'archivio certificati delle autorità di certificazione radice attendibili che autentica il certificato utente è scaduto. Rinnovare il certificato.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché un certificato che convalida il certificato del server non è stato trovato nell'archivio certificati delle autorità di certificazione radice attendibili.<br/></td>
</tr>
<tr class="even">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato nell'archivio certificati delle autorità di certificazione radice attendibili che convalida il certificato del server non è valido.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione di accesso remoto è stata completata, ma l'autenticazione non è riuscita perché il certificato nel computer server non ha un nome di server specificato.<br/></td>
</tr>
<tr class="even">
...
<td>L'identità esterna PEAP non corrisponde all'identità interna quando la privacy delle identità è disattivata.<br/></td>
</tr>
<tr class="odd">
...
<td>La connessione remota non è stata eseguita perché il nome del server di accesso remoto non è stato risolto.<br/></td>
</tr>
<tr class="even">
...
<td>La password specificata per il certificato non è valida.<br/></td>
</tr>
<tr class="odd">
...
<td>Non è stato possibile abilitare l'interfaccia perché è stata creata più di un'interfaccia con la stessa destinazione con il metodo di autenticazione della chiave già condivisa. Modificare il metodo di destinazione/autenticazione e abilitare l'interfaccia.<br/></td>
</tr>
</tbody>
</table>
...
I codici di errore API RRAS (routing e accesso remoto) seguenti sono definiti in mprerror. h. Tutti i codici di errore sono supportati in Windows 2000 o versioni successive di Windows, a meno che non sia specificato diversamente.
...
<td>Il router non è in esecuzione.<br/></td>
</tr>
<tr class="even">
...
<td>L'interfaccia è già connessa.<br/></td>
</tr>
<tr class="odd">
...
<td>L'identificatore di protocollo specificato non è noto al router.<br/></td>
</tr>
<tr class="even">
...
<td>DDM (Demand-Dial Interface Manager) non è in esecuzione.<br/></td>
</tr>
<tr class="odd">
...
<td>Un'interfaccia con questo nome è già registrata con il router.<br/></td>
</tr>
<tr class="even">
...
<td>Un'interfaccia con questo nome non è registrata con il router.<br/></td>
</tr>
<tr class="odd">
...
<td>L'interfaccia non è connessa.<br/></td>
</tr>
<tr class="even">
...
<td>Il protocollo specificato viene arrestato.<br/></td>
</tr>
<tr class="odd">
...
<td>L'interfaccia è connessa e pertanto non può essere eliminata.<br/></td>
</tr>
<tr class="even">
...
<td>Le credenziali dell'interfaccia non sono state impostate.<br/></td>
</tr>
<tr class="odd">
...
<td>Questa interfaccia è già in fase di connessione.<br/></td>
</tr>
<tr class="even">
...
<td>È già in corso un aggiornamento delle informazioni di routing su questa interfaccia.<br/></td>
</tr>
<tr class="odd">
...
<td>L'interfaccia configurazione non è valida. Esiste già un'altra interfaccia connessa alla stessa interfaccia sul router remoto.<br/></td>
</tr>
<tr class="even">
...
<td>L'interfaccia client con questo nome esiste già ed è attualmente connessa.<br/></td>
</tr>
<tr class="odd">
...
<td>L'interfaccia si trova in uno stato disabilitato.<br/></td>
</tr>
<tr class="even">
...
<td>Il protocollo di autenticazione è stato rifiutato dal peer remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Non sono disponibili protocolli di autenticazione per l'uso.<br/></td>
</tr>
<tr class="even">
...
<td>Impossibile stabilire la connessione. il protocollo di autenticazione utilizzato dal server RAS/VPN per verificare il nome utente e la password non è stato in grado di trovare la corrispondenza con le impostazioni nel profilo di connessione.<br/></td>
</tr>
<tr class="odd">
...
<td>L'account remoto non dispone dell'autorizzazione di accesso remoto.<br/></td>
</tr>
<tr class="even">
...
<td>L'account remoto è scaduto.<br/></td>
</tr>
<tr class="odd">
...
<td>L'account remoto è disabilitato.<br/></td>
</tr>
<tr class="even">
...
<td>Accesso negato al peer remoto perché il nome utente, la password o entrambi non sono validi per il dominio.<br/></td>
</tr>
<tr class="even">
...
<td>Non sono disponibili porte abilitate per il routing per l'uso da questa interfaccia della richiesta di connessione.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta è stata disconnessa a causa di inattività.<br/></td>
</tr>
<tr class="even">
...
<td>L'interfaccia non è attualmente raggiungibile in questo momento.<br/></td>
</tr>
<tr class="odd">
...
<td>Il servizio Demand Dial è in uno stato di sospensione.<br/></td>
</tr>
<tr class="even">
...
<td>L'interfaccia è stata disconnessa dall'amministratore.<br/></td>
</tr>
<tr class="odd">
...
<td>Il server di autenticazione non ha risposto tempestivamente alle richieste di autenticazione.<br/></td>
</tr>
<tr class="even">
...
<td>È stato raggiunto il numero massimo di porte consentite per l'uso nella connessione a più collegamenti.<br/></td>
</tr>
<tr class="odd">
...
<td>È stato raggiunto il limite di tempo di connessione per l'utente.<br/></td>
</tr>
<tr class="even">
...
<td>È stato raggiunto il limite massimo per il numero di interfacce LAN supportate.<br/></td>
</tr>
<tr class="odd">
...
<td>È stato raggiunto il limite massimo per il numero di interfacce di connessione a richiesta supportate.<br/></td>
</tr>
<tr class="even">
...
<td>È stato raggiunto il limite massimo per il numero di client di accesso remoto supportati.<br/></td>
</tr>
<tr class="odd">
...
<td>La porta è stata disconnessa a causa del criterio BAP (Bandwidth Allocation Protocol).<br/></td>
</tr>
<tr class="even">
<td><span id="ERROR_USER_LIMIT"></span><span id="error_user_limit"></span><dl> <dt><strong>ERROR_USER_LIMIT</strong></dt> <dt>937</dt> </dl></td>
<td>Poiché è in uso un'altra connessione del tipo, la connessione in ingresso non può accettare la richiesta di connessione.<br/></td>
</tr>
<tr class="odd">
...
<td>Nessun server RADIUS presente nella rete.<br/></td>
</tr>
<tr class="even">
...
<td>Non si è autorizzati a connettersi in questo momento.<br/></td>
</tr>
<tr class="even">
...
<td>Non si è autorizzati a connettersi usando il tipo di dispositivo corrente.<br/></td>
</tr>
<tr class="odd">
...
<td>Impossibile stabilire la connessione perché il metodo di autenticazione utilizzato dal profilo di connessione non è consentito per l'utilizzo da parte di criteri di accesso configurati nel server RAS/VPN. In particolare, ciò può essere dovuto a differenze di configurazione tra il metodo di autenticazione selezionato nel server RAS/VPN e i criteri di accesso configurati.<br/></td>
</tr>
<tr class="even">
...
<td>Al momento non è consentito connettersi all'interfaccia.<br/></td>
</tr>
<tr class="even">
...
<td>La configurazione del router salvato non è compatibile con il router corrente.<br/></td>
</tr>
<tr class="odd">
...
<td>Accesso remoto ha rilevato gli account utente di formato precedenti che non verranno migrati automaticamente.<br/></td>
</tr>
<tr class="even">
...
<td>Il trasporto è già installato con il router.<br/></td>
</tr>
<tr class="odd">
...
<td>La lunghezza della firma ricevuta in un pacchetto dal server RADIUS non è valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>La firma ricevuta in un pacchetto dal server RADIUS non è valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>Non ha ricevuto la firma insieme a EAPMessage dal server RADIUS.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>La lunghezza o l'ID ricevuto in un pacchetto dal server RADIUS non è valido.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>La lunghezza ricevuta in un pacchetto con attributo dal server RADIUS non è valida.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>Il pacchetto ricevuto dal server RADIUS non è valido.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>L'autenticatore non corrisponde al pacchetto dal server RADIUS.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows XP e versioni successive di Windows.
</blockquote>
...
<td>Il server di routing e accesso remoto non è configurato o non è in esecuzione.<br/>
<blockquote>
[!Note]<br />
Supportato in Windows 7 e versioni successive di Windows.
</blockquote>
