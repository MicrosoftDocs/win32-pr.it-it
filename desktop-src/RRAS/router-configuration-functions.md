...
---
# <a name="router-configuration-functions"></a>Funzioni di configurazione del router

Usare le funzioni seguenti quando si sviluppa il software per configurare i router Windows.
