...
---
# <a name="routing-protocol-interface-functions"></a>Funzioni di interfaccia del protocollo di routing

Implementare le funzioni seguenti per una DLL del protocollo di routing:
...
[**GetVicini**](/windows/desktop/api/Routprot/nc-routprot-pget_neighbors)
...
[**Sepower**](/windows/desktop/api/Routprot/nc-routprot-pset_power)
...
Se il protocollo di routing supporta la gestione del servizio, implementare la funzione seguente oltre a quelle elencate in precedenza:
