...
description: Le istruzioni di definizione delle risorse definiscono le risorse che il compilatore di risorse inserisce nella risorsa (. Res) .
...
Le istruzioni di definizione delle risorse definiscono le risorse che il compilatore di risorse inserisce nella risorsa (. Res) . Dopo . Il file Res è collegato al file eseguibile. L'applicazione può caricare le risorse in fase di esecuzione in base alle esigenze. Tutte le istruzioni della risorsa associano un nome o un numero di identificazione a una determinata risorsa.
...
| [**Bitmap**](bitmap-resource.md)             | Definisce una bitmap denominarla e specificando il nome del file che la contiene. Per usare una particolare bitmap, l'applicazione la richiede in base al nome.                          |
...
| [**Icona**](icon-resource.md)                 | Definisce un'icona o un'icona animata assegnando un nome e specificando il nome del file che lo contiene. Per usare una determinata icona, l'applicazione la richiede in base al nome.            |
...
| [**Stringtable**](stringtable-resource.md)   | Definisce le risorse di tipo stringa. Le risorse stringa sono stringhe Unicode o ASCII che possono essere caricate dal file eseguibile.                                                            |
...
| [**CASELLA DI CONTROLLO AUTOMATICA**](autocheckbox-control.md)       | Crea un controllo casella di controllo automatico.                                     |
...
|------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Didascalia**](caption-statement.md)                 | Imposta il titolo per una finestra di dialogo.                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [**Caratteristiche**](characteristics-statement.md) | Specifica informazioni su una risorsa che possono essere usate dallo strumento che può leggere o scrivere file di definizione delle risorse.                                                                                                                                                                                                                                                                                                                                                                           |
| [**Classe**](class-statement.md)                     | Imposta la classe della finestra di dialogo.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [**EXSTYLE**](exstyle-statement.md)                 | Imposta lo stile esteso della finestra di dialogo.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [**Carattere**](font-statement.md)                       | Imposta il tipo di carattere con cui il sistema disegna testo per la finestra di dialogo.                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [**Lingua**](language-statement.md)               | Imposta la lingua per tutte le risorse fino all'istruzione [**LANGUAGE**](language-statement.md) successiva o alla fine del file. Quando **l'istruzione LANGUAGE** viene visualizzata prima dell'inizio del corpo di una definizione di risorsa [**ACCELERATORS**](accelerators-resource.md), [**DIALOG**](dialog-resource.md), [**MENU**](menu-resource.md), [**RCDATA**](rcdata-resource.md)o [**STRINGTABLE,**](stringtable-resource.md) la lingua specificata si applica solo a tale risorsa. |
