---
title: Strutture di menu
description: Strutture di menu
...
-   [**VOCE DEL MODELLO MENUEX \_ \_**](menuex-template-item.md)
...
-   [**PARAMETRI TPM**](/windows/win32/api/winuser/ns-winuser-tpmparams)
