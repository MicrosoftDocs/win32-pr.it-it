...
description: Per quattro valori texel che verrebbero usati in un'operazione di filtro bi lineare, restituisce un confronto tra il componente rosso e un valore di confronto insieme allo stato del mapping delle sezioni. | Funzione Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2,uint)
...
ms.locfileid: "117723988"
---
# <a name="texture2dgathercmpredsfloatfloatint2int2int2int2uint-function"></a>Funzione Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2,uint)
