---
title: uaddc (sm5 - asm)
description: Intero senza segno aggiunto con carry.
...
ms.locfileid: "117722189"
---
# <a name="uaddc-sm5---asm"></a>uaddc (sm5 - asm)

Intero senza segno aggiunto con carry.
...
|--------------------------------------------------------------------|--------------------------------------------------------|
| <span id="dest0"></span><span id="DEST0"></span>*dest0*<br/> | \[in \] Indirizzo del risultato.<br/>               |
...
*dest1* può essere NULL se il supporto non è necessario.

Usare questa istruzione per l'aritmetica a precisione elevata.
