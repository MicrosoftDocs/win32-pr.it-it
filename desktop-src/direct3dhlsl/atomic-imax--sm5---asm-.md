...
Questa operazione esegue un singolo componente con segno massimo a 32 bit di operando *src0* in *dst* a 32 bit per indirizzo componente *dstAddress*, eseguito in modo atomico.
