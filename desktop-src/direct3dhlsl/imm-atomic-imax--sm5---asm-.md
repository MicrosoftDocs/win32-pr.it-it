...
Segno atomico immediato max alla memoria. Restituisce un valore in memoria prima dell'operazione max.



| IMM \_ Atomic \_ IMAX dst0 \[ . singolo \_ componente \_ mask \] , DST1, dstAddress \[ . Swizzle \] , src0 \[ . Select \_ Component\] |
|--------------------------------------------------------------------------------------------------------------|
...
Questa istruzione esegue un singolo componente a 32 bit con segno massimo di operando *src0* con *DST1* a 32 bit per indirizzo componente *dstAddress*.
...
Il valore in *DST1* Memory prima che Max venga restituito a *dst0*.
