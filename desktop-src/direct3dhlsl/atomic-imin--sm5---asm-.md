...
description: Numero intero con segno atomico minimo in memoria.
...
ms.locfileid: "118287744"
---
# <a name="atomic_imin-sm5---asm"></a>atomic \_ imin (sm5 - asm)

Numero intero con segno atomico minimo in memoria.
...
Questa istruzione esegue un singolo componente con segno minimo a 32 bit dell'operando *src0* *in dst* a 32 bit per ogni indirizzo del componente *dstAddress*, eseguito in modo atomico.
