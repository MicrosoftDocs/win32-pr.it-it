...
description: Numero intero senza segno atomico minimo in memoria.
...
ms.locfileid: "118516783"
---
# <a name="atomic_umin-sm5---asm"></a>atomic \_ umin (sm5 - asm)

Numero intero senza segno atomico minimo in memoria.



| atomic \_ umin dst, dstAddress \[ .swizzle \] , src0 \[ .select \_ component\] |
|----------------------------------------------------------------------|
...
Questa istruzione esegue un singolo componente senza segno minimo a 32 bit dell'operando *src0* in *dst* a 32 bit per ogni indirizzo del componente *dstAddress,* eseguito in modo atomico.
