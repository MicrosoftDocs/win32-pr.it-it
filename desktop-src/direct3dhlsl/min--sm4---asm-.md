...
NaN ha una gestione speciale. Se un operando di origine è NaN, viene restituito l'altro operando di origine e viene effettuata la scelta per ogni componente. Se entrambi sono NaN, viene restituita qualsiasi rappresentazione NaN. Questo è conforme alle nuove regole IEEE 754R.
