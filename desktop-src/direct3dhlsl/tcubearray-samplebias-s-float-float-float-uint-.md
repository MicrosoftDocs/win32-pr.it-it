...
description: La funzione SampleBias::SampleBias(S,float,float,float,uint) per TextureCubeArray consente di eseguire il campionamento di una trama dopo l'applicazione del valore di distorsione al livello mipmap.
...
ms.locfileid: "119367371"
---
# <a name="samplebiassamplebiassfloatfloatfloatuint-function-for-texturecubearray"></a>Funzione SampleBias::SampleBias(S,float,float,float,uint) per TextureCubeArray
