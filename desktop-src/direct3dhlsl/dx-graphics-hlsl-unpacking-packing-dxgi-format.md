...
> L' \_ intestazione D3DX DXGIFormatConvert. inl viene fornita in Legacy DirectX SDK. Viene anche incluso nel pacchetto NuGet [Microsoft. DXSDK. D3DX](https://www.nuget.org/packages/Microsoft.DXSDK.D3DX) .
