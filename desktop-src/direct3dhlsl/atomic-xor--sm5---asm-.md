...
description: XOR bit per bit atomico in memoria.
...
ms.locfileid: "118794832"
---
# <a name="atomic_xor-sm5---asm"></a>atomic \_ xor (sm5 - asm)

XOR bit per bit atomico in memoria.
...
|----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="dst"></span><span id="DST"></span>*Dst*<br/>                                                   | \[in \] Componenti di XOR con *src0*. Questo valore deve essere una visualizzazione di accesso non ordinato (UAV) (u \# ). Nello shader di calcolo può anche essere la memoria condivisa del gruppo di thread (g \# ). <br/> |
| <span id="dstAddress"></span><span id="dstaddress"></span><span id="DSTADDRESS"></span>*dstAddress*<br/> | \[in \] Indirizzo di memoria.<br/>                                                                                                                                                 |
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | \[in \] I componenti di XOR con *dst*.<br/>                                                                                                                                   |
...
Questa istruzione esegue un singolo componente XOR bit per bit dell'operando *src0* in *dst* a 32 bit per indirizzo componente *dstAddress,* eseguito in modo atomico.
