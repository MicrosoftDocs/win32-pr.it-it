...
Avvia una Rep... blocco [endrep-PS](endrep---ps.md) .
...
dove i \# è un registro di tipo integer che specifica il numero di ripetizioni nel componente. x. Vedere [registro integer costanti](dx9-graphics-reference-asm-ps-registers-constant-integer.md).
...
-   I blocchi di ripetizione possono essere annidati. Vedere [limitazioni del controllo di flusso](dx9-graphics-reference-asm-ps-instructions-flow-control.md).
