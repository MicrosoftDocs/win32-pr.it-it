...
| [setp \_ comp](setp-comp---ps.md)                                 | Impostare il registro predicati                                                           | 1                 |       |            |         | x            |     |
| [sincos - ps](sincos---ps.md)                                   | Seno e coseno                                                                      | 8                 |       | x          |         |              |     |
| [sub - ps](sub---ps.md)                                         | Sottrazione                                                                             | 1                 |       | x          |         |              |     |
| [texkill - ps](texkill---ps.md)                                 | Uccidi rendering pixel                                                                    | 2                 |       |            | x       |              |     |
| [texld - ps \_ 2 \_ 0 e up](texld---ps-2-0.md)                    | Campionare una trama                                                                     | Vedere la nota 1        |       |            | x       |              |     |
| [texldb - ps](texldb---ps.md)                                   | Campionamento trame con distorsione del livello di dettaglio dal componente w                          | 6                 |       |            | x       |              |     |
| [texldl - ps](texldl---ps.md)                                   | Campionamento trame con livello di dettaglio dal componente w                               | Vedere la nota 2        |       |            | x       |              | x   |
| [texldd - ps](texldd---ps.md)                                   | Campionamento trame con sfumature fornite dall'utente                                        | 3                 |       |            | x       |              |     |
| [texldp - ps](texldp---ps.md)                                   | Campionamento delle trame con divisione proiettativa per w-component                               | Vedere la nota 3        |       |            | x       |              |     |
