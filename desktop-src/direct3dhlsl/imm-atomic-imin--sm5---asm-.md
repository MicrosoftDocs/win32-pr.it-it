...
description: Min con segno atomico immediato in memoria. Restituisce il valore in memoria prima dell'operazione max.
...
ms.locfileid: "118089422"
---
# <a name="imm_atomic_imin-sm5---asm"></a>imm \_ atomic \_ imin (sm5 - asm)

Min con segno atomico immediato in memoria. Restituisce il valore in memoria prima dell'operazione max.



| imm \_ atomic \_ imin dst0 \[ .single component mask , \_ \_ \] dst1, dstAddress \[ .swizzle \] , src0 \[ .select \_ component\] |
|--------------------------------------------------------------------------------------------------------------|
...
Questa istruzione esegue un singolo componente con segno minimo a 32 bit dell'operando *src0* con *dst1* a 32 bit per indirizzo componente *dstAddress*.
