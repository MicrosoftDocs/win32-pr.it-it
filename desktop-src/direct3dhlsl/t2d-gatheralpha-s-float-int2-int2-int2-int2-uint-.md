...
description: Restituisce i componenti alfa dei quattro valori texel che verrebbero usati in un'operazione di filtro bi-lineare, insieme allo stato del mapping delle sezioni. | Funzione Texture2D::GatherAlpha(S,float,int2,int2,int2,int2,uint)
