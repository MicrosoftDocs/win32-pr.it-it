...
description: Questa funzione esempe una trama usando un valore di confronto per rifiutare i campioni, con un valore facoltativo per la chiusura dei valori di livello di dettaglio (LOD) del campione. Per Texture2DArray.
