...
description: Questa funzione consente di campionare una trama usando un valore di confronto per rifiutare i campioni, con un valore facoltativo a cui impostare i valori del livello di dettaglio del campione. Per Texture2DArray.
...
ms.locfileid: "117723549"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture2darray"></a>Funzione SampleCmp::SampleCmp(S,float,float,int,float,uint) per Texture2DArray
...
[Metodi SampleCmp](texture2darray-samplecmp.md)
</dt> <dt>
