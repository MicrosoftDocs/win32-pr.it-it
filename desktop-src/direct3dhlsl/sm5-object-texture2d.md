...
Tipo Texture2D ([così come esiste in Shader Model 4](dx-graphics-hlsl-to-type.md)) più variabili di risorsa. Questo oggetto trama supporta i metodi seguenti oltre ai metodi in Shader Model 4.
...
| [**GatherCmpRed**](texture2d-gathercmpred.md)                          | Per quattro valori texel che verrebbero usati in un'operazione di filtro bi-lineare, restituisce un confronto tra il componente rosso e un valore di confronto.   |
| [**GatherCmpGreen**](texture2d-gathercmpgreen.md)                      | Per quattro valori texel che verrebbero usati in un'operazione di filtro bi-lineare, restituisce un confronto tra il componente verde e un valore di confronto. |
...
| [**GatherCmpAlpha**](texture2d-gathercmpalpha.md)                      | Per quattro valori texel che verrebbero usati in un'operazione di filtro bi-lineare, restituisce un confronto tra il componente alfa e un valore di confronto. |
| [**GetDimensions**](sm5-object-texture2d-getdimensions.md)             | Ottiene le dimensioni della risorsa.                                                                                                                       |
| [**Caricamento**](texture2d-load.md)                                          | Legge i dati delle trame.                                                                                                                                 |
...
| [**Esempio**](texture-sample-overload.md)                               | Campiota una trama.                                                                                                                                  |
| [**SampleBias**](texture2d-samplebias.md)                              | Campionamento di una trama, dopo l'applicazione del valore di distorsione al livello mipmap.                                                                               |
| [**SampleCmp**](texture2d-samplecmp.md)                                | Esempi di una trama, usando un valore di confronto per rifiutare gli esempi.                                                                                      |
| [**SampleCmpLevelZero**](texture2d-samplecmplevelzero.md)              | Esempi di una trama (solo livello mipmap 0), usando un valore di confronto per rifiutare i campioni.                                                                |
...
| [**SampleLevel**](texture2d-samplelevel.md)                            | Campionamento di una trama al livello mipmap specificato.                                                                                                    |
