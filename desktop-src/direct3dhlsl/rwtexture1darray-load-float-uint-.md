...
---
# <a name="rwtexture1darrayloadintuint-function"></a>Funzione RWTexture1DArray:: Load (int, uint)
...
Il tipo restituito corrisponde al tipo nella dichiarazione per l'oggetto [**RWTexture1DArray**](sm5-object-rwtexture1darray.md) .
...
[Metodi Load](rwtexture1darray-load.md)
</dt> </dl>
