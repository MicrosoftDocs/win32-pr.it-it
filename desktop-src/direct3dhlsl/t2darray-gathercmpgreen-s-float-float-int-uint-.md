...
description: Per quattro valori texel che verrebbero usati in un'operazione di filtro bi lineare, restituisce un confronto tra il componente verde e un valore di confronto insieme allo stato del mapping delle sezioni. | Funzione Texture2DArray::GatherCmpGreen(S,float,float,int,uint)
