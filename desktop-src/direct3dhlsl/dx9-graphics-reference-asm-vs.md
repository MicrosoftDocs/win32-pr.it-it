...
-   [Differenze tra vertex shader](dx9-graphics-reference-asm-vs-differences.md)
...
Per visualizzare le funzionalità più recenti introdotte nel modello shader 3, vedere:
