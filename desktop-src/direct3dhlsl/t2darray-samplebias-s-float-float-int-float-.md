...
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture2darray"></a>Funzione SampleBias:: SampleBias (S, float, float, int, float) per Texture2DArray
