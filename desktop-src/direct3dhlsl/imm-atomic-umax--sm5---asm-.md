...
Max senza segno atomico immediato in memoria. Restituisce un valore in memoria prima dell'operazione max.



| IMM \_ Atomic \_ UMAX dst0 \[ . Single \_ Component \_ mask \] , DST1, dstAddress \[ . Swizzle \] , src0 \[ . Select \_ Component\] |
|--------------------------------------------------------------------------------------------------------------|
...
Questa istruzione esegue un singolo componente senza segno a 32 bit dell'operando *src0* con *DST1* a 32 bit per indirizzo componente *dstAddress*.
