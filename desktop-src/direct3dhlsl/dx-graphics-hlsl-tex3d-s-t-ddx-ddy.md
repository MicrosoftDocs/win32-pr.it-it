---
title: 'tex3D (informazioni di riferimento su HLSL): selezionare il livello mip'
description: Campio una trama 3D usando una sfumatura per selezionare il livello mip. | tex3D (informazioni di riferimento su HLSL)
...
ms.locfileid: "119119895"
---
# <a name="tex3d-hlsl-reference---select-the-mip-level"></a>tex3D (informazioni di riferimento su HLSL): selezionare il livello mip

Campio una trama 3D usando una sfumatura per selezionare il livello mip.
