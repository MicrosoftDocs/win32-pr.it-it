...
---
# <a name="dcl_globalflags-sm4---asm"></a>\_globalFlags DCL (SM4-ASM)

Dichiara i flag globali dello shader.



| \_ *flag* globalFlags DCL |
|--------------------------|
...
\[in \] un flag shader globale. Attualmente è definito un flag.

-   Refactoring \_ consentito: consente al driver di riordinare le operazioni aritmetiche per l'ottimizzazione, come illustrato di seguito.
...
> [!Note]
>
> Il riordino delle operazioni aritmetiche può generare risultati diversi.
