...
description: Per quattro valori texel che verrebbero usati in un'operazione di filtro bi lineare, restituisce un confronto tra il componente blu e un valore di confronto insieme allo stato del mapping delle sezioni. | Funzione Texture2DArray::GatherCmpBlue(S,float,float,int2,int2,int2,int2,uint)
