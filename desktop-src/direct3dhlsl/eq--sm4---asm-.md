...
Confronto di uguaglianza a virgola mobile vettoriale a livello di componente.
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[nel \] componente da comapre a *src1*.<br/>         |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[nel \] componente da comapre a *src0*.<br/>         |
...
Le denormazioni vengono scaricate prima del confronto (i registri di origine originali non vengono modificati). + 0 è uguale a-0. Il confronto con NaN restituisce false.
