---
title: Oggetti Shader Model 5
description: Shader Model 5 implementa le funzioni intrinseche dal modello di Shader 4 e versioni precedenti (vedere DirectX SDK) e anche queste nuove funzioni.
...
ms.locfileid: "103719459"
---
# <a name="shader-model-5-objects"></a>Oggetti Shader Model 5

Shader Model 5 implementa le funzioni intrinseche dal modello di Shader 4 e versioni precedenti (vedere DirectX SDK) e le nuove funzioni:
