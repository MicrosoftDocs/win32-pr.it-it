...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture3d"></a>Funzione SampleGrad:: SampleGrad (S, float, float, float, int, float, uint) per Texture3D
