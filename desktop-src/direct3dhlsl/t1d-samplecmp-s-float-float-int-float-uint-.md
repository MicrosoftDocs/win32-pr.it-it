...
description: La funzione campione una trama, usando un valore di confronto per rifiutare i campioni, con un valore facoltativo a cui impostare i valori del livello di dettaglio del campione. Per Texture1D.
