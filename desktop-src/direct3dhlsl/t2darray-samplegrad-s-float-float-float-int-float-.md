...
description: Informazioni su come questa funzione campionare una trama usando una sfumatura per influenzare il modo in cui viene calcolata la posizione del campione, con un valore facoltativo a cui impostare i valori di livello di dettaglio (LOD) del campione. Per Texture2DArray.
...
[Metodi di SampleGrad](texture2darray-samplegrad.md)
</dt> <dt>
