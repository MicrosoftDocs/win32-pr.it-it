...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture1darray"></a>Funzione SampleGrad:: SampleGrad (S, float, float, float, int, float, uint) per Texture1DArray
