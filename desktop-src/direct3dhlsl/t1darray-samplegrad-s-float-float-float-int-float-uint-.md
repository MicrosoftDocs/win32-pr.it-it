...
description: Informazioni su come questa funzione campionare una trama usando una sfumatura per influenzare il modo in cui viene calcolata la posizione del campione.
...
[Metodi di SampleGrad](texture1darray-samplegrad.md)
</dt> </dl>
