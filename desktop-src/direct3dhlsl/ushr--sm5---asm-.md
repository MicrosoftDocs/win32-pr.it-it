...
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[in \] LSB 5 bits specificare il numero di bit da spostare (0-31).<br/> |



 

Questa istruzione esegue uno spostamento a livello di componente di ogni valore a 32 bit in *src0* a destra di un numero di bit unsigned integer fornito da LSB 5 bits (intervallo 0-31) in *src1*, inserendo 0. I risultati a 32 bit per componente sono posizionati in *dest*.
