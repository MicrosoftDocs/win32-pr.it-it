---
title: Funzione Texture2DArray::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2)
description: Per quattro valori texel che verrebbero usati in un'operazione di filtro bi-lineare, restituisce un confronto tra il componente rosso e un valore di confronto. | Funzione Texture2DArray::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2)
...
ms.locfileid: "119485871"
---
# <a name="texture2darraygathercmpredsfloatfloatint2int2int2int2-function"></a>Funzione Texture2DArray::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2)
