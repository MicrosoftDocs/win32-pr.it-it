...
Logaritmo in base 2 del parametro *x* . Se il parametro *x* è negativo, la funzione restituisce un valore indefinito. Se il parametro *x* è 0, questa funzione restituisce + inf.
