...
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatintuint-function-for-texture1darray"></a>Funzione SampleCmpLevelZero:: SampleCmpLevelZero (S, float, float, int, uint) per Texture1DArray
...
[Metodi SampleCmpLevelZero](texture1darray-samplecmplevelzero.md)
</dt> </dl>
