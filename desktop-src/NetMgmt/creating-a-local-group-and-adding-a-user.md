...
---
# <a name="creating-a-local-group-and-adding-a-user"></a>Creazione di un gruppo locale e aggiunta di un utente

Per creare un nuovo gruppo locale, chiamare la funzione [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) . Per aggiungere un utente a tale gruppo, chiamare la funzione [**NetlocalgroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) .

Il programma seguente consente di creare un utente e un gruppo locale e di aggiungere l'utente al gruppo locale.
