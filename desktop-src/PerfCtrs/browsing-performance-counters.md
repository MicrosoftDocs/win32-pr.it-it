...
---
# <a name="browsing-performance-counters"></a>Esplorazione dei contatori delle prestazioni

Nell'esempio seguente viene illustrato come chiamare [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) per visualizzare i contatori delle prestazioni. Nell'esempio viene inoltre illustrato come raccogliere e formattare i dati dei contatori non elaborati per la visualizzazione.
