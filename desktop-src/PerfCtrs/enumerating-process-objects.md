---
description: Nell'esempio seguente viene chiamata la funzione PdhEnumObjectItems per enumerare le istanze e i contatori degli oggetti processo nel computer locale.
ms.assetid: d7518ba6-a0f1-4985-aa2c-1ca15a0ceb02
title: Enumerazione di oggetti processo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106312168"
---
# <a name="enumerating-process-objects"></a><span data-ttu-id="0e943-103">Enumerazione di oggetti processo</span><span class="sxs-lookup"><span data-stu-id="0e943-103">Enumerating Process Objects</span></span>

<span data-ttu-id="0e943-104">Nell'esempio seguente viene chiamata la funzione [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) per enumerare le istanze e i contatori degli oggetti processo nel computer locale.</span><span class="sxs-lookup"><span data-stu-id="0e943-104">The following example calls the [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) function to enumerate the instances and counters of the process objects on the local computer.</span></span>
