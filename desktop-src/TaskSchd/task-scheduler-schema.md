...
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="29fe0-105">Schema Utilità di pianificazione</span><span class="sxs-lookup"><span data-stu-id="29fe0-105">Task Scheduler Schema</span></span>

<span data-ttu-id="29fe0-106">Lo schema Utilità di pianificazione definisce il codice XML valido usato per registrare le attività con il servizio Utilità di pianificazione.</span><span class="sxs-lookup"><span data-stu-id="29fe0-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="29fe0-107">Gli sviluppatori possono creare il proprio codice XML, convalidarlo rispetto a questo schema e registrare le attività usando il metodo [**ITaskFolder:: l'RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .</span><span class="sxs-lookup"><span data-stu-id="29fe0-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="29fe0-108">I tipi e gli elementi dello schema Utilità di pianificazione sono documentati singolarmente nelle sezioni seguenti.</span><span class="sxs-lookup"><span data-stu-id="29fe0-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="29fe0-109">Elementi dello schema Utilità di pianificazione</span><span class="sxs-lookup"><span data-stu-id="29fe0-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="29fe0-110">Tipi semplici dello schema Utilità di pianificazione</span><span class="sxs-lookup"><span data-stu-id="29fe0-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="29fe0-111">Tipi complessi dello schema Utilità di pianificazione</span><span class="sxs-lookup"><span data-stu-id="29fe0-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="29fe0-112">Gruppi di schemi Utilità di pianificazione</span><span class="sxs-lookup"><span data-stu-id="29fe0-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="29fe0-113">L'intero schema di Utilità di pianificazione viene definito dal seguente file XSD.</span><span class="sxs-lookup"><span data-stu-id="29fe0-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
