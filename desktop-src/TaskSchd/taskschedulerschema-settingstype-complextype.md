---
title: settingsType Tipo complesso
description: Definisce gli elementi figlio e le informazioni di sequenziazione per l'Impostazioni (taskType).
ms.assetid: dba6b82d-aaa4-4f77-aeb1-c5a8f81aec25
keywords:
- settingsType tipo complesso Utilità di pianificazione
topic_type:
- apiref
api_name:
- settingsType
...
---
# <a name="settingstype-complex-type"></a>settingsType Tipo complesso

Definisce gli elementi figlio e le informazioni di sequenziazione per [**l'Impostazioni (taskType).**](taskschedulerschema-settings-tasktype-element.md)
...
| [**DeleteExpiredTaskAfter**](taskschedulerschema-deleteexpiredtaskafter-settingstype-element.md)                   | duration                                                                                          | Specifica la quantità di tempo di attesa dell'Utilità di pianificazione prima di eliminare l'attività dopo la scadenza. Se non viene specificato alcun valore per questo elemento, il Utilità di pianificazione non eliminerà l'attività.<br/>                                                                                           |
| [**DisallowStartIfOnBatteries**](taskschedulerschema-disallowstartifonbatteries-settingstype-element.md)           | boolean                                                                                           | Specifica che l'attività non verrà avviata se il computer è in esecuzione con alimentazione a batteria.<br/>                                                                                                                                                                                                                 |
...
| [**RestartOnFailure**](taskschedulerschema-restartonfailure-settingstype-element.md)                               | [**restartType**](taskschedulerschema-restarttype-complextype.md)                                | Specifica che il Utilità di pianificazione tenterà di riavviare l'attività in caso di errore per qualsiasi motivo. <br/>                                                                                                                                                                                                          |
...
| [**WakeToRun**](taskschedulerschema-waketorun-settingstype-element.md)                                             | boolean                                                                                           | Specifica che il Utilità di pianificazione riattivazione del computer prima di eseguire l'attività.<br/>                                                                                                                                                                                                                            |
