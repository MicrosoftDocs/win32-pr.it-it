...
---
# <a name="cc-code-example-creating-an-idle-trigger"></a>Esempio di codice C/C++: creazione di un trigger inattivo

In questo esempio viene creato un trigger inattivo per un'attività esistente. Per informazioni sulle condizioni di inattività, vedere [condizioni](task-idle-conditions.md)di inattività.
