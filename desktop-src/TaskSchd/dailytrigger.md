...
keywords:
- trigger giornaliero Utilità di pianificazione , oggetto
- Oggetto DailyTrigger Utilità di pianificazione
...
**L'oggetto DailyTrigger** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

**L'oggetto DailyTrigger** ha queste proprietà.



| Proprietà                                                            | Tipo di accesso           | Descrizione                                                                                                                                                                                 |
|:--------------------------------------------------------------------|:----------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DaysInterval**](dailytrigger-daysinterval.md)<br/>        | Lettura/Scrittura<br/> | Ottiene o imposta l'intervallo tra i giorni nella pianificazione.<br/>                                                                                                                      |
...
| [**RandomDelay**](dailytrigger-randomdelay.md)<br/>          | Lettura/Scrittura<br/> | Ottiene o imposta un tempo di ritardo aggiunto in modo casuale all'ora di inizio del trigger.<br/>                                                                                               |
...
Un intervallo di 1 produce una pianificazione giornaliera. Un intervallo di 2 produce una pianificazione ogni due giorni e così via.

Quando si legge o si scrive codice XML personalizzato per un'attività, viene specificato un trigger giornaliero usando l'elemento [**ScheduleByDay**](taskschedulerschema-schedulebyday-calendartriggertype-element.md) dello schema Utilità di pianificazione dati.

## <a name="examples"></a>Esempio

Per altre informazioni e un esempio di codice per questo oggetto di scripting, vedere [Daily Trigger Example (Scripting) .](daily-trigger-example--scripting-.md)
