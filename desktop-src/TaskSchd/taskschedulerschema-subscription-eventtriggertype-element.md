...
Per lo sviluppo in C++, la sottoscrizione di eventi viene specificata dalla [**proprietà IEventTrigger::Subscription.**](/windows/desktop/api/taskschd/nf-taskschd-ieventtrigger-get_subscription)
