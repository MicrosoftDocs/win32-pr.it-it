...
title: Impostazione delle proprietà delle finestre tramite STARTUPINFO
ms.topic: article
ms.date: 05/31/2018
...
Per i processi della console, usare la struttura [**STARTUPINFO**](/windows/win32/api/processthreadsapi/ns-processthreadsapi-startupinfoa) per specificare le proprietà della finestra solo quando si crea una nuova console (usando [**CreateProcess**](/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa) con CREATE NEW CONSOLE o con la funzione \_ \_ [**AllocConsole).**](/windows/console/allocconsole) La **struttura STARTUPINFO** può essere usata per specificare le proprietà della finestra della console seguenti:

-   Dimensioni della nuova finestra della console, in celle di caratteri.
-   Posizione della nuova finestra della console, in coordinate dello schermo.
-   Dimensioni, in celle di caratteri, del buffer dello schermo della nuova console.
-   Attributi del testo e del colore di sfondo del buffer dello schermo della nuova console.
