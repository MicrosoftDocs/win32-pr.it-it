...
---
# <a name="using-the-thread-pool-functions"></a>Uso delle funzioni del pool di thread

Questo esempio crea un pool di thread personalizzato, crea un elemento di lavoro e un timer del pool di thread e li associa a un gruppo di pulitura. Il pool è costituito da un thread permanente. Viene illustrato l'utilizzo delle funzioni del pool di thread seguenti:
