---
description: Questo documento contiene un esempio che illustra come usare le funzioni di contesto XState per recuperare e impostare le funzionalità estese in un thread.
...
---
# <a name="working-with-xstate-context"></a><span data-ttu-id="3d8b5-103">Uso del contesto XState</span><span class="sxs-lookup"><span data-stu-id="3d8b5-103">Working with XState Context</span></span>

<span data-ttu-id="3d8b5-104">Questo documento contiene un esempio che illustra come usare le funzioni di contesto XState per recuperare e impostare le funzionalità estese in un thread.</span><span class="sxs-lookup"><span data-stu-id="3d8b5-104">This document contains an example that demonstrates how to use the XState context functions to retrieve and set extended features on a thread.</span></span> <span data-ttu-id="3d8b5-105">Negli esempi seguenti viene modificato lo stato di Intel Advanced Vector Extensions (AVX), definito da FeatureId 2 (feature Mask 4).</span><span class="sxs-lookup"><span data-stu-id="3d8b5-105">The following examples manipulate Intel Advanced Vector Extensions (AVX) state which is defined by FeatureId 2 (Feature Mask 4).</span></span> <span data-ttu-id="3d8b5-106">Intel AVX è definito in "Guida di riferimento alla programmazione di Intel Advanced Vector Extensions" disponibile in <https://go.microsoft.com/fwlink/p/?linkid=212716> .</span><span class="sxs-lookup"><span data-stu-id="3d8b5-106">Intel AVX is defined in the "Intel Advanced Vector Extensions Programming Reference" available from <https://go.microsoft.com/fwlink/p/?linkid=212716>.</span></span>

<span data-ttu-id="3d8b5-107">**Windows 7 con SP1:** L' [API AVX](avx-support-portal.md) viene implementata per la prima volta in Windows 7 con SP1.</span><span class="sxs-lookup"><span data-stu-id="3d8b5-107">**Windows 7 with SP1:** The [AVX API](avx-support-portal.md) is first implemented on Windows 7 with SP1.</span></span> <span data-ttu-id="3d8b5-108">Poiché non esiste un SDK per Windows 7 con SP1, significa che non sono disponibili intestazioni e file di libreria da usare.</span><span class="sxs-lookup"><span data-stu-id="3d8b5-108">Since there is no SDK for Windows 7 with SP1, that means there are no available headers and library files to work with.</span></span> <span data-ttu-id="3d8b5-109">In questa situazione, un chiamante deve dichiarare le funzioni necessarie da questa documentazione e ottenere i puntatori utilizzando [**GetModuleHandle**](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea) su "Kernel32.dll", seguito da chiamate a [**GetProcAddress**](/windows/win32/api/libloaderapi/nf-libloaderapi-getprocaddress).</span><span class="sxs-lookup"><span data-stu-id="3d8b5-109">In this situation, a caller must declare the needed functions from this documentation and get pointers to them using [**GetModuleHandle**](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea) on "Kernel32.dll", followed by calls to [**GetProcAddress**](/windows/win32/api/libloaderapi/nf-libloaderapi-getprocaddress).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="3d8b5-110">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="3d8b5-110">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="3d8b5-111">**CopyContext**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-111">**CopyContext**</span></span>](/windows/desktop/api/WinBase/nf-winbase-copycontext)
</dt> <dt>

[<span data-ttu-id="3d8b5-112">**InitializeContext**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-112">**InitializeContext**</span></span>](/windows/desktop/api/WinBase/nf-winbase-initializecontext)
</dt> <dt>

[<span data-ttu-id="3d8b5-113">**GetEnabledXStateFeatures**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-113">**GetEnabledXStateFeatures**</span></span>](/windows/desktop/api/WinBase/nf-winbase-getenabledxstatefeatures)
</dt> <dt>

[<span data-ttu-id="3d8b5-114">**LocateXStateFeature**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-114">**LocateXStateFeature**</span></span>](/windows/desktop/api/WinBase/nf-winbase-locatexstatefeature)
</dt> <dt>

[<span data-ttu-id="3d8b5-115">**GetXStateFeaturesMask**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-115">**GetXStateFeaturesMask**</span></span>](/windows/desktop/api/WinBase/nf-winbase-getxstatefeaturesmask)
</dt> <dt>

[<span data-ttu-id="3d8b5-116">**SetXStateFeaturesMask**</span><span class="sxs-lookup"><span data-stu-id="3d8b5-116">**SetXStateFeaturesMask**</span></span>](/windows/desktop/api/WinBase/nf-winbase-setxstatefeaturesmask)
</dt> </dl>
