...
<td><dl> <dt><span id="_string__attribute_must_be_specified__byte____char___or__wchar_t__array_or_pointer"></span><span id="_STRING__ATTRIBUTE_MUST_BE_SPECIFIED__BYTE____CHAR___OR__WCHAR_T__ARRAY_OR_POINTER"></span>L'attributo [string] deve essere byte, char o &quot; &quot; &quot; wchar_t o &quot; &quot; &quot; puntatore</dt> <dd> Un attributo stringa non può essere applicato a un puntatore o a una matrice il cui tipo di base non è un <a href="byte.md"><strong>byte,</strong></a> <a href="char-idl.md"><strong>char</strong></a>o <a href="struct.md"><strong>struct</strong></a> in cui i membri sono tutti di tipo <strong>byte</strong> <strong>o char.</strong><br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2083"></span><span id="midl2083"></span><dl> <dt><strong>MIDL2083</strong></dt> </dl></td>
<td><dl> <dt><span id="mismatch_between_the_type_of_the__switch_is__expression_and_the_switch_type_of_the_union"></span><span id="MISMATCH_BETWEEN_THE_TYPE_OF_THE__SWITCH_IS__EXPRESSION_AND_THE_SWITCH_TYPE_OF_THE_UNION"></span>mancata corrispondenza tra il tipo dell'espressione [switch_is] e il tipo switch dell'unione</dt> <dd> Se<a href="switch-type.md"><strong>l'unione</strong></a>[ switch_type ] non è specificata, il tipo dell'opzione è dello stesso tipo del campo [<a href="switch-is.md"><strong>switch_is</strong></a>].<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="parameter_with__comm_status__or__fault_status__attribute_must_be_a_pointer_to_type_error_status_t"></span><span id="PARAMETER_WITH__COMM_STATUS__OR__FAULT_STATUS__ATTRIBUTE_MUST_BE_A_POINTER_TO_TYPE_ERROR_STATUS_T"></span>il parametro con l'attributo [comm_status] o [fault_status] deve essere un puntatore al tipo error_status_t</dt> <dd> Quando [<a href="fault-status.md"><strong>fault_status</strong></a>] o [<a href="comm-status.md"><strong>comm_status</strong></a>] viene usato come attributo di parametro, il parametro deve essere un parametro [<a href="out-idl.md"><strong>out</strong></a>] di <a href="error-status-t.md"><strong>tipo error_status_t</strong></a>. Se si verifica un errore del server, il parametro viene impostato sul codice di errore. Al termine della chiamata remota, la procedura imposta il valore .<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="pointer_to_a_conformant_array_or_an_array_that_contains_a_conformant_array_is_not_supported"></span><span id="POINTER_TO_A_CONFORMANT_ARRAY_OR_AN_ARRAY_THAT_CONTAINS_A_CONFORMANT_ARRAY_IS_NOT_SUPPORTED"></span>Il puntatore a una matrice conforme o a una matrice che contiene una matrice conforme non è supportato</dt> <dd> Utilizzo della matrice conforme non valido. Per le regole che regolano le matrici conformi, vedere <a href="/windows/desktop/Rpc/arrays-and-rpc">Matrici e RPC.</a><br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="bit_field_specification_on_a_type_other_that__int__is_a_non-ANSI-compatible_extension"></span><span id="bit_field_specification_on_a_type_other_that__int__is_a_non-ansi-compatible_extension"></span><span id="BIT_FIELD_SPECIFICATION_ON_A_TYPE_OTHER_THAT__INT__IS_A_NON-ANSI-COMPATIBLE_EXTENSION"></span>specifica del campo di bit in un tipo diverso da &quot; int è un'estensione non compatibile con &quot; ANSI</dt> <dd> La specifica del linguaggio di programmazione ANSI C non consente l'applicazione di campi di bit a tipi non di tipo non integer.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2134"></span><span id="midl2134"></span><dl> <dt><strong>MIDL2134</strong></dt> </dl></td>
<td><dl> <dt><span id="bit_field_specification_can_be_applied_only_to_simple__integral_types"></span><span id="BIT_FIELD_SPECIFICATION_CAN_BE_APPLIED_ONLY_TO_SIMPLE__INTEGRAL_TYPES"></span>La specifica del campo di bit può essere applicata solo a tipi semplici e integrali</dt> <dd> La specifica del linguaggio di programmazione ANSI C non consente l'applicazione di campi di bit a tipi non di tipo non integer.<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="_allocate__attribute_must_be_applied_only_on_non-void_pointer_types"></span><span id="_ALLOCATE__ATTRIBUTE_MUST_BE_APPLIED_ONLY_ON_NON-VOID_POINTER_TYPES"></span>L'attributo [allocate] deve essere applicato solo ai tipi di puntatore non void</dt> <dd> <a href="allocate.md"><strong>L'attributo</strong></a>[ allocate ] è progettato per strutture di dati complesse basate su puntatore. Quando viene specificato l'attributo [allocate], il file stub attraversa la struttura dei dati per calcolare le dimensioni totali di tutti gli oggetti accessibili dal puntatore e da tutti gli altri puntatori nella struttura di dati. Modificare il tipo in un tipo di puntatore nonvoid o rimuovere l'attributo [<strong>allocate</strong>] e usare un altro metodo per determinarne le dimensioni di allocazione, ad esempio l'operatore <strong>sizeof.</strong><br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2159"></span><span id="midl2159"></span><dl> <dt><strong>MIDL2159</strong></dt> </dl></td>
<td><dl> <dt><span id="array_or_equivalent_pointer_construct_cannot_derive_from_a_nonencapsulated_union"></span><span id="ARRAY_OR_EQUIVALENT_POINTER_CONSTRUCT_CANNOT_DERIVE_FROM_A_NONENCAPSULATED_UNION"></span>Il costrutto di matrice o puntatore equivalente non può derivare da un'unione non incapsulata</dt> <dd> Ogni unione deve essere associata a un discriminante. Le matrici di unioni non sono consentite perché non forniscono la discriminante associata. Le matrici di strutture in cui la struttura contiene l'unione e il relativo discriminante sono consentite perché gli stub possono usare il discriminante per determinare le dimensioni di ogni unione.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2160"></span><span id="midl2160"></span><dl> <dt><strong>MIDL2160</strong></dt> </dl></td>
<td><dl> <dt><span id="field_must_not_derive_from_an_error_status_t_type"></span><span id="FIELD_MUST_NOT_DERIVE_FROM_AN_ERROR_STATUS_T_TYPE"></span>il campo non deve derivare da un error_status_t specificato</dt> <dd> Il <a href="error-status-t.md"><strong>error_status_t</strong></a> può essere usato solo come parametro o come tipo restituito. Non può essere incorporato nel campo di una struttura o di un'unione.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2161"></span><span id="midl2161"></span><dl> <dt><strong>MIDL2161</strong></dt> </dl></td>
<td><dl> <dt><span id="union_has_at_least_one_arm_without_a_case_label"></span><span id="UNION_HAS_AT_LEAST_ONE_ARM_WITHOUT_A_CASE_LABEL"></span>union ha almeno un arm senza un'etichetta case</dt> <dd> La dichiarazione di unione non corrisponde alla sintassi MIDL richiesta per l'unione. Ogni arm di unione richiede un'etichetta case o un'etichetta predefinita che seleziona tale arm di unione.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2162"></span><span id="midl2162"></span><dl> <dt><strong>MIDL2162</strong></dt> </dl></td>
<td><dl> <dt><span id="parameter_or_return_value_must_not_derive_from_a_type_that_has__ignore__applied_to_it"></span><span id="PARAMETER_OR_RETURN_VALUE_MUST_NOT_DERIVE_FROM_A_TYPE_THAT_HAS__IGNORE__APPLIED_TO_IT"></span>il parametro o il valore restituito non deve derivare da un tipo a cui è applicato [ignore]</dt> <dd> <a href="ignore.md"><strong>L'attributo</strong></a>[ ignore ] è un attributo di campo che può essere applicato solo a campi, ad esempio campi di strutture e matrici. L'attributo [<strong>ignore</strong>] indica che lo stub non deve dereferenziare il puntatore durante la trasmissione e non è consentito quando è in conflitto con altri attributi che devono essere dereferenziati, ad esempio i parametri [<a href="out-idl.md"><strong>out</strong></a>] e i valori restituiti dalla funzione.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2163"></span><span id="midl2163"></span><dl> <dt><strong>MIDL2163</strong></dt> </dl></td>
<td><dl> <dt><span id="pointer_already_has_a_pointer_attribute_applied_to_it"></span><span id="POINTER_ALREADY_HAS_A_POINTER_ATTRIBUTE_APPLIED_TO_IT"></span>Puntatore a cui è già applicato un attributo puntatore</dt> <dd> Solo uno degli attributi del puntatore, [<a href="ref.md"><strong>ref</strong></a>], [<a href="unique.md"><strong>unique</strong></a>], o [<a href="ptr.md"><strong>ptr</strong></a>], può essere applicato a un singolo puntatore.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2164"></span><span id="midl2164"></span><dl> <dt><strong>MIDL2164</strong></dt> </dl></td>
<td><dl> <dt><span id="field_parameter_must_not_derive_from_a_structure_that_is_recursive_through_a_ref_pointer"></span><span id="FIELD_PARAMETER_MUST_NOT_DERIVE_FROM_A_STRUCTURE_THAT_IS_RECURSIVE_THROUGH_A_REF_POINTER"></span>field/parameter non deve derivare da una struttura ricorsiva tramite un puntatore ref</dt> <dd> Per definizione, un puntatore di riferimento non può essere impostato su <strong>NULL.</strong> Una struttura di dati ricorsiva definita con un puntatore di riferimento non ha elementi <strong>NULL</strong> e per convenzione non è di tipo nonminante. Usare un attributo<a href="unique.md"><strong>puntatore</strong></a>[ unique ] per consentire alla struttura dei dati di specificare un elemento <strong>NULL</strong> o ridefinire la struttura dei dati come struttura di dati non ricorsiva.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2165"></span><span id="midl2165"></span><dl> <dt><strong>MIDL2165</strong></dt> </dl></td>
<td><dl> <dt><span id="use_of_field_deriving_from_a_void_pointer_needs__c_ext"></span><span id="USE_OF_FIELD_DERIVING_FROM_A_VOID_POINTER_NEEDS__C_EXT"></span>L'uso di campi che derivano da un puntatore void richiede /c_ext</dt> <dd> Il tipo <strong>void *</strong> e altri tipi e qualificatori di tipo non supportati da DCE IDL sono consentiti nel file IDL solo quando si usano le impostazioni predefinite del compilatore MIDL. <a href="-osf.md"><strong>L'uso dell'opzione /osf</strong></a> sostituisce questa impostazione predefinita. Se è necessario eseguire la compilazione in modalità osf-compatibility, sarà necessario ridefinire il tipo di puntatore.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2166"></span><span id="midl2166"></span><dl> <dt><strong>MIDL2166</strong></dt> </dl></td>
<td><dl> <dt><span id="use_of_this_attribute_needs__ms_ext"></span><span id="USE_OF_THIS_ATTRIBUTE_NEEDS__MS_EXT"></span>L'uso di questo attributo richiede /ms_ext</dt> <dd> Questa funzionalità del linguaggio è un'estensione Microsoft di DCE IDL. Non è possibile usare questa funzionalità se si esegue la compilazione in modalità di compatibilità osf ( <a href="-osf.md"><strong>/osf</strong></a> ).<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="use_of_wchar_t_needs__ms_ext_or__c_ext"></span><span id="USE_OF_WCHAR_T_NEEDS__MS_EXT_OR__C_EXT"></span>l'wchar_t richiede /ms_ext o /c_ext</dt> <dd> Il tipo di carattere wide rappresenta un'estensione di DCE IDL. Il compilatore MIDL non accetta il tipo di carattere wide quando si specifica <a href="-osf.md"><strong>l'opzione /osf.</strong></a><br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="initializing_expression_must_resolve_to_a_constant_expression"></span><span id="INITIALIZING_EXPRESSION_MUST_RESOLVE_TO_A_CONSTANT_EXPRESSION"></span>l'inizializzazione dell'espressione deve essere risolta in un'espressione costante</dt> <dd> Se un'espressione viene usata come inizializzatore, l'espressione deve essere un'espressione costante. Questo vale in tutte le modalità del compilatore MIDL. L'espressione deve essere risolvibile in fase di compilazione. Specificare una costante letterale o un'espressione che viene risolta in una costante anziché in una variabile.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2174"></span><span id="midl2174"></span><dl> <dt><strong>MIDL2174</strong></dt> </dl></td>
<td><dl> <dt><span id="attribute_expression_must_be_of_type_integer__char__Boolean_or_enum"></span><span id="attribute_expression_must_be_of_type_integer__char__boolean_or_enum"></span><span id="ATTRIBUTE_EXPRESSION_MUST_BE_OF_TYPE_INTEGER__CHAR__BOOLEAN_OR_ENUM"></span>L'espressione attribute deve essere di tipo integer, char, booleano o enum</dt> <dd> Il tipo specificato non viene risolto in un tipo di opzione valido. Usare un tipo integer, character, <a href="byte.md"><strong>byte</strong></a>, <a href="boolean.md"><strong>Boolean</strong></a>o <a href="enum.md"><strong>enum</strong></a> oppure un tipo derivato da uno di questi tipi.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2175"></span><span id="midl2175"></span><dl> <dt><strong>MIDL2175</strong></dt> </dl></td>
<td><dl> <dt><span id="illegal_constant"></span><span id="ILLEGAL_CONSTANT"></span>costante non valida</dt> <dd> La costante specificata non è in un intervallo valido per il tipo specificato.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="return_type_must_not_derive_from_a__ref__pointer"></span><span id="RETURN_TYPE_MUST_NOT_DERIVE_FROM_A__REF__POINTER"></span>il tipo restituito non deve derivare da un puntatore [ref]</dt> <dd> I valori restituiti della funzione definiti come tipi puntatore devono essere specificati come [<a href="unique.md"><strong>unique</strong></a>] o <a href="ptr.md"><strong>come puntatori</strong></a> completi. Non è possibile usare puntatori di riferimento.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2178"></span><span id="midl2178"></span><dl> <dt><strong>MIDL2178</strong></dt> </dl></td>
<td><dl> <dt><span id="attribute_expression_must_be_a_variable_name_or_a_pointer_dereference_expression_in_this_mode._You_must_specify_the__ms_ext_switch"></span><span id="attribute_expression_must_be_a_variable_name_or_a_pointer_dereference_expression_in_this_mode._you_must_specify_the__ms_ext_switch"></span><span id="ATTRIBUTE_EXPRESSION_MUST_BE_A_VARIABLE_NAME_OR_A_POINTER_DEREFERENCE_EXPRESSION_IN_THIS_MODE._YOU_MUST_SPECIFY_THE__MS_EXT_SWITCH"></span>L'espressione attribute deve essere un nome di variabile o un'espressione di dereferenziazione del puntatore in questa modalità. È necessario specificare l'opzione /ms_ext</dt> <dd> Il compilatore IDL DCE richiede che le dimensioni associate all'attributo [<a href="size-is.md"><strong>size_is</strong></a>] siano specificate da una variabile o da una variabile puntatore. Se si vuole sfruttare l'estensione Microsoft che consente all'attributo [<strong>size_is</strong>] di essere definito da un'espressione costante, non è possibile usare l'opzione del compilatore <a href="-osf.md"><strong>/osf.</strong></a><br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2179"></span><span id="midl2179"></span><dl> <dt><strong>MIDL2179</strong></dt> </dl></td>
<td><dl> <dt><span id="parameter_must_not_derive_from_a_recursive_nonencapsulated_union"></span><span id="PARAMETER_MUST_NOT_DERIVE_FROM_A_RECURSIVE_NONENCAPSULATED_UNION"></span>il parametro non deve derivare da un'unione ricorsiva non incapsulata</dt> <dd> Un'unione deve includere un discriminante, quindi un'unione non può avere un'altra unione come elemento. Un'unione può essere incorporata in un'altra unione solo quando fa parte di una struttura che include la discriminante.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2180"></span><span id="midl2180"></span><dl> <dt><strong>MIDL2180</strong></dt> </dl></td>
<td><dl> <dt><span id="binding-handle_parameter_cannot_be__out__only"></span><span id="BINDING-HANDLE_PARAMETER_CANNOT_BE__OUT__ONLY"></span>il parametro binding-handle non può essere solo [out]</dt> <dd> Il parametro handle identificato dal compilatore MIDL come handle di associazione per questa operazione deve essere un parametro [<a href="in.md"><strong>in</strong></a>]. [<a href="out-idl.md"><strong>out</strong></a>]-only parameters are undefined on the client stub and the binding handle must be defined on the client.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2181"></span><span id="midl2181"></span><dl> <dt><strong>MIDL2181</strong></dt> </dl></td>
<td><dl> <dt><span id="pointer_to_a_handle_cannot_be__unique__or__ptr_"></span><span id="POINTER_TO_A_HANDLE_CANNOT_BE__UNIQUE__OR__PTR_"></span>Il puntatore a un handle non può essere [unique] o [ptr]</dt> <dd> Non è possibile usare gli attributi univoci e completi del puntatore per un puntatore a un handle. Questi attributi consentono il valore <strong>NULL</strong>e l'handle di associazione non può essere <strong>NULL.</strong> Usare<a href="ref.md"><strong>l'attributo</strong></a>[ ref ] per derivare il parametro binding-handle dai puntatori di riferimento.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="unexpected_end_of_file_found"></span><span id="UNEXPECTED_END_OF_FILE_FOUND"></span>Rilevata fine del file imprevista</dt> <dd> Il compilatore MIDL ha trovato la fine del file prima che fosse in grado di risolvere correttamente tutti gli elementi sintattici del file. Verificare che il carattere di terminazione della parentesi graffa destra (}) sia presente alla fine del file o controllare la sintassi.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="stringable_structures_are_not_implemented_in_this_version"></span><span id="STRINGABLE_STRUCTURES_ARE_NOT_IMPLEMENTED_IN_THIS_VERSION"></span>Le strutture stringable non sono implementate in questa versione</dt> <dd> DCE IDL consente all'attributo [<a href="string.md"><strong>string</strong></a>] di applicarsi a una struttura i cui elementi sono costituiti solo da caratteri, byte o tipi che si risolvono in caratteri o byte. Questa funzionalità non è supportata in Microsoft RPC. <strong>L'attributo</strong>[ string ] non può essere applicato all'intera struttura. Tuttavia, può essere applicato a ogni singola matrice.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2192"></span><span id="midl2192"></span><dl> <dt><strong>MIDL2192</strong></dt> </dl></td>
<td><dl> <dt><span id="switch_type_can_only_be_integral__char__Boolean_or_enum"></span><span id="switch_type_can_only_be_integral__char__boolean_or_enum"></span><span id="SWITCH_TYPE_CAN_ONLY_BE_INTEGRAL__CHAR__BOOLEAN_OR_ENUM"></span>il tipo switch può essere solo integrale, char, booleano o enum</dt> <dd> Il tipo specificato non viene risolto in un tipo di commutatore valido. Usare un tipo integer, character, <a href="byte.md"><strong>byte</strong></a>, <a href="boolean.md"><strong>Boolean</strong></a>, <a href="enum.md"><strong>enum</strong></a> o un tipo derivato da uno di questi tipi.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2193"></span><span id="midl2193"></span><dl> <dt><strong>MIDL2193</strong></dt> </dl></td>
<td><dl> <dt><span id="_handle__must_not_be_specified_on_a_type_deriving_from_handle_t"></span><span id="_HANDLE__MUST_NOT_BE_SPECIFIED_ON_A_TYPE_DERIVING_FROM_HANDLE_T"></span>[handle] non deve essere specificato in un tipo derivante da handle_t</dt> <dd> Un tipo di handle deve essere definito usando uno e solo uno dei tipi di handle o degli attributi. Usare il tipo primitivo <a href="handle-t.md"><strong>handle_t</strong></a> o l'attributo [<a href="handle.md"><strong>handle</strong></a>], ma non entrambi. Il tipo di handle definito dall'utente deve essere trasmissibile, <strong>ma handle_t</strong> non viene trasmesso in rete.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="attribute_expression_derives_from__unique__or__ptr__pointer_dereference"></span><span id="ATTRIBUTE_EXPRESSION_DERIVES_FROM__UNIQUE__OR__PTR__POINTER_DEREFERENCE"></span>L'espressione attribute deriva da [unique] o [ptr] pointer dereference</dt> <dd> Anche se gli attributi [<a href="unique.md"><strong>unique</strong></a>] e <a href="ptr.md"><strong>full</strong></a> pointer consentono ai puntatori di avere valori <strong>NULL,</strong> l'espressione che definisce l'attributo size o length non deve mai avere un <strong>valore NULL.</strong> Quando vengono usati puntatori, MIDL vincola le espressioni ai puntatori [<a href="ref.md"><strong>ref</strong></a>].<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="quoted_uuid_requires__ms_ext"></span><span id="QUOTED_UUID_REQUIRES__MS_EXT"></span>L'uuid tra virgolette richiede /ms_ext</dt> <dd> La possibilità di specificare un valore UUID tra virgolette è un'estensione Microsoft per DCE IDL. Non usare l'opzione del compilatore MIDL <a href="-osf.md"><strong>/osf</strong></a>, che esegue l'override <a href="-ms-ext.md"><strong>di /ms_ext</strong></a>.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="this_name_already_used_as_a_const_identifier_name"></span><span id="THIS_NAME_ALREADY_USED_AS_A_CONST_IDENTIFIER_NAME"></span>questo nome è già usato come nome di identificatore const</dt> <dd> L'identificatore è stato usato in precedenza per identificare una costante in una <a href="const.md"><strong>dichiarazione const.</strong></a> Modificare il nome di uno degli identificatori in modo che siano univoci.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2205"></span><span id="midl2205"></span><dl> <dt><strong>MIDL2205</strong></dt> </dl></td>
<td><dl> <dt><span id="inconsistent_redefinition_of_type_error_status_t"></span><span id="INCONSISTENT_REDEFINITION_OF_TYPE_ERROR_STATUS_T"></span>ridefinizione incoerente del tipo error_status_t</dt> <dd> Il tipo <a href="error-status-t.md"><strong>error_status_t</strong></a> deve essere risolto nel tipo <strong>unsigned long</strong>. Non è possibile usare altre definizioni di tipo.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2206"></span><span id="midl2206"></span><dl> <dt><strong>MIDL2206</strong></dt> </dl></td>
<td><dl> <dt><span id="_case__value_out_of_range_of_switch_type"></span><span id="_CASE__VALUE_OUT_OF_RANGE_OF_SWITCH_TYPE"></span>[case] valore non compreso nell'intervallo del tipo switch</dt> <dd> Il valore associato al case dell'istruzione switch non è compreso nell'intervallo per il tipo di opzione specificato. Ad esempio, questo errore si verifica quando nell'istruzione case long integer un valore di tipo short integer.<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2207"></span><span id="midl2207"></span><dl> <dt><strong>MIDL2207</strong></dt> </dl></td>
<td><dl> <dt><span id="parameter_deriving_from_wchar_t_needs__ms_ext"></span><span id="PARAMETER_DERIVING_FROM_WCHAR_T_NEEDS__MS_EXT"></span>il parametro derivante da wchar_t richiede /ms_ext</dt> <dd> Il tipo di carattere <a href="wchar-t.md"><strong>wide wchar_t</strong></a> è un'estensione Microsoft per DCE IDL. Non usare l'opzione del compilatore MIDL <a href="-osf.md"><strong>/osf</strong></a>, che esegue l'override <a href="-ms-ext.md"><strong>di /ms_ext</strong></a><br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="context_handle_type_used_for_an_implicit_handle"></span><span id="CONTEXT_HANDLE_TYPE_USED_FOR_AN_IMPLICIT_HANDLE"></span>Tipo di handle di contesto usato per un handle implicito</dt> <dd> Un tipo definito usando<a href="context-handle.md"><strong>l'attributo</strong></a>[ context_handle ] è stato specificato come tipo di handle in un attributo [ <a href="implicit-handle.md"><strong>implicit_handle</strong></a>]. Gli attributi non possono essere combinati in questo modo.<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="semantic_check_incomplete_due_to_previous_errors"></span><span id="SEMANTIC_CHECK_INCOMPLETE_DUE_TO_PREVIOUS_ERRORS"></span>Controllo semantico incompleto a causa di errori precedenti</dt> <dd> Il compilatore MIDL esegue due passaggi sui file di input per risolvere eventuali dichiarazioni con inoltro. A causa di errori rilevati durante il primo passaggio, il controllo del secondo passaggio non è stato eseguito. Gli errori non rilevati relativi alle dichiarazioni di inoltro potrebbero essere ancora presenti nel file.<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="_allocate__illegal_on_a_type_deriving_from_a_primitive_generic_context_handle"></span><span id="_ALLOCATE__ILLEGAL_ON_A_TYPE_DERIVING_FROM_A_PRIMITIVE_GENERIC_CONTEXT_HANDLE"></span>[allocate] non valido in un tipo derivante da un handle primitivo/generico/contesto</dt> <dd> Per impostazione predefinita, l'attributo ACF [<a href="allocate.md"><strong>allocate</strong></a>] non può essere applicato ai tipi di handle.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
<td><span id="MIDL2228"></span><span id="midl2228"></span><dl> <dt><strong>MIDL2228</strong></dt> </dl></td>
<td><dl> <dt><span id="transmitted_or_presented_type_must_not_derive_from_error_status_t"></span><span id="TRANSMITTED_OR_PRESENTED_TYPE_MUST_NOT_DERIVE_FROM_ERROR_STATUS_T"></span>Il tipo trasmesso o presentato non deve derivare da error_status_t</dt> <dd> In questa versione di Microsoft RPC il <a href="error-status-t.md"><strong>tipo</strong></a> error_status_t non può essere usato con l'attributo [<a href="transmit-as.md"><strong>transmit_as</strong></a>].<br/> </dd> </dl></td>
</tr>
<tr class="even">
<td><span id="MIDL2229"></span><span id="midl2229"></span><dl> <dt><strong>MIDL2229</strong></dt> </dl></td>
<td><dl> <dt><span id="discriminant_of_a_union_must_not_derive_from_a_field_with__ignore__applied_to_it"></span><span id="DISCRIMINANT_OF_A_UNION_MUST_NOT_DERIVE_FROM_A_FIELD_WITH__IGNORE__APPLIED_TO_IT"></span>La discriminante di un'unione non deve derivare da un campo a cui è applicato [ignore]</dt> <dd> Un'unione usata in una chiamata di procedura remota deve essere associata a un altro elemento di dati, denominato discriminante, che seleziona il braccio dell'unione. Il discriminante deve essere trasmesso. <a href="ignore.md"><strong>L'attributo</strong></a>[ ignore ] non può essere applicato all'unione discriminante.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="value_out_of_range"></span><span id="VALUE_OUT_OF_RANGE"></span>valore non compreso nell'intervallo</dt> <dd> Il valore case specificato non è compreso nell'intervallo del tipo di opzione.<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="calling_conventions_other_than___stdcall_or___cdecl_not_supported_for__Oi_modes__using__Os"></span><span id="calling_conventions_other_than___stdcall_or___cdecl_not_supported_for__oi_modes__using__os"></span><span id="CALLING_CONVENTIONS_OTHER_THAN___STDCALL_OR___CDECL_NOT_SUPPORTED_FOR__OI_MODES__USING__OS"></span>Le convenzioni di chiamata diverse __stdcall o __cdecl non sono supportate per le modalità /Oi, con /Os</dt> <dd> Le convenzioni di chiamata <strong>__pascal</strong> o <strong>__fastcall</strong> modificano il formato dello stack. Le <a href="-oi.md"><strong>modalità /Oi</strong></a> supportano solo <strong>le</strong> __stdcall e <strong>__cdecl</strong> di chiamata. Se è necessario utilizzare altre convenzioni di chiamata, utilizzare <a href="-os.md"><strong>la modalità /Os.</strong></a><br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="possible_invalid_member"></span><span id="POSSIBLE_INVALID_MEMBER"></span>possibile membro non valido</dt> <dd> Per essere un membro valido di una libreria, l'elemento library deve essere un modulo, un'interfaccia dispatch, una coclasse, un'istruzione if, una struttura, un'unione, un'enumerazione o una dichiarazione con inoltro.<br/> </dd> </dl></td>
</tr>
<tr class="even">
...
<td><dl> <dt><span id="async_procedures_cannot_use_auto_handle"></span><span id="ASYNC_PROCEDURES_CANNOT_USE_AUTO_HANDLE"></span>Le procedure asincrone non possono usare l'handle automatico</dt> <dd> Le routine con l'attributo [<a href="async.md"><strong>async</strong></a>] richiedono handle espliciti.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="this_construct_is_only_allowed_within_a_library_block"></span><span id="THIS_CONSTRUCT_IS_ONLY_ALLOWED_WITHIN_A_LIBRARY_BLOCK"></span>Questo costrutto è consentito solo all'interno di un blocco di libreria</dt> <dd> Un modulo può essere eseguito solo all'interno di un blocco di libreria.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="procedures_with_a__vararg__attribute_must_have_a_SAFEARRAY_VARIANT__parameter__param_order_is__vararg____lcid____retval_"></span><span id="procedures_with_a__vararg__attribute_must_have_a_safearray_variant__parameter__param_order_is__vararg____lcid____retval_"></span><span id="PROCEDURES_WITH_A__VARARG__ATTRIBUTE_MUST_HAVE_A_SAFEARRAY_VARIANT__PARAMETER__PARAM_ORDER_IS__VARARG____LCID____RETVAL_"></span>Le routine con un attributo [vararg] devono avere un parametro SAFEARRAY(VARIANT). l'ordine dei parametri è [vararg], [lcid], [retval]</dt> <dd> La maggior parte dei parametri per le routine con l'attributo [<a href="vararg.md"><strong>vararg</strong></a>] deve essere eseguita prima del <strong>parametro SAFEARRAY(VARIANT).</strong> Il <strong>parametro SAFEARRAY(VARIANT)</strong> deve essere presente. Se l'elenco di parametri contiene un parametro con l'attributo [ <a href="lcid.md"><strong>lcid</strong></a>], deve seguire il <strong>parametro SAFEARRAY(VARIANT).</strong> Se l'elenco di parametri contiene un parametro con l'attributo [<a href="retval.md"><strong>retval</strong></a>], deve verificarsi dopo il parametro con l'attributo [<strong>lcid</strong>].<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="switch_is_being_phased_out"></span><span id="SWITCH_IS_BEING_PHASED_OUT"></span>L'opzione è in fase di uscita</dt> <dd> Le opzioni seguenti sono obsolete: /<strong>hookole</strong>, /<strong>env win16</strong>e /<strong>env</strong>.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="use_of__robust_requires__Oicf__switching_modes"></span><span id="use_of__robust_requires__oicf__switching_modes"></span><span id="USE_OF__ROBUST_REQUIRES__OICF__SWITCHING_MODES"></span>l'uso di /robust richiede /Oicf, modalità di commutazione</dt> <dd> È necessario compilare in <a href="-oi.md"><strong>modalità /Oicf</strong></a> quando si specifica <a href="-robust.md"><strong>l'opzione /robust</strong></a> nella riga di comando.<br/> </dd> </dl></td>
</tr>
<tr class="odd">
...
<td><dl> <dt><span id="DOS__Win16_and_MAC_platforms_are_not_supported_with__robust"></span><span id="dos__win16_and_mac_platforms_are_not_supported_with__robust"></span><span id="DOS__WIN16_AND_MAC_PLATFORMS_ARE_NOT_SUPPORTED_WITH__ROBUST"></span>Le piattaforme DOS, Win16 e MAC non sono supportate con /robust</dt> <dd> MIDL supporta <a href="-robust.md"><strong>l'opzione /robust</strong></a> in Microsoft Windows 2000 o versioni successive.<br/> </dd> </dl></td>
</tr>
<tr class="even">
