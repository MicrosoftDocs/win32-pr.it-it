...
---
# <a name="sh_token-keyword"></a>\_parola chiave del token SH

La parola chiave del **\_ token SH** specifica che un oggetto `system_handle` include un handle per un token.
...
[Diritti di accesso per oggetti Access-Token](../secauthz/access-rights-for-access-token-objects.md)
</dt> </dl>
