...
keywords:
- Archiviazione strutturata Strctd STG, esempi, WriteRead
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103711638"
---
# <a name="writeread-sample"></a><span data-ttu-id="bd54b-104">Esempio WriteRead</span><span class="sxs-lookup"><span data-stu-id="bd54b-104">WriteRead Sample</span></span>

<span data-ttu-id="bd54b-105">WriteRead. cpp crea un set di proprietà, scrive una proprietà, chiude e riapre il set di proprietà e legge nuovamente la proprietà.</span><span class="sxs-lookup"><span data-stu-id="bd54b-105">The WriteRead.cpp creates a property set, writes a property, closes and reopens the property set, and reads back the property.</span></span> <span data-ttu-id="bd54b-106">Questa applicazione di esempio crea il file "WriteRead. STG" nella directory corrente.</span><span class="sxs-lookup"><span data-stu-id="bd54b-106">This sample application creates the file "WriteRead.stg" in the current directory.</span></span> <span data-ttu-id="bd54b-107">Crea set di proprietà in un file di archiviazione della struttura, ma una modifica di una riga comporta la creazione di set di proprietà NTFS file system.</span><span class="sxs-lookup"><span data-stu-id="bd54b-107">It creates property sets in a structure storage file, but a one-line change causes it to create NTFS file system property sets.</span></span>
