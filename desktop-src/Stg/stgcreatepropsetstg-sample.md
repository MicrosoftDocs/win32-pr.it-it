---
title: Esempio StgCreatePropSetStg
description: Mostra come è possibile usare la funzione StgCreatePropSetStg per creare un'interfaccia IPropertySetStorage su una determinata interfaccia IStorage.
ms.assetid: f0d0664a-2cfd-4eb0-b1d5-47d1545394fd
keywords:
- Archiviazione strutturata Strctd STG, esempi, StgCreatePropSetStg
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104396606"
---
# <a name="stgcreatepropsetstg-sample"></a><span data-ttu-id="61c65-104">Esempio StgCreatePropSetStg</span><span class="sxs-lookup"><span data-stu-id="61c65-104">StgCreatePropSetStg Sample</span></span>

<span data-ttu-id="61c65-105">L'esempio StgCreatePropSetStg. cpp Mostra come è possibile usare la funzione [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) per creare un'interfaccia [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) su qualsiasi interfaccia [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) specificata.</span><span class="sxs-lookup"><span data-stu-id="61c65-105">The StgCreatePropSetStg.cpp sample shows how the [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) function can be used to create an [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) interface on top of any given [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) interface.</span></span>
