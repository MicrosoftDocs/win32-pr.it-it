...
---
# <a name="enumall-sample"></a><span data-ttu-id="d4192-104">Esempio EnumAll</span><span class="sxs-lookup"><span data-stu-id="d4192-104">EnumAll Sample</span></span>

<span data-ttu-id="d4192-105">L'applicazione di esempio EnumAll. cpp inserisce tutte le proprietà in tutti i set di proprietà di un file di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="d4192-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
