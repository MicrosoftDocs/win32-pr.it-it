...
---
# <a name="why-does-a-decoder-dmo-not-accept-the-input-format-that-i-set"></a><span data-ttu-id="78ffa-105">Perché un decodificatore DMO non accetta il formato di input impostato?</span><span class="sxs-lookup"><span data-stu-id="78ffa-105">Why does a decoder DMO not accept the input format that I set?</span></span>

<span data-ttu-id="78ffa-106">Per la documentazione corrente sui codec Windows Media e sui processori di segnali digitali, vedere [Windows Media audio e codec video e API DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="78ffa-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
