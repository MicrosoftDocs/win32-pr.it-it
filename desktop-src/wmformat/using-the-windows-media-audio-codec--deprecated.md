...
---
# <a name="using-the-windows-media-audio-codec"></a><span data-ttu-id="c2295-105">Uso del codec Windows Media Audio</span><span class="sxs-lookup"><span data-stu-id="c2295-105">Using the Windows Media Audio Codec</span></span>

<span data-ttu-id="c2295-106">Per la documentazione corrente sui codec Windows Media e sui processori di segnali digitali, vedere [Windows Media audio e codec video e API DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="c2295-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
