...
-   [Codec supportati](supported-codecs.md)
...
-   [Codifica a due passi](two-pass-encoding.md)
-   [Supporto audio ad alta risoluzione](high-resolution-audio-support.md)
-   [Audio a basso ritardo](low-delay-audio.md)
