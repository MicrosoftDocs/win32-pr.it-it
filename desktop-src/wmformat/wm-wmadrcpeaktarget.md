...
L'attributo **WM/WMADRCPeakTarget** contiene il livello di volume massimo richiesto dall'utente. Questo valore viene utilizzato da Windows Media Player per il controllo dinamico degli intervalli.
