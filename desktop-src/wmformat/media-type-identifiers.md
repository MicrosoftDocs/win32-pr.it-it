---
title: Identificatori dei tipi di supporto per Windows Media Format SDK
description: Informazioni sugli identificatori dei tipi di supporti usati per definire il formato dei supporti usati con Windows Media Format SDK.
ms.assetid: 5d903953-cd6b-4fba-b877-8c7ad3aeb87d
keywords:
- Windows MEDIA Format SDK, identificatori dei tipi di supporti
- Advanced Systems Format (ASF), identificatori del tipo di supporto
- ASF (Advanced Systems Format),identificatori dei tipi di supporti
- tipi di supporti, identificatori
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119084688"
---
# <a name="media-type-identifiers-for-the-windows-media-format-sdk"></a>Identificatori dei tipi di supporto per Windows Media Format SDK

È necessario usare i tipi di supporti per definire il formato dei supporti usati con Windows Media Format SDK. Per le descrizioni dei vari tipi di supporti, vedere [Tipi di supporti.](media-types.md)

Nella tabella seguente sono elencati gli identificatori globali per tutti i tipi di supporti supportati e i valori GUID corrispondenti.
...
| Immagine \_ WMMEDIATYPE                | 34A50FD8-8AA5-4386-81FE-A0EFE0488E31 |
| WMMEDIATYPE \_ Script               | 73636d64-0000-0010-8000-00AA00389B71 |
| Testo \_ WMMEDIATYPE                 | 9BBA1EA7-5AB2-4829-BA57-0940209BCF3E |
| WMMEDIATYPE \_ Video                | 73646976-0000-0010-8000-00AA00389B71 |
| TwoString WMSCRIPTTYPE \_          | 82f38a70-c29f-11d1-97ad-00a0c95ea850 |
