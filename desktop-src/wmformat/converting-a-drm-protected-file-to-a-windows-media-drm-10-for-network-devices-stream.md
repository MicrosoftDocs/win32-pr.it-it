...
8.  Quando si riceve un messaggio WMT TRANSCRYPTOR READ con il parametro hr impostato su \_ \_ NS S  \_ \_ TRANSCRYPTOR EOF, è stato letto \_ l'intero file. A questo punto, chiamare il [**metodo IWMDRMTranscryptor::Close**](/previous-versions/windows/desktop/api/Wmsdkidl/nf-wmsdkidl-iwmdrmtranscryptor-close) per chiudere il file e liberare risorse.
