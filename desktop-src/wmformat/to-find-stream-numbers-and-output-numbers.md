...
- Advanced Systems Format (ASF), ricerca di numeri di output
- ASF (Advanced Systems Format),ricerca di numeri di output
...
Il lettore sincrono supporta un passaggio più semplificato tra i numeri di flusso e di output per la riproduzione rispetto al lettore asincrono. È quindi più importante essere in grado di trovare i numeri di flusso che equi equidominano ai numeri di output o il contrario.
