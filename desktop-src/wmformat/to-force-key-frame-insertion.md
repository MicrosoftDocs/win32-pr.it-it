---
title: Per forzare Key-Frame inserimento
description: Per forzare Key-Frame inserimento
ms.assetid: 456482da-aaa2-41f8-93f7-c0fa5abe7dd2
keywords:
- Advanced Systems Format (ASF), forzando gli inserimenti di fotogrammi chiave
...
---
# <a name="to-force-key-frame-insertion"></a>Per forzare Key-Frame inserimento

Il Windows Media Video 9 supporta l'inserimento forzato di fotogrammi chiave. Quando si passa un esempio al writer, è possibile specificare che deve essere codificato come [*fotogramma chiave.*](wmformat-glossary.md)
...
4.  Aggiornare la quantità di dati usati nel buffer per riflettere le dimensioni effettive dell'esempio chiamando [**INSSBuffer::SetLength**](/previous-versions/windows/desktop/api/Wmsbuffer/nf-wmsbuffer-inssbuffer-setlength).
