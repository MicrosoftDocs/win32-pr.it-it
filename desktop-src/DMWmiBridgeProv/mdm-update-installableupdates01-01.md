...
---
# <a name="mdm_update_installableupdates01_01-class"></a>\_Classe MDM Update \_ InstallableUpdates01 \_ 01

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe **MDM \_ Update \_ InstallableUpdates01 \_ 01** viene usata per gestire e controllare l'implementazione degli aggiornamenti approvati.
...
La classe **MDM \_ Update \_ InstallableUpdates01 \_ 01** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **MDM \_ Update \_ InstallableUpdates01 \_ 01** presenta queste proprietà.
