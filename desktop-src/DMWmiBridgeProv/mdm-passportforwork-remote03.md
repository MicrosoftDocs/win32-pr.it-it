...
---
# <a name="mdm_passportforwork_remote03-class"></a>\_Classe MDM PassportForWork \_ Remote03

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe **MDM \_ PassportForWork \_ Remote03** definisce le impostazioni dei criteri remoti di Windows Hello for business.
...
La classe **MDM \_ PassportForWork \_ Remote03** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **MDM \_ PassportForWork \_ Remote03** dispone di queste proprietà.
...
Nodo interno per la definizione di criteri remoti di Windows Hello for business. Questo nodo è stato aggiunto in Windows 10, versione 1511.
...
Nodo per la definizione delle impostazioni dei criteri di Windows Hello for business.
