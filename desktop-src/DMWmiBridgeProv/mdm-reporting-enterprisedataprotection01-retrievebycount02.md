...
---
# <a name="mdm_reporting_enterprisedataprotection01_retrievebycount02-class"></a>MDM \_ Reporting \_ EnterpriseDataProtection01 \_ classe RetrieveByCount02

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La **classe \_ \_ EnterpriseDataProtection01 \_ RetrieveByCount02 di Reporting MDM** viene utilizzata per recuperare un numero specificato di log da StartTime. Il StartTime è espresso nel formato ISO 8601. È possibile impostare il numero di log necessari impostando LogCount e StartTime. Restituisce il numero specificato di log o meno, se il numero totale di log è inferiore a LogCount.
...
La **classe \_ \_ EnterpriseDataProtection01 \_ RetrieveByCount02 di Reporting MDM** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe RetrieveByCount02 per la **\_ creazione di report MDM \_ \_ EnterpriseDataProtection01** ha queste proprietà.
