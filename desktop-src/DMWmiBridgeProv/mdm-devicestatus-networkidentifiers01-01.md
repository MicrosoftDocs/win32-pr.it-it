...
---
# <a name="mdm_devicestatus_networkidentifiers01_01-class"></a>\_Classe MDM DeviceStatus \_ NetworkIdentifiers01 \_ 01

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe **MDM \_ DeviceStatus \_ NetworkIdentifiers01 \_ 01** consente di eseguire una query su un dispositivo per le proprietà di rete.
...
La classe **MDM \_ DeviceStatus \_ NetworkIdentifiers01 \_ 01** presenta questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La classe **MDM \_ DeviceStatus \_ NetworkIdentifiers01 \_ 01** presenta queste proprietà.
...
Nodo per le query sulle proprietà della rete e del dispositivo.
