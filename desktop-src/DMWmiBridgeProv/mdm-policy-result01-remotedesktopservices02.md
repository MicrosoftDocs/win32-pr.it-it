...
description: La classe MDM \_ Policy \_ Result01 \_ RemoteDesktopServices02 rappresenta i criteri di Servizi Desktop remoto.
ms.assetid: 015fe30d-2b76-4df5-a81f-65e488db3526
keywords:
- MDM_Policy_Result01_RemoteDesktopServices02 classe
- MDM_Policy_Result01_RemoteDesktopServices02 classe , descritta
topic_type:
- apiref
api_name:
...
ms.locfileid: "119796011"
---
# <a name="mdm_policy_result01_remotedesktopservices02-class"></a>Classe \_ \_ \_ RemoteDesktopServices02 risultato dei criteri MDM01

\[Alcune informazioni riguardano un prodotto pre-rilasciato che può essere modificato sostanzialmente prima del rilascio in commercio. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe MDM \_ Policy \_ Result01 \_ RemoteDesktopServices02 rappresenta i criteri di Servizi Desktop remoto.
...
La **classe MDM Policy \_ \_ Result01 \_ RemoteDesktopServices02** include questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe MDM Policy \_ \_ Result01 \_ RemoteDesktopServices02** ha queste proprietà.
