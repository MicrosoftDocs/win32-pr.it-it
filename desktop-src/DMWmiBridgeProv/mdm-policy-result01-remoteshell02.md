---
title: MDM_Policy_Result01_RemoteShell02 classe
description: La classe MDM \_ Policy \_ Result01 \_ RemoteShell02 rappresenta i criteri della shell remota.
ms.assetid: d005b2e6-e838-4bda-9ba4-bd49c092f951
keywords:
- MDM_Policy_Result01_RemoteShell02 classe
- MDM_Policy_Result01_RemoteShell02 classe , descritta
topic_type:
- apiref
api_name:
...
ms.locfileid: "119698646"
---
# <a name="mdm_policy_result01_remoteshell02-class"></a>Classe \_ \_ RemoteShell02 mdm Policy \_ Result01

\[Alcune informazioni riguardano un prodotto pre-rilasciato che può essere modificato sostanzialmente prima del rilascio in commercio. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe MDM \_ Policy \_ Result01 \_ RemoteShell02 rappresenta i criteri della shell remota.
...
La **classe MDM Policy \_ \_ Result01 \_ RemoteShell02** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe MDM Policy \_ \_ Result01 \_ RemoteShell02** ha queste proprietà.
