...
---
# <a name="mdm_policy_user_config01_start02-class"></a>\_Utente criteri \_ MDM \_ Config01 \_ classe Start02

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La classe del **\_ criterio MDM \_ utente \_ Config01 \_ Start02** rappresenta i criteri di avvio disponibili impostati per ogni singolo utente.
...
La **classe \_ \_ \_ Config01 \_ Start02 dell'utente dei criteri MDM** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ \_ \_ Config01 \_ Start02 dell'utente dei criteri MDM** ha queste proprietà.
