...
---
# <a name="mdm_policy_config01_remotedesktopservices02-class"></a>\_ \_ Classe Config01 RemoteDesktopServices02 di criteri \_ MDM

\[Alcune informazioni si riferiscono al prodotto pre-rilasciato che può essere modificato in modo sostanziale prima del rilascio commerciale. Microsoft non riconosce alcuna garanzia, espressa o implicita, in merito alle informazioni qui fornite.\]

La \_ \_ classe Config01 RemoteDesktopServices02 dei criteri MDM \_ Configura i criteri del servizio desktop remoto.
...
La **classe \_ \_ Config01 \_ RemoteDesktopServices02 dei criteri MDM** ha questi tipi di membri:

-   [Proprietà](#properties)

### <a name="properties"></a>Proprietà

La **classe \_ \_ \_ RemoteDesktopServices02 dei criteri MDM Config01** ha queste proprietà.
