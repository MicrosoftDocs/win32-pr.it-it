...
---
# <a name="tbn_toolbarchange-notification-code"></a>\_Codice di notifica TOOLBARCHANGE di TBN

Notifica alla finestra padre della barra degli strumenti che l'utente ha personalizzato una barra degli strumenti. Questo codice di notifica viene inviato sotto forma di messaggio [**di \_ notifica WM**](wm-notify.md) .
