...
## <a name="using-hot-key-controls"></a>Uso dei controlli dei tasti di scelta rapida
...
### <a name="hot-key-control-messages"></a>Messaggi di controllo tasto di scelta rapida
...
| [**WM \_ SYSKEYDOWN**](/windows/desktop/inputdev/wm-syskeydown)   | Chiama la [**funzione DefWindowProc**](/windows/desktop/api/winuser/nf-winuser-defwindowproca) se il tasto è INVIO, TAB, BARRA SPAZIATRICE, DEL, ESC o BACKSPACE. Se il tasto è MAIUSC, CTRL o ALT, controlla se la combinazione è valida e, in caso contrario, imposta il tasto di scelta usando la combinazione. Tutte le altre chiavi vengono impostate come tasti di scelta rapida senza che la relativa validità venga verificata per prima. |
