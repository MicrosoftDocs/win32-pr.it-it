...
---
# <a name="rbn_begindrag-notification-code"></a>\_Codice di notifica BEGINDRAG di RBN

Inviato da un controllo Rebar quando l'utente inizia a trascinare un gruppo. Questo codice di notifica viene inviato sotto forma di messaggio [**di \_ notifica WM**](wm-notify.md) .
...
Restituisce zero per consentire al controllo Rebar di continuare l'operazione di trascinamento o un valore diverso da zero per interrompere l'operazione di trascinamento.
