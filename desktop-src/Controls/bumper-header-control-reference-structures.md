---
title: Strutture del controllo Header
description: Strutture del controllo Header
...
ms.locfileid: "119916721"
---
# <a name="header-control-structures"></a>Strutture del controllo Header
