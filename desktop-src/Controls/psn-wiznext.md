...
---
# <a name="psn_wiznext-notification-code"></a>\_Codice di notifica WIZNEXT PSN

Notifica a una pagina che l'utente ha fatto clic sul pulsante **Avanti** in una procedura guidata. Questo codice di notifica viene inviato sotto forma di messaggio [**di \_ notifica WM**](wm-notify.md) .
