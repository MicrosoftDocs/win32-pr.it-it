...
[**LOWORD**](/previous-versions/windows/desktop/legacy/ms632659(v=vs.85)) è un valore **bool** che indica se selezionare o deselezionare il pulsante specificato. Se **true**, viene aggiunto il controllo. Se **false**, il controllo viene rimosso.
