...
---
# <a name="wm_hscroll-trackbar-notification-code"></a>Codice di notifica di WM \_ HSCROLL (TrackBar)
...
Si noti che il messaggio **WM \_ HSCROLL** contiene solo 16 bit di dati sulla posizione. Pertanto, le applicazioni che si basano esclusivamente su **WM \_ HSCROLL** (e [**WM \_ VSCROLL**](wm-vscroll--trackbar-.md)) per i dati della posizione del dispositivo di scorrimento hanno un valore di posizione massimo pratica di 65.535.
...
[**\_VSCROLL WM**](wm-vscroll--trackbar-.md)
</dt> </dl>
