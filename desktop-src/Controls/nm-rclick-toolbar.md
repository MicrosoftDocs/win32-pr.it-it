---
title: NM_RCLICK (barra degli strumenti) codice di notifica (Commctrl.h)
...
---
# <a name="nm_rclick-toolbar-notification-code"></a>Codice \_ di notifica NM RCLICK (barra degli strumenti)
