...
---
# <a name="tcm_getunicodeformat-message"></a>\_Messaggio TCM GETUNICODEFORMAT

Recupera il flag del formato carattere Unicode per il controllo. È possibile inviare questo messaggio in modo esplicito o usare la macro [**\_ GetUnicodeFormat di TabCtrl**](/windows/desktop/api/Commctrl/nf-commctrl-tabctrl_getunicodeformat) .
