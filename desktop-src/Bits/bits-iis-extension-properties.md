...
L'esempio seguente illustra come impostare le proprietà dell'estensione IIS BITS usando Windows Host script. Se la directory virtuale punta a una condivisione remota, impostare anche le proprietà **UNCUserName** e **UNCPassword** IIS.
