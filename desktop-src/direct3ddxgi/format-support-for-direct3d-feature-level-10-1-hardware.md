...
---
# <a name="format-support-for-direct3d-feature-level-101-hardware"></a>Supporto del formato per l'hardware a livello di funzionalità 10.1 di Direct3D

Questa sezione specifica i formati ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valori) supportati nell'hardware a livello di funzionalità Direct3D 10,1.
