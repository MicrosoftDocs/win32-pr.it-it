---
description: Questa sezione specifica i formati [**(DXGI_FORMAT_)** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) supportati nell'hardware Direct3D Feature Level 12.0.
ms.assetid: A039A82B-2E30-41A6-96B5-AD5538FE2285
title: Supporto del formato per l'hardware a livello di funzionalità 12.0 di Direct3D
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119745621"
---
# <a name="format-support-for-direct3d-feature-level-120-hardware"></a>Supporto del formato per l'hardware a livello di funzionalità 12.0 di Direct3D

Questa sezione specifica i formati [**(DXGI_FORMAT_)** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) supportati nell'hardware Direct3D Feature Level 12.0.
...
## <a name="dxgi_format_r32g8x24_typeless-19"></a>DXGI_FORMAT_R32G8X24 \_ TYPELESS (19)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 64 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32_float_x8x24_typeless-21"></a>DXGI_FORMAT_R32 FLOAT \_ \_ X8X24 \_ TYPELESS (21)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 64 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_x32_typeless_g8x24_uint-22"></a>DXGI_FORMAT_X32 \_ \_ UINT G8X24 \_ SENZA TIPI (22)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 64 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
| Operazioni atomiche bit per bit UAV | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24_unorm_x8_typeless-46"></a>DXGI_FORMAT_R24 \_ UNORM \_ X8 \_ SENZA TIPI (46)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 32 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_x24_typeless_g8_uint-47"></a>DXGI_FORMAT_X24 \_ \_ UINT senza TIPO G8 \_ (47)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 32 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_r9g9b9e5_sharedexpsupfncsup-67"></a>DXGI_FORMAT_R9G9B9E5 \_ <sup>FNC</sup> SHAREDEXP (67)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 32 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
<sup>PCS:</sup> layout parzialmente tipizzato, di cui è possibile eseguire il cast e semplice
</dt> <dt>
