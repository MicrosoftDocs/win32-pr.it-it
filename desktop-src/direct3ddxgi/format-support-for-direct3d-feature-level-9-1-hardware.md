...
---
# <a name="format-support-for-direct3d-feature-10level9-91-hardware"></a>Supporto del formato per l'hardware a livello di funzionalità 10Level9 9.1 di Direct3D

Questa sezione specifica i formati ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valori) supportati nella funzionalità Direct3D 10Level9 9,1 hardware.
