...
---
# <a name="format-support-for-direct3d-feature-level-100-hardware"></a>Supporto del formato per l'hardware a livello di funzionalità 10.0 di Direct3D

Questa sezione specifica i formati ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valori) supportati nell'hardware a livello di funzionalità Direct3D 10,0.
...
| RenderTarget | ![necessario](images/letter-r.jpg) |
| RenderTarget blendable | \- |
| Operazione logica di Unione output | ![facoltative](images/letter-o.jpg) |
| Profondità/stencil di destinazione | \- |
| UAV e SRV non elaborati | \- |
| UAV strutturato e SRV | \- |
| UAV tipizzato | \- |
...
## <a name="dxgi_format_bc1_unormsupfccsup-71"></a>DXGI_FORMAT_BC1 \_ <sup>FCC</sup> UNORM (71)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 4 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc2_unormsupfccsup-74"></a>DXGI_FORMAT_BC2 \_ <sup>FCC</sup> UNORM (74)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 8 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc3_unormsupfccsup-77"></a>DXGI_FORMAT_BC3 \_ <sup>FCC</sup> UNORM (77)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 8 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc4_unormsupfccsup-80"></a>DXGI_FORMAT_BC4 \_ <sup>FCC</sup> UNORM (80)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 4 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc4_snormsupfccsup-81"></a>DXGI_FORMAT_BC4 \_ russare<sup>FCC</sup> (81)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 4 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc5_unormsupfccsup-83"></a>DXGI_FORMAT_BC5 \_ <sup>FCC</sup> UNORM (83)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 8 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc5_snormsupfccsup-84"></a>DXGI_FORMAT_BC5 \_ russare<sup>FCC</sup> (84)
| Destinazione | Supporto |
| - | - |
| Bit per elemento (BPE) | 8 |
| Supporto del formato | ![necessario](images/letter-r.jpg) |
...
I buffer indietro e le analisi con il [**formato \_ DXGI \_ R16G16B16A16 \_ float**](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) contengono dati gamma con valori lineari.
