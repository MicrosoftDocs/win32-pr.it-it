...
Valore a virgola mobile che specifica il componente blu di un colore. Questo valore è in genere compreso nell'intervallo da 0,0 a 1,0. Il valore 0,0 indica l'assenza completa del componente blu, mentre un valore 1,0 indica che il blu è completamente presente.
...
L'intestazione DXGItype.h type definisce [**DXGI \_ RGBA**](dxgi-rgba.md) come alias **di D3DCOLORVALUE,** come indicato di seguito:
