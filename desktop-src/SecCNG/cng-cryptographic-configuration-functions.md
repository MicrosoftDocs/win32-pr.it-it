---
description: "L'API di crittografia: Next Generation (CNG) definisce le funzioni seguenti usate con il sistema di configurazione crittografica CNG."
...
ms.locfileid: "118908808"
---
# <a name="cng-cryptographic-configuration-functions"></a>Funzioni di configurazione crittografica CNG

L'API di crittografia: Next Generation (CNG) definisce le funzioni seguenti usate con il sistema di configurazione crittografica CNG.
...
-   [**Oggetti BCryptEnumContexts**](/windows/desktop/api/Bcrypt/nf-bcrypt-bcryptenumcontexts)
