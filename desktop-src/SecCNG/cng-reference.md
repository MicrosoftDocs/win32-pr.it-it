...
-   [Funzioni del provider SSL CNG](cng-ssl-provider-functions.md)
-   [Funzioni di associazione di token CNG](cng-token-binding-functions.md)
-   [Strutture CNG](cng-structures.md)
-   [Enumerazioni CNG](cng-enumerations.md)
