...
-   [**GESTISCi \_ Opzioni di accesso \_**](/windows/desktop/api/windowsstoragecom/ne-windowsstoragecom-handle_access_options)
-   [**GESTISCi \_ Opzioni di creazione \_**](/windows/desktop/api/windowsstoragecom/ne-windowsstoragecom-handle_creation_options)
-   [**\_Opzioni handle**](/windows/desktop/api/windowsstoragecom/ne-windowsstoragecom-handle_options)
-   [**GESTISCi \_ Opzioni di condivisione \_**](/windows/desktop/api/windowsstoragecom/ne-windowsstoragecom-handle_sharing_options)
...
-   [**opzioni di BSOS \_**](/windows/win32/api/shcore/ne-shcore-bsos_options)
...
-   [**\_tipo ro init \_**](/windows/win32/api/roapi/ne-roapi-ro_init_type)
-   [**\_flag di \_ segnalazione \_ errori ro**](/windows/win32/api/roerrorapi/ne-roerrorapi-roerrorreportingflags)
